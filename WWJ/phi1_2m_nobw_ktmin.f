      subroutine phi1_2m_nobw_ktmin(p1,m2,m3,ktmin,xth,
     $     p2,p3,wt)
...
c     delta(p2^2-s2) delta(p3^2-s3)
      ...
      double precision x3,xth,costh,sinth,phi,cphi,sphi,ktmin
      ...
      if (s1 .lt. 0d0) then
         write(*,*) '** error in phi1_2m_nobw_ktmin: s1 < 0 **',s1
