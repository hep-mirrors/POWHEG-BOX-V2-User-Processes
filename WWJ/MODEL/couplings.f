...
c$$$      double precision  Vud,Vus,Vub,Vcd,Vcs,Vcb,Vtd,Vts,Vtb !CKM matrix elements
c$$$      common/values/    alpha,gfermi,alfas,   
c$$$     &                  mtMS,mbMS,mcMS,mtaMS,
c$$$     &                  Vud,Vus,Vub,Vcd,Vcs,Vcb,Vtd,Vts,Vtb
c$$$      double complex  ci
c$$$      parameter( ci = ( 0.0d0, 1.0d0 ) )
c$$$      double precision  Zero, One, Two, Three, Four, Half, Rt2
c$$$      parameter( Zero = 0.0d0, One = 1.0d0, Two = 2.0d0 )
c$$$      parameter( Three = 3.0d0, Four = 4.0d0, Half = 0.5d0 )
c$$$      parameter( Rt2   = 1.414213562d0 )
c$$$      double precision  Pi, Fourpi
c$$$      parameter( Pi = 3.14159265358979323846d0 )
c$$$      parameter( Fourpi = Four * Pi )
c$$$
c$$$c
c$$$c----------
c$$$c     start
...
c$$$       call set_it(n,ivalue,value,name,15,bn,mtaMS,1.777d0)
c$$$       bn="mgckm"
c$$$       call set_it(n,ivalue,value,name,11,bn,vud,1d0)
c$$$       call set_it(n,ivalue,value,name,12,bn,vus,0d0)
c$$$       call set_it(n,ivalue,value,name,13,bn,vub,0d0)
c$$$       call set_it(n,ivalue,value,name,21,bn,vcd,0d0)
c$$$       call set_it(n,ivalue,value,name,22,bn,vcs,1d0)
c$$$       call set_it(n,ivalue,value,name,23,bn,vcb,0d0)
c$$$       call set_it(n,ivalue,value,name,31,bn,vtd,0d0)
c$$$       call set_it(n,ivalue,value,name,32,bn,vts,0d0)
c$$$       call set_it(n,ivalue,value,name,33,bn,vtb,1d0)
c$$$       bn="mass"
...
c         write(*,*) 'read model file',tempname
 ...
 30      continue
         if (i.eq.5)then
c            write(*,*) 'Error: file ',tempname,' cannot be opened'
            call exit(-1)
         else
c            write(*,*) 'Warning: file ',tempname,' cannot be opened'
         endif
         tempname='../'//tempname
      enddo
