...
C  
C FOR PROCESS : d~ u -> e+ ve mu- vm~ c s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
      ...
      CALL FVIXXX(W(1,8   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(1   ))            
      CALL FVOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      ...
      CALL FVIXXX(W(1,8   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,7   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,8   ),W(1,20  ),GWF ,WMASS   ,WWIDTH  ,W(1,21  ))    
