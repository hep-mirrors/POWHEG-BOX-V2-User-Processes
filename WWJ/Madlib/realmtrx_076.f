      SUBROUTINE SREALMTRX_076(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ c -> e+ ve mu- vm~ g g  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_076/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_076(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_076(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,15  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL JIOXXX(W(1,16  ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,17  ),GWF ,AMP(2   ))            
      CALL JVVXXX(W(1,8   ),W(1,7   ),G ,ZERO    ,ZERO    ,W(1,18  ))      
      CALL FVOXXX(W(1,1   ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,11  ),W(1,19  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,11  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JIOXXX(W(1,21  ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,11  ),W(1,23  ),GWF ,WMASS   ,WWIDTH  ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL FVIXXX(W(1,25  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL JIOXXX(W(1,26  ),W(1,10  ),GWF ,WMASS   ,WWIDTH  ,W(1,27  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GWF ,AMP(6   ))            
      CALL FVIXXX(W(1,15  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL FVIXXX(W(1,28  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,29  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(7   ))            
      CALL FVIXXX(W(1,2   ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL FVIXXX(W(1,31  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,32  ))    
      CALL JIOXXX(W(1,32  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,33  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GWF ,AMP(8   ))            
      CALL FVIXXX(W(1,26  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JIOXXX(W(1,34  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,35  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GWF ,AMP(9   ))            
      CALL FVIXXX(W(1,25  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL FVIXXX(W(1,36  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL JIOXXX(W(1,37  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,38  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,38  ),GWF ,AMP(10  ))            
      CALL FVIXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL JIOXXX(W(1,39  ),W(1,10  ),GWF ,WMASS   ,WWIDTH  ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,40  ),GWF ,AMP(11  ))            
      CALL FVIXXX(W(1,16  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,41  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,42  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GWF ,AMP(12  ))            
      CALL FVIXXX(W(1,11  ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL JIOXXX(W(1,43  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,44  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,44  ),GWF ,AMP(13  ))            
      CALL FVIXXX(W(1,21  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,45  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,46  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GWF ,AMP(14  ))            
      CALL FVIXXX(W(1,39  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL JIOXXX(W(1,47  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,48  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GWF ,AMP(15  ))            
      CALL JIOXXX(W(1,2   ),W(1,12  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,49  ))    
      CALL FVOXXX(W(1,4   ),W(1,49  ),GZN ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL JIOXXX(W(1,3   ),W(1,50  ),GWF ,WMASS   ,WWIDTH  ,W(1,51  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GWF ,AMP(16  ))            
      CALL JIOXXX(W(1,15  ),W(1,14  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,52  ))    
      CALL FVOXXX(W(1,4   ),W(1,52  ),GZN ,ZERO    ,ZERO    ,W(1,53  ))    
      CALL JIOXXX(W(1,3   ),W(1,53  ),GWF ,WMASS   ,WWIDTH  ,W(1,54  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GWF ,AMP(17  ))            
      CALL JIOXXX(W(1,2   ),W(1,19  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,55  ))    
      CALL FVOXXX(W(1,4   ),W(1,55  ),GZN ,ZERO    ,ZERO    ,W(1,56  ))    
      CALL JIOXXX(W(1,3   ),W(1,56  ),GWF ,WMASS   ,WWIDTH  ,W(1,57  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GWF ,AMP(18  ))            
      CALL JIOXXX(W(1,2   ),W(1,23  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,58  ))    
      CALL FVOXXX(W(1,4   ),W(1,58  ),GZN ,ZERO    ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,3   ),W(1,59  ),GWF ,WMASS   ,WWIDTH  ,W(1,60  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GWF ,AMP(19  ))            
      CALL JIOXXX(W(1,25  ),W(1,10  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,61  ))    
      CALL FVOXXX(W(1,4   ),W(1,61  ),GZN ,ZERO    ,ZERO    ,W(1,62  ))    
      CALL JIOXXX(W(1,3   ),W(1,62  ),GWF ,WMASS   ,WWIDTH  ,W(1,63  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GWF ,AMP(20  ))            
      CALL JIOXXX(W(1,28  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,64  ))    
      CALL FVOXXX(W(1,4   ),W(1,64  ),GZN ,ZERO    ,ZERO    ,W(1,65  ))    
      CALL JIOXXX(W(1,3   ),W(1,65  ),GWF ,WMASS   ,WWIDTH  ,W(1,66  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,66  ),GWF ,AMP(21  ))            
      CALL JIOXXX(W(1,31  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,67  ))    
      CALL FVOXXX(W(1,4   ),W(1,67  ),GZN ,ZERO    ,ZERO    ,W(1,68  ))    
      CALL JIOXXX(W(1,3   ),W(1,68  ),GWF ,WMASS   ,WWIDTH  ,W(1,69  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,69  ),GWF ,AMP(22  ))            
      CALL JIOXXX(W(1,36  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,70  ))    
      CALL FVOXXX(W(1,4   ),W(1,70  ),GZN ,ZERO    ,ZERO    ,W(1,71  ))    
      CALL JIOXXX(W(1,3   ),W(1,71  ),GWF ,WMASS   ,WWIDTH  ,W(1,72  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,72  ),GWF ,AMP(23  ))            
      CALL JIOXXX(W(1,2   ),W(1,12  ),GAU ,ZERO    ,AWIDTH  ,W(1,73  ))    
      CALL FVIXXX(W(1,3   ),W(1,73  ),GAL ,ZERO    ,ZERO    ,W(1,74  ))    
      CALL JIOXXX(W(1,74  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,75  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,75  ),GWF ,AMP(24  ))            
      CALL FVIXXX(W(1,3   ),W(1,49  ),GZL ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL JIOXXX(W(1,76  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,77  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,77  ),GWF ,AMP(25  ))            
      CALL JIOXXX(W(1,15  ),W(1,14  ),GAU ,ZERO    ,AWIDTH  ,W(1,78  ))    
      CALL FVIXXX(W(1,3   ),W(1,78  ),GAL ,ZERO    ,ZERO    ,W(1,79  ))    
      CALL JIOXXX(W(1,79  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,80  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,80  ),GWF ,AMP(26  ))            
      CALL FVIXXX(W(1,3   ),W(1,52  ),GZL ,ZERO    ,ZERO    ,W(1,81  ))    
      CALL JIOXXX(W(1,81  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,82  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,82  ),GWF ,AMP(27  ))            
      CALL JIOXXX(W(1,2   ),W(1,19  ),GAU ,ZERO    ,AWIDTH  ,W(1,83  ))    
      CALL FVIXXX(W(1,3   ),W(1,83  ),GAL ,ZERO    ,ZERO    ,W(1,84  ))    
      CALL JIOXXX(W(1,84  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,85  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,85  ),GWF ,AMP(28  ))            
      CALL FVIXXX(W(1,3   ),W(1,55  ),GZL ,ZERO    ,ZERO    ,W(1,86  ))    
      CALL JIOXXX(W(1,86  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,87  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,87  ),GWF ,AMP(29  ))            
      CALL JIOXXX(W(1,2   ),W(1,23  ),GAU ,ZERO    ,AWIDTH  ,W(1,88  ))    
      CALL FVIXXX(W(1,3   ),W(1,88  ),GAL ,ZERO    ,ZERO    ,W(1,89  ))    
      CALL JIOXXX(W(1,89  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,90  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,90  ),GWF ,AMP(30  ))            
      CALL FVIXXX(W(1,3   ),W(1,58  ),GZL ,ZERO    ,ZERO    ,W(1,91  ))    
      CALL JIOXXX(W(1,91  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,92  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,92  ),GWF ,AMP(31  ))            
      CALL JIOXXX(W(1,25  ),W(1,10  ),GAU ,ZERO    ,AWIDTH  ,W(1,93  ))    
      CALL FVIXXX(W(1,3   ),W(1,93  ),GAL ,ZERO    ,ZERO    ,W(1,94  ))    
      CALL JIOXXX(W(1,94  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,95  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,95  ),GWF ,AMP(32  ))            
      CALL FVIXXX(W(1,3   ),W(1,61  ),GZL ,ZERO    ,ZERO    ,W(1,96  ))    
      CALL JIOXXX(W(1,96  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,97  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,97  ),GWF ,AMP(33  ))            
      CALL JIOXXX(W(1,28  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,98  ))    
      CALL FVIXXX(W(1,3   ),W(1,98  ),GAL ,ZERO    ,ZERO    ,W(1,99  ))    
      CALL JIOXXX(W(1,99  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,100 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,100 ),GWF ,AMP(34  ))            
      CALL FVIXXX(W(1,3   ),W(1,64  ),GZL ,ZERO    ,ZERO    ,W(1,101 ))    
      CALL JIOXXX(W(1,101 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,102 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,102 ),GWF ,AMP(35  ))            
      CALL JIOXXX(W(1,31  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,103 ))    
      CALL FVIXXX(W(1,3   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,104 ))    
      CALL JIOXXX(W(1,104 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,105 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,105 ),GWF ,AMP(36  ))            
      CALL FVIXXX(W(1,3   ),W(1,67  ),GZL ,ZERO    ,ZERO    ,W(1,106 ))    
      CALL JIOXXX(W(1,106 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,107 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,107 ),GWF ,AMP(37  ))            
      CALL JIOXXX(W(1,36  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,108 ))    
      CALL FVIXXX(W(1,3   ),W(1,108 ),GAL ,ZERO    ,ZERO    ,W(1,109 ))    
      CALL JIOXXX(W(1,109 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,110 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,110 ),GWF ,AMP(38  ))            
      CALL FVIXXX(W(1,3   ),W(1,70  ),GZL ,ZERO    ,ZERO    ,W(1,111 ))    
      CALL JIOXXX(W(1,111 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,112 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,112 ),GWF ,AMP(39  ))            
      CALL JVVXXX(W(1,9   ),W(1,73  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     113 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,113 ),GWF ,AMP(40  ))            
      CALL JVVXXX(W(1,9   ),W(1,49  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     114 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,114 ),GWF ,AMP(41  ))            
      CALL JVVXXX(W(1,9   ),W(1,78  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     115 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,115 ),GWF ,AMP(42  ))            
      CALL JVVXXX(W(1,9   ),W(1,52  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     116 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,116 ),GWF ,AMP(43  ))            
      CALL JVVXXX(W(1,9   ),W(1,83  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     117 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,117 ),GWF ,AMP(44  ))            
      CALL JVVXXX(W(1,9   ),W(1,55  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     118 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,118 ),GWF ,AMP(45  ))            
      CALL JVVXXX(W(1,9   ),W(1,88  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     119 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,119 ),GWF ,AMP(46  ))            
      CALL JVVXXX(W(1,9   ),W(1,58  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     120 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,120 ),GWF ,AMP(47  ))            
      CALL JVVXXX(W(1,9   ),W(1,93  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     121 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,121 ),GWF ,AMP(48  ))            
      CALL JVVXXX(W(1,9   ),W(1,61  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     122 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,122 ),GWF ,AMP(49  ))            
      CALL JVVXXX(W(1,9   ),W(1,98  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     123 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GWF ,AMP(50  ))            
      CALL JVVXXX(W(1,9   ),W(1,64  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     124 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,124 ),GWF ,AMP(51  ))            
      CALL JVVXXX(W(1,9   ),W(1,103 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     125 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,125 ),GWF ,AMP(52  ))            
      CALL JVVXXX(W(1,9   ),W(1,67  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     126 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,126 ),GWF ,AMP(53  ))            
      CALL JVVXXX(W(1,9   ),W(1,108 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     127 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,127 ),GWF ,AMP(54  ))            
      CALL JVVXXX(W(1,9   ),W(1,70  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     128 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,128 ),GWF ,AMP(55  ))            
      CALL FVOXXX(W(1,5   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,129 ))    
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,49  ),GZN ,AMP(56  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,52  ),GZN ,AMP(57  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,55  ),GZN ,AMP(58  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,58  ),GZN ,AMP(59  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,61  ),GZN ,AMP(60  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,64  ),GZN ,AMP(61  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,67  ),GZN ,AMP(62  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,70  ),GZN ,AMP(63  ))            
      CALL FVOXXX(W(1,5   ),W(1,73  ),GAL ,ZERO    ,ZERO    ,W(1,130 ))    
      CALL IOVXXX(W(1,6   ),W(1,130 ),W(1,9   ),GWF ,AMP(64  ))            
      CALL FVOXXX(W(1,5   ),W(1,49  ),GZL ,ZERO    ,ZERO    ,W(1,131 ))    
      CALL IOVXXX(W(1,6   ),W(1,131 ),W(1,9   ),GWF ,AMP(65  ))            
      CALL FVOXXX(W(1,5   ),W(1,78  ),GAL ,ZERO    ,ZERO    ,W(1,132 ))    
      CALL IOVXXX(W(1,6   ),W(1,132 ),W(1,9   ),GWF ,AMP(66  ))            
      CALL FVOXXX(W(1,5   ),W(1,52  ),GZL ,ZERO    ,ZERO    ,W(1,133 ))    
      CALL IOVXXX(W(1,6   ),W(1,133 ),W(1,9   ),GWF ,AMP(67  ))            
      CALL FVOXXX(W(1,5   ),W(1,83  ),GAL ,ZERO    ,ZERO    ,W(1,134 ))    
      CALL IOVXXX(W(1,6   ),W(1,134 ),W(1,9   ),GWF ,AMP(68  ))            
      CALL FVOXXX(W(1,5   ),W(1,55  ),GZL ,ZERO    ,ZERO    ,W(1,135 ))    
      CALL IOVXXX(W(1,6   ),W(1,135 ),W(1,9   ),GWF ,AMP(69  ))            
      CALL FVOXXX(W(1,5   ),W(1,88  ),GAL ,ZERO    ,ZERO    ,W(1,136 ))    
      CALL IOVXXX(W(1,6   ),W(1,136 ),W(1,9   ),GWF ,AMP(70  ))            
      CALL FVOXXX(W(1,5   ),W(1,58  ),GZL ,ZERO    ,ZERO    ,W(1,137 ))    
      CALL IOVXXX(W(1,6   ),W(1,137 ),W(1,9   ),GWF ,AMP(71  ))            
      CALL FVOXXX(W(1,5   ),W(1,93  ),GAL ,ZERO    ,ZERO    ,W(1,138 ))    
      CALL IOVXXX(W(1,6   ),W(1,138 ),W(1,9   ),GWF ,AMP(72  ))            
      CALL FVOXXX(W(1,5   ),W(1,61  ),GZL ,ZERO    ,ZERO    ,W(1,139 ))    
      CALL IOVXXX(W(1,6   ),W(1,139 ),W(1,9   ),GWF ,AMP(73  ))            
      CALL FVOXXX(W(1,5   ),W(1,98  ),GAL ,ZERO    ,ZERO    ,W(1,140 ))    
      CALL IOVXXX(W(1,6   ),W(1,140 ),W(1,9   ),GWF ,AMP(74  ))            
      CALL FVOXXX(W(1,5   ),W(1,64  ),GZL ,ZERO    ,ZERO    ,W(1,141 ))    
      CALL IOVXXX(W(1,6   ),W(1,141 ),W(1,9   ),GWF ,AMP(75  ))            
      CALL FVOXXX(W(1,5   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,142 ))    
      CALL IOVXXX(W(1,6   ),W(1,142 ),W(1,9   ),GWF ,AMP(76  ))            
      CALL FVOXXX(W(1,5   ),W(1,67  ),GZL ,ZERO    ,ZERO    ,W(1,143 ))    
      CALL IOVXXX(W(1,6   ),W(1,143 ),W(1,9   ),GWF ,AMP(77  ))            
      CALL FVOXXX(W(1,5   ),W(1,108 ),GAL ,ZERO    ,ZERO    ,W(1,144 ))    
      CALL IOVXXX(W(1,6   ),W(1,144 ),W(1,9   ),GWF ,AMP(78  ))            
      CALL FVOXXX(W(1,5   ),W(1,70  ),GZL ,ZERO    ,ZERO    ,W(1,145 ))    
      CALL IOVXXX(W(1,6   ),W(1,145 ),W(1,9   ),GWF ,AMP(79  ))            
      JAMP(   1) = +AMP(   1)+AMP(   3)+AMP(   6)+AMP(   8)+AMP(   9)
     &             +AMP(  10)+AMP(  11)+AMP(  13)+AMP(  15)+AMP(  16)
     &             +AMP(  18)+AMP(  20)+AMP(  22)+AMP(  23)+AMP(  24)
     &             +AMP(  25)+AMP(  28)+AMP(  29)+AMP(  32)+AMP(  33)
     &             +AMP(  36)+AMP(  37)+AMP(  38)+AMP(  39)+AMP(  40)
     &             +AMP(  41)+AMP(  44)+AMP(  45)+AMP(  48)+AMP(  49)
     &             +AMP(  52)+AMP(  53)+AMP(  54)+AMP(  55)+AMP(  56)
     &             +AMP(  58)+AMP(  60)+AMP(  62)+AMP(  63)+AMP(  64)
     &             +AMP(  65)+AMP(  68)+AMP(  69)+AMP(  72)+AMP(  73)
     &             +AMP(  76)+AMP(  77)+AMP(  78)+AMP(  79)
      JAMP(   2) = +AMP(   2)-AMP(   3)+AMP(   4)+AMP(   5)+AMP(   7)
     &             -AMP(   8)+AMP(  12)-AMP(  13)+AMP(  14)+AMP(  17)
     &             -AMP(  18)+AMP(  19)+AMP(  21)-AMP(  22)+AMP(  26)
     &             +AMP(  27)-AMP(  28)-AMP(  29)+AMP(  30)+AMP(  31)
     &             +AMP(  34)+AMP(  35)-AMP(  36)-AMP(  37)+AMP(  42)
     &             +AMP(  43)-AMP(  44)-AMP(  45)+AMP(  46)+AMP(  47)
     &             +AMP(  50)+AMP(  51)-AMP(  52)-AMP(  53)+AMP(  57)
     &             -AMP(  58)+AMP(  59)+AMP(  61)-AMP(  62)+AMP(  66)
     &             +AMP(  67)-AMP(  68)-AMP(  69)+AMP(  70)+AMP(  71)
     &             +AMP(  74)+AMP(  75)-AMP(  76)-AMP(  77)
      REALMTRX_076 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_076 =REALMTRX_076+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
