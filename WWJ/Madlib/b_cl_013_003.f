...
C  
C BORN AMPLITUDE IS s~ s -> e+ ve mu- vm~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL JIOXXX(W(1,12  ),W(1,13  ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,14  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,13  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,2   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,17  ))    
      ...
      CALL JIOXXX(W(1,12  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,20  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,9   ),GAD ,ZERO    ,AWIDTH  ,W(1,23  ))    
      ...
      CALL JIOXXX(W(1,12  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,28  ))    
