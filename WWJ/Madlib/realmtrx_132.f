      SUBROUTINE SREALMTRX_132(P1,ANS)
C  
...
C  
C FOR PROCESS : g u -> e+ ve mu- vm~ u g  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_132/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_132(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_132(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,12  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      ...
      CALL JIOXXX(W(1,15  ),W(1,14  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,38  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,19  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,41  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,23  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,44  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVIXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      ...
      CALL JIOXXX(W(1,2   ),W(1,12  ),GAU ,ZERO    ,AWIDTH  ,W(1,63  ))    
      ...
      CALL JIOXXX(W(1,15  ),W(1,14  ),GAU ,ZERO    ,AWIDTH  ,W(1,68  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,19  ),GAU ,ZERO    ,AWIDTH  ,W(1,73  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,23  ),GAU ,ZERO    ,AWIDTH  ,W(1,78  ))    
     ...
     &             +AMP(  72)+AMP(  73)-AMP(  74)-AMP(  75)
      JAMP(   2) = -AMP(   1)-AMP(   3)-AMP(   6)-AMP(   8)-AMP(  10)
     &             -AMP(  11)-AMP(  13)-AMP(  15)-AMP(  17)-AMP(  18)
     &             -AMP(  19)-AMP(  20)-AMP(  23)-AMP(  24)-AMP(  27)
     &             -AMP(  28)-AMP(  31)-AMP(  32)-AMP(  33)-AMP(  34)
     &             -AMP(  35)-AMP(  36)-AMP(  39)-AMP(  40)-AMP(  43)
     &             -AMP(  44)-AMP(  47)-AMP(  48)-AMP(  49)-AMP(  50)
     &             -AMP(  51)-AMP(  53)-AMP(  54)-AMP(  55)-AMP(  56)
     ...
     &             -AMP(  76)-AMP(  77)-AMP(  78)-AMP(  79)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_132 =REALMTRX_132+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
