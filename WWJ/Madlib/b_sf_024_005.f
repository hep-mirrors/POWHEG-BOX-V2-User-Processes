...
C ----------
      ...
      CALL FVOXXX(W(1,12  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL JIOXXX(W(1,2   ),W(1,13  ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,14  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,15  ))    
      CALL FVOXXX(W(1,4   ),W(1,15  ),GZN ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL JIOXXX(W(1,3   ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,17  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,19  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,9   ),GAD ,ZERO    ,AWIDTH  ,W(1,22  ))    
      CALL FVIXXX(W(1,3   ),W(1,22  ),GAL ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL JIOXXX(W(1,23  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,3   ),W(1,15  ),GZL ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL JIOXXX(W(1,25  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GWF ,AMP(6   ))            
      CALL JIOXXX(W(1,18  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,27  ))    
      CALL FVIXXX(W(1,3   ),W(1,27  ),GAL ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL JIOXXX(W(1,28  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,29  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,29  ),GWF ,AMP(7   ))            
      CALL FVIXXX(W(1,3   ),W(1,19  ),GZL ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL JIOXXX(W(1,30  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,31  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,31  ),GWF ,AMP(8   ))            
      CALL JVVXXX(W(1,8   ),W(1,22  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     32  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GWF ,AMP(9   ))            
      CALL JVVXXX(W(1,8   ),W(1,15  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     33  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GWF ,AMP(10  ))            
      CALL JVVXXX(W(1,8   ),W(1,27  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     34  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GWF ,AMP(11  ))            
      CALL JVVXXX(W(1,8   ),W(1,19  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     35  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GWF ,AMP(12  ))            
      CALL JIOXXX(W(1,18  ),W(1,12  ),GWF ,WMASS   ,WWIDTH  ,W(1,36  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GWF ,AMP(13  ))            
      CALL FVOXXX(W(1,5   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,15  ),GZN ,AMP(14  ))            
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,19  ),GZN ,AMP(15  ))            
      CALL FVOXXX(W(1,5   ),W(1,22  ),GAL ,ZERO    ,ZERO    ,W(1,38  ))    
      CALL IOVXXX(W(1,6   ),W(1,38  ),W(1,8   ),GWF ,AMP(16  ))            
      CALL FVOXXX(W(1,5   ),W(1,15  ),GZL ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,8   ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,5   ),W(1,27  ),GAL ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,8   ),GWF ,AMP(18  ))            
      CALL FVOXXX(W(1,5   ),W(1,19  ),GZL ,ZERO    ,ZERO    ,W(1,41  ))    
