      SUBROUTINE SREALMTRX_075(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ c -> e+ ve mu- vm~ s s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_075/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_075(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_075(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,14  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,15  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(2   ))            
      CALL FVIXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,17  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GWF ,AMP(3   ))            
      CALL JIOXXX(W(1,2   ),W(1,12  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,19  ))    
      ...
      CALL JIOXXX(W(1,14  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,22  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,12  ),GAU ,ZERO    ,AWIDTH  ,W(1,34  ))    
      ...
      CALL JIOXXX(W(1,14  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,39  ))    
     ...
     &     63  ))                                                          
      ...
      CALL JIOXXX(W(1,2   ),W(1,64  ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      ...
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
     ...
     &             -AMP(  36)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_075 =REALMTRX_075+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
