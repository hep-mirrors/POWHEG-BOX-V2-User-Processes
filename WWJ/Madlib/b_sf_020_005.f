...
C  
C BORN AMPLITUDE IS g u -> e+ ve mu- vm~ u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      ...
      CALL FVIXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,14  ))    
      CALL FVOXXX(W(1,4   ),W(1,14  ),GZN ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,3   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,17  ),W(1,7   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,18  ))    
      CALL FVOXXX(W(1,4   ),W(1,18  ),GZN ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL JIOXXX(W(1,3   ),W(1,19  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(4   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GAU ,ZERO    ,AWIDTH  ,W(1,21  ))    
      CALL FVIXXX(W(1,3   ),W(1,21  ),GAL ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL JIOXXX(W(1,22  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,23  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,23  ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,3   ),W(1,14  ),GZL ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL JIOXXX(W(1,24  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,25  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,25  ),GWF ,AMP(6   ))            
      CALL JIOXXX(W(1,17  ),W(1,7   ),GAU ,ZERO    ,AWIDTH  ,W(1,26  ))    
      CALL FVIXXX(W(1,3   ),W(1,26  ),GAL ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL JIOXXX(W(1,27  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,28  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GWF ,AMP(7   ))            
      CALL FVIXXX(W(1,3   ),W(1,18  ),GZL ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,29  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(8   ))            
      CALL JVVXXX(W(1,8   ),W(1,21  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     31  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,31  ),GWF ,AMP(9   ))            
      CALL JVVXXX(W(1,8   ),W(1,14  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     32  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GWF ,AMP(10  ))            
      CALL JVVXXX(W(1,8   ),W(1,26  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     33  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GWF ,AMP(11  ))            
      CALL JVVXXX(W(1,8   ),W(1,18  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     34  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GWF ,AMP(12  ))            
      CALL FVIXXX(W(1,17  ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL JIOXXX(W(1,35  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,36  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GWF ,AMP(13  ))            
      CALL FVOXXX(W(1,5   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,14  ),GZN ,AMP(14  ))            
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,18  ),GZN ,AMP(15  ))            
      CALL FVOXXX(W(1,5   ),W(1,21  ),GAL ,ZERO    ,ZERO    ,W(1,38  ))    
      CALL IOVXXX(W(1,6   ),W(1,38  ),W(1,8   ),GWF ,AMP(16  ))            
      CALL FVOXXX(W(1,5   ),W(1,14  ),GZL ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,8   ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,5   ),W(1,26  ),GAL ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,8   ),GWF ,AMP(18  ))            
      CALL FVOXXX(W(1,5   ),W(1,18  ),GZL ,ZERO    ,ZERO    ,W(1,41  ))    
