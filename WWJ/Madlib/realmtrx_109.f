      SUBROUTINE SREALMTRX_109(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_109/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_109(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_109(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,15  ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,14  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,2   ),W(1,17  ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GWF ,AMP(3   ))            
      CALL JIOXXX(W(1,2   ),W(1,11  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,19  ))    
      ...
      CALL JIOXXX(W(1,15  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,22  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,11  ),GAD ,ZERO    ,AWIDTH  ,W(1,34  ))    
      ...
      CALL JIOXXX(W(1,15  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,39  ))    
     ...
     &     63  ))                                                          
      ...
      CALL JIOXXX(W(1,60  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      ...
      CALL JIOXXX(W(1,8   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
     ...
     &             -AMP(  36)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_109 =REALMTRX_109+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
