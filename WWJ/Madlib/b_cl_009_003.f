...
C  
C BORN AMPLITUDE IS c~ c -> e+ ve mu- vm~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL VXXXXX(P(0,  7),ZERO,ihel,+1*IC(  7),W(1,  7))
      ...
      CALL JIOXXX(W(1,10  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVIXXX(W(1,12  ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL JIOXXX(W(1,13  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,14  ),GWF ,AMP(2   ))            
      CALL FVIXXX(W(1,10  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,15  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,17  ))    
      CALL FVOXXX(W(1,4   ),W(1,17  ),GZN ,ZERO    ,ZERO    ,W(1,18  ))    
      CALL JIOXXX(W(1,3   ),W(1,18  ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GWF ,AMP(4   ))            
      CALL JIOXXX(W(1,12  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,20  ))    
      CALL FVOXXX(W(1,4   ),W(1,20  ),GZN ,ZERO    ,ZERO    ,W(1,21  ))    
      CALL JIOXXX(W(1,3   ),W(1,21  ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GWF ,AMP(5   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GAU ,ZERO    ,AWIDTH  ,W(1,23  ))    
      CALL FVIXXX(W(1,3   ),W(1,23  ),GAL ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL JIOXXX(W(1,24  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,25  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,25  ),GWF ,AMP(6   ))            
      CALL FVIXXX(W(1,3   ),W(1,17  ),GZL ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL JIOXXX(W(1,26  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,27  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GWF ,AMP(7   ))            
      CALL JIOXXX(W(1,12  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,28  ))    
      CALL FVIXXX(W(1,3   ),W(1,28  ),GAL ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,29  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(8   ))            
      CALL FVIXXX(W(1,3   ),W(1,20  ),GZL ,ZERO    ,ZERO    ,W(1,31  ))    
      CALL JIOXXX(W(1,31  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,32  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GWF ,AMP(9   ))            
      CALL JVVXXX(W(1,8   ),W(1,23  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     33  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GWF ,AMP(10  ))            
      CALL JVVXXX(W(1,8   ),W(1,17  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     34  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GWF ,AMP(11  ))            
      CALL JVVXXX(W(1,8   ),W(1,28  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     35  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GWF ,AMP(12  ))            
      CALL JVVXXX(W(1,8   ),W(1,20  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     36  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GWF ,AMP(13  ))            
      CALL FVOXXX(W(1,5   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,17  ),GZN ,AMP(14  ))            
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,20  ),GZN ,AMP(15  ))            
      CALL FVOXXX(W(1,5   ),W(1,23  ),GAL ,ZERO    ,ZERO    ,W(1,38  ))    
      CALL IOVXXX(W(1,6   ),W(1,38  ),W(1,8   ),GWF ,AMP(16  ))            
      CALL FVOXXX(W(1,5   ),W(1,17  ),GZL ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,8   ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,5   ),W(1,28  ),GAL ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,8   ),GWF ,AMP(18  ))            
      CALL FVOXXX(W(1,5   ),W(1,20  ),GZL ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL IOVXXX(W(1,6   ),W(1,41  ),W(1,8   ),GWF ,AMP(19  ))            
      do i=1,ngraphs
         if(ihel.eq.-1)then
