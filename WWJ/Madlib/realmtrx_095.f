      SUBROUTINE SREALMTRX_095(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_095/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_095(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_095(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      ...
      CALL JIOXXX(W(1,2   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,18  ))    
      CALL FVOXXX(W(1,7   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,18  ),W(1,19  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,18  ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JIOXXX(W(1,21  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,8   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,24  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,14  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,27  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,19  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,30  ))    
      ...
      CALL FVIXXX(W(1,1   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      ...
      CALL JIOXXX(W(1,23  ),W(1,8   ),GAD ,ZERO    ,AWIDTH  ,W(1,37  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,14  ),GAD ,ZERO    ,AWIDTH  ,W(1,42  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,19  ),GAU ,ZERO    ,AWIDTH  ,W(1,47  ))    
     ...
     &     58  ))                                                          
      ...
      CALL JIOXXX(W(1,23  ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,59  ))    
     ...
     &     65  ))                                                          
      ...
      CALL JIOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL FVOXXX(W(1,7   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL JIOXXX(W(1,2   ),W(1,78  ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL JIOXXX(W(1,18  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL FVOXXX(W(1,7   ),W(1,80  ),GG ,ZERO    ,ZERO    ,W(1,81  ))     
      CALL JIOXXX(W(1,2   ),W(1,81  ),GWF ,WMASS   ,WWIDTH  ,W(1,82  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,82  ),GWF ,AMP(40  ))            
      CALL FVIXXX(W(1,2   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL JIOXXX(W(1,83  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,84  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,84  ),GWF ,AMP(41  ))            
      CALL FVIXXX(W(1,2   ),W(1,80  ),GG ,ZERO    ,ZERO    ,W(1,85  ))     
     ...
     &             +AMP(  36)+AMP(  37)+AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_095 =REALMTRX_095+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
