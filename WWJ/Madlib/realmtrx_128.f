      SUBROUTINE SREALMTRX_128(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_128/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_128(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_128(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,10  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,20  ),GWF ,WMASS   ,WWIDTH  ,W(1,21  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,12  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      ...
      CALL JIOXXX(W(1,1   ),W(1,25  ),GWF ,WMASS   ,WWIDTH  ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL FVOXXX(W(1,27  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL JIOXXX(W(1,11  ),W(1,28  ),GWF ,WMASS   ,WWIDTH  ,W(1,29  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,29  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,27  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL JIOXXX(W(1,1   ),W(1,30  ),GWF ,WMASS   ,WWIDTH  ,W(1,31  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,31  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,18  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,32  ))    
      ...
      CALL FVOXXX(W(1,27  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL FVOXXX(W(1,35  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,1   ),W(1,36  ),GWF ,WMASS   ,WWIDTH  ,W(1,37  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GWF ,AMP(9   ))            
      CALL FVOXXX(W(1,28  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL JIOXXX(W(1,1   ),W(1,38  ),GWF ,WMASS   ,WWIDTH  ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GWF ,AMP(10  ))            
      CALL JIOXXX(W(1,11  ),W(1,10  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,40  ))    
      CALL FVOXXX(W(1,4   ),W(1,40  ),GZN ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,3   ),W(1,41  ),GWF ,WMASS   ,WWIDTH  ,W(1,42  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GWF ,AMP(11  ))            
      CALL JIOXXX(W(1,1   ),W(1,15  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,43  ))    
      CALL FVOXXX(W(1,4   ),W(1,43  ),GZN ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL JIOXXX(W(1,3   ),W(1,44  ),GWF ,WMASS   ,WWIDTH  ,W(1,45  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,45  ),GWF ,AMP(12  ))            
      CALL JIOXXX(W(1,1   ),W(1,19  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,46  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,24  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,49  ))    
      CALL FVOXXX(W(1,4   ),W(1,49  ),GZN ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL JIOXXX(W(1,3   ),W(1,50  ),GWF ,WMASS   ,WWIDTH  ,W(1,51  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GWF ,AMP(14  ))            
      CALL FVIXXX(W(1,11  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,52  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,53  ))    
      CALL FVOXXX(W(1,4   ),W(1,53  ),GZN ,ZERO    ,ZERO    ,W(1,54  ))    
      CALL JIOXXX(W(1,3   ),W(1,54  ),GWF ,WMASS   ,WWIDTH  ,W(1,55  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GWF ,AMP(15  ))            
      CALL FVIXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,57  ))    
      CALL FVOXXX(W(1,4   ),W(1,57  ),GZN ,ZERO    ,ZERO    ,W(1,58  ))    
      CALL JIOXXX(W(1,3   ),W(1,58  ),GWF ,WMASS   ,WWIDTH  ,W(1,59  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GWF ,AMP(16  ))            
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL JIOXXX(W(1,60  ),W(1,18  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,61  ))    
      CALL FVOXXX(W(1,4   ),W(1,61  ),GZN ,ZERO    ,ZERO    ,W(1,62  ))    
      CALL JIOXXX(W(1,3   ),W(1,62  ),GWF ,WMASS   ,WWIDTH  ,W(1,63  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GWF ,AMP(17  ))            
      CALL FVIXXX(W(1,60  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL JIOXXX(W(1,64  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,65  ))    
      CALL FVOXXX(W(1,4   ),W(1,65  ),GZN ,ZERO    ,ZERO    ,W(1,66  ))    
      CALL JIOXXX(W(1,3   ),W(1,66  ),GWF ,WMASS   ,WWIDTH  ,W(1,67  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,67  ),GWF ,AMP(18  ))            
      CALL JIOXXX(W(1,11  ),W(1,10  ),GAD ,ZERO    ,AWIDTH  ,W(1,68  ))    
      CALL FVIXXX(W(1,3   ),W(1,68  ),GAL ,ZERO    ,ZERO    ,W(1,69  ))    
      CALL JIOXXX(W(1,69  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,70  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,70  ),GWF ,AMP(19  ))            
      CALL FVIXXX(W(1,3   ),W(1,40  ),GZL ,ZERO    ,ZERO    ,W(1,71  ))    
      CALL JIOXXX(W(1,71  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,72  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,72  ),GWF ,AMP(20  ))            
      CALL JIOXXX(W(1,1   ),W(1,15  ),GAD ,ZERO    ,AWIDTH  ,W(1,73  ))    
      CALL FVIXXX(W(1,3   ),W(1,73  ),GAL ,ZERO    ,ZERO    ,W(1,74  ))    
      CALL JIOXXX(W(1,74  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,75  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,75  ),GWF ,AMP(21  ))            
      CALL FVIXXX(W(1,3   ),W(1,43  ),GZL ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL JIOXXX(W(1,76  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,77  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,77  ),GWF ,AMP(22  ))            
      CALL JIOXXX(W(1,1   ),W(1,19  ),GAD ,ZERO    ,AWIDTH  ,W(1,78  ))    
      CALL FVIXXX(W(1,3   ),W(1,78  ),GAL ,ZERO    ,ZERO    ,W(1,79  ))    
      CALL JIOXXX(W(1,79  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,80  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,80  ),GWF ,AMP(23  ))            
      CALL FVIXXX(W(1,3   ),W(1,46  ),GZL ,ZERO    ,ZERO    ,W(1,81  ))    
      CALL JIOXXX(W(1,81  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,82  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,82  ),GWF ,AMP(24  ))            
      CALL JIOXXX(W(1,1   ),W(1,24  ),GAD ,ZERO    ,AWIDTH  ,W(1,83  ))    
      CALL FVIXXX(W(1,3   ),W(1,83  ),GAL ,ZERO    ,ZERO    ,W(1,84  ))    
      CALL JIOXXX(W(1,84  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,85  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,85  ),GWF ,AMP(25  ))            
      CALL FVIXXX(W(1,3   ),W(1,49  ),GZL ,ZERO    ,ZERO    ,W(1,86  ))    
      CALL JIOXXX(W(1,86  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,87  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,87  ),GWF ,AMP(26  ))            
      CALL JIOXXX(W(1,52  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,88  ))    
      CALL FVIXXX(W(1,3   ),W(1,88  ),GAL ,ZERO    ,ZERO    ,W(1,89  ))    
      CALL JIOXXX(W(1,89  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,90  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,90  ),GWF ,AMP(27  ))            
      CALL FVIXXX(W(1,3   ),W(1,53  ),GZL ,ZERO    ,ZERO    ,W(1,91  ))    
      CALL JIOXXX(W(1,91  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,92  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,92  ),GWF ,AMP(28  ))            
      CALL JIOXXX(W(1,56  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,93  ))    
      CALL FVIXXX(W(1,3   ),W(1,93  ),GAL ,ZERO    ,ZERO    ,W(1,94  ))    
      CALL JIOXXX(W(1,94  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,95  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,95  ),GWF ,AMP(29  ))            
      CALL FVIXXX(W(1,3   ),W(1,57  ),GZL ,ZERO    ,ZERO    ,W(1,96  ))    
      CALL JIOXXX(W(1,96  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,97  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,97  ),GWF ,AMP(30  ))            
      CALL JIOXXX(W(1,60  ),W(1,18  ),GAD ,ZERO    ,AWIDTH  ,W(1,98  ))    
      CALL FVIXXX(W(1,3   ),W(1,98  ),GAL ,ZERO    ,ZERO    ,W(1,99  ))    
      CALL JIOXXX(W(1,99  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,100 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,100 ),GWF ,AMP(31  ))            
      CALL FVIXXX(W(1,3   ),W(1,61  ),GZL ,ZERO    ,ZERO    ,W(1,101 ))    
      CALL JIOXXX(W(1,101 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,102 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,102 ),GWF ,AMP(32  ))            
      CALL JIOXXX(W(1,64  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,103 ))    
      CALL FVIXXX(W(1,3   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,104 ))    
      CALL JIOXXX(W(1,104 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,105 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,105 ),GWF ,AMP(33  ))            
      CALL FVIXXX(W(1,3   ),W(1,65  ),GZL ,ZERO    ,ZERO    ,W(1,106 ))    
      CALL JIOXXX(W(1,106 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,107 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,107 ),GWF ,AMP(34  ))            
      CALL JVVXXX(W(1,9   ),W(1,68  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     108 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,108 ),GWF ,AMP(35  ))            
      CALL JVVXXX(W(1,9   ),W(1,40  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     109 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,109 ),GWF ,AMP(36  ))            
      CALL JVVXXX(W(1,9   ),W(1,73  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     110 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,110 ),GWF ,AMP(37  ))            
      CALL JVVXXX(W(1,9   ),W(1,43  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     111 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,111 ),GWF ,AMP(38  ))            
     ...
     &     116 ))                                                          
      ...
      CALL JVVXXX(W(1,9   ),W(1,53  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     117 ))                                                          
     ...
     &     118 ))                                                          
      ...
      CALL JVVXXX(W(1,9   ),W(1,57  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     119 ))                                                          
     ...
     &     122 ))                                                          
      ...
      CALL JVVXXX(W(1,9   ),W(1,65  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     123 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GWF ,AMP(50  ))            
      CALL JIOXXX(W(1,52  ),W(1,27  ),GWF ,WMASS   ,WWIDTH  ,W(1,124 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,124 ),GWF ,AMP(51  ))            
      CALL JIOXXX(W(1,56  ),W(1,27  ),GWF ,WMASS   ,WWIDTH  ,W(1,125 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,125 ),GWF ,AMP(52  ))            
      CALL JIOXXX(W(1,60  ),W(1,32  ),GWF ,WMASS   ,WWIDTH  ,W(1,126 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,126 ),GWF ,AMP(53  ))            
      CALL JIOXXX(W(1,64  ),W(1,27  ),GWF ,WMASS   ,WWIDTH  ,W(1,127 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,127 ),GWF ,AMP(54  ))            
      CALL JIOXXX(W(1,60  ),W(1,35  ),GWF ,WMASS   ,WWIDTH  ,W(1,128 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,128 ),GWF ,AMP(55  ))            
      CALL FVOXXX(W(1,5   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,129 ))    
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,40  ),GZN ,AMP(56  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,43  ),GZN ,AMP(57  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,46  ),GZN ,AMP(58  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,49  ),GZN ,AMP(59  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,53  ),GZN ,AMP(60  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,57  ),GZN ,AMP(61  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,61  ),GZN ,AMP(62  ))            
      CALL IOVXXX(W(1,6   ),W(1,129 ),W(1,65  ),GZN ,AMP(63  ))            
      CALL FVOXXX(W(1,5   ),W(1,68  ),GAL ,ZERO    ,ZERO    ,W(1,130 ))    
      CALL IOVXXX(W(1,6   ),W(1,130 ),W(1,9   ),GWF ,AMP(64  ))            
      CALL FVOXXX(W(1,5   ),W(1,40  ),GZL ,ZERO    ,ZERO    ,W(1,131 ))    
      CALL IOVXXX(W(1,6   ),W(1,131 ),W(1,9   ),GWF ,AMP(65  ))            
      CALL FVOXXX(W(1,5   ),W(1,73  ),GAL ,ZERO    ,ZERO    ,W(1,132 ))    
      CALL IOVXXX(W(1,6   ),W(1,132 ),W(1,9   ),GWF ,AMP(66  ))            
      CALL FVOXXX(W(1,5   ),W(1,43  ),GZL ,ZERO    ,ZERO    ,W(1,133 ))    
      CALL IOVXXX(W(1,6   ),W(1,133 ),W(1,9   ),GWF ,AMP(67  ))            
      CALL FVOXXX(W(1,5   ),W(1,78  ),GAL ,ZERO    ,ZERO    ,W(1,134 ))    
      CALL IOVXXX(W(1,6   ),W(1,134 ),W(1,9   ),GWF ,AMP(68  ))            
      CALL FVOXXX(W(1,5   ),W(1,46  ),GZL ,ZERO    ,ZERO    ,W(1,135 ))    
      CALL IOVXXX(W(1,6   ),W(1,135 ),W(1,9   ),GWF ,AMP(69  ))            
      CALL FVOXXX(W(1,5   ),W(1,83  ),GAL ,ZERO    ,ZERO    ,W(1,136 ))    
      CALL IOVXXX(W(1,6   ),W(1,136 ),W(1,9   ),GWF ,AMP(70  ))            
      CALL FVOXXX(W(1,5   ),W(1,49  ),GZL ,ZERO    ,ZERO    ,W(1,137 ))    
      CALL IOVXXX(W(1,6   ),W(1,137 ),W(1,9   ),GWF ,AMP(71  ))            
      CALL FVOXXX(W(1,5   ),W(1,88  ),GAL ,ZERO    ,ZERO    ,W(1,138 ))    
      CALL IOVXXX(W(1,6   ),W(1,138 ),W(1,9   ),GWF ,AMP(72  ))            
      CALL FVOXXX(W(1,5   ),W(1,53  ),GZL ,ZERO    ,ZERO    ,W(1,139 ))    
      CALL IOVXXX(W(1,6   ),W(1,139 ),W(1,9   ),GWF ,AMP(73  ))            
      CALL FVOXXX(W(1,5   ),W(1,93  ),GAL ,ZERO    ,ZERO    ,W(1,140 ))    
      CALL IOVXXX(W(1,6   ),W(1,140 ),W(1,9   ),GWF ,AMP(74  ))            
      CALL FVOXXX(W(1,5   ),W(1,57  ),GZL ,ZERO    ,ZERO    ,W(1,141 ))    
      CALL IOVXXX(W(1,6   ),W(1,141 ),W(1,9   ),GWF ,AMP(75  ))            
      CALL FVOXXX(W(1,5   ),W(1,98  ),GAL ,ZERO    ,ZERO    ,W(1,142 ))    
      CALL IOVXXX(W(1,6   ),W(1,142 ),W(1,9   ),GWF ,AMP(76  ))            
      CALL FVOXXX(W(1,5   ),W(1,61  ),GZL ,ZERO    ,ZERO    ,W(1,143 ))    
      CALL IOVXXX(W(1,6   ),W(1,143 ),W(1,9   ),GWF ,AMP(77  ))            
      CALL FVOXXX(W(1,5   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,144 ))    
      CALL IOVXXX(W(1,6   ),W(1,144 ),W(1,9   ),GWF ,AMP(78  ))            
      CALL FVOXXX(W(1,5   ),W(1,65  ),GZL ,ZERO    ,ZERO    ,W(1,145 ))    
      CALL IOVXXX(W(1,6   ),W(1,145 ),W(1,9   ),GWF ,AMP(79  ))            
      JAMP(   1) = -AMP(   1)+AMP(   2)-AMP(   4)-AMP(   5)-AMP(   6)
     &             +AMP(   7)-AMP(  10)-AMP(  11)+AMP(  12)-AMP(  14)
     ...
     &             -AMP(  76)-AMP(  77)-AMP(  78)-AMP(  79)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_128 =REALMTRX_128+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
