      SUBROUTINE SREALMTRX_008(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_008/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_008(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_008(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,17  ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,17  ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,7   ),W(1,20  ),GWF ,WMASS   ,WWIDTH  ,W(1,21  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL JIOXXX(W(1,22  ),W(1,8   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,23  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,14  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,26  ))    
      ...
      CALL JIOXXX(W(1,18  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,29  ))    
      ...
      CALL FVOXXX(W(1,1   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      ...
      CALL JIOXXX(W(1,22  ),W(1,8   ),GAU ,ZERO    ,AWIDTH  ,W(1,36  ))    
      ...
      CALL FVIXXX(W(1,3   ),W(1,23  ),GZL ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL JIOXXX(W(1,39  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,40  ),GWF ,AMP(10  ))            
      CALL JIOXXX(W(1,2   ),W(1,14  ),GAU ,ZERO    ,AWIDTH  ,W(1,41  ))    
      ...
      CALL JIOXXX(W(1,18  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,46  ))    
     ...
     &     57  ))                                                          
      ...
      CALL FVIXXX(W(1,22  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,58  ))    
      CALL JIOXXX(W(1,58  ),W(1,8   ),GWF ,WMASS   ,WWIDTH  ,W(1,59  ))    
     ...
     &     65  ))                                                          
      ...
      CALL JIOXXX(W(1,7   ),W(1,78  ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL FVIXXX(W(1,7   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL JIOXXX(W(1,80  ),W(1,8   ),GWF ,WMASS   ,WWIDTH  ,W(1,81  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,81  ),GWF ,AMP(40  ))            
      CALL JIOXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL FVOXXX(W(1,8   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL JIOXXX(W(1,7   ),W(1,83  ),GWF ,WMASS   ,WWIDTH  ,W(1,84  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,84  ),GWF ,AMP(41  ))            
      CALL FVIXXX(W(1,7   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,85  ))     
     ...
     &             -AMP(  36)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_008 =REALMTRX_008+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
