...
C  
C FOR PROCESS : u~ c -> e+ ve mu- vm~ d~ s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,2   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL JIOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVIXXX(W(1,7   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
