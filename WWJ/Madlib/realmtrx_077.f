      SUBROUTINE SREALMTRX_077(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ s~ -> e+ ve mu- vm~ c~ s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_077/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_077(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_077(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NGRAPHS=  42,NEIGEN=  2) 
      include "nexternal.inc"
      INTEGER    NWAVEFUNCS     , NCOLOR
      PARAMETER (NWAVEFUNCS=  86, NCOLOR=   2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C ----------
      ...
      CALL JIOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL FVOXXX(W(1,2   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL FVOXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,8   ),W(1,12  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,8   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL JIOXXX(W(1,14  ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,15  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,15  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL FVIXXX(W(1,7   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVIXXX(W(1,17  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,18  ))    
      CALL JIOXXX(W(1,18  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL FVIXXX(W(1,20  ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JIOXXX(W(1,21  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,8   ),W(1,23  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,24  ))    
      CALL FVOXXX(W(1,4   ),W(1,24  ),GZN ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL JIOXXX(W(1,3   ),W(1,25  ),GWF ,WMASS   ,WWIDTH  ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GWF ,AMP(5   ))            
      CALL JIOXXX(W(1,14  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,27  ))    
      ...
      CALL JIOXXX(W(1,17  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,30  ))    
      ...
      CALL FVOXXX(W(1,1   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,7   ),W(1,33  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,34  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,23  ),GAD ,ZERO    ,AWIDTH  ,W(1,37  ))    
      ...
      CALL FVIXXX(W(1,3   ),W(1,24  ),GZL ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL JIOXXX(W(1,40  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,41  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,41  ),GWF ,AMP(10  ))            
      CALL JIOXXX(W(1,14  ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,42  ))    
      ...
      CALL JIOXXX(W(1,17  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,47  ))    
      ...
      CALL JIOXXX(W(1,7   ),W(1,33  ),GAU ,ZERO    ,AWIDTH  ,W(1,52  ))    
     ...
     &     57  ))                                                          
      ...
      CALL JVVXXX(W(1,9   ),W(1,24  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     58  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GWF ,AMP(18  ))            
      CALL FVOXXX(W(1,23  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,8   ),W(1,59  ),GWF ,WMASS   ,WWIDTH  ,W(1,60  ))    
     ...
     &     66  ))                                                          
      ...
      CALL JIOXXX(W(1,20  ),W(1,33  ),GWF ,WMASS   ,WWIDTH  ,W(1,67  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,67  ),GWF ,AMP(26  ))            
      CALL FVOXXX(W(1,5   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,68  ))    
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,24  ),GZN ,AMP(27  ))            
      ...
      CALL FVOXXX(W(1,5   ),W(1,24  ),GZL ,ZERO    ,ZERO    ,W(1,70  ))    
      ...
      CALL JIOXXX(W(1,20  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL FVIXXX(W(1,8   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL JIOXXX(W(1,78  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL FVOXXX(W(1,1   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL JIOXXX(W(1,8   ),W(1,80  ),GWF ,WMASS   ,WWIDTH  ,W(1,81  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,81  ),GWF ,AMP(40  ))            
      CALL JIOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL FVOXXX(W(1,1   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL JIOXXX(W(1,8   ),W(1,83  ),GWF ,WMASS   ,WWIDTH  ,W(1,84  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,84  ),GWF ,AMP(41  ))            
      CALL FVIXXX(W(1,8   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,85  ))     
      CALL JIOXXX(W(1,85  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,86  ))    
     ...
     &             +AMP(  36)+AMP(  37)+AMP(  38)
      JAMP(   2) = -AMP(  39)-AMP(  40)-AMP(  41)-AMP(  42)
      REALMTRX_077 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_077 =REALMTRX_077+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
