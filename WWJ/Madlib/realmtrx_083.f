...
C  
C FOR PROCESS : c d -> e+ ve mu- vm~ u s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
      ...
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      ...
      CALL FVOXXX(W(1,7   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL JIOXXX(W(1,2   ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,17  ),GWF ,AMP(2   ))            
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
