      SUBROUTINE SREALMTRX_137(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> e+ ve mu- vm~ d d~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_137/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_137(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_137(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,8   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      ...
      CALL FVOXXX(W(1,12  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL JIOXXX(W(1,8   ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,15  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,15  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL FVOXXX(W(1,16  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,11  ),W(1,17  ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,8   ),W(1,19  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVIXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL FVOXXX(W(1,21  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL JIOXXX(W(1,22  ),W(1,23  ),GWF ,WMASS   ,WWIDTH  ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,23  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,8   ),W(1,25  ),GWF ,WMASS   ,WWIDTH  ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,22  ),W(1,27  ),GWF ,WMASS   ,WWIDTH  ,W(1,28  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,27  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,8   ),W(1,29  ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(8   ))            
      CALL JIOXXX(W(1,22  ),W(1,21  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
      ...
      CALL FVOXXX(W(1,21  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JIOXXX(W(1,8   ),W(1,34  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      ...
      CALL JIOXXX(W(1,11  ),W(1,10  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,38  ))    
      ...
      CALL FVOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,8   ),W(1,41  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,42  ))    
      ...
      CALL FVIXXX(W(1,11  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,45  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,46  ))    
      ...
      CALL FVIXXX(W(1,22  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,49  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,50  ))    
      ...
      CALL JIOXXX(W(1,54  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,55  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,58  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,59  ))    
      ...
      CALL JIOXXX(W(1,22  ),W(1,21  ),GAD ,ZERO    ,AWIDTH  ,W(1,62  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,34  ),GAD ,ZERO    ,AWIDTH  ,W(1,67  ))    
      ...
      CALL JIOXXX(W(1,11  ),W(1,10  ),GAD ,ZERO    ,AWIDTH  ,W(1,72  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,41  ),GAD ,ZERO    ,AWIDTH  ,W(1,77  ))    
      ...
      CALL JIOXXX(W(1,45  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,82  ))    
      ...
      CALL JIOXXX(W(1,49  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,87  ))    
      ...
      CALL JIOXXX(W(1,54  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,92  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,58  ),GAD ,ZERO    ,AWIDTH  ,W(1,97  ))    
     ...
     &     105 ))                                                          
      ...
      CALL FVOXXX(W(1,34  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,106 ))    
      CALL JIOXXX(W(1,8   ),W(1,106 ),GWF ,WMASS   ,WWIDTH  ,W(1,107 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,107 ),GWF ,AMP(37  ))            
      CALL JVVXXX(W(1,9   ),W(1,72  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     108 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,108 ),GWF ,AMP(38  ))            
      CALL JVVXXX(W(1,9   ),W(1,38  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     109 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,109 ),GWF ,AMP(39  ))            
      CALL JVVXXX(W(1,9   ),W(1,77  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     110 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,110 ),GWF ,AMP(40  ))            
      CALL JVVXXX(W(1,9   ),W(1,42  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     111 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,111 ),GWF ,AMP(41  ))            
      CALL FVOXXX(W(1,41  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,112 ))    
      CALL JIOXXX(W(1,8   ),W(1,112 ),GWF ,WMASS   ,WWIDTH  ,W(1,113 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,113 ),GWF ,AMP(42  ))            
      CALL JVVXXX(W(1,9   ),W(1,82  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     114 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,114 ),GWF ,AMP(43  ))            
      CALL JVVXXX(W(1,9   ),W(1,46  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     115 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,115 ),GWF ,AMP(44  ))            
      CALL JVVXXX(W(1,9   ),W(1,87  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     116 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,116 ),GWF ,AMP(45  ))            
      CALL JVVXXX(W(1,9   ),W(1,50  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     117 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,117 ),GWF ,AMP(46  ))            
      CALL JVVXXX(W(1,9   ),W(1,92  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     118 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,118 ),GWF ,AMP(47  ))            
      CALL JVVXXX(W(1,9   ),W(1,55  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     119 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,119 ),GWF ,AMP(48  ))            
      CALL FVOXXX(W(1,58  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,120 ))    
      CALL JIOXXX(W(1,8   ),W(1,120 ),GWF ,WMASS   ,WWIDTH  ,W(1,121 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,121 ),GWF ,AMP(49  ))            
      CALL JVVXXX(W(1,9   ),W(1,97  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     122 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,122 ),GWF ,AMP(50  ))            
      CALL JVVXXX(W(1,9   ),W(1,59  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     123 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GWF ,AMP(51  ))            
      CALL JIOXXX(W(1,45  ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,124 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,124 ),GWF ,AMP(52  ))            
      CALL JIOXXX(W(1,49  ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,125 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,125 ),GWF ,AMP(53  ))            
      CALL JIOXXX(W(1,54  ),W(1,16  ),GWF ,WMASS   ,WWIDTH  ,W(1,126 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,126 ),GWF ,AMP(54  ))            
      CALL FVOXXX(W(1,16  ),W(1,53  ),GG ,ZERO    ,ZERO    ,W(1,127 ))     
      CALL JIOXXX(W(1,8   ),W(1,127 ),GWF ,WMASS   ,WWIDTH  ,W(1,128 ))    
     ...
     &             +AMP(  76)+AMP(  77)+AMP(  78)+AMP(  79)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_137 =REALMTRX_137+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
