      SUBROUTINE SREALMTRX_121(P1,ANS)
C  
...
C  
C FOR PROCESS : s c -> e+ ve mu- vm~ c s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_121/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_121(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_121(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      ...
      CALL FVOXXX(W(1,18  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL JIOXXX(W(1,26  ),W(1,8   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,27  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,18  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,30  ))    
      ...
      CALL JIOXXX(W(1,26  ),W(1,8   ),GAD ,ZERO    ,AWIDTH  ,W(1,42  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,18  ),GAD ,ZERO    ,AWIDTH  ,W(1,47  ))    
     ...
     &     60  ))                                                          
      ...
      CALL JIOXXX(W(1,26  ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,61  ))    
     ...
     &     65  ))                                                          
      ...
      CALL JIOXXX(W(1,2   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      ...
      CALL JIOXXX(W(1,11  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
     ...
     &             -AMP(  36)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_121 =REALMTRX_121+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
