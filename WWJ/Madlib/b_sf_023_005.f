...
C  
C BORN AMPLITUDE IS g s~ -> e+ ve mu- vm~ s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL FVOXXX(W(1,2   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,9   ),W(1,10  ),GWF ,WMASS   ,WWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GWF ,AMP(1   ))            
      CALL FVOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,7   ),W(1,12  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,9   ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,14  ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,7   ),W(1,17  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,18  ))    
      ...
      CALL JIOXXX(W(1,9   ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,21  ))    
      ...
      CALL JIOXXX(W(1,7   ),W(1,17  ),GAD ,ZERO    ,AWIDTH  ,W(1,26  ))    
     ...
     &     34  ))                                                          
      ...
      CALL FVOXXX(W(1,17  ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL JIOXXX(W(1,7   ),W(1,35  ),GWF ,WMASS   ,WWIDTH  ,W(1,36  ))    
