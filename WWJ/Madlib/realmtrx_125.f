...
C  
C FOR PROCESS : s s~ -> e+ ve mu- vm~ s s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      PARAMETER (NGRAPHS=  76,NEIGEN=  2) 
      include "nexternal.inc"
      INTEGER    NWAVEFUNCS     , NCOLOR
      PARAMETER (NWAVEFUNCS= 140, NCOLOR=   2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C ----------
      ...
      CALL JIOXXX(W(1,8   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL FVOXXX(W(1,2   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL FVIXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GWF ,AMP(1   ))            
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,1   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,1   ),W(1,17  ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GWF ,AMP(3   ))            
      CALL JIOXXX(W(1,12  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,19  ))    
      CALL FVOXXX(W(1,4   ),W(1,19  ),GZN ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL JIOXXX(W(1,3   ),W(1,20  ),GWF ,WMASS   ,WWIDTH  ,W(1,21  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GWF ,AMP(4   ))            
      CALL JIOXXX(W(1,1   ),W(1,14  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,22  ))    
      CALL FVOXXX(W(1,4   ),W(1,22  ),GZN ,ZERO    ,ZERO    ,W(1,23  ))    
      ...
      CALL FVIXXX(W(1,8   ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,26  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,27  ))    
      CALL FVOXXX(W(1,4   ),W(1,27  ),GZN ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL JIOXXX(W(1,3   ),W(1,28  ),GWF ,WMASS   ,WWIDTH  ,W(1,29  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,29  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,7   ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL JIOXXX(W(1,8   ),W(1,30  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
      CALL FVOXXX(W(1,4   ),W(1,31  ),GZN ,ZERO    ,ZERO    ,W(1,32  ))    
      CALL JIOXXX(W(1,3   ),W(1,32  ),GWF ,WMASS   ,WWIDTH  ,W(1,33  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GWF ,AMP(7   ))            
      CALL JIOXXX(W(1,12  ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,34  ))    
      CALL FVIXXX(W(1,3   ),W(1,34  ),GAL ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL JIOXXX(W(1,35  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,36  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GWF ,AMP(8   ))            
      CALL FVIXXX(W(1,3   ),W(1,19  ),GZL ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL JIOXXX(W(1,37  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,38  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,38  ),GWF ,AMP(9   ))            
      CALL JIOXXX(W(1,1   ),W(1,14  ),GAD ,ZERO    ,AWIDTH  ,W(1,39  ))    
      CALL FVIXXX(W(1,3   ),W(1,39  ),GAL ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL JIOXXX(W(1,40  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,41  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,41  ),GWF ,AMP(10  ))            
      CALL FVIXXX(W(1,3   ),W(1,22  ),GZL ,ZERO    ,ZERO    ,W(1,42  ))    
      CALL JIOXXX(W(1,42  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,43  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GWF ,AMP(11  ))            
      CALL JIOXXX(W(1,26  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,44  ))    
      CALL FVIXXX(W(1,3   ),W(1,44  ),GAL ,ZERO    ,ZERO    ,W(1,45  ))    
      CALL JIOXXX(W(1,45  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,46  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GWF ,AMP(12  ))            
      CALL FVIXXX(W(1,3   ),W(1,27  ),GZL ,ZERO    ,ZERO    ,W(1,47  ))    
      CALL JIOXXX(W(1,47  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,48  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GWF ,AMP(13  ))            
      CALL JIOXXX(W(1,8   ),W(1,30  ),GAD ,ZERO    ,AWIDTH  ,W(1,49  ))    
      CALL FVIXXX(W(1,3   ),W(1,49  ),GAL ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL JIOXXX(W(1,50  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,51  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GWF ,AMP(14  ))            
      CALL FVIXXX(W(1,3   ),W(1,31  ),GZL ,ZERO    ,ZERO    ,W(1,52  ))    
      CALL JIOXXX(W(1,52  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,53  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,53  ),GWF ,AMP(15  ))            
      CALL JVVXXX(W(1,9   ),W(1,34  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     54  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GWF ,AMP(16  ))            
      CALL JVVXXX(W(1,9   ),W(1,19  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     55  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GWF ,AMP(17  ))            
      CALL JVVXXX(W(1,9   ),W(1,39  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     56  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,56  ),GWF ,AMP(18  ))            
      CALL JVVXXX(W(1,9   ),W(1,22  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     57  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GWF ,AMP(19  ))            
      CALL JVVXXX(W(1,9   ),W(1,44  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     58  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GWF ,AMP(20  ))            
      CALL JVVXXX(W(1,9   ),W(1,27  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     59  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GWF ,AMP(21  ))            
      CALL FVOXXX(W(1,30  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,60  ))    
      CALL JIOXXX(W(1,8   ),W(1,60  ),GWF ,WMASS   ,WWIDTH  ,W(1,61  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GWF ,AMP(22  ))            
      CALL JVVXXX(W(1,9   ),W(1,49  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     62  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,62  ),GWF ,AMP(23  ))            
      CALL JVVXXX(W(1,9   ),W(1,31  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     63  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GWF ,AMP(24  ))            
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,64  ))    
      CALL JIOXXX(W(1,26  ),W(1,64  ),GWF ,WMASS   ,WWIDTH  ,W(1,65  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,65  ),GWF ,AMP(25  ))            
      CALL FVOXXX(W(1,64  ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL JIOXXX(W(1,8   ),W(1,66  ),GWF ,WMASS   ,WWIDTH  ,W(1,67  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,67  ),GWF ,AMP(26  ))            
      CALL FVOXXX(W(1,5   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,68  ))    
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,19  ),GZN ,AMP(27  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,22  ),GZN ,AMP(28  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,27  ),GZN ,AMP(29  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,31  ),GZN ,AMP(30  ))            
      CALL FVOXXX(W(1,5   ),W(1,34  ),GAL ,ZERO    ,ZERO    ,W(1,69  ))    
      CALL IOVXXX(W(1,6   ),W(1,69  ),W(1,9   ),GWF ,AMP(31  ))            
      CALL FVOXXX(W(1,5   ),W(1,19  ),GZL ,ZERO    ,ZERO    ,W(1,70  ))    
      CALL IOVXXX(W(1,6   ),W(1,70  ),W(1,9   ),GWF ,AMP(32  ))            
      CALL FVOXXX(W(1,5   ),W(1,39  ),GAL ,ZERO    ,ZERO    ,W(1,71  ))    
      CALL IOVXXX(W(1,6   ),W(1,71  ),W(1,9   ),GWF ,AMP(33  ))            
      CALL FVOXXX(W(1,5   ),W(1,22  ),GZL ,ZERO    ,ZERO    ,W(1,72  ))    
      CALL IOVXXX(W(1,6   ),W(1,72  ),W(1,9   ),GWF ,AMP(34  ))            
      CALL FVOXXX(W(1,5   ),W(1,44  ),GAL ,ZERO    ,ZERO    ,W(1,73  ))    
      CALL IOVXXX(W(1,6   ),W(1,73  ),W(1,9   ),GWF ,AMP(35  ))            
      CALL FVOXXX(W(1,5   ),W(1,27  ),GZL ,ZERO    ,ZERO    ,W(1,74  ))    
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,9   ),GWF ,AMP(36  ))            
      CALL FVOXXX(W(1,5   ),W(1,49  ),GAL ,ZERO    ,ZERO    ,W(1,75  ))    
      CALL IOVXXX(W(1,6   ),W(1,75  ),W(1,9   ),GWF ,AMP(37  ))            
      CALL FVOXXX(W(1,5   ),W(1,31  ),GZL ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL IOVXXX(W(1,6   ),W(1,76  ),W(1,9   ),GWF ,AMP(38  ))            
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL FVOXXX(W(1,11  ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL JIOXXX(W(1,8   ),W(1,78  ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL FVIXXX(W(1,8   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL JIOXXX(W(1,80  ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,81  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,81  ),GWF ,AMP(40  ))            
      CALL JIOXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL FVOXXX(W(1,7   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL FVOXXX(W(1,83  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,84  ))    
      CALL JIOXXX(W(1,1   ),W(1,84  ),GWF ,WMASS   ,WWIDTH  ,W(1,85  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,85  ),GWF ,AMP(41  ))            
      CALL FVOXXX(W(1,64  ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,86  ))     
      CALL JIOXXX(W(1,1   ),W(1,86  ),GWF ,WMASS   ,WWIDTH  ,W(1,87  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,87  ),GWF ,AMP(42  ))            
      CALL FVOXXX(W(1,2   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      CALL JIOXXX(W(1,8   ),W(1,88  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,89  ))    
      CALL FVOXXX(W(1,4   ),W(1,89  ),GZN ,ZERO    ,ZERO    ,W(1,90  ))    
      CALL JIOXXX(W(1,3   ),W(1,90  ),GWF ,WMASS   ,WWIDTH  ,W(1,91  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,91  ),GWF ,AMP(43  ))            
      CALL JIOXXX(W(1,80  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,92  ))    
      CALL FVOXXX(W(1,4   ),W(1,92  ),GZN ,ZERO    ,ZERO    ,W(1,93  ))    
      CALL JIOXXX(W(1,3   ),W(1,93  ),GWF ,WMASS   ,WWIDTH  ,W(1,94  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,94  ),GWF ,AMP(44  ))            
      CALL JIOXXX(W(1,1   ),W(1,83  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,95  ))    
      CALL FVOXXX(W(1,4   ),W(1,95  ),GZN ,ZERO    ,ZERO    ,W(1,96  ))    
      CALL JIOXXX(W(1,3   ),W(1,96  ),GWF ,WMASS   ,WWIDTH  ,W(1,97  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,97  ),GWF ,AMP(45  ))            
      CALL FVIXXX(W(1,1   ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,98  ))     
      CALL JIOXXX(W(1,98  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,99  ))    
      CALL FVOXXX(W(1,4   ),W(1,99  ),GZN ,ZERO    ,ZERO    ,W(1,100 ))    
      CALL JIOXXX(W(1,3   ),W(1,100 ),GWF ,WMASS   ,WWIDTH  ,W(1,101 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,101 ),GWF ,AMP(46  ))            
      CALL JIOXXX(W(1,8   ),W(1,88  ),GAD ,ZERO    ,AWIDTH  ,W(1,102 ))    
      CALL FVIXXX(W(1,3   ),W(1,102 ),GAL ,ZERO    ,ZERO    ,W(1,103 ))    
      CALL JIOXXX(W(1,103 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,104 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,104 ),GWF ,AMP(47  ))            
      CALL FVIXXX(W(1,3   ),W(1,89  ),GZL ,ZERO    ,ZERO    ,W(1,105 ))    
      CALL JIOXXX(W(1,105 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,106 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,106 ),GWF ,AMP(48  ))            
      CALL JIOXXX(W(1,80  ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,107 ))    
      CALL FVIXXX(W(1,3   ),W(1,107 ),GAL ,ZERO    ,ZERO    ,W(1,108 ))    
      CALL JIOXXX(W(1,108 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,109 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,109 ),GWF ,AMP(49  ))            
      CALL FVIXXX(W(1,3   ),W(1,92  ),GZL ,ZERO    ,ZERO    ,W(1,110 ))    
      CALL JIOXXX(W(1,110 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,111 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,111 ),GWF ,AMP(50  ))            
      CALL JIOXXX(W(1,1   ),W(1,83  ),GAD ,ZERO    ,AWIDTH  ,W(1,112 ))    
      CALL FVIXXX(W(1,3   ),W(1,112 ),GAL ,ZERO    ,ZERO    ,W(1,113 ))    
      CALL JIOXXX(W(1,113 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,114 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,114 ),GWF ,AMP(51  ))            
      CALL FVIXXX(W(1,3   ),W(1,95  ),GZL ,ZERO    ,ZERO    ,W(1,115 ))    
      CALL JIOXXX(W(1,115 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,116 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,116 ),GWF ,AMP(52  ))            
      CALL JIOXXX(W(1,98  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,117 ))    
      CALL FVIXXX(W(1,3   ),W(1,117 ),GAL ,ZERO    ,ZERO    ,W(1,118 ))    
      CALL JIOXXX(W(1,118 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,119 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,119 ),GWF ,AMP(53  ))            
      CALL FVIXXX(W(1,3   ),W(1,99  ),GZL ,ZERO    ,ZERO    ,W(1,120 ))    
      CALL JIOXXX(W(1,120 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,121 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,121 ),GWF ,AMP(54  ))            
      CALL JVVXXX(W(1,9   ),W(1,102 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     122 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,122 ),GWF ,AMP(55  ))            
      CALL JVVXXX(W(1,9   ),W(1,89  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     123 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GWF ,AMP(56  ))            
      CALL FVOXXX(W(1,88  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,124 ))    
      CALL JIOXXX(W(1,8   ),W(1,124 ),GWF ,WMASS   ,WWIDTH  ,W(1,125 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,125 ),GWF ,AMP(57  ))            
      CALL JVVXXX(W(1,9   ),W(1,107 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     126 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,126 ),GWF ,AMP(58  ))            
      CALL JVVXXX(W(1,9   ),W(1,92  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     127 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,127 ),GWF ,AMP(59  ))            
      CALL JVVXXX(W(1,9   ),W(1,112 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     128 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,128 ),GWF ,AMP(60  ))            
      CALL JVVXXX(W(1,9   ),W(1,95  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     129 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,129 ),GWF ,AMP(61  ))            
      CALL JVVXXX(W(1,9   ),W(1,117 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     130 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,130 ),GWF ,AMP(62  ))            
      CALL JVVXXX(W(1,9   ),W(1,99  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     131 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,131 ),GWF ,AMP(63  ))            
      CALL JIOXXX(W(1,98  ),W(1,64  ),GWF ,WMASS   ,WWIDTH  ,W(1,132 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,132 ),GWF ,AMP(64  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,89  ),GZN ,AMP(65  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,92  ),GZN ,AMP(66  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,95  ),GZN ,AMP(67  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,99  ),GZN ,AMP(68  ))            
      CALL FVOXXX(W(1,5   ),W(1,102 ),GAL ,ZERO    ,ZERO    ,W(1,133 ))    
      CALL IOVXXX(W(1,6   ),W(1,133 ),W(1,9   ),GWF ,AMP(69  ))            
      CALL FVOXXX(W(1,5   ),W(1,89  ),GZL ,ZERO    ,ZERO    ,W(1,134 ))    
      CALL IOVXXX(W(1,6   ),W(1,134 ),W(1,9   ),GWF ,AMP(70  ))            
      CALL FVOXXX(W(1,5   ),W(1,107 ),GAL ,ZERO    ,ZERO    ,W(1,135 ))    
      CALL IOVXXX(W(1,6   ),W(1,135 ),W(1,9   ),GWF ,AMP(71  ))            
      CALL FVOXXX(W(1,5   ),W(1,92  ),GZL ,ZERO    ,ZERO    ,W(1,136 ))    
      CALL IOVXXX(W(1,6   ),W(1,136 ),W(1,9   ),GWF ,AMP(72  ))            
      CALL FVOXXX(W(1,5   ),W(1,112 ),GAL ,ZERO    ,ZERO    ,W(1,137 ))    
      CALL IOVXXX(W(1,6   ),W(1,137 ),W(1,9   ),GWF ,AMP(73  ))            
      CALL FVOXXX(W(1,5   ),W(1,95  ),GZL ,ZERO    ,ZERO    ,W(1,138 ))    
      CALL IOVXXX(W(1,6   ),W(1,138 ),W(1,9   ),GWF ,AMP(74  ))            
      CALL FVOXXX(W(1,5   ),W(1,117 ),GAL ,ZERO    ,ZERO    ,W(1,139 ))    
      CALL IOVXXX(W(1,6   ),W(1,139 ),W(1,9   ),GWF ,AMP(75  ))            
      CALL FVOXXX(W(1,5   ),W(1,99  ),GZL ,ZERO    ,ZERO    ,W(1,140 ))    
      CALL IOVXXX(W(1,6   ),W(1,140 ),W(1,9   ),GWF ,AMP(76  ))            
     ...
     &             +AMP(  36)+AMP(  37)+AMP(  38)
      JAMP(   2) = -AMP(  39)-AMP(  40)-AMP(  41)-AMP(  42)-AMP(  43)
