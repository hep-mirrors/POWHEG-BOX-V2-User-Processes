      SUBROUTINE SREALMTRX_112(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ g -> e+ ve mu- vm~ s~ g  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_112/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_112(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_112(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL FVIXXX(W(1,7   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL JIOXXX(W(1,16  ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,17  ))    
      ...
      CALL JIOXXX(W(1,19  ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,15  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JIOXXX(W(1,10  ),W(1,21  ),GWF ,WMASS   ,WWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,10  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,12  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,7   ),W(1,25  ),GWF ,WMASS   ,WWIDTH  ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,15  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,7   ),W(1,27  ),GWF ,WMASS   ,WWIDTH  ,W(1,28  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,15  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,18  ),W(1,29  ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(8   ))            
      CALL FVOXXX(W(1,21  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      ...
      CALL JIOXXX(W(1,10  ),W(1,11  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      ...
      CALL JIOXXX(W(1,16  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,38  ))    
      ...
      CALL JIOXXX(W(1,19  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,41  ))    
      ...
      CALL JIOXXX(W(1,23  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,44  ))    
      ...
      CALL FVOXXX(W(1,11  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      ...
      CALL JIOXXX(W(1,10  ),W(1,11  ),GAD ,ZERO    ,AWIDTH  ,W(1,63  ))    
      ...
      CALL JIOXXX(W(1,16  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,68  ))    
      ...
      CALL JIOXXX(W(1,19  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,73  ))    
      ...
      CALL JIOXXX(W(1,23  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,78  ))    
     ...
     &             +AMP(  76)+AMP(  77)+AMP(  78)+AMP(  79)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_112 =REALMTRX_112+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
