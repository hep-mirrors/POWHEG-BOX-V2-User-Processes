      SUBROUTINE SREALMTRX_022(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_022/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_022(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_022(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL FVOXXX(W(1,14  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,1   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,18  ))    
      CALL FVOXXX(W(1,18  ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,2   ),W(1,19  ),GWF ,WMASS   ,WWIDTH  ,W(1,20  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,8   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVOXXX(W(1,21  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL JIOXXX(W(1,2   ),W(1,22  ),GWF ,WMASS   ,WWIDTH  ,W(1,23  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,23  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL JIOXXX(W(1,24  ),W(1,8   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,25  ))    
      CALL FVOXXX(W(1,4   ),W(1,25  ),GZN ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL JIOXXX(W(1,3   ),W(1,26  ),GWF ,WMASS   ,WWIDTH  ,W(1,27  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GWF ,AMP(5   ))            
      CALL JIOXXX(W(1,2   ),W(1,21  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,28  ))    
      CALL FVOXXX(W(1,4   ),W(1,28  ),GZN ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,3   ),W(1,29  ),GWF ,WMASS   ,WWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GWF ,AMP(6   ))            
      CALL JIOXXX(W(1,1   ),W(1,11  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
      ...
      CALL FVIXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JIOXXX(W(1,34  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      CALL FVOXXX(W(1,4   ),W(1,35  ),GZN ,ZERO    ,ZERO    ,W(1,36  ))    
      CALL JIOXXX(W(1,3   ),W(1,36  ),GWF ,WMASS   ,WWIDTH  ,W(1,37  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GWF ,AMP(8   ))            
      CALL JIOXXX(W(1,24  ),W(1,8   ),GAD ,ZERO    ,AWIDTH  ,W(1,38  ))    
      CALL FVIXXX(W(1,3   ),W(1,38  ),GAL ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL JIOXXX(W(1,39  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,40  ),GWF ,AMP(9   ))            
      CALL FVIXXX(W(1,3   ),W(1,25  ),GZL ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,41  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,42  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GWF ,AMP(10  ))            
      CALL JIOXXX(W(1,2   ),W(1,21  ),GAD ,ZERO    ,AWIDTH  ,W(1,43  ))    
      CALL FVIXXX(W(1,3   ),W(1,43  ),GAL ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL JIOXXX(W(1,44  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,45  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,45  ),GWF ,AMP(11  ))            
      CALL FVIXXX(W(1,3   ),W(1,28  ),GZL ,ZERO    ,ZERO    ,W(1,46  ))    
      CALL JIOXXX(W(1,46  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,47  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,47  ),GWF ,AMP(12  ))            
      CALL JIOXXX(W(1,1   ),W(1,11  ),GAD ,ZERO    ,AWIDTH  ,W(1,48  ))    
      CALL FVIXXX(W(1,3   ),W(1,48  ),GAL ,ZERO    ,ZERO    ,W(1,49  ))    
      CALL JIOXXX(W(1,49  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,50  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,50  ),GWF ,AMP(13  ))            
      CALL FVIXXX(W(1,3   ),W(1,31  ),GZL ,ZERO    ,ZERO    ,W(1,51  ))    
      CALL JIOXXX(W(1,51  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,52  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,52  ),GWF ,AMP(14  ))            
      CALL JIOXXX(W(1,34  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,53  ))    
      CALL FVIXXX(W(1,3   ),W(1,53  ),GAL ,ZERO    ,ZERO    ,W(1,54  ))    
      CALL JIOXXX(W(1,54  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,55  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GWF ,AMP(15  ))            
      CALL FVIXXX(W(1,3   ),W(1,35  ),GZL ,ZERO    ,ZERO    ,W(1,56  ))    
      CALL JIOXXX(W(1,56  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,57  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GWF ,AMP(16  ))            
      CALL JVVXXX(W(1,9   ),W(1,38  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     58  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GWF ,AMP(17  ))            
      CALL JVVXXX(W(1,9   ),W(1,25  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     59  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GWF ,AMP(18  ))            
      CALL JIOXXX(W(1,24  ),W(1,18  ),GWF ,WMASS   ,WWIDTH  ,W(1,60  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GWF ,AMP(19  ))            
      CALL JVVXXX(W(1,9   ),W(1,43  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     61  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GWF ,AMP(20  ))            
      CALL JVVXXX(W(1,9   ),W(1,28  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     62  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,62  ),GWF ,AMP(21  ))            
      CALL JVVXXX(W(1,9   ),W(1,48  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     63  ))                                                          
     ...
     &     64  ))                                                          
      ...
      CALL JVVXXX(W(1,9   ),W(1,53  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     65  ))                                                          
     ...
     &     66  ))                                                          
      ...
      CALL JIOXXX(W(1,34  ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,67  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,67  ),GWF ,AMP(26  ))            
      CALL FVOXXX(W(1,5   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,68  ))    
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,25  ),GZN ,AMP(27  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,28  ),GZN ,AMP(28  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,31  ),GZN ,AMP(29  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,35  ),GZN ,AMP(30  ))            
      CALL FVOXXX(W(1,5   ),W(1,38  ),GAL ,ZERO    ,ZERO    ,W(1,69  ))    
      CALL IOVXXX(W(1,6   ),W(1,69  ),W(1,9   ),GWF ,AMP(31  ))            
      CALL FVOXXX(W(1,5   ),W(1,25  ),GZL ,ZERO    ,ZERO    ,W(1,70  ))    
      CALL IOVXXX(W(1,6   ),W(1,70  ),W(1,9   ),GWF ,AMP(32  ))            
      CALL FVOXXX(W(1,5   ),W(1,43  ),GAL ,ZERO    ,ZERO    ,W(1,71  ))    
      CALL IOVXXX(W(1,6   ),W(1,71  ),W(1,9   ),GWF ,AMP(33  ))            
      CALL FVOXXX(W(1,5   ),W(1,28  ),GZL ,ZERO    ,ZERO    ,W(1,72  ))    
      CALL IOVXXX(W(1,6   ),W(1,72  ),W(1,9   ),GWF ,AMP(34  ))            
      CALL FVOXXX(W(1,5   ),W(1,48  ),GAL ,ZERO    ,ZERO    ,W(1,73  ))    
      CALL IOVXXX(W(1,6   ),W(1,73  ),W(1,9   ),GWF ,AMP(35  ))            
      CALL FVOXXX(W(1,5   ),W(1,31  ),GZL ,ZERO    ,ZERO    ,W(1,74  ))    
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,9   ),GWF ,AMP(36  ))            
      CALL FVOXXX(W(1,5   ),W(1,53  ),GAL ,ZERO    ,ZERO    ,W(1,75  ))    
      CALL IOVXXX(W(1,6   ),W(1,75  ),W(1,9   ),GWF ,AMP(37  ))            
      CALL FVOXXX(W(1,5   ),W(1,35  ),GZL ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL IOVXXX(W(1,6   ),W(1,76  ),W(1,9   ),GWF ,AMP(38  ))            
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL FVOXXX(W(1,18  ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL JIOXXX(W(1,1   ),W(1,78  ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL FVOXXX(W(1,8   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL FVOXXX(W(1,80  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,81  ))    
      CALL JIOXXX(W(1,1   ),W(1,81  ),GWF ,WMASS   ,WWIDTH  ,W(1,82  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,82  ),GWF ,AMP(40  ))            
      CALL JIOXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL FVOXXX(W(1,7   ),W(1,83  ),GG ,ZERO    ,ZERO    ,W(1,84  ))     
      CALL FVOXXX(W(1,84  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,85  ))    
      CALL JIOXXX(W(1,2   ),W(1,85  ),GWF ,WMASS   ,WWIDTH  ,W(1,86  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,86  ),GWF ,AMP(41  ))            
      CALL FVOXXX(W(1,14  ),W(1,83  ),GG ,ZERO    ,ZERO    ,W(1,87  ))     
      CALL JIOXXX(W(1,2   ),W(1,87  ),GWF ,WMASS   ,WWIDTH  ,W(1,88  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,88  ),GWF ,AMP(42  ))            
      CALL JIOXXX(W(1,2   ),W(1,84  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,89  ))    
      ...
      CALL FVIXXX(W(1,1   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,92  ))     
      CALL JIOXXX(W(1,92  ),W(1,8   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,93  ))    
      ...
      CALL JIOXXX(W(1,1   ),W(1,80  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,96  ))    
      CALL FVOXXX(W(1,4   ),W(1,96  ),GZN ,ZERO    ,ZERO    ,W(1,97  ))    
      CALL JIOXXX(W(1,3   ),W(1,97  ),GWF ,WMASS   ,WWIDTH  ,W(1,98  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,98  ),GWF ,AMP(45  ))            
      CALL FVIXXX(W(1,2   ),W(1,83  ),GG ,ZERO    ,ZERO    ,W(1,99  ))     
      CALL JIOXXX(W(1,99  ),W(1,7   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,100 ))    
      CALL FVOXXX(W(1,4   ),W(1,100 ),GZN ,ZERO    ,ZERO    ,W(1,101 ))    
      CALL JIOXXX(W(1,3   ),W(1,101 ),GWF ,WMASS   ,WWIDTH  ,W(1,102 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,102 ),GWF ,AMP(46  ))            
      CALL JIOXXX(W(1,2   ),W(1,84  ),GAD ,ZERO    ,AWIDTH  ,W(1,103 ))    
      CALL FVIXXX(W(1,3   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,104 ))    
      CALL JIOXXX(W(1,104 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,105 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,105 ),GWF ,AMP(47  ))            
      CALL FVIXXX(W(1,3   ),W(1,89  ),GZL ,ZERO    ,ZERO    ,W(1,106 ))    
      CALL JIOXXX(W(1,106 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,107 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,107 ),GWF ,AMP(48  ))            
      CALL JIOXXX(W(1,92  ),W(1,8   ),GAD ,ZERO    ,AWIDTH  ,W(1,108 ))    
      CALL FVIXXX(W(1,3   ),W(1,108 ),GAL ,ZERO    ,ZERO    ,W(1,109 ))    
      CALL JIOXXX(W(1,109 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,110 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,110 ),GWF ,AMP(49  ))            
      CALL FVIXXX(W(1,3   ),W(1,93  ),GZL ,ZERO    ,ZERO    ,W(1,111 ))    
      CALL JIOXXX(W(1,111 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,112 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,112 ),GWF ,AMP(50  ))            
      CALL JIOXXX(W(1,1   ),W(1,80  ),GAD ,ZERO    ,AWIDTH  ,W(1,113 ))    
      CALL FVIXXX(W(1,3   ),W(1,113 ),GAL ,ZERO    ,ZERO    ,W(1,114 ))    
      CALL JIOXXX(W(1,114 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,115 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,115 ),GWF ,AMP(51  ))            
      CALL FVIXXX(W(1,3   ),W(1,96  ),GZL ,ZERO    ,ZERO    ,W(1,116 ))    
      CALL JIOXXX(W(1,116 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,117 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,117 ),GWF ,AMP(52  ))            
      CALL JIOXXX(W(1,99  ),W(1,7   ),GAD ,ZERO    ,AWIDTH  ,W(1,118 ))    
      CALL FVIXXX(W(1,3   ),W(1,118 ),GAL ,ZERO    ,ZERO    ,W(1,119 ))    
      CALL JIOXXX(W(1,119 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,120 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,120 ),GWF ,AMP(53  ))            
      CALL FVIXXX(W(1,3   ),W(1,100 ),GZL ,ZERO    ,ZERO    ,W(1,121 ))    
      CALL JIOXXX(W(1,121 ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,122 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,122 ),GWF ,AMP(54  ))            
      CALL JVVXXX(W(1,9   ),W(1,103 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     123 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GWF ,AMP(55  ))            
      CALL JVVXXX(W(1,9   ),W(1,89  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     124 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,124 ),GWF ,AMP(56  ))            
     ...
     &     126 ))                                                          
      ...
      CALL JIOXXX(W(1,92  ),W(1,18  ),GWF ,WMASS   ,WWIDTH  ,W(1,127 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,127 ),GWF ,AMP(59  ))            
      CALL JVVXXX(W(1,9   ),W(1,113 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     128 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,128 ),GWF ,AMP(60  ))            
      CALL JVVXXX(W(1,9   ),W(1,96  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     129 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,129 ),GWF ,AMP(61  ))            
      CALL JVVXXX(W(1,9   ),W(1,118 ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     130 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,130 ),GWF ,AMP(62  ))            
      CALL JVVXXX(W(1,9   ),W(1,100 ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     131 ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,131 ),GWF ,AMP(63  ))            
      CALL JIOXXX(W(1,99  ),W(1,14  ),GWF ,WMASS   ,WWIDTH  ,W(1,132 ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,132 ),GWF ,AMP(64  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,89  ),GZN ,AMP(65  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,93  ),GZN ,AMP(66  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,96  ),GZN ,AMP(67  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,100 ),GZN ,AMP(68  ))            
      CALL FVOXXX(W(1,5   ),W(1,103 ),GAL ,ZERO    ,ZERO    ,W(1,133 ))    
      ...
      CALL FVOXXX(W(1,5   ),W(1,108 ),GAL ,ZERO    ,ZERO    ,W(1,135 ))    
      CALL IOVXXX(W(1,6   ),W(1,135 ),W(1,9   ),GWF ,AMP(71  ))            
      CALL FVOXXX(W(1,5   ),W(1,93  ),GZL ,ZERO    ,ZERO    ,W(1,136 ))    
      CALL IOVXXX(W(1,6   ),W(1,136 ),W(1,9   ),GWF ,AMP(72  ))            
      CALL FVOXXX(W(1,5   ),W(1,113 ),GAL ,ZERO    ,ZERO    ,W(1,137 ))    
      CALL IOVXXX(W(1,6   ),W(1,137 ),W(1,9   ),GWF ,AMP(73  ))            
      CALL FVOXXX(W(1,5   ),W(1,96  ),GZL ,ZERO    ,ZERO    ,W(1,138 ))    
      CALL IOVXXX(W(1,6   ),W(1,138 ),W(1,9   ),GWF ,AMP(74  ))            
      CALL FVOXXX(W(1,5   ),W(1,118 ),GAL ,ZERO    ,ZERO    ,W(1,139 ))    
      CALL IOVXXX(W(1,6   ),W(1,139 ),W(1,9   ),GWF ,AMP(75  ))            
      CALL FVOXXX(W(1,5   ),W(1,100 ),GZL ,ZERO    ,ZERO    ,W(1,140 ))    
     ...
     &             -AMP(  74)-AMP(  75)-AMP(  76)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_022 =REALMTRX_022+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
