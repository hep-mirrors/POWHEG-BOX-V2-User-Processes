      SUBROUTINE SREALMTRX_096(P1,ANS)
C  
...
C  
C FOR PROCESS : c g -> e+ ve mu- vm~ c g  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_096/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_096(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_096(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             -AMP(  76)-AMP(  77)-AMP(  78)-AMP(  79)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_096 =REALMTRX_096+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
