      SUBROUTINE SREALMTRX_023(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_023/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_023(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_023(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     66  ))                                                          
      ...
      CALL JIOXXX(W(1,8   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL FVOXXX(W(1,2   ),W(1,77  ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL JIOXXX(W(1,1   ),W(1,78  ),GWF ,WMASS   ,WWIDTH  ,W(1,79  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,79  ),GWF ,AMP(39  ))            
      CALL JIOXXX(W(1,18  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL FVOXXX(W(1,2   ),W(1,80  ),GG ,ZERO    ,ZERO    ,W(1,81  ))     
      ...
      CALL JIOXXX(W(1,83  ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,84  ))    
     ...
     &             -AMP(  36)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_023 =REALMTRX_023+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
