module     p8_cbarc_epnemumnmubarg_dipoles
   use p8_cbarc_epnemumnmubarg_config, only: ki
   use p8_cbarc_epnemumnmubarg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T7, &
       & T2T7
   use p8_cbarc_epnemumnmubarg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p8_cbarc_epnemumnmubarg_dipoles
