module     p8_cbarc_epnemumnmubarg_abbrevd559h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb559(8)=abb559(5)*gHC*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb559(4)*abb&
...
end module p8_cbarc_epnemumnmubarg_abbrevd559h4
