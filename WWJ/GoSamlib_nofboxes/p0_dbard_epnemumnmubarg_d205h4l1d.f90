module     p0_dbard_epnemumnmubarg_d205h4l1d
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p0_dbard_epnemumnmubarg/helicity4d205h4l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      acd205(4)=abb205(13)
      acd205(5)=dotproduct(qshift,spvak7k1)
      acd205(6)=abb205(8)
      acd205(7)=dotproduct(qshift,spvak7k2)
      acd205(8)=abb205(9)
      acd205(9)=abb205(11)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd205(3)=k7(iv1)
      acd205(4)=abb205(13)
      acd205(5)=spvak7k1(iv1)
      acd205(6)=abb205(8)
      acd205(7)=spvak7k2(iv1)
      acd205(8)=abb205(9)
...
!---#] subroutine reconstruct_d205:
end module     p0_dbard_epnemumnmubarg_d205h4l1d
