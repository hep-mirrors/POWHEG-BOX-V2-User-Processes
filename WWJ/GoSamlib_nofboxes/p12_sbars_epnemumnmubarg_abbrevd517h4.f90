module     p12_sbars_epnemumnmubarg_abbrevd517h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb517(6)=spbk7k2**(-1)
      abb517(7)=NC**(-1)
      abb517(8)=spak4k5*gHWW*gHS*abb517(6)*abb517(5)*abb517(4)*abb517(3)*gW**2*&
      &abb517(1)*abb517(2)*spbk6k3*c1*TR*i_
      abb517(9)=abb517(8)*spbk2k1
      ...
      abb517(8)=-abb517(8)*spbk7k1*abb517(11)
      R2d517=0.0_ki
      rat2 = rat2 + R2d517
...
end module p12_sbars_epnemumnmubarg_abbrevd517h4
