module     p8_cbarc_epnemumnmubarg_abbrevd517h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb517(6)=spbk7k2**(-1)
      abb517(7)=NC**(-1)
      abb517(8)=spak4k5*gHWW*gHC*abb517(6)*abb517(5)*abb517(4)*abb517(3)*gW**2*&
...
end module p8_cbarc_epnemumnmubarg_abbrevd517h4
