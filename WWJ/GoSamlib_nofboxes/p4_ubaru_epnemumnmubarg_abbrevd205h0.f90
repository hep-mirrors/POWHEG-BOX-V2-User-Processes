module     p4_ubaru_epnemumnmubarg_abbrevd205h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb205(12)=spak4k5*gHWW*gHU*abb205(5)*abb205(3)*abb205(1)*abb205(2)*spbk6&
      &k3*c1*TR*i_
...
end module p4_ubaru_epnemumnmubarg_abbrevd205h0
