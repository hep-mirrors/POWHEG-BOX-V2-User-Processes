module     p8_cbarc_epnemumnmubarg_abbrevd573h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb573(10)=spbk6k3*spak4k5*gHWW*gHC*abb573(5)*abb573(4)*abb573(3)*gW**2*a&
...
end module p8_cbarc_epnemumnmubarg_abbrevd573h0
