module     p4_ubaru_epnemumnmubarg_d573h6l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p4_ubaru_epnemumnmubarg/helicity6d573h6l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p4_ubaru_epnemumnmubarg_d573h6l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p4_ubaru_epnemumnmubarg_d573h6l1
