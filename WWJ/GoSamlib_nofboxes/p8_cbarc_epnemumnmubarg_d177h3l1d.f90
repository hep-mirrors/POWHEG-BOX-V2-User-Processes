module     p8_cbarc_epnemumnmubarg_d177h3l1d
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p8_cbarc_epnemumnmubarg/helicity3d177h3l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p8_cbarc_epnemumnmubarg_abbrevd177h3
      implicit none
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(10) :: acd177
      complex(ki) :: brack
      acd177(1)=k1(iv1)
      acd177(2)=abb177(12)
      acd177(3)=k2(iv1)
      acd177(4)=spvak1k7(iv1)
      acd177(5)=abb177(8)
      acd177(6)=spvak2k7(iv1)
      acd177(7)=abb177(9)
      acd177(8)=acd177(1)-acd177(3)
      acd177(8)=acd177(2)*acd177(8)
      acd177(9)=acd177(5)*acd177(4)
      acd177(10)=acd177(7)*acd177(6)
      brack=acd177(8)+acd177(9)+acd177(10)
...
!---#] subroutine reconstruct_d177:
end module     p8_cbarc_epnemumnmubarg_d177h3l1d
