module     p0_dbard_epnemumnmubarg_d489h3l1d
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p0_dbard_epnemumnmubarg/helicity3d489h3l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p0_dbard_epnemumnmubarg_abbrevd489h3
      implicit none
      ...
      acd489(9)=abb489(10)
      acd489(10)=abb489(12)
      acd489(11)=dotproduct(qshift,spvak1k7)
      acd489(12)=abb489(11)
      acd489(13)=abb489(16)
      acd489(14)=abb489(8)
      acd489(15)=abb489(13)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd489(13)=abb489(12)
      acd489(14)=dotproduct(qshift,spvak1k7)
      acd489(15)=abb489(11)
      acd489(16)=abb489(16)
      acd489(17)=spvak1k7(iv1)
      acd489(18)=abb489(8)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd489(10)=k7(iv2)
      acd489(11)=abb489(12)
      acd489(12)=spvak1k7(iv2)
      acd489(13)=abb489(11)
      acd489(14)=spvak1k7(iv1)
...
!---#] subroutine reconstruct_d489:
end module     p0_dbard_epnemumnmubarg_d489h3l1d
