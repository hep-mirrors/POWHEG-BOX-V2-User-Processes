module     p4_ubaru_epnemumnmubarg_abbrevd545h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb545(5)=sqrt2**(-1)
      abb545(6)=spak2k7**(-1)
      abb545(7)=spak4k5*gHWW*gHU*abb545(5)*abb545(4)*abb545(3)*gW**2*abb545(1)*&
...
end module p4_ubaru_epnemumnmubarg_abbrevd545h0
