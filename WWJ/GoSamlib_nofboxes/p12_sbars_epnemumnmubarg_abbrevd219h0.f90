module     p12_sbars_epnemumnmubarg_abbrevd219h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb219(11)=spak4k5*gHWW*gHS*abb219(7)*abb219(6)*abb219(11)**2*abb219(4)*a&
...
end module p12_sbars_epnemumnmubarg_abbrevd219h0
