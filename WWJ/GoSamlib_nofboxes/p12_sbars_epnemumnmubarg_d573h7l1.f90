module     p12_sbars_epnemumnmubarg_d573h7l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity7d573h7l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc573(13)=abb573(18)
      acc573(14)=abb573(19)
      acc573(15)=acc573(5)*Qspvak1k7
      acc573(16)=QspQ*acc573(7)
      acc573(17)=Qspvak2k7*acc573(8)
      acc573(18)=-Qspk1*acc573(10)
      acc573(19)=Qspk7*acc573(12)
      acc573(20)=Qspk2*acc573(13)
      acc573(15)=acc573(20)+acc573(19)+acc573(18)+acc573(17)+acc573(16)+acc573(&
      &11)+acc573(15)
      acc573(15)=Qspvak7k2*acc573(15)
      acc573(16)=QspQ*acc573(3)
      acc573(17)=Qspvak2k7*acc573(14)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p12_sbars_epnemumnmubarg_d573h7l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p12_sbars_epnemumnmubarg_d573h7l1
