module     p12_sbars_epnemumnmubarg_diagramsh4l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity4diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(6)=spbk7k2**(-1)
      abb(7)=spbk2k1*gW
      abb(7)=-4.0_ki*i_*spak1k7*spbk6k3*spak4k5*gHWW*gHS*abb(6)*abb(5)*abb(4)*a&
...
!---#] function amplitude:
end module p12_sbars_epnemumnmubarg_diagramsh4l0
