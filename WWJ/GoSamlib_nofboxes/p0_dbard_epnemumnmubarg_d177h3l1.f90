module     p0_dbard_epnemumnmubarg_d177h3l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p0_dbard_epnemumnmubarg/helicity3d177h3l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbard_epnemumnmubarg_d177h3l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_dbard_epnemumnmubarg_d177h3l1
