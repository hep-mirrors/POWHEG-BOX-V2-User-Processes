module     p12_sbars_epnemumnmubarg_diagramsh2l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity2diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(19)=2.0_ki*abb(23)+2.0_ki/3.0_ki*abb(19)
      ...
      abb(26)=2.0_ki*abb(20)+2.0_ki/3.0_ki*abb(12)
      ...
      abb(14)=1.0_ki/3.0_ki*abb(14)+abb(15)
      abb(14)=spbk6k5*abb(10)*abb(14)
      abb(12)=-1.0_ki/3.0_ki*abb(12)-abb(20)
...
!---#] function amplitude:
end module p12_sbars_epnemumnmubarg_diagramsh2l0
