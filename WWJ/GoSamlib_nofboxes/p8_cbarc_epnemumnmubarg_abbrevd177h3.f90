module     p8_cbarc_epnemumnmubarg_abbrevd177h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb177(11)=gHC*gHWW*spak4k5*spbk6k3*c1*i_*TR*abb177(5)*abb177(3)*abb177(2&
      &)*abb177(1)
...
end module p8_cbarc_epnemumnmubarg_abbrevd177h3
