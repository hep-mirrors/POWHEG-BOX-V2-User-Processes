module     p0_dbard_epnemumnmubarg_d545h1l132
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p0_dbard_epnemumnmubarg/helicity1d545h1l132.f90
...
!---#[ subroutine brack_22:
   pure subroutine brack_22(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd545(3)=dotproduct(ninjaE3,spvak1k2)
      acd545(4)=abb545(15)
      acd545(5)=dotproduct(k3,ninjaE3)
      acd545(6)=dotproduct(ninjaA1,spvak2k7)
      acd545(7)=dotproduct(ninjaA1,spvak1k2)
      ...
      acd545(18)=abb545(47)
      acd545(19)=dotproduct(ninjaE3,spvak4k6)
      acd545(20)=abb545(48)
      acd545(21)=dotproduct(ninjaE3,spvak5k6)
      acd545(22)=abb545(43)
      ...
      acd545(29)=abb545(83)
      acd545(30)=dotproduct(ninjaE3,spvak1k7)
      acd545(31)=abb545(57)
      acd545(32)=abb545(64)
      acd545(33)=abb545(42)
      acd545(34)=abb545(140)
      acd545(35)=dotproduct(ninjaE3,spvak4k2)
      acd545(36)=abb545(20)
      acd545(37)=dotproduct(ninjaE3,spvak5k2)
      acd545(38)=abb545(33)
      acd545(39)=abb545(62)
      acd545(40)=abb545(24)
      acd545(41)=dotproduct(ninjaE3,spvak3k2)
      acd545(42)=abb545(30)
      acd545(43)=dotproduct(ninjaE3,spvak6k2)
      acd545(44)=abb545(110)
      acd545(45)=dotproduct(k7,ninjaE3)
      acd545(46)=dotproduct(ninjaA0,ninjaE3)
      acd545(47)=abb545(89)
      acd545(48)=dotproduct(k3,ninjaA0)
      acd545(49)=dotproduct(ninjaA0,spvak2k7)
      acd545(50)=dotproduct(ninjaA0,spvak1k2)
      acd545(51)=abb545(58)
      acd545(52)=abb545(38)
      ...
      acd545(86)=acd545(90)+acd545(89)+acd545(88)+acd545(87)+acd545(72)+acd545(&
      &86)
      acd545(86)=acd545(3)*acd545(86)
      acd545(87)=acd545(76)*acd545(77)
      acd545(88)=acd545(43)*acd545(78)
      acd545(89)=acd545(41)*acd545(75)
      acd545(90)=acd545(37)*acd545(74)
      acd545(91)=acd545(35)*acd545(73)
      acd545(92)=2.0_ki*acd545(46)
      acd545(93)=acd545(57)*acd545(92)
      acd545(94)=acd545(30)*acd545(67)
      acd545(95)=acd545(26)*acd545(33)
      ...
      acd545(86)=acd545(51)*acd545(82)
      acd545(87)=acd545(45)*acd545(31)
      acd545(88)=acd545(56)*acd545(92)
      acd545(89)=acd545(21)*acd545(70)
      acd545(90)=acd545(19)*acd545(69)
      acd545(91)=acd545(17)*acd545(68)
      acd545(93)=acd545(16)*acd545(66)
      acd545(86)=acd545(93)+acd545(91)+acd545(90)+acd545(89)+acd545(87)+acd545(&
      &88)+acd545(86)
      acd545(86)=acd545(30)*acd545(86)
      acd545(87)=acd545(27)*acd545(28)
      acd545(88)=acd545(43)*acd545(44)
      acd545(89)=acd545(41)*acd545(42)
      acd545(90)=acd545(37)*acd545(38)
      acd545(91)=acd545(35)*acd545(36)
      ...
      acd545(91)=acd545(17)*acd545(34)
      acd545(93)=acd545(16)*acd545(32)
      acd545(94)=-acd545(30)*acd545(31)
...
!---#[ subroutine numerator_t2:
   ...
   & bind(c, name="p0_dbard_epnemumnmubarg_d545h1_ninja_t2")
...
!---#] subroutine numerator_t2:
end module     p0_dbard_epnemumnmubarg_d545h1l132
