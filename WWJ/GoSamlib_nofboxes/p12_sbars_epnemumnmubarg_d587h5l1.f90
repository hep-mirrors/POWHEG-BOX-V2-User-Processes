module     p12_sbars_epnemumnmubarg_d587h5l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity5d587h5l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p12_sbars_epnemumnmubarg_d587h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p12_sbars_epnemumnmubarg_d587h5l1
