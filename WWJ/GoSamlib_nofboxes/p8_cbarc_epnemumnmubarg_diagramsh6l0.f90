module     p8_cbarc_epnemumnmubarg_diagramsh6l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p8_cbarc_epnemumnmubarg/helicity6diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(15)=2.0_ki/3.0_ki*abb(16)+abb(15)
      ...
      abb(15)=abb(15)+2.0_ki/3.0_ki*abb(16)+abb(18)
      abb(15)=abb(9)*abb(15)
      ...
      abb(18)=2.0_ki/3.0_ki*abb(18)+abb(20)
      ...
      abb(16)=abb(18)+2.0_ki/3.0_ki*abb(16)+abb(20)
...
!---#] function amplitude:
end module p8_cbarc_epnemumnmubarg_diagramsh6l0
