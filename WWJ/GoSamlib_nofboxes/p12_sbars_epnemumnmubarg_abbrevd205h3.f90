module     p12_sbars_epnemumnmubarg_abbrevd205h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb205(8)=spak4k5*gHWW*gHS*abb205(5)*abb205(3)*abb205(1)*abb205(2)*spbk6k&
      &3*c1*abb205(8)*TR*i_
      abb205(9)=abb205(7)*abb205(8)
      abb205(10)=abb205(9)*spbk7k1
      abb205(11)=gW*spak1k2
      abb205(11)=4.0_ki*abb205(6)*abb205(11)**2*abb205(10)
      abb205(12)=abb205(6)*gW
      abb205(13)=abb205(12)*spak1k2
      abb205(10)=abb205(10)*abb205(13)**2
      abb205(13)=16.0_ki*abb205(10)
      abb205(10)=-8.0_ki*abb205(10)
      abb205(9)=8.0_ki*spak1k2*abb205(9)*abb205(6)*gW**2
      abb205(8)=4.0_ki*abb205(12)**2*spak1k2*spbk7k1*abb205(8)
      R2d205=0.0_ki
      rat2 = rat2 + R2d205
...
end module p12_sbars_epnemumnmubarg_abbrevd205h3
