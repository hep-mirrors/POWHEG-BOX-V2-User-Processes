module     p4_ubaru_epnemumnmubarg_abbrevd573h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb573(4)=sqrt2**(-1)
      abb573(5)=spbk7k2**(-1)
      abb573(6)=spbk6k3*spak4k5*gHWW*gHU*abb573(4)*abb573(3)*gW**2*abb573(1)*ab&
      &b573(2)*c1*NC*TR*i_
...
end module p4_ubaru_epnemumnmubarg_abbrevd573h4
