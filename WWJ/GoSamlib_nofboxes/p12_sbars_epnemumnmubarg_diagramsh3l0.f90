module     p12_sbars_epnemumnmubarg_diagramsh3l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity3diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(6)=spak2k7**(-1)
      abb(7)=spak1k2*gW
      abb(7)=4.0_ki*i_*spbk7k1*spbk6k3*spak4k5*gHWW*gHS*abb(6)*abb(5)*abb(4)*ab&
...
!---#] function amplitude:
end module p12_sbars_epnemumnmubarg_diagramsh3l0
