module     p4_ubaru_epnemumnmubarg_d545h3l1d
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p4_ubaru_epnemumnmubarg/helicity3d545h3l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      acd545(4)=dotproduct(qshift,spvak2k7)
      acd545(5)=abb545(14)
      acd545(6)=abb545(10)
      ...
      acd545(9)=abb545(13)
      acd545(10)=abb545(12)
      acd545(11)=dotproduct(qshift,spvak1k7)
      acd545(12)=abb545(7)
      acd545(13)=dotproduct(qshift,spvak2k1)
      acd545(14)=abb545(8)
      acd545(15)=abb545(11)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd545(1)=d(iv1,iv2)
      acd545(2)=dotproduct(qshift,spvak2k7)
      acd545(3)=abb545(13)
      acd545(4)=abb545(9)
      acd545(5)=k2(iv1)
      acd545(6)=spvak2k7(iv2)
      acd545(7)=abb545(14)
      acd545(8)=k2(iv2)
      acd545(9)=spvak2k7(iv1)
      acd545(10)=k7(iv1)
      acd545(11)=k7(iv2)
      acd545(12)=qshift(iv1)
      acd545(13)=qshift(iv2)
      acd545(14)=abb545(12)
      acd545(15)=spvak1k7(iv2)
      acd545(16)=abb545(7)
      acd545(17)=spvak1k7(iv1)
...
!---#[ function brack_4:
   pure function brack_4(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd545(1)=d(iv1,iv2)
      acd545(2)=spvak2k7(iv3)
      acd545(3)=abb545(13)
      acd545(4)=d(iv1,iv3)
      acd545(5)=spvak2k7(iv2)
      acd545(6)=d(iv2,iv3)
      acd545(7)=spvak2k7(iv1)
...
!---#] subroutine reconstruct_d545:
end module     p4_ubaru_epnemumnmubarg_d545h3l1d
