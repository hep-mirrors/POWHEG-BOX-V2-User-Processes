module     p0_dbard_epnemumnmubarg_color
   ! file:      /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/
   ! Virtual/p0_dbard_epnemumnmubarg/common/color.f90
   ! generator: haggies (1.1)
   use p0_dbard_epnemumnmubarg_config, only: ki
   use p0_dbard_epnemumnmubarg_model, only: NC, Nf
   implicit none
   save
...
end module p0_dbard_epnemumnmubarg_color
