module     p0_dbard_epnemumnmubarg_diagramsh0l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p0_dbard_epnemumnmubarg/helicity0diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(8)=4.0_ki*abb(1)*abb(2)*abb(3)*abb(4)*abb(5)*gHD*gHWW*spak4k5*spbk6k3&
...
!---#] function amplitude:
end module p0_dbard_epnemumnmubarg_diagramsh0l0
