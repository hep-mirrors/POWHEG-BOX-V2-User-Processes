module     p0_dbard_epnemumnmubarg_abbrevd177h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb177(9)=gHD*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb177(5)*abb177(3)*abb&
      &177(2)*abb177(1)
...
end module p0_dbard_epnemumnmubarg_abbrevd177h0
