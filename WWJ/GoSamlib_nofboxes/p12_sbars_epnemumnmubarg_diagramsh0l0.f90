module     p12_sbars_epnemumnmubarg_diagramsh0l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity0diagramsl0.f90
...
!---#] function amplitude:
end module p12_sbars_epnemumnmubarg_diagramsh0l0
