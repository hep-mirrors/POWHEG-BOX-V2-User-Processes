module     p12_sbars_epnemumnmubarg_d57h5l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity5d57h5l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p12_sbars_epnemumnmubarg_abbrevd57h5
      implicit none
      ...
      acc57(9)=Qspvak2k6*acc57(6)
      acc57(10)=Qspk6*acc57(7)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p12_sbars_epnemumnmubarg_d57h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p12_sbars_epnemumnmubarg_d57h5l1
