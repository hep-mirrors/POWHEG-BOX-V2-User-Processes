module     p8_cbarc_epnemumnmubarg_abbrevd177h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb177(9)=gHC*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb177(5)*abb177(3)*abb&
      &177(2)*abb177(1)
      abb177(10)=abb177(8)*abb177(9)*abb177(6)*spbk7k1
      ...
      abb177(9)=abb177(8)*abb177(7)*spbk7k1**2
      abb177(16)=4.0_ki*spak1k2
      abb177(17)=abb177(16)*abb177(6)*abb177(9)
      abb177(11)=-spbk7k2*abb177(11)*abb177(16)
      abb177(16)=4.0_ki*abb177(7)
      abb177(8)=-spbk2k1*abb177(8)*spbk7k1*abb177(16)
      abb177(9)=4.0_ki*abb177(9)
      R2d177=abb177(14)
      rat2 = rat2 + R2d177
...
end module p8_cbarc_epnemumnmubarg_abbrevd177h0
