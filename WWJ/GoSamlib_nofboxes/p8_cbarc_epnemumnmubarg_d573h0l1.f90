module     p8_cbarc_epnemumnmubarg_d573h0l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p8_cbarc_epnemumnmubarg/helicity0d573h0l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p8_cbarc_epnemumnmubarg_d573h0l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p8_cbarc_epnemumnmubarg_d573h0l1
