module     p4_ubaru_epnemumnmubarg_color
   ! file:      /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/
   ! Virtual/p4_ubaru_epnemumnmubarg/common/color.f90
   ! generator: haggies (1.1)
   use p4_ubaru_epnemumnmubarg_config, only: ki
   use p4_ubaru_epnemumnmubarg_model, only: NC, Nf
   implicit none
   save
...
end module p4_ubaru_epnemumnmubarg_color
