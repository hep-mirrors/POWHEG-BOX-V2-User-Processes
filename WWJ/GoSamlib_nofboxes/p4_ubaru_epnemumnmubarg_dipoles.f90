module     p4_ubaru_epnemumnmubarg_dipoles
   use p4_ubaru_epnemumnmubarg_config, only: ki
   use p4_ubaru_epnemumnmubarg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T7, &
       & T2T7
   use p4_ubaru_epnemumnmubarg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
contains
   ...
   function I_ii_qed(mu_sq, vec, I, J)
      ...
      if (flag) then
              ...
              term(1) = ncs*(-2.0_ki)*(2.0_ki)/9.0_ki
              term(2) = ncs*(-2.0_ki)*(2.0_ki)/9.0_ki
...
end module p4_ubaru_epnemumnmubarg_dipoles
