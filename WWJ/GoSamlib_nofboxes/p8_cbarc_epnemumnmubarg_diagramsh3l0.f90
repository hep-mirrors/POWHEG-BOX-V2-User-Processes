module     p8_cbarc_epnemumnmubarg_diagramsh3l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p8_cbarc_epnemumnmubarg/helicity3diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(6)=spak2k7**(-1)
      abb(7)=gW*spak1k2
      abb(7)=4.0_ki*abb(1)*abb(2)*abb(3)*abb(4)*abb(5)*abb(6)*gHC*gHWW*spak4k5*&
      &spbk6k3*spbk7k1*i_*abb(7)**2
      amplitude=c1*abb(7)
...
!---#] function amplitude:
end module p8_cbarc_epnemumnmubarg_diagramsh3l0
