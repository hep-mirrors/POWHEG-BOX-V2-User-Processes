module     p8_cbarc_epnemumnmubarg_color
   ! file:      /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/
   ! Virtual/p8_cbarc_epnemumnmubarg/common/color.f90
   ! generator: haggies (1.1)
   use p8_cbarc_epnemumnmubarg_config, only: ki
   use p8_cbarc_epnemumnmubarg_model, only: NC, Nf
   implicit none
   save
...
end module p8_cbarc_epnemumnmubarg_color
