module     p12_sbars_epnemumnmubarg_abbrevd545h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb545(15)=1.0_ki/3.0_ki*abb545(8)
      ...
      abb545(37)=2.0_ki/3.0_ki*abb545(7)
      ...
      abb545(47)=2.0_ki/3.0_ki*abb545(10)
      ...
      abb545(60)=1.0_ki/3.0_ki*abb545(7)
      ...
      abb545(79)=1.0_ki/3.0_ki*abb545(10)
      abb545(78)=abb545(78)*abb545(79)
      ...
      &(127)+abb545(128)-abb545(94)+abb545(95)+abb545(104)+abb545(83)-abb545(11&
      &7)+abb545(89)+abb545(84)+abb545(122)-abb545(85)+abb545(65)+abb545(58)+ab&
      &b545(115)+abb545(68)+abb545(97)+abb545(64)
      ...
      abb545(84)=-abb545(100)-abb545(95)+abb545(85)+abb545(110)-abb545(84)+abb5&
      &45(75)
      abb545(85)=abb545(56)*abb545(59)
      abb545(95)=abb545(34)*abb545(7)
      abb545(100)=abb545(30)*abb545(95)
      abb545(85)=abb545(85)+1.0_ki/3.0_ki*abb545(100)
      ...
      abb545(122)=2.0_ki/3.0_ki*abb545(8)
      ...
      abb545(100)=2.0_ki/3.0_ki*abb545(100)
      ...
      abb545(34)=1.0_ki/3.0_ki*abb545(34)+abb545(55)
      ...
      abb545(132)=1.0_ki/3.0_ki*abb545(160)+abb545(132)
      ...
      abb545(22)=abb545(135)+2.0_ki/3.0_ki*abb545(19)
      ...
      abb545(54)=abb545(54)+1.0_ki/3.0_ki*abb545(19)
      ...
      abb545(54)=abb545(86)+abb545(54)+abb545(133)-abb545(103)+abb545(97)+abb54&
      &5(102)-abb545(83)
      ...
      abb545(97)=abb545(97)+2.0_ki/3.0_ki*abb545(13)
      ...
      abb545(13)=abb545(66)+1.0_ki/3.0_ki*abb545(13)
      ...
      abb545(24)=abb545(16)+2.0_ki/3.0_ki*abb545(21)
      ...
      abb545(41)=1.0_ki/3.0_ki*abb545(41)+abb545(53)
      ...
      abb545(12)=1.0_ki/3.0_ki*abb545(19)+abb545(12)
      ...
      abb545(21)=abb545(33)+1.0_ki/3.0_ki*abb545(21)
...
end module p12_sbars_epnemumnmubarg_abbrevd545h2
