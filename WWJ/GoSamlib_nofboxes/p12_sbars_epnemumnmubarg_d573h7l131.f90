module     p12_sbars_epnemumnmubarg_d573h7l131
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity7d573h7l131.f90
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd573(1)=dotproduct(ninjaE3,spvak7k2)
      acd573(2)=abb573(12)
      ...
      acd573(17)=dotproduct(ninjaA,spvak7k2)
      acd573(18)=abb573(6)
      ...
      acd573(23)=abb573(8)
      acd573(24)=dotproduct(ninjaA,spvak1k7)
      acd573(25)=dotproduct(ninjaA,spvak2k7)
      acd573(26)=abb573(16)
      acd573(27)=abb573(19)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p12_sbars_epnemumnmubarg_d573h7_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p12_sbars_epnemumnmubarg_d573h7l131
