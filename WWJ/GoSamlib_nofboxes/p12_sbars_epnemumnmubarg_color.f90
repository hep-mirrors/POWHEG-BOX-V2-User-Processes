module     p12_sbars_epnemumnmubarg_color
   ! file:      /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/
   ! Virtual/p12_sbars_epnemumnmubarg/common/color.f90
   ! generator: haggies (1.1)
   use p12_sbars_epnemumnmubarg_config, only: ki
   use p12_sbars_epnemumnmubarg_model, only: NC, Nf
   implicit none
   save
...
end module p12_sbars_epnemumnmubarg_color
