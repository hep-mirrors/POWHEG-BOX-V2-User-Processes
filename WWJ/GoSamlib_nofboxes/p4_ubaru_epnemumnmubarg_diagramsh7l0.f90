module     p4_ubaru_epnemumnmubarg_diagramsh7l0
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p4_ubaru_epnemumnmubarg/helicity7diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(8)=4.0_ki*abb(1)*abb(2)*abb(3)*abb(4)*abb(5)*gHU*gHWW*spak4k5*spbk6k3&
...
!---#] function amplitude:
end module p4_ubaru_epnemumnmubarg_diagramsh7l0
