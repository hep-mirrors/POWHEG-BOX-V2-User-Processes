module     p0_dbard_epnemumnmubarg_abbrevd205h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb205(9)=gHD*gHWW*spak4k5*spbk6k3*c1*i_*TR*abb205(5)*abb205(3)*abb205(2)&
      &*abb205(1)
      abb205(10)=abb205(9)*abb205(6)*spbk7k1
      ...
      abb205(13)=abb205(8)*abb205(9)*spbk7k1**2
      abb205(13)=8.0_ki*abb205(13)
      abb205(15)=-spak1k2*abb205(6)*abb205(13)
      abb205(10)=4.0_ki*spbk7k2*spak1k2*abb205(10)
      abb205(8)=4.0_ki*spbk2k1*spbk7k1*abb205(9)*abb205(8)
      R2d205=0.0_ki
      rat2 = rat2 + R2d205
...
end module p0_dbard_epnemumnmubarg_abbrevd205h0
