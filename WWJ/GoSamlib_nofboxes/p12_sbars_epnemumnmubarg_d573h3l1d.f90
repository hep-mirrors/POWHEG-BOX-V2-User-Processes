module     p12_sbars_epnemumnmubarg_d573h3l1d
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_nobox/GoSam_POWHEG/Virt &
   ! &ual/p12_sbars_epnemumnmubarg/helicity3d573h3l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      acd573(11)=abb573(9)
      acd573(12)=abb573(7)
      acd573(13)=dotproduct(qshift,spvak1k7)
      acd573(14)=abb573(6)
      acd573(15)=abb573(10)
      acd573(16)=abb573(11)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd573(17)=abb573(7)
      acd573(18)=dotproduct(qshift,spvak1k7)
      acd573(19)=abb573(6)
      acd573(20)=abb573(10)
      acd573(21)=spvak1k7(iv1)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd573(4)=abb573(9)
      acd573(5)=k1(iv1)
      acd573(6)=spvak2k7(iv2)
      acd573(7)=abb573(15)
      acd573(8)=k1(iv2)
      acd573(9)=spvak2k7(iv1)
      acd573(10)=k2(iv1)
      acd573(11)=abb573(14)
      acd573(12)=k2(iv2)
      acd573(13)=k7(iv1)
...
!---#] subroutine reconstruct_d573:
end module     p12_sbars_epnemumnmubarg_d573h3l1d
