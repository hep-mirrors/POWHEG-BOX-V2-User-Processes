...
subroutine     reconstruct_group1(coeffs)
   ...
   use p12_sbars_epnemumnmubarg_d17h4l1, only: numerator_d17 => numerator_golem95
   use p12_sbars_epnemumnmubarg_d17h4l1d, only: reconstruct_d17
   ...
   use p12_sbars_epnemumnmubarg_d65h4l1, only: numerator_d65 => numerator_golem95
   use p12_sbars_epnemumnmubarg_d65h4l1d, only: reconstruct_d65
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p12_sbars_epnemumnmubarg_d41h4l1, only: numerator_d41 => numerator_golem95
   use p12_sbars_epnemumnmubarg_d41h4l1d, only: reconstruct_d41
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p12_sbars_epnemumnmubarg_d1h4l1, only: numerator_d1 => numerator_golem95
   use p12_sbars_epnemumnmubarg_d1h4l1d, only: reconstruct_d1
