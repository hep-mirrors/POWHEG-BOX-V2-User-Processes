module     p12_sbars_epnemumnmubarg_abbrevd559h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb559(9)=spak4k5*gHWW*gHS*abb559(5)*abb559(4)*abb559(3)*gW**2*abb559(1)*&
...
end module p12_sbars_epnemumnmubarg_abbrevd559h0
