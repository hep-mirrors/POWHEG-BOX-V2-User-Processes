module     p12_sbars_epnemumnmubarg_model
   ! Model parameters for the model: /users/pmonni/Programs/POWHEG-BOX-V2/WWJ_em
   ! u/GoSam_POWHEG/Virtual/model/model
...
end module p12_sbars_epnemumnmubarg_model
