module     p12_sbars_epnemumnmubarg_groups
...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use p12_sbars_epnemumnmubarg_config, only: debug_nlo_diagrams, logfile
   use p12_sbars_epnemumnmubarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7, es234, es345, es12, es671, es567, es23, es123, &
   ...
   !-------#[ Diagram 485:
      ...
      amp = + (contract5_4(coeffs%coeffs_485, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
...
function     contract_tensor_coefficients_group_1(coeffs) result(amp)
   ...
   !-------#[ Diagram 37:
      ...
      amp = amp + (contract4_3(coeffs%coeffs_37, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
   ...
   !-------#[ Diagram 65:
      ...
      amp = amp +  (contract3_3(coeffs%coeffs_65, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
...
function     contract_tensor_coefficients_group_2(coeffs) result(amp)
   ...
   !-------#[ Diagram 473:
      ...
      amp = amp + (contract5_4(coeffs%coeffs_473, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
...
function     contract_tensor_coefficients_group_3(coeffs) result(amp)
   ...
   !-------#[ Diagram 1:
      ...
      amp = +  (contract4_4(coeffs%coeffs_1, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
   ...
   !-------#[ Diagram 33:
      ...
      amp = amp + (contract4_3(coeffs%coeffs_33, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
   ...
   !-------#[ Diagram 477:
      ...
      amp = amp + (contract5_4(coeffs%coeffs_477, rmomenta, b_set))
      if(debug_nlo_diagrams) then
         dbg_amp = amp - dbg_amp
         write(logfile,100) &
            & "<result kind='nlo-finite' re='", real(dbg_amp%C, ki), &
...
!---#] subroutine ninja_exit:
end module p12_sbars_epnemumnmubarg_groups
