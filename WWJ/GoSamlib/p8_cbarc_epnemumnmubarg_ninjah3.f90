...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p8_cbarc_epnemumnmubarg_kinematics
   use p8_cbarc_epnemumnmubarg_model
   use p8_cbarc_epnemumnmubarg_d1h3l1, only: numerator_diagram1 => numerator_ni&
   &nja
   use p8_cbarc_epnemumnmubarg_d1h3l121, only: numerator_tmu_diagram1 => numera&
   &tor_tmu
   use p8_cbarc_epnemumnmubarg_d1h3l131, only: numerator_t3_diagram1 => numerat&
   &or_t3
   use p8_cbarc_epnemumnmubarg_d1h3l132, only: numerator_t2_diagram1 => numerat&
   &or_t2
   ...
   &ator_t2
   use p8_cbarc_epnemumnmubarg_d65h3l1, only: numerator_diagram65 => numerator_&
   &ninja
   use p8_cbarc_epnemumnmubarg_d65h3l121, only: numerator_tmu_diagram65 => nume&
   &rator_tmu
   use p8_cbarc_epnemumnmubarg_d65h3l131, only: numerator_t3_diagram65 => numer&
   &ator_t3
   use p8_cbarc_epnemumnmubarg_d65h3l132, only: numerator_t2_diagram65 => numer&
   &ator_t2
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p8_cbarc_epnemumnmubarg_kinematics
   use p8_cbarc_epnemumnmubarg_model
   use p8_cbarc_epnemumnmubarg_d41h3l1, only: numerator_diagram41 => numerator_&
   &ninja
   use p8_cbarc_epnemumnmubarg_d41h3l121, only: numerator_tmu_diagram41 => nume&
   &rator_tmu
   use p8_cbarc_epnemumnmubarg_d41h3l131, only: numerator_t3_diagram41 => numer&
   &ator_t3
   use p8_cbarc_epnemumnmubarg_d41h3l132, only: numerator_t2_diagram41 => numer&
   &ator_t2
...
subroutine     ninja_reduce_group3(scale2,tot,totr,ok)
   ...
   use p8_cbarc_epnemumnmubarg_kinematics
   use p8_cbarc_epnemumnmubarg_model
   use p8_cbarc_epnemumnmubarg_d17h3l1, only: numerator_diagram17 => numerator_&
   &ninja
   use p8_cbarc_epnemumnmubarg_d17h3l121, only: numerator_tmu_diagram17 => nume&
   &rator_tmu
   use p8_cbarc_epnemumnmubarg_d17h3l131, only: numerator_t3_diagram17 => numer&
   &ator_t3
   use p8_cbarc_epnemumnmubarg_d17h3l132, only: numerator_t2_diagram17 => numer&
   &ator_t2
