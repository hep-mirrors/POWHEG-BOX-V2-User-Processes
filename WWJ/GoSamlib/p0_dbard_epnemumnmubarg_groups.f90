module     p0_dbard_epnemumnmubarg_groups
...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use p0_dbard_epnemumnmubarg_config, only: debug_nlo_diagrams, logfile
   use p0_dbard_epnemumnmubarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7, es234, es345, es12, es671, es567, es23, es123, &
...
!---#] subroutine ninja_exit:
end module p0_dbard_epnemumnmubarg_groups
