module     p12_sbars_epnemumnmubarg_matrix
   ...
   use p12_sbars_epnemumnmubarg_model, only: Nf, NC, sqrt2, init_functions
   use p12_sbars_epnemumnmubarg_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p12_sbars_epnemumnmubarg_diagramsh0l0, only: amplitude0l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh0, only: samplitudeh0l1 => samplitude, &
        &   finite_renormalisation0 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh1l0, only: amplitude1l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh1, only: samplitudeh1l1 => samplitude, &
        &   finite_renormalisation1 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh2l0, only: amplitude2l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh2, only: samplitudeh2l1 => samplitude, &
        &   finite_renormalisation2 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh3l0, only: amplitude3l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh3, only: samplitudeh3l1 => samplitude, &
        &   finite_renormalisation3 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh4l0, only: amplitude4l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh4, only: samplitudeh4l1 => samplitude, &
        &   finite_renormalisation4 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh5l0, only: amplitude5l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh5, only: samplitudeh5l1 => samplitude, &
        &   finite_renormalisation5 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh6l0, only: amplitude6l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh6, only: samplitudeh6l1 => samplitude, &
        &   finite_renormalisation6 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_diagramsh7l0, only: amplitude7l0 => amplitude
   use p12_sbars_epnemumnmubarg_amplitudeh7, only: samplitudeh7l1 => samplitude, &
        &   finite_renormalisation7 => finite_renormalisation
   use p12_sbars_epnemumnmubarg_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, ok, h)
      ...
      if(PSP_check) then
         ...
         if(icheck.eq.3.and.PSP_verbosity) then
            ...
            write(42,'(4x,A15,A24,A3)') &
                 &  "<process name='","p12_sbars_epnemumnmubarg","'/>"
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use p12_sbars_epnemumnmubarg_dipoles, only: pi
      implicit none
      real(ki), dimension(7, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      ...
      case default
         ! not implemented
         print*, "In p12_sbars_epnemumnmubarg_matrix:"
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p12_sbars_epnemumnmubarg_config, only: logfile
      use p12_sbars_epnemumnmubarg_kinematics, only: init_event
      implicit none
      real(ki), dimension(7, 4), intent(in) :: vecs
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use p12_sbars_epnemumnmubarg_color, only: T1T1, &
      & T1T2, &
      & T1T7, &
      & T2T2, &
      & T2T7, &
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use p12_sbars_epnemumnmubarg_color, only: cmat => CC
      implicit none
   ...
   pure function square_7_1_sc(color_vector1, color_vector2) result(amp)
      use p12_sbars_epnemumnmubarg_color, only: cmat => T1T7
   ...
   pure function square_7_2_sc(color_vector1, color_vector2) result(amp)
      use p12_sbars_epnemumnmubarg_color, only: cmat => T2T7
...
end module p12_sbars_epnemumnmubarg_matrix
