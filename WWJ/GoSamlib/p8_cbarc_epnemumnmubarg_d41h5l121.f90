module     p8_cbarc_epnemumnmubarg_d41h5l121
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_emu/GoSam_POWHEG/Virtua &
   ! &l/p8_cbarc_epnemumnmubarg/helicity5d41h5l121.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      use p8_cbarc_epnemumnmubarg_abbrevd41h5
      implicit none
...
!---#[ subroutine numerator_tmu:
   ...
   & bind(c, name="p8_cbarc_epnemumnmubarg_d41h5_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p8_cbarc_epnemumnmubarg_d41h5l121
