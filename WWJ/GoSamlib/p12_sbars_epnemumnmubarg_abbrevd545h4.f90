module     p12_sbars_epnemumnmubarg_abbrevd545h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb545(5)=sqrt2**(-1)
      abb545(6)=spbk7k2**(-1)
      abb545(7)=abb545(5)*gHS*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb545(4)*abb&
      &545(3)*abb545(2)*abb545(1)
      abb545(8)=abb545(7)*spbk2k1**2
      abb545(9)=spak1k7*abb545(6)
...
end module p12_sbars_epnemumnmubarg_abbrevd545h4
