module     p0_dbard_epnemumnmubarg_abbrevd559h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb559(8)=spak4k5*gHWW*gHD*abb559(5)*abb559(4)*abb559(3)*gW**2*abb559(1)*&
...
end module p0_dbard_epnemumnmubarg_abbrevd559h4
