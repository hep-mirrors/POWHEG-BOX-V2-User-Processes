module    p4_ubaru_epnemumnmubarg_amplitudeh3
   use p4_ubaru_epnemumnmubarg_config, only: ki, &
       & reduction_interoperation
   use p4_ubaru_epnemumnmubarg_color, only: numcs
   use p4_ubaru_epnemumnmubarg_groups
   use precision_golem, only: ki_gol => ki
   use p4_ubaru_epnemumnmubarg_golem95h3
   use ninjago_module, only: ki_nin
   use p4_ubaru_epnemumnmubarg_ninjah3
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p4_ubaru_epnemumnmubarg_diagramsh3l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p4_ubaru_epnemumnmubarg_abbrevd33h3, only: init_abbrevd33 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd57h3, only: init_abbrevd57 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd177h3, only: init_abbrevd177 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd205h3, only: init_abbrevd205 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd281h3, only: init_abbrevd281 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd465h3, only: init_abbrevd465 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd485h3, only: init_abbrevd485 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd489h3, only: init_abbrevd489 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd573h3, only: init_abbrevd573 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd595h3, only: init_abbrevd595 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd603h3, only: init_abbrevd603 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd971h3, only: init_abbrevd971 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd1h3, only: init_abbrevd1 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd37h3, only: init_abbrevd37 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd61h3, only: init_abbrevd61 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd65h3, only: init_abbrevd65 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd191h3, only: init_abbrevd191 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd219h3, only: init_abbrevd219 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd285h3, only: init_abbrevd285 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd469h3, only: init_abbrevd469 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd481h3, only: init_abbrevd481 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd517h3, only: init_abbrevd517 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd559h3, only: init_abbrevd559 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd607h3, only: init_abbrevd607 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd41h3, only: init_abbrevd41 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd473h3, only: init_abbrevd473 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd587h3, only: init_abbrevd587 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd591h3, only: init_abbrevd591 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd17h3, only: init_abbrevd17 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd477h3, only: init_abbrevd477 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd545h3, only: init_abbrevd545 => init_abbrev
      use p4_ubaru_epnemumnmubarg_abbrevd599h3, only: init_abbrevd599 => init_abbrev
      use p4_ubaru_epnemumnmubarg_diagramsh3l0, only: amplitudel0 => amplitude
      use p4_ubaru_epnemumnmubarg_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p4_ubaru_epnemumnmubarg_golem95h3, only: reconstruct_golem95 => reconstruct_group
   use p4_ubaru_epnemumnmubarg_groups, only: contract_golem95
   use p4_ubaru_epnemumnmubarg_ninjah3, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p4_ubaru_epnemumnmubarg_golem95h3, only: reconstruct_golem95 => reconstruct_group
   use p4_ubaru_epnemumnmubarg_groups, only: contract_golem95
   use p4_ubaru_epnemumnmubarg_ninjah3, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p4_ubaru_epnemumnmubarg_golem95h3, only: reconstruct_golem95 => reconstruct_group
   use p4_ubaru_epnemumnmubarg_groups, only: contract_golem95
   use p4_ubaru_epnemumnmubarg_ninjah3, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p4_ubaru_epnemumnmubarg_golem95h3, only: reconstruct_golem95 => reconstruct_group
   use p4_ubaru_epnemumnmubarg_groups, only: contract_golem95
   use p4_ubaru_epnemumnmubarg_ninjah3, only: ninja_reduce => ninja_reduce_group3
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group3:
end module p4_ubaru_epnemumnmubarg_amplitudeh3
