module     p12_sbars_epnemumnmubarg_abbrevd559h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb559(5)=sqrt2**(-1)
      abb559(6)=spbk7k2**(-1)
      abb559(7)=spak1k7*spbk2k1**2
      abb559(8)=abb559(5)*gHS*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb559(4)*abb&
...
end module p12_sbars_epnemumnmubarg_abbrevd559h4
