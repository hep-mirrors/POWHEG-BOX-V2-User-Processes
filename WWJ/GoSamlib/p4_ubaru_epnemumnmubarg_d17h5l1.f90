module     p4_ubaru_epnemumnmubarg_d17h5l1
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_emu/GoSam_POWHEG/Virtua &
   ! &l/p4_ubaru_epnemumnmubarg/helicity5d17h5l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p4_ubaru_epnemumnmubarg_d17h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p4_ubaru_epnemumnmubarg_d17h5l1
