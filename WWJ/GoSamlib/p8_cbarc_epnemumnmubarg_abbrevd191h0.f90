module     p8_cbarc_epnemumnmubarg_abbrevd191h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb191(11)=spak4k5*gHWW*gHC*abb191(7)*abb191(6)*abb191(4)*abb191(3)*gW**2&
      &*abb191(1)*abb191(2)*spbk6k3*c1*TR*i_
      abb191(12)=4.0_ki*abb191(11)
      abb191(13)=abb191(12)*spbk7k1
      ...
      abb191(11)=8.0_ki*spbk7k1
      abb191(11)=-abb191(11)*abb191(9)
      abb191(9)=-16.0_ki*spbk7k1*abb191(9)
      abb191(10)=abb191(10)*abb191(12)
      abb191(12)=spbk2k1*abb191(10)
      abb191(10)=spbk7k2*abb191(10)
      R2d191=abb191(14)
      rat2 = rat2 + R2d191
...
end module p8_cbarc_epnemumnmubarg_abbrevd191h0
