module     p0_dbard_epnemumnmubarg_abbrevd545h4
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb545(5)=sqrt2**(-1)
      abb545(6)=spbk7k2**(-1)
      abb545(7)=abb545(5)*gHD*gHWW*spak4k5*spbk6k3*c1*gW**2*i_*TR*abb545(4)*abb&
...
end module p0_dbard_epnemumnmubarg_abbrevd545h4
