module     p12_sbars_epnemumnmubarg_abbrevd205h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb205(12)=spak4k5*gHWW*gHS*abb205(5)*abb205(3)*abb205(1)*abb205(2)*spbk6&
      &k3*c1*TR*i_
      abb205(13)=abb205(12)*spbk7k1
      ...
      abb205(12)=abb205(14)*abb205(12)*spbk7k1**2
      abb205(12)=8.0_ki*abb205(12)
      abb205(9)=abb205(9)*spak1k2
      abb205(16)=abb205(12)*abb205(9)
      abb205(13)=4.0_ki*abb205(13)
      abb205(13)=abb205(13)*abb205(14)
      abb205(9)=-abb205(13)*spbk7k2*abb205(9)
      abb205(13)=-spbk2k1*abb205(8)*abb205(13)
...
end module p12_sbars_epnemumnmubarg_abbrevd205h0
