module     p4_ubaru_epnemumnmubarg_d1h5l121
   ! file: /mnt/users/pmonni/Programs/POWHEG-BOX-V2/WWJ_emu/GoSam_POWHEG/Virtua &
   ! &l/p4_ubaru_epnemumnmubarg/helicity5d1h5l121.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      use p4_ubaru_epnemumnmubarg_abbrevd1h5
      implicit none
...
!---#[ subroutine numerator_tmu:
   ...
   & bind(c, name="p4_ubaru_epnemumnmubarg_d1h5_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p4_ubaru_epnemumnmubarg_d1h5l121
