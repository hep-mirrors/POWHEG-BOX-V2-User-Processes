      SUBROUTINE SREALMTRX_300(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_300/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_300(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_300(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,10  ),GWFCB ,AMP(2   ))          
     ...
     &     14  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,10  ),GWFCB ,AMP(4   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   3)-AMP(   4)
      REALMTRX_300 = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_300 =REALMTRX_300+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
