...
C ----------
     ...
     &     9   ))                                                          
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL JIOXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,11  ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,9   ),GWFCB ,AMP(3   ))          
