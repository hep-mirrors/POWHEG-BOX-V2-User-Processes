      SUBROUTINE SREALMTRX_313(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_313/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_313(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_313(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,14  ),GG ,AMP(3   ))             
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_313 =REALMTRX_313+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
