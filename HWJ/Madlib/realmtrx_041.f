...
C ----------
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,10  ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,9   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,10  ),GWFUD ,AMP(2   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      REALMTRX_041 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
