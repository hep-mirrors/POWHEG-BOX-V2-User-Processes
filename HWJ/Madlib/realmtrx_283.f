      SUBROUTINE SREALMTRX_283(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_283/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_283(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_283(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
     ...
     &     11  ))                                                          
      ...
      CALL FVIXXX(W(1,7   ),W(1,10  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     13  ))                                                          
      CALL JIOXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,14  ),GG ,AMP(3   ))             
      CALL JIOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_283 =REALMTRX_283+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
