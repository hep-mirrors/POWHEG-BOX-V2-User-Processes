      SUBROUTINE SREALMTRX_291(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_291/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_291(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_291(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,10  ),GWFCB ,AMP(2   ))          
      CALL JIOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,13  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,10  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,15  ),GG ,AMP(4   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   3)+AMP(   4)
      REALMTRX_291 = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_291 =REALMTRX_291+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
