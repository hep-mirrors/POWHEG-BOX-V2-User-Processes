      SUBROUTINE SREALMTRX_288(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_288/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_288(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_288(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     9   ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,9   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL JIOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,11  ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,13  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,9   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL JIOXXX(W(1,14  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,15  ),GG ,AMP(3   ))             
      CALL JIOXXX(W(1,7   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_288 =REALMTRX_288+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
