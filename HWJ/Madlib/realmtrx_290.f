      SUBROUTINE SREALMTRX_290(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_290/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_290(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_290(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,9   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,10  ),GWFCS ,AMP(2   ))          
      JAMP(   1) = -AMP(   1)-AMP(   2)
      REALMTRX_290 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          REALMTRX_290 =REALMTRX_290+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
