      SUBROUTINE SREALMTRX_204(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_204/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_204(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_204(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,9   ),W(1,10  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,2   ),GG ,AMP(1   ))             
      CALL JVVXXX(W(1,7   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     13  ))                                                          
     ...
     &     19  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_204 =REALMTRX_204+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
