...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,9   ),W(1,10  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,2   ),GG ,AMP(1   ))             
      CALL JVVXXX(W(1,7   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     13  ))                                                          
      ...
      CALL FVIXXX(W(1,9   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,10  ),GWFUB ,AMP(5   ))          
      CALL FVIXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
