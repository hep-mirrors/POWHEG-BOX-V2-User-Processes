      SUBROUTINE SREALMTRX_275(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_275/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_275(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_275(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,13  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,9   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_275 =REALMTRX_275+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
