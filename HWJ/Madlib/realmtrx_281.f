      SUBROUTINE SREALMTRX_281(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_281/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_281(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_281(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     17  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,17  ),W(1,6   ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,18  ),G ,AMP(7   ))              
      CALL FVOXXX(W(1,17  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,2   ),W(1,19  ),W(1,6   ),GG ,AMP(8   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_281 =REALMTRX_281+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
