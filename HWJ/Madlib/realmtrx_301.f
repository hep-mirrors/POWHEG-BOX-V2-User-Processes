      SUBROUTINE SREALMTRX_301(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_301/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_301(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_301(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     11  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,11  ),GWFUD ,AMP(1   ))          
      CALL FVIXXX(W(1,7   ),W(1,11  ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_301 =REALMTRX_301+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
