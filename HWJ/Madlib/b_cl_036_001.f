      SUBROUTINE SB_CL_036_001(P1,ANS)
C  
...
C  
C BORN AMPLITUDE IS g b~ -> h e+ ve c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_036_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_036_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,8   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,9   ),W(1,1   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,6   ),W(1,10  ),W(1,8   ),GWFCB ,AMP(2   ))          
      do i=1,ngraphs
         if(ihel.eq.-1)then
      ...
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_036_001=B_CL_036_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_036_001=B_CL_036_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
