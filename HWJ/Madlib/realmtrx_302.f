      SUBROUTINE SREALMTRX_302(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_302/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_302(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_302(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL JIOXXX(W(1,4   ),W(1,5   ),GWF ,WMASS   ,WWIDTH  ,W(1,9   ))    
      CALL FVIXXX(W(1,7   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL JVSXXX(W(1,9   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     11  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,11  ),GWFCD ,AMP(1   ))          
      CALL FVIXXX(W(1,7   ),W(1,11  ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,8   ),GG ,AMP(2   ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)
      REALMTRX_302 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          REALMTRX_302 =REALMTRX_302+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
