...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      ph_sthw2 = abs(1d0-ph_cthw**2)
      ph_sthw = sqrt(ph_sthw2)

      ph_alphaem = sqrt(2d0)*ph_gfermi*ph_Wmass2/pi*ph_sthw2
      em_alpha = ph_alphaem
