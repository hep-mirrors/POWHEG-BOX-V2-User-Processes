...
C     -- factor 2 accounts for emu + 1/2 ee + 1/2 mumu
         wsymfact=2d0
      elseif(vdecaymodeW1.eq.vdecaymodeW2 .and. 
     .     abs(vdecaymodeW1) .eq. 135) then
C     -- factor 4.5 accounts for emu,mutau,etau, + 1/2 ee + 1/2 mumu +1/3 tautau
         wsymfact=4.5d0
