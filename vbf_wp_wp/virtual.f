...
c
      subroutine compvirt_ew(pin,bflav,virtual)
      implicit none
c
      include 'nlegborn.h'
      include 'pwhg_math.h'
...
c triangles:
      call qqwppqq_vonly(pbar,fsign,4,1,bos,tri) 
c boxes:
      call qqwppqq_vonly(pbar,fsign,-4,1,bos,box) 
c pentagons:
      call qqwppqq_vonly(pbar,fsign,-5,1,bos,pent)
