...
C     - Boson kinematics fully inclusive w.r.t radiation:
      ...
      call bookupeqbins(pr//'-PTZ2l1',dpt,0d0,400d0)
      call bookupeqbins(pr//'-PTZ2l2',dpt,0d0,400d0)
      ...
      call bookupeqbins(pr//'-M4l',dpt,100d0,1000d0)
      call bookupeqbins(pr//'-MZ1',dM,50d0,150d0)
      call bookupeqbins(pr//'-MZ2',dM,50d0,150d0)
...
c      common/cWHCPRG/WHCPRG
     ...
     1    phij(maxjet),pj(4,maxjet),rr,rjl,ptrel(4),pjet_in(4,maxjet) 
      ...
      real * 8 powheginput,dotp,pt_veto
...
C     -- VBF cuts 
     ...
     $        (y_Z2l1.lt.rapj_in(1).and.y_Z2l1.lt.rapj_in(2))) return !Requires the leptons to fall between the two tagging jets
      ...
      ptmp = p_Z2l2+p_Z2l1
      mZ2 = invmass(ptmp)
      if (mZ2 < mz_min .or. mZ2 > mz_max) return 
