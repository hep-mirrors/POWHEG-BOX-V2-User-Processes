...
c
   ...
   10 FORMAT(20(1H-),a,20(1H-))
      ...
      write(6,11) 1./ALFA,SIN2W,ALFAS,XMZ,XMW,XMH,XMT
   11 FORMAT(/,
...
c	gauge-higgs boson couplings:
	...
	gwwhh = dcmplx( ee2/sin2w*0.5d0 )
        ...
        ghhhh = ghhh/vv
c MadGraph 5 variables
        complexi = dcmplx(0D0,1D0)
        g1       = ee/cw
        vev      = (2.000000D+00*MW*SW)/EE
        CWWWL2   = powheginput('CWWWL2')
        CWL2     = powheginput('CWL2')
        CBL2     = powheginput('CBL2')
        CPWWWL2  = powheginput('CPWWWL2')
        CPWL2    = powheginput('CPWL2')
              
        GC_1 = -(EE*COMPLEXI)/3.000000D+00
        GC_2 = (2.000000D+00*EE*COMPLEXI)/3.000000D+00
        GC_3 = -(EE*COMPLEXI)
        GC_7 = CW*COMPLEXI*GW
        GC_12 = CW**2*COMPLEXI*GW**2
        GC_18 = (CPWWWL2*CW*COMPLEXI*GW**3)/4.000000D+06
        GC_20 = (3.000000D+00*CW*CWWWL2*COMPLEXI*GW**3)/2.000000D+06
        GC_22 = (CPWWWL2*CW**2*COMPLEXI*GW**4)/2.000000D+06
        GC_25 = (3.000000D+00*CW**2*CWWWL2*COMPLEXI*GW**4)
     $       /2.000000D+06
        GC_42 = (EE*COMPLEXI)/(SW*SQRT(2D0))
        GC_43 = -(CW*EE*COMPLEXI)/(2.000000D+00*SW)
        GC_44 = (CW*EE*COMPLEXI)/(2.000000D+00*SW)
        GC_45 = -(EE*COMPLEXI*SW)/(6.000000D+00*CW)
        GC_46 = (EE*COMPLEXI*SW)/(2.000000D+00*CW)
        GC_47 = COMPLEXI*GW*SW
        GC_49 = -2.000000D+00*CW*COMPLEXI*GW**2*SW
        GC_55 = (CPWWWL2*COMPLEXI*GW**3*SW)/4.000000D+06
        GC_57 = (3.000000D+00*CWWWL2*COMPLEXI*GW**3*SW)/2.000000D+06
        GC_58 = (CPWWWL2*CW*COMPLEXI*GW**4*SW)/2.000000D+06
        GC_59 = (-3.000000D+00*CW*CWWWL2*COMPLEXI*GW**4*SW)
     $       /2.000000D+06
        GC_66 = COMPLEXI*GW**2*SW**2
        GC_67 = (CPWWWL2*COMPLEXI*GW**4*SW**2)/2.000000D+06
        GC_68 = (3.000000D+00*CWWWL2*COMPLEXI*GW**4*SW**2)
     $       /2.000000D+06
        GC_74 = (CW*EE*COMPLEXI)/(2.000000D+00*SW)+(EE*COMPLEXI
     $       *SW)/(2.000000D+00*CW)
        GC_86 = -(CPWL2*CW**2*COMPLEXI*G1*GW*VV)/8.000000D+06
        GC_88 = (CWL2*COMPLEXI*GW**2*VV)/4.000000D+06
        GC_96 = (EE**2*COMPLEXI*VV)/(2.000000D+00*SW**2)
        GC_97 = -(CPWL2*CW*COMPLEXI*GW**2*SW*VV)/8.000000D+06
        GC_103 = -(CPWL2*COMPLEXI*G1*GW*SW**2*VV)/8.000000D+06
        GC_104 = -(CBL2*CW*COMPLEXI*G1*GW**2*VV**2)/8.000000D+06
        GC_105 = (CPWL2*CW*COMPLEXI*G1*GW**2*VV**2)/8.000000D+06
        GC_108 = -(CW*CWL2*COMPLEXI*GW**3*VV**2)/8.000000D+06
        GC_110 = (CBL2*COMPLEXI*G1*GW**2*SW*VV**2)/8.000000D+06
        GC_112 = -(CWL2*COMPLEXI*G1*GW**2*SW*VV**2)/8.000000D+06
        GC_114 = -(CWL2*COMPLEXI*GW**3*SW*VV**2)/8.000000D+06
        GC_115 = -(CPWL2*CW**2*COMPLEXI*GW**2*VV)/8.000000D
     $       +06-(CPWL2*CW*COMPLEXI*G1*GW*SW*VV)/8.000000D+06
        GC_116 = -(CBL2*CW*COMPLEXI*G1**2*SW*VV)/4.000000D+06
     $       +(CW*CWL2*COMPLEXI*GW**2*SW*VV)/4.000000D+06
        GC_118 = EE**2*COMPLEXI*VV+(CW**2*EE**2*COMPLEXI
     $       *VV)/(2.000000D+00*SW**2)+(EE**2*COMPLEXI*SW**2
     $       *VV)/(2.000000D+00*CW**2)
        GC_119 = (CW**2*CWL2*COMPLEXI*GW**2*VV)/4.000000D+06
     $       +(CBL2*CW*COMPLEXI*G1*GW*SW*VV)/4.000000D+06+(CW*CWL2*COMPLEXI
     $       *G1*GW*SW*VV)/4.000000D+06+(CBL2*COMPLEXI*G1**2*SW**2
     $       *VV)/4.000000D+06
        GC_120 = -(CW**2*CWL2*COMPLEXI*G1*GW*VV)/4.000000D+06
     $       +(CBL2*COMPLEXI*G1*GW*SW**2*VV)/4.000000D+06
        GC_126 = -(CW**2*CWL2*COMPLEXI*GW**4*VV**2)
     $       /4.000000D+06-(CW*CWL2*COMPLEXI*G1*GW**3*SW*VV**2)
     $       /4.000000D+06
        GC_127 = -(CW**2*CWL2*COMPLEXI*G1*GW**3*VV**2)
     $       /4.000000D+06+(CW*CWL2*COMPLEXI*GW**4*SW*VV**2)
     $       /2.000000D+06+(CWL2*COMPLEXI*G1*GW**3*SW**2*VV**2
     $       )/4.000000D+06
