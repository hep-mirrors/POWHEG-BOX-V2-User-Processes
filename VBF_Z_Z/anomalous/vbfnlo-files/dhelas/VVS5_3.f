...
C     
     ...
     $ -CI* W3))
      S3(3)= DENOM*2D0*(-CI*(TMP26+TMP25)+CI*(TMP23+TMP28))
      END
...
C     2,-1,-2)*P(-2,2)*P(-1,3)
C     
      SUBROUTINE VVS5_9_3(V1, V2, COUP1, COUP2, M3, W3,S3)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
      ...
      INTEGER*4 I
      COMPLEX*16 V1(*)
      CALL VVS5_3(V1,V2,COUP1,M3,W3,S3)
      CALL VVS9_3(V1,V2,COUP2,M3,W3,STMP)
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
      END
