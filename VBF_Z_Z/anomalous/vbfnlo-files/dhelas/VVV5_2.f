...
c     IF (M2.NE.0D0) OM2=1D0/M2**2
     ...
     $ +(V1(3)*(-CI*(TMP24)+CI*(TMP27))+(-CI*(V3(3)*TMP12)+CI*(P1(0)
     $ *TMP35))))
      V2(4)= DENOM*(OM2*P2(1)*(-CI*(TMP6*TMP35)+CI*(TMP12*TMP24))
     $ +(V1(4)*(-CI*(TMP24)+CI*(TMP27))+(-CI*(V3(4)*TMP12)+CI*(P1(1)
     $ *TMP35))))
      V2(5)= DENOM*(OM2*P2(2)*(-CI*(TMP6*TMP35)+CI*(TMP12*TMP24))
     $ +(V1(5)*(-CI*(TMP24)+CI*(TMP27))+(-CI*(V3(5)*TMP12)+CI*(P1(2)
     $ *TMP35))))
      V2(6)= DENOM*(OM2*P2(3)*(-CI*(TMP6*TMP35)+CI*(TMP12*TMP24))
     $ +(V1(6)*(-CI*(TMP24)+CI*(TMP27))+(-CI*(V3(6)*TMP12)+CI*(P1(3)
     $ *TMP35))))
      END
