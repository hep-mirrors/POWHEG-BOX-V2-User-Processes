...
C     2*Epsilon(1,2,3,-1)*P(-1,1) + 2*Epsilon(1,2,3,-1)*P(-1,2)
C     
      SUBROUTINE VVV1_10_3_5_6_7_9_0(V1, V2, V3, COUP1, COUP2, COUP3
     $ , COUP4, COUP5, COUP6, COUP7,VERTEX)
      ...
      CALL VVV10_0(V1,V2,V3,COUP2,TMP)
      VERTEX = VERTEX + TMP
      CALL VVV3_0(V1,V2,V3,COUP3,TMP)
      VERTEX = VERTEX + TMP
      CALL VVV5_0(V1,V2,V3,COUP4,TMP)
      VERTEX = VERTEX + TMP
      CALL VVV6_0(V1,V2,V3,COUP5,TMP)
      VERTEX = VERTEX + TMP
      CALL VVV7_0(V1,V2,V3,COUP6,TMP)
      VERTEX = VERTEX + TMP
