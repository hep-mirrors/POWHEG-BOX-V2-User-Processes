...
c     MadGraph 5 variables
      ...
      GC_4 = EE*COMPLEXI
      GC_5 = EE**2*COMPLEXI
      GC_36 = (CW**2*EE**2*COMPLEXI)/SW**2
      GC_50 = -(CW*EE*COMPLEXI)/(2.000000D+00*SW)
      GC_51 = (CW*EE*COMPLEXI)/(2.000000D+00*SW)
      GC_53 = (CW*EE*COMPLEXI)/SW
      GC_57 = (-2.000000D+00*CW*EE**2*COMPLEXI)/SW
      GC_58 = -(EE*COMPLEXI*SW)/(6.000000D+00*CW)
      GC_59 = (EE*COMPLEXI*SW)/(2.000000D+00*CW)
      GC_62 = (CW*EE*COMPLEXI)/(2.000000D+00*SW)+(EE*COMPLEXI
     $     *SW)/(2.000000D+00*CW)
      GC_72 = (EE**2*COMPLEXI*VEV)/(2.000000D+00*SW**2)
      GC_81 = EE**2*COMPLEXI*VEV+(CW**2*EE**2*COMPLEXI
     $     *VEV)/(2.000000D+00*SW**2)+(EE**2*COMPLEXI*SW**2
     $     *VEV)/(2.000000D+00*CW**2)
      GC_100 = (EE*COMPLEXI)/(SW*SQRT(2D0))
