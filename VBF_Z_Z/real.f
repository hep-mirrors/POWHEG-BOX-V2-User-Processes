...
c
      ...
      if ( pzsum.ne.pidr) then ! new PS point -> compute tensors
         call compute_tensors_zz_real(p) 
         pidr = 0d0
         do j = 1,nleg
      ...
      call compreal_zzjj_ew(p,fermion_flav,amp2)
...
c
      subroutine compreal_zzjj_ew(pin,bflav,amp2)
      implicit none
c
      include 'nlegborn.h'
      include 'pwhg_math.h'
...
c k-ordering is: uucc,uuss,ddcc,ddss,udsc,ducs
      ...
      call qqzzqqj(pbar,fsign,qbar,gsign,bos,k,res(1))
