...
c.....mauro-kine ADDED
     ...
     +     mc_dlberad
      ...
      common/mcfix/mc_emitter
c
      if(mc_emitter.eq.-100) then
         write(*,*)'error in 2 rad proc'
         stop
      endif
...
c         loc_fl=flst_real(i1,rad_realidx)      ! set before by gen_real_idx
      ...
      loc_xb1=kn_x1
      loc_xb2=kn_x2
      loc_em =mc_emitter +1 ! +1 as it these arrays want the resonance as a particle
      loc_csi=mc_csifsr
      loc_y  =mc_yfsr
      loc_azi=mc_azifsr
...
c            condition = kt2max.lt.kt2minqed ! Z specific 2 fsr regions, both from Z
            condition = kt2max.lt.kt2minqed.or.kt2max.lt.mc_tmaxfsr
         endif
         if(condition) then
c.....mauro-kine
            t=-1
...
c     condition = t.lt.kt2minqed  ! Z specific 2 fsr regions, both from Z
         condition = t.lt.kt2minqed.or.t.lt.mc_tmaxfsr !
      endif
      if(condition) then
c.....mauro-kine
c.....mod:         
