...
c
      ...
      double precision  tau,series_t,series_p,tau_t,tau_w,series_a
...
c$$$        tau = hmass**2/(4d0*tmass**2)
c$$$	    series_t = 1d0 + tau*7d0/30d0 + tau**2*2d0/21d0 + tau**3*26d0/525d0
c$$$	    series_p = 1d0 + tau/3d0      + tau**2*8d0/45d0 + tau**3*4d0/35d0
        series_t=1d0
        series_p=1d0
...
c----------------------------
      ...
      subroutine lh_readin_mad(param_name)
c----------------------------------------------------------------------
...
99	continue      
       ...
       call set_it(n,ivalue,value,name,7,bn,lmass,0d0)
       bn="mgyukawa"
       call set_it(n,ivalue,value,name,4,bn,mcMS,0d0)
       call set_it(n,ivalue,value,name,5,bn,mbMS,0d0)
