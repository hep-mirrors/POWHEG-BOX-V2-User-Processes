...
* CH: modified: use the parameters from pwhg_math, uncomment electroweak parameters

!#include "pwhg_math.h"
!#include "PhysPars.h"
c CH: pi, sqrt2 in pwhg_math defined
	double precision degree!, pi,  sqrt2, hbar_c2
...
* SM parameters
!  CH: masses set in Virtual.f!!!
	double precision MU, MU2, MC, MC2, MT, MT2
	double precision MD, MD2, MS, MS2, MB, MB2, MBatMB

! for Powheg: attach apropiate factors of alfas "by hand"->set alphas=1
	double precision Alfas,Alfas2
	parameter (Alfas=1.d0,Alfas2=Alfas**2)
!  ORIGINAL MODEL_FILE:
...
! 	common /sm_para/ Alfas, Alfas2, AlfasMT, SW,EL, GS, 
...
!	common /sm_para/alfas,alfas2

	save /sm_para/
* MSSM parameters
! comment out all parameters which are not needed!
...
! 	double complex Atau, At, Ab, MUE
	double complex Mino3!,Mino1, Mino2, SqrtEGl
! 	double precision MCha(2), MCha2(2), MNeu(4), MNeu2(4)
! 	double precision MSS(2,2:4,3), MSS2(2,2:4,3), DSf(2,4)
	double precision MSf(2,4,3), MSf2(2,4,3), MGl, MGl2!,MSUSY
! 	double precision MHiggs(4), MHiggs2(4), MHiggstree2(4) ! CH: Higgs-masses
...
! 	common /mssm_para/ Atau, At, Ab, MUE
	common /mssm_para/ Mino3!,Mino1, Mino2, SqrtEGl
! 	common /mssm_para/ MCha, MCha2, MNeu, MNeu2
! 	common /mssm_para/ MSS, MSS2, DSf
	common /mssm_para/ MSf, MSf2,  MGl, MGl2!,MSUSY
