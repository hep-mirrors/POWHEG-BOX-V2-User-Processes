...
* CH: modify: do not need all the functions in util-> keep only those related to kin and system-folders!

c CH: these functions appear in /kin/..-> keep them all
