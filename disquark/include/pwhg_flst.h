...
c CH: added flst_regularsplit and nregularsplit for the case we want to split the real ampsq...
c CH: added flst_sumup 
...
c resonace's decay products, zero for the other particles.
     ...
     2     flst_regularres(nlegreal,maxprocreal)
      integer flst_nregularsplit,flst_regularsplit(nlegreal,maxprocreal)
...
c     born2alr(1.. born2alr(0,k),k)= pointer to corresponding alpha_r
     ...
     4     flst_nregularsplit,flst_regularsplit,
     ...
     1     flst_isres,flst_cur_iborn,flst_cur_alr,flst_sumup
      save /pwhg_flst/
