ccc colour stripped partial amplitude for M2M5
     ...
     .      *(2*s-2*s1+t2)))/(s*(mgo**2-t1))
              ...
              M2M5 = 
     .      (4*(-2*msq2**2*(msq1**2-s)*(msq1**2-t1)+mgo**4*(-2*msq1**2-2*s
     .      +s1+2*t1-t2)+mgo**2*(2*msq1**4+msq2**2*(s-2*t1)+(s+s1)*t1-s*t2
     .      +msq1**2*(2*msq2**2-2*(s1+t1)+t2))))/(s*(mgo**2-t1))
            else
     ...
     .      (4*mgo**2*(s1-t2))/(s*(-mgo**2+t1))
              ...
              M2M5 = 
     .      (-4*(2*(msq1**2+msq2**2-s1)*(-msq1**2+t1)+mgo**2*(4*msq1**2+2
     .      *s-s1-4*t1+t2)))/(s*(mgo**2-t1))
            else
              write(*,*) 'Error in M2M5: deltac1c2=',deltac1c2
            endif
     ...
     .      -t1)*t2)))/(npg*s*(mgo**2-t1))
              ...
              M2M5 = 
     .      (4*(-(mgo**4*msq1**2*npg)+2*mgo**2*msq1**4*npg+mgo**2*msq1**2
     .      *msq2**2*npg-2*msq1**4*msq2**2*npg+mgo**2*msq1**2*nk2*s-msq1*
     .      *2*msq2**2*nk2*s-mgo**4*nkq*s+mgo**2*msq1**2*nkq*s-msq1**2*msq2
     .      **2*nkq*s-mgo**4*npg*s+mgo**2*msq2**2*npg*s+2*msq1**2*msq2**2
     .      *npg*s+mgo**2*nk2*s**2-2*mgo**2*msq1**2*npg*s1-mgo**2*nk2*s*s1
     .      -mgo**2*nkq*s*s1-2*mgo**2*msq1**2*npg*s2g+2*msq1**4*npg*s2g+msq1
     .      **2*msq2**2*npg*s2g+msq1**2*nk2*s*s2g-mgo**2*nkq*s*s2g-mgo**2
     .      *npg*s*s2g-2*msq1**2*npg*s1*s2g-msq1**2*npg*s2g**2+mgo**4*npg
     .      *t1-3*mgo**2*msq1**2*npg*t1-mgo**2*msq2**2*npg*t1+3*msq1**2*msq2
     .      **2*npg*t1-mgo**2*nk2*s*t1+msq2**2*nk2*s*t1+msq2**2*nkq*s*t1-2
     .      *msq2**2*npg*s*t1+2*mgo**2*npg*s1*t1+2*mgo**2*npg*s2g*t1-3*msq1
     .      **2*npg*s2g*t1-msq2**2*npg*s2g*t1-nk2*s*s2g*t1+2*npg*s1*s2g*t1
     .      +npg*s2g**2*t1+mgo**2*npg*t1**2-msq2**2*npg*t1**2+npg*s2g*t1*
     .      *2+mgo**2*msq1**2*npg*t2+msq1**2*npg*s2g*t2-mgo**2*npg*t1*t2-npg
     .      *s2g*t1*t2+npq*(-mgo**6+msq2**2*s**2-s*s1*s2g+msq2**2*s2g**2+s
     .      *s2g**2-s1*s2g**2-s2g**3-msq2**2*s*t1+s1*s2g*t1-msq2**2*t1**2
     .      +s2g*t1**2-s2g*t1*t2+mgo**4*(2*msq1**2+msq2**2-2*s1-3*s2g+t2)
     .      +msq1**2*(-((msq2**2-s2g)*(s+2*s2g-2*t1))+s2g*t2)+mgo**2*(-(s
     .      *s1)+s*s2g-3*s1*s2g-3*s2g**2+2*msq2**2*(s+s2g)+msq1**2*(-2*msq2
     .      **2+s+4*s2g-2*t1)-s*t1+2*s1*t1+t1**2+(s+s2g-t1)*t2))-nk1*s*(mgo
     .      **4+msq2**2*s-msq2**2*s2g-s1*s2g+s2g**2+msq1**2*(-msq2**2+s2g)
     .      +2*msq2**2*t1-2*s2g*t1+2*s2g*t2+mgo**2*(msq1**2-msq2**2-s1+2*(s2g
     .      -t1+t2)))))/(npg*s*(mgo**2-t1))
            else
              write(*,*) 'Error in M2M5: deltac1c2=',deltac1c2
            endif
        ...
        write(*,*) 'Error in amplitude-routine M2M52 for the qg-contributions:' 
        write(*,*) 'gauge = ',gauge
        call exit(-1)
      endif
      end
