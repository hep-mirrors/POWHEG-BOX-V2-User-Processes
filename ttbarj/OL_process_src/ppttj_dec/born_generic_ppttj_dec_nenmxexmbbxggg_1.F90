...
module ol_external_ppttj_dec_nenmxexmbbxggg_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppttj_dec_nenmxexmbbxggg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: external_perm_inv_ppttj_dec_nenmxexmbbxggg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: extcomb_perm_ppttj_dec_nenmxexmbbxggg_1(0:46) = &
                     [ (dummy_counter, dummy_counter = 0, 46) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppttj_dec_nenmxexmbbxggg_1(9) = &
                     [ 1, 2, 3, 4, 5, 6, 7, 7, 7 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppttj_dec_nenmxexmbbxggg_1(9) = &
                     [ 2, 2, 2, 2, 6, 6, 16, 16, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppttj_dec_nenmxexmbbxggg_1 = &
                     24
  integer, save :: channel_number_ppttj_dec_nenmxexmbbxggg_1 = -1
  ...
  integer, save :: photonid_ppttj_dec_nenmxexmbbxggg_1(9) = 0

  contains

  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppttj_dec_nenmxexmbbxggg_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppttj_dec_nenmxexmbbxggg_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppttj_dec_nenmxexmbbxggg_1")
    ...
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppttj_dec_nenmxexmbbxggg_1(9)
    external_perm_ppttj_dec_nenmxexmbbxggg_1 = perm
    do i = 1, 9
      external_perm_inv_ppttj_dec_nenmxexmbbxggg_1( &
        external_perm_ppttj_dec_nenmxexmbbxggg_1(i)) = i
      particle_types_perm_ppttj_dec_nenmxexmbbxggg_1(i) = &
        particle_types_ppttj_dec_nenmxexmbbxggg_1( &
        external_perm_ppttj_dec_nenmxexmbbxggg_1(i))
    end do
    do i = 1, 9
      do j = 1, i
        if (external_perm_ppttj_dec_nenmxexmbbxggg_1(i) >= &
          external_perm_ppttj_dec_nenmxexmbbxggg_1(j)) then
          ii = external_perm_ppttj_dec_nenmxexmbbxggg_1(i)
          jj = external_perm_ppttj_dec_nenmxexmbbxggg_1(j)
        else
          ii = external_perm_ppttj_dec_nenmxexmbbxggg_1(j)
          jj = external_perm_ppttj_dec_nenmxexmbbxggg_1(i)
        end if
        extcomb_perm_ppttj_dec_nenmxexmbbxggg_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppttj_dec_nenmxexmbbxggg_1 = 1
    do i = 1, n_scatt
      average_factor_ppttj_dec_nenmxexmbbxggg_1 = &
        average_factor_ppttj_dec_nenmxexmbbxggg_1 &
        * average_factors_ppttj_dec_nenmxexmbbxggg_1( &
        external_perm_ppttj_dec_nenmxexmbbxggg_1(i))
    end do
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 9
        average_factor_ppttj_dec_nenmxexmbbxggg_1 = &
          average_factor_ppttj_dec_nenmxexmbbxggg_1 &
          * factorial(count(particle_types_perm_ppttj_dec_nenmxexmbbxggg_1(n_scatt+1:9) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppttj_dec_nenmxexmbbxggg_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppttj_dec_nenmxexmbbxggg_1")
    ...
    m_ex_orig = [ rZERO, rZERO, rZERO, rZERO, rMB_unscaled, rMB_unscaled, rZERO, rZERO, rZERO ]
    do i = 1, 9
      m_ex(i) = m_ex_orig(external_perm_ppttj_dec_nenmxexmbbxggg_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppttj_dec_nenmxexmbbxggg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppttj_dec_nenmxexmbbxggg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppttj_dec_nenmxexmbbxggg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
  ...
  H_HC(:,7) = [ ((((2*(binco-1)+flip)*4+binpos, flip = 0, 1), binpos = 1, 4), binco = 1, 512/4/2) ]
  H_HC(:,8) = [ ((((2*(binco-1)+flip)*2+binpos, flip = 0, 1), binpos = 1, 2), binco = 1, 512/2/2) ]
  H_HC(:,9) = [ ((((2*(binco-1)+flip)*1+binpos, flip = 0, 1), binpos = 1, 1), binco = 1, 512/1/2) ]
  end subroutine hel_init


  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
  ...
  subroutine set_photons(photon_id) &
      & bind(c,name="ol_f_set_photons_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
    integer, intent(in) :: photon_id(9)
    photonid_ppttj_dec_nenmxexmbbxggg_1 = photon_id
  end subroutine set_photons


end module ol_external_ppttj_dec_nenmxexmbbxggg_1


module ol_settings_ppttj_dec_nenmxexmbbxggg_1
  implicit none
  ...
  subroutine set_hel_mem_opt(set) &
      & bind(c,name="ol_hel_mem_opt_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
  ...
  subroutine set_loopcc(set,was) &
      & bind(c,name="ol_loopcc_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
    logical, intent(in) :: set
    logical :: was
    was = loopcc
...
end module ol_settings_ppttj_dec_nenmxexmbbxggg_1

module colour_basis_ppttj_dec_nenmxexmbbxggg_1
  implicit none
  ! tree colour basis
  integer, save :: extcolours(9) = [0,0,0,0,1,1,2,2,2]
  contains

  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppttj_dec_nenmxexmbbxggg_1")
    implicit none
    ...
    basis = reshape( &
      [2,66,4,2,72,4,2,90,4,2,96,4,2,114,4,2,120,4], &
      [3,6])
#endif
  end subroutine tree_colbasis

end module colour_basis_ppttj_dec_nenmxexmbbxggg_1

! **********************************************************************
module ol_heltables_ppttj_dec_nenmxexmbbxggg_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(10), n3(3,47), n4(4,3)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x64(2,64,1), t3x4(2,4,5), t3x8(2,8,5), t3x16(2,16,6), t3x32(2,32,12), t3x512(2,512,18), t4x8(3,8,3)
...
! **********************************************************************
  ...
  n2(3) = 8
  n2(4) = 8
  call heltable([8,8,64], n3(:,5), t3x64(:,:,1))
  ...
  call heltable([8,4,32], n3(:,8), t3x32(:,:,1))
  n2(5) = 16
  call heltable([8,2,16], n3(:,9), t3x16(:,:,2))
  call heltable([4,8,32], n3(:,10), t3x32(:,:,2))
  n2(6) = 16
  call heltable([4,2,8], n3(:,11), t3x8(:,:,3))
  call heltable([2,2,4], n3(:,12), t3x4(:,:,4))
  call heltable([2,8,16], n3(:,13), t3x16(:,:,3))
  call heltable([8,4,32], n3(:,14), t3x32(:,:,3))
  n2(7) = 16
  call heltable([8,2,16], n3(:,15), t3x16(:,:,4))
  ...
  call heltable([8,4,32], n3(:,20), t3x32(:,:,5))
  n2(9) = 16
  call heltable([8,2,16], n3(:,21), t3x16(:,:,6))
  call heltable([4,8,32], n3(:,22), t3x32(:,:,6))
  n2(10) = 16
  call heltable([2,4,8], n3(:,23), t3x8(:,:,5))
  call heltable([2,16,32], n3(:,24), t3x32(:,:,7))
  call heltable([2,16,32], n3(:,25), t3x32(:,:,8))
  call heltable([16,2,32], n3(:,26), t3x32(:,:,9))
  call heltable([2,16,32], n3(:,27), t3x32(:,:,10))
  call heltable([16,2,32], n3(:,28), t3x32(:,:,11))
  call heltable([16,2,32], n3(:,29), t3x32(:,:,12))
  call heltable([8,64,512], n3(:,30), t3x512(:,:,1))
  call heltable([64,8,512], n3(:,31), t3x512(:,:,2))
  call heltable([64,8,512], n3(:,32), t3x512(:,:,3))
  call heltable([32,16,512], n3(:,33), t3x512(:,:,4))
  call heltable([32,16,512], n3(:,34), t3x512(:,:,5))
  call heltable([64,8,512], n3(:,35), t3x512(:,:,6))
  call heltable([32,16,512], n3(:,36), t3x512(:,:,7))
  call heltable([32,16,512], n3(:,37), t3x512(:,:,8))
  call heltable([64,8,512], n3(:,38), t3x512(:,:,9))
  call heltable([32,16,512], n3(:,39), t3x512(:,:,10))
  call heltable([32,16,512], n3(:,40), t3x512(:,:,11))
  call heltable([64,8,512], n3(:,41), t3x512(:,:,12))
  call heltable([16,32,512], n3(:,42), t3x512(:,:,13))
  call heltable([16,32,512], n3(:,43), t3x512(:,:,14))
  call heltable([16,32,512], n3(:,44), t3x512(:,:,15))
  call heltable([16,32,512], n3(:,45), t3x512(:,:,16))
  call heltable([16,32,512], n3(:,46), t3x512(:,:,17))
  call heltable([16,32,512], n3(:,47), t3x512(:,:,18))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppttj_dec_nenmxexmbbxggg_1
