...
module ol_colourmatrix_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND
  ...
  K1(251,:) = [   4,  12,   0,   4,   0,   0]
  K1(252,:) = [  12,   4,   4,   0,   0,   0]
  K1(253,:) = [ -36, -12, -12,  -4,  -4, -12]
  K1(254,:) = [ -12,   0,  -4,   0,   0,  -4]
  K1(255,:) = [ -12,  -4, -36, -12, -12,  -4]
  K1(256,:) = [  -4,   0, -12,   0,  -4,   0]
  K1(257,:) = [  -4,   0, -12,  -4,   0,   0]
  K1(258,:) = [ -12,  -4,  -4,   0,   0,   0]
  K1(259,:) = [   0,  12,   0,   4,   4,   0]
  ...
  K1(313,:) = [   0,   0, -12,  -4,  -4,   0]
  K1(314,:) = [   0,   0,  -4, -12,   0,  -4]
  K1(315,:) = [ -12,  -4, -36, -12, -12,  -4]
  K1(316,:) = [  -4, -12, -12, -36,  -4, -12]
  K1(317,:) = [  -4,   0, -12,  -4,   0,   0]
  K1(318,:) = [   0,  -4,  -4, -12,   0,   0]
  K1(319,:) = [   0,   0,  12,   4,   4,   0]
  K1(320,:) = [   0,   0,   4,   0,  12,   4]
...
end module ol_colourmatrix_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND



module ol_forced_parameters_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND

module ol_tree_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(4) = 1 /((L(5,192))+L(6,192))
  den(6) = 1 /((L(5,261) - MT2)+L(6,261))
  den(8) = 1 /((L(5,522) - MT2)+L(6,522))
  den(10) = 1 /((L(5,240))+L(6,240))
  den(16) = 1 /((L(5,309) - MT2)+L(6,309))
  den(21) = 1 /((L(5,570) - MT2)+L(6,570))
  den(24) = 1 /((L(5,112))+L(6,112))
  den(28) = 1 /((L(5,176))+L(6,176))
  den(32) = 1 /((L(5,208))+L(6,208))
  den(36) = 1 /((L(5,224))+L(6,224))
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppttj_dec_nenmxexmuuxddxbbx_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e anti-nu_mu e+ mu- up anti-up down anti-down bottom anti-bottom -> 0
...
! **********************************************************************
  ...
  use ol_external_ppttj_dec_nenmxexmuuxddxbbx_1, only: &
    & external_perm_ppttj_dec_nenmxexmuuxddxbbx_1, &
    & external_perm_inv_ppttj_dec_nenmxexmuuxddxbbx_1, &
    & extcomb_perm_ppttj_dec_nenmxexmuuxddxbbx_1, &
    & average_factor_ppttj_dec_nenmxexmuuxddxbbx_1, &
    & photonid_ppttj_dec_nenmxexmuuxddxbbx_1
  use ol_external_ppttj_dec_nenmxexmuuxddxbbx_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppttj_dec_nenmxexmuuxddxbbx_1
  ...
  type(wfun) :: wf4(4,6), wf8(8,12), wf16(16,5), wf32(32,6), wf64(64,1), wf1024(1024,7)

  type(polcont) :: A(1024,7)
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
      &  external_perm_inv_ppttj_dec_nenmxexmuuxddxbbx_1, 10,.false.)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppttj_dec_nenmxexmuuxddxbbx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppttj_dec_nenmxexmuuxddxbbx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = &
       & extcomb_perm_ppttj_dec_nenmxexmuuxddxbbx_1(extcombs(k))
  end do
  ...
  call vert_UV_W(ntry, wf4(:,3), 48, wf4(:,4), 192, wf16(:,1), n3(:,7), t3x16(:,:,1))
  ...
  call prop_Q_A(ntry, wf32(:,1), 309, MT, 1_intkind1, wf32(:,3), n2(5))
  call vert_AV_Q(ntry, wf8(:,4), wf4(:,3), wf32(:,4), n3(:,11), t3x32(:,:,3))
  call vert_VQ_A(ntry, wf4(:,4), wf8(:,3), wf32(:,5), n3(:,12), t3x32(:,:,4))
  call prop_A_Q(ntry, wf32(:,4), 570, MT, 1_intkind1, wf32(:,6), n2(6))
  call vert_VQ_A(ntry, wf4(:,3), ex7, wf8(:,5), n3(:,13), t3x8(:,:,3))
  ...
  call prop_A_Q(ntry, wf8(:,7), 176, ZERO, 0_intkind1, wf8(:,8), n2(8))
  call vert_QA_V(ntry, ex7, wf8(:,8), wf16(:,3), n3(:,16), t3x16(:,:,3))
  call vert_VQ_A(ntry, wf4(:,4), ex5, wf8(:,9), n3(:,17), t3x8(:,:,5))
  call prop_Q_A(ntry, wf8(:,9), 208, ZERO, 0_intkind1, wf8(:,10), n2(9))
  call vert_QA_V(ntry, wf8(:,10), ex6, wf16(:,4), n3(:,18), t3x16(:,:,4))
  call vert_AV_Q(ntry, ex6, wf4(:,4), wf8(:,11), n3(:,19), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,11), 224, ZERO, 0_intkind1, wf8(:,12), n2(10))
  call vert_QA_V(ntry, ex5, wf8(:,12), wf16(:,5), n3(:,20), t3x16(:,:,5))
  ...
  if ( JBmunu /= 0 ) then ! POWHEGs Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppttj_dec_nenmxexmuuxddxbbx_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppttj_dec_nenmxexmuuxddxbbx_1

  do k = 0, 57-1
    M2(k) = M2add(extcomb_perm_ppttj_dec_nenmxexmuuxddxbbx_1(k))
  end do

  ! photon-factors
  call photon_factors(photonid_ppttj_dec_nenmxexmuuxddxbbx_1, 0, bornphotonfactor)
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_VV(nsync, wf16(:,1), wf64(:,1), A(:,1), n3(:,21), t3x1024(:,:,1), nhel, den(13))
    call cont_QA(nsync, wf32(:,2), wf32(:,3), A(:,2), n3(:,22), t3x1024(:,:,2), nhel, den(18))
    call cont_QA(nsync, wf32(:,5), wf32(:,6), A(:,3), n3(:,23), t3x1024(:,:,3), nhel, den(23))
    call cont_VV(nsync, wf64(:,1), wf16(:,2), A(:,4), n3(:,24), t3x1024(:,:,4), nhel, den(27))
    call cont_VV(nsync, wf64(:,1), wf16(:,3), A(:,5), n3(:,25), t3x1024(:,:,5), nhel, den(31))
    call cont_VV(nsync, wf64(:,1), wf16(:,4), A(:,6), n3(:,26), t3x1024(:,:,6), nhel, den(35))
    call cont_VV(nsync, wf64(:,1), wf16(:,5), A(:,7), n3(:,27), t3x1024(:,:,7), nhel, den(39))
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppttj_dec_nenmxexmuuxddxbbx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppttj_dec_nenmxexmuuxddxbbx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppttj_dec_nenmxexmuuxddxbbx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppttj_dec_nenmxexmuuxddxbbx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppttj_dec_nenmxexmuuxddxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,10)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppttj_dec_nenmxexmuuxddxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,10)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppttj_dec_nenmxexmuuxddxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,10)
...
end module ol_tree_ppttj_dec_nenmxexmuuxddxbbx_1_/**/REALKIND
