...
module ol_external_ppttj_ttxbbxgg_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppttj_ttxbbxgg_1(6) = &
                     [ (dummy_counter, dummy_counter = 1, 6) ]
  integer, save :: external_perm_inv_ppttj_ttxbbxgg_1(6) = &
                     [ (dummy_counter, dummy_counter = 1, 6) ]
  integer, save :: extcomb_perm_ppttj_ttxbbxgg_1(0:22) = &
                     [ (dummy_counter, dummy_counter = 0, 22) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppttj_ttxbbxgg_1(6) = &
                     [ 1, 2, 3, 4, 5, 5 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppttj_ttxbbxgg_1(6) = &
                     [ 6, 6, 6, 6, 16, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppttj_ttxbbxgg_1 = &
                     72
  integer, save :: channel_number_ppttj_ttxbbxgg_1 = -1
  ...
  integer, save :: photonid_ppttj_ttxbbxgg_1(6) = 0

  contains

  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppttj_ttxbbxgg_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppttj_ttxbbxgg_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppttj_ttxbbxgg_1")
    ...
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppttj_ttxbbxgg_1(6)
    external_perm_ppttj_ttxbbxgg_1 = perm
    do i = 1, 6
      external_perm_inv_ppttj_ttxbbxgg_1( &
        external_perm_ppttj_ttxbbxgg_1(i)) = i
      particle_types_perm_ppttj_ttxbbxgg_1(i) = &
        particle_types_ppttj_ttxbbxgg_1( &
        external_perm_ppttj_ttxbbxgg_1(i))
    end do
    do i = 1, 6
      do j = 1, i
        if (external_perm_ppttj_ttxbbxgg_1(i) >= &
          external_perm_ppttj_ttxbbxgg_1(j)) then
          ii = external_perm_ppttj_ttxbbxgg_1(i)
          jj = external_perm_ppttj_ttxbbxgg_1(j)
        else
          ii = external_perm_ppttj_ttxbbxgg_1(j)
          jj = external_perm_ppttj_ttxbbxgg_1(i)
        end if
        extcomb_perm_ppttj_ttxbbxgg_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppttj_ttxbbxgg_1 = 1
    do i = 1, n_scatt
      average_factor_ppttj_ttxbbxgg_1 = &
        average_factor_ppttj_ttxbbxgg_1 &
        * average_factors_ppttj_ttxbbxgg_1( &
        external_perm_ppttj_ttxbbxgg_1(i))
    end do
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 6
        average_factor_ppttj_ttxbbxgg_1 = &
          average_factor_ppttj_ttxbbxgg_1 &
          * factorial(count(particle_types_perm_ppttj_ttxbbxgg_1(n_scatt+1:6) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppttj_ttxbbxgg_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppttj_ttxbbxgg_1")
    ...
    m_ex_orig = [ rMT_unscaled, rMT_unscaled, rMB_unscaled, rMB_unscaled, rZERO, rZERO ]
    do i = 1, 6
      m_ex(i) = m_ex_orig(external_perm_ppttj_ttxbbxgg_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppttj_ttxbbxgg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppttj_ttxbbxgg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppttj_ttxbbxgg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
  ...
  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_ppttj_ttxbbxgg_1")
    implicit none
  ...
  subroutine set_photons(photon_id) &
      & bind(c,name="ol_f_set_photons_ppttj_ttxbbxgg_1")
    implicit none
    integer, intent(in) :: photon_id(6)
    photonid_ppttj_ttxbbxgg_1 = photon_id
  end subroutine set_photons


end module ol_external_ppttj_ttxbbxgg_1


module ol_settings_ppttj_ttxbbxgg_1
  implicit none
  ...
  subroutine set_hel_mem_opt(set) &
      & bind(c,name="ol_hel_mem_opt_ppttj_ttxbbxgg_1")
    implicit none
  ...
  subroutine set_loopcc(set,was) &
      & bind(c,name="ol_loopcc_ppttj_ttxbbxgg_1")
    implicit none
    logical, intent(in) :: set
    logical :: was
    was = loopcc
...
end module ol_settings_ppttj_ttxbbxgg_1

module colour_basis_ppttj_ttxbbxgg_1
  implicit none
  ! tree colour basis
  integer, save :: extcolours(6) = [1,1,1,1,2,2]
  contains

  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppttj_ttxbbxgg_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppttj_ttxbbxgg_1")
    implicit none
    ...
    basis = reshape( &
      [2,570,0,2,557,0,2,516,0,2,510,0,3,584,0,3,586,0,3,595,0,3,600,0,3,704,0,3,706,0,3,715,0,3,720,0], &
      [3,12])
#endif
  end subroutine tree_colbasis

end module colour_basis_ppttj_ttxbbxgg_1

! **********************************************************************
module ol_heltables_ppttj_ttxbbxgg_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(14), n3(3,82), n4(4,3)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x16(2,16,5), t3x4(2,4,11), t3x8(2,8,28), t3x64(2,64,38), t4x16(3,16,3)
...
! **********************************************************************
  ...
  call heltable([2,2,4], n3(:,34), t3x4(:,:,11))
  n2(11) = 4
  n2(12) = 4
  call heltable([4,4,16], n3(:,35), t3x16(:,:,5))
  call heltable([2,4,8], n3(:,36), t3x8(:,:,20))
  ...
  call heltable([2,4,8], n3(:,41), t3x8(:,:,25))
  call heltable([4,2,8], n3(:,42), t3x8(:,:,26))
  call heltable([2,4,8], n3(:,43), t3x8(:,:,27))
  call heltable([4,2,8], n3(:,44), t3x8(:,:,28))
  n2(14) = 8
  call heltable([4,16,64], n3(:,45), t3x64(:,:,1))
  call heltable([4,16,64], n3(:,46), t3x64(:,:,2))
  call heltable([4,16,64], n3(:,47), t3x64(:,:,3))
  call heltable([4,16,64], n3(:,48), t3x64(:,:,4))
  call heltable([8,8,64], n3(:,49), t3x64(:,:,5))
  call heltable([8,8,64], n3(:,50), t3x64(:,:,6))
  call heltable([4,16,64], n3(:,51), t3x64(:,:,7))
  call heltable([8,8,64], n3(:,52), t3x64(:,:,8))
  call heltable([8,8,64], n3(:,53), t3x64(:,:,9))
  call heltable([4,16,64], n3(:,54), t3x64(:,:,10))
  call heltable([8,8,64], n3(:,55), t3x64(:,:,11))
  call heltable([8,8,64], n3(:,56), t3x64(:,:,12))
  call heltable([8,8,64], n3(:,57), t3x64(:,:,13))
  call heltable([8,8,64], n3(:,58), t3x64(:,:,14))
  call heltable([8,8,64], n3(:,59), t3x64(:,:,15))
  call heltable([8,8,64], n3(:,60), t3x64(:,:,16))
  call heltable([8,8,64], n3(:,61), t3x64(:,:,17))
  call heltable([8,8,64], n3(:,62), t3x64(:,:,18))
  call heltable([4,16,64], n3(:,63), t3x64(:,:,19))
  call heltable([8,8,64], n3(:,64), t3x64(:,:,20))
  call heltable([8,8,64], n3(:,65), t3x64(:,:,21))
  call heltable([4,16,64], n3(:,66), t3x64(:,:,22))
  call heltable([8,8,64], n3(:,67), t3x64(:,:,23))
  call heltable([8,8,64], n3(:,68), t3x64(:,:,24))
  call heltable([8,8,64], n3(:,69), t3x64(:,:,25))
  call heltable([8,8,64], n3(:,70), t3x64(:,:,26))
  call heltable([8,8,64], n3(:,71), t3x64(:,:,27))
  call heltable([8,8,64], n3(:,72), t3x64(:,:,28))
  call heltable([8,8,64], n3(:,73), t3x64(:,:,29))
  call heltable([8,8,64], n3(:,74), t3x64(:,:,30))
  call heltable([8,8,64], n3(:,75), t3x64(:,:,31))
  call heltable([8,8,64], n3(:,76), t3x64(:,:,32))
  call heltable([8,8,64], n3(:,77), t3x64(:,:,33))
  call heltable([8,8,64], n3(:,78), t3x64(:,:,34))
  call heltable([8,8,64], n3(:,79), t3x64(:,:,35))
  call heltable([8,8,64], n3(:,80), t3x64(:,:,36))
  call heltable([8,8,64], n3(:,81), t3x64(:,:,37))
  call heltable([8,8,64], n3(:,82), t3x64(:,:,38))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppttj_ttxbbxgg_1
