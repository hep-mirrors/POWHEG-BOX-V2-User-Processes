...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppttj_ttxbbxgg_1_/**/DREALKIND, only: &
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbxgg_1, only: &
    & external_perm_ppttj_ttxbbxgg_1, &
    & external_perm_inv_ppttj_ttxbbxgg_1, &
    & extcomb_perm_ppttj_ttxbbxgg_1, &
    & average_factor_ppttj_ttxbbxgg_1, &
    & photonid_ppttj_ttxbbxgg_1
  use ol_external_ppttj_ttxbbxgg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppttj_ttxbbxgg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppttj_ttxbbxgg_1_/**/REALKIND, only: &
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
      &  external_perm_inv_ppttj_ttxbbxgg_1, 6,.false.)
  ...
  do k = 1, nextcombs
    extcombs_permuted(k) = &
       & extcomb_perm_ppttj_ttxbbxgg_1(extcombs(k))
  end do
  ...
  if ( JBmunu /= 0 ) then ! POWHEGs Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppttj_ttxbbxgg_1
  end if
  ...
  ! photon-factors
  call photon_factors(photonid_ppttj_ttxbbxgg_1, 0, bornphotonfactor)
