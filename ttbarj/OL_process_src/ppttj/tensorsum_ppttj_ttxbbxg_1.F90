...
! **********************************************************************
module ol_tables_storage_ppttj_ttxbbxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_tables_storage_ppttj_ttxbbxg_1_/**/REALKIND
...
! **********************************************************************
 ...
 use ol_data_types_/**/REALKIND, only: scalarbox 
  ...
  type(hcl), save, dimension(312) :: G0tensor
...
integer, save :: mass3set(0:2,23)
integer, save :: mass4set(0:3,17)
...
!**********************************************************************
  ...
  use ol_loop_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: nhel
  use ol_data_types_/**/REALKIND, only: hol
...
!**********************************************************************
  ...
  call hcl_allocation(1,G0tensor, 312)
...
!**********************************************************************
  ...
  call hcl_deallocation(G0tensor, 312,dmode)
...
! **********************************************************************
  ...
  masses2_24 = [ 0, nMB, nMT ]
  masses2_25 = [ nMB, nMB, nMT ]
  masses2_26 = [ 0, nMT, 0 ]
  masses2_27 = [ nMB, nMT, 0 ]
  masses2_28 = [ nMT, nMT, 0 ]
  masses2_29 = [ 0, nMT, nMB ]
  masses2_30 = [ nMT, nMT, nMB ]
  masses2_31 = [ 0, nMT, nMT ]
  masses2_32 = [ nMT, nMT, nMT ]
  masses2_33 = [ 0, 0, 0, nMB ]
  masses2_34 = [ nMT, 0, nMB, 0 ]
  masses2_35 = [ 0, 0, nMB, nMB ]
  masses2_36 = [ 0, 0, nMT, 0 ]
  masses2_37 = [ nMB, 0, nMT, 0 ]
  masses2_38 = [ 0, 0, nMT, nMB ]
  masses2_39 = [ 0, 0, nMT, nMT ]
  masses2_40 = [ nMB, nMB, 0, 0 ]
  masses2_41 = [ 0, nMB, 0, nMT ]
  masses2_42 = [ nMB, nMB, 0, nMT ]
  masses2_43 = [ nMB, nMB, nMB, 0 ]
  masses2_44 = [ nMB, nMB, nMT, 0 ]
  masses2_45 = [ nMT, nMT, 0, 0 ]
  masses2_46 = [ 0, nMT, 0, nMB ]
  masses2_47 = [ nMT, nMT, 0, nMB ]
  masses2_48 = [ nMT, nMT, 0, nMT ]
  masses2_49 = [ nMT, nMT, nMB, 0 ]
  masses2_50 = [ 0, 0, nMT, 0, nMB ]
  masses2_51 = [ nMB, nMB, 0, nMT, 0 ]
  masses2_52 = [ nMT, nMT, 0, nMB, 0 ]
...
#endif
  call TI_call_OL(0,0, momenta_62, masses2_36, T0sum(1), M2,[4], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_56, masses2_36, T0sum(2), M2,[12], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_84, masses2_41, T0sum(3), M2,[21], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_67, masses2_42, T0sum(4), M2,[20], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_85, masses2_41, T0sum(5), M2,[25], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_68, masses2_42, T0sum(6), M2,[24], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_78, masses2_46, T0sum(7), M2,[1], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_57, masses2_47, T0sum(8), M2,[29], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_79, masses2_46, T0sum(9), M2,[6], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_59, masses2_47, T0sum(10), M2,[33], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_83, masses2_37, T0sum(11), M2,[5], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_65, masses2_33, T0sum(12), M2,[2], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_63, masses2_38, T0sum(13), M2,[3], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_81, masses2_37, T0sum(14), M2,[22], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_66, masses2_33, T0sum(15), M2,[7], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_64, masses2_38, T0sum(16), M2,[8], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_82, masses2_37, T0sum(17), M2,[13], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_74, masses2_46, T0sum(18), M2,[10], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_58, masses2_38, T0sum(19), M2,[11], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_80, masses2_37, T0sum(20), M2,[17], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_75, masses2_46, T0sum(21), M2,[14], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_60, masses2_38, T0sum(22), M2,[15], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_70, masses2_44, T0sum(23), M2,[18], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_69, masses2_40, T0sum(24), M2,[19], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_72, masses2_44, T0sum(25), M2,[23], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_76, masses2_34, T0sum(26), M2,[26], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_71, masses2_49, T0sum(27), M2,[27], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_61, masses2_45, T0sum(28), M2,[28], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_77, masses2_34, T0sum(29), M2,[31], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_73, masses2_49, T0sum(30), M2,[32], ScalarBoxes(:))
  call TI_call_OL(0,0, momenta_69, masses2_35, T0sum(31), M2)
  call TI_call_OL(0,0, momenta_61, masses2_39, T0sum(32), M2)
  call TI_call_OL(0,0, momenta_66, masses2_43, T0sum(33), M2)
  call TI_call_OL(0,0, momenta_65, masses2_43, T0sum(34), M2)
  call TI_call_OL(0,0, momenta_56, masses2_48, T0sum(35), M2)
  call TI_call_OL(0,0, momenta_62, masses2_48, T0sum(36), M2)
  call TI_call_OL(0,0, momenta_19, masses2_10, T0sum(37), M2)
  call TI_call_OL(0,0, momenta_20, masses2_13, T0sum(38), M2)
  call TI_call_OL(0,0, momenta_17, masses2_16, T0sum(39), M2)
  call TI_call_OL(0,0, momenta_47, masses2_19, T0sum(40), M2)
  call TI_call_OL(0,0, momenta_20, masses2_20, T0sum(41), M2)
  call TI_call_OL(0,0, momenta_33, masses2_26, T0sum(42), M2)
  call TI_call_OL(0,0, momenta_17, masses2_28, T0sum(43), M2)
  call TI_call_OL(0,0, momenta_40, masses2_22, T0sum(44), M2)
  call TI_call_OL(0,0, momenta_19, masses2_23, T0sum(45), M2)
  call TI_call_OL(0,0, momenta_46, masses2_22, T0sum(46), M2)
  call TI_call_OL(0,0, momenta_54, masses2_28, T0sum(47), M2)
  call TI_call_OL(0,0, momenta_54, masses2_16, T0sum(48), M2)
  call TI_call_OL(0,0, momenta_55, masses2_28, T0sum(49), M2)
  call TI_call_OL(0,0, momenta_18, masses2_28, T0sum(50), M2)
  call TI_call_OL(0,0, momenta_55, masses2_16, T0sum(51), M2)
  call TI_call_OL(0,0, momenta_18, masses2_16, T0sum(52), M2)
  call TI_call_OL(0,0, momenta_27, masses2_26, T0sum(53), M2)
  call TI_call_OL(0,0, momenta_53, masses2_21, T0sum(54), M2)
  call TI_call_OL(0,0, momenta_48, masses2_24, T0sum(55), M2)
  call TI_call_OL(0,0, momenta_38, masses2_17, T0sum(56), M2)
  call TI_call_OL(0,0, momenta_21, masses2_25, T0sum(57), M2)
  call TI_call_OL(0,0, momenta_51, masses2_21, T0sum(58), M2)
  call TI_call_OL(0,0, momenta_49, masses2_24, T0sum(59), M2)
  call TI_call_OL(0,0, momenta_39, masses2_17, T0sum(60), M2)
  call TI_call_OL(0,0, momenta_22, masses2_25, T0sum(61), M2)
  call TI_call_OL(0,0, momenta_52, masses2_27, T0sum(62), M2)
  call TI_call_OL(0,0, momenta_36, masses2_13, T0sum(63), M2)
  call TI_call_OL(0,0, momenta_34, masses2_29, T0sum(64), M2)
  call TI_call_OL(0,0, momenta_28, masses2_15, T0sum(65), M2)
  call TI_call_OL(0,0, momenta_21, masses2_30, T0sum(66), M2)
  call TI_call_OL(0,0, momenta_43, masses2_27, T0sum(67), M2)
  call TI_call_OL(0,0, momenta_37, masses2_13, T0sum(68), M2)
  call TI_call_OL(0,0, momenta_35, masses2_29, T0sum(69), M2)
  call TI_call_OL(0,0, momenta_30, masses2_15, T0sum(70), M2)
  call TI_call_OL(0,0, momenta_24, masses2_30, T0sum(71), M2)
  call TI_call_OL(0,0, momenta_46, masses2_11, T0sum(72), M2)
  call TI_call_OL(0,0, momenta_45, masses2_17, T0sum(73), M2)
  call TI_call_OL(0,0, momenta_23, masses2_13, T0sum(74), M2)
  call TI_call_OL(0,0, momenta_40, masses2_11, T0sum(75), M2)
  call TI_call_OL(0,0, momenta_25, masses2_13, T0sum(76), M2)
  call TI_call_OL(0,0, momenta_50, masses2_27, T0sum(77), M2)
  call TI_call_OL(0,0, momenta_44, masses2_17, T0sum(78), M2)
  call TI_call_OL(0,0, momenta_29, masses2_29, T0sum(79), M2)
  call TI_call_OL(0,0, momenta_41, masses2_27, T0sum(80), M2)
  call TI_call_OL(0,0, momenta_31, masses2_29, T0sum(81), M2)
  call TI_call_OL(0,0, momenta_23, masses2_20, T0sum(82), M2)
  call TI_call_OL(0,0, momenta_42, masses2_21, T0sum(83), M2)
  call TI_call_OL(0,0, momenta_32, masses2_12, T0sum(84), M2)
  call TI_call_OL(0,0, momenta_26, masses2_28, T0sum(85), M2)
  call TI_call_OL(0,0, momenta_47, masses2_14, T0sum(86), M2)
  call TI_call_OL(0,0, momenta_33, masses2_18, T0sum(87), M2)
  call TI_call_OL(0,0, momenta_32, masses2_31, T0sum(88), M2)
  call TI_call_OL(0,0, momenta_26, masses2_16, T0sum(89), M2)
  call TI_call_OL(0,0, momenta_37, masses2_20, T0sum(90), M2)
  call TI_call_OL(0,0, momenta_25, masses2_20, T0sum(91), M2)
  call TI_call_OL(0,0, momenta_36, masses2_20, T0sum(92), M2)
  call TI_call_OL(0,0, momenta_27, masses2_18, T0sum(93), M2)
  call TI_call_OL(0,0, momenta_19, masses2_32, T0sum(94), M2)
  call TI_call_OL(0,0, momenta_14, masses2_1, T0sum(95), M2)
  call TI_call_OL(0,0, momenta_5, masses2_1, T0sum(96), M2)
  call TI_call_OL(0,0, momenta_2, masses2_1, T0sum(97), M2)
  call TI_call_OL(0,0, momenta_13, masses2_2, T0sum(98), M2)
  call TI_call_OL(0,0, momenta_6, masses2_4, T0sum(99), M2)
  call TI_call_OL(0,0, momenta_1, masses2_2, T0sum(100), M2)
  call TI_call_OL(0,0, momenta_16, masses2_3, T0sum(101), M2)
  call TI_call_OL(0,0, momenta_3, masses2_7, T0sum(102), M2)
  call TI_call_OL(0,0, momenta_1, masses2_3, T0sum(103), M2)
  call TI_call_OL(0,0, momenta_13, masses2_4, T0sum(104), M2)
  call TI_call_OL(0,0, momenta_10, masses2_4, T0sum(105), M2)
  call TI_call_OL(0,0, momenta_6, masses2_2, T0sum(106), M2)
  call TI_call_OL(0,0, momenta_2, masses2_5, T0sum(107), M2)
  call TI_call_OL(0,0, momenta_16, masses2_7, T0sum(108), M2)
  call TI_call_OL(0,0, momenta_4, masses2_7, T0sum(109), M2)
  call TI_call_OL(0,0, momenta_3, masses2_3, T0sum(110), M2)
  call TI_call_OL(0,0, momenta_2, masses2_9, T0sum(111), M2)
  call TI_call_OL(0,0, momenta_14, masses2_5, T0sum(112), M2)
  call TI_call_OL(0,0, momenta_9, masses2_4, T0sum(113), M2)
  call TI_call_OL(0,0, momenta_5, masses2_5, T0sum(114), M2)
  call TI_call_OL(0,0, momenta_15, masses2_3, T0sum(115), M2)
  call TI_call_OL(0,0, momenta_14, masses2_9, T0sum(116), M2)
  call TI_call_OL(0,0, momenta_15, masses2_7, T0sum(117), M2)
  call TI_call_OL(0,0, momenta_4, masses2_3, T0sum(118), M2)
  call TI_call_OL(0,0, momenta_9, masses2_2, T0sum(119), M2)
  call TI_call_OL(0,0, momenta_10, masses2_2, T0sum(120), M2)
  call TI_call_OL(0,0, momenta_5, masses2_9, T0sum(121), M2)
  call TI_call_OL(0,0, momenta_12, masses2_6, T0sum(122), M2)
  call TI_call_OL(0,0, momenta_7, masses2_8, T0sum(123), M2)
  call TI_call_OL(0,0, momenta_11, masses2_6, T0sum(124), M2)
  call TI_call_OL(0,0, momenta_8, masses2_8, T0sum(125), M2)
  call TI_call_OL(0,0, momenta_12, masses2_8, T0sum(126), M2)
  call TI_call_OL(0,0, momenta_7, masses2_6, T0sum(127), M2)
  call TI_call_OL(0,0, momenta_11, masses2_8, T0sum(128), M2)

  call TI_call_OL(0,1, momenta_90, masses2_50, T1sum(1), M2,sbarray_1, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_91, masses2_50, T1sum(2), M2,sbarray_2, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_86, masses2_50, T1sum(3), M2,sbarray_3, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_87, masses2_50, T1sum(4), M2,sbarray_4, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_92, masses2_51, T1sum(5), M2,sbarray_5, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_93, masses2_51, T1sum(6), M2,sbarray_6, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_88, masses2_52, T1sum(7), M2,sbarray_7, ScalarBoxes(:))
  call TI_call_OL(0,1, momenta_89, masses2_52, T1sum(8), M2,sbarray_8, ScalarBoxes(:))
