...
module ol_colourmatrix_ppttj_ttxbbbxbx_1_/**/REALKIND
...
end module ol_colourmatrix_ppttj_ttxbbbxbx_1_/**/REALKIND



module ol_forced_parameters_ppttj_ttxbbbxbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppttj_ttxbbbxbx_1_/**/REALKIND

module ol_tree_ppttj_ttxbbbxbx_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(6) = 1 /((L(5,11) - MB2)+L(6,11))
  den(9) = 1 /((L(5,28) - MB2)+L(6,28))
  den(12) = 1 /((L(5,36))+L(6,36))
  den(13) = 1 /((L(5,24))+L(6,24))
  den(16) = 1 /((L(5,7) - MB2)+L(6,7))
  den(22) = 1 /((L(5,44) - MB2)+L(6,44))
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppttj_ttxbbbxbx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppttj_ttxbbbxbx_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for top anti-top bottom bottom anti-bottom anti-bottom -> 0
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbbxbx_1, only: &
    & external_perm_ppttj_ttxbbbxbx_1, &
    & external_perm_inv_ppttj_ttxbbbxbx_1, &
    & extcomb_perm_ppttj_ttxbbbxbx_1, &
    & average_factor_ppttj_ttxbbbxbx_1, &
    & photonid_ppttj_ttxbbbxbx_1
  use ol_external_ppttj_ttxbbbxbx_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppttj_ttxbbbxbx_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppttj_ttxbbbxbx_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppttj_ttxbbbxbx_1
  ...
  extmasses2 = [ nMT, nMT, nMB, nMB, nMB, nMB ]
  ! Convert 2 -> n-2 PS-point to n -> 0 (so that P(1) + ... + P(n) = 0) and compute
  ! internal-propagator momenta in light-cone representation
  call init_kinematics(P_scatt, extmasses2, P, &
      &  external_perm_inv_ppttj_ttxbbbxbx_1, 6,.false.)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppttj_ttxbbbxbx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppttj_ttxbbbxbx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = &
       & extcomb_perm_ppttj_ttxbbbxbx_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf8(:,1), 11, MB, 1_intkind1, wf8(:,3), n2(1))
  ...
  call prop_Q_A(ntry, wf8(:,7), 7, MB, 1_intkind1, wf8(:,9), n2(3))
  call vert_VQ_A(ntry, wf4(:,5), ex3, wf8(:,10), n3(:,14), t3x8(:,:,7))
  call prop_Q_A(ntry, wf8(:,10), 28, MB, 1_intkind1, wf8(:,11), n2(4))
  ...
  call prop_Q_A(ntry, wf8(:,13), 44, MB, 1_intkind1, wf8(:,15), n2(5))
  call vert_AV_Q(ntry, ex5, wf4(:,3), wf8(:,16), n3(:,18), t3x8(:,:,11))
  call vert_VQ_A(ntry, wf4(:,3), ex3, wf8(:,17), n3(:,19), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,17), 44, MB, 1_intkind1, wf8(:,18), n2(6))
  ...
  if ( JBmunu /= 0 ) then ! POWHEGs Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppttj_ttxbbbxbx_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppttj_ttxbbbxbx_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppttj_ttxbbbxbx_1(k))
  end do

  ! photon-factors
  call photon_factors(photonid_ppttj_ttxbbbxbx_1, 0, bornphotonfactor)
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppttj_ttxbbbxbx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppttj_ttxbbbxbx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppttj_ttxbbbxbx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppttj_ttxbbbxbx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppttj_ttxbbbxbx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppttj_ttxbbbxbx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppttj_ttxbbbxbx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppttj_ttxbbbxbx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppttj_ttxbbbxbx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppttj_ttxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppttj_ttxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppttj_ttxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
end module ol_tree_ppttj_ttxbbbxbx_1_/**/REALKIND
