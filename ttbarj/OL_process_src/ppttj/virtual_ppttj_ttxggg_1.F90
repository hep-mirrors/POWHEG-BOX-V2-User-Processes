...
module ol_vamp_ppttj_ttxggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  mass5set(0:4,2) = [0,0,nMT,nMT,0]
  mass5set(0:4,3) = [0,0,nMT,nMT,nMT]
  mass5set(0:4,4) = [nMT,nMT,nMT,0,nMT]
  mass5set(0:4,5) = [nMT,nMT,0,nMT,nMT]
  mass5set(0:4,6) = [0,0,nMT,0,0]
  mass5set(0:4,7) = [nMT,nMT,0,0,nMT]
  mass5set(0:4,8) = [nMT,nMT,0,0,0]
mass4set(0:3,1) = [0,0,nMT,nMT]
mass4set(0:3,2) = [0,0,0,nMT]
mass4set(0:3,3) = [nMT,nMT,nMT,0]
mass4set(0:3,4) = [nMT,nMT,0,nMT]
mass4set(0:3,5) = [0,0,nMT,0]
mass4set(0:3,6) = [nMT,nMT,0,0]
mass4set(0:3,7) = [nMT,nMT,nMT,nMT]
mass4set(0:3,8) = [0,0,0,0]
mass4set(0:3,9) = [0,nMT,nMT,nMT]
mass4set(0:3,10) = [nMB,nMB,nMB,nMB]
mass4set(0:3,11) = [0,nMT,0,0]
mass4set(0:3,12) = [nMT,0,nMT,nMT]
mass4set(0:3,13) = [0,nMT,nMT,0]
mass4set(0:3,14) = [nMT,0,0,nMT]
mass4set(0:3,15) = [nMT,0,0,0]
  mass3set(0:2,1) = [nMT,0,0]
  mass3set(0:2,2) = [nMT,0,nMT]
  mass3set(0:2,3) = [0,nMT,nMT]
  mass3set(0:2,4) = [nMT,nMT,0]
  mass3set(0:2,5) = [0,0,nMT]
  mass3set(0:2,6) = [0,nMT,0]
  mass3set(0:2,7) = [0,0,0]
  mass3set(0:2,8) = [nMT,nMT,nMT]
  mass3set(0:2,9) = [nMB,nMB,nMB]
mass2set(0:1,1) = [nMT,nMT]
mass2set(0:1,2) = [0,0]
mass2set(0:1,3) = [nMB,nMB]
mass2set(0:1,4) = [nMT,0]
mass2set(0:1,5) = [0,nMT]
  ...
  call construct_RedBasis(18,22,RedBasis(11))
  call construct_RedBasis(18,23,RedBasis(12))
  call construct_RedBasis(16,26,RedBasis(13))
  call construct_RedBasis(16,27,RedBasis(14))
  call construct_RedBasis(18,26,RedBasis(15))
  call construct_RedBasis(18,27,RedBasis(16))
  call construct_RedBasis(26,27,RedBasis(17))
  call construct_RedBasis(16,17,RedBasis(18))
  call construct_RedBasis(17,21,RedBasis(19))
  call construct_RedBasis(17,23,RedBasis(20))
  call construct_RedBasis(16,29,RedBasis(21))
  call construct_RedBasis(17,29,RedBasis(22))
  call construct_RedBasis(21,29,RedBasis(23))
  call construct_RedBasis(16,25,RedBasis(24))
  call construct_RedBasis(17,25,RedBasis(25))
  call construct_RedBasis(17,27,RedBasis(26))
  call construct_RedBasis(25,27,RedBasis(27))
  call construct_RedBasis(25,29,RedBasis(28))
  call construct_RedBasis(16,19,RedBasis(29))
  call construct_RedBasis(18,19,RedBasis(30))
  call construct_RedBasis(19,23,RedBasis(31))
  call construct_RedBasis(19,27,RedBasis(32))
  call construct_RedBasis(17,19,RedBasis(33))
  call construct_RedBasis(1,5,RedBasis(34))
  call construct_RedBasis(1,13,RedBasis(35))
  call construct_RedBasis(5,13,RedBasis(36))
  call construct_RedBasis(1,9,RedBasis(37))
  call construct_RedBasis(9,13,RedBasis(38))
  call construct_RedBasis(4,5,RedBasis(39))
  call construct_RedBasis(4,7,RedBasis(40))
  call construct_RedBasis(5,7,RedBasis(41))
  call construct_RedBasis(4,6,RedBasis(42))
  call construct_RedBasis(6,7,RedBasis(43))
  call construct_RedBasis(2,6,RedBasis(44))
  call construct_RedBasis(2,7,RedBasis(45))
  call construct_RedBasis(2,10,RedBasis(46))
  call construct_RedBasis(2,11,RedBasis(47))
  call construct_RedBasis(10,11,RedBasis(48))
  call construct_RedBasis(1,7,RedBasis(49))
  call construct_RedBasis(1,11,RedBasis(50))
  call construct_RedBasis(9,11,RedBasis(51))
  call construct_RedBasis(2,3,RedBasis(52))
  call construct_RedBasis(3,7,RedBasis(53))
  call construct_RedBasis(3,11,RedBasis(54))
  call construct_RedBasis(1,3,RedBasis(55))
  call construct_RedBasis(24,28,RedBasis(56))
  call construct_RedBasis(24,29,RedBasis(57))
  call construct_RedBasis(28,29,RedBasis(58))
  call construct_RedBasis(24,30,RedBasis(59))
  call construct_RedBasis(28,30,RedBasis(60))
  call construct_RedBasis(24,26,RedBasis(61))
  call construct_RedBasis(26,30,RedBasis(62))
  call construct_RedBasis(20,30,RedBasis(63))
  call construct_RedBasis(22,30,RedBasis(64))
  call construct_RedBasis(24,25,RedBasis(65))
  call construct_RedBasis(20,29,RedBasis(66))
  call construct_RedBasis(24,27,RedBasis(67))
 ...
 RedBasis(3), RedBasis(8),RedBasis(5), RedBasis(9), RedSet_5(2))
  call construct_redset5(16, 18, 22, 23, RedBasis(10), RedBasis(7), & 
 RedBasis(3), RedBasis(11),RedBasis(12), RedBasis(9), RedSet_5(3))
  call construct_redset5(16, 18, 26, 27, RedBasis(10), RedBasis(13), & 
 RedBasis(14), RedBasis(15),RedBasis(16), RedBasis(17), RedSet_5(4))
  call construct_redset5(16, 17, 21, 23, RedBasis(18), RedBasis(2), & 
 RedBasis(3), RedBasis(19),RedBasis(20), RedBasis(6), RedSet_5(5))
  call construct_redset5(16, 17, 21, 29, RedBasis(18), RedBasis(2), & 
 RedBasis(21), RedBasis(19),RedBasis(22), RedBasis(23), RedSet_5(6))
  call construct_redset5(16, 17, 25, 27, RedBasis(18), RedBasis(24), & 
 RedBasis(14), RedBasis(25),RedBasis(26), RedBasis(27), RedSet_5(7))
  call construct_redset5(16, 17, 25, 29, RedBasis(18), RedBasis(24), & 
 RedBasis(21), RedBasis(25),RedBasis(22), RedBasis(28), RedSet_5(8))
  call construct_redset5(16, 18, 19, 23, RedBasis(10), RedBasis(29), & 
 RedBasis(3), RedBasis(30),RedBasis(12), RedBasis(31), RedSet_5(9))
  call construct_redset5(16, 18, 19, 27, RedBasis(10), RedBasis(29), & 
 RedBasis(14), RedBasis(30),RedBasis(16), RedBasis(32), RedSet_5(10))
  call construct_redset5(16, 17, 19, 23, RedBasis(18), RedBasis(29), & 
 RedBasis(3), RedBasis(33),RedBasis(20), RedBasis(31), RedSet_5(11))
  call construct_redset5(16, 17, 19, 27, RedBasis(18), RedBasis(29), & 
 RedBasis(14), RedBasis(33),RedBasis(26), RedBasis(32), RedSet_5(12))
  call construct_redset4(16,17,29,RedBasis(18),RedBasis(21),RedBasis(22),RedSet_4(1))
  call construct_redset4(16,17,21,RedBasis(18),RedBasis(2),RedBasis(19),RedSet_4(2))
  call construct_redset4(16,17,25,RedBasis(18),RedBasis(24),RedBasis(25),RedSet_4(3))
  call construct_redset4(16,20,21,RedBasis(1),RedBasis(2),RedBasis(4),RedSet_4(4))
  call construct_redset4(16,20,22,RedBasis(1),RedBasis(7),RedBasis(8),RedSet_4(5))
  call construct_redset4(16,18,22,RedBasis(10),RedBasis(7),RedBasis(11),RedSet_4(6))
  call construct_redset4(16,18,26,RedBasis(10),RedBasis(13),RedBasis(15),RedSet_4(7))
  call construct_redset4(16,18,19,RedBasis(10),RedBasis(29),RedBasis(30),RedSet_4(8))
  call construct_redset4(16,17,19,RedBasis(18),RedBasis(29),RedBasis(33),RedSet_4(9))
  call construct_redset4(17,21,29,RedBasis(19),RedBasis(22),RedBasis(23),RedSet_4(10))
  call construct_redset4(16,21,29,RedBasis(2),RedBasis(21),RedBasis(23),RedSet_4(11))
  call construct_redset4(1,5,13,RedBasis(34),RedBasis(35),RedBasis(36),RedSet_4(12))
  call construct_redset4(17,25,29,RedBasis(25),RedBasis(22),RedBasis(28),RedSet_4(13))
  call construct_redset4(16,25,29,RedBasis(24),RedBasis(21),RedBasis(28),RedSet_4(14))
  call construct_redset4(1,9,13,RedBasis(37),RedBasis(35),RedBasis(38),RedSet_4(15))
  call construct_redset4(20,21,23,RedBasis(4),RedBasis(5),RedBasis(6),RedSet_4(16))
  call construct_redset4(16,21,23,RedBasis(2),RedBasis(3),RedBasis(6),RedSet_4(17))
  call construct_redset4(16,20,23,RedBasis(1),RedBasis(3),RedBasis(5),RedSet_4(18))
  call construct_redset4(4,5,7,RedBasis(39),RedBasis(40),RedBasis(41),RedSet_4(19))
  call construct_redset4(20,22,23,RedBasis(8),RedBasis(5),RedBasis(9),RedSet_4(20))
  call construct_redset4(16,22,23,RedBasis(7),RedBasis(3),RedBasis(9),RedSet_4(21))
  call construct_redset4(4,6,7,RedBasis(42),RedBasis(40),RedBasis(43),RedSet_4(22))
  call construct_redset4(18,22,23,RedBasis(11),RedBasis(12),RedBasis(9),RedSet_4(23))
  call construct_redset4(16,18,23,RedBasis(10),RedBasis(3),RedBasis(12),RedSet_4(24))
  call construct_redset4(2,6,7,RedBasis(44),RedBasis(45),RedBasis(43),RedSet_4(25))
  call construct_redset4(18,26,27,RedBasis(15),RedBasis(16),RedBasis(17),RedSet_4(26))
  call construct_redset4(16,26,27,RedBasis(13),RedBasis(14),RedBasis(17),RedSet_4(27))
  call construct_redset4(16,18,27,RedBasis(10),RedBasis(14),RedBasis(16),RedSet_4(28))
  call construct_redset4(2,10,11,RedBasis(46),RedBasis(47),RedBasis(48),RedSet_4(29))
  call construct_redset4(17,21,23,RedBasis(19),RedBasis(20),RedBasis(6),RedSet_4(30))
  call construct_redset4(16,17,23,RedBasis(18),RedBasis(3),RedBasis(20),RedSet_4(31))
  call construct_redset4(1,5,7,RedBasis(34),RedBasis(49),RedBasis(41),RedSet_4(32))
  call construct_redset4(17,25,27,RedBasis(25),RedBasis(26),RedBasis(27),RedSet_4(33))
  call construct_redset4(16,25,27,RedBasis(24),RedBasis(14),RedBasis(27),RedSet_4(34))
  call construct_redset4(16,17,27,RedBasis(18),RedBasis(14),RedBasis(26),RedSet_4(35))
  call construct_redset4(1,9,11,RedBasis(37),RedBasis(50),RedBasis(51),RedSet_4(36))
  call construct_redset4(18,19,23,RedBasis(30),RedBasis(12),RedBasis(31),RedSet_4(37))
  call construct_redset4(16,19,23,RedBasis(29),RedBasis(3),RedBasis(31),RedSet_4(38))
  call construct_redset4(2,3,7,RedBasis(52),RedBasis(45),RedBasis(53),RedSet_4(39))
  call construct_redset4(18,19,27,RedBasis(30),RedBasis(16),RedBasis(32),RedSet_4(40))
  call construct_redset4(16,19,27,RedBasis(29),RedBasis(14),RedBasis(32),RedSet_4(41))
  call construct_redset4(2,3,11,RedBasis(52),RedBasis(47),RedBasis(54),RedSet_4(42))
  call construct_redset4(17,19,23,RedBasis(33),RedBasis(20),RedBasis(31),RedSet_4(43))
  call construct_redset4(1,3,7,RedBasis(55),RedBasis(49),RedBasis(53),RedSet_4(44))
  call construct_redset4(17,19,27,RedBasis(33),RedBasis(26),RedBasis(32),RedSet_4(45))
  call construct_redset4(1,3,11,RedBasis(55),RedBasis(50),RedBasis(54),RedSet_4(46))
  call construct_redset4(24,28,29,RedBasis(56),RedBasis(57),RedBasis(58),RedSet_4(47))
  call construct_redset4(24,28,30,RedBasis(56),RedBasis(59),RedBasis(60),RedSet_4(48))
  call construct_redset4(24,26,30,RedBasis(61),RedBasis(59),RedBasis(62),RedSet_4(49))
  call construct_redset4(20,22,30,RedBasis(8),RedBasis(63),RedBasis(64),RedSet_4(50))
  call construct_redset4(24,25,29,RedBasis(65),RedBasis(57),RedBasis(28),RedSet_4(51))
  call construct_redset4(20,21,29,RedBasis(4),RedBasis(66),RedBasis(23),RedSet_4(52))
  call construct_redset4(24,26,27,RedBasis(61),RedBasis(67),RedBasis(17),RedSet_4(53))
  call construct_redset4(24,25,27,RedBasis(65),RedBasis(67),RedBasis(27),RedSet_4(54))
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxggg_1, only: & 
    & channel_number_ppttj_ttxggg_1
  use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/REALKIND
  use ol_loop_storage_ppttj_ttxggg_1_/**/DREALKIND, only: &
    merge_step, hel_states

  use ol_vamp_1_ppttj_ttxggg_1_/**/REALKIND, only: vamp_1
  use ol_vamp_2_ppttj_ttxggg_1_/**/REALKIND, only: vamp_2
  use ol_vamp_3_ppttj_ttxggg_1_/**/REALKIND, only: vamp_3
  use ol_vamp_4_ppttj_ttxggg_1_/**/REALKIND, only: vamp_4
  ...
  call channel_on(channel_number_ppttj_ttxggg_1)
...
! M2tree = helicity-summed squared tree matrix element for top anti-top glue glue glue -> 0
! M2loop0 = helicity-summed squared loop matrix element for top anti-top glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_colourmatrix_ppttj_ttxggg_1_/**/REALKIND ! colmat_not_initialised, K1, K2, KL, KL2, KL2ct, KL2ct2
  ...
  use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/REALKIND, only: &
  ...
  use ol_tables_storage_ppttj_ttxggg_1_/**/DREALKIND, only: HOL_m3_init
  use ol_loop_ppttj_ttxggg_1_/**/REALKIND, only: amp2
  use ol_loop_ppttj_ttxggg_1_/**/DREALKIND, only: init_merging_tables, update_merging_tables
  use ol_loop_storage_ppttj_ttxggg_1_/**/REALKIND, only: &
    & fac_status_loop1, fac_status_loop2, M0_col1_helarray
  use ol_i_operator_/**/REALKIND, only: intdip
  use ol_loop_storage_ppttj_ttxggg_1_/**/DREALKIND, only: ntryL, nhel, p_switch, &
    & dp_not_alloc, qp_not_alloc
  use ol_settings_ppttj_ttxggg_1, only: hel_mem_opt
  ...
  complex(REALKIND)    :: M0_col1(11), Mct(11)
  complex(REALKIND)    :: Mcol_loop(11)
  ...
  if(ntryL == 1) then
    ...
    call init_merging_tables(32,761)
  end if
  ...
  if (IR_is_on > 0) then
    ...
    call intdip(ioperator_mode, M2L0, M2CC, M2CC_EW, [2,2,1,1,1], [2,-2,0,0,0]/3._/**/REALKIND, &
      & 5, get_rmass2(extmasses2), QInvariantsMatrix, vdip, c_dip, &
      & 1, &
      & [( photonid_ppttj_ttxggg_1( &
      & external_perm_inv_ppttj_ttxggg_1(i)), &
      & i=1, size(external_perm_inv_ppttj_ttxggg_1))])
    IRL1(0) = c_dip(0) / average_factor_ppttj_ttxggg_1
    IRL1(1) = c_dip(1) / average_factor_ppttj_ttxggg_1
    IRL1(2) = c_dip(2) / average_factor_ppttj_ttxggg_1
  else
    vdip = 0
    IRL1 = 0
  end if
  ...
  ! photon factors
  call photon_factors(photonid_ppttj_ttxggg_1, &
  ...
  M2L0 = M2L0 / average_factor_ppttj_ttxggg_1
  M2L1 = 2*(M2L1 + M2ct)
  if (IR_is_on > 1) then
    M2L1 = M2L1 + vdip
  end if
  M2L1 = M2L1 / average_factor_ppttj_ttxggg_1
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxggg_1, only: &
    & external_perm_inv_ppttj_ttxggg_1, average_factor_ppttj_ttxggg_1
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  ...
  ! photon factors
  call photon_factors(photonid_ppttj_ttxggg_1, 0, bornphotonfactor, loopphotonfactor)
  ...
  scalebackfactor = scalefactor**(2*5-8)
  M2tree = scalebackfactor * M2tree / average_factor_ppttj_ttxggg_1
  M2ct   = scalebackfactor * 2*M2ct / average_factor_ppttj_ttxggg_1
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxggg_1, only: & 
    ...
    & average_factor_ppttj_ttxggg_1, &
    & photonid_ppttj_ttxggg_1
  use ol_loop_storage_ppttj_ttxggg_1_/**/REALKIND, only: M2ctcc, M0M1_hel_cc
  use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/REALKIND, only: reset_tensor_sum, &
    & integrate_tensor_sum
  use ol_debug, only: ol_fatal
  use ol_colourmatrix_ppttj_ttxggg_1_/**/REALKIND, only: Cas
  ...
  do k = 1, 5
    ...
    M2L1cc(m) = 2*(M2L1 + M2ctcc(m))/average_factor_ppttj_ttxggg_1
  end do
#endif
  ...
  do k = 1, 16
    corr%rescc(k) = M2L1cc(extcomb_perm_ppttj_ttxggg_1(k))
  end do
  M2L0 = M2L0cache
  corr%rescc(0) = M2L1cache
  M2L1 = M2L1cache
#else
  call ol_fatal("born-loop colour correlators not available for process ppttj_ttxggg_1")
#endif
...
end module ol_vamp_ppttj_ttxggg_1_/**/REALKIND


#ifdef DUMMY_qp
module ol_vamp_ppttj_ttxggg_1_/**/QREALKIND
  implicit none
  contains
  subroutine vamp2pc(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2, mode)
    ...
    integer, intent(in), optional :: mode
    call ol_fatal("Process ppttj_ttxggg_1" &
      & // "has not been compiled in quad precision")
  end subroutine vamp2pc
end module ol_vamp_ppttj_ttxggg_1_/**/QREALKIND
#endif


#ifdef PRECISION_dp

module ol_vamp_ppttj_ttxggg_1
  use ol_parameters_decl_/**/DREALKIND, only: procname_length
  use ol_data_types_/**/DREALKIND, only: me_cache
  implicit none
  character(procname_length) :: processname = 'ppttj_ttxggg_1'
  ...
  subroutine finish_ppttj_ttxggg_1()
    ! final update of the stability histogram and memory deallocation
    use KIND_TYPES, only: DREALKIND
!   use ol_data_types_/**/REALKIND, only: Hpolcont
!   use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/DREALKIND, only: HOL_memory_allocation
    use ol_stability, only: finish_histograms
    use ol_vamp_ppttj_ttxggg_1_/**/DREALKIND, only: vamp
    use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/DREALKIND, only: &
      & HOL_memory_deallocation_/**/DREALKIND, HCL_memory_deallocation_/**/DREALKIND
#ifndef DUMMY_qp
    use ol_tensor_sum_storage_ppttj_ttxggg_1_/**/QREALKIND, only: &
...
!   call vamp(Mdummy)
  ...
  end subroutine finish_ppttj_ttxggg_1


  subroutine vamp2(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2) &
      & bind(c,name="ol_f_vamp2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_init, only: register_cleanup
    use ol_external_ppttj_ttxggg_1, only: &
      & external_perm_ppttj_ttxggg_1
    use ol_vamp_ppttj_ttxggg_1_/**/DREALKIND, only: vamp2dp => vamp2pc
    use ol_vamp_ppttj_ttxggg_1_/**/QREALKIND, only: vamp2qp => vamp2pc
    ...
    if (first_call) then
      call register_cleanup(finish_ppttj_ttxggg_1)
      first_call = .false.
    end if
    call vamp2generic(vamp2dp, vamp2qp, processname, P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2, &
                    ...
                    & external_perm_ppttj_ttxggg_1, me_caches)
  end subroutine vamp2


  subroutine ctamp2(P_scatt, M2tree, M2ct) &
      & bind(c,name="ol_f_ctamp2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppttj_ttxggg_1_/**/DREALKIND, only: ctamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine iopamp2(P_scatt, M2tree, IRL1) &
      & bind(c,name="ol_f_iopamp2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppttj_ttxggg_1_/**/DREALKIND, only: iopamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine vamp2_c(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2) &
      & bind(c,name="ol_vamp2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine ctamp2_c(P_scatt, M2tree, M2ct) &
      & bind(c,name="ol_ctamp2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
    real(c_double), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine vampcr2(P_scatt, M2L0, M2L1, M2L2, crtype, &
      ...
      & bind(c,name="ol_f_vampcr2_ppttj_ttxggg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_debug, only: ol_error
    use ol_vamp_ppttj_ttxggg_1_/**/DREALKIND, only: vamp2cache
    use ol_data_types_/**/DREALKIND, only: correlator
    implicit none
...
end module ol_vamp_ppttj_ttxggg_1
