...
module ol_vamp_ppttj_ttxbbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  mass5set(0:4,1) = [0,0,nMT,0,nMB]
  mass5set(0:4,2) = [nMB,nMB,0,nMT,0]
  mass5set(0:4,3) = [nMT,nMT,0,nMB,0]
mass4set(0:3,1) = [0,0,0,nMB]
mass4set(0:3,2) = [0,0,nMB,nMB]
mass4set(0:3,3) = [0,0,nMT,nMT]
mass4set(0:3,4) = [nMB,nMB,0,0]
mass4set(0:3,5) = [nMT,nMT,0,0]
mass4set(0:3,6) = [nMB,nMB,nMB,0]
mass4set(0:3,7) = [nMT,nMT,0,nMT]
mass4set(0:3,8) = [0,0,nMT,0]
mass4set(0:3,9) = [0,nMB,0,nMT]
mass4set(0:3,10) = [nMB,nMB,0,nMT]
mass4set(0:3,11) = [0,nMT,0,nMB]
mass4set(0:3,12) = [nMT,nMT,0,nMB]
mass4set(0:3,13) = [nMB,0,nMT,0]
mass4set(0:3,14) = [0,0,nMT,nMB]
mass4set(0:3,15) = [nMB,nMB,nMT,0]
mass4set(0:3,16) = [nMT,0,nMB,0]
mass4set(0:3,17) = [nMT,nMT,nMB,0]
  mass3set(0:2,1) = [0,0,0]
  mass3set(0:2,2) = [0,0,nMB]
  mass3set(0:2,3) = [0,0,nMT]
  mass3set(0:2,4) = [0,nMB,0]
  mass3set(0:2,5) = [nMB,nMB,0]
  mass3set(0:2,6) = [0,nMT,0]
  mass3set(0:2,7) = [nMT,nMT,0]
  mass3set(0:2,8) = [0,nMB,nMB]
  mass3set(0:2,9) = [nMB,nMB,nMB]
  mass3set(0:2,10) = [nMB,0,0]
  mass3set(0:2,11) = [nMT,0,0]
  mass3set(0:2,12) = [nMB,0,nMB]
  mass3set(0:2,13) = [nMT,0,nMT]
  mass3set(0:2,14) = [0,nMT,nMT]
  mass3set(0:2,15) = [nMT,nMT,nMT]
  mass3set(0:2,16) = [nMT,nMB,0]
  mass3set(0:2,17) = [0,nMB,nMT]
  mass3set(0:2,18) = [nMB,0,nMT]
  mass3set(0:2,19) = [nMB,nMB,nMT]
  mass3set(0:2,20) = [nMB,nMT,0]
  mass3set(0:2,21) = [0,nMT,nMB]
  mass3set(0:2,22) = [nMT,0,nMB]
  mass3set(0:2,23) = [nMT,nMT,nMB]
mass2set(0:1,1) = [0,0]
mass2set(0:1,2) = [nMB,nMB]
mass2set(0:1,3) = [nMT,nMT]
mass2set(0:1,4) = [0,nMB]
mass2set(0:1,5) = [nMB,0]
mass2set(0:1,6) = [0,nMT]
mass2set(0:1,7) = [nMT,0]
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbxg_1, only: & 
    & channel_number_ppttj_ttxbbxg_1
  use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/REALKIND
  use ol_loop_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: &
    merge_step, hel_states

  use ol_vamp_1_ppttj_ttxbbxg_1_/**/REALKIND, only: vamp_1
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbxg_1, only: &
    ...
    & photonid_ppttj_ttxbbxg_1
  use ol_colourmatrix_ppttj_ttxbbxg_1_/**/REALKIND ! colmat_not_initialised, K1, K2, KL, KL2, KL2ct, KL2ct2
  ...
  use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/REALKIND, only: &
  ...
  use ol_tables_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: HOL_m3_init
  use ol_loop_ppttj_ttxbbxg_1_/**/REALKIND, only: amp2
  use ol_loop_ppttj_ttxbbxg_1_/**/DREALKIND, only: init_merging_tables, update_merging_tables
  use ol_loop_storage_ppttj_ttxbbxg_1_/**/REALKIND, only: &
    & fac_status_loop1, fac_status_loop2, M0_col1_helarray
  use ol_i_operator_/**/REALKIND, only: intdip
  use ol_loop_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: ntryL, nhel, p_switch, &
    & dp_not_alloc, qp_not_alloc
  use ol_settings_ppttj_ttxbbxg_1, only: hel_mem_opt
  ...
  if (IR_is_on > 0) then
    ...
    call intdip(ioperator_mode, M2L0, M2CC, M2CC_EW, [2,2,2,2,1], [2,-2,-1,1,0]/3._/**/REALKIND, &
      ...
      & 1, &
      & [( photonid_ppttj_ttxbbxg_1( &
      & external_perm_inv_ppttj_ttxbbxg_1(i)), &
      & i=1, size(external_perm_inv_ppttj_ttxbbxg_1))])
    IRL1(0) = c_dip(0) / average_factor_ppttj_ttxbbxg_1
    IRL1(1) = c_dip(1) / average_factor_ppttj_ttxbbxg_1
    IRL1(2) = c_dip(2) / average_factor_ppttj_ttxbbxg_1
  else
    vdip = 0
    IRL1 = 0
  end if
  ...
  ! photon factors
  call photon_factors(photonid_ppttj_ttxbbxg_1, &
  ...
  M2L0 = M2L0 / average_factor_ppttj_ttxbbxg_1
  M2L1 = 2*(M2L1 + M2ct)
  if (IR_is_on > 1) then
    M2L1 = M2L1 + vdip
  end if
  M2L1 = M2L1 / average_factor_ppttj_ttxbbxg_1
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbxg_1, only: &
    & external_perm_inv_ppttj_ttxbbxg_1, average_factor_ppttj_ttxbbxg_1
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  ...
  ! photon factors
  call photon_factors(photonid_ppttj_ttxbbxg_1, 0, bornphotonfactor, loopphotonfactor)
  ...
  scalebackfactor = scalefactor**(2*5-8)
  M2tree = scalebackfactor * M2tree / average_factor_ppttj_ttxbbxg_1
  M2ct   = scalebackfactor * 2*M2ct / average_factor_ppttj_ttxbbxg_1
...
! **********************************************************************
  ...
  use ol_external_ppttj_ttxbbxg_1, only: & 
    ...
    & average_factor_ppttj_ttxbbxg_1, &
    & photonid_ppttj_ttxbbxg_1
  use ol_loop_storage_ppttj_ttxbbxg_1_/**/REALKIND, only: M2ctcc, M0M1_hel_cc
  use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/REALKIND, only: reset_tensor_sum, &
    & integrate_tensor_sum
  use ol_debug, only: ol_fatal
  use ol_colourmatrix_ppttj_ttxbbxg_1_/**/REALKIND, only: Cas
  ...
  do k = 1, 5
    ...
    M2L1cc(m) = 2*(M2L1 + M2ctcc(m))/average_factor_ppttj_ttxbbxg_1
  end do
#endif
  ...
  do k = 1, 16
    corr%rescc(k) = M2L1cc(extcomb_perm_ppttj_ttxbbxg_1(k))
  end do
  M2L0 = M2L0cache
  corr%rescc(0) = M2L1cache
  M2L1 = M2L1cache
#else
  call ol_fatal("born-loop colour correlators not available for process ppttj_ttxbbxg_1")
#endif
...
end module ol_vamp_ppttj_ttxbbxg_1_/**/REALKIND


#ifdef DUMMY_qp
module ol_vamp_ppttj_ttxbbxg_1_/**/QREALKIND
  implicit none
  contains
  subroutine vamp2pc(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2, mode)
    ...
    integer, intent(in), optional :: mode
    call ol_fatal("Process ppttj_ttxbbxg_1" &
      & // "has not been compiled in quad precision")
  end subroutine vamp2pc
end module ol_vamp_ppttj_ttxbbxg_1_/**/QREALKIND
#endif


#ifdef PRECISION_dp

module ol_vamp_ppttj_ttxbbxg_1
  use ol_parameters_decl_/**/DREALKIND, only: procname_length
  use ol_data_types_/**/DREALKIND, only: me_cache
  implicit none
  character(procname_length) :: processname = 'ppttj_ttxbbxg_1'
  ...
  subroutine finish_ppttj_ttxbbxg_1()
    ! final update of the stability histogram and memory deallocation
    use KIND_TYPES, only: DREALKIND
!   use ol_data_types_/**/REALKIND, only: Hpolcont
!   use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: HOL_memory_allocation
    use ol_stability, only: finish_histograms
    use ol_vamp_ppttj_ttxbbxg_1_/**/DREALKIND, only: vamp
    use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/DREALKIND, only: &
      & HOL_memory_deallocation_/**/DREALKIND, HCL_memory_deallocation_/**/DREALKIND
#ifndef DUMMY_qp
    use ol_tensor_sum_storage_ppttj_ttxbbxg_1_/**/QREALKIND, only: &
...
!   call vamp(Mdummy)
  ...
  end subroutine finish_ppttj_ttxbbxg_1


  subroutine vamp2(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2) &
      & bind(c,name="ol_f_vamp2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_init, only: register_cleanup
    use ol_external_ppttj_ttxbbxg_1, only: &
      & external_perm_ppttj_ttxbbxg_1
    use ol_vamp_ppttj_ttxbbxg_1_/**/DREALKIND, only: vamp2dp => vamp2pc
    use ol_vamp_ppttj_ttxbbxg_1_/**/QREALKIND, only: vamp2qp => vamp2pc
    ...
    if (first_call) then
      call register_cleanup(finish_ppttj_ttxbbxg_1)
      first_call = .false.
    end if
    call vamp2generic(vamp2dp, vamp2qp, processname, P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2, &
                    ...
                    & external_perm_ppttj_ttxbbxg_1, me_caches)
  end subroutine vamp2


  subroutine ctamp2(P_scatt, M2tree, M2ct) &
      & bind(c,name="ol_f_ctamp2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppttj_ttxbbxg_1_/**/DREALKIND, only: ctamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine iopamp2(P_scatt, M2tree, IRL1) &
      & bind(c,name="ol_f_iopamp2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_vamp_ppttj_ttxbbxg_1_/**/DREALKIND, only: iopamp2base
    implicit none
    real(DREALKIND), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine vamp2_c(P_scatt, M2L0, M2L1, IRL1, M2L2, IRL2) &
      & bind(c,name="ol_vamp2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine ctamp2_c(P_scatt, M2tree, M2ct) &
      & bind(c,name="ol_ctamp2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
    real(c_double), intent(in)  :: P_scatt(0:3,5)
  ...
  subroutine vampcr2(P_scatt, M2L0, M2L1, M2L2, crtype, &
      ...
      & bind(c,name="ol_f_vampcr2_ppttj_ttxbbxg_1")
    use KIND_TYPES, only: DREALKIND
    use ol_debug, only: ol_error
    use ol_vamp_ppttj_ttxbbxg_1_/**/DREALKIND, only: vamp2cache
    use ol_data_types_/**/DREALKIND, only: correlator
    implicit none
...
end module ol_vamp_ppttj_ttxbbxg_1
