...
module ol_colourmatrix_ppttj_ttxddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppttj_ttxddxg_1_/**/REALKIND



module ol_forced_parameters_ppttj_ttxddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppttj_ttxddxg_1_/**/REALKIND


! **********************************************************************
module ol_loop_storage_ppttj_ttxddxg_1_/**/REALKIND
! **********************************************************************
...
end module ol_loop_storage_ppttj_ttxddxg_1_/**/REALKIND
...
! **********************************************************************
module ol_loop_ppttj_ttxddxg_1_/**/REALKIND
! **********************************************************************
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGqq*gQCD**5
    f( 6) = countertermnorm*ctGqq*gQCD**5
...
! **********************************************************************
#ifndef PRECISION_dp
  use ol_loop_storage_ppttj_ttxddxg_1_/**/DREALKIND, only: hel_states
#endif
  implicit none
...
! M2  = helicity-summed squared matrix element for top anti-top down anti-down glue -> 0
! **********************************************************************
  use ol_parameters_decl_/**/REALKIND !, only: ci, parameters_status, ZERO, scalefactor, >masses<
  use ol_parameters_init_/**/REALKIND, only: ensure_mp_init, ensure_mp_loop_init
  use ol_kinematics_/**/REALKIND, only: init_kinematics
  use ol_momenta_decl_/**/DREALKIND, only: momenta_nan_check
  use ol_settings_ppttj_ttxddxg_1, only: hel_mem_opt, loopcc
  ...
  use ol_forced_parameters_ppttj_ttxddxg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_OLR_ppttj_ttxddxg_1
  ...
  call init_kinematics(P_scatt, extmasses2, P, &
     external_perm_inv_ppttj_ttxddxg_1, 5, qp_kinematics)
  ...
  call prop_A_Q(ntry, wf4(:,5), 24, ZERO, 0_intkind1, wf4(:,6), n2(2))
  ...
  call prop_A_Q(ntry, wf4(:,11), 24, ZERO, 0_intkind1, wf4(:,12), n2(5))
  call counter_VQ_A(ntry, wf4(:,1), ex3(:), wf8(:,8), n3(:,15), t3x8(:,:,8))
  call counter_VQ_A(ntry, ex5(:), ex3(:), wf4(:,13), n3(:,16), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,13), 20, ZERO, 0_intkind1, wf4(:,14), n2(6))
  ...
  call counter_Q_A(ctqq,1,ntry, wf4(:,4), 20, wf4(:,23), n2(11))
  call prop_A_Q(ntry, wf8(:,2), 11, ZERO, 0_intkind1, wf8(:,18), n2(12))
  call vert_QA_V(ntry, ex3(:), wf4(:,6), wf8(:,19), n3(:,30), t3x8(:,:,18))
  call counter_A_Q(ctqq,1,ntry, wf4(:,6), 24, wf4(:,24), n2(13))
  call prop_Q_A(ntry, wf8(:,3), 7, ZERO, 0_intkind1, wf8(:,20), n2(14))
...
! K1(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppttj_ttxddxg_1_/**/REALKIND, only: K1
  implicit none
...
! K2(i,j) = <Ci|Cj>
! **********************************************************************
  use ol_colourmatrix_ppttj_ttxddxg_1_/**/REALKIND, only: K2
  implicit none
...
! **********************************************************************
  use ol_colourmatrix_ppttj_ttxddxg_1_/**/REALKIND, only: KL
  implicit none
...
end module ol_loop_ppttj_ttxddxg_1_/**/REALKIND
