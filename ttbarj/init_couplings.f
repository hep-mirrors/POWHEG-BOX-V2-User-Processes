...
c     top decay only.
      ...
      if (ph_bottommass.le.0d0) ph_bottommass = 0d0
...
ccccccccccccccccccccccccc OpenLoops Init cccccccccccccccccccccccccccccccccc
...
c$$$      call set_parameter("use_cms",1)
...
c$$$      call set_parameter("minnf_alphasrun", st_nlight)
...
! write stability log files
      ...
      call set_parameter("wf_v_select",3)
      end
