module    p0_gg_hhg_amplitudeh4
   use p0_gg_hhg_config, only: ki, &
       & reduction_interoperation
   use p0_gg_hhg_color, only: numcs
   use p0_gg_hhg_groups
   use precision_golem, only: ki_gol => ki
   use p0_gg_hhg_golem95h4
   use ninjago_module, only: ki_nin
   use p0_gg_hhg_ninjah4
...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p0_gg_hhg_abbrevd65h4, only: init_abbrevd65 => init_abbrev
      use p0_gg_hhg_abbrevd25h4, only: init_abbrevd25 => init_abbrev
      use p0_gg_hhg_abbrevd55h4, only: init_abbrevd55 => init_abbrev
      use p0_gg_hhg_abbrevd63h4, only: init_abbrevd63 => init_abbrev
      use p0_gg_hhg_abbrevd19h4, only: init_abbrevd19 => init_abbrev
      use p0_gg_hhg_abbrevd59h4, only: init_abbrevd59 => init_abbrev
      use p0_gg_hhg_abbrevd4h4, only: init_abbrevd4 => init_abbrev
      use p0_gg_hhg_abbrevd6h4, only: init_abbrevd6 => init_abbrev
      use p0_gg_hhg_abbrevd15h4, only: init_abbrevd15 => init_abbrev
      use p0_gg_hhg_abbrevd21h4, only: init_abbrevd21 => init_abbrev
      use p0_gg_hhg_abbrevd31h4, only: init_abbrevd31 => init_abbrev
      use p0_gg_hhg_abbrevd51h4, only: init_abbrevd51 => init_abbrev
      use p0_gg_hhg_abbrevd17h4, only: init_abbrevd17 => init_abbrev
      use p0_gg_hhg_abbrevd47h4, only: init_abbrevd47 => init_abbrev
      use p0_gg_hhg_abbrevd8h4, only: init_abbrevd8 => init_abbrev
      use p0_gg_hhg_abbrevd23h4, only: init_abbrevd23 => init_abbrev
      use p0_gg_hhg_abbrevd27h4, only: init_abbrevd27 => init_abbrev
      use p0_gg_hhg_abbrevd35h4, only: init_abbrevd35 => init_abbrev
      use p0_gg_hhg_abbrevd61h4, only: init_abbrevd61 => init_abbrev
      use p0_gg_hhg_abbrevd57h4, only: init_abbrevd57 => init_abbrev
      use p0_gg_hhg_abbrevd53h4, only: init_abbrevd53 => init_abbrev
      use p0_gg_hhg_abbrevd43h4, only: init_abbrevd43 => init_abbrev
      use p0_gg_hhg_abbrevd13h4, only: init_abbrevd13 => init_abbrev
      use p0_gg_hhg_abbrevd29h4, only: init_abbrevd29 => init_abbrev
      use p0_gg_hhg_abbrevd33h4, only: init_abbrevd33 => init_abbrev
      use p0_gg_hhg_abbrevd49h4, only: init_abbrevd49 => init_abbrev
      use p0_gg_hhg_abbrevd45h4, only: init_abbrevd45 => init_abbrev
      use p0_gg_hhg_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group3
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group4
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group5(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group5
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group6(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group6
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group7(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group7
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group8(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group8
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group9(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group9
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group10(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group10
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group11(scale2,samplitude,ok)
   ...
   use p0_gg_hhg_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hhg_groups, only: contract_golem95
   use p0_gg_hhg_ninjah4, only: ninja_reduce => ninja_reduce_group11
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group11:
end module p0_gg_hhg_amplitudeh4
