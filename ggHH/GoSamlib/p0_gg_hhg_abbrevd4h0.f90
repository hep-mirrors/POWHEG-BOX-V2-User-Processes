...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb4(9)=spak1k2**2*abb4(8)*spbk5k1
      abb4(10)=abb4(9)*abb4(2)
      abb4(11)=2.0_ki*abb4(10)
      abb4(9)=4.0_ki*abb4(9)
      abb4(9)=abb4(2)**3*abb4(9)
      abb4(10)=-4.0_ki*abb4(10)
      abb4(12)=abb4(2)*spak1k2
      abb4(12)=16.0_ki*abb4(12)
      abb4(8)=abb4(8)*abb4(12)
      abb4(12)=spbk5k1*abb4(7)*abb4(8)
      R2d4=abb4(11)
      rat2 = rat2 + R2d4
...
end module p0_gg_hhg_abbrevd4h0
