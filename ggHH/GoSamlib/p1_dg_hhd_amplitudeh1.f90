...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p1_dg_hhd_abbrevd4h1, only: init_abbrevd4 => init_abbrev
      use p1_dg_hhd_abbrevd1h1, only: init_abbrevd1 => init_abbrev
      use p1_dg_hhd_abbrevd6h1, only: init_abbrevd6 => init_abbrev
      use p1_dg_hhd_abbrevd8h1, only: init_abbrevd8 => init_abbrev
      use p1_dg_hhd_groups
      implicit none
      real(ki), intent(in) :: scale2
...
!---#] subroutine evaluate_group2:
end module p1_dg_hhd_amplitudeh1
