...
subroutine     reconstruct_group0(coeffs)
   ...
   use p1_dg_hhd_d4h0l1, only: numerator_d4 => numerator_golem95
   use p1_dg_hhd_d4h0l1d, only: reconstruct_d4
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p1_dg_hhd_d1h0l1, only: numerator_d1 => numerator_golem95
   use p1_dg_hhd_d1h0l1d, only: reconstruct_d1
   use p1_dg_hhd_d6h0l1, only: numerator_d6 => numerator_golem95
   use p1_dg_hhd_d6h0l1d, only: reconstruct_d6
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p1_dg_hhd_d8h0l1, only: numerator_d8 => numerator_golem95
   use p1_dg_hhd_d8h0l1d, only: reconstruct_d8
   implicit none
...
!---#] subroutine reconstruct_group2:
end module p1_dg_hhd_golem95h0
