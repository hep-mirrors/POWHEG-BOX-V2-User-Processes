...
subroutine     reconstruct_group0(coeffs)
   ...
   use p0_gg_hhg_d65h0l1, only: numerator_d65 => numerator_golem95
   use p0_gg_hhg_d65h0l1d, only: reconstruct_d65
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p0_gg_hhg_d25h0l1, only: numerator_d25 => numerator_golem95
   use p0_gg_hhg_d25h0l1d, only: reconstruct_d25
   use p0_gg_hhg_d55h0l1, only: numerator_d55 => numerator_golem95
   use p0_gg_hhg_d55h0l1d, only: reconstruct_d55
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p0_gg_hhg_d63h0l1, only: numerator_d63 => numerator_golem95
   use p0_gg_hhg_d63h0l1d, only: reconstruct_d63
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p0_gg_hhg_d19h0l1, only: numerator_d19 => numerator_golem95
   use p0_gg_hhg_d19h0l1d, only: reconstruct_d19
   use p0_gg_hhg_d59h0l1, only: numerator_d59 => numerator_golem95
   use p0_gg_hhg_d59h0l1d, only: reconstruct_d59
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p0_gg_hhg_d4h0l1, only: numerator_d4 => numerator_golem95
   use p0_gg_hhg_d4h0l1d, only: reconstruct_d4
   use p0_gg_hhg_d6h0l1, only: numerator_d6 => numerator_golem95
   use p0_gg_hhg_d6h0l1d, only: reconstruct_d6
   use p0_gg_hhg_d15h0l1, only: numerator_d15 => numerator_golem95
   use p0_gg_hhg_d15h0l1d, only: reconstruct_d15
   use p0_gg_hhg_d21h0l1, only: numerator_d21 => numerator_golem95
   use p0_gg_hhg_d21h0l1d, only: reconstruct_d21
   use p0_gg_hhg_d31h0l1, only: numerator_d31 => numerator_golem95
   use p0_gg_hhg_d31h0l1d, only: reconstruct_d31
   use p0_gg_hhg_d51h0l1, only: numerator_d51 => numerator_golem95
   use p0_gg_hhg_d51h0l1d, only: reconstruct_d51
   implicit none
...
subroutine     reconstruct_group5(coeffs)
   ...
   use p0_gg_hhg_d17h0l1, only: numerator_d17 => numerator_golem95
   use p0_gg_hhg_d17h0l1d, only: reconstruct_d17
   use p0_gg_hhg_d47h0l1, only: numerator_d47 => numerator_golem95
   use p0_gg_hhg_d47h0l1d, only: reconstruct_d47
   implicit none
...
subroutine     reconstruct_group6(coeffs)
   ...
   use p0_gg_hhg_d8h0l1, only: numerator_d8 => numerator_golem95
   use p0_gg_hhg_d8h0l1d, only: reconstruct_d8
   use p0_gg_hhg_d23h0l1, only: numerator_d23 => numerator_golem95
   use p0_gg_hhg_d23h0l1d, only: reconstruct_d23
   use p0_gg_hhg_d27h0l1, only: numerator_d27 => numerator_golem95
   use p0_gg_hhg_d27h0l1d, only: reconstruct_d27
   use p0_gg_hhg_d35h0l1, only: numerator_d35 => numerator_golem95
   use p0_gg_hhg_d35h0l1d, only: reconstruct_d35
   use p0_gg_hhg_d61h0l1, only: numerator_d61 => numerator_golem95
   use p0_gg_hhg_d61h0l1d, only: reconstruct_d61
   implicit none
...
subroutine     reconstruct_group7(coeffs)
   ...
   use p0_gg_hhg_d57h0l1, only: numerator_d57 => numerator_golem95
   use p0_gg_hhg_d57h0l1d, only: reconstruct_d57
   implicit none
...
subroutine     reconstruct_group8(coeffs)
   ...
   use p0_gg_hhg_d53h0l1, only: numerator_d53 => numerator_golem95
   use p0_gg_hhg_d53h0l1d, only: reconstruct_d53
   implicit none
...
subroutine     reconstruct_group9(coeffs)
   ...
   use p0_gg_hhg_d43h0l1, only: numerator_d43 => numerator_golem95
   use p0_gg_hhg_d43h0l1d, only: reconstruct_d43
   implicit none
...
subroutine     reconstruct_group10(coeffs)
   ...
   use p0_gg_hhg_d13h0l1, only: numerator_d13 => numerator_golem95
   use p0_gg_hhg_d13h0l1d, only: reconstruct_d13
   use p0_gg_hhg_d29h0l1, only: numerator_d29 => numerator_golem95
   use p0_gg_hhg_d29h0l1d, only: reconstruct_d29
   use p0_gg_hhg_d33h0l1, only: numerator_d33 => numerator_golem95
   use p0_gg_hhg_d33h0l1d, only: reconstruct_d33
   use p0_gg_hhg_d49h0l1, only: numerator_d49 => numerator_golem95
   use p0_gg_hhg_d49h0l1d, only: reconstruct_d49
   implicit none
...
subroutine     reconstruct_group11(coeffs)
   ...
   use p0_gg_hhg_d45h0l1, only: numerator_d45 => numerator_golem95
   use p0_gg_hhg_d45h0l1d, only: reconstruct_d45
   implicit none
...
!---#] subroutine reconstruct_group11:
end module p0_gg_hhg_golem95h0
