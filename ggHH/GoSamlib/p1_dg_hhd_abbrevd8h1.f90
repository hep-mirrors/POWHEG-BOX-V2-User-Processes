...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb8(14)=es12*spal4k5
      abb8(15)=abb8(14)*spbl4k2
      abb8(16)=spbl4k2*spal3l4
      abb8(17)=abb8(16)*spbl3k1
      abb8(18)=abb8(17)*spak1k5
      abb8(19)=spal3k5*spbl3k2
      ...
      abb8(27)=abb8(26)*spbl4k2
      abb8(28)=abb8(27)*spak2l4
      abb8(28)=abb8(28)+1.0_ki
      abb8(29)=abb8(28)*spak1k5
      abb8(30)=abb8(7)+abb8(27)
      abb8(30)=abb8(30)*spak2k5*spak1l4
      abb8(29)=abb8(29)+abb8(30)
      abb8(30)=abb8(22)*spbk2k1
      abb8(31)=-abb8(29)*abb8(30)
      abb8(25)=abb8(25)+abb8(31)
      abb8(31)=mH**2
      abb8(25)=abb8(25)*abb8(31)
      abb8(32)=abb8(22)*spak1k5
      abb8(33)=2.0_ki*abb8(32)
      abb8(34)=spal3k5*spbl4l3
      abb8(35)=abb8(34)*spak1l4
      ...
      abb8(29)=spbk2k1*abb8(29)
      abb8(24)=-abb8(24)+abb8(29)
      abb8(24)=abb8(24)*abb8(31)
      abb8(29)=spbk2k1*abb8(35)
      ...
      abb8(30)=abb8(29)*spak1l3
      abb8(35)=-spbk2k1*abb8(30)
      abb8(39)=-abb8(3)*spbl3k1*spak1l3*abb8(22)
      abb8(39)=-abb8(17)+abb8(39)
      abb8(10)=2.0_ki*abb8(39)*abb8(10)
      abb8(30)=spbl3k1*abb8(30)
      abb8(39)=abb8(29)*spbl3k2
      abb8(32)=-abb8(32)*abb8(39)
      abb8(39)=spak1k5*abb8(39)
      abb8(42)=spal4k5*spbl4k1
      abb8(43)=spal3k5*spbl3k1
      abb8(44)=-4.0_ki*abb8(42)-3.0_ki*abb8(43)
      abb8(37)=abb8(44)*abb8(37)
      abb8(44)=-spak2l4*abb8(34)
      abb8(45)=spak2k5*abb8(22)
      abb8(44)=abb8(44)-6.0_ki*abb8(45)
      abb8(44)=spbk2k1*abb8(44)
      abb8(45)=abb8(38)*spak2k5
      abb8(46)=abb8(26)*spak2k5
      abb8(47)=-3.0_ki*abb8(46)-4.0_ki*abb8(45)
      abb8(47)=abb8(47)*abb8(22)
      abb8(28)=-spak2k5*abb8(28)
      abb8(28)=abb8(28)+abb8(47)
      abb8(47)=abb8(31)*spbk2k1
      abb8(28)=abb8(28)*abb8(47)
      abb8(17)=-spak2k5*abb8(17)
      abb8(17)=2.0_ki*abb8(28)+abb8(44)+abb8(17)+abb8(37)
      abb8(17)=abb8(17)*abb8(29)
      abb8(28)=abb8(46)*abb8(47)
      abb8(37)=spbk2k1*spak2k5
      abb8(28)=abb8(43)+abb8(37)+abb8(28)
      abb8(37)=-abb8(28)*abb8(20)
      abb8(44)=abb8(47)*abb8(45)
      abb8(44)=abb8(42)+abb8(44)
      abb8(44)=abb8(44)*abb8(20)
      abb8(42)=abb8(26)*abb8(42)
      abb8(43)=-abb8(38)*abb8(43)
      abb8(46)=-spbk2k1*abb8(45)
      abb8(42)=abb8(46)+abb8(42)+abb8(43)
      abb8(42)=abb8(42)*abb8(31)*abb8(20)
      abb8(25)=-abb8(28)*abb8(25)
      abb8(26)=abb8(26)*spak2l4
      abb8(26)=abb8(26)+2.0_ki*abb8(8)
      abb8(28)=-abb8(26)*abb8(47)
      abb8(43)=spbl3k1*spal3l4
      abb8(28)=-abb8(43)+abb8(28)
      abb8(28)=abb8(28)*abb8(29)
      abb8(38)=abb8(38)*spak2l3
      abb8(43)=-abb8(47)*abb8(38)
      abb8(46)=spal3l4*spbl4k1
      abb8(43)=abb8(46)+abb8(43)
      abb8(43)=abb8(43)*abb8(29)
      abb8(46)=abb8(29)*abb8(31)
      abb8(26)=spbl4k1*abb8(26)
      abb8(38)=spbl3k1*abb8(38)
      abb8(26)=abb8(38)+abb8(26)
      abb8(26)=abb8(26)*abb8(46)
      abb8(22)=24.0_ki*abb8(22)*abb8(11)
      abb8(11)=16.0_ki*abb8(11)
      abb8(23)=abb8(23)*abb8(11)
      abb8(38)=abb8(27)+2.0_ki*abb8(7)
      abb8(38)=abb8(31)*spak2k5*abb8(38)
      abb8(34)=abb8(34)+abb8(38)
      abb8(34)=abb8(34)*abb8(29)
      abb8(31)=spbl3k2*abb8(31)*abb8(45)
      abb8(38)=-spal4k5*spbl4l3
      abb8(31)=abb8(38)+abb8(31)
      abb8(29)=abb8(31)*abb8(29)
      abb8(27)=-spal4k5*abb8(27)
      abb8(19)=-abb8(8)*abb8(19)
      abb8(19)=-2.0_ki*spal4k5+abb8(19)
      abb8(19)=abb8(7)*abb8(19)
      abb8(19)=abb8(27)+abb8(19)
      abb8(19)=abb8(19)*abb8(46)
      R2d8=abb8(13)
      rat2 = rat2 + R2d8
...
end module p1_dg_hhd_abbrevd8h1
