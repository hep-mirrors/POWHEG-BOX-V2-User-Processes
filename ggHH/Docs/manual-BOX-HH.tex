...
\keywords{Shower Monte Carlo, POWHEG, NLO, Higgs}
...
\abstract{This note documents the use of the package \POWHEGBOXV{} for
  ...
  production with full top quark mass dependence, and also allows variations of the Higgs boson trilinear coupling $c_{hhh}=\kappa_\lambda=\lambda/\lambda_{SM}$. By rescaling as described below, it also allows to vary the top-Higgs Yukawa coupling.
