...
!
!*****
module golem_function_3p1m_2mi_qp
  !
  use golem_precision_golem_qp
  use golem_func_gn_qp
  ...
  use golem_constante_qp, only : un,i_,pi6
  use golem_parametre_qp, only : rat_or_tot_par,mu2_scale_par
  ...
  contains
    ...
    !
end module golem_function_3p1m_2mi_qp
