...
module golem_avh_olo_version_qp
  implicit none
  private
  public :: olo_version
...
module golem_avh_olo_dp_kinds_qp
  use golem_avh_olo_xkind_qp
  public :: kindr2
  integer ,parameter :: kindr2=olo_xkind
end module


module golem_avh_olo_dp_arrays_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_kinds_qp 
  implicit none
  private
...
module golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_kinds_qp
...
module golem_avh_olo_dp_print_qp
  use golem_avh_olo_dp_prec_qp
  implicit none
  private
  public :: myprint
...
module golem_avh_olo_dp_auxfun_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
...
module golem_avh_olo_dp_olog_qp
!***********************************************************************
...
!***********************************************************************
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_print_qp
  use golem_avh_olo_dp_auxfun_qp
  implicit none
  private
...
!***********************************************************************
!***********************************************************************
  use golem_avh_olo_dp_arrays_qp
  real(kindr2) &  
    :: tt
  integer :: nn,mm,ii,jj
...
module golem_avh_olo_dp_dilog_qp
!***********************************************************************
!                     /1    ln(1-zz*t)
!   dilog(xx,iph) = - |  dt ---------- 
!                     /0        t
...
module golem_avh_olo_dp_bnlog_qp
!***********************************************************************
!                      /1    
...
module golem_avh_olo_dp_qmplx_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_auxfun_qp
  use golem_avh_olo_dp_olog_qp
  use golem_avh_olo_dp_dilog_qp
...
module golem_avh_olo_dp_bub_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_auxfun_qp
  use golem_avh_olo_dp_bnlog_qp
  use golem_avh_olo_dp_qmplx_qp
  use golem_avh_olo_dp_olog_qp
  implicit none
  private
...
module golem_avh_olo_dp_tri_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_auxfun_qp
  use golem_avh_olo_dp_qmplx_qp
...
module golem_avh_olo_dp_box_qp
  use golem_avh_olo_units_qp
  use golem_avh_olo_dp_prec_qp
  use golem_avh_olo_dp_auxfun_qp
  use golem_avh_olo_dp_qmplx_qp
...
module golem_avh_olo_dp_boxc_qp
   use golem_avh_olo_units_qp
   use golem_avh_olo_dp_prec_qp
   use golem_avh_olo_dp_auxfun_qp
   use golem_avh_olo_dp_qmplx_qp
...
!*******************************************************************
   use golem_avh_olo_dp_box_qp ,only: base,casetable,ll=>permtable
  complex(kindr2) &   
     ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!*******************************************************************
!*******************************************************************
  use golem_avh_olo_dp_olog_qp  ,only: update_olog
  use golem_avh_olo_dp_dilog_qp ,only: update_dilog
  use golem_avh_olo_dp_bnlog_qp ,only: update_bnlog
...
!*******************************************************************
!*******************************************************************
  use golem_avh_olo_dp_prec_qp ,only: ndecim,prcpar
  integer :: rslt
  if (initz) call init
  rslt = ndecim(prcpar)
  end function
...
!
  use golem_avh_olo_dp_bub_qp ,only: tadp
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!
  use golem_avh_olo_dp_bub_qp ,only: tadpn
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:,0:)   
  complex(kindr2) &   
...
!
  use golem_avh_olo_dp_bub_qp ,only: bub0
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!
  use golem_avh_olo_dp_bub_qp ,only: dbub0
  use golem_avh_olo_dp_olog_qp ,only: olog
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!
  use golem_avh_olo_dp_bub_qp ,only: bub11
!
  complex(kindr2) &   
    ,intent(out) :: b11(0:2),b00(0:2),b1(0:2),b0(0:2)
  complex(kindr2) &   
...
!
  use golem_avh_olo_dp_bub_qp ,only: bub0,bub1,bub11,bub111,bub1111
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:,0:)   
  complex(kindr2) &   
...
!*******************************************************************
  ...
  use golem_avh_olo_dp_tri_qp
  use golem_avh_olo_dp_auxfun_qp ,only: kallen
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!*******************************************************************
  ...
  use golem_avh_olo_dp_box_qp
  use golem_avh_olo_dp_boxc_qp
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
module golem_avh_olo_qp

  use golem_avh_olo_units_qp, only: olo_errorcode=>errorcode

  use golem_avh_olo_dp_qp ,only: &
...
contains
  ...
  subroutine olo_unit( val ,message )
  use golem_avh_olo_version_qp
  use golem_avh_olo_units_qp ,only: set_unit
  integer     ,intent(in) :: val
  character(*),intent(in),optional :: message
  call olo_version
  if (present(message)) then ;call set_unit( message ,val )
  ...
  use golem_avh_olo_dp_qp ,only: dp_sub=>olo_precision 
  integer ,intent(in) :: ndec
  call dp_sub( ndec ) 
  end subroutine

  subroutine olo_scale( val )
  use golem_avh_olo_dp_qp ,only: dp_sub=>olo_scale 
  real(olo_dp_kind) ,intent(in) :: val
  call dp_sub( val ) 
  end subroutine

  subroutine olo_onshell( val )
  use golem_avh_olo_dp_qp ,only: dp_sub=>olo_onshell 
  real(olo_dp_kind) ,intent(in) :: val
  call dp_sub( val ) 
  end subroutine
  ...
  write(nunit,*) 'ERROR in OneLOop: use  function olo_get_scale  etc. instead.'
      ...
      subroutine avh_olo_mu_set_qp(mu)
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      real(rkind) ,intent(in) :: mu
      call olo_scale( mu )
      end subroutine

      subroutine avh_olo_onshell_qp(thrs)
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      ...
      subroutine avh_olo_unit_qp( unit_in )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      ...
      subroutine avh_olo_printall_qp( unit_in )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      integer ,intent(in) :: unit_in
      ...
      subroutine avh_olo_a0c_qp( rslt ,mm )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      ...
      subroutine avh_olo_b0c_qp( rslt ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_db0c_qp( rslt ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      complex(rkind) ,intent(in)  :: pp,m1,m2
      ...
      subroutine avh_olo_b11c_qp( b11,b00,b1,b0 ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      ...
      subroutine avh_olo_c0c_qp( rslt ,p1,p2,p3 ,m1,m2,m3 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_d0c_qp( rslt ,p1,p2,p3,p4,p12,p23 ,m1,m2,m3,m4 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_a0m_qp( rslt ,mm )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_b0m_qp( rslt ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_db0m_qp( rslt ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      real(rkind)    ,intent(in)  :: pp,m1,m2
      ...
      subroutine avh_olo_b11m_qp( b11,b00,b1,b0 ,pp,m1,m2 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: b11(0:2),b00(0:2),b1(0:2),b0(0:2)
      real(rkind)    ,intent(in)  :: pp,m1,m2
      ...
      subroutine avh_olo_c0m_qp( rslt ,p1,p2,p3 ,m1,m2,m3 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
      ...
      subroutine avh_olo_d0m_qp( rslt ,p1,p2,p3,p4,p12,p23 ,m1,m2,m3,m4 )
      use golem_avh_olo_qp ,rkind=>olo_dp_kind
      implicit none
      complex(rkind) ,intent(out) :: rslt(0:2)
