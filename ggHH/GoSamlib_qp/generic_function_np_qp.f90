...
! USAGE
!
!  use golem_generic_function_np_qp
!
! DESCRIPTION
!
...
!
!*****
module golem_generic_function_np_qp
  !
  use golem_array_qp
  use golem_cache_generic_qp
  use golem_constante_qp, only: czero
  use golem_equal_qp
  use golem_form_factor_1p_qp
  use golem_form_factor_2p_qp
  use golem_form_factor_3p_qp
  use golem_form_factor_4p_qp
  use golem_form_factor_5p_qp
  use golem_form_factor_type_qp
  use golem_generic_function_1p_qp
  use golem_generic_function_2p_qp
  use golem_generic_function_3p_qp
  use golem_generic_function_4p_qp
  use golem_inverse_matrice_qp
  ...
  contains
    ...
    recursive function fnp_generic(leg_count,dim_nplus,b_pin,l_count,l,depth) result(return_val)
       ...
       if (cur_depth <= 100) then ! do not use golem_cache_qp for control
...
end module golem_generic_function_np_qp
