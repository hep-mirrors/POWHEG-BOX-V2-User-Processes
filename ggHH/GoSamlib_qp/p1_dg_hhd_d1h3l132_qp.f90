module p1_dg_hhd_d1h3l132_qp
   ! file: /home/luisonig/Documents/Lavoro/GoSamPowheg/POWHEG-BOX-V2/ggHH/GoSam &
   ! &_POWHEG/Virtual/p1_dg_hhd/helicity3d1h3l132.f90
...
!---#[ subroutine brack_22:
   pure subroutine brack_22(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      ninjaP1 = ninjaP(1)
      ninjaP2 = ninjaP(2)
      acd1(1)=dotproduct(ninjaA1,spvak1k2)
      acd1(2)=dotproduct(ninjaE3,spvak1k5)
      acd1(3)=abb1(6)
      acd1(4)=dotproduct(ninjaA1,spvak1k5)
      acd1(5)=dotproduct(ninjaE3,spvak1k2)
      acd1(6)=dotproduct(ninjaA0,spvak1k2)
      acd1(7)=dotproduct(ninjaA0,spvak1k5)
      acd1(8)=acd1(2)*acd1(3)
      acd1(9)=acd1(1)*acd1(8)
      acd1(10)=acd1(5)*acd1(3)
      acd1(11)=acd1(4)*acd1(10)
      acd1(9)=acd1(9)+acd1(11)
      acd1(8)=acd1(6)*acd1(8)
      acd1(10)=acd1(7)*acd1(10)
      acd1(8)=acd1(8)+acd1(10)
      brack(ninjaidxt0x0mu0)=acd1(8)
      brack(ninjaidxt0x0mu2)=0.0_ki
      brack(ninjaidxt0x1mu0)=acd1(9)
      brack(ninjaidxt0x2mu0)=0.0_ki
   end subroutine brack_22
!---#] subroutine brack_22:
!---#[ subroutine numerator_t2:
   subroutine numerator_t2(ncut, a0, a1, b, c, param, deg, coeffs) &
   & bind(c, name="p1_dg_hhd_d1h3_ninja_t2_qp")
...
!---#] subroutine numerator_t2:
end module p1_dg_hhd_d1h3l132_qp
