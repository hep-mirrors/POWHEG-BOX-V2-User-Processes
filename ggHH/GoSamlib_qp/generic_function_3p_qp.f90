...
!
!*****
module golem_generic_function_3p_qp
  !
  use golem_precision_golem_qp
  use golem_matrice_s_qp, only : dim_s,b_ref
  use golem_s_matrix_type_qp
  use golem_array_qp
  use golem_tri_croissant_qp
  use golem_constante_qp
  use golem_function_3p0m_1mi_qp
  use golem_function_3p1m_qp
  use golem_function_3p1m_1mi_qp
  use golem_function_3p1m_2mi_qp
  use golem_function_3p2m_qp
  use golem_function_3p2m_1mi_qp
  use golem_function_3p3m_qp
...
!    calls_f3p_np2_sc = calls_f3p_np2_sc + 1
  ...
  !
end module golem_generic_function_3p_qp
