...
function gc0i(idt,s1,s2,s3,m1,m2,m3,mu2,eps_flag)
  !
  use golem_precision_golem_qp ! to get the type ki (for real and complex)
  use golem_matrice_s_qp
  use golem_form_factor_type_qp, only: form_factor
  use golem_form_factor_3p_qp 
  use golem_form_factor_higher_ranks_qp
  use golem_cache_qp, only: allocate_cache, clear_cache
  use golem_constante_qp, only: b_null
  use golem_tool_lt_to_golem_qp, only : extract
...
function gc0(s1,s2,s3,m1,m2,m3,mu2,eps_flag)
  ...
  use golem_form_factor_3p_qp ! module containing the three-point form factors (export all)
  use golem_cache_qp, only: allocate_cache, clear_cache
