...
module golem_func_he_qp
  ...
  use golem_parametre_qp, only : coupure_3p2m,rat_or_tot_par,tolerance,alpha_par,&
       & beta_par,lambda_par
  use golem_logarithme_qp, only : z_log
