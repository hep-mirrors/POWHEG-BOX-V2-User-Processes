...
#  define AVH_ONSHELL_KIND(x) real(x,selected_real_kind(33, 4931))
# endif
#endif
...
# define AVH_ONSHELL_KIND(x) x
      ...
      subroutine ninjavholo_qp_onshell(thrs)  bind (c)
      ...
      subroutine ninjavholo_qp_d0_cm(rslt,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,rmu) &
           & bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      ...
      subroutine ninjavholo_qp_d0_rm(rslt,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,rmu) &
           & bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      ...
      subroutine ninjavholo_qp_c0_cm(rslt,p1,p2,p3,m1,m2,m3,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine ninjavholo_qp_c0_rm(rslt,p1,p2,p3,m1,m2,m3,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine ninjavholo_qp_b0_cm(rslt,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine ninjavholo_qp_b0_rm(rslt,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine ninjavholo_qp_b11_cm(b11,b00,b1,b0,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      ...
      subroutine ninjavholo_qp_b11_rm(b11,b00,b1,b0,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: b11,b00,b1,b0
      ...
      subroutine ninjavholo_qp_a0_cm(rslt,mm,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine ninjavholo_qp_a0_rm(rslt,mm,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use golem_avh_olo_qp
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
