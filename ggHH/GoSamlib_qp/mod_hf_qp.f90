...
module golem_func_hf_qp
  ...
  use golem_parametre_qp, only : coupure_3p2m,rat_or_tot_par,tolerance,alpha_par,beta_par,lambda_par,mu2_scale_par
  use golem_logarithme_qp, only : z_log,z_log2
...
contains
  ...
  !  alpha_par are given by the module golem_parametre_qp
  !
  ! RETURN VALUE
  !
