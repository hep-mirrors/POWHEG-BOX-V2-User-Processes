...
namespace ninja_qp {
  namespace details {
    ...
    template<typename T, typename U>
    struct common_type;
    template<> struct common_type<ninja_qp::Complex, ninja_qp::Real> {
      typedef ninja_qp::Complex type;
    };
    template<>
    struct common_type<ninja_qp::Real,ninja_qp::Complex> {
      typedef ninja_qp::Complex type;
    };
    template<>
    struct common_type<ninja_qp::Complex,ninja_qp::Complex> {
      typedef ninja_qp::Complex type;
    };
    template<typename T>
...
namespace ninja_qp {
  ...
  namespace details {
    ...
    // Specialize ninja_qp::details::common_type<...>
    template<typename T>
