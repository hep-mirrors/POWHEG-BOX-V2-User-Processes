module p0_gg_hhg_dipoles_qp
   use p0_gg_hhg_config_qp, only: ki
   use p0_gg_hhg_color_qp, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T5, &
       & T2T5
   use p0_gg_hhg_kinematics_qp, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p0_gg_hhg_dipoles_qp
