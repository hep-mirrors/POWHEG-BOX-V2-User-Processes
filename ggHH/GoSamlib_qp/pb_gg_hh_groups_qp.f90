...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use pb_gg_hh_config_qp, only: debug_nlo_diagrams, logfile
   use pb_gg_hh_kinematics_qp, only: k1, k2, k3, k4, es12, es3, es23, es4
