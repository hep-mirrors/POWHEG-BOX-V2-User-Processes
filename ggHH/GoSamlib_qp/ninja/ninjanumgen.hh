...
namespace {
  ...
  typedef ninja_qp::Complex NinjaAbbrType;

  const ninja_qp::Real NINJAZERO(0);

  //template<unsigned N>
  //struct NinjaFormAbbr {
  //    ninja_qp::Complex data_[N];
  //    ninja_qp::Complex & operator[](unsigned i)
  //    {
  //      return data_[i-1];
  //    }
  //    ninja_qp::Complex & operator[](unsigned i) const
  //    {
  //      return data_[i-1];
  //    }
  //};
  ...
  inline ninja_qp::Complex ninjaMP(const T & p, const U & u)
  {
    return ninja_qp::mp(p,u);
  }
