...
namespace ninja_qp {
  ...
  void setDefaultIntegralLibrary(ninja_qp::IntegralLibrary & lib);
  ninja_qp::IntegralLibrary * getIntegralLibrary();
  ...
  private:
    ...
    friend ninja_qp::IntegralLibrary * getIntegralLibrary();
