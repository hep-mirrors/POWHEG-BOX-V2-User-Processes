...
#define NINJA_REAL(x) (ninja_qp::Real(x))

#if !defined(NINJA_QUADRUPLE) && !defined(QUADNINJA_TYPES_HH_INSIDE)
# define NINJA_REAL_DEF(x) (ninja_qp::Real(x))
# define NINJA_COMPLEX_DEF(r,i) (ninja_qp::Complex(r,i))
#else
# define NINJA_TOKEN_QPASTE0(x,y) x##y
# define NINJA_REAL_DEF(x) (ninja_qp::Real(NINJA_TOKEN_QPASTE0(x,q)))
# define NINJA_COMPLEX_DEF(r,i) (ninja_qp::Complex(NINJA_REAL_DEF(r)),ninja_qp::Complex(NINJA_REAL_DEF(i)))
#endif
...
namespace ninja_qp {
...
#else
  typedef ninja_qp::Quadruple Real;
  typedef ninja_qp::ComplexQuadruple Complex;
  ...
  // Specialize ninja_qp::const_pointer<ZeroFloat>
...
#if !defined(NINJA_QUADRUPLE) && !defined(QUADNINJA_TYPES_HH_INSIDE)
  const ninja_qp::Real PI = M_PI;
#else
  const ninja_qp::Real PI = M_PIq;
#endif
