...
subroutine     reconstruct_group0(coeffs)
   ...
   use pb_gg_hh_d10h1l1_qp, only: numerator_d10 => numerator_golem95
   use pb_gg_hh_d10h1l1d_qp, only: reconstruct_d10
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use pb_gg_hh_d4h1l1_qp, only: numerator_d4 => numerator_golem95
   use pb_gg_hh_d4h1l1d_qp, only: reconstruct_d4
   use pb_gg_hh_d8h1l1_qp, only: numerator_d8 => numerator_golem95
   use pb_gg_hh_d8h1l1d_qp, only: reconstruct_d8
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use pb_gg_hh_d6h1l1_qp, only: numerator_d6 => numerator_golem95
   use pb_gg_hh_d6h1l1d_qp, only: reconstruct_d6
   implicit none
...
!---#] subroutine reconstruct_group2:
end module pb_gg_hh_golem95h1_qp
