...
namespace ninja_qp {
  ...
  Complex TensorNumerator::evaluate(const ninja_qp::ComplexMomentum & q,
  ...
  void TensorNumerator::muExpansion(const ninja_qp::ComplexMomentum v[],
  ...
  void TensorNumerator::t3Expansion(const ninja_qp::ComplexMomentum & a,
  ...
  void TensorNumerator::t2Expansion(const ninja_qp::ComplexMomentum & a0,
