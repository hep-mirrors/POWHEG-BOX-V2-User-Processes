module p0_gg_hhg_d4h4l1_qp
   ! file: /home/luisonig/Documents/Lavoro/GoSamPowheg/POWHEG-BOX-V2/ggHH/GoSam &
   ! &_POWHEG/Virtual/p0_gg_hhg/helicity4d4h4l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc4(6)=Qspvak1k2*acc4(1)
      acc4(5)=acc4(6)+acc4(5)
      acc4(5)=Qspvak5k2*acc4(5)
      acc4(6)=QspQ*acc4(4)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_gg_hhg_d4h4l1_ninja_qp")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_gg_hhg_d4h4l1_qp
