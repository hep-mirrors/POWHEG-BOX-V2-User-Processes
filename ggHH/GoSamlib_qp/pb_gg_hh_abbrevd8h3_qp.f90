module pb_gg_hh_abbrevd8h3_qp
   use pb_gg_hh_config_qp, only: ki
   use pb_gg_hh_globalsh3_qp
   implicit none
   private
   complex(ki), dimension(32), public :: abb8
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb8(10)=spak1l4*spbl4k1
      abb8(11)=spbl4k2*spak2l4
      ...
      abb8(22)=abb8(1)*gHT**2
      abb8(6)=abb8(6)*abb8(22)
      abb8(28)=abb8(6)*spbl4k1
      abb8(29)=-abb8(13)*abb8(28)
      abb8(17)=-spbl4k1*abb8(17)*abb8(22)
      abb8(14)=abb8(14)+es12
      abb8(22)=spbl4k2*spak1l4
      abb8(14)=abb8(7)*abb8(22)*abb8(14)
      abb8(22)=abb8(18)*abb8(22)
      abb8(6)=-spbl4k2*abb8(6)
      abb8(30)=abb8(7)*spbk2k1
      abb8(31)=abb8(30)*spak2l4
      abb8(32)=abb8(13)*abb8(31)
      abb8(18)=abb8(18)*spak2l4*spbk2k1
      abb8(30)=-spak1l4*abb8(30)
      abb8(8)=spak2l4*spbl4k1*abb8(8)
...
end module pb_gg_hh_abbrevd8h3_qp
