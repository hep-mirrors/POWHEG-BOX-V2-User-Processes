...
!
!*****
module golem_sortie_erreur_qp
  !
  use golem_precision_golem_qp
  use golem_parametre_qp, only : if_print_info_par,if_print_warn_par,not_enough_accuracy_par
  use golem_array_qp, only : unpackb
  implicit none
  !
  private
  !
  ...
  contains
    ...
    !
end module golem_sortie_erreur_qp
