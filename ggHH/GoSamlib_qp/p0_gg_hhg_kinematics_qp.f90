module p0_gg_hhg_kinematics_qp
   use p0_gg_hhg_config_qp, only: ki
   use p0_gg_hhg_model_qp
   use p0_gg_hhg_scalar_cache_qp
   implicit none
   save
   ...
   complex(ki), public :: spal4k5, spbk5l4
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2, hel5)
      use p0_gg_hhg_model_qp
      implicit none
      real(ki), dimension(num_legs,4), intent(in) :: vecs
      integer, intent(in), optional :: hel1
      integer, intent(in), optional :: hel2
      integer, intent(in), optional :: hel5
      complex(ki) :: N1
      logical :: flag1
      complex(ki) :: N2
      logical :: flag2
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p0_gg_hhg_kinematics_qp
