...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use golem_form_factor_5p_qp, only: a50
   use golem_form_factor_type_qp, only: form_factor, operator(+), operator(-)
   use p0_gg_hhg_config_qp, only: debug_nlo_diagrams, logfile
   use p0_gg_hhg_kinematics_qp, only: k1, k2, k3, k4, k5, es45, es12, es3, es51, es23, es4, es34
...
!---#] subroutine ninja_exit:
end module p0_gg_hhg_groups_qp
