...
#if QUADNINJA
#if defined(NINJA_USE_ONELOOP) && defined(NINJA_USE_ONELOOP_WITH_CACHE)
    if (quadninja_qp::getIntegralLibrary() == (& quadninja_qp::avh_olo))
      quadninja_qp::avh_olo.clearIntegralCache();
#endif
//#ifdef NINJA_USE_LOOPTOOLS
//    if (quadninja_qp::getIntegralLibrary() == (& quadninja_qp::loop_tools))
//      quadninja_qp::loop_tools.clearIntegralCache();
//#endif
#endif
  }
...
#if QUADNINJA
    quadninja_qp::avh_olo.freeIntegralCache();
#endif
#endif
  }
...
#if QUADNINJA
    quadninja_qp::setTestTolerance(val);
#endif
  }
...
#if QUADNINJA
      quadninja_qp::setDefaultIntegralLibrary(quadninja_qp::avh_olo);
#endif
      break;
#endif
#ifdef NINJA_USE_LOOPTOOLS
...
//#if QUADNINJA
//      quadninja_qp::setDefaultIntegralLibrary(ninja_qp::loop_tools);
//#endif
      break;
#endif
    default:
  ...
  {
    quadninja_qp::setDefaultFloatingPointThreshold(thr);
  }
#endif
