...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki), dimension(5) :: acd4
      complex(ki) :: brack
      acd4(1)=dotproduct(qshift,spvak2k1)
      acd4(2)=dotproduct(qshift,spvak2k5)
      acd4(3)=abb4(7)
      acd4(4)=abb4(8)
      acd4(5)=acd4(3)*acd4(2)*acd4(1)
      brack=acd4(4)+acd4(5)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(7) :: acd4
      complex(ki) :: brack
      acd4(1)=spvak2k1(iv1)
      acd4(2)=dotproduct(qshift,spvak2k5)
      acd4(3)=abb4(7)
      acd4(4)=spvak2k5(iv1)
      acd4(5)=dotproduct(qshift,spvak2k1)
      acd4(6)=-acd4(2)*acd4(1)
      acd4(7)=-acd4(5)*acd4(4)
      acd4(6)=acd4(6)+acd4(7)
      brack=acd4(6)*acd4(3)
...
!---#] subroutine reconstruct_d4:
end module p0_gg_hhg_d4h1l1d_qp
