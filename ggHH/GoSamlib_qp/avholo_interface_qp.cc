...
namespace ninja_qp {
  ...
  void AvHOneLoop::setInfraredThreshold(Real threshold)
  {
    ...
    ninjavholo_qp_onshell(ir_threshold_);
  }
  ...
  {
    ninjavholo_qp_b0_cm(result,p1,m1,m2,mur_);
  }
  ...
  AvHOneLoop::getBubbleIntegralRM(Complex result[3],
                                  ...
                                  Real m1, Real m2)
  {
    ninjavholo_qp_b0_rm(result,p1,m1,m2,mur_);
  }
...
namespace ninja_qp {
                               ...
                               const Complex & m3, const Complex & m4)
  {
    ...
    if (cache_->ht_4cm.find(args,val)) {
      ...
      ninjavholo_qp_d0_cm(result,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                               ...
                               Real m3, Real m4)
  {
    ...
    if (cache_->ht_4rm.find(args,val)) {
      ...
      ninjavholo_qp_d0_rm(result,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                               ...
                               Real p12, Real p23)
  {
    ...
    if (cache_->ht_4nm.find(args,val)) {
      ...
      ninjavholo_qp_d0_rm(result,p1,p2,p3,p4,p12,p23,msq,msq,msq,msq,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                                    ...
                                    const Complex & m3)
  {
    ...
    if (cache_->ht_3cm.find(args,val)) {
      ...
      ninjavholo_qp_c0_cm(result,p1,p2,p3,m1,m2,m3,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                                    ...
                                    Real m3)
  {
    ...
    if (cache_->ht_3rm.find(args,val)) {
      ...
      ninjavholo_qp_c0_rm(result,p1,p2,p3,m1,m2,m3,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                                    ...
                                    Real p3)
  {
    ...
    if (cache_->ht_3nm.find(args,val)) {
      ...
      ninjavholo_qp_c0_rm(result,p1,p2,p3,msq,msq,msq,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
                                       ...
                                       const Complex & m1, const Complex & m2)
  {
    ...
    if (cache_->ht_2cm.find(args,val)) {
      ...
      Complex avh_res00[3];
      ninjavholo_qp_b11_cm(b11,avh_res00,b1,b0,p1,m1,m2,mur_);
      val->data11[0] = b11[0];
      val->data11[1] = b11[1];
      val->data11[2] = b11[2];
      val->data1[0] = b1[0];
                                       ...
                                       Real m1, Real m2)
  {
    ...
    if (cache_->ht_2rm.find(args,val)) {
      ...
      Complex avh_res00[3];
      ninjavholo_qp_b11_rm(b11,avh_res00,b1,b0,p1,m1,m2,mur_);
      val->data11[0] = b11[0];
      val->data11[1] = b11[1];
      val->data11[2] = b11[2];
      val->data1[0] = b1[0];
                                       ...
                                       Real p1)
  {
    ...
    if (cache_->ht_2nm.find(args,val)) {
      ...
      Complex avh_res00[3];
      ninjavholo_qp_b11_rm(b11,avh_res00,b1,b0,p1,msq,msq,mur_);
      val->data11[0] = b11[0];
      val->data11[1] = b11[1];
      val->data11[2] = b11[2];
      val->data1[0] = b1[0];
  ...
  AvHOneLoop::getTadpoleIntegralCM(Complex result[3], const Complex & m0)
  {
    ...
    if (cache_->ht_1cm.find(args,val)) {
      ...
      ninjavholo_qp_a0_cm(result,m0,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
  ...
  AvHOneLoop::getTadpoleIntegralRM(Complex result[3], Real m0)
  {
    ...
    if (cache_->ht_1rm.find(args,val)) {
      ...
      ninjavholo_qp_a0_rm(result,m0,mur_);
      val->data[0] = result[0];
      val->data[1] = result[1];
      val->data[2] = result[2];
    }
