...
! USAGE
!
!  use golem_function_3p2m_1mi_qp
!
! DESCRIPTION
!
...
!
!*****
module golem_function_3p2m_1mi_qp
  !
  use golem_precision_golem_qp
  use golem_logarithme_qp
  use golem_dilogarithme_qp
  use golem_func_he_qp
  use golem_func_hf_qp
  use golem_sortie_erreur_qp, only : tab_erreur_par,catch_exception,origine_info_par,num_grand_b_info_par,denom_grand_b_info_par
  use golem_constante_qp, only : i_, un, czero
  use golem_parametre_qp, only : coupure_3p2m_1mi,rat_or_tot_par,tolerance,alpha_par,beta_par,lambda_par,mu2_scale_par
  use golem_array_qp, only : packb
  use golem_numerical_evaluation_qp, only : generic_eval_numer
  use golem_matrice_s_qp, only: find_plus_grand
  implicit none
  !
  private
...
!
  ...
  contains
   ...
   function f3p2m_1mi_c(s23,s13,m3_sq,par1,par2,par3)
    ...
    !  by the module golem_parametre_qp (src/module/parametre.f90)
    !
    ! RETURN VALUE
    !
    ...
    !
end module golem_function_3p2m_1mi_qp
