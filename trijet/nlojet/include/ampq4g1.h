...
namespace nlo {
  ...
  public:
    ...
    // commentAK:
    void set_scale(double mu) { lmu2 = std::log(mu*mu); }

    // commentAK:
    // Added by AK to handle \log{\mu^2} terms:
    double lmu2;
  ...
  private:
    ...
    _ComplexD Pij(double) const;

    _ComplexD A034ppp(int, int, int, int, int) const;
    _ComplexD A034mpp(int, int, int, int, int) const;
    _ComplexD A034pmp(int, int, int, int, int) const;
    _ComplexD A032ppp(int, int, int, int, int) const;
    _ComplexD A032mpp(int, int, int, int, int) const;
    _ComplexD A032pmp(int, int, int, int, int) const;
    _ComplexD A012ppp(int, int, int, int, int) const;
    _ComplexD A012mpp(int, int, int, int, int) const;
    _ComplexD A012pmp(int, int, int, int, int) const;
    _ComplexD A014ppp(int, int, int, int, int) const;
    _ComplexD A014mpp(int, int, int, int, int) const;
    _ComplexD A014pmp(int, int, int, int, int) const;
