...
#define H(i,j,k,l) std::pow(a##i##k*a##j##l/(a##i##l*a##j##k), 2)
  ...
  std::complex<double> 
  ampq4g1::Pij(double sij) const
  {
    return 0.5*(lmu2 - Log(-sij))*(lmu2 - Log(-sij));
  }

  std::complex<double> 
  ampq4g1::A034ppp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);

    _ComplexD a12 = A(1,2), a13 = A(1,3), a14 = A(1,4), a15 = A(1,5), 
      a21 = A(2,1), a23 = A(2,3), a24 = A(2,4), a25 = A(2,5), 
      a31 = A(3,1), a32 = A(3,2), a34 = A(3,4), a35 = A(3,5), 
      a41 = A(4,1), a42 = A(4,2), a43 = A(4,3), a45 = A(4,5), 
      a51 = A(5,1), a52 = A(5,2), a53 = A(5,3), a54 = A(5,4), 
      b13 = B(1,3), b15 = B(1,5), b35 = B(3,5);

    _ComplexD A0 = -ICPLX*a24*a24/(a12*a35*a54);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A034mpp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a14*a14/(a12*a35*a54);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A034pmp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a23*a23/(a12*a35*a54);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A032ppp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = -ICPLX*a24*a24*a32/(a12*a34*a35*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A032mpp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a14*a14*a32/(a12*a34*a35*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A032pmp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = -ICPLX*a23*a23*a23/(a12*a34*a35*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A012ppp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = -ICPLX*a24*a24/(a34*a15*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A012mpp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a14*a14/(a34*a15*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A012pmp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a23*a23/(a34*a15*a52);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A014ppp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = -ICPLX*a24*a24*a14/(a12*a34*a15*a54);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A014mpp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a14*a14*a14/(a12*a34*a15*a54);

    return A0;
  }

  std::complex<double> 
  ampq4g1::A014pmp(int p1, int p2, int p3, int p4, int p5) const
  {
    double s12 = S(1,2), s14 = S(1,4), s23 = S(2,3), s34 = S(3,4), 
      s45 = S(4,5);
    ...
    _ComplexD A0 = ICPLX*a23*a23*a14/(a12*a34*a15*a54);
		       ...
		       int p4, int p5, _ComplexD *A) const
  {
    ...
    //commentAK: mu dependent terms in \mathcal{C}:
    V += 2.0*(Nc-nf)*lmu2/3.0 + 3.0/Nc*lmu2;
    //commentAK: from FDH to tHV:
    V -= 2.0/3.0*Nc - 1.0/Nc;

    //commentAK new declarations for double log terms:
    _ComplexD a034ppp = A034ppp(p1,p2,p3,p4,p5);
    _ComplexD a032ppp = A032ppp(p1,p2,p3,p4,p5);
    _ComplexD a014ppp = A014ppp(p1,p2,p3,p4,p5);

    double sqqb = S(1,2), sqQ = S(1,3), sqQb = S(1,4), sqg = S(1,5),
           sqbQ = S(2,3), sqbQb = S(2,4), sqbg = S(2,5),
           sQQb = S(3,4), sQg = S(3,5),
           sQbg = S(4,5);
    _ComplexD Pqbq = Pij(sqqb);
    _ComplexD PQq = Pij(sqQ);
    _ComplexD PQbq = Pij(sqQb);
    _ComplexD PqbQ = Pij(sqbQ);
    _ComplexD PqbQb = Pij(sqbQb);
    _ComplexD PQbQ = Pij(sQQb);
    _ComplexD Pqg = Pij(sqg);
    _ComplexD Pqbg = Pij(sqbg);
    _ComplexD PQg = Pij(sQg);
    _ComplexD PQbg = Pij(sQbg);
    
    A[0] = -ICPLX*A(2,4)*A(2,4)/(A(1,2)*A(3,5)*A(5,4));
    A[1] = V*A[0] + D34ppp(nf, p1,p2,p3,p4,p5) + E34ppp(p1,p2,p3,p4,p5);
    A[1] -= Nc*a034ppp*(Pqbq + PQbg + PQg)
          - 1.0/Nc*a034ppp*(-PqbQb + PqbQ + Pqbq + PQbQ + PQbq - PQq)
          + Nc*a032ppp*(PqbQb - Pqbq - PQbg + Pqg)
          + Nc*a014ppp*(-Pqbq + Pqbg + PQq - PQg);
  }
		       ...
		       int p4, int p5, _ComplexD *A) const
  {
    ...
    //commentAK new declarations for double log terms:
    _ComplexD a034mpp = A034mpp(p1,p2,p3,p4,p5);
    _ComplexD a032mpp = A032mpp(p1,p2,p3,p4,p5);
    _ComplexD a014mpp = A014mpp(p1,p2,p3,p4,p5);
    ...
    A[1] -= Nc*a034mpp*(Pqbq + PQbg + PQg)
          - 1.0/Nc*a034mpp*(-PqbQb + PqbQ + Pqbq + PQbQ + PQbq - PQq)
          + Nc*a032mpp*(PqbQb - Pqbq - PQbg + Pqg)
          + Nc*a014mpp*(-Pqbq + Pqbg + PQq - PQg);
  }
		       ...
		       int p4, int p5, _ComplexD *A) const
  {
    ...
    _ComplexD a032ppp = A032ppp(p1,p2,p3,p4,p5);
    _ComplexD a034ppp = A034ppp(p1,p2,p3,p4,p5);
    _ComplexD a012ppp = A012ppp(p1,p2,p3,p4,p5);
    ...
    A[1] -= Nc*a032ppp*(Pqbg + PQbq + PQg)
          - 1.0/Nc*a032ppp*(-PqbQb + PqbQ + Pqbq + PQbQ + PQbq - PQq)
          - 1.0/Nc*a034ppp*(-PqbQb + Pqbg + PQbq - Pqg)
          - 1.0/Nc*a012ppp*(PQbq - PQbg - PQq + PQg);
  }
		       ...
		       int p4, int p5, _ComplexD *A) const
  {
    ...
    _ComplexD a032mpp = A032mpp(p1,p2,p3,p4,p5);
    _ComplexD a034mpp = A034mpp(p1,p2,p3,p4,p5);
    _ComplexD a012mpp = A012mpp(p1,p2,p3,p4,p5);
    ...
    A[1] -= Nc*a032mpp*(Pqbg + PQbq + PQg)
          - 1.0/Nc*a032mpp*(-PqbQb + PqbQ + Pqbq + PQbQ + PQbq - PQq)
          - 1.0/Nc*a034mpp*(-PqbQb + Pqbg + PQbq - Pqg)
          - 1.0/Nc*a012mpp*(PQbq - PQbg - PQq + PQg);
  }
		       ...
		       int p4, int p5, _ComplexD *A) const
  {
    ...
    //commentAK new declarations for double log terms:
    _ComplexD a032pmp = A032pmp(p1,p2,p3,p4,p5);
    _ComplexD a034pmp = A034pmp(p1,p2,p3,p4,p5);
    _ComplexD a012pmp = A012pmp(p1,p2,p3,p4,p5);
    ...
    A[1] -= Nc*a032pmp*(Pqbg + PQbq + PQg)
          - 1.0/Nc*a032pmp*(-PqbQb + PqbQ + Pqbq + PQbQ + PQbq - PQq)
          - 1.0/Nc*a034pmp*(-PqbQb + Pqbg + PQbq - Pqg)
          - 1.0/Nc*a012pmp*(PQbq - PQbg - PQq + PQg);
  }
