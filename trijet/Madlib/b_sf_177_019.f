      SUBROUTINE SB_SF_177_019(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_177_019(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_177_019(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /  -168,   18, -171,   21,   -8,  -62/    
      DATA (CF(i,1  ),i=7  ,8  ) /     1,  -71/                            
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    18,   21,   21,   18,   10,    1/    
      DATA (CF(i,2  ),i=7  ,8  ) /     1,   10/                            
C               T[ 1, 3]T[ 2, 4, 5]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /  -171,   21, -168,   18,    1,  -71/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -8,  -62/                            
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   18,   18,   21,    1,   10/    
      DATA (CF(i,4  ),i=7  ,8  ) /    10,    1/                            
C               T[ 2, 4, 5]T[ 1, 3]                                        
      DATA Denom(5  )/           54/                                       
...
C               T[ 2, 3]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -62,    1,  -71,   10,   -6,   -3/    
      DATA (CF(i,6  ),i=7  ,8  ) /    21,  -30/                            
C               T[ 1, 4]T[ 2, 3, 5]                                        
      DATA Denom(7  )/           54/                                       
...
C               T[ 2, 3, 5]T[ 1, 4]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /   -71,   10,  -62,    1,   21,  -30/    
      DATA (CF(i,8  ),i=7  ,8  ) /    -6,   -3/                            
C               T[ 2, 3]T[ 1, 4, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_177_019 =B_SF_177_019+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
