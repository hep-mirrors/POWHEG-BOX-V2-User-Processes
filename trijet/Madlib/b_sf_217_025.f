      SUBROUTINE SB_SF_217_025(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_217_025(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_217_025(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -3,   -6,   21,  -30,   10,    1/    
...
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /   -30,   21,   -6,   -3,    1,   10/    
      DATA (CF(i,4  ),i=7  ,8  ) /   -71,  -62/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    10,    1,   10,    1,   21,   18/    
      DATA (CF(i,5  ),i=7  ,8  ) /    21,   18/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     1,   10,    1,   10,   18,   21/    
      DATA (CF(i,6  ),i=7  ,8  ) /    18,   21/                            
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -62,   -8,    1,  -71,   21,   18/    
      DATA (CF(i,7  ),i=7  ,8  ) /  -168, -171/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /   -71,    1,   -8,  -62,   18,   21/    
      DATA (CF(i,8  ),i=7  ,8  ) /  -171, -168/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_217_025 =B_SF_217_025+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
