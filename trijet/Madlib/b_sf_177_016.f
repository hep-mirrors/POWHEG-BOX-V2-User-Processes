      SUBROUTINE SB_SF_177_016(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ b~ -> b~ b~ g g  
C  
C BORN AMPLITUDE IS b~ b~ -> b~ b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_177/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_177/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_177/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_177_016(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_177_016(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NWAVEFUNCS=  16, NCOLOR=   8) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -24,   18,   -9,    3,   40,  -14/    
      DATA (CF(i,1  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    18,  -24,    3,   -9,  -14,   40/    
      DATA (CF(i,2  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 1, 3]T[ 2, 4, 5]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -9,    3,    3,   -9,   31,   -5/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,   -9,   -9,    3,   -5,   31/    
      DATA (CF(i,4  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 2, 4, 5]T[ 1, 3]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    40,  -14,   31,   -5,  -24,   18/    
      DATA (CF(i,5  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 2, 3]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -14,   40,   -5,   31,   18,  -24/    
      DATA (CF(i,6  ),i=7  ,8  ) /    -9,    3/                            
C               T[ 1, 4]T[ 2, 3, 5]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -5,   31,   -5,   31,    3,   -9/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 2, 3, 5]T[ 1, 4]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    31,   -5,   31,   -5,   -9,    3/    
      DATA (CF(i,8  ),i=7  ,8  ) /    -9,    3/                            
C               T[ 2, 3]T[ 1, 4, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVIXXX(W(1,4   ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,1   ),W(1,5   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,4   ),W(1,11  ),W(1,5   ),GG ,AMP(4   ))             
      CALL VVVXXX(W(1,5   ),W(1,6   ),W(1,8   ),G ,AMP(5   ))              
      CALL JIOXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,3   ),W(1,13  ),W(1,12  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,4   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,5   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,10  ),W(1,1   ),W(1,12  ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,2   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,4   ),W(1,16  ),W(1,5   ),GG ,AMP(9   ))             
      CALL VVVXXX(W(1,5   ),W(1,14  ),W(1,12  ),G ,AMP(10  ))              
      do i=1,ngraphs
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_177_016 =B_SF_177_016+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
