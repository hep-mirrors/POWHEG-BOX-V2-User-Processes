...
C  
C FOR PROCESS : g u -> u u u~ g  
C  
C BORN AMPLITUDE IS g u -> u u u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     3,   -9,   -9,    3,   -5,   -5/    
      DATA (CF(i,1  ),i=7  ,8  ) /    31,   31/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -9,    3,    3,   -9,   31,   31/    
      DATA (CF(i,2  ),i=7  ,8  ) /    -5,   -5/                            
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -9,    3,  -24,   18,  -14,   -5/    
      DATA (CF(i,3  ),i=7  ,8  ) /    31,   40/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,   -9,   18,  -24,   40,   31/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -5,  -14/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -5,   31,  -14,   40,  -24,   -9/    
      DATA (CF(i,5  ),i=7  ,8  ) /     3,   18/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -5,   31,   -5,   31,   -9,    3/    
      DATA (CF(i,6  ),i=7  ,8  ) /    -9,    3/                            
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    31,   -5,   31,   -5,    3,   -9/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    31,   -5,   40,  -14,   18,    3/    
      DATA (CF(i,8  ),i=7  ,8  ) /    -9,  -24/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      ...
      CALL FVIXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
