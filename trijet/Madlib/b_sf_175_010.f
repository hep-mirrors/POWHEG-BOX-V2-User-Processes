      SUBROUTINE SB_SF_175_010(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_175_010(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_175_010(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,4  ) /     1,   -3,   -3,    1/                
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,4  ) /    -3,    1,    1,   -3/                
C               T[ 1, 3]T[ 2, 4, 5]                                        
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /    -3,    1,   -8,    6/                
C               T[ 2, 4]T[ 1, 3, 5]                                        
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /     1,   -3,    6,   -8/                
C               T[ 2, 4, 5]T[ 1, 3]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_175_010 =B_SF_175_010+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
