      SUBROUTINE SB_SF_275_016(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> b b~ g g  
C  
C BORN AMPLITUDE IS g g -> b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_275/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_275/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_275/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_275_016(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_275_016(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     1,   10,  -62,  -62,   28,   10/    
C               T[ 3, 4, 2, 1, 5]                                          
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    10,    1,   10,   28,  -62,  -62/    
C               T[ 3, 4, 2, 5, 1]                                          
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /   -62,   10,    1,  -62,   10,   28/    
C               T[ 3, 4, 5, 2, 1]                                          
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /   -62,   28,  -62,    1,   10,   10/    
C               T[ 3, 4, 1, 5, 2]                                          
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    28,  -62,   10,   10,    1,  -62/    
C               T[ 3, 4, 5, 1, 2]                                          
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    10,  -62,   28,   10,  -62,    1/    
C               T[ 3, 4, 1, 2, 5]                                          
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      CALL JIOXXX(W(1,4   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL VVVXXX(W(1,5   ),W(1,1   ),W(1,7   ),G ,AMP(1   ))              
      CALL FVIXXX(W(1,4   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      ...
      CALL FVOXXX(W(1,6   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,4   ),W(1,11  ),W(1,5   ),GG ,AMP(4   ))             
      CALL IOVXXX(W(1,8   ),W(1,6   ),W(1,5   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      ...
      CALL FVOXXX(W(1,14  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      ...
      CALL FVIXXX(W(1,4   ),W(1,18  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,19  ),W(1,3   ),W(1,5   ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,3   ),W(1,18  ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,4   ),W(1,20  ),W(1,5   ),GG ,AMP(14  ))             
      CALL JGGGXX(W(1,1   ),W(1,2   ),W(1,5   ),G ,W(1,21  ))              
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,21  ),GG ,AMP(15  ))             
      CALL JGGGXX(W(1,5   ),W(1,1   ),W(1,2   ),G ,W(1,22  ))              
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,22  ),GG ,AMP(16  ))             
      CALL JGGGXX(W(1,2   ),W(1,5   ),W(1,1   ),G ,W(1,23  ))              
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,23  ),GG ,AMP(17  ))             
     ...
     &             -AMP(  17)+AMP(  18)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_275_016 =B_SF_275_016+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
