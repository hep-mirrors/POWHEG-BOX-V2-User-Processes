      SUBROUTINE SB_SF_263_023(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_263_023(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_263_023(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -3,   -6,   21,   -8,   10/    
...
C               T[ 2, 4]T[ 3, 5, 1]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,   21,   -3,  -30,  -62,    1/    
      DATA (CF(i,3  ),i=7  ,8  ) /    10,  -71/                            
C               T[ 3, 5, 1]T[ 2, 4]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -6,  -30,   -3,  -71,   10/    
      DATA (CF(i,4  ),i=7  ,8  ) /     1,  -62/                            
C               T[ 3, 5]T[ 2, 4, 1]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -8,    1,  -62,  -71, -168,   18/    
      DATA (CF(i,5  ),i=7  ,8  ) /    21, -171/                            
C               T[ 3, 4, 1]T[ 2, 5]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    10,    1,    1,   10,   18,   21/    
      DATA (CF(i,6  ),i=7  ,8  ) /    18,   21/                            
C               T[ 3, 4]T[ 2, 5, 1]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     1,   10,   10,    1,   21,   18/    
      DATA (CF(i,7  ),i=7  ,8  ) /    21,   18/                            
C               T[ 3, 4]T[ 2, 5, 1]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,   -8,  -71,  -62, -171,   21/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_263_023 =B_SF_263_023+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
