      SUBROUTINE SB_SF_138_015(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ s -> b b~ g g  
C  
C BORN AMPLITUDE IS s~ s -> b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_138/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_138/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_138/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_138_015(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_138_015(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,4   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,3   ),W(1,5   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,3   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_138_015 =B_SF_138_015+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
