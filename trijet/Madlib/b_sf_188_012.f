      SUBROUTINE SB_SF_188_012(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_012(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_012(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/            3/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     0,    3,   -3,    0,    5,   -5/    
      DATA (CF(i,3  ),i=7  ,8  ) /     4,   -4/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/            6/                                       
...
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/            6/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     8,   -1,    8,   -1,    0,    3/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,    0/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/            6/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -1,   -1,   -8,   -8,    0,  -21/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_012 =B_SF_188_012+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
