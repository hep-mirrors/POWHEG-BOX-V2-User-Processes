      SUBROUTINE SB_SF_182_014(P1,ANS)
C  
...
C  
      ...
      common/to_amps_182/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_182/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_182/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_182_014(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_182_014(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -9,  -24,    3,   18,   -5,   40/    
      DATA (CF(i,2  ),i=7  ,8  ) /    31,  -14/                            
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(3  )/           27/                                       
...
C               T[ 1, 2]T[ 3, 4, 5]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,   18,   -9,  -24,   31,  -14/    
...
C               T[ 3, 2]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    31,   40,   -5,  -14,    3,  -24/    
      DATA (CF(i,6  ),i=7  ,8  ) /    -9,   18/                            
C               T[ 3, 2, 5]T[ 1, 4]                                        
      DATA Denom(7  )/           27/                                       
...
C               T[ 1, 4]T[ 3, 2, 5]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -5,  -14,   31,   40,   -9,   18/    
...
C ----------
      ...
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,12  ),GG ,AMP(6   ))             
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,12  ),GG ,AMP(7   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_182_014 =B_SF_182_014+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
