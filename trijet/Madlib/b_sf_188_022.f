      SUBROUTINE SB_SF_188_022(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_022(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_022(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -6,   -3,  -30,    1,  -62/    
      DATA (CF(i,3  ),i=7  ,8  ) /    10,  -71/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   21,  -30,   -3,   10,  -71/    
      DATA (CF(i,4  ),i=7  ,8  ) /     1,  -62/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     1,   10,    1,   10,   21,   18/    
      DATA (CF(i,5  ),i=7  ,8  ) /    18,   21/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     1,   -8,  -62,  -71,   18, -168/    
      DATA (CF(i,6  ),i=7  ,8  ) /    21, -171/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    10,    1,   10,    1,   18,   21/    
      DATA (CF(i,7  ),i=7  ,8  ) /    21,   18/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -8,    1,  -71,  -62,   21, -171/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_022 =B_SF_188_022+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
