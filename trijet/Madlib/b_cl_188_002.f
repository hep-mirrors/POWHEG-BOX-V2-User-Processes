      SUBROUTINE SB_CL_188_002(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_188_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_188_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -3,   21,   -6,    1,    1/    
      DATA (CF(i,1  ),i=7  ,8  ) /    10,   -8/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -3,   24,   -6,   21,   10,   -8/    
      DATA (CF(i,2  ),i=7  ,8  ) /     1,    1/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -6,   24,   -3,   -8,   10/    
      DATA (CF(i,3  ),i=7  ,8  ) /     1,    1/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   21,   -3,   24,    1,    1/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -8,   10/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/            9/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     1,   10,   -8,    1,   24,   -6/    
      DATA (CF(i,5  ),i=7  ,8  ) /    21,   -3/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/            9/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     1,   -8,   10,    1,   -6,   24/    
      DATA (CF(i,6  ),i=7  ,8  ) /    -3,   21/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/            9/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    10,    1,    1,   -8,   21,   -3/    
      DATA (CF(i,7  ),i=7  ,8  ) /    24,   -6/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/            9/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -8,    1,    1,   10,   -3,   21/    
      DATA (CF(i,8  ),i=7  ,8  ) /    -6,   24/                            
C               T[ 1, 5]T[ 3, 4, 2]                                        
C ----------
C BEGIN CODE
C ----------
      B_CL_188_002 = (0D0,0D0)  
      BORNTILDE = (0d0,0d0)
      do ihel=-1,1,2
      if (.not. calculatedBorn) then
      ...
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_188_002=B_CL_188_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_188_002=B_CL_188_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
