      SUBROUTINE SB_SF_056_011(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ b~ -> u~ b~ g g  
C  
C BORN AMPLITUDE IS u~ b~ -> u~ b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_056/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_056/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_056/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_056_011(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_056_011(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,3   ),W(1,7   ),W(1,6   ),GG ,AMP(1   ))             
      ...
      CALL IOVXXX(W(1,10  ),W(1,1   ),W(1,6   ),GG ,AMP(3   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_056_011 =B_SF_056_011+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
