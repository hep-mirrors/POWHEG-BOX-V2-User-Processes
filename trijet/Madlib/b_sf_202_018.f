      SUBROUTINE SB_SF_202_018(P1,ANS)
C  
...
C  
      ...
      common/to_amps_202/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_202/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_202/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_202_018(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_202_018(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     3,   -9,    3,   -9,   -5,   31/    
      DATA (CF(i,1  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -9,  -24,   18,    3,   -5,   40/    
      DATA (CF(i,2  ),i=7  ,8  ) /   -14,   31/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     3,   18,  -24,   -9,   31,  -14/    
      DATA (CF(i,3  ),i=7  ,8  ) /    40,   -5/                            
C               T[ 2, 1]T[ 3, 4, 5]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -9,    3,   -9,    3,   31,   -5/    
      DATA (CF(i,4  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 3, 4, 5]T[ 2, 1]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -5,   -5,   31,   31,    3,    3/    
      DATA (CF(i,5  ),i=7  ,8  ) /    -9,   -9/                            
C               T[ 3, 1, 5]T[ 2, 4]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    31,   40,  -14,   -5,    3,  -24/    
      DATA (CF(i,6  ),i=7  ,8  ) /    18,   -9/                            
C               T[ 3, 1]T[ 2, 4, 5]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -5,  -14,   40,   31,   -9,   18/    
      DATA (CF(i,7  ),i=7  ,8  ) /   -24,    3/                            
C               T[ 2, 4]T[ 3, 1, 5]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    31,   31,   -5,   -5,   -9,   -9/    
      DATA (CF(i,8  ),i=7  ,8  ) /     3,    3/                            
C               T[ 3, 1]T[ 2, 4, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,6   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,1   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL FVIXXX(W(1,4   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,2   ),W(1,5   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,3   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,1   ),W(1,10  ),W(1,6   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,2   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,4   ),W(1,11  ),W(1,5   ),GG ,AMP(4   ))             
      CALL VVVXXX(W(1,5   ),W(1,8   ),W(1,6   ),G ,AMP(5   ))              
      CALL JIOXXX(W(1,4   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,12  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,1   ),W(1,13  ),W(1,12  ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,4   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,3   ),W(1,5   ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,3   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_202_018 =B_SF_202_018+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
