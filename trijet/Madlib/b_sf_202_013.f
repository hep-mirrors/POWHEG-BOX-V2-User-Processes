      SUBROUTINE SB_SF_202_013(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_202_013(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_202_013(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -21,  -21,    0,    0,   -1,   -1/    
      DATA (CF(i,1  ),i=7  ,8  ) /    -8,   -8/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(2  )/            6/                                       
...
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(3  )/            3/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     0,    3,   -3,    0,    4,   -5/    
      DATA (CF(i,3  ),i=7  ,8  ) /     5,   -4/                            
C               T[ 2, 1]T[ 3, 4, 5]                                        
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     0,    3,    0,    3,    8,   -1/    
      DATA (CF(i,4  ),i=7  ,8  ) /     8,   -1/                            
C               T[ 3, 4, 5]T[ 2, 1]                                        
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -1,   -1,    8,    8,    3,    3/    
...
C               T[ 3, 1]T[ 2, 4, 5]                                        
      DATA Denom(7  )/            3/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -4,   -5,    5,    4,    0,    3/    
      DATA (CF(i,7  ),i=7  ,8  ) /    -3,    0/                            
C               T[ 2, 4]T[ 3, 1, 5]                                        
      DATA Denom(8  )/            6/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -8,   -1,   -8,   -1,    0,  -21/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_202_013 =B_SF_202_013+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
