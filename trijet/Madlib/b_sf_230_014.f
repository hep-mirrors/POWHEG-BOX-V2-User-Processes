      SUBROUTINE SB_SF_230_014(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_230_014(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_230_014(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -21,    0,  -21,    0,   -8,   -1/    
      DATA (CF(i,1  ),i=7  ,8  ) /    -8,   -1/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     0,    3,    3,    0,    8,    8/    
...
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/            3/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     0,    0,    3,   -3,    5,    4/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -4,   -5/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/            3/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -4,    4,   -5,    5,   -3,    0/    
      DATA (CF(i,5  ),i=7  ,8  ) /     0,    3/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,    8,   -1,    8,    0,    3/    
      DATA (CF(i,6  ),i=7  ,8  ) /     0,    3/                            
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/            6/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,   -1,   -1,   -8,    0,    0/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_230_014 =B_SF_230_014+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
