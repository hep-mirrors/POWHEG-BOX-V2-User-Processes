...
C  
C FOR PROCESS : u~ u~ -> u~ u~ g g  
C  
C BORN AMPLITUDE IS u~ u~ -> u~ u~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVIXXX(W(1,4   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,6   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      ...
      CALL FVIXXX(W(1,4   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
