      SUBROUTINE SB_SF_188_025(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ g -> b b~ b~ g  
C  
C BORN AMPLITUDE IS b~ g -> b b~ b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_188/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_188/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_188/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_025(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_025(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -24,    3,   -9,   18,   -5,   31/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -14,   40/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     3,    3,   -9,   -9,   31,   -5/    
      DATA (CF(i,2  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -9,   -9,    3,    3,   -5,   31/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    18,   -9,    3,  -24,   31,   -5/    
      DATA (CF(i,4  ),i=7  ,8  ) /    40,  -14/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -5,   31,   -5,   31,    3,   -9/    
      DATA (CF(i,5  ),i=7  ,8  ) /    -9,    3/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    31,   -5,   31,   -5,   -9,    3/    
      DATA (CF(i,6  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -14,   31,   -5,   40,   -9,    3/    
      DATA (CF(i,7  ),i=7  ,8  ) /   -24,   18/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    40,   -5,   31,  -14,    3,   -9/    
...
C ----------
      ...
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      ...
      CALL JIOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,11  ),W(1,3   ),W(1,13  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,5   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL VVVXXX(W(1,13  ),W(1,2   ),W(1,14  ),G ,AMP(7   ))              
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,13  ),GG ,AMP(8   ))             
      CALL IOVXXX(W(1,8   ),W(1,1   ),W(1,14  ),GG ,AMP(9   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_025 =B_SF_188_025+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
