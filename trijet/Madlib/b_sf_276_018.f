      SUBROUTINE SB_SF_276_018(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_276_018(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_276_018(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           72/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /  -511,   74,   -7,  -70,   65,    2/    
      DATA (CF(i,1  ),i=7  ,12 ) /  -124,   56,  -52, -124,  -70,   20/    
      DATA (CF(i,1  ),i=13 ,18 ) /    74,    2,   20,  -70,  -16,  -70/    
      DATA (CF(i,1  ),i=19 ,24 ) /    65,   11,    2,   -7,    2,   -7/    
C               F[1, 5, 2, 3, 4]                                           
      DATA Denom(2  )/           72/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    74, -511,  -70,   -7,    2,   65/    
      DATA (CF(i,2  ),i=7  ,12 ) /    56, -124,  -70,   20,   74, -124/    
      DATA (CF(i,2  ),i=13 ,18 ) /   -70,   20,    2,  -52,   65,   11/    
      DATA (CF(i,2  ),i=19 ,24 ) /   -16,  -70,    2,   -7,    2,   -7/    
C               F[1, 5, 3, 2, 4]                                           
      DATA Denom(3  )/           72/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -7,  -70,   56,  -88,  128,  -16/    
      DATA (CF(i,3  ),i=7  ,12 ) /    65,    2,  -70,    2,   11,  -16/    
      DATA (CF(i,3  ),i=13 ,18 ) /    -7,   65,    2,   -7,   65,   56/    
      DATA (CF(i,3  ),i=19 ,24 ) /   -16,  -25,   65,  -25,  -16,   56/    
C               F[1, 5, 4, 2, 3]                                           
      DATA Denom(4  )/           72/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /   -70,   -7,  -88,   56,  -16,  128/    
      DATA (CF(i,4  ),i=7  ,12 ) /     2,   65,   -7,  -16,   -7,    2/    
      DATA (CF(i,4  ),i=13 ,18 ) /    11,    2,   65,  -70,  -16,  -25/    
      DATA (CF(i,4  ),i=19 ,24 ) /    65,   56,  -16,   56,   65,  -25/    
C               F[1, 5, 4, 3, 2]                                           
      DATA Denom(5  )/           72/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    65,    2,  128,  -16,   56,  -88/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -7,  -70,    2,   11,    2,   -7/    
      DATA (CF(i,5  ),i=13 ,18 ) /   -16,   -7,  -70,   65,   56,   65/    
      DATA (CF(i,5  ),i=19 ,24 ) /   -25,  -16,   56,  -16,  -25,   65/    
C               F[1, 2, 3, 4, 5]                                           
      DATA Denom(6  )/           72/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     2,   65,  -16,  128,  -88,   56/    
      DATA (CF(i,6  ),i=7  ,12 ) /   -70,   -7,   65,   -7,  -16,   11/    
      DATA (CF(i,6  ),i=13 ,18 ) /     2,  -70,   -7,    2,  -25,  -16/    
      DATA (CF(i,6  ),i=19 ,24 ) /    56,   65,  -25,   65,   56,  -16/    
C               F[1, 3, 2, 4, 5]                                           
      DATA Denom(7  )/           72/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /  -124,   56,   65,    2,   -7,  -70/    
      DATA (CF(i,7  ),i=7  ,12 ) /  -511,   74,   20,  -70, -124,   74/    
      DATA (CF(i,7  ),i=13 ,18 ) /    20,  -70,  -52,    2,  -70,  -16/    
      DATA (CF(i,7  ),i=19 ,24 ) /    11,   65,   -7,    2,   -7,    2/    
C               F[1, 4, 2, 3, 5]                                           
      DATA Denom(8  )/           72/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    56, -124,    2,   65,  -70,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    74, -511,    2,   74,   20,  -70/    
      DATA (CF(i,8  ),i=13 ,18 ) /  -124,  -52,  -70,   20,   11,   65/    
      DATA (CF(i,8  ),i=19 ,24 ) /   -70,  -16,   -7,    2,   -7,    2/    
C               F[1, 4, 3, 2, 5]                                           
      DATA Denom(9  )/           72/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /   -52,  -70,  -70,   -7,    2,   65/    
      DATA (CF(i,9  ),i=7  ,12 ) /    20,    2, -511,   20,   74, -124/    
      DATA (CF(i,9  ),i=13 ,18 ) /   -70,   56, -124,   74,    2,   -7/    
      DATA (CF(i,9  ),i=19 ,24 ) /     2,   -7,   65,  -70,  -16,   11/    
C               F[1, 3, 2, 5, 4]                                           
      DATA Denom(10 )/           72/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /  -124,   20,    2,  -16,   11,   -7/    
      DATA (CF(i,10 ),i=7  ,12 ) /   -70,   74,   20, -511,    2,  -52/    
      DATA (CF(i,10 ),i=13 ,18 ) /    56,  -70,   74, -124,  -70,    2/    
      DATA (CF(i,10 ),i=19 ,24 ) /    -7,   65,  -70,   65,   -7,    2/    
C               F[1, 4, 3, 5, 2]                                           
      DATA Denom(11 )/           72/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /   -70,   74,   11,   -7,    2,  -16/    
      DATA (CF(i,11 ),i=7  ,12 ) /  -124,   20,   74,    2, -511,   56/    
      DATA (CF(i,11 ),i=13 ,18 ) /   -52, -124,   20,  -70,    2,  -70/    
      DATA (CF(i,11 ),i=19 ,24 ) /    65,   -7,    2,   -7,   65,  -70/    
C               F[1, 3, 5, 2, 4]                                           
      DATA Denom(12 )/           72/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    20, -124,  -16,    2,   -7,   11/    
      DATA (CF(i,12 ),i=7  ,12 ) /    74,  -70, -124,  -52,   56, -511/    
      DATA (CF(i,12 ),i=13 ,18 ) /     2,   74,  -70,   20,   -7,   65/    
      DATA (CF(i,12 ),i=19 ,24 ) /   -70,    2,   -7,    2,  -70,   65/    
C               F[1, 4, 2, 5, 3]                                           
      DATA Denom(13 )/           72/                                       
      DATA (CF(i,13 ),i=1  ,6  ) /    74,  -70,   -7,   11,  -16,    2/    
      DATA (CF(i,13 ),i=7  ,12 ) /    20, -124,  -70,   56,  -52,    2/    
      DATA (CF(i,13 ),i=13 ,18 ) /  -511,   20, -124,   74,   65,   -7/    
      DATA (CF(i,13 ),i=19 ,24 ) /     2,  -70,   65,  -70,    2,   -7/    
C               F[1, 2, 5, 3, 4]                                           
      DATA Denom(14 )/           72/                                       
      DATA (CF(i,14 ),i=1  ,6  ) /     2,   20,   65,    2,   -7,  -70/    
      DATA (CF(i,14 ),i=7  ,12 ) /   -70,  -52,   56,  -70, -124,   74/    
      DATA (CF(i,14 ),i=13 ,18 ) /    20, -511,   74, -124,   -7,    2/    
      DATA (CF(i,14 ),i=19 ,24 ) /    -7,    2,  -70,   65,   11,  -16/    
C               F[1, 4, 5, 2, 3]                                           
      DATA Denom(15 )/           72/                                       
      DATA (CF(i,15 ),i=1  ,6  ) /    20,    2,    2,   65,  -70,   -7/    
      DATA (CF(i,15 ),i=7  ,12 ) /   -52,  -70, -124,   74,   20,  -70/    
      DATA (CF(i,15 ),i=13 ,18 ) /  -124,   74, -511,   56,   -7,    2/    
      DATA (CF(i,15 ),i=19 ,24 ) /    -7,    2,   11,  -16,  -70,   65/    
C               F[1, 4, 5, 3, 2]                                           
      DATA Denom(16 )/           72/                                       
      DATA (CF(i,16 ),i=1  ,6  ) /   -70,  -52,   -7,  -70,   65,    2/    
      DATA (CF(i,16 ),i=7  ,12 ) /     2,   20,   74, -124,  -70,   20/    
      DATA (CF(i,16 ),i=13 ,18 ) /    74, -124,   56, -511,    2,   -7/    
      DATA (CF(i,16 ),i=19 ,24 ) /     2,   -7,  -16,   11,   65,  -70/    
C               F[1, 2, 3, 5, 4]                                           
      DATA Denom(17 )/           72/                                       
      DATA (CF(i,17 ),i=1  ,6  ) /   -16,   65,   65,  -16,   56,  -25/    
      DATA (CF(i,17 ),i=7  ,12 ) /   -70,   11,    2,  -70,    2,   -7/    
      DATA (CF(i,17 ),i=13 ,18 ) /    65,   -7,   -7,    2,   56,  -16/    
      DATA (CF(i,17 ),i=19 ,24 ) /    56,  -16,  -25,   65,  -88,  128/    
C               F[1, 5, 3, 4, 2]                                           
      DATA Denom(18 )/           72/                                       
      DATA (CF(i,18 ),i=1  ,6  ) /   -70,   11,   56,  -25,   65,  -16/    
      DATA (CF(i,18 ),i=7  ,12 ) /   -16,   65,   -7,    2,  -70,   65/    
      DATA (CF(i,18 ),i=13 ,18 ) /    -7,    2,    2,   -7,  -16,   56/    
      DATA (CF(i,18 ),i=19 ,24 ) /   -16,   56,  128,  -88,   65,  -25/    
C               F[1, 3, 4, 2, 5]                                           
      DATA Denom(19 )/           72/                                       
      DATA (CF(i,19 ),i=1  ,6  ) /    65,  -16,  -16,   65,  -25,   56/    
      DATA (CF(i,19 ),i=7  ,12 ) /    11,  -70,    2,   -7,   65,  -70/    
      DATA (CF(i,19 ),i=13 ,18 ) /     2,   -7,   -7,    2,   56,  -16/    
      DATA (CF(i,19 ),i=19 ,24 ) /    56,  -16,  -88,  128,  -25,   65/    
C               F[1, 5, 2, 4, 3]                                           
      DATA Denom(20 )/           72/                                       
      DATA (CF(i,20 ),i=1  ,6  ) /    11,  -70,  -25,   56,  -16,   65/    
      DATA (CF(i,20 ),i=7  ,12 ) /    65,  -16,   -7,   65,   -7,    2/    
      DATA (CF(i,20 ),i=13 ,18 ) /   -70,    2,    2,   -7,  -16,   56/    
      DATA (CF(i,20 ),i=19 ,24 ) /   -16,   56,   65,  -25,  128,  -88/    
C               F[1, 2, 4, 3, 5]                                           
      DATA Denom(21 )/           72/                                       
      DATA (CF(i,21 ),i=1  ,6  ) /     2,    2,   65,  -16,   56,  -25/    
      DATA (CF(i,21 ),i=7  ,12 ) /    -7,   -7,   65,  -70,    2,   -7/    
      DATA (CF(i,21 ),i=13 ,18 ) /    65,  -70,   11,  -16,  -25,  128/    
      DATA (CF(i,21 ),i=19 ,24 ) /   -88,   65,   56,  -16,   56,  -16/    
C               F[1, 2, 5, 4, 3]                                           
      DATA Denom(22 )/           72/                                       
      DATA (CF(i,22 ),i=1  ,6  ) /    -7,   -7,  -25,   56,  -16,   65/    
      DATA (CF(i,22 ),i=7  ,12 ) /     2,    2,  -70,   65,   -7,    2/    
      DATA (CF(i,22 ),i=13 ,18 ) /   -70,   65,  -16,   11,   65,  -88/    
      DATA (CF(i,22 ),i=19 ,24 ) /   128,  -25,  -16,   56,  -16,   56/    
C               F[1, 3, 4, 5, 2]                                           
      DATA Denom(23 )/           72/                                       
      DATA (CF(i,23 ),i=1  ,6  ) /     2,    2,  -16,   65,  -25,   56/    
      DATA (CF(i,23 ),i=7  ,12 ) /    -7,   -7,  -16,   -7,   65,  -70/    
      DATA (CF(i,23 ),i=13 ,18 ) /     2,   11,  -70,   65,  -88,   65/    
      DATA (CF(i,23 ),i=19 ,24 ) /   -25,  128,   56,  -16,   56,  -16/    
C               F[1, 3, 5, 4, 2]                                           
      DATA Denom(24 )/           72/                                       
      DATA (CF(i,24 ),i=1  ,6  ) /    -7,   -7,   56,  -25,   65,  -16/    
      DATA (CF(i,24 ),i=7  ,12 ) /     2,    2,   11,    2,  -70,   65/    
      DATA (CF(i,24 ),i=13 ,18 ) /    -7,  -16,   65,  -70,  128,  -25/    
      DATA (CF(i,24 ),i=19 ,24 ) /    65,  -88,  -16,   56,  -16,   56/    
C               F[1, 2, 4, 5, 3]                                           
C ----------
C BEGIN CODE
C ----------
     ...
     &             +AMP(  44))
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_276_018 =B_SF_276_018+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
