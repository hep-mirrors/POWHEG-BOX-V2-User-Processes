      SUBROUTINE SB_CL_203_005(P1,ANS)
C  
...
C  
      ...
      common/to_amps_203/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_203/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_203/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_203_005(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_203_005(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      CALL FVOXXX(W(1,6   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,5   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,1   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,8   ),W(1,9   ),W(1,3   ),GG ,AMP(2   ))             
      CALL JVVXXX(W(1,5   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,10  ))      
      CALL IOVXXX(W(1,8   ),W(1,2   ),W(1,10  ),GG ,AMP(3   ))             
      ...
      CALL IOVXXX(W(1,13  ),W(1,12  ),W(1,3   ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,14  ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,5   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,1   ),W(1,12  ),W(1,10  ),GG ,AMP(8   ))             
      CALL JIOXXX(W(1,14  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,16  ),G ,AMP(9   ))              
      CALL IOVXXX(W(1,14  ),W(1,12  ),W(1,5   ),GG ,AMP(10  ))             
      CALL JVVXXX(W(1,4   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,17  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,17  ),GG ,AMP(12  ))             
     ...
     &             +AMP(  16)-AMP(  17)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_203_005=B_CL_203_005 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_203_005=B_CL_203_005 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
