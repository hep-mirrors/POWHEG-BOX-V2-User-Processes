      SUBROUTINE SB_SF_210_014(P1,ANS)
C  
...
C  
      ...
      common/to_amps_210/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_210/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_210/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_210_014(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_210_014(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     1,   10,  -62,   10,  -62,   28/    
C               T[ 3, 1, 2, 4, 5]                                          
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    10,    1,   10,  -62,   28,  -62/    
C               T[ 3, 1, 2, 5, 4]                                          
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /   -62,   10,    1,   28,  -62,   10/    
C               T[ 3, 1, 5, 2, 4]                                          
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    10,  -62,   28,    1,   10,  -62/    
C               T[ 3, 1, 4, 2, 5]                                          
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /   -62,   28,  -62,   10,    1,   10/    
C               T[ 3, 1, 4, 5, 2]                                          
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    28,  -62,   10,  -62,   10,    1/    
C               T[ 3, 1, 5, 4, 2]                                          
C ----------
C BEGIN CODE
C ----------
     ...
     &             +AMP(  16)+AMP(  17)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_210_014 =B_SF_210_014+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
