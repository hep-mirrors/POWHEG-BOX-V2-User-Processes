      SUBROUTINE SB_CL_062_002(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ g -> u~ b b~ g  
C  
C BORN AMPLITUDE IS u~ g -> u~ b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_062/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_062/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_062/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_062_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_062_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,6   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,7   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL FVOXXX(W(1,4   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,5   ),W(1,9   ),W(1,2   ),GG ,AMP(2   ))             
      CALL JVVXXX(W(1,8   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,10  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,10  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,5   ),W(1,11  ),W(1,8   ),GG ,AMP(4   ))             
      ...
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_062_002=B_CL_062_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_062_002=B_CL_062_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
