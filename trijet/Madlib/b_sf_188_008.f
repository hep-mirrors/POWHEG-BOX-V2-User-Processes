      SUBROUTINE SB_SF_188_008(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_008(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_008(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /  -168,   21, -171,   18,    1,  -71/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -62,   -8/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   21,   18,   18,   10,    1/    
      DATA (CF(i,2  ),i=7  ,8  ) /    10,    1/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /  -171,   18, -168,   21,   -8,  -62/    
      DATA (CF(i,3  ),i=7  ,8  ) /   -71,    1/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    18,   18,   21,   21,    1,   10/    
...
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -71,    1,  -62,   10,   -6,   -3/    
      DATA (CF(i,6  ),i=7  ,8  ) /   -30,   21/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -62,   10,  -71,    1,   21,  -30/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_008 =B_SF_188_008+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
