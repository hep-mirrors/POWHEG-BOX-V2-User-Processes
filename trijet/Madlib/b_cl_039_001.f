      SUBROUTINE SB_CL_039_001(P1,ANS)
C  
...
C  
C FOR PROCESS : g d~ -> d~ g g g  
C  
C BORN AMPLITUDE IS g d~ -> d~ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_039/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_039/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_039/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_039_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_039_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,3   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JVVXXX(W(1,5   ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,13  ))      
      CALL IOVXXX(W(1,3   ),W(1,12  ),W(1,13  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,14  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      ...
      CALL FVIXXX(W(1,3   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      ...
      CALL FVOXXX(W(1,18  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
     ...
     &             -AMP(  16)+AMP(  17)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_039_001=B_CL_039_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_039_001=B_CL_039_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
