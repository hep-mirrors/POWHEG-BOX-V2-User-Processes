      SUBROUTINE SB_SF_188_013(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_013(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_013(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/            3/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -4,    5,   -5,    4,    3,   -3/    
      DATA (CF(i,6  ),i=7  ,8  ) /     0,    0/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/            6/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,   -8,   -1,   -1,  -21,    0/    
      DATA (CF(i,7  ),i=7  ,8  ) /   -21,    0/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/            6/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -1,    8,   -1,    8,    3,    0/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_013 =B_SF_188_013+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
