      SUBROUTINE SB_SF_202_021(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_202_021(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_202_021(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            3/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -3,    0,    0,    3,    5,   -4/    
      DATA (CF(i,1  ),i=7  ,8  ) /     4,   -5/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     0,    3,    0,    3,    8,   -1/    
      DATA (CF(i,2  ),i=7  ,8  ) /     8,   -1/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     0,    0,  -21,  -21,   -8,   -8/    
...
C               T[ 3, 4, 5]T[ 2, 1]                                        
      DATA Denom(5  )/            3/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     5,    4,   -4,   -5,   -3,    0/    
      DATA (CF(i,5  ),i=7  ,8  ) /     0,    3/                            
C               T[ 3, 1, 5]T[ 2, 4]                                        
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -8,   -1,   -8,   -1,    0,  -21/    
      DATA (CF(i,6  ),i=7  ,8  ) /     0,  -21/                            
C               T[ 3, 1]T[ 2, 4, 5]                                        
      DATA Denom(7  )/            6/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     8,    8,   -1,   -1,    0,    0/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,    3/                            
C               T[ 2, 4]T[ 3, 1, 5]                                        
      DATA Denom(8  )/            6/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /   -10,   -1,   -1,    8,    6,  -21/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_202_021 =B_SF_202_021+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
