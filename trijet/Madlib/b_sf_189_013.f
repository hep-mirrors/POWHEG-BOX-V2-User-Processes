      SUBROUTINE SB_SF_189_013(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_189_013(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_189_013(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            2/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     3,    0,    3,    3,    0,    6/    
C               T[ 1, 3, 5, 4, 2]                                          
      DATA Denom(2  )/            2/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     0,  -24,    0,   -6,   -3,    3/    
C               T[ 1, 3, 4, 2, 5]                                          
      DATA Denom(3  )/            2/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     3,    0,  -24,   -3,   -6,    0/    
C               T[ 1, 3, 4, 5, 2]                                          
      DATA Denom(4  )/            2/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,   -6,   -3,  -24,    0,    0/    
C               T[ 1, 3, 5, 2, 4]                                          
      DATA Denom(5  )/            2/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     0,   -3,   -6,    0,  -24,    3/    
C               T[ 1, 3, 2, 5, 4]                                          
      DATA Denom(6  )/            2/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     6,    3,    0,    0,    3,    3/    
C               T[ 1, 3, 2, 4, 5]                                          
C ----------
C BEGIN CODE
C ----------
     ...
     &             -AMP(  16)+AMP(  17)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_189_013 =B_SF_189_013+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
