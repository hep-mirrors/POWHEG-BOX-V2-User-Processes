      SUBROUTINE SB_SF_182_008(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_182_008(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_182_008(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -3,   21,   -6,  -30,    1,  -71/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -62,   10/                            
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(2  )/           54/                                       
...
C               T[ 1, 2]T[ 3, 4, 5]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /   -30,   -6,   21,   -3,   10,  -62/    
...
C               T[ 3, 2]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -71,   -8,    1,  -62,   21, -168/    
      DATA (CF(i,6  ),i=7  ,8  ) /  -171,   18/                            
C               T[ 3, 2, 5]T[ 1, 4]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -62,    1,   -8,  -71,   18, -171/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_182_008 =B_SF_182_008+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
