      SUBROUTINE SB_SF_188_014(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_014(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_014(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     3,    3,   -9,   -9,   31,   -5/    
      DATA (CF(i,1  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     3,  -24,   18,   -9,  -14,   40/    
      DATA (CF(i,2  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -9,   18,  -24,    3,   40,  -14/    
      DATA (CF(i,3  ),i=7  ,8  ) /    31,   -5/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -9,   -9,    3,    3,   -5,   31/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -5,   31/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    31,  -14,   40,   -5,  -24,   18/    
      DATA (CF(i,5  ),i=7  ,8  ) /    -9,    3/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -5,   40,  -14,   31,   18,  -24/    
      DATA (CF(i,6  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    31,   -5,   31,   -5,   -9,    3/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -5,   31,   -5,   31,    3,   -9/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_014 =B_SF_188_014+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
