      SUBROUTINE SB_SF_182_011(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_182_011(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_182_011(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   -3,  -30,   -6,  -71,    1/    
      DATA (CF(i,2  ),i=7  ,8  ) /    10,  -62/                            
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,  -30,   -3,   21,  -62,   10/    
...
C               T[ 3, 4, 5]T[ 1, 2]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -8,  -71,  -62,    1, -168,   21/    
      DATA (CF(i,5  ),i=7  ,8  ) /    18, -171/                            
C               T[ 3, 2]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           54/                                       
...
C               T[ 1, 4]T[ 3, 2, 5]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,  -62,  -71,   -8, -171,   18/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_182_011 =B_SF_182_011+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
