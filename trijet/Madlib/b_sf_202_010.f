      SUBROUTINE SB_SF_202_010(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_202_010(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_202_010(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    21,   18,   21,   18,    1,   10/    
      DATA (CF(i,1  ),i=7  ,8  ) /     1,   10/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    18,   21,   18,   21,   10,    1/    
      DATA (CF(i,2  ),i=7  ,8  ) /    10,    1/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   18, -168, -171,  -71,  -62/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -8,    1/                            
C               T[ 2, 1]T[ 3, 4, 5]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    18,   21, -171, -168,  -62,  -71/    
      DATA (CF(i,4  ),i=7  ,8  ) /     1,   -8/                            
C               T[ 3, 4, 5]T[ 2, 1]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     1,   10,  -71,  -62,   -3,  -30/    
      DATA (CF(i,5  ),i=7  ,8  ) /    21,   -6/                            
C               T[ 3, 1, 5]T[ 2, 4]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    10,    1,  -62,  -71,  -30,   -3/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_202_010 =B_SF_202_010+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
