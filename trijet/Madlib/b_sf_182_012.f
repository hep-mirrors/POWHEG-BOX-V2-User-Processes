      SUBROUTINE SB_SF_182_012(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_182_012(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_182_012(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -24,   -9,   18,    3,   40,   -5/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -14,   31/                            
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(2  )/           27/                                       
...
C               T[ 3, 4]T[ 1, 2, 5]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    18,    3,  -24,   -9,  -14,   31/    
...
C               T[ 3, 4, 5]T[ 1, 2]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    40,   31,  -14,   -5,  -24,    3/    
      DATA (CF(i,5  ),i=7  ,8  ) /    18,   -9/                            
C               T[ 3, 2]T[ 1, 4, 5]                                        
      DATA Denom(6  )/           27/                                       
...
C               T[ 3, 2, 5]T[ 1, 4]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -14,   -5,   40,   31,   18,   -9/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_182_012 =B_SF_182_012+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
