      SUBROUTINE SB_CL_139_005(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ s -> g g g g  
C  
C BORN AMPLITUDE IS s~ s -> g g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_139/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_139/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_139/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_139_005(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_139_005(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL FVIXXX(W(1,6   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,1   ),W(1,5   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,12  ),W(1,13  ),W(1,3   ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,1   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
     ...
     &             -AMP(  16)+AMP(  17)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_139_005=B_CL_139_005 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_139_005=B_CL_139_005 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
