      SUBROUTINE SB_SF_062_020(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_062_020(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_062_020(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,4  ) /     7,    6,    7,    6/                
C               T[ 4, 3, 2]T[ 1, 5]                                        
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,4  ) /     6,  -56,  -57,    7/                
C               T[ 4, 3]T[ 1, 5, 2]                                        
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /     7,  -57,  -56,    6/                
C               T[ 4, 3]T[ 1, 5, 2]                                        
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /     6,    7,    6,    7/                
C               T[ 1, 5]T[ 4, 3, 2]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_062_020 =B_SF_062_020+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
