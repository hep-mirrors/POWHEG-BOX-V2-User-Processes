      SUBROUTINE SB_SF_099_010(P1,ANS)
C  
...
C  
      ...
      common/to_amps_099/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_099/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_099/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_099_010(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_099_010(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 4, 3]T[ 1, 2, 5]                                        
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /     7,    6,  -56,  -57/                
C               T[ 4, 3, 5]T[ 1, 2]                                        
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /     6,    7,  -57,  -56/                
C               T[ 1, 2]T[ 4, 3, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_099_010 =B_SF_099_010+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
