      SUBROUTINE SB_CL_183_004(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ b -> g g g g  
C  
C BORN AMPLITUDE IS b~ b -> g g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_183/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_183/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_183/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(4,ihel).eq.-1) THEN
                 T=B_CL_183_004(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_183_004(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    64,    1,   -8,   -8,   10,    1/    
C               T[ 1, 2, 5, 4, 3]                                          
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     1,   64,   -8,   10,   -8,    1/    
C               T[ 1, 2, 4, 3, 5]                                          
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -8,   -8,   64,    1,    1,   10/    
C               T[ 1, 2, 4, 5, 3]                                          
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -8,   10,    1,   64,    1,   -8/    
C               T[ 1, 2, 5, 3, 4]                                          
      DATA Denom(5  )/            9/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    10,   -8,    1,    1,   64,   -8/    
C               T[ 1, 2, 3, 4, 5]                                          
      DATA Denom(6  )/            9/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     1,    1,   10,   -8,   -8,   64/    
C               T[ 1, 2, 3, 5, 4]                                          
C ----------
C BEGIN CODE
C ----------
      B_CL_183_004 = (0D0,0D0)  
      BORNTILDE = (0d0,0d0)
      do ihel=-1,1,2
      if (.not. calculatedBorn) then
      ...
      CALL FVIXXX(W(1,2   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      CALL FVIXXX(W(1,6   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,1   ),W(1,5   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,8   ),W(1,3   ),GG ,AMP(2   ))             
      CALL JVVXXX(W(1,5   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,10  ))      
      CALL IOVXXX(W(1,2   ),W(1,8   ),W(1,10  ),GG ,AMP(3   ))             
      CALL JIOXXX(W(1,6   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,11  ),G ,AMP(4   ))              
      CALL IOVXXX(W(1,6   ),W(1,8   ),W(1,5   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,2   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,12  ),W(1,13  ),W(1,3   ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,2   ),W(1,15  ),W(1,5   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,12  ),W(1,1   ),W(1,10  ),GG ,AMP(8   ))             
      CALL JIOXXX(W(1,2   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,16  ),G ,AMP(9   ))              
      CALL IOVXXX(W(1,12  ),W(1,14  ),W(1,5   ),GG ,AMP(10  ))             
      CALL JVVXXX(W(1,4   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,17  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,17  ),GG ,AMP(12  ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JVVXXX(W(1,4   ),W(1,18  ),G ,ZERO    ,ZERO    ,W(1,19  ))      
      CALL VVVXXX(W(1,5   ),W(1,3   ),W(1,19  ),G ,AMP(13  ))              
      CALL JVVXXX(W(1,18  ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,20  ))      
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,20  ),G ,AMP(14  ))              
      CALL GGGGXX(W(1,4   ),W(1,3   ),W(1,18  ),W(1,5   ),G ,AMP(15  ))    
      CALL GGGGXX(W(1,18  ),W(1,4   ),W(1,3   ),W(1,5   ),G ,AMP(16  ))    
      CALL GGGGXX(W(1,3   ),W(1,18  ),W(1,4   ),W(1,5   ),G ,AMP(17  ))    
      CALL VVVXXX(W(1,5   ),W(1,18  ),W(1,17  ),G ,AMP(18  ))              
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             -AMP(  17)+AMP(  18)
      JAMP(   2) = -AMP(   2)+AMP(   3)-AMP(  12)-AMP(  13)-AMP(  15)
     &             +AMP(  16)-AMP(  18)
      JAMP(   3) = -AMP(   3)+AMP(   4)-AMP(   5)+AMP(  13)-AMP(  14)
     &             -AMP(  16)+AMP(  17)
      JAMP(   4) = -AMP(   6)-AMP(   8)+AMP(  11)-AMP(  13)-AMP(  15)
     &             +AMP(  16)-AMP(  18)
      JAMP(   5) = -AMP(   7)+AMP(   9)+AMP(  12)+AMP(  14)+AMP(  15)
     &             -AMP(  17)+AMP(  18)
      JAMP(   6) = +AMP(   8)-AMP(   9)-AMP(  10)+AMP(  13)-AMP(  14)
     &             -AMP(  16)+AMP(  17)
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_183_004=B_CL_183_004 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_183_004=B_CL_183_004 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
