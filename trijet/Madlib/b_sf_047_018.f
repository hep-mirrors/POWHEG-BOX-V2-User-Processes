...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     3,    0,    0,    3,   -1,   -1/    
      DATA (CF(i,1  ),i=7  ,8  ) /     8,    8/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     0,  -21,    0,  -21,   -1,   -8/    
      DATA (CF(i,2  ),i=7  ,8  ) /    -1,   -8/                            
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/            3/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     0,    0,   -3,    3,   -5,   -4/    
      DATA (CF(i,3  ),i=7  ,8  ) /     4,    5/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/            6/                                       
...
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,   -8,   -8,   -1,  -21,  -21/    
      DATA (CF(i,6  ),i=7  ,8  ) /     0,    0/                            
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/            6/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     8,   -1,    8,   -1,    3,    0/    
      DATA (CF(i,7  ),i=7  ,8  ) /     3,    0/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/            3/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     4,   -4,    5,   -5,    3,    0/    
