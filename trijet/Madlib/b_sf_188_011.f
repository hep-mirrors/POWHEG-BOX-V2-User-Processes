      SUBROUTINE SB_SF_188_011(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_011(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_011(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,   -1,   -8,   -8,    0,  -21/    
      DATA (CF(i,6  ),i=7  ,8  ) /     0,  -21/                            
C               T[ 3, 4, 2]T[ 1, 5]                                        
      DATA Denom(7  )/            3/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -5,    4,   -4,    5,    0,    0/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_011 =B_SF_188_011+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
