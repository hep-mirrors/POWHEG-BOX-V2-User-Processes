      SUBROUTINE SB_SF_188_010(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_010(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_010(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            3/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -3,    0,    0,    3,   -4,    4/    
      DATA (CF(i,1  ),i=7  ,8  ) /    -5,    5/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/            6/                                       
...
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -8,   -8,   -1,   -1,  -21,    0/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_010 =B_SF_188_010+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
