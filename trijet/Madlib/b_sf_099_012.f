      SUBROUTINE SB_SF_099_012(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_099_012(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_099_012(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 4, 3]T[ 1, 2, 5]                                        
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,4  ) /     7,   -1,   -2,  -10/                
C               T[ 4, 3]T[ 1, 2, 5]                                        
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /    -1,   -2,    8,    7/                
C               T[ 4, 3, 5]T[ 1, 2]                                        
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /    -2,  -10,    7,   -1/                
C               T[ 1, 2]T[ 4, 3, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_099_012 =B_SF_099_012+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
