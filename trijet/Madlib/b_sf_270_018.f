      SUBROUTINE SB_SF_270_018(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_270_018(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_270_018(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            2/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -24,    0,    3,   -6,    0,   -3/    
C               T[ 3, 2, 4, 1, 5]                                          
      DATA Denom(2  )/            2/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     0,    3,    6,    3,    3,    0/    
C               T[ 3, 2, 1, 5, 4]                                          
      DATA Denom(3  )/            2/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     3,    6,    3,    0,    0,    3/    
C               T[ 3, 2, 4, 5, 1]                                          
      DATA Denom(4  )/            2/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,    3,    0,  -24,   -3,    0/    
C               T[ 3, 2, 5, 1, 4]                                          
      DATA Denom(5  )/            2/                                       
...
C ----------
     ...
     &             +AMP(  16)+AMP(  17)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_270_018 =B_SF_270_018+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
