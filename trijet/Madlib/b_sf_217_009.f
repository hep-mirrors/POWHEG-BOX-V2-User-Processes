      SUBROUTINE SB_SF_217_009(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_217_009(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_217_009(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/            3/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     3,   -3,    0,    0,   -4,   -5/    
      DATA (CF(i,2  ),i=7  ,8  ) /     5,    4/                            
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /   -21,    0,  -21,    0,   -8,   -1/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -8,   -1/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,    0,    0,    3,   -1,   -1/    
      DATA (CF(i,4  ),i=7  ,8  ) /     8,    8/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -1,   -8,   -8,   -1,  -21,  -21/    
...
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/            3/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -5,    5,   -4,    4,    0,    3/    
      DATA (CF(i,7  ),i=7  ,8  ) /    -3,    0/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/            6/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -1,    8,   -1,    8,    0,    3/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_217_009 =B_SF_217_009+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
