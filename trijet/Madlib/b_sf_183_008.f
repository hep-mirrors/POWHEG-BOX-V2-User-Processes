      SUBROUTINE SB_SF_183_008(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_183_008(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_183_008(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 1, 2, 4, 5, 3]                                          
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -1,  -10,   -1,   -1,    8,  -10/    
C               T[ 1, 2, 5, 3, 4]                                          
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     8,    8,   -1,    8,    8,   -1/    
C               T[ 1, 2, 3, 4, 5]                                          
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     8,   -1,  -10,  -10,   -1,   -1/    
C               T[ 1, 2, 3, 5, 4]                                          
C ----------
C BEGIN CODE
C ----------
     ...
     &             -AMP(  16)+AMP(  17)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_183_008 =B_SF_183_008+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
