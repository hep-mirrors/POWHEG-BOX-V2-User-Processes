      SUBROUTINE SB_SF_202_014(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_202_014(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_202_014(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -3,   21,  -30,   -6,    1,  -71/    
      DATA (CF(i,1  ),i=7  ,8  ) /    10,  -62/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   24,   -6,   -3,    1,   -8/    
      DATA (CF(i,2  ),i=7  ,8  ) /    10,    1/                            
C               T[ 3, 4]T[ 2, 1, 5]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /   -30,   -6,   -3,   21,   10,  -62/    
      DATA (CF(i,3  ),i=7  ,8  ) /     1,  -71/                            
C               T[ 2, 1]T[ 3, 4, 5]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   -3,   21,   24,   10,    1/    
      DATA (CF(i,4  ),i=7  ,8  ) /     1,   -8/                            
C               T[ 3, 4, 5]T[ 2, 1]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     1,    1,   10,   10,   21,   21/    
      DATA (CF(i,5  ),i=7  ,8  ) /    18,   18/                            
C               T[ 3, 1, 5]T[ 2, 4]                                        
      DATA Denom(6  )/           54/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -71,   -8,  -62,    1,   21, -168/    
      DATA (CF(i,6  ),i=7  ,8  ) /    18, -171/                            
C               T[ 3, 1]T[ 2, 4, 5]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    10,   10,    1,    1,   18,   18/    
      DATA (CF(i,7  ),i=7  ,8  ) /    21,   21/                            
C               T[ 2, 4]T[ 3, 1, 5]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /   -62,    1,  -71,   -8,   18, -171/    
      DATA (CF(i,8  ),i=7  ,8  ) /    21, -168/                            
C               T[ 3, 1]T[ 2, 4, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_202_014 =B_SF_202_014+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
