      SUBROUTINE SB_SF_275_024(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_275_024(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_275_024(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    -1,   -1,   -1,    8,  -10,  -10/    
C               T[ 3, 4, 2, 1, 5]                                          
      DATA Denom(2  )/            6/                                       
...
C               T[ 3, 4, 5, 1, 2]                                          
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -10,    8,  -10,   -1,   -1,   -1/    
C               T[ 3, 4, 1, 2, 5]                                          
C ----------
C BEGIN CODE
C ----------
     ...
     &             -AMP(  17)+AMP(  18)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_275_024 =B_SF_275_024+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
