      SUBROUTINE SB_SF_188_024(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_188_024(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_188_024(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    21,   21,   18,   18,   10,    1/    
      DATA (CF(i,1  ),i=7  ,8  ) /    10,    1/                            
C               T[ 1, 4]T[ 3, 5, 2]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21, -168,   18, -171,  -62,   -8/    
      DATA (CF(i,2  ),i=7  ,8  ) /     1,  -71/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    18,   18,   21,   21,    1,   10/    
      DATA (CF(i,3  ),i=7  ,8  ) /     1,   10/                            
C               T[ 3, 5, 2]T[ 1, 4]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    18, -171,   21, -168,  -71,    1/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -8,  -62/                            
C               T[ 3, 5]T[ 1, 4, 2]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    10,  -62,    1,  -71,   -3,   -6/    
      DATA (CF(i,5  ),i=7  ,8  ) /    21,  -30/                            
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(6  )/           54/                                       
...
C               T[ 3, 4]T[ 1, 5, 2]                                        
      DATA Denom(8  )/           54/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,  -71,   10,  -62,  -30,   21/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_188_024 =B_SF_188_024+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
