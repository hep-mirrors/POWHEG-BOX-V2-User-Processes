      SUBROUTINE SB_SF_040_012(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_040_012(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_040_012(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           54/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /  -168,   18, -171,   21,  -71,   -8/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -62,    1/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/           54/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    18,   21,   21,   18,   10,   10/    
      DATA (CF(i,2  ),i=7  ,8  ) /     1,    1/                            
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/           54/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /  -171,   21, -168,   18,  -62,    1/    
      DATA (CF(i,3  ),i=7  ,8  ) /   -71,   -8/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/           54/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   18,   18,   21,    1,    1/    
      DATA (CF(i,4  ),i=7  ,8  ) /    10,   10/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/           54/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /   -71,   10,  -62,    1,   -3,   21/    
      DATA (CF(i,5  ),i=7  ,8  ) /   -30,   -6/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/           54/                                       
...
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/           54/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -62,    1,  -71,   10,  -30,   -6/    
      DATA (CF(i,7  ),i=7  ,8  ) /    -3,   21/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/           54/                                       
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_040_012 =B_SF_040_012+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
