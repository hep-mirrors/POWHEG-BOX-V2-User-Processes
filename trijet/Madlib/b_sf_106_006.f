      SUBROUTINE SB_SF_106_006(P1,ANS)
C  
...
C  
      ...
      common/to_amps_106/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_106/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_106/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_106_006(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_106_006(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 4, 3]T[ 2, 1, 5]                                        
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /     6,    7,  -56,  -57/                
C               T[ 4, 3, 5]T[ 2, 1]                                        
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /     7,    6,  -57,  -56/                
C               T[ 2, 1]T[ 4, 3, 5]                                        
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_106_006 =B_SF_106_006+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
