      SUBROUTINE SB_SF_276_012(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_276_012(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_276_012(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           72/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    56,   65,   -7,  128,  -88,    2/    
      DATA (CF(i,1  ),i=7  ,12 ) /   -70,  -16,   56,   56,  -16,   11/    
      DATA (CF(i,1  ),i=13 ,18 ) /   -16,  -16,  -25,   65,   -7,  -70/    
      DATA (CF(i,1  ),i=19 ,24 ) /    65,    2,  -25,   65,   -7,    2/    
C               F[1, 5, 2, 3, 4]                                           
      DATA Denom(2  )/           72/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    65, -511, -124,   -7,    2,   74/    
      DATA (CF(i,2  ),i=7  ,12 ) /    56,  -70,  -16,    2,   74, -124/    
      DATA (CF(i,2  ),i=13 ,18 ) /    -7,   11,   65,  -70,    2,   20/    
      DATA (CF(i,2  ),i=19 ,24 ) /   -70,  -52,    2,   -7,   20,  -70/    
C               F[1, 5, 3, 2, 4]                                           
      DATA Denom(3  )/           72/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -7, -124, -511,   65,  -70,   56/    
      DATA (CF(i,3  ),i=7  ,12 ) /    74,    2,  -70,   -7,   20,  -70/    
      DATA (CF(i,3  ),i=13 ,18 ) /     2,   65,   11,  -16,  -70,  -52/    
      DATA (CF(i,3  ),i=19 ,24 ) /     2,   20,   -7,    2,   74, -124/    
C               F[1, 5, 4, 2, 3]                                           
      DATA Denom(4  )/           72/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /   128,   -7,   65,   56,  -16,  -70/    
      DATA (CF(i,4  ),i=7  ,12 ) /     2,  -88,   65,   65,   -7,    2/    
      DATA (CF(i,4  ),i=13 ,18 ) /   -25,  -25,  -16,   56,   65,    2/    
      DATA (CF(i,4  ),i=19 ,24 ) /    -7,  -70,  -16,   56,  -16,   11/    
C               F[1, 5, 4, 3, 2]                                           
      DATA Denom(5  )/           72/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /   -88,    2,  -70,  -16,   56,   65/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -7,  128,  -25,  -25,    2,   -7/    
      DATA (CF(i,5  ),i=13 ,18 ) /    65,   65,   56,  -16,  -70,   -7/    
      DATA (CF(i,5  ),i=19 ,24 ) /     2,   65,   56,  -16,   11,  -16/    
C               F[1, 2, 3, 4, 5]                                           
      DATA Denom(6  )/           72/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     2,   74,   56,  -70,   65, -511/    
      DATA (CF(i,6  ),i=7  ,12 ) /  -124,   -7,   65,    2,  -70,   20/    
      DATA (CF(i,6  ),i=13 ,18 ) /    -7,  -70,  -16,   11,   20,    2/    
      DATA (CF(i,6  ),i=19 ,24 ) /   -52,  -70,    2,   -7, -124,   74/    
C               F[1, 3, 2, 4, 5]                                           
      DATA Denom(7  )/           72/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -70,   56,   74,    2,   -7, -124/    
      DATA (CF(i,7  ),i=7  ,12 ) /  -511,   65,   11,   -7, -124,   74/    
      DATA (CF(i,7  ),i=13 ,18 ) /     2,  -16,  -70,   65,  -52,  -70/    
      DATA (CF(i,7  ),i=19 ,24 ) /    20,    2,   -7,    2,  -70,   20/    
C               F[1, 4, 2, 3, 5]                                           
      DATA Denom(8  )/           72/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /   -16,  -70,    2,  -88,  128,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    65,   56,  -16,  -16,   11,  -16/    
      DATA (CF(i,8  ),i=13 ,18 ) /    56,   56,   65,  -25,    2,   65/    
      DATA (CF(i,8  ),i=19 ,24 ) /   -70,   -7,   65,  -25,    2,   -7/    
C               F[1, 4, 3, 2, 5]                                           
      DATA Denom(9  )/           72/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    56,  -16,  -70,   65,  -25,   65/    
      DATA (CF(i,9  ),i=7  ,12 ) /    11,  -16,   56,  -25,   65,  -70/    
      DATA (CF(i,9  ),i=13 ,18 ) /    65,  -16,   56,  -16,   -7,   -7/    
      DATA (CF(i,9  ),i=19 ,24 ) /     2,    2,  -88,  128,   -7,    2/    
C               F[1, 3, 2, 5, 4]                                           
      DATA Denom(10 )/           72/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    56,    2,   -7,   65,  -25,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -7,  -16,  -25,   56,   65,  -70/    
      DATA (CF(i,10 ),i=13 ,18 ) /   -16,   65,  -88,  128,  -70,   11/    
      DATA (CF(i,10 ),i=19 ,24 ) /   -16,   65,   56,  -16,   -7,    2/    
C               F[1, 4, 3, 5, 2]                                           
      DATA Denom(11 )/           72/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /   -16,   74,   20,   -7,    2,  -70/    
      DATA (CF(i,11 ),i=7  ,12 ) /  -124,   11,   65,   65, -511,   56/    
      DATA (CF(i,11 ),i=13 ,18 ) /   -70,  -70,    2,   -7,   20, -124/    
      DATA (CF(i,11 ),i=19 ,24 ) /    74,  -70,    2,   -7,    2,  -52/    
C               F[1, 3, 5, 2, 4]                                           
      DATA Denom(12 )/           72/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    11, -124,  -70,    2,   -7,   20/    
      DATA (CF(i,12 ),i=7  ,12 ) /    74,  -16,  -70,  -70,   56, -511/    
      DATA (CF(i,12 ),i=13 ,18 ) /    65,   65,   -7,    2,  -70,   74/    
      DATA (CF(i,12 ),i=19 ,24 ) /  -124,   20,   -7,    2,  -52,    2/    
C               F[1, 4, 2, 5, 3]                                           
      DATA Denom(13 )/           72/                                       
      DATA (CF(i,13 ),i=1  ,6  ) /   -16,   -7,    2,  -25,   65,   -7/    
      DATA (CF(i,13 ),i=7  ,12 ) /     2,   56,   65,  -16,  -70,   65/    
      DATA (CF(i,13 ),i=13 ,18 ) /    56,  -25,  128,  -88,   65,  -16/    
      DATA (CF(i,13 ),i=19 ,24 ) /    11,  -70,  -16,   56,    2,   -7/    
C               F[1, 2, 5, 3, 4]                                           
      DATA Denom(14 )/           72/                                       
      DATA (CF(i,14 ),i=1  ,6  ) /   -16,   11,   65,  -25,   65,  -70/    
      DATA (CF(i,14 ),i=7  ,12 ) /   -16,   56,  -16,   65,  -70,   65/    
      DATA (CF(i,14 ),i=13 ,18 ) /   -25,   56,  -16,   56,    2,    2/    
      DATA (CF(i,14 ),i=19 ,24 ) /    -7,   -7,  128,  -88,    2,   -7/    
C               F[1, 4, 5, 2, 3]                                           
      DATA Denom(15 )/           72/                                       
      DATA (CF(i,15 ),i=1  ,6  ) /   -25,   65,   11,  -16,   56,  -16/    
      DATA (CF(i,15 ),i=7  ,12 ) /   -70,   65,   56,  -88,    2,   -7/    
      DATA (CF(i,15 ),i=13 ,18 ) /   128,  -16,   56,  -16,   -7,   -7/    
      DATA (CF(i,15 ),i=19 ,24 ) /     2,    2,  -25,   65,  -70,   65/    
C               F[1, 4, 5, 3, 2]                                           
      DATA Denom(16 )/           72/                                       
      DATA (CF(i,16 ),i=1  ,6  ) /    65,  -70,  -16,   56,  -16,   11/    
      DATA (CF(i,16 ),i=7  ,12 ) /    65,  -25,  -16,  128,   -7,    2/    
      DATA (CF(i,16 ),i=13 ,18 ) /   -88,   56,  -16,   56,    2,    2/    
      DATA (CF(i,16 ),i=19 ,24 ) /    -7,   -7,   65,  -25,   65,  -70/    
C               F[1, 2, 3, 5, 4]                                           
      DATA Denom(17 )/           72/                                       
      DATA (CF(i,17 ),i=1  ,6  ) /    -7,    2,  -70,   65,  -70,   20/    
      DATA (CF(i,17 ),i=7  ,12 ) /   -52,    2,   -7,  -70,   20,  -70/    
      DATA (CF(i,17 ),i=13 ,18 ) /    65,    2,   -7,    2, -511,   74/    
      DATA (CF(i,17 ),i=19 ,24 ) /  -124,   56,   11,  -16,   74, -124/    
C               F[1, 5, 3, 4, 2]                                           
      DATA Denom(18 )/           72/                                       
      DATA (CF(i,18 ),i=1  ,6  ) /   -70,   20,  -52,    2,   -7,    2/    
      DATA (CF(i,18 ),i=7  ,12 ) /   -70,   65,   -7,   11, -124,   74/    
      DATA (CF(i,18 ),i=13 ,18 ) /   -16,    2,   -7,    2,   74, -511/    
      DATA (CF(i,18 ),i=19 ,24 ) /    56, -124,  -70,   65,  -70,   20/    
C               F[1, 3, 4, 2, 5]                                           
      DATA Denom(19 )/           72/                                       
      DATA (CF(i,19 ),i=1  ,6  ) /    65,  -70,    2,   -7,    2,  -52/    
      DATA (CF(i,19 ),i=7  ,12 ) /    20,  -70,    2,  -16,   74, -124/    
      DATA (CF(i,19 ),i=13 ,18 ) /    11,   -7,    2,   -7, -124,   56/    
      DATA (CF(i,19 ),i=19 ,24 ) /  -511,   74,   65,  -70,   20,  -70/    
C               F[1, 5, 2, 4, 3]                                           
      DATA Denom(20 )/           72/                                       
      DATA (CF(i,20 ),i=1  ,6  ) /     2,  -52,   20,  -70,   65,  -70/    
      DATA (CF(i,20 ),i=7  ,12 ) /     2,   -7,    2,   65,  -70,   20/    
      DATA (CF(i,20 ),i=13 ,18 ) /   -70,   -7,    2,   -7,   56, -124/    
      DATA (CF(i,20 ),i=19 ,24 ) /    74, -511,  -16,   11, -124,   74/    
C               F[1, 2, 4, 3, 5]                                           
      DATA Denom(21 )/           72/                                       
      DATA (CF(i,21 ),i=1  ,6  ) /   -25,    2,   -7,  -16,   56,    2/    
      DATA (CF(i,21 ),i=7  ,12 ) /    -7,   65,  -88,   56,    2,   -7/    
      DATA (CF(i,21 ),i=13 ,18 ) /   -16,  128,  -25,   65,   11,  -70/    
      DATA (CF(i,21 ),i=19 ,24 ) /    65,  -16,   56,  -16,  -70,   65/    
C               F[1, 2, 5, 4, 3]                                           
      DATA Denom(22 )/           72/                                       
      DATA (CF(i,22 ),i=1  ,6  ) /    65,   -7,    2,   56,  -16,   -7/    
      DATA (CF(i,22 ),i=7  ,12 ) /     2,  -25,  128,  -16,   -7,    2/    
      DATA (CF(i,22 ),i=13 ,18 ) /    56,  -88,   65,  -25,  -16,   65/    
      DATA (CF(i,22 ),i=19 ,24 ) /   -70,   11,  -16,   56,   65,  -70/    
C               F[1, 3, 4, 5, 2]                                           
      DATA Denom(23 )/           72/                                       
      DATA (CF(i,23 ),i=1  ,6  ) /    -7,   20,   74,  -16,   11, -124/    
      DATA (CF(i,23 ),i=7  ,12 ) /   -70,    2,   -7,   -7,    2,  -52/    
      DATA (CF(i,23 ),i=13 ,18 ) /     2,    2,  -70,   65,   74,  -70/    
      DATA (CF(i,23 ),i=19 ,24 ) /    20, -124,  -70,   65, -511,   56/    
C               F[1, 3, 5, 4, 2]                                           
      DATA Denom(24 )/           72/                                       
      DATA (CF(i,24 ),i=1  ,6  ) /     2,  -70, -124,   11,  -16,   74/    
      DATA (CF(i,24 ),i=7  ,12 ) /    20,   -7,    2,    2,  -52,    2/    
      DATA (CF(i,24 ),i=13 ,18 ) /    -7,   -7,   65,  -70, -124,   20/    
      DATA (CF(i,24 ),i=19 ,24 ) /   -70,   74,   65,  -70,   56, -511/    
C               F[1, 2, 4, 5, 3]                                           
C ----------
C BEGIN CODE
C ----------
     ...
     &             +AMP(  44))
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_276_012 =B_SF_276_012+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
