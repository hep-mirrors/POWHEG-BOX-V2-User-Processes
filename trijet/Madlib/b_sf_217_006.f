      SUBROUTINE SB_SF_217_006(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_217_006(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_217_006(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     0,    3,    3,    0,    8,    8/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -1,   -1/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     0,  -21,    0,  -21,   -1,   -8/    
      DATA (CF(i,4  ),i=7  ,8  ) /    -1,   -8/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     8,   -1,    8,   -1,    3,    0/    
      DATA (CF(i,5  ),i=7  ,8  ) /     3,    0/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/            3/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     5,   -5,    4,   -4,    0,   -3/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_217_006 =B_SF_217_006+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
