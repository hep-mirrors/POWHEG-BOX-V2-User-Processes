      SUBROUTINE SB_SF_217_020(P1,ANS)
C  
...
C  
C FOR PROCESS : g d -> d d d~ g  
C  
C BORN AMPLITUDE IS g d -> d d d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_217/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_217/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_217/savemom
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_217_020(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_217_020(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           27/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /   -24,   18,   -9,    3,   31,   40/    
      DATA (CF(i,1  ),i=7  ,8  ) /   -14,   -5/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(2  )/           27/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    18,  -24,    3,   -9,   -5,  -14/    
      DATA (CF(i,2  ),i=7  ,8  ) /    40,   31/                            
C               T[ 4, 2, 1]T[ 3, 5]                                        
      DATA Denom(3  )/           27/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -9,    3,    3,   -9,   31,   31/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -5,   -5/                            
C               T[ 4, 2]T[ 3, 5, 1]                                        
      DATA Denom(4  )/           27/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     3,   -9,   -9,    3,   -5,   -5/    
      DATA (CF(i,4  ),i=7  ,8  ) /    31,   31/                            
C               T[ 3, 5]T[ 4, 2, 1]                                        
      DATA Denom(5  )/           27/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    31,   -5,   31,   -5,    3,   -9/    
      DATA (CF(i,5  ),i=7  ,8  ) /     3,   -9/                            
C               T[ 3, 2]T[ 4, 5, 1]                                        
      DATA Denom(6  )/           27/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    40,  -14,   31,   -5,   -9,  -24/    
      DATA (CF(i,6  ),i=7  ,8  ) /    18,    3/                            
C               T[ 4, 5, 1]T[ 3, 2]                                        
      DATA Denom(7  )/           27/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /   -14,   40,   -5,   31,    3,   18/    
      DATA (CF(i,7  ),i=7  ,8  ) /   -24,   -9/                            
C               T[ 4, 5]T[ 3, 2, 1]                                        
      DATA Denom(8  )/           27/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -5,   31,   -5,   31,   -9,    3/    
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_217_020 =B_SF_217_020+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
