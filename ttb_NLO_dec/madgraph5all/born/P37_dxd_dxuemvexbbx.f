      SUBROUTINE SP37_dxd_dxuemvexbbx1(P,ANS)
C     
...
C     
C     Process: d~ d > d~ u e- ve~ b b~ QCD=2 QED=4 @37
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P37_dxd_dxuemvexbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      COMMON/TO_AMPS_P37_dxd_dxuemvexbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P37_dxd_dxuemvexbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P37_dxd_dxuemvexbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1P0_3(W(1,2),W(1,1),GC_1,ZERO,ZERO,W(1,21))
...
C     Amplitude(s) for diagram number 29
      ...
      CALL FFV2_3_3(W(1,2),W(1,1),GC_50,GC_58,MZ,WZ,W(1,17))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_2(W(1,3),W(1,18),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,28),W(1,13),W(1,19),GC_100,AMP(37))
      CALL VVV1_3(W(1,21),W(1,19),GC_4,MW,WW,W(1,13))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,28),W(1,4),W(1,13),GC_100,AMP(38))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,28),W(1,16),W(1,21),GC_1,AMP(41))
...
C     Amplitude(s) for diagram number 42
      ...
      CALL FFV1_1(W(1,4),W(1,13),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 43
      CALL FFV2_0(W(1,25),W(1,29),W(1,19),GC_100,AMP(43))
      CALL VVV1_3(W(1,13),W(1,19),GC_4,MW,WW,W(1,30))
C     Amplitude(s) for diagram number 44
      CALL FFV2_0(W(1,25),W(1,4),W(1,30),GC_100,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,11),W(1,26),W(1,13),GC_2,AMP(45))
      CALL FFV1_2(W(1,3),W(1,13),GC_1,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 46
      CALL FFV2_0(W(1,31),W(1,26),W(1,19),GC_100,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_0(W(1,3),W(1,26),W(1,30),GC_100,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,11),W(1,29),W(1,9),GC_11,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,31),W(1,16),W(1,9),GC_11,AMP(49))
      CALL FFS4_3(W(1,8),W(1,7),GC_83,MH,WH,W(1,32))
      CALL VVS1_2(W(1,19),W(1,32),GC_72,MW,WW,W(1,33))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,25),W(1,4),W(1,33),GC_100,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,3),W(1,26),W(1,33),GC_100,AMP(51))
      CALL FFV2_3_3(W(1,8),W(1,7),GC_50,GC_58,MZ,WZ,W(1,32))
C     Amplitude(s) for diagram number 52
      CALL FFV2_3_0(W(1,25),W(1,16),W(1,32),GC_50,GC_58,AMP(52))
      CALL FFV2_5_1(W(1,4),W(1,32),GC_51,GC_58,ZERO,ZERO,W(1,34))
C     Amplitude(s) for diagram number 53
      CALL FFV2_0(W(1,25),W(1,34),W(1,19),GC_100,AMP(53))
      CALL VVV1_2(W(1,19),W(1,32),GC_53,MW,WW,W(1,35))
C     Amplitude(s) for diagram number 54
      CALL FFV2_0(W(1,25),W(1,4),W(1,35),GC_100,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_5_0(W(1,11),W(1,26),W(1,32),GC_51,GC_58,AMP(55))
      CALL FFV2_3_2(W(1,3),W(1,32),GC_50,GC_58,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 56
      CALL FFV2_0(W(1,25),W(1,26),W(1,19),GC_100,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_0(W(1,3),W(1,26),W(1,35),GC_100,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,11),W(1,34),W(1,9),GC_11,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,25),W(1,16),W(1,9),GC_11,AMP(59))
      CALL FFV2_3_2(W(1,3),W(1,17),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,9),W(1,16),W(1,18),GC_11,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_0(W(1,9),W(1,15),W(1,19),GC_100,AMP(61))
      CALL FFV2_5_1(W(1,4),W(1,17),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,11),W(1,9),W(1,18),GC_11,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV2_0(W(1,28),W(1,9),W(1,19),GC_100,AMP(63))
      CALL VVV1_2(W(1,19),W(1,17),GC_53,MW,WW,W(1,9))
C     Amplitude(s) for diagram number 64
      CALL FFV2_0(W(1,28),W(1,4),W(1,9),GC_100,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV2_0(W(1,3),W(1,15),W(1,9),GC_100,AMP(65))
...
C     Amplitude(s) for diagram number 67
      CALL FFV2_3_0(W(1,28),W(1,16),W(1,17),GC_50,GC_58,AMP(67))
      CALL FFV1_1(W(1,5),W(1,21),GC_3,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,6),W(1,9),GC_100,MW,WW,W(1,21))
C     Amplitude(s) for diagram number 68
      CALL FFV2_0(W(1,28),W(1,4),W(1,21),GC_100,AMP(68))
...
C     Amplitude(s) for diagram number 71
      ...
      CALL FFV2_4_1(W(1,5),W(1,32),GC_50,GC_59,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 72
      CALL FFV2_0(W(1,6),W(1,9),W(1,24),GC_100,AMP(72))
      CALL FFV2_2(W(1,6),W(1,32),GC_62,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 73
      CALL FFV2_0(W(1,26),W(1,5),W(1,24),GC_100,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_0(W(1,6),W(1,9),W(1,27),GC_100,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV2_0(W(1,26),W(1,5),W(1,27),GC_100,AMP(75))
      CALL FFV2_4_1(W(1,5),W(1,17),GC_50,GC_59,ZERO,ZERO,W(1,27))
      CALL FFV2_3(W(1,6),W(1,27),GC_100,MW,WW,W(1,24))
C     Amplitude(s) for diagram number 76
      CALL FFV2_0(W(1,28),W(1,4),W(1,24),GC_100,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_0(W(1,3),W(1,15),W(1,24),GC_100,AMP(77))
      CALL FFV2_2(W(1,6),W(1,17),GC_62,ZERO,ZERO,W(1,24))
      CALL FFV2_3(W(1,24),W(1,5),GC_100,MW,WW,W(1,17))
C     Amplitude(s) for diagram number 78
      CALL FFV2_0(W(1,28),W(1,4),W(1,17),GC_100,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_0(W(1,3),W(1,15),W(1,17),GC_100,AMP(79))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,17))
      CALL FFV2_3(W(1,2),W(1,4),GC_100,MW,WW,W(1,24))
      CALL FFV1_1(W(1,7),W(1,17),GC_11,MB,ZERO,W(1,27))
      CALL FFV2_1(W(1,5),W(1,24),GC_100,ZERO,ZERO,W(1,36))
      CALL FFV2_3_3(W(1,8),W(1,27),GC_50,GC_58,MZ,WZ,W(1,37))
C     Amplitude(s) for diagram number 80
      CALL FFV2_0(W(1,6),W(1,36),W(1,37),GC_62,AMP(80))
      CALL FFV2_2(W(1,6),W(1,24),GC_100,ZERO,ZERO,W(1,38))
      CALL FFV1P0_3(W(1,8),W(1,27),GC_1,ZERO,ZERO,W(1,39))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,38),W(1,5),W(1,39),GC_3,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV2_4_0(W(1,38),W(1,5),W(1,37),GC_50,GC_59,AMP(82))
      CALL FFV1_2(W(1,8),W(1,17),GC_11,MB,ZERO,W(1,40))
      CALL FFV2_3_3(W(1,40),W(1,7),GC_50,GC_58,MZ,WZ,W(1,41))
C     Amplitude(s) for diagram number 83
      CALL FFV2_0(W(1,6),W(1,36),W(1,41),GC_62,AMP(83))
      CALL FFV1P0_3(W(1,40),W(1,7),GC_1,ZERO,ZERO,W(1,42))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,38),W(1,5),W(1,42),GC_3,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV2_4_0(W(1,38),W(1,5),W(1,41),GC_50,GC_59,AMP(85))
      CALL VVV1P0_1(W(1,19),W(1,24),GC_4,ZERO,ZERO,W(1,43))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,8),W(1,27),W(1,43),GC_1,AMP(86))
      CALL VVS1_3(W(1,19),W(1,24),GC_72,MH,WH,W(1,44))
C     Amplitude(s) for diagram number 87
      CALL FFS4_0(W(1,8),W(1,27),W(1,44),GC_83,AMP(87))
      CALL VVV1_3(W(1,19),W(1,24),GC_53,MZ,WZ,W(1,45))
C     Amplitude(s) for diagram number 88
      CALL FFV2_3_0(W(1,8),W(1,27),W(1,45),GC_50,GC_58,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV2_0(W(1,23),W(1,27),W(1,24),GC_100,AMP(89))
...
C     Amplitude(s) for diagram number 92
      ...
      CALL FFV2_1(W(1,7),W(1,24),GC_100,MT,WT,W(1,44))
C     Amplitude(s) for diagram number 93
      CALL FFV2_0(W(1,40),W(1,44),W(1,19),GC_100,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,23),W(1,44),W(1,17),GC_11,AMP(94))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_1,ZERO,ZERO,W(1,44))
      CALL FFV1_1(W(1,7),W(1,44),GC_1,MB,ZERO,W(1,40))
      CALL FFV2_2(W(1,2),W(1,19),GC_100,ZERO,ZERO,W(1,27))
      CALL FFV1P0_3(W(1,8),W(1,40),GC_11,ZERO,ZERO,W(1,46))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,27),W(1,4),W(1,46),GC_11,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,2),W(1,16),W(1,46),GC_11,AMP(96))
      CALL FFV1_2(W(1,8),W(1,44),GC_1,MB,ZERO,W(1,46))
      CALL FFV1P0_3(W(1,46),W(1,7),GC_11,ZERO,ZERO,W(1,40))
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,27),W(1,4),W(1,40),GC_11,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFV1_0(W(1,2),W(1,16),W(1,40),GC_11,AMP(98))
      CALL FFV1_2(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,40))
      CALL FFV2_3(W(1,40),W(1,4),GC_100,MW,WW,W(1,46))
C     Amplitude(s) for diagram number 99
      CALL FFV2_0(W(1,23),W(1,7),W(1,46),GC_100,AMP(99))
      CALL FFV1_1(W(1,4),W(1,17),GC_11,ZERO,ZERO,W(1,47))
      CALL FFV2_3(W(1,2),W(1,47),GC_100,MW,WW,W(1,48))
C     Amplitude(s) for diagram number 100
      CALL FFV2_0(W(1,23),W(1,7),W(1,48),GC_100,AMP(100))
C     Amplitude(s) for diagram number 101
      CALL FFV1_0(W(1,27),W(1,4),W(1,39),GC_2,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV2_5_0(W(1,27),W(1,4),W(1,37),GC_51,GC_58,AMP(102))
C     Amplitude(s) for diagram number 103
      CALL FFV1_0(W(1,2),W(1,16),W(1,39),GC_1,AMP(103))
C     Amplitude(s) for diagram number 104
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,37),GC_50,GC_58,AMP(104))
C     Amplitude(s) for diagram number 105
      CALL FFV1_0(W(1,27),W(1,4),W(1,42),GC_2,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV2_5_0(W(1,27),W(1,4),W(1,41),GC_51,GC_58,AMP(106))
C     Amplitude(s) for diagram number 107
      CALL FFV1_0(W(1,2),W(1,16),W(1,42),GC_1,AMP(107))
C     Amplitude(s) for diagram number 108
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,41),GC_50,GC_58,AMP(108))
      CALL FFV2_3_3(W(1,3),W(1,1),GC_50,GC_58,MZ,WZ,W(1,41))
      CALL FFV2_3_1(W(1,7),W(1,41),GC_50,GC_58,MB,ZERO,W(1,42))
      CALL FFV1P0_3(W(1,8),W(1,42),GC_11,ZERO,ZERO,W(1,37))
C     Amplitude(s) for diagram number 109
      CALL FFV1_0(W(1,27),W(1,4),W(1,37),GC_11,AMP(109))
C     Amplitude(s) for diagram number 110
      CALL FFV1_0(W(1,2),W(1,16),W(1,37),GC_11,AMP(110))
      CALL FFV2_3_2(W(1,8),W(1,41),GC_50,GC_58,MB,ZERO,W(1,37))
      CALL FFV1P0_3(W(1,37),W(1,7),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 111
      CALL FFV1_0(W(1,27),W(1,4),W(1,8),GC_11,AMP(111))
C     Amplitude(s) for diagram number 112
      CALL FFV1_0(W(1,2),W(1,16),W(1,8),GC_11,AMP(112))
      CALL FFV1_2(W(1,2),W(1,44),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 113
      CALL FFV1_0(W(1,8),W(1,16),W(1,18),GC_11,AMP(113))
C     Amplitude(s) for diagram number 114
      CALL FFV2_0(W(1,8),W(1,15),W(1,19),GC_100,AMP(114))
      CALL FFV1_1(W(1,4),W(1,44),GC_2,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 115
      CALL FFV1_0(W(1,27),W(1,8),W(1,18),GC_11,AMP(115))
      CALL FFV1_2(W(1,2),W(1,18),GC_11,ZERO,ZERO,W(1,37))
C     Amplitude(s) for diagram number 116
      CALL FFV2_0(W(1,37),W(1,8),W(1,19),GC_100,AMP(116))
      CALL VVV1_3(W(1,44),W(1,19),GC_4,MW,WW,W(1,8))
C     Amplitude(s) for diagram number 117
      CALL FFV2_0(W(1,37),W(1,4),W(1,8),GC_100,AMP(117))
C     Amplitude(s) for diagram number 118
      CALL FFV2_0(W(1,2),W(1,15),W(1,8),GC_100,AMP(118))
C     Amplitude(s) for diagram number 119
      CALL FFV1_0(W(1,27),W(1,15),W(1,44),GC_2,AMP(119))
C     Amplitude(s) for diagram number 120
      CALL FFV1_0(W(1,37),W(1,16),W(1,44),GC_1,AMP(120))
C     Amplitude(s) for diagram number 121
      CALL FFV1_0(W(1,40),W(1,16),W(1,13),GC_1,AMP(121))
C     Amplitude(s) for diagram number 122
      CALL FFV2_0(W(1,40),W(1,29),W(1,19),GC_100,AMP(122))
C     Amplitude(s) for diagram number 123
      CALL FFV2_0(W(1,40),W(1,4),W(1,30),GC_100,AMP(123))
C     Amplitude(s) for diagram number 124
      CALL FFV1_0(W(1,27),W(1,47),W(1,13),GC_2,AMP(124))
      CALL FFV1_2(W(1,2),W(1,13),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 125
      CALL FFV2_0(W(1,8),W(1,47),W(1,19),GC_100,AMP(125))
C     Amplitude(s) for diagram number 126
      CALL FFV2_0(W(1,2),W(1,47),W(1,30),GC_100,AMP(126))
C     Amplitude(s) for diagram number 127
      CALL FFV1_0(W(1,27),W(1,29),W(1,17),GC_11,AMP(127))
C     Amplitude(s) for diagram number 128
      CALL FFV1_0(W(1,8),W(1,16),W(1,17),GC_11,AMP(128))
C     Amplitude(s) for diagram number 129
      CALL FFV2_0(W(1,40),W(1,4),W(1,33),GC_100,AMP(129))
C     Amplitude(s) for diagram number 130
      CALL FFV2_0(W(1,2),W(1,47),W(1,33),GC_100,AMP(130))
C     Amplitude(s) for diagram number 131
      CALL FFV2_3_0(W(1,40),W(1,16),W(1,32),GC_50,GC_58,AMP(131))
C     Amplitude(s) for diagram number 132
      CALL FFV2_0(W(1,40),W(1,34),W(1,19),GC_100,AMP(132))
C     Amplitude(s) for diagram number 133
      CALL FFV2_0(W(1,40),W(1,4),W(1,35),GC_100,AMP(133))
C     Amplitude(s) for diagram number 134
      CALL FFV2_5_0(W(1,27),W(1,47),W(1,32),GC_51,GC_58,AMP(134))
      CALL FFV2_3_2(W(1,2),W(1,32),GC_50,GC_58,ZERO,ZERO,W(1,40))
C     Amplitude(s) for diagram number 135
      CALL FFV2_0(W(1,40),W(1,47),W(1,19),GC_100,AMP(135))
C     Amplitude(s) for diagram number 136
      CALL FFV2_0(W(1,2),W(1,47),W(1,35),GC_100,AMP(136))
C     Amplitude(s) for diagram number 137
      CALL FFV1_0(W(1,27),W(1,34),W(1,17),GC_11,AMP(137))
C     Amplitude(s) for diagram number 138
      CALL FFV1_0(W(1,40),W(1,16),W(1,17),GC_11,AMP(138))
      CALL FFV2_3_2(W(1,2),W(1,41),GC_50,GC_58,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 139
      CALL FFV1_0(W(1,17),W(1,16),W(1,18),GC_11,AMP(139))
C     Amplitude(s) for diagram number 140
      CALL FFV2_0(W(1,17),W(1,15),W(1,19),GC_100,AMP(140))
      CALL FFV2_5_1(W(1,4),W(1,41),GC_51,GC_58,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 141
      CALL FFV1_0(W(1,27),W(1,17),W(1,18),GC_11,AMP(141))
C     Amplitude(s) for diagram number 142
      CALL FFV2_0(W(1,37),W(1,17),W(1,19),GC_100,AMP(142))
      CALL VVV1_2(W(1,19),W(1,41),GC_53,MW,WW,W(1,17))
C     Amplitude(s) for diagram number 143
      CALL FFV2_0(W(1,37),W(1,4),W(1,17),GC_100,AMP(143))
C     Amplitude(s) for diagram number 144
      CALL FFV2_0(W(1,2),W(1,15),W(1,17),GC_100,AMP(144))
C     Amplitude(s) for diagram number 145
      CALL FFV2_5_0(W(1,27),W(1,15),W(1,41),GC_51,GC_58,AMP(145))
C     Amplitude(s) for diagram number 146
      CALL FFV2_3_0(W(1,37),W(1,16),W(1,41),GC_50,GC_58,AMP(146))
      CALL FFV1_1(W(1,5),W(1,44),GC_3,ZERO,ZERO,W(1,17))
      CALL FFV2_3(W(1,6),W(1,17),GC_100,MW,WW,W(1,44))
C     Amplitude(s) for diagram number 147
      CALL FFV2_0(W(1,37),W(1,4),W(1,44),GC_100,AMP(147))
C     Amplitude(s) for diagram number 148
      CALL FFV2_0(W(1,2),W(1,15),W(1,44),GC_100,AMP(148))
C     Amplitude(s) for diagram number 149
      CALL FFV2_0(W(1,6),W(1,21),W(1,46),GC_100,AMP(149))
C     Amplitude(s) for diagram number 150
      CALL FFV2_0(W(1,6),W(1,21),W(1,48),GC_100,AMP(150))
C     Amplitude(s) for diagram number 151
      CALL FFV2_0(W(1,6),W(1,9),W(1,46),GC_100,AMP(151))
C     Amplitude(s) for diagram number 152
      CALL FFV2_0(W(1,26),W(1,5),W(1,46),GC_100,AMP(152))
C     Amplitude(s) for diagram number 153
      CALL FFV2_0(W(1,6),W(1,9),W(1,48),GC_100,AMP(153))
C     Amplitude(s) for diagram number 154
      CALL FFV2_0(W(1,26),W(1,5),W(1,48),GC_100,AMP(154))
      CALL FFV2_4_1(W(1,5),W(1,41),GC_50,GC_59,ZERO,ZERO,W(1,48))
      CALL FFV2_3(W(1,6),W(1,48),GC_100,MW,WW,W(1,26))
C     Amplitude(s) for diagram number 155
      CALL FFV2_0(W(1,37),W(1,4),W(1,26),GC_100,AMP(155))
C     Amplitude(s) for diagram number 156
      CALL FFV2_0(W(1,2),W(1,15),W(1,26),GC_100,AMP(156))
      CALL FFV2_2(W(1,6),W(1,41),GC_62,ZERO,ZERO,W(1,26))
      CALL FFV2_3(W(1,26),W(1,5),GC_100,MW,WW,W(1,41))
C     Amplitude(s) for diagram number 157
      CALL FFV2_0(W(1,37),W(1,4),W(1,41),GC_100,AMP(157))
C     Amplitude(s) for diagram number 158
      CALL FFV2_0(W(1,2),W(1,15),W(1,41),GC_100,AMP(158))
      CALL FFV2_1(W(1,1),W(1,24),GC_100,ZERO,ZERO,W(1,41))
C     Amplitude(s) for diagram number 159
      CALL FFV1_0(W(1,11),W(1,41),W(1,18),GC_11,AMP(159))
C     Amplitude(s) for diagram number 160
      CALL FFV2_0(W(1,28),W(1,41),W(1,19),GC_100,AMP(160))
      CALL FFV1_1(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,41))
C     Amplitude(s) for diagram number 161
      CALL FFV1_0(W(1,3),W(1,41),W(1,43),GC_1,AMP(161))
C     Amplitude(s) for diagram number 162
      CALL FFV2_3_0(W(1,3),W(1,41),W(1,45),GC_50,GC_58,AMP(162))
C     Amplitude(s) for diagram number 163
      CALL FFV2_0(W(1,11),W(1,41),W(1,24),GC_100,AMP(163))
C     Amplitude(s) for diagram number 164
      CALL FFV1_0(W(1,28),W(1,1),W(1,43),GC_1,AMP(164))
C     Amplitude(s) for diagram number 165
      CALL FFV2_3_0(W(1,28),W(1,1),W(1,45),GC_50,GC_58,AMP(165))
      CALL FFV2_3_3(W(1,3),W(1,41),GC_50,GC_58,MZ,WZ,W(1,45))
C     Amplitude(s) for diagram number 166
      CALL FFV2_0(W(1,6),W(1,36),W(1,45),GC_62,AMP(166))
      CALL FFV1P0_3(W(1,3),W(1,41),GC_1,ZERO,ZERO,W(1,43))
C     Amplitude(s) for diagram number 167
      CALL FFV1_0(W(1,38),W(1,5),W(1,43),GC_3,AMP(167))
C     Amplitude(s) for diagram number 168
      CALL FFV2_4_0(W(1,38),W(1,5),W(1,45),GC_50,GC_59,AMP(168))
      CALL FFV2_3_3(W(1,28),W(1,1),GC_50,GC_58,MZ,WZ,W(1,24))
C     Amplitude(s) for diagram number 169
      CALL FFV2_0(W(1,6),W(1,36),W(1,24),GC_62,AMP(169))
      CALL FFV1P0_3(W(1,28),W(1,1),GC_1,ZERO,ZERO,W(1,36))
C     Amplitude(s) for diagram number 170
      CALL FFV1_0(W(1,38),W(1,5),W(1,36),GC_3,AMP(170))
C     Amplitude(s) for diagram number 171
      CALL FFV2_4_0(W(1,38),W(1,5),W(1,24),GC_50,GC_59,AMP(171))
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,38))
C     Amplitude(s) for diagram number 172
      CALL FFV1_0(W(1,27),W(1,38),W(1,18),GC_11,AMP(172))
C     Amplitude(s) for diagram number 173
      CALL FFV2_0(W(1,37),W(1,38),W(1,19),GC_100,AMP(173))
C     Amplitude(s) for diagram number 174
      CALL FFV2_0(W(1,27),W(1,41),W(1,10),GC_100,AMP(174))
C     Amplitude(s) for diagram number 175
      CALL FFV1_0(W(1,2),W(1,41),W(1,20),GC_1,AMP(175))
C     Amplitude(s) for diagram number 176
      CALL FFV2_3_0(W(1,2),W(1,41),W(1,22),GC_50,GC_58,AMP(176))
C     Amplitude(s) for diagram number 177
      CALL FFV1_0(W(1,37),W(1,1),W(1,20),GC_1,AMP(177))
C     Amplitude(s) for diagram number 178
      CALL FFV2_3_0(W(1,37),W(1,1),W(1,22),GC_50,GC_58,AMP(178))
      CALL FFV2_3_3(W(1,2),W(1,41),GC_50,GC_58,MZ,WZ,W(1,22))
C     Amplitude(s) for diagram number 179
      CALL FFV2_0(W(1,6),W(1,12),W(1,22),GC_62,AMP(179))
      CALL FFV1P0_3(W(1,2),W(1,41),GC_1,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 180
      CALL FFV1_0(W(1,14),W(1,5),W(1,20),GC_3,AMP(180))
C     Amplitude(s) for diagram number 181
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,22),GC_50,GC_59,AMP(181))
      CALL FFV2_3_3(W(1,37),W(1,1),GC_50,GC_58,MZ,WZ,W(1,41))
C     Amplitude(s) for diagram number 182
      CALL FFV2_0(W(1,6),W(1,12),W(1,41),GC_62,AMP(182))
      CALL FFV1P0_3(W(1,37),W(1,1),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 183
      CALL FFV1_0(W(1,14),W(1,5),W(1,12),GC_3,AMP(183))
C     Amplitude(s) for diagram number 184
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,41),GC_50,GC_59,AMP(184))
      CALL FFV1_1(W(1,1),W(1,13),GC_1,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,3),W(1,14),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 185
      CALL FFV1_0(W(1,27),W(1,4),W(1,13),GC_11,AMP(185))
      CALL FFV1P0_3(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 186
      CALL FFV1_0(W(1,11),W(1,4),W(1,5),GC_11,AMP(186))
C     Amplitude(s) for diagram number 187
      CALL FFV1_0(W(1,3),W(1,16),W(1,5),GC_11,AMP(187))
C     Amplitude(s) for diagram number 188
      CALL FFV1_0(W(1,2),W(1,16),W(1,13),GC_11,AMP(188))
      CALL FFV1P0_3(W(1,31),W(1,1),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 189
      CALL FFV1_0(W(1,27),W(1,4),W(1,13),GC_11,AMP(189))
      CALL FFV1P0_3(W(1,8),W(1,1),GC_11,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 190
      CALL FFV1_0(W(1,11),W(1,4),W(1,31),GC_11,AMP(190))
C     Amplitude(s) for diagram number 191
      CALL FFV1_0(W(1,3),W(1,16),W(1,31),GC_11,AMP(191))
C     Amplitude(s) for diagram number 192
      CALL FFV1_0(W(1,2),W(1,16),W(1,13),GC_11,AMP(192))
C     Amplitude(s) for diagram number 193
      CALL FFV1_0(W(1,27),W(1,4),W(1,43),GC_2,AMP(193))
C     Amplitude(s) for diagram number 194
      CALL FFV2_5_0(W(1,27),W(1,4),W(1,45),GC_51,GC_58,AMP(194))
C     Amplitude(s) for diagram number 195
      CALL FFV1_0(W(1,11),W(1,4),W(1,20),GC_2,AMP(195))
C     Amplitude(s) for diagram number 196
      CALL FFV2_5_0(W(1,11),W(1,4),W(1,22),GC_51,GC_58,AMP(196))
C     Amplitude(s) for diagram number 197
      CALL FFV1_0(W(1,3),W(1,16),W(1,20),GC_1,AMP(197))
C     Amplitude(s) for diagram number 198
      CALL FFV2_3_0(W(1,3),W(1,16),W(1,22),GC_50,GC_58,AMP(198))
C     Amplitude(s) for diagram number 199
      CALL FFV1_0(W(1,2),W(1,16),W(1,43),GC_1,AMP(199))
C     Amplitude(s) for diagram number 200
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,45),GC_50,GC_58,AMP(200))
      CALL FFV2_3(W(1,27),W(1,1),GC_100,MW,WW,W(1,45))
C     Amplitude(s) for diagram number 201
      CALL FFV2_0(W(1,28),W(1,4),W(1,45),GC_100,AMP(201))
C     Amplitude(s) for diagram number 202
      CALL FFV1_0(W(1,27),W(1,4),W(1,36),GC_2,AMP(202))
C     Amplitude(s) for diagram number 203
      CALL FFV2_5_0(W(1,27),W(1,4),W(1,24),GC_51,GC_58,AMP(203))
C     Amplitude(s) for diagram number 204
      CALL FFV2_0(W(1,3),W(1,15),W(1,45),GC_100,AMP(204))
C     Amplitude(s) for diagram number 205
      CALL FFV1_0(W(1,11),W(1,4),W(1,12),GC_2,AMP(205))
C     Amplitude(s) for diagram number 206
      CALL FFV2_5_0(W(1,11),W(1,4),W(1,41),GC_51,GC_58,AMP(206))
      CALL FFV2_3(W(1,11),W(1,1),GC_100,MW,WW,W(1,45))
C     Amplitude(s) for diagram number 207
      CALL FFV2_0(W(1,37),W(1,4),W(1,45),GC_100,AMP(207))
C     Amplitude(s) for diagram number 208
      CALL FFV1_0(W(1,3),W(1,16),W(1,12),GC_1,AMP(208))
C     Amplitude(s) for diagram number 209
      CALL FFV2_3_0(W(1,3),W(1,16),W(1,41),GC_50,GC_58,AMP(209))
C     Amplitude(s) for diagram number 210
      CALL FFV2_0(W(1,2),W(1,15),W(1,45),GC_100,AMP(210))
C     Amplitude(s) for diagram number 211
      CALL FFV1_0(W(1,2),W(1,16),W(1,36),GC_1,AMP(211))
C     Amplitude(s) for diagram number 212
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,24),GC_50,GC_58,AMP(212))
      CALL FFV2_3_1(W(1,1),W(1,32),GC_50,GC_58,ZERO,ZERO,W(1,24))
      CALL FFV1P0_3(W(1,3),W(1,24),GC_11,ZERO,ZERO,W(1,32))
C     Amplitude(s) for diagram number 213
      CALL FFV1_0(W(1,27),W(1,4),W(1,32),GC_11,AMP(213))
      CALL FFV1P0_3(W(1,2),W(1,24),GC_11,ZERO,ZERO,W(1,36))
C     Amplitude(s) for diagram number 214
      CALL FFV1_0(W(1,11),W(1,4),W(1,36),GC_11,AMP(214))
C     Amplitude(s) for diagram number 215
      CALL FFV1_0(W(1,3),W(1,16),W(1,36),GC_11,AMP(215))
C     Amplitude(s) for diagram number 216
      CALL FFV1_0(W(1,2),W(1,16),W(1,32),GC_11,AMP(216))
      CALL FFV1P0_3(W(1,25),W(1,1),GC_11,ZERO,ZERO,W(1,32))
C     Amplitude(s) for diagram number 217
      CALL FFV1_0(W(1,27),W(1,4),W(1,32),GC_11,AMP(217))
      CALL FFV1P0_3(W(1,40),W(1,1),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 218
      CALL FFV1_0(W(1,11),W(1,4),W(1,27),GC_11,AMP(218))
C     Amplitude(s) for diagram number 219
      CALL FFV1_0(W(1,3),W(1,16),W(1,27),GC_11,AMP(219))
C     Amplitude(s) for diagram number 220
      CALL FFV1_0(W(1,2),W(1,16),W(1,32),GC_11,AMP(220))
     ...
     $ +1./3.*AMP(182)+1./3.*AMP(183)+1./3.*AMP(184)+AMP(185)
     $ +1./3.*AMP(186)+1./3.*AMP(187)+AMP(188)+AMP(189)+1./3.*AMP(190)
     $ +1./3.*AMP(191)+AMP(192)+1./3.*AMP(195)+1./3.*AMP(196)
     $ +1./3.*AMP(197)+1./3.*AMP(198)+1./3.*AMP(201)+1./3.*AMP(204)
     $ +1./3.*AMP(205)+1./3.*AMP(206)+1./3.*AMP(208)+1./3.*AMP(209)
     $ +AMP(213)+1./3.*AMP(214)+1./3.*AMP(215)+AMP(216)+AMP(217)
     $ +1./3.*AMP(218)+1./3.*AMP(219)+AMP(220))
     ...
     $ -AMP(77)-AMP(78)-AMP(79)-AMP(201)-AMP(204))
     ...
     $ -1./3.*AMP(169)-1./3.*AMP(170)-1./3.*AMP(171)-1./3.*AMP(185)
     $ -AMP(186)-AMP(187)-1./3.*AMP(188)-1./3.*AMP(189)-AMP(190)
     $ -AMP(191)-1./3.*AMP(192)-1./3.*AMP(193)-1./3.*AMP(194)
     $ -1./3.*AMP(199)-1./3.*AMP(200)-1./3.*AMP(202)-1./3.*AMP(203)
     $ -1./3.*AMP(207)-1./3.*AMP(210)-1./3.*AMP(211)-1./3.*AMP(212)
     $ -1./3.*AMP(213)-AMP(214)-AMP(215)-1./3.*AMP(216)-1./3.*AMP(217)
     $ -AMP(218)-AMP(219)-1./3.*AMP(220))
     ...
     $ +AMP(155)+AMP(156)+AMP(157)+AMP(158)+AMP(207)+AMP(210))
     ...
     $ +AMP(170)+AMP(171)+AMP(193)+AMP(194)+AMP(199)+AMP(200)+AMP(202)
     $ +AMP(203)+AMP(211)+AMP(212))
      JAMP(6)=+1./2.*(-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)
     $ -AMP(7)-AMP(8)-AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)
     $ -AMP(15)-AMP(22)-AMP(23)-AMP(24)-AMP(25)-AMP(26)-AMP(27)
     $ -AMP(28)-AMP(29)-AMP(172)-AMP(173)-AMP(174)-AMP(175)-AMP(176)
     $ -AMP(177)-AMP(178)-AMP(179)-AMP(180)-AMP(181)-AMP(182)-AMP(183)
     $ -AMP(184)-AMP(195)-AMP(196)-AMP(197)-AMP(198)-AMP(205)-AMP(206)
     $ -AMP(208)-AMP(209))
      P37_dxd_dxuemvexbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P37_dxd_dxuemvexbbx1=P37_dxd_dxuemvexbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
