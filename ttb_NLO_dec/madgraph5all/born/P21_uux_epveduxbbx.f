      SUBROUTINE SP21_uux_epveduxbbx1(P,ANS)
C     
...
C     
C     Process: u u~ > e+ ve d u~ b b~ QCD=2 QED=4 @21
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P21_uux_epveduxbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      COMMON/TO_AMPS_P21_uux_epveduxbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P21_uux_epveduxbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P21_uux_epveduxbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_51,GC_58,MZ,WZ,W(1,25))
...
C     Amplitude(s) for diagram number 79
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_100,MW,WW,W(1,25))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 94
      ...
      CALL FFV2_1(W(1,2),W(1,25),GC_100,ZERO,ZERO,W(1,41))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,11),W(1,41),W(1,30),GC_11,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV2_0(W(1,19),W(1,41),W(1,10),GC_100,AMP(96))
      CALL FFV1_1(W(1,2),W(1,30),GC_11,ZERO,ZERO,W(1,41))
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,6),W(1,41),W(1,38),GC_2,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFV2_5_0(W(1,6),W(1,41),W(1,42),GC_51,GC_58,AMP(98))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,19),W(1,2),W(1,38),GC_2,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,42),GC_51,GC_58,AMP(100))
C     Amplitude(s) for diagram number 101
      CALL FFV2_0(W(1,11),W(1,41),W(1,25),GC_100,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV2_5_0(W(1,6),W(1,41),W(1,20),GC_51,GC_58,AMP(102))
C     Amplitude(s) for diagram number 103
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,20),GC_51,GC_58,AMP(103))
C     Amplitude(s) for diagram number 104
      CALL FFV1_0(W(1,6),W(1,41),W(1,39),GC_2,AMP(104))
C     Amplitude(s) for diagram number 105
      CALL FFV2_5_0(W(1,6),W(1,41),W(1,40),GC_51,GC_58,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV1_0(W(1,19),W(1,2),W(1,39),GC_2,AMP(106))
C     Amplitude(s) for diagram number 107
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,40),GC_51,GC_58,AMP(107))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_2,ZERO,ZERO,W(1,40))
      CALL FFV2_2(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,39))
      CALL FFV1_1(W(1,7),W(1,40),GC_1,MB,ZERO,W(1,20))
      CALL FFV1P0_3(W(1,39),W(1,5),GC_11,ZERO,ZERO,W(1,25))
...
C     Amplitude(s) for diagram number 109
      ...
      CALL FFV1P0_3(W(1,1),W(1,12),GC_11,ZERO,ZERO,W(1,38))
...
C     Amplitude(s) for diagram number 111
      ...
      CALL FFV1_2(W(1,1),W(1,16),GC_11,ZERO,ZERO,W(1,42))
      CALL FFV2_3(W(1,42),W(1,5),GC_100,MW,WW,W(1,20))
C     Amplitude(s) for diagram number 112
      CALL FFV2_0(W(1,8),W(1,15),W(1,20),GC_100,AMP(112))
      CALL FFV1P0_3(W(1,39),W(1,5),GC_1,ZERO,ZERO,W(1,43))
C     Amplitude(s) for diagram number 113
      CALL FFV1_0(W(1,8),W(1,21),W(1,43),GC_1,AMP(113))
      CALL FFV2_3_3(W(1,39),W(1,5),GC_50,GC_58,MZ,WZ,W(1,44))
...
C     Amplitude(s) for diagram number 116
      ...
      CALL FFV1_1(W(1,5),W(1,16),GC_11,ZERO,ZERO,W(1,45))
      CALL FFV2_3(W(1,1),W(1,45),GC_100,MW,WW,W(1,46))
...
C     Amplitude(s) for diagram number 118
      ...
      CALL FFV2_5_3(W(1,1),W(1,12),GC_51,GC_58,MZ,WZ,W(1,47))
...
C     Amplitude(s) for diagram number 121
      ...
      CALL FFV2_5_3(W(1,6),W(1,2),GC_51,GC_58,MZ,WZ,W(1,18))
...
C     Amplitude(s) for diagram number 125
      ...
      CALL FFV1_2(W(1,1),W(1,40),GC_2,ZERO,ZERO,W(1,48))
C     Amplitude(s) for diagram number 126
      CALL FFV1_0(W(1,48),W(1,12),W(1,30),GC_11,AMP(126))
C     Amplitude(s) for diagram number 127
      CALL FFV2_0(W(1,48),W(1,28),W(1,10),GC_100,AMP(127))
      CALL FFV1_1(W(1,5),W(1,40),GC_1,ZERO,ZERO,W(1,48))
C     Amplitude(s) for diagram number 128
      CALL FFV1_0(W(1,39),W(1,48),W(1,30),GC_11,AMP(128))
C     Amplitude(s) for diagram number 129
      CALL FFV1_0(W(1,39),W(1,28),W(1,40),GC_1,AMP(129))
      CALL FFV1_2(W(1,1),W(1,30),GC_11,ZERO,ZERO,W(1,7))
      CALL VVV1_2(W(1,40),W(1,10),GC_4,MW,WW,W(1,21))
C     Amplitude(s) for diagram number 130
      CALL FFV2_0(W(1,7),W(1,5),W(1,21),GC_100,AMP(130))
C     Amplitude(s) for diagram number 131
      CALL FFV2_0(W(1,7),W(1,48),W(1,10),GC_100,AMP(131))
C     Amplitude(s) for diagram number 132
      CALL FFV1_0(W(1,7),W(1,12),W(1,40),GC_2,AMP(132))
C     Amplitude(s) for diagram number 133
      CALL FFV2_0(W(1,1),W(1,28),W(1,21),GC_100,AMP(133))
C     Amplitude(s) for diagram number 134
      CALL FFV1_0(W(1,42),W(1,12),W(1,22),GC_2,AMP(134))
C     Amplitude(s) for diagram number 135
      CALL FFV2_0(W(1,42),W(1,5),W(1,31),GC_100,AMP(135))
C     Amplitude(s) for diagram number 136
      CALL FFV2_0(W(1,42),W(1,33),W(1,10),GC_100,AMP(136))
C     Amplitude(s) for diagram number 137
      CALL FFV1_0(W(1,39),W(1,45),W(1,22),GC_1,AMP(137))
C     Amplitude(s) for diagram number 138
      CALL FFV1_0(W(1,39),W(1,33),W(1,16),GC_11,AMP(138))
      CALL FFV1_2(W(1,1),W(1,22),GC_2,ZERO,ZERO,W(1,33))
C     Amplitude(s) for diagram number 139
      CALL FFV2_0(W(1,33),W(1,45),W(1,10),GC_100,AMP(139))
C     Amplitude(s) for diagram number 140
      CALL FFV1_0(W(1,33),W(1,12),W(1,16),GC_11,AMP(140))
C     Amplitude(s) for diagram number 141
      CALL FFV2_0(W(1,1),W(1,45),W(1,31),GC_100,AMP(141))
C     Amplitude(s) for diagram number 142
      CALL FFV2_0(W(1,42),W(1,5),W(1,35),GC_100,AMP(142))
C     Amplitude(s) for diagram number 143
      CALL FFV2_0(W(1,1),W(1,45),W(1,35),GC_100,AMP(143))
C     Amplitude(s) for diagram number 144
      CALL FFV2_5_0(W(1,42),W(1,12),W(1,34),GC_51,GC_58,AMP(144))
C     Amplitude(s) for diagram number 145
      CALL FFV2_0(W(1,42),W(1,5),W(1,36),GC_100,AMP(145))
C     Amplitude(s) for diagram number 146
      CALL FFV2_0(W(1,42),W(1,13),W(1,10),GC_100,AMP(146))
C     Amplitude(s) for diagram number 147
      CALL FFV2_3_0(W(1,39),W(1,45),W(1,34),GC_50,GC_58,AMP(147))
C     Amplitude(s) for diagram number 148
      CALL FFV1_0(W(1,39),W(1,13),W(1,16),GC_11,AMP(148))
      CALL FFV2_5_2(W(1,1),W(1,34),GC_51,GC_58,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 149
      CALL FFV2_0(W(1,13),W(1,45),W(1,10),GC_100,AMP(149))
C     Amplitude(s) for diagram number 150
      CALL FFV1_0(W(1,13),W(1,12),W(1,16),GC_11,AMP(150))
C     Amplitude(s) for diagram number 151
      CALL FFV2_0(W(1,1),W(1,45),W(1,36),GC_100,AMP(151))
      CALL FFV2_5_2(W(1,1),W(1,18),GC_51,GC_58,ZERO,ZERO,W(1,45))
C     Amplitude(s) for diagram number 152
      CALL FFV1_0(W(1,45),W(1,12),W(1,30),GC_11,AMP(152))
C     Amplitude(s) for diagram number 153
      CALL FFV2_0(W(1,45),W(1,28),W(1,10),GC_100,AMP(153))
      CALL FFV2_3_1(W(1,5),W(1,18),GC_50,GC_58,ZERO,ZERO,W(1,45))
C     Amplitude(s) for diagram number 154
      CALL FFV1_0(W(1,39),W(1,45),W(1,30),GC_11,AMP(154))
C     Amplitude(s) for diagram number 155
      CALL FFV2_3_0(W(1,39),W(1,28),W(1,18),GC_50,GC_58,AMP(155))
      CALL VVV1_1(W(1,10),W(1,18),GC_53,MW,WW,W(1,36))
C     Amplitude(s) for diagram number 156
      CALL FFV2_0(W(1,7),W(1,5),W(1,36),GC_100,AMP(156))
C     Amplitude(s) for diagram number 157
      CALL FFV2_0(W(1,7),W(1,45),W(1,10),GC_100,AMP(157))
C     Amplitude(s) for diagram number 158
      CALL FFV2_5_0(W(1,7),W(1,12),W(1,18),GC_51,GC_58,AMP(158))
C     Amplitude(s) for diagram number 159
      CALL FFV2_0(W(1,1),W(1,28),W(1,36),GC_100,AMP(159))
      CALL FFV1_2(W(1,3),W(1,40),GC_3,ZERO,ZERO,W(1,36))
      CALL FFV2_3(W(1,7),W(1,5),GC_100,MW,WW,W(1,40))
C     Amplitude(s) for diagram number 160
      CALL FFV2_0(W(1,36),W(1,4),W(1,40),GC_100,AMP(160))
      CALL FFV2_3(W(1,1),W(1,28),GC_100,MW,WW,W(1,45))
...
C     Amplitude(s) for diagram number 171
      ...
      CALL FFV2_1(W(1,2),W(1,26),GC_100,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 172
      CALL FFV1_0(W(1,39),W(1,23),W(1,30),GC_11,AMP(172))
C     Amplitude(s) for diagram number 173
      CALL FFV2_0(W(1,39),W(1,41),W(1,26),GC_100,AMP(173))
C     Amplitude(s) for diagram number 174
      CALL FFV2_0(W(1,7),W(1,23),W(1,10),GC_100,AMP(174))
C     Amplitude(s) for diagram number 175
      CALL FFV1_0(W(1,7),W(1,2),W(1,27),GC_2,AMP(175))
C     Amplitude(s) for diagram number 176
      CALL FFV2_5_0(W(1,7),W(1,2),W(1,29),GC_51,GC_58,AMP(176))
C     Amplitude(s) for diagram number 177
      CALL FFV1_0(W(1,1),W(1,41),W(1,27),GC_2,AMP(177))
C     Amplitude(s) for diagram number 178
      CALL FFV2_5_0(W(1,1),W(1,41),W(1,29),GC_51,GC_58,AMP(178))
      CALL FFV1_1(W(1,2),W(1,22),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 179
      CALL FFV1_0(W(1,6),W(1,29),W(1,25),GC_11,AMP(179))
C     Amplitude(s) for diagram number 180
      CALL FFV1_0(W(1,32),W(1,2),W(1,25),GC_11,AMP(180))
      CALL FFV1P0_3(W(1,33),W(1,2),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 182
      ...
      CALL FFV1P0_3(W(1,1),W(1,29),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 183
      CALL FFV1_0(W(1,6),W(1,12),W(1,22),GC_11,AMP(183))
C     Amplitude(s) for diagram number 184
      CALL FFV1_0(W(1,6),W(1,29),W(1,38),GC_11,AMP(184))
C     Amplitude(s) for diagram number 185
      CALL FFV1_0(W(1,11),W(1,5),W(1,22),GC_11,AMP(185))
C     Amplitude(s) for diagram number 186
      CALL FFV1_0(W(1,32),W(1,2),W(1,38),GC_11,AMP(186))
C     Amplitude(s) for diagram number 187
      CALL FFV1_0(W(1,6),W(1,41),W(1,43),GC_2,AMP(187))
C     Amplitude(s) for diagram number 188
      CALL FFV2_5_0(W(1,6),W(1,41),W(1,44),GC_51,GC_58,AMP(188))
      CALL FFV2_3(W(1,39),W(1,2),GC_100,MW,WW,W(1,32))
C     Amplitude(s) for diagram number 189
      CALL FFV2_0(W(1,6),W(1,28),W(1,32),GC_100,AMP(189))
C     Amplitude(s) for diagram number 190
      CALL FFV2_0(W(1,19),W(1,5),W(1,32),GC_100,AMP(190))
C     Amplitude(s) for diagram number 191
      CALL FFV1_0(W(1,19),W(1,2),W(1,43),GC_2,AMP(191))
C     Amplitude(s) for diagram number 192
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,44),GC_51,GC_58,AMP(192))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_2,ZERO,ZERO,W(1,44))
C     Amplitude(s) for diagram number 193
      CALL FFV1_0(W(1,6),W(1,12),W(1,44),GC_2,AMP(193))
      CALL FFV2_5_3(W(1,7),W(1,2),GC_51,GC_58,MZ,WZ,W(1,43))
C     Amplitude(s) for diagram number 194
      CALL FFV2_5_0(W(1,6),W(1,12),W(1,43),GC_51,GC_58,AMP(194))
C     Amplitude(s) for diagram number 195
      CALL FFV1_0(W(1,11),W(1,5),W(1,44),GC_1,AMP(195))
C     Amplitude(s) for diagram number 196
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,43),GC_50,GC_58,AMP(196))
C     Amplitude(s) for diagram number 197
      CALL FFV2_0(W(1,11),W(1,2),W(1,40),GC_100,AMP(197))
      CALL FFV1P0_3(W(1,1),W(1,41),GC_2,ZERO,ZERO,W(1,40))
C     Amplitude(s) for diagram number 198
      CALL FFV1_0(W(1,6),W(1,12),W(1,40),GC_2,AMP(198))
      CALL FFV2_5_3(W(1,1),W(1,41),GC_51,GC_58,MZ,WZ,W(1,7))
...
C     Amplitude(s) for diagram number 200
      CALL FFV1_0(W(1,6),W(1,41),W(1,15),GC_2,AMP(200))
C     Amplitude(s) for diagram number 201
      CALL FFV2_5_0(W(1,6),W(1,41),W(1,47),GC_51,GC_58,AMP(201))
C     Amplitude(s) for diagram number 202
      CALL FFV1_0(W(1,11),W(1,5),W(1,40),GC_1,AMP(202))
C     Amplitude(s) for diagram number 203
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,7),GC_50,GC_58,AMP(203))
C     Amplitude(s) for diagram number 204
      CALL FFV1_0(W(1,19),W(1,2),W(1,15),GC_2,AMP(204))
C     Amplitude(s) for diagram number 205
      CALL FFV2_5_0(W(1,19),W(1,2),W(1,47),GC_51,GC_58,AMP(205))
C     Amplitude(s) for diagram number 206
      CALL FFV2_0(W(1,11),W(1,2),W(1,45),GC_100,AMP(206))
      CALL FFV2_5_1(W(1,2),W(1,34),GC_51,GC_58,ZERO,ZERO,W(1,45))
C     Amplitude(s) for diagram number 207
      CALL FFV1_0(W(1,6),W(1,45),W(1,25),GC_11,AMP(207))
C     Amplitude(s) for diagram number 208
      CALL FFV1_0(W(1,37),W(1,2),W(1,25),GC_11,AMP(208))
      CALL FFV1P0_3(W(1,13),W(1,2),GC_11,ZERO,ZERO,W(1,25))
...
C     Amplitude(s) for diagram number 210
      ...
      CALL FFV1P0_3(W(1,1),W(1,45),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 211
      CALL FFV1_0(W(1,6),W(1,12),W(1,25),GC_11,AMP(211))
C     Amplitude(s) for diagram number 212
      CALL FFV1_0(W(1,6),W(1,45),W(1,38),GC_11,AMP(212))
C     Amplitude(s) for diagram number 213
      CALL FFV1_0(W(1,11),W(1,5),W(1,25),GC_11,AMP(213))
C     Amplitude(s) for diagram number 214
      CALL FFV1_0(W(1,37),W(1,2),W(1,38),GC_11,AMP(214))
C     Amplitude(s) for diagram number 215
      CALL FFV2_0(W(1,14),W(1,4),W(1,43),GC_62,AMP(215))
C     Amplitude(s) for diagram number 216
      CALL FFV1_0(W(1,3),W(1,17),W(1,44),GC_3,AMP(216))
C     Amplitude(s) for diagram number 217
      CALL FFV2_4_0(W(1,3),W(1,17),W(1,43),GC_50,GC_59,AMP(217))
...
C     Amplitude(s) for diagram number 220
     ...
     $ -1./3.*AMP(183)-AMP(184)-1./3.*AMP(185)-AMP(186)-1./3.*AMP(189)
     $ -1./3.*AMP(190)-1./3.*AMP(193)-1./3.*AMP(194)-1./3.*AMP(195)
     $ -1./3.*AMP(196)-1./3.*AMP(198)-1./3.*AMP(199)-1./3.*AMP(202)
     $ -1./3.*AMP(203)-AMP(207)-AMP(208)-1./3.*AMP(209)-1./3.*AMP(210)
     $ -1./3.*AMP(211)-AMP(212)-1./3.*AMP(213)-AMP(214)-1./3.*AMP(215)
     ...
     $ +AMP(77)+AMP(78)+AMP(79)+AMP(189)+AMP(190))
     ...
     $ +1./3.*AMP(180)+AMP(181)+AMP(182)+AMP(183)+1./3.*AMP(184)
     $ +AMP(185)+1./3.*AMP(186)+1./3.*AMP(187)+1./3.*AMP(188)
     $ +1./3.*AMP(191)+1./3.*AMP(192)+1./3.*AMP(197)+1./3.*AMP(200)
     $ +1./3.*AMP(201)+1./3.*AMP(204)+1./3.*AMP(205)+1./3.*AMP(206)
     $ +1./3.*AMP(207)+1./3.*AMP(208)+AMP(209)+AMP(210)+AMP(211)
     $ +1./3.*AMP(212)+AMP(213)+1./3.*AMP(214))
      JAMP(4)=+1./2.*(-AMP(108)-AMP(109)-AMP(110)-AMP(111)-AMP(122)
     ...
     $ -AMP(168)-AMP(169)-AMP(170)-AMP(171)-AMP(197)-AMP(206))
     ...
     $ -AMP(120)-AMP(121)-AMP(187)-AMP(188)-AMP(191)-AMP(192)-AMP(200)
     $ -AMP(201)-AMP(204)-AMP(205))
     ...
     $ +AMP(176)+AMP(177)+AMP(178)+AMP(193)+AMP(194)+AMP(195)+AMP(196)
     $ +AMP(198)+AMP(199)+AMP(202)+AMP(203)+AMP(215)+AMP(216)+AMP(217)
     $ +AMP(218)+AMP(219)+AMP(220))
      P21_uux_epveduxbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P21_uux_epveduxbbx1=P21_uux_epveduxbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
