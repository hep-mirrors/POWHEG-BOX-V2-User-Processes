      SUBROUTINE SP371_dxd_sxcemvexbbx1(P,ANS)
C     
...
C     
C     Process: d~ d > s~ c e- ve~ b b~ QCD=2 QED=4 @371
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P371_dxd_sxcemvexbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      INTEGER ISHEL(2)
      REAL*8 T,P371_dxd_sxcemvexbbx1
...
C     
      ...
      COMMON/TO_AMPS_P371_dxd_sxcemvexbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P371_dxd_sxcemvexbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P371_dxd_sxcemvexbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 79
      ...
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 81
      CALL FFV2_0(W(1,25),W(1,17),W(1,19),GC_100,AMP(81))
      CALL FFV1_1(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 82
      CALL FFV2_0(W(1,27),W(1,17),W(1,10),GC_100,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,2),W(1,17),W(1,20),GC_1,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,2),W(1,17),W(1,22),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,25),W(1,1),W(1,20),GC_1,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,25),W(1,1),W(1,22),GC_50,GC_58,AMP(86))
      CALL FFV2_3_3(W(1,2),W(1,17),GC_50,GC_58,MZ,WZ,W(1,22))
C     Amplitude(s) for diagram number 87
      CALL FFV2_0(W(1,6),W(1,12),W(1,22),GC_62,AMP(87))
      CALL FFV1P0_3(W(1,2),W(1,17),GC_1,ZERO,ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 89
      ...
      CALL FFV2_3_3(W(1,25),W(1,1),GC_50,GC_58,MZ,WZ,W(1,17))
C     Amplitude(s) for diagram number 90
      CALL FFV2_0(W(1,6),W(1,12),W(1,17),GC_62,AMP(90))
      CALL FFV1P0_3(W(1,25),W(1,1),GC_1,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 94
      ...
      CALL FFV1_2(W(1,2),W(1,13),GC_1,ZERO,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 100
      ...
      CALL FFV2_3(W(1,27),W(1,1),GC_100,MW,WW,W(1,22))
...
C     Amplitude(s) for diagram number 106
      ...
      CALL FFV2_3_1(W(1,1),W(1,28),GC_50,GC_58,ZERO,ZERO,W(1,17))
      CALL FFV1P0_3(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 108
      ...
      CALL FFV2_3_2(W(1,2),W(1,28),GC_50,GC_58,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 110
     ...
     $ -AMP(105)-AMP(106))
      P371_dxd_sxcemvexbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P371_dxd_sxcemvexbbx1=P371_dxd_sxcemvexbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
