      SUBROUTINE SP15_ddx_epvemmvmxbbx1(P,ANS)
C     
...
C     
C     Process: d d~ > e+ ve mu- vm~ b b~ QCD=2 QED=4 @15
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P15_ddx_epvemmvmxbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      INTEGER ISHEL(2)
      REAL*8 T,P15_ddx_epvemmvmxbbx1
...
C     
      ...
      COMMON/TO_AMPS_P15_ddx_epvemmvmxbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P15_ddx_epvemmvmxbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P15_ddx_epvemmvmxbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV2_2(W(1,1),W(1,19),GC_100,ZERO,ZERO,W(1,8))
      CALL FFV2_1(W(1,2),W(1,10),GC_100,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,8),W(1,7),W(1,17),GC_11,AMP(22))
      CALL FFV1_1(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,8),W(1,18),W(1,10),GC_100,AMP(23))
      CALL FFV1_2(W(1,1),W(1,17),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,8),W(1,7),W(1,19),GC_100,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,8),W(1,2),W(1,20),GC_1,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,8),W(1,2),W(1,22),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,1),W(1,18),W(1,20),GC_1,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,1),W(1,18),W(1,22),GC_50,GC_58,AMP(28))
      CALL FFV2_3_3(W(1,8),W(1,2),GC_50,GC_58,MZ,WZ,W(1,22))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,6),W(1,12),W(1,22),GC_62,AMP(29))
      CALL FFV1P0_3(W(1,8),W(1,2),GC_1,ZERO,ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV2_3_3(W(1,1),W(1,18),GC_50,GC_58,MZ,WZ,W(1,8))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,6),W(1,12),W(1,8),GC_62,AMP(32))
      CALL FFV1P0_3(W(1,1),W(1,18),GC_1,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 40
     ...
     $ +AMP(36)+AMP(37)+AMP(38)+AMP(39)+AMP(40))
      P15_ddx_epvemmvmxbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P15_ddx_epvemmvmxbbx1=P15_ddx_epvemmvmxbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
