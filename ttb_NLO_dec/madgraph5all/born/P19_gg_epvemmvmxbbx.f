      SUBROUTINE SP19_gg_epvemmvmxbbx1(P,ANS)
C     
...
C     
C     Process: g g > e+ ve mu- vm~ b b~ QCD=2 QED=4 @19
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P19_gg_epvemmvmxbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
      PARAMETER (NGRAPHS=87)
      INTEGER    NDIAGS
      PARAMETER (NDIAGS=87)
      INTEGER    THEL
...
C     
      ...
      COMMON/TO_AMPS_P19_gg_epvemmvmxbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P19_gg_epvemmvmxbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P19_gg_epvemmvmxbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_2(W(1,3),W(1,19),GC_100,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,9),W(1,4),W(1,13),GC_62,AMP(16))
      CALL FFV2_1(W(1,4),W(1,19),GC_100,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,3),W(1,16),W(1,15),GC_3,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,13),GC_50,GC_59,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,9),W(1,4),W(1,17),GC_62,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,3),W(1,16),W(1,18),GC_3,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,17),GC_50,GC_59,AMP(21))
...
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,6),W(1,12),W(1,13),GC_62,AMP(22))
      CALL FFV1P0_3(W(1,18),W(1,17),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,14),W(1,5),W(1,15),GC_3,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,13),GC_50,GC_59,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,15),W(1,19),W(1,10),GC_4,AMP(25))
      CALL FFS4_3(W(1,18),W(1,17),GC_83,MH,WH,W(1,24))
C     Amplitude(s) for diagram number 26
      CALL VVS1_0(W(1,19),W(1,10),W(1,24),GC_72,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL VVV1_0(W(1,19),W(1,10),W(1,13),GC_53,AMP(27))
      CALL FFV2_1(W(1,17),W(1,10),GC_100,MT,WT,W(1,24))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,18),W(1,24),W(1,19),GC_100,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,9),W(1,4),W(1,13),GC_62,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,3),W(1,16),W(1,15),GC_3,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,13),GC_50,GC_59,AMP(31))
...
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,6),W(1,12),W(1,17),GC_62,AMP(32))
      CALL FFV1P0_3(W(1,8),W(1,13),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,14),W(1,5),W(1,15),GC_3,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,17),GC_50,GC_59,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,8),W(1,13),W(1,20),GC_1,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFS4_0(W(1,8),W(1,13),W(1,21),GC_83,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,8),W(1,13),W(1,22),GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,23),W(1,13),W(1,10),GC_100,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,23),W(1,24),W(1,2),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_0(W(1,9),W(1,4),W(1,17),GC_62,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,3),W(1,16),W(1,15),GC_3,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,17),GC_50,GC_59,AMP(42))
      CALL FFV1_2(W(1,8),W(1,1),GC_11,MB,ZERO,W(1,17))
      CALL FFV1_1(W(1,7),W(1,2),GC_11,MB,ZERO,W(1,15))
      CALL FFV2_3_3(W(1,17),W(1,15),GC_50,GC_58,MZ,WZ,W(1,24))
C     Amplitude(s) for diagram number 43
      CALL FFV2_0(W(1,6),W(1,12),W(1,24),GC_62,AMP(43))
      CALL FFV1P0_3(W(1,17),W(1,15),GC_1,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,14),W(1,5),W(1,13),GC_3,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,24),GC_50,GC_59,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL VVV1_0(W(1,13),W(1,19),W(1,10),GC_4,AMP(46))
      CALL FFS4_3(W(1,17),W(1,15),GC_83,MH,WH,W(1,25))
C     Amplitude(s) for diagram number 47
      CALL VVS1_0(W(1,19),W(1,10),W(1,25),GC_72,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL VVV1_0(W(1,19),W(1,10),W(1,24),GC_53,AMP(48))
      CALL FFV2_2(W(1,17),W(1,19),GC_100,MT,WT,W(1,25))
C     Amplitude(s) for diagram number 49
      CALL FFV2_0(W(1,25),W(1,15),W(1,10),GC_100,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,9),W(1,4),W(1,24),GC_62,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,3),W(1,16),W(1,13),GC_3,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,24),GC_50,GC_59,AMP(52))
      CALL FFV1_2(W(1,17),W(1,2),GC_11,MB,ZERO,W(1,24))
      CALL FFV2_3_3(W(1,24),W(1,7),GC_50,GC_58,MZ,WZ,W(1,17))
C     Amplitude(s) for diagram number 53
      CALL FFV2_0(W(1,6),W(1,12),W(1,17),GC_62,AMP(53))
      CALL FFV1P0_3(W(1,24),W(1,7),GC_1,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,14),W(1,5),W(1,13),GC_3,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,17),GC_50,GC_59,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,24),W(1,7),W(1,20),GC_1,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS4_0(W(1,24),W(1,7),W(1,21),GC_83,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV2_3_0(W(1,24),W(1,7),W(1,22),GC_50,GC_58,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV2_0(W(1,24),W(1,11),W(1,19),GC_100,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,25),W(1,11),W(1,2),GC_11,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_0(W(1,9),W(1,4),W(1,17),GC_62,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,3),W(1,16),W(1,13),GC_3,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,17),GC_50,GC_59,AMP(63))
      CALL FFV1_1(W(1,15),W(1,1),GC_11,MB,ZERO,W(1,17))
      CALL FFV2_3_3(W(1,8),W(1,17),GC_50,GC_58,MZ,WZ,W(1,13))
C     Amplitude(s) for diagram number 64
      CALL FFV2_0(W(1,6),W(1,12),W(1,13),GC_62,AMP(64))
      CALL FFV1P0_3(W(1,8),W(1,17),GC_1,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,14),W(1,5),W(1,25),GC_3,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,13),GC_50,GC_59,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,8),W(1,17),W(1,20),GC_1,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFS4_0(W(1,8),W(1,17),W(1,21),GC_83,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV2_3_0(W(1,8),W(1,17),W(1,22),GC_50,GC_58,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV2_0(W(1,23),W(1,17),W(1,10),GC_100,AMP(70))
      CALL FFV2_1(W(1,15),W(1,10),GC_100,MT,WT,W(1,17))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,23),W(1,17),W(1,1),GC_11,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV2_0(W(1,9),W(1,4),W(1,13),GC_62,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,3),W(1,16),W(1,25),GC_3,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,13),GC_50,GC_59,AMP(74))
      CALL FFV1_2(W(1,18),W(1,1),GC_11,MB,ZERO,W(1,13))
      CALL FFV2_3_3(W(1,13),W(1,7),GC_50,GC_58,MZ,WZ,W(1,25))
C     Amplitude(s) for diagram number 75
      CALL FFV2_0(W(1,6),W(1,12),W(1,25),GC_62,AMP(75))
      CALL FFV1P0_3(W(1,13),W(1,7),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,14),W(1,5),W(1,12),GC_3,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,25),GC_50,GC_59,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,13),W(1,7),W(1,20),GC_1,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFS4_0(W(1,13),W(1,7),W(1,21),GC_83,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_3_0(W(1,13),W(1,7),W(1,22),GC_50,GC_58,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_0(W(1,13),W(1,11),W(1,19),GC_100,AMP(81))
      CALL FFV2_2(W(1,18),W(1,19),GC_100,MT,WT,W(1,13))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,13),W(1,11),W(1,1),GC_11,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV2_0(W(1,9),W(1,4),W(1,25),GC_62,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,3),W(1,16),W(1,12),GC_3,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,25),GC_50,GC_59,AMP(85))
      CALL FFV1_1(W(1,11),W(1,1),GC_11,MT,WT,W(1,25))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,23),W(1,25),W(1,2),GC_11,AMP(86))
      CALL FFV1_2(W(1,23),W(1,1),GC_11,MT,WT,W(1,25))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,25),W(1,11),W(1,2),GC_11,AMP(87))
     ...
     $ +AMP(82)+AMP(83)+AMP(84)+AMP(85)+AMP(86)
     ...
     $ +AMP(71)+AMP(72)+AMP(73)+AMP(74)+AMP(87)
      P19_gg_epvemmvmxbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P19_gg_epvemmvmxbbx1=P19_gg_epvemmvmxbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
