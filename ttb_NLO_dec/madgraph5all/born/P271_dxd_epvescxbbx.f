      SUBROUTINE SP271_dxd_epvescxbbx1(P,ANS)
C     
...
C     
C     Process: d~ d > e+ ve s c~ b b~ QCD=2 QED=4 @271
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P271_dxd_epvescxbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      COMMON/TO_AMPS_P271_dxd_epvescxbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P271_dxd_epvescxbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P271_dxd_epvescxbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 79
      ...
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,25))
      CALL FFV2_2(W(1,2),W(1,26),GC_100,ZERO,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 81
      CALL FFV2_0(W(1,24),W(1,25),W(1,26),GC_100,AMP(81))
      CALL FFV1_1(W(1,1),W(1,30),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 82
      CALL FFV2_0(W(1,18),W(1,26),W(1,10),GC_100,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,2),W(1,26),W(1,27),GC_1,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,2),W(1,26),W(1,29),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,24),W(1,1),W(1,27),GC_1,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,24),W(1,1),W(1,29),GC_50,GC_58,AMP(86))
      CALL FFV1_1(W(1,1),W(1,15),GC_1,ZERO,ZERO,W(1,29))
...
C     Amplitude(s) for diagram number 88
      ...
      CALL FFV1_2(W(1,2),W(1,15),GC_1,ZERO,ZERO,W(1,27))
...
C     Amplitude(s) for diagram number 90
      ...
      CALL FFV2_3(W(1,2),W(1,25),GC_100,MW,WW,W(1,15))
C     Amplitude(s) for diagram number 91
      CALL FFV2_0(W(1,6),W(1,22),W(1,15),GC_100,AMP(91))
C     Amplitude(s) for diagram number 92
      CALL FFV2_0(W(1,28),W(1,5),W(1,15),GC_100,AMP(92))
      CALL FFV1P0_3(W(1,2),W(1,26),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,6),W(1,12),W(1,15),GC_2,AMP(93))
      CALL FFV2_3_3(W(1,2),W(1,26),GC_50,GC_58,MZ,WZ,W(1,28))
C     Amplitude(s) for diagram number 94
      CALL FFV2_5_0(W(1,6),W(1,12),W(1,28),GC_51,GC_58,AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,11),W(1,5),W(1,15),GC_1,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,28),GC_50,GC_58,AMP(96))
      CALL FFV1P0_3(W(1,24),W(1,1),GC_1,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,6),W(1,12),W(1,26),GC_2,AMP(97))
      CALL FFV2_3_3(W(1,24),W(1,1),GC_50,GC_58,MZ,WZ,W(1,22))
C     Amplitude(s) for diagram number 98
      CALL FFV2_5_0(W(1,6),W(1,12),W(1,22),GC_51,GC_58,AMP(98))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,11),W(1,5),W(1,26),GC_1,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,22),GC_50,GC_58,AMP(100))
      CALL FFV2_3_1(W(1,1),W(1,31),GC_50,GC_58,ZERO,ZERO,W(1,24))
      CALL FFV1P0_3(W(1,2),W(1,24),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 101
      CALL FFV1_0(W(1,6),W(1,12),W(1,25),GC_11,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV1_0(W(1,11),W(1,5),W(1,25),GC_11,AMP(102))
      CALL FFV2_3_2(W(1,2),W(1,31),GC_50,GC_58,ZERO,ZERO,W(1,25))
      CALL FFV1P0_3(W(1,25),W(1,1),GC_11,ZERO,ZERO,W(1,31))
...
C     Amplitude(s) for diagram number 105
      CALL FFV2_0(W(1,8),W(1,4),W(1,28),GC_62,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV1_0(W(1,3),W(1,14),W(1,15),GC_3,AMP(106))
C     Amplitude(s) for diagram number 107
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,28),GC_50,GC_59,AMP(107))
C     Amplitude(s) for diagram number 108
      CALL FFV2_0(W(1,8),W(1,4),W(1,22),GC_62,AMP(108))
C     Amplitude(s) for diagram number 109
      CALL FFV1_0(W(1,3),W(1,14),W(1,26),GC_3,AMP(109))
C     Amplitude(s) for diagram number 110
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,22),GC_50,GC_59,AMP(110))
     ...
     $ -AMP(77)-AMP(78)-AMP(79)-AMP(91)-AMP(92))
     ...
     $ -AMP(84)-AMP(85)-AMP(86)-AMP(93)-AMP(94)-AMP(95)-AMP(96)
     $ -AMP(97)-AMP(98)-AMP(99)-AMP(100)-AMP(105)-AMP(106)-AMP(107)
     $ -AMP(108)-AMP(109)-AMP(110))
      P271_dxd_epvescxbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P271_dxd_epvescxbbx1=P271_dxd_epvescxbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
