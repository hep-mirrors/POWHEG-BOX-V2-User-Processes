      SUBROUTINE SP5_ddx_epveemvexbbx1(P,ANS)
C     
...
C     
C     Process: d d~ > e+ ve e- ve~ b b~ QCD=2 QED=4 @5
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P5_ddx_epveemvexbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
      PARAMETER (NGRAPHS=106)
      INTEGER    NDIAGS
      PARAMETER (NDIAGS=106)
      INTEGER    THEL
...
C     
      ...
      COMMON/TO_AMPS_P5_ddx_epveemvexbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P5_ddx_epveemvexbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P5_ddx_epveemvexbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV2_4_3(W(1,3),W(1,5),GC_50,GC_59,MZ,WZ,W(1,21))
      CALL FFV2_1(W(1,4),W(1,21),GC_62,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,6),W(1,23),W(1,13),GC_62,AMP(16))
      CALL FFV2_2(W(1,6),W(1,21),GC_62,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,24),W(1,4),W(1,13),GC_62,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,6),W(1,23),W(1,17),GC_62,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,24),W(1,4),W(1,17),GC_62,AMP(19))
      CALL FFV1P0_3(W(1,3),W(1,5),GC_3,ZERO,ZERO,W(1,25))
      CALL FFV2_3(W(1,6),W(1,4),GC_62,MZ,WZ,W(1,26))
      CALL FFV1_2(W(1,8),W(1,25),GC_1,MB,ZERO,W(1,27))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,27),W(1,11),W(1,26),GC_50,GC_58,AMP(20))
      CALL FFV2_3_2(W(1,8),W(1,26),GC_50,GC_58,MB,ZERO,W(1,28))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,28),W(1,11),W(1,25),GC_1,AMP(21))
      CALL FFV1_1(W(1,7),W(1,25),GC_1,MB,ZERO,W(1,29))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,16),W(1,29),W(1,26),GC_50,GC_58,AMP(22))
      CALL FFV2_3_1(W(1,7),W(1,26),GC_50,GC_58,MB,ZERO,W(1,30))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,16),W(1,30),W(1,25),GC_1,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,28),W(1,29),W(1,9),GC_11,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,27),W(1,30),W(1,9),GC_11,AMP(25))
      CALL VVS1_3(W(1,21),W(1,26),GC_81,MH,WH,W(1,31))
C     Amplitude(s) for diagram number 26
      CALL FFS4_0(W(1,8),W(1,11),W(1,31),GC_83,AMP(26))
      CALL FFV2_3_2(W(1,8),W(1,21),GC_50,GC_58,MB,ZERO,W(1,32))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,32),W(1,11),W(1,26),GC_50,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,28),W(1,11),W(1,21),GC_50,GC_58,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFS4_0(W(1,16),W(1,7),W(1,31),GC_83,AMP(29))
      CALL FFV2_3_1(W(1,7),W(1,21),GC_50,GC_58,MB,ZERO,W(1,31))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,16),W(1,31),W(1,26),GC_50,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_3_0(W(1,16),W(1,30),W(1,21),GC_50,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,28),W(1,31),W(1,9),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,32),W(1,30),W(1,9),GC_11,AMP(33))
      CALL FFV2_4_2(W(1,3),W(1,26),GC_50,GC_59,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 35
      ...
      CALL FFV2_4_1(W(1,5),W(1,26),GC_50,GC_59,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 42
      CALL FFV2_0(W(1,11),W(1,4),W(1,13),GC_62,AMP(42))
      CALL FFV2_1(W(1,4),W(1,19),GC_100,ZERO,ZERO,W(1,33))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,3),W(1,33),W(1,15),GC_3,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV2_4_0(W(1,3),W(1,33),W(1,13),GC_50,GC_59,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_0(W(1,11),W(1,4),W(1,17),GC_62,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,3),W(1,33),W(1,18),GC_3,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_4_0(W(1,3),W(1,33),W(1,17),GC_50,GC_59,AMP(47))
      CALL FFV1P0_3(W(1,8),W(1,7),GC_11,ZERO,ZERO,W(1,17))
      CALL FFV2_2(W(1,1),W(1,19),GC_100,ZERO,ZERO,W(1,18))
      CALL FFV2_1(W(1,2),W(1,10),GC_100,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,18),W(1,13),W(1,17),GC_11,AMP(48))
      CALL FFV1_1(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 49
      CALL FFV2_0(W(1,18),W(1,15),W(1,10),GC_100,AMP(49))
      CALL FFV1_2(W(1,1),W(1,17),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,18),W(1,13),W(1,19),GC_100,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,18),W(1,2),W(1,20),GC_1,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_3_0(W(1,18),W(1,2),W(1,22),GC_50,GC_58,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,1),W(1,15),W(1,20),GC_1,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_3_0(W(1,1),W(1,15),W(1,22),GC_50,GC_58,AMP(54))
      CALL FFV2_3_3(W(1,18),W(1,2),GC_50,GC_58,MZ,WZ,W(1,22))
C     Amplitude(s) for diagram number 55
      CALL FFV2_0(W(1,6),W(1,12),W(1,22),GC_62,AMP(55))
      CALL FFV1P0_3(W(1,18),W(1,2),GC_1,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,14),W(1,5),W(1,20),GC_3,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,22),GC_50,GC_59,AMP(57))
      CALL FFV2_3_3(W(1,1),W(1,15),GC_50,GC_58,MZ,WZ,W(1,13))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,6),W(1,12),W(1,13),GC_62,AMP(58))
      CALL FFV1P0_3(W(1,1),W(1,15),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,14),W(1,5),W(1,12),GC_3,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV2_4_0(W(1,14),W(1,5),W(1,13),GC_50,GC_59,AMP(60))
      CALL FFV1_2(W(1,1),W(1,25),GC_1,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,14),W(1,2),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,8),W(1,30),W(1,19),GC_11,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,28),W(1,7),W(1,19),GC_11,AMP(62))
      CALL FFV2_3_2(W(1,1),W(1,26),GC_50,GC_58,ZERO,ZERO,W(1,19))
      CALL FFV1P0_3(W(1,19),W(1,2),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,8),W(1,29),W(1,10),GC_11,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,27),W(1,7),W(1,10),GC_11,AMP(64))
      CALL FFV1_1(W(1,2),W(1,25),GC_1,ZERO,ZERO,W(1,34))
      CALL FFV1P0_3(W(1,1),W(1,34),GC_11,ZERO,ZERO,W(1,35))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,8),W(1,30),W(1,35),GC_11,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,28),W(1,7),W(1,35),GC_11,AMP(66))
      CALL FFV2_3_1(W(1,2),W(1,26),GC_50,GC_58,ZERO,ZERO,W(1,35))
      CALL FFV1P0_3(W(1,1),W(1,35),GC_11,ZERO,ZERO,W(1,36))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,8),W(1,29),W(1,36),GC_11,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV1_0(W(1,27),W(1,7),W(1,36),GC_11,AMP(68))
      CALL FFV2_3_2(W(1,1),W(1,21),GC_50,GC_58,ZERO,ZERO,W(1,27))
      CALL FFV1P0_3(W(1,27),W(1,2),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 69
      CALL FFV1_0(W(1,8),W(1,30),W(1,29),GC_11,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,28),W(1,7),W(1,29),GC_11,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,8),W(1,31),W(1,10),GC_11,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,32),W(1,7),W(1,10),GC_11,AMP(72))
      CALL FFV2_3_1(W(1,2),W(1,21),GC_50,GC_58,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,8),W(1,30),W(1,2),GC_11,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,28),W(1,7),W(1,2),GC_11,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV1_0(W(1,8),W(1,31),W(1,36),GC_11,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,32),W(1,7),W(1,36),GC_11,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,14),W(1,35),W(1,17),GC_11,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV2_3_0(W(1,14),W(1,15),W(1,26),GC_50,GC_58,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,19),W(1,34),W(1,17),GC_11,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,19),W(1,15),W(1,25),GC_1,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_3_0(W(1,18),W(1,34),W(1,26),GC_50,GC_58,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,18),W(1,35),W(1,25),GC_1,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,27),W(1,35),W(1,17),GC_11,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,27),W(1,15),W(1,26),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,19),W(1,10),W(1,17),GC_11,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,19),W(1,15),W(1,21),GC_50,GC_58,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV2_3_0(W(1,18),W(1,10),W(1,26),GC_50,GC_58,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV2_3_0(W(1,18),W(1,35),W(1,21),GC_50,GC_58,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV2_0(W(1,6),W(1,23),W(1,22),GC_62,AMP(89))
C     Amplitude(s) for diagram number 90
      CALL FFV2_0(W(1,24),W(1,4),W(1,22),GC_62,AMP(90))
C     Amplitude(s) for diagram number 91
      CALL FFV2_0(W(1,6),W(1,23),W(1,13),GC_62,AMP(91))
C     Amplitude(s) for diagram number 92
      CALL FFV2_0(W(1,24),W(1,4),W(1,13),GC_62,AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,9),W(1,5),W(1,20),GC_3,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFV2_4_0(W(1,9),W(1,5),W(1,22),GC_50,GC_59,AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,3),W(1,16),W(1,20),GC_3,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,22),GC_50,GC_59,AMP(96))
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,9),W(1,5),W(1,12),GC_3,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFV2_4_0(W(1,9),W(1,5),W(1,13),GC_50,GC_59,AMP(98))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,3),W(1,16),W(1,12),GC_3,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFV2_4_0(W(1,3),W(1,16),W(1,13),GC_50,GC_59,AMP(100))
C     Amplitude(s) for diagram number 101
      CALL FFV2_0(W(1,11),W(1,4),W(1,22),GC_62,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV1_0(W(1,3),W(1,33),W(1,20),GC_3,AMP(102))
C     Amplitude(s) for diagram number 103
      CALL FFV2_4_0(W(1,3),W(1,33),W(1,22),GC_50,GC_59,AMP(103))
C     Amplitude(s) for diagram number 104
      CALL FFV2_0(W(1,11),W(1,4),W(1,13),GC_62,AMP(104))
C     Amplitude(s) for diagram number 105
      CALL FFV1_0(W(1,3),W(1,33),W(1,12),GC_3,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV2_4_0(W(1,3),W(1,33),W(1,13),GC_50,GC_59,AMP(106))
     ...
     $ +AMP(106))
      P5_ddx_epveemvexbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P5_ddx_epveemvexbbx1=P5_ddx_epveemvexbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
