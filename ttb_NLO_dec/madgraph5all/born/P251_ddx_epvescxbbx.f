      SUBROUTINE SP251_ddx_epvescxbbx1(P,ANS)
C     
...
C     
C     Process: d d~ > e+ ve s c~ b b~ QCD=2 QED=4 @251
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P251_ddx_epvescxbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      COMMON/TO_AMPS_P251_ddx_epvescxbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P251_ddx_epvescxbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P251_ddx_epvescxbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     
      ...
      PARAMETER (NWAVEFUNCS=31, NCOLOR=4)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     Amplitude(s) for diagram number 27
      ...
      CALL VVV1_2(W(1,9),W(1,10),GC_4,MW,WW,W(1,15))
      CALL FFV1_1(W(1,5),W(1,30),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,6),W(1,22),W(1,15),GC_100,AMP(28))
      CALL FFV1_2(W(1,6),W(1,30),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,28),W(1,5),W(1,15),GC_100,AMP(29))
      CALL FFV1_1(W(1,5),W(1,9),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,11),W(1,15),W(1,30),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,28),W(1,15),W(1,10),GC_100,AMP(31))
      CALL FFV1_2(W(1,6),W(1,9),GC_2,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,15),W(1,12),W(1,30),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_0(W(1,15),W(1,22),W(1,10),GC_100,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,28),W(1,12),W(1,9),GC_2,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,11),W(1,22),W(1,9),GC_1,AMP(35))
      CALL FFV1P0_3(W(1,8),W(1,7),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,11),W(1,13),W(1,15),GC_1,AMP(36))
      CALL VVV1_2(W(1,15),W(1,10),GC_4,MW,WW,W(1,19))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,6),W(1,13),W(1,19),GC_100,AMP(37))
      CALL FFV1_2(W(1,6),W(1,15),GC_2,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,31),W(1,13),W(1,10),GC_100,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,17),W(1,12),W(1,15),GC_2,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_0(W(1,17),W(1,5),W(1,19),GC_100,AMP(40))
      CALL FFV1_1(W(1,5),W(1,15),GC_1,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 41
      CALL FFV2_0(W(1,17),W(1,19),W(1,10),GC_100,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,31),W(1,12),W(1,14),GC_11,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,11),W(1,19),W(1,14),GC_11,AMP(43))
      CALL FFS4_3(W(1,8),W(1,7),GC_83,MH,WH,W(1,19))
      CALL VVS1_1(W(1,10),W(1,19),GC_72,MW,WW,W(1,31))
C     Amplitude(s) for diagram number 44
      CALL FFV2_0(W(1,6),W(1,13),W(1,31),GC_100,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_0(W(1,17),W(1,5),W(1,31),GC_100,AMP(45))
      CALL FFV2_3_3(W(1,8),W(1,7),GC_50,GC_58,MZ,WZ,W(1,31))
C     Amplitude(s) for diagram number 46
      CALL FFV2_3_0(W(1,11),W(1,13),W(1,31),GC_50,GC_58,AMP(46))
      CALL VVV1_1(W(1,10),W(1,31),GC_53,MW,WW,W(1,8))
C     Amplitude(s) for diagram number 47
      CALL FFV2_0(W(1,6),W(1,13),W(1,8),GC_100,AMP(47))
      CALL FFV2_5_2(W(1,6),W(1,31),GC_51,GC_58,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 48
      CALL FFV2_0(W(1,7),W(1,13),W(1,10),GC_100,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV2_5_0(W(1,17),W(1,12),W(1,31),GC_51,GC_58,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,17),W(1,5),W(1,8),GC_100,AMP(50))
      CALL FFV2_3_1(W(1,5),W(1,31),GC_50,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,17),W(1,8),W(1,10),GC_100,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,7),W(1,12),W(1,14),GC_11,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,11),W(1,8),W(1,14),GC_11,AMP(53))
      CALL VVV1_1(W(1,10),W(1,25),GC_53,MW,WW,W(1,8))
C     Amplitude(s) for diagram number 54
      CALL FFV2_0(W(1,6),W(1,22),W(1,8),GC_100,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_0(W(1,28),W(1,5),W(1,8),GC_100,AMP(55))
      CALL FFV2_3_1(W(1,5),W(1,25),GC_50,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,11),W(1,8),W(1,30),GC_11,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_0(W(1,28),W(1,8),W(1,10),GC_100,AMP(57))
      CALL FFV2_5_2(W(1,6),W(1,25),GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,8),W(1,12),W(1,30),GC_11,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV2_0(W(1,8),W(1,22),W(1,10),GC_100,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV2_5_0(W(1,28),W(1,12),W(1,25),GC_51,GC_58,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_3_0(W(1,11),W(1,22),W(1,25),GC_50,GC_58,AMP(61))
      CALL FFV2_2(W(1,3),W(1,26),GC_100,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 62
      CALL FFV2_0(W(1,8),W(1,4),W(1,21),GC_62,AMP(62))
      CALL FFV2_1(W(1,4),W(1,26),GC_100,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,3),W(1,14),W(1,20),GC_3,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,21),GC_50,GC_59,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV2_0(W(1,8),W(1,4),W(1,24),GC_62,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,3),W(1,14),W(1,23),GC_3,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,24),GC_50,GC_59,AMP(67))
...
C     Amplitude(s) for diagram number 68
      CALL FFV2_0(W(1,6),W(1,22),W(1,9),GC_100,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV2_0(W(1,28),W(1,5),W(1,9),GC_100,AMP(69))
      CALL FFV1_2(W(1,3),W(1,15),GC_3,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 71
      ...
      CALL FFV2_4_2(W(1,3),W(1,31),GC_50,GC_59,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 72
      CALL FFV2_0(W(1,9),W(1,4),W(1,16),GC_100,AMP(72))
      CALL FFV2_1(W(1,4),W(1,31),GC_62,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 73
      CALL FFV2_0(W(1,3),W(1,24),W(1,16),GC_100,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_0(W(1,9),W(1,4),W(1,18),GC_100,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV2_0(W(1,3),W(1,24),W(1,18),GC_100,AMP(75))
      CALL FFV2_4_2(W(1,3),W(1,25),GC_50,GC_59,ZERO,ZERO,W(1,24))
      CALL FFV2_3(W(1,24),W(1,4),GC_100,MW,WW,W(1,18))
C     Amplitude(s) for diagram number 76
      CALL FFV2_0(W(1,6),W(1,22),W(1,18),GC_100,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_0(W(1,28),W(1,5),W(1,18),GC_100,AMP(77))
      CALL FFV2_1(W(1,4),W(1,25),GC_62,ZERO,ZERO,W(1,18))
      CALL FFV2_3(W(1,3),W(1,18),GC_100,MW,WW,W(1,25))
C     Amplitude(s) for diagram number 78
      CALL FFV2_0(W(1,6),W(1,22),W(1,25),GC_100,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_0(W(1,28),W(1,5),W(1,25),GC_100,AMP(79))
      CALL FFV2_2(W(1,1),W(1,26),GC_100,ZERO,ZERO,W(1,25))
      CALL FFV2_1(W(1,2),W(1,10),GC_100,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,25),W(1,18),W(1,30),GC_11,AMP(80))
      CALL FFV1_1(W(1,2),W(1,30),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 81
      CALL FFV2_0(W(1,25),W(1,24),W(1,10),GC_100,AMP(81))
      CALL FFV1_2(W(1,1),W(1,30),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 82
      CALL FFV2_0(W(1,25),W(1,18),W(1,26),GC_100,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,25),W(1,2),W(1,27),GC_1,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,25),W(1,2),W(1,29),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,1),W(1,24),W(1,27),GC_1,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,1),W(1,24),W(1,29),GC_50,GC_58,AMP(86))
      CALL FFV1_2(W(1,1),W(1,15),GC_1,ZERO,ZERO,W(1,29))
      CALL FFV1P0_3(W(1,29),W(1,2),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,6),W(1,12),W(1,27),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV1_0(W(1,11),W(1,5),W(1,27),GC_11,AMP(88))
      CALL FFV1_1(W(1,2),W(1,15),GC_1,ZERO,ZERO,W(1,27))
      CALL FFV1P0_3(W(1,1),W(1,27),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 89
      CALL FFV1_0(W(1,6),W(1,12),W(1,15),GC_11,AMP(89))
C     Amplitude(s) for diagram number 90
      CALL FFV1_0(W(1,11),W(1,5),W(1,15),GC_11,AMP(90))
      CALL FFV1P0_3(W(1,25),W(1,2),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,6),W(1,12),W(1,15),GC_2,AMP(91))
      CALL FFV2_3_3(W(1,25),W(1,2),GC_50,GC_58,MZ,WZ,W(1,27))
C     Amplitude(s) for diagram number 92
      CALL FFV2_5_0(W(1,6),W(1,12),W(1,27),GC_51,GC_58,AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,11),W(1,5),W(1,15),GC_1,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,27),GC_50,GC_58,AMP(94))
      CALL FFV2_3(W(1,1),W(1,18),GC_100,MW,WW,W(1,25))
C     Amplitude(s) for diagram number 95
      CALL FFV2_0(W(1,6),W(1,22),W(1,25),GC_100,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV2_0(W(1,28),W(1,5),W(1,25),GC_100,AMP(96))
      CALL FFV1P0_3(W(1,1),W(1,24),GC_1,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 97
      CALL FFV1_0(W(1,6),W(1,12),W(1,25),GC_2,AMP(97))
      CALL FFV2_3_3(W(1,1),W(1,24),GC_50,GC_58,MZ,WZ,W(1,28))
C     Amplitude(s) for diagram number 98
      CALL FFV2_5_0(W(1,6),W(1,12),W(1,28),GC_51,GC_58,AMP(98))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,11),W(1,5),W(1,25),GC_1,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,28),GC_50,GC_58,AMP(100))
      CALL FFV2_3_2(W(1,1),W(1,31),GC_50,GC_58,ZERO,ZERO,W(1,24))
      CALL FFV1P0_3(W(1,24),W(1,2),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 101
      CALL FFV1_0(W(1,6),W(1,12),W(1,22),GC_11,AMP(101))
C     Amplitude(s) for diagram number 102
      CALL FFV1_0(W(1,11),W(1,5),W(1,22),GC_11,AMP(102))
      CALL FFV2_3_1(W(1,2),W(1,31),GC_50,GC_58,ZERO,ZERO,W(1,22))
      CALL FFV1P0_3(W(1,1),W(1,22),GC_11,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 103
      CALL FFV1_0(W(1,6),W(1,12),W(1,31),GC_11,AMP(103))
C     Amplitude(s) for diagram number 104
      CALL FFV1_0(W(1,11),W(1,5),W(1,31),GC_11,AMP(104))
C     Amplitude(s) for diagram number 105
      CALL FFV2_0(W(1,8),W(1,4),W(1,27),GC_62,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV1_0(W(1,3),W(1,14),W(1,15),GC_3,AMP(106))
C     Amplitude(s) for diagram number 107
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,27),GC_50,GC_59,AMP(107))
C     Amplitude(s) for diagram number 108
      CALL FFV2_0(W(1,8),W(1,4),W(1,28),GC_62,AMP(108))
C     Amplitude(s) for diagram number 109
      CALL FFV1_0(W(1,3),W(1,14),W(1,25),GC_3,AMP(109))
C     Amplitude(s) for diagram number 110
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,28),GC_50,GC_59,AMP(110))
     ...
     $ +AMP(77)+AMP(78)+AMP(79)+AMP(95)+AMP(96))
     ...
     $ +AMP(70)+AMP(71)+AMP(72)+AMP(73)+AMP(74)+AMP(75)+AMP(87)
     $ +AMP(88)+AMP(89)+AMP(90)+AMP(101)+AMP(102)+AMP(103)+AMP(104))
      JAMP(4)=+1./2.*(+AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)
     $ +AMP(13)+AMP(14)+AMP(19)+AMP(20)+AMP(21)+AMP(22)+AMP(23)
     $ +AMP(24)+AMP(25)+AMP(26)+AMP(27)+AMP(62)+AMP(63)+AMP(64)
     $ +AMP(65)+AMP(66)+AMP(67)+AMP(80)+AMP(81)+AMP(82)+AMP(83)
     $ +AMP(84)+AMP(85)+AMP(86)+AMP(91)+AMP(92)+AMP(93)+AMP(94)
     $ +AMP(97)+AMP(98)+AMP(99)+AMP(100)+AMP(105)+AMP(106)+AMP(107)
     $ +AMP(108)+AMP(109)+AMP(110))
      P251_ddx_epvescxbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P251_ddx_epvescxbbx1=P251_ddx_epvescxbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
