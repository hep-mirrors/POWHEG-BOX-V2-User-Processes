      SUBROUTINE SP7_dxd_epveemvexbbx1(P,ANS)
C     
...
C     
C     Process: d~ d > e+ ve e- ve~ b b~ QCD=2 QED=4 @7
C     
      IMPLICIT NONE
C     
C     CONSTANTS
C     
      ...
      INCLUDE 'maxamps_P7_dxd_epveemvexbbx.inc'
      INTEGER                 NCOMB
      PARAMETER (             NCOMB=256)
      INTEGER    NGRAPHS
...
C     
      ...
      COMMON/TO_AMPS_P7_dxd_epveemvexbbx/  AMP2,       JAMP2
      ...
      IF (ISHEL(IMIRROR) .EQ. 0 .OR. NTRY(IMIRROR) .LE. MAXTRIES) THEN
        DO I=1,NCOMB
          IF (GOODHEL(I,IMIRROR) .OR. NTRY(IMIRROR).LE.MAXTRIES) THEN
            T=P7_dxd_epveemvexbbx1(P ,NHEL(1,I),JC(1))
            DO JJ=1,NINCOMING
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION P7_dxd_epveemvexbbx1(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.13, 2013-11-04
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 47
      ...
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,18))
      CALL FFV2_2(W(1,2),W(1,19),GC_100,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 49
      CALL FFV2_0(W(1,15),W(1,18),W(1,19),GC_100,AMP(49))
      CALL FFV1_1(W(1,1),W(1,17),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,13),W(1,18),W(1,10),GC_100,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,2),W(1,18),W(1,20),GC_1,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_3_0(W(1,2),W(1,18),W(1,22),GC_50,GC_58,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,15),W(1,1),W(1,20),GC_1,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_3_0(W(1,15),W(1,1),W(1,22),GC_50,GC_58,AMP(54))
      CALL FFV2_3_3(W(1,2),W(1,18),GC_50,GC_58,MZ,WZ,W(1,22))
...
C     Amplitude(s) for diagram number 57
      ...
      CALL FFV2_3_3(W(1,15),W(1,1),GC_50,GC_58,MZ,WZ,W(1,13))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,6),W(1,12),W(1,13),GC_62,AMP(58))
      CALL FFV1P0_3(W(1,15),W(1,1),GC_1,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 60
      ...
      CALL FFV1_1(W(1,1),W(1,25),GC_1,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 62
      ...
      CALL FFV2_3_1(W(1,1),W(1,26),GC_50,GC_58,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,2),W(1,10),GC_11,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 64
      ...
      CALL FFV1_2(W(1,2),W(1,25),GC_1,ZERO,ZERO,W(1,34))
...
C     Amplitude(s) for diagram number 66
      ...
      CALL FFV2_3_2(W(1,2),W(1,26),GC_50,GC_58,ZERO,ZERO,W(1,35))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL FFV2_3_1(W(1,1),W(1,21),GC_50,GC_58,ZERO,ZERO,W(1,27))
...
C     Amplitude(s) for diagram number 72
      ...
      CALL FFV2_3_2(W(1,2),W(1,21),GC_50,GC_58,ZERO,ZERO,W(1,19))
      CALL FFV1P0_3(W(1,19),W(1,1),GC_11,ZERO,ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 78
      CALL FFV2_3_0(W(1,15),W(1,14),W(1,26),GC_50,GC_58,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,34),W(1,10),W(1,17),GC_11,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,15),W(1,10),W(1,25),GC_1,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_3_0(W(1,34),W(1,18),W(1,26),GC_50,GC_58,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,35),W(1,18),W(1,25),GC_1,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,35),W(1,27),W(1,17),GC_11,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,15),W(1,27),W(1,26),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,19),W(1,10),W(1,17),GC_11,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,15),W(1,10),W(1,21),GC_50,GC_58,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV2_3_0(W(1,19),W(1,18),W(1,26),GC_50,GC_58,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV2_3_0(W(1,35),W(1,18),W(1,21),GC_50,GC_58,AMP(88))
...
C     Amplitude(s) for diagram number 106
     ...
     $ -AMP(106))
      P7_dxd_epveemvexbbx1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        P7_dxd_epveemvexbbx1=P7_dxd_epveemvexbbx1+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
