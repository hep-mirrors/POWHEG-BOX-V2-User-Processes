...
C     
     ...
     $ +1D0/4D0*(M1*(F2(6)*(V3(4)+CI*(V3(5)))+4D0*(F2(5)*1D0/4D0
     ...
     $ +CI*(V3(5))-V3(4)))))+(+1D0/4D0*(M1*(F2(6)*(V3(3)-V3(6))
     $ +4D0*(F2(5)*1D0/4D0*(V3(4)-CI*(V3(5))))))+F2(4)*(P1(0)*
     ...
     $ +M1*(F2(3)*4D0*(V3(6)-V3(3))+4D0*(F2(4)*(V3(4)+CI*(V3(5)))))))
     ...
     $ +M1*(F2(3)*4D0*(+CI*(V3(5))-V3(4))+4D0*(F2(4)*(V3(3)+V3(6))))))
      END
