...
c     !: write out parameters
      write(*,*)
      write(*,*) '***************************************************'
      write(*,*) 'parameters used in DYNNLO'
      write(*,*) '[numerical inputs defined in mdata.f]'
      write(*,*) '***************************************************'
      write(*,*) 'EW scheme= ',ewscheme
      write(*,*)
      if(ewscheme.eq.-1) then
         write(*,*) 'scheme: old MCFM default'
         write(*,*) 'inputs:'
         write(*,*) 'GF= ',Gf
         write(*,*) 'aem(mz)= ',aemmz
         write(*,*) 'wmass= ',wmass
         ...
         write(*,*) 'sthw^2= ',xw
      elseif(ewscheme.eq.1) then
         write(*,*) 'scheme: Gmu scheme (new MCFM default)'
         write(*,*) 'inputs:'
         write(*,*) 'wmass= ',wmass
         write(*,*) 'zmass= ',zmass
         write(*,*) 'GF= ',Gf
      ...
      write(*,*) 'gwsq= ',gwsq
      write(*,*) '***************************************************'
      write(*,*) 'the same parameters should be used for POWHEG+MiNLO'
      write(*,*) '(POWHEG CKM matrix needs small numbers'
      write(*,*) 'instead of exact 0s)'
      write(*,*) '***************************************************'
c      stop
