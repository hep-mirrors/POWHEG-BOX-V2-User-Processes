...
### LHAPDF = on,off
LHAPDF = on
LHADIR = $(shell lhapdf-config --libdir)
...
CCLINK=$(FCC)
LDFLAGS=-nofor-main 
FFLAGS= -align all -extend_source -mcmodel=large -shared-intel -fpp -O3 #The O3 flags slows down compilation tremendously
endif
...
PATCHESDIR = $(BASEDIR)/fewz-patches
#BUILDPATCHES = $(BUILDIR)/pathces
# add include flag
VPATH = $(BASEDIR)/fewz-patches:\
	$(BASEDIR)/src:\
	$(BASEDIR)/mainSrc: 
FFLAGS += -I${PATCHESDIR} -I${INCLUDEDIR} #
