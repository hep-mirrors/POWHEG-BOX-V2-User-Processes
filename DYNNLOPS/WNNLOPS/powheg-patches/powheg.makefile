...
VPATH= DYNNLOPS/WNNLOPS/powheg-patches/:./:../:$(OBJ)/
...
PYTHIA8LOCATION=/lscr/karlberg/pythia8185
...
HERWIG=main-HERWIG.o setup-HERWIG-lhef.o herwig.o boostrot.o	\
	...
	opencount.o pwhg_analysis_driver.o newunit.o cernroutines.o random.o $(FPEOBJ) 
...
main-PYTHIA8-lhef: $(PYTHIA8)
	$(FF) $(patsubst %,$(OBJ)/%,$(PYTHIA8)) $(LIBS) $(LIBSFASTJET) $(LIBPYTHIA8) $(STATIC) -o $@
