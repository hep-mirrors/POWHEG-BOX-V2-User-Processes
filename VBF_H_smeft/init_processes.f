...
c      enddo
      ...
      do j=2,flst_nreal         
         do k=1,ii
           if(flavequiv(nlegreal,flst_real(1,j),flst_real_tmp(1,k)))then
         ...
         enddo
         ii=ii+1
         call intassign(nlegreal,flst_real(1,j),flst_real_tmp(1,ii))
 987  continue
      enddo
...
c now copy back to flst_real      
      do i=1,flst_nreal
         call intassign(nlegreal,flst_real_tmp(1,i),flst_real(1,i))
      enddo
