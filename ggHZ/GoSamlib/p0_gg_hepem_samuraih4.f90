...
function     numeval_group0(icut, Q, mu2) result(num)
   ...
   use p0_gg_hepem_d49h4l1, only: numerator_d49 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p0_gg_hepem_kinematics, only: k1, k2, k3, k4, k5
   use p0_gg_hepem_model
   use p0_gg_hepem_d37h4l1, only: numerator_d37 => numerator_samurai
   use p0_gg_hepem_d61h4l1, only: numerator_d61 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p0_gg_hepem_kinematics, only: k1, k2, k3, k4, k5
   use p0_gg_hepem_model
   use p0_gg_hepem_d25h4l1, only: numerator_d25 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group3(icut, Q, mu2) result(num)
   use p0_gg_hepem_kinematics, only: k1, k2, k3, k4, k5
   use p0_gg_hepem_model
   use p0_gg_hepem_d47h4l1, only: numerator_d47 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group4(icut, Q, mu2) result(num)
   use p0_gg_hepem_kinematics, only: k1, k2, k3, k4, k5
   use p0_gg_hepem_model
   use p0_gg_hepem_d35h4l1, only: numerator_d35 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group5(icut, Q, mu2) result(num)
   use p0_gg_hepem_kinematics, only: k1, k2, k3, k4, k5
   use p0_gg_hepem_model
   use p0_gg_hepem_d23h4l1, only: numerator_d23 => numerator_samurai
   use p0_gg_hepem_d59h4l1, only: numerator_d59 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_model
   use p0_gg_hepem_d49h4l1, only: numerator_diagram49 => numerator_samurai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_kinematics
   use p0_gg_hepem_model
   use p0_gg_hepem_d37h4l1, only: numerator_diagram37 => numerator_samurai
   use p0_gg_hepem_d61h4l1, only: numerator_diagram61 => numerator_samurai
   use p0_gg_hepem_globalsl1, only: epspow
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_kinematics
   use p0_gg_hepem_model
   use p0_gg_hepem_d25h4l1, only: numerator_diagram25 => numerator_samurai
   use p0_gg_hepem_globalsl1, only: epspow
...
subroutine     reduce_group3(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_kinematics
   use p0_gg_hepem_model
   use p0_gg_hepem_d47h4l1, only: numerator_diagram47 => numerator_samurai
   use p0_gg_hepem_globalsl1, only: epspow
...
subroutine     reduce_group4(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_kinematics
   use p0_gg_hepem_model
   use p0_gg_hepem_d35h4l1, only: numerator_diagram35 => numerator_samurai
   use p0_gg_hepem_globalsl1, only: epspow
...
subroutine     reduce_group5(scale2,tot,totr,ok)
   ...
   use p0_gg_hepem_kinematics
   use p0_gg_hepem_model
   use p0_gg_hepem_d23h4l1, only: numerator_diagram23 => numerator_samurai
   use p0_gg_hepem_d59h4l1, only: numerator_diagram59 => numerator_samurai
   use p0_gg_hepem_globalsl1, only: epspow
...
!-----#] subroutine reduce_group5:
!---#] reduce groups with samurai:
end module p0_gg_hepem_samuraih4
