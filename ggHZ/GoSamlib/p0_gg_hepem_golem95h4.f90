...
subroutine     reconstruct_group0(coeffs)
   ...
   use p0_gg_hepem_d49h4l1, only: numerator_d49 => numerator_golem95
   use p0_gg_hepem_d49h4l1d, only: reconstruct_d49
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p0_gg_hepem_d37h4l1, only: numerator_d37 => numerator_golem95
   use p0_gg_hepem_d37h4l1d, only: reconstruct_d37
   use p0_gg_hepem_d61h4l1, only: numerator_d61 => numerator_golem95
   use p0_gg_hepem_d61h4l1d, only: reconstruct_d61
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p0_gg_hepem_d25h4l1, only: numerator_d25 => numerator_golem95
   use p0_gg_hepem_d25h4l1d, only: reconstruct_d25
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p0_gg_hepem_d47h4l1, only: numerator_d47 => numerator_golem95
   use p0_gg_hepem_d47h4l1d, only: reconstruct_d47
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p0_gg_hepem_d35h4l1, only: numerator_d35 => numerator_golem95
   use p0_gg_hepem_d35h4l1d, only: reconstruct_d35
   implicit none
...
subroutine     reconstruct_group5(coeffs)
   ...
   use p0_gg_hepem_d23h4l1, only: numerator_d23 => numerator_golem95
   use p0_gg_hepem_d23h4l1d, only: reconstruct_d23
   use p0_gg_hepem_d59h4l1, only: numerator_d59 => numerator_golem95
   use p0_gg_hepem_d59h4l1d, only: reconstruct_d59
   implicit none
...
!---#] subroutine reconstruct_group5:
end module p0_gg_hepem_golem95h4
