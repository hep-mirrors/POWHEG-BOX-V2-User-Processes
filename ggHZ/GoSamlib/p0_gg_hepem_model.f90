module     p0_gg_hepem_model
   ! Model parameters for the model: smdiag
   ...
   real(ki), parameter :: wchi =        0.000000000000000_ki
   real(ki), parameter :: wghWm =        0.000000000000000_ki
   real(ki), parameter :: wghWp =        0.000000000000000_ki
   real(ki), parameter :: wghZ =        0.000000000000000_ki
   real(ki), parameter :: wH =        0.000000000000000_ki
   real(ki), parameter :: wphi =        0.000000000000000_ki
   real(ki), parameter :: wT =        0.000000000000000_ki
   real(ki), parameter :: wtau =        0.000000000000000_ki
   real(ki), parameter :: wW =        0.000000000000000_ki
   ...
   character(len=name_length), dimension(13) :: names = (/& 
      & "alpha  ", &
      & "gauge1z", &
      & "gauge2z", &
      & "mB     ", &
