...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p0_gg_hepem_abbrevd49h4, only: init_abbrevd49 => init_abbrev
      use p0_gg_hepem_abbrevd37h4, only: init_abbrevd37 => init_abbrev
      use p0_gg_hepem_abbrevd61h4, only: init_abbrevd61 => init_abbrev
      use p0_gg_hepem_abbrevd25h4, only: init_abbrevd25 => init_abbrev
      use p0_gg_hepem_abbrevd47h4, only: init_abbrevd47 => init_abbrev
      use p0_gg_hepem_abbrevd35h4, only: init_abbrevd35 => init_abbrev
      use p0_gg_hepem_abbrevd23h4, only: init_abbrevd23 => init_abbrev
      use p0_gg_hepem_abbrevd59h4, only: init_abbrevd59 => init_abbrev
      use p0_gg_hepem_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_golem95h4, only: reconstruct_golem95 => reconstruct_group
   use p0_gg_hepem_groups, only: contract_golem95, &
      & global_coeffs => coeffs_group0, &
      & reduce_numetens => reduce_numetens_group0
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group0
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group1
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group2
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group5(scale2,samplitude,ok)
   ...
   use p0_gg_hepem_samuraih4, only: samurai_reduce => reduce_group5
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
!---#] subroutine evaluate_group5:
end module p0_gg_hepem_amplitudeh4
