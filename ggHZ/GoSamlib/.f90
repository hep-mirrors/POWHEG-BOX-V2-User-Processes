program test
   use p0_gg_hepem_config, only: ki, logfile
   use p0_gg_hepem_kinematics, only: dotproduct, boost_to_cms
   use p0_gg_hepem_model, only: parse
   use p0_gg_hepem_matrix, only: samplitude, &
     & initgolem, ir_subtraction
   use p0_gg_hepem_color, only: numcs, CA
   use p0_gg_hepem_rambo, only: ramb
