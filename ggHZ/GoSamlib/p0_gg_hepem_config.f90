module     p0_gg_hepem_config
   ...
   logical :: include_eps2_terms = .true.
   ...
   logical :: include_eps_terms = .true.
   ...
   integer :: PSP_chk_threshold1 = 10
   logical :: PSP_rescue = .true.
   integer :: PSP_chk_threshold2 = 10
   real(ki) :: PSP_chk_kfactor = -1.0_ki
end module p0_gg_hepem_config
