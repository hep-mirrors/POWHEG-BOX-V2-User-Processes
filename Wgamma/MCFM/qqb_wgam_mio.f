      subroutine qqb_wgam_mio(p,bflav,amp2)
      implicit none
...
c---
      ...
      fac=aveqq*2d0*xn*ph_unit_e**4/ph_sthw2**2*ph_unit_e**2
...
ccc     3 <-> 4 (W-)
ccc     p1 -> -p1, p2 -> -p2 
ccc     -->  za(1,2) -> -za(1,2) ; za(1,k) -> i * za(1,k) 
ccc     -->  s(1,2) -> s(1,2) ; s(1,k) -> -s(1,k)
ccc     <3+|,|4+>,<2+|,|1+> 
      if (hgamma .eq. -1) then
c     k=2 ausiliar vector
        agam2=-prp34/s(p3,p4)*za(p1,p5)*zb(p4,p2)/zb(p2,p5) *
     &           ( Qu * ( -1d0/s(p1,p5) - prp12/s(p1,p2)) +   
     &             Qd * prp12/s(p1,p2) )    *             
     &           ( za(p3,p5)*zb(p2,p5) - za(p1,p3)*zb(p2,p1) ) -
     &           prp12/s(p1,p2)/s(p3,p5)/zb(p2,p5) *
     &           zb(p4,p2)**2*za(p1,p4)*za(p5,p3)
      elseif (hgamma .eq. +1) then
c     k=1 ausiliar vector
        agam2=-prp34/s(p3,p4)*za(p1,p3)*zb(p2,p5)/za(p1,p5) *
     &           ( Qd * ( -1d0/s(p2,p5) - prp12/s(p1,p2) ) + 
     &             Qu * prp12/s(p1,p2)  )    *              
     &           ( zb(p4,p5)*za(p5,p1) - zb(p4,p2)*za(p1,p2) ) -
     &           prp12/s(p1,p2)/s(p3,p5)/za(p1,p5) *
     &           za(p1,p3)**2*zb(p3,p5) * zb(p4,p2)
      endif

      if (hgamma .eq. -1) then
c     k=2 ausiliar vector
        agam1=-prp34/s(p3,p4)*za(p1,p5)*zb(p4,p2)/zb(p2,p5) *
     &           ( Qu * ( -1d0/s(p1,p5) - 1d0/(s(p1,p2)-s(p3,p4))) +   
     &             Qd * 1d0/(s(p1,p2)-s(p3,p4)) )    *             
     &           ( za(p3,p5)*zb(p2,p5) - za(p1,p3)*zb(p2,p1) ) 
      elseif (hgamma .eq. +1) then
c     k=1 ausiliar vector
        agam1=-prp34/s(p3,p4)*za(p1,p3)*zb(p2,p5)/za(p1,p5) *
     &           ( Qd * ( -1d0/s(p2,p5) - 1d0/(s(p1,p2)-s(p3,p4)) ) + 
     &             Qu * 1d0/(s(p1,p2)-s(p3,p4)) )    *              
     &           ( zb(p4,p5)*za(p5,p1) - zb(p4,p2)*za(p1,p2) ) 
      endif
...
c      if(abs(dble(agam1/agam2)-1).gt.1d-6) then
c      if(s(p3,p4).gt.6000) then
c      print*,'agamtree= ',agam1
c      print*,'agam2= ',agam2
c      print*,'rapp= ',agam1/agam2
c      print*,'sp= ',s(p3,p4)
c      endif
c      endif
...
c--- k=2 (ausiliar vector)
*        agamtree = agamtree + 
*     &    prp12/s(p1,p2) * prp34/s(p3,p4) * (-1d0/2d0) *
*     &    za(p5,p3) * za(p1,p5) *
*     &    ( (xdelk_g + s(p1,p2)/ ph_Wmass2 * xlambda_g) * zb(p4,p2) +
*     &      xlambda_g / ph_Wmass2 * zb(p1,p2) * za(p1,p5) * zb(p4,p5) )
*      elseif (hgamma .eq. +1) then
c--- k=1 (ausiliar vector)
*         agamtree = agamtree + 
*     &    prp12/s(p1,p2) * prp34/s(p3,p4) * (1d0/2d0) *
*     &    zb(p4,p5) * zb(p2,p5) *
*     &    ( (xdelk_g + s(p1,p2)/ ph_Wmass2 * xlambda_g) * za(p1,p3) +
*     &      xlambda_g / ph_Wmass2 * za(p1,p2) * zb(p5,p2) * zb(p5,p3) )
*      endif
...
c      print*,'agamtree1= ',agamtree1
c      print*,'agamtree2= ',agamtree2
c      print*,'rapporto= ',agamtree1/agamtree2
c      print*
