      SUBROUTINE SREALMTRX_009(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ u -> e+ ve b b~ d d~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_009/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_009(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_009(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,17  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      ...
      CALL FVIXXX(W(1,36  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     38  ))                                                          
     ...
     &     44  ))                                                          
      ...
      CALL FVOXXX(W(1,41  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     56  ))                                                          
     ...
     &     58  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_009 =REALMTRX_009+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
