...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   -3,   -6,   21,   21/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,    2,    1,   -7,   10,    1/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   21,   21,   -6,   -3/    
      DATA (CF(i,2  ),i=7  ,12 ) /     2,   -6,    2,   -6,   -7,   -7/    
C               T[ 5, 7]T[ 1, 8]T[ 2, 6]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -3,   21,   24,   21,   -6,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,    2,   10,   -7,    1,   -8/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   21,   21,   24,   -3,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    10,   -7,    1,    2,   -8,    1/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   -6,   -3,   24,   21/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   -7,   -8,    2,    1,   10/    
C               T[ 2, 7]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -3,   -6,   -6,   21,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    -7,   -6,   -7,   -6,    2,    2/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,    2,    1,   10,    1,   -7/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -6,   -3,   21,   -6,   21/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,   -6,    2,   -7,   -7,   -6/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -6,   24,   21,   -3,   21,   -6/    
C               T[ 5, 8]T[ 1, 7]T[ 2, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     1,    2,   10,    1,   -8,   -7/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -3,   21,   24,   -6,   21,   -6/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,   -6,   -7,    2,    2,   -6/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -3,   -6,   24,   -6,   21/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    10,   -7,    1,   -8,    1,    2/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   21,   -6,   24,   -3/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /     1,   -7,   -8,    1,   10,    2/    
...
C ----------
     ...
     &     19  ))                                                          
      ...
      CALL FVIXXX(W(1,8   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL JIOXXX(W(1,24  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,25  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,8   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,8   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL FVIXXX(W(1,8   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
     ...
     &     45  ))                                                          
      ...
      CALL JIOXXX(W(1,8   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      ...
      CALL FVOXXX(W(1,19  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL JIOXXX(W(1,8   ),W(1,53  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GG ,AMP(23  ))             
      CALL JIOXXX(W(1,44  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVIXXX(W(1,7   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
