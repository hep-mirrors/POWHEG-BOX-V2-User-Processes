      SUBROUTINE SREALMTRX_159(P1,ANS)
C  
...
C  
C FOR PROCESS : s d~ -> e+ ve b b~ u~ s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_159/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_159(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_159(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,   -2,    7,   -2,    7,   -1/    
C               T[ 5, 7]T[ 2, 1]T[ 8, 6]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -2,    8,   -1,    7,   -2,    7/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     7,   -1,    8,   -2,    7,   -2/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -2,    7,   -2,    8,   -1,    7/    
C               T[ 8, 7]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     7,   -2,    7,   -1,    8,   -2/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,    7,   -2,    7,   -2,    8/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL FVIXXX(W(1,17  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
     ...
     &     38  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_159 =REALMTRX_159+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
