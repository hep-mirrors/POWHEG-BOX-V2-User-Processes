      SUBROUTINE SREALMTRX_066(P1,ANS)
C  
...
C  
C FOR PROCESS : u u -> e+ ve b b~ d u  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_066/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_066(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_066(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   21,   -6,   -6,   21,   -3/    
      DATA (CF(i,1  ),i=7  ,12 ) /     2,   -6,    2,   -7,   -7,   -6/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   24,   -3,   -6,   21,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /    10,    2,    1,   -8,    1,   -7/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,   -3,   24,   21,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,    2,   -8,    1,   10,   -7/    
C               T[ 7, 6]T[ 5, 1]T[ 8, 2]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   -6,   21,   24,   -3,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -8,   -7,    1,   10,    1,    2/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   21,   -6,   -3,   24,   -6/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   -7,   10,    1,   -8,    2/    
C               T[ 8, 6]T[ 5, 2]T[ 7, 1]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -3,   -6,   21,   21,   -6,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    -7,   -6,   -7,    2,    2,   -6/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     2,   10,    1,   -8,    1,   -7/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   21,   -3,   -6,   21,   -6/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -6,    2,    2,   -7,   -7,   -6/    
      DATA (CF(i,8  ),i=7  ,12 ) /    21,   24,   -6,   -6,   21,   -3/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     2,    1,   -8,    1,   10,   -7/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -3,   -6,   24,   21,   -6,   21/    
C               T[ 7, 6]T[ 5, 2]T[ 8, 1]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,   -8,    1,   10,    1,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   -6,   21,   24,   -3,   21/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,    1,   10,    1,   -8,    2/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   21,   -6,   -3,   24,   -6/    
C               T[ 8, 6]T[ 5, 1]T[ 7, 2]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,   -7,   -7,    2,    2,   -6/    
      DATA (CF(i,12 ),i=7  ,12 ) /    -6,   -3,   21,   21,   -6,   24/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     10  ))                                                          
      CALL JIOXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,8   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,1   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL JIOXXX(W(1,22  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,25  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,8   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
     ...
     &     38  ))                                                          
      ...
      CALL JIOXXX(W(1,2   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL FVOXXX(W(1,7   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL FVOXXX(W(1,41  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     42  ))                                                          
      CALL JIOXXX(W(1,1   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,10  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL JIOXXX(W(1,1   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,45  ),GG ,AMP(18  ))             
      CALL JIOXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL FVOXXX(W(1,5   ),W(1,46  ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,47  ),W(1,40  ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     48  ))                                                          
      CALL JIOXXX(W(1,48  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL FVOXXX(W(1,5   ),W(1,49  ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,40  ),GG ,AMP(20  ))             
      CALL JIOXXX(W(1,48  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GG ,AMP(21  ))             
      CALL JVVXXX(W(1,46  ),W(1,40  ),G ,ZERO    ,ZERO    ,W(1,52  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,52  ),GG ,AMP(22  ))             
      CALL FVOXXX(W(1,8   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL JIOXXX(W(1,2   ),W(1,53  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,2   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL JIOXXX(W(1,55  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,56  ),GG ,AMP(24  ))             
      CALL JVVXXX(W(1,49  ),W(1,40  ),G ,ZERO    ,ZERO    ,W(1,57  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(25  ))             
      CALL FVIXXX(W(1,2   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL JIOXXX(W(1,58  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,8   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL JIOXXX(W(1,2   ),W(1,60  ),GG ,ZERO    ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GG ,AMP(27  ))             
      CALL FVIXXX(W(1,48  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL JIOXXX(W(1,62  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GG ,AMP(28  ))             
      CALL FVOXXX(W(1,5   ),W(1,40  ),GG ,BMASS   ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,64  ),W(1,46  ),GG ,AMP(29  ))             
      CALL IOVXXX(W(1,6   ),W(1,64  ),W(1,49  ),GG ,AMP(30  ))             
      CALL FVIXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,65  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,66  ),GG ,AMP(31  ))             
      CALL FVIXXX(W(1,65  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      CALL JIOXXX(W(1,67  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      ...
      JAMP(   7) = +AMP(  17)+AMP(  18)+AMP(  21)+AMP(  22)
      JAMP(   8) = +AMP(  19)+AMP(  20)+AMP(  25)
      JAMP(   9) = -AMP(  22)+AMP(  28)+AMP(  31)+AMP(  32)
      JAMP(  10) = +AMP(  23)+AMP(  27)
      JAMP(  11) = +AMP(  24)+AMP(  26)
      JAMP(  12) = -AMP(  25)+AMP(  29)+AMP(  30)
      REALMTRX_066 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_066 =REALMTRX_066+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
