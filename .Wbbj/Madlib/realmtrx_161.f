      SUBROUTINE SREALMTRX_161(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_161/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_161(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_161(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,    7,   -2,   -2,    7,   -1/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     7,    8,   -1,   -2,    7,   -2/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -2,   -1,    8,    7,   -2,    7/    
C               T[ 7, 6]T[ 5, 1]T[ 8, 2]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -2,   -2,    7,    8,   -1,    7/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     7,    7,   -2,   -1,    8,   -2/    
C               T[ 8, 6]T[ 5, 2]T[ 7, 1]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,   -2,    7,    7,   -2,    8/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     38  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_161 =REALMTRX_161+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
