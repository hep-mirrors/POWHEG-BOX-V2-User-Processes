...
C  
C FOR PROCESS : d~ c~ -> e+ ve b b~ u~ c~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,   -2,   -1,   -2,    7,    7/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -2,    8,    7,    7,   -2,   -1/    
C               T[ 5, 7]T[ 1, 8]T[ 2, 6]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -1,    7,    8,    7,   -2,   -2/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -2,    7,    7,    8,   -1,   -2/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     7,   -2,   -2,   -1,    8,    7/    
C               T[ 2, 7]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     7,   -1,   -2,   -2,    7,    8/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
C ----------
C BEGIN CODE
C ----------
