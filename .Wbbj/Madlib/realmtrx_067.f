...
C  
C FOR PROCESS : u u -> e+ ve b b~ u s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      DATA (CF(i,1  ),i=7  ,12 ) /     2,   -6,    2,   -6,   -7,   -7/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   21,   21,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /     1,    2,   -8,   -7,    1,   10/    
C               T[ 8, 6]T[ 5, 1]T[ 7, 2]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /    10,    2,    1,   -7,   -8,    1/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -7,   -6,   -7,   -6,    2,    2/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -8,   -7,    1,    2,   10,    1/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -6,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     1,   -7,   10,    2,    1,   -8/    
C               T[ 7, 6]T[ 5, 2]T[ 8, 1]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     2,    1,   10,   -7,   -8,    1/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   21,   -3,   -6,   -6,   21/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    21,   24,   -6,   -3,   -6,   21/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     2,   -8,    1,   -7,    1,   10/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -3,   -6,   24,   21,   21,   -6/    
C               T[ 8, 6]T[ 5, 2]T[ 7, 1]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -6,   -7,   -7,   -6,    2,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   -3,   21,   24,   21,   -6/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,    1,   -8,    2,   10,    1/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   -6,   21,   21,   24,   -3/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -7,   10,    1,    2,    1,   -8/    
      DATA (CF(i,12 ),i=7  ,12 ) /    21,   21,   -6,   -6,   -3,   24/    
C               T[ 7, 6]T[ 5, 1]T[ 8, 2]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     38  ))                                                          
      ...
      CALL FVOXXX(W(1,11  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,1   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,8   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
     ...
     &     44  ))                                                          
      ...
      CALL JIOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
     ...
     &     48  ))                                                          
      CALL JIOXXX(W(1,48  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL FVOXXX(W(1,5   ),W(1,49  ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,40  ),GG ,AMP(20  ))             
      CALL JVVXXX(W(1,46  ),W(1,40  ),G ,ZERO    ,ZERO    ,W(1,51  ))      
      ...
      CALL FVIXXX(W(1,48  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL JIOXXX(W(1,53  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GG ,AMP(23  ))             
      CALL JIOXXX(W(1,48  ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVOXXX(W(1,7   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      ...
      CALL JIOXXX(W(1,65  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
