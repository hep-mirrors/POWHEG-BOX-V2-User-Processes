...
C  
      ...
      DATA (CF(i,1  ),i=7  ,12 ) /    -6,   -7,   -7,    2,    2,   -6/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   21,   21,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -7,    1,   10,    1,   -8,    2/    
C               T[ 8, 6]T[ 5, 1]T[ 7, 2]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /    -7,   -8,    1,   10,    1,    2/    
C               T[ 5, 2]T[ 8, 1]T[ 7, 6]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -6,    2,    2,   -7,   -7,   -6/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /     2,   10,    1,   -8,    1,   -7/    
C               T[ 5, 1]T[ 7, 2]T[ 8, 6]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -6,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     2,    1,   -8,    1,   10,   -7/    
C               T[ 7, 6]T[ 5, 2]T[ 8, 1]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -6,   -7,   -7,   -6,    2,    2/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   21,   -6,   -6,   21,   -3/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -7,    1,   -8,    2,   10,    1/    
      DATA (CF(i,8  ),i=7  ,12 ) /    21,   24,   -3,   -6,   21,   -6/    
C               T[ 5, 2]T[ 7, 1]T[ 8, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -7,   10,    1,    2,    1,   -8/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   -3,   24,   21,   -6,   21/    
C               T[ 7, 6]T[ 5, 1]T[ 8, 2]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /     2,    1,   10,   -7,   -8,    1/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   -6,   21,   24,   -3,   21/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /     2,   -8,    1,   -7,    1,   10/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   21,   -6,   -3,   24,   -6/    
C               T[ 8, 6]T[ 5, 2]T[ 7, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
      DATA (CF(i,12 ),i=7  ,12 ) /    -3,   -6,   21,   21,   -6,   24/    
C               T[ 5, 1]T[ 8, 2]T[ 7, 6]                                   
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     14  ))                                                          
      ...
      CALL FVIXXX(W(1,14  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,19  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,8   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      ...
      CALL FVOXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
     ...
     &     34  ))                                                          
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
     ...
     &     40  ))                                                          
      CALL JIOXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,2   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL FVOXXX(W(1,5   ),W(1,42  ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,41  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,14  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL FVOXXX(W(1,5   ),W(1,44  ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,45  ),W(1,41  ),GG ,AMP(18  ))             
      CALL FVOXXX(W(1,7   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL JIOXXX(W(1,14  ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,47  ),GG ,AMP(19  ))             
      CALL JVVXXX(W(1,42  ),W(1,41  ),G ,ZERO    ,ZERO    ,W(1,48  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GG ,AMP(20  ))             
      CALL FVOXXX(W(1,8   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,1   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,50  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,1   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL JIOXXX(W(1,51  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,52  ),GG ,AMP(22  ))             
      CALL JVVXXX(W(1,44  ),W(1,41  ),G ,ZERO    ,ZERO    ,W(1,53  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,53  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,1   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL JIOXXX(W(1,54  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVOXXX(W(1,8   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,1   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(25  ))             
      CALL FVIXXX(W(1,14  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL JIOXXX(W(1,58  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,5   ),W(1,41  ),GG ,BMASS   ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,60  ),W(1,42  ),GG ,AMP(27  ))             
      CALL IOVXXX(W(1,6   ),W(1,60  ),W(1,44  ),GG ,AMP(28  ))             
     ...
     &     61  ))                                                          
      ...
      CALL FVOXXX(W(1,40  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL JIOXXX(W(1,2   ),W(1,63  ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,64  ),GG ,AMP(30  ))             
      CALL FVIXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,65  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
     ...
     &     67  ))                                                          
      ...
      JAMP(   2) = -AMP(   3)+AMP(   5)+AMP(  15)+AMP(  16)
      JAMP(   3) = +AMP(   3)+AMP(   6)+AMP(  13)+AMP(  14)
      JAMP(   4) = -AMP(   4)+AMP(  11)+AMP(  12)
      JAMP(   5) = +AMP(   7)+AMP(   8)
      JAMP(   6) = +AMP(   9)+AMP(  10)
      JAMP(   7) = -AMP(  17)-AMP(  18)-AMP(  23)
      JAMP(   8) = -AMP(  19)-AMP(  20)-AMP(  29)-AMP(  30)
      JAMP(   9) = +AMP(  20)-AMP(  26)-AMP(  31)-AMP(  32)
      JAMP(  10) = -AMP(  21)-AMP(  25)
      JAMP(  11) = -AMP(  22)-AMP(  24)
      JAMP(  12) = +AMP(  23)-AMP(  27)-AMP(  28)
      REALMTRX_037 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
