...
C  
C FOR PROCESS : s~ u -> e+ ve b b~ s s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      PARAMETER (NGRAPHS=  32,NEIGEN= 12) 
      include "nexternal.inc"
      INTEGER    NWAVEFUNCS     , NCOLOR
      PARAMETER (NWAVEFUNCS=  68, NCOLOR=  12) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   21,   -6,   21,   -6,   -3/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -7,   -7,   -6,   -6,    2,    2/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   24,   -3,   21,   -6,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -8,    1,    2,   -7,    1,   10/    
C               T[ 7, 8]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,   -3,   24,   -6,   21,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,    2,   -7,   -8,    1/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   21,   -6,   24,   -3,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /     1,   -8,   -7,    2,   10,    1/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   -6,   21,   -3,   24,   21/    
      DATA (CF(i,5  ),i=7  ,12 ) /    10,    1,   -7,    2,    1,   -8/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -3,   -6,   21,   -6,   21,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     2,    2,   -6,   -6,   -7,   -7/    
C               T[ 5, 8]T[ 1, 2]T[ 7, 6]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -7,   -8,    1,    1,   10,    2/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   -6,   21,   21,   -6/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -7,    1,   10,   -8,    1,    2/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   21,   -6,   -6,   21/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -6,    2,    2,   -7,   -7,   -6/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   21,   24,   -3,   -6,   21/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -6,   -7,   -7,    2,    2,   -6/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   -3,   24,   21,   -6/    
C               T[ 5, 2]T[ 1, 8]T[ 7, 6]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /     2,    1,   -8,   10,    1,   -7/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   -6,   -6,   21,   24,   -3/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /     2,   10,    1,    1,   -8,   -7/    
      DATA (CF(i,12 ),i=7  ,12 ) /    -6,   21,   21,   -6,   -3,   24/    
C               T[ 7, 2]T[ 1, 6]T[ 5, 8]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     10  ))                                                          
      CALL JIOXXX(W(1,8   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
     ...
     &     14  ))                                                          
      CALL JIOXXX(W(1,14  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVOXXX(W(1,5   ),W(1,15  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,11  ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,14  ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GG ,AMP(3   ))             
      CALL JVVXXX(W(1,12  ),W(1,11  ),G ,ZERO    ,ZERO    ,W(1,19  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,8   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL JIOXXX(W(1,8   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,23  ),GG ,AMP(6   ))             
      CALL JVVXXX(W(1,15  ),W(1,11  ),G ,ZERO    ,ZERO    ,W(1,24  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,8   ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,8   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,27  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,14  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,29  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL FVOXXX(W(1,5   ),W(1,11  ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,12  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,15  ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,17  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,32  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,10  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JIOXXX(W(1,2   ),W(1,34  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,36  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,36  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     38  ))                                                          
      CALL JIOXXX(W(1,38  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,8   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL FVOXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,14  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(17  ))             
      CALL FVIXXX(W(1,2   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL FVIXXX(W(1,43  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     44  ))                                                          
      CALL JIOXXX(W(1,44  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,45  ),GG ,AMP(18  ))             
      CALL JIOXXX(W(1,14  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL FVOXXX(W(1,5   ),W(1,40  ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,47  ),W(1,46  ),GG ,AMP(19  ))             
      CALL FVOXXX(W(1,5   ),W(1,46  ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,48  ),W(1,40  ),GG ,AMP(20  ))             
      CALL FVIXXX(W(1,14  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,49  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,50  ),GG ,AMP(21  ))             
      CALL JVVXXX(W(1,40  ),W(1,46  ),G ,ZERO    ,ZERO    ,W(1,51  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GG ,AMP(22  ))             
      CALL FVIXXX(W(1,8   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,52  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,53  ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,7   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL JIOXXX(W(1,8   ),W(1,54  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVOXXX(W(1,41  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     56  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     58  ))                                                          
      CALL JIOXXX(W(1,43  ),W(1,58  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,2   ),W(1,58  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,47  ),W(1,60  ),GG ,AMP(27  ))             
      CALL FVOXXX(W(1,5   ),W(1,60  ),GG ,BMASS   ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,61  ),W(1,40  ),GG ,AMP(28  ))             
      CALL FVOXXX(W(1,58  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL JIOXXX(W(1,2   ),W(1,62  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GG ,AMP(29  ))             
      CALL JVVXXX(W(1,40  ),W(1,60  ),G ,ZERO    ,ZERO    ,W(1,64  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,64  ),GG ,AMP(30  ))             
      CALL FVIXXX(W(1,8   ),W(1,60  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,65  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,66  ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,7   ),W(1,60  ),GG ,ZERO    ,ZERO    ,W(1,67  ))     
      CALL JIOXXX(W(1,8   ),W(1,67  ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,68  ),GG ,AMP(32  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   7)
      JAMP(   2) = +AMP(   3)+AMP(   4)+AMP(  13)+AMP(  14)
      JAMP(   3) = -AMP(   4)+AMP(  10)+AMP(  15)+AMP(  16)
      JAMP(   4) = +AMP(   5)+AMP(   9)
      JAMP(   5) = +AMP(   6)+AMP(   8)
      JAMP(   6) = -AMP(   7)+AMP(  11)+AMP(  12)
      JAMP(   7) = -AMP(  17)+AMP(  22)-AMP(  25)-AMP(  29)+AMP(  30)
      JAMP(   8) = -AMP(  18)-AMP(  21)-AMP(  22)-AMP(  26)-AMP(  30)
      JAMP(   9) = -AMP(  19)-AMP(  27)
      JAMP(  10) = -AMP(  20)-AMP(  28)
      JAMP(  11) = -AMP(  23)-AMP(  31)
      JAMP(  12) = -AMP(  24)-AMP(  32)
      REALMTRX_140 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
