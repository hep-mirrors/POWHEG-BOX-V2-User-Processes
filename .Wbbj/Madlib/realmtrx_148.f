      SUBROUTINE SREALMTRX_148(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ c -> e+ ve b b~ c c~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_148/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_148(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_148(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -3,   -6,   21,   21,   -6/    
      DATA (CF(i,1  ),i=7  ,12 ) /     1,    2,   10,   -7,   -8,    1/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -3,   24,   21,   -6,   -6,   21/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -8,    2,    1,   -7,    1,   10/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,   21,   24,   -3,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /    -7,   -6,   -7,   -6,    2,    2/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -6,   -3,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /     2,   -6,    2,   -6,   -7,   -7/    
C               T[ 5, 2]T[ 1, 8]T[ 7, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /    10,   -7,    1,    2,    1,   -8/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   21,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     1,   -7,   -8,    2,   10,    1/    
C               T[ 7, 2]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     1,   -8,   -7,    2,   10,    1/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -6,   -3,   21,   21,   -6/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,    2,   -6,   -6,   -7,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -6,   24,   21,   -3,   -6,   21/    
C               T[ 5, 8]T[ 1, 2]T[ 7, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    10,    1,   -7,    2,    1,   -8/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -3,   21,   24,   -6,   -6,   21/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,   -7,   -6,   -6,    2,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -3,   -6,   24,   21,   -6/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -8,    1,    2,   -7,    1,   10/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   -6,   -6,   21,   24,   -3/    
C               T[ 7, 8]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /     1,   10,    2,   -7,   -8,    1/    
...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL FVOXXX(W(1,5   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,17  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,5   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,10  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL JVVXXX(W(1,10  ),W(1,17  ),G ,ZERO    ,ZERO    ,W(1,22  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,8   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,7   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
     ...
     &     29  ))                                                          
      CALL JIOXXX(W(1,14  ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,2   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,31  ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,5   ),W(1,31  ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,6   ),W(1,32  ),W(1,10  ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,29  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,2   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(13  ))             
      CALL JVVXXX(W(1,10  ),W(1,31  ),G ,ZERO    ,ZERO    ,W(1,35  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,8   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,36  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,7   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL JIOXXX(W(1,8   ),W(1,38  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL FVIXXX(W(1,8   ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     41  ))                                                          
      CALL FVIXXX(W(1,41  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,42  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(17  ))             
      CALL FVIXXX(W(1,8   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL FVIXXX(W(1,44  ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     45  ))                                                          
      CALL JIOXXX(W(1,45  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(18  ))             
      CALL JIOXXX(W(1,41  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL FVOXXX(W(1,5   ),W(1,47  ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,48  ),W(1,40  ),GG ,AMP(19  ))             
      CALL JIOXXX(W(1,8   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL FVOXXX(W(1,5   ),W(1,49  ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,40  ),GG ,AMP(20  ))             
      CALL JVVXXX(W(1,47  ),W(1,40  ),G ,ZERO    ,ZERO    ,W(1,51  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,51  ),GG ,AMP(21  ))             
      CALL JVVXXX(W(1,49  ),W(1,40  ),G ,ZERO    ,ZERO    ,W(1,52  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,52  ),GG ,AMP(22  ))             
      CALL FVOXXX(W(1,29  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL JIOXXX(W(1,8   ),W(1,53  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GG ,AMP(23  ))             
      CALL JIOXXX(W(1,44  ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVOXXX(W(1,7   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,2   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,7   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL JIOXXX(W(1,2   ),W(1,58  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL FVIXXX(W(1,2   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL JIOXXX(W(1,60  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GG ,AMP(27  ))             
      CALL FVIXXX(W(1,2   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,64  ),W(1,47  ),GG ,AMP(29  ))             
      CALL IOVXXX(W(1,6   ),W(1,64  ),W(1,49  ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,41  ),W(1,65  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
     ...
     &     67  ))                                                          
      ...
      JAMP(   1) = -AMP(   1)+AMP(   6)-AMP(   9)-AMP(  13)+AMP(  14)
      JAMP(   2) = -AMP(   2)-AMP(   5)-AMP(   6)-AMP(  10)-AMP(  14)
      JAMP(   3) = -AMP(   3)-AMP(  11)
      JAMP(   4) = -AMP(   4)-AMP(  12)
      JAMP(   5) = -AMP(   7)-AMP(  15)
      JAMP(   6) = -AMP(   8)-AMP(  16)
      JAMP(   7) = +AMP(  17)+AMP(  18)-AMP(  21)+AMP(  24)
      JAMP(   8) = +AMP(  19)+AMP(  20)+AMP(  22)
      JAMP(   9) = +AMP(  21)+AMP(  23)+AMP(  31)+AMP(  32)
      JAMP(  10) = -AMP(  22)+AMP(  29)+AMP(  30)
      JAMP(  11) = +AMP(  25)+AMP(  26)
      JAMP(  12) = +AMP(  27)+AMP(  28)
      REALMTRX_148 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_148 =REALMTRX_148+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
