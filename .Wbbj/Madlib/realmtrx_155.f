      SUBROUTINE SREALMTRX_155(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_155/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_155(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_155(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   -3,   21,   -6,   21/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,    1,   10,    1,   -7,    2/    
C               T[ 1, 6]T[ 5, 2]T[ 8, 7]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   21,   -6,   21,   -3/    
      DATA (CF(i,2  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 7]T[ 1, 2]T[ 8, 6]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -3,   21,   24,   -6,   21,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,    1,   -8,   -7,    2/    
C               T[ 1, 2]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -6,   -6,   24,   -3,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /     1,   -8,    1,   10,    2,   -7/    
C               T[ 8, 7]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   21,   -3,   24,   -6/    
      DATA (CF(i,5  ),i=7  ,12 ) /    10,    1,   -8,    1,    2,   -7/    
C               T[ 1, 2]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -3,   -6,   21,   -6,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 1, 6]T[ 5, 2]T[ 8, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,    2,    1,    1,   10,   -7/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   -6,   21,   21,   -6/    
C               T[ 1, 6]T[ 5, 7]T[ 8, 2]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,    2,   10,   -8,    1,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   21,   -6,   -6,   21/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    10,   -7,    1,    1,   -8,    2/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   21,   24,   -3,   -6,   21/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /     1,   -7,   -8,   10,    1,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   -3,   24,   21,   -6/    
C               T[ 8, 2]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,   -6,   -7,    2,    2,   -6/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   -6,   -6,   21,   24,   -3/    
C               T[ 1, 6]T[ 5, 7]T[ 8, 2]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /     2,   -6,    2,   -7,   -7,   -6/    
...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL JIOXXX(W(1,14  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
     ...
     &     19  ))                                                          
      ...
      CALL JIOXXX(W(1,11  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GG ,AMP(5   ))             
      CALL JVVXXX(W(1,17  ),W(1,10  ),G ,ZERO    ,ZERO    ,W(1,23  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,23  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,8   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL JIOXXX(W(1,2   ),W(1,24  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,25  ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,26  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GG ,AMP(8   ))             
      CALL JVVXXX(W(1,20  ),W(1,10  ),G ,ZERO    ,ZERO    ,W(1,28  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,2   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,29  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL FVOXXX(W(1,8   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL JIOXXX(W(1,2   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,19  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,14  ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
     ...
     &     38  ))                                                          
      ...
      CALL JIOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
     ...
     &     54  ))                                                          
      ...
      CALL JIOXXX(W(1,14  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      ...
      CALL FVIXXX(W(1,14  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
     ...
     &     62  ))                                                          
      ...
      JAMP(   2) = -AMP(   3)-AMP(   4)-AMP(   9)
      JAMP(   3) = -AMP(   6)-AMP(  12)-AMP(  15)-AMP(  16)
      JAMP(   4) = -AMP(   7)-AMP(  11)
      JAMP(   5) = -AMP(   8)-AMP(  10)
      JAMP(   6) = +AMP(   9)-AMP(  13)-AMP(  14)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_155 =REALMTRX_155+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
