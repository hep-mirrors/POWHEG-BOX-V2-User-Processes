      SUBROUTINE SREALMTRX_149(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ c -> e+ ve b b~ s s~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_149/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_149(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_149(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,17  ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
     ...
     &     44  ))                                                          
      ...
      CALL FVOXXX(W(1,41  ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     56  ))                                                          
     ...
     &     58  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_149 =REALMTRX_149+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
