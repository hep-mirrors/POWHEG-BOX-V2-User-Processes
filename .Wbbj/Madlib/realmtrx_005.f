...
C  
C FOR PROCESS : d~ d -> e+ ve b b~ u~ s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,   -1,   -2,    7,    7,   -2/    
C               T[ 1, 6]T[ 5, 7]T[ 8, 2]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -1,    8,    7,   -2,   -2,    7/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -2,    7,    8,   -1,   -2,    7/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     7,   -2,   -1,    8,    7,   -2/    
C               T[ 8, 2]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     7,   -2,   -2,    7,    8,   -1/    
C               T[ 1, 6]T[ 5, 7]T[ 8, 2]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -2,    7,    7,   -2,   -1,    8/    
C               T[ 5, 2]T[ 1, 7]T[ 8, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     10  ))                                                          
      ...
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,2   ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,19  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,2   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(4   ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL FVIXXX(W(1,7   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,23  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     25  ))                                                          
      CALL JIOXXX(W(1,25  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,8   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,10  ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(7   ))             
      CALL JVVXXX(W(1,15  ),W(1,22  ),G ,ZERO    ,ZERO    ,W(1,29  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,29  ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,10  ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL JIOXXX(W(1,30  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,31  ),GG ,AMP(9   ))             
      CALL JVVXXX(W(1,11  ),W(1,22  ),G ,ZERO    ,ZERO    ,W(1,32  ))      
     ...
     &     33  ))                                                          
      ...
      CALL FVOXXX(W(1,14  ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL JIOXXX(W(1,7   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,5   ),W(1,15  ),GG ,BMASS   ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,22  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,5   ),W(1,11  ),GG ,BMASS   ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,6   ),W(1,38  ),W(1,22  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,5   ),W(1,22  ),GG ,BMASS   ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,15  ),GG ,AMP(15  ))             
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,11  ),GG ,AMP(16  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   8)+AMP(  10)
      JAMP(   2) = +AMP(   3)+AMP(   4)-AMP(   8)-AMP(  10)
      JAMP(   3) = +AMP(   5)+AMP(   6)+AMP(   9)
      JAMP(   4) = +AMP(   7)+AMP(  11)+AMP(  12)
      JAMP(   5) = +AMP(  13)+AMP(  14)
      JAMP(   6) = +AMP(  15)+AMP(  16)
      REALMTRX_005 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
