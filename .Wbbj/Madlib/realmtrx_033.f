...
C  
C FOR PROCESS : d d~ -> e+ ve b b~ d u~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C               T[ 5, 8]T[ 2, 1]T[ 7, 6]                                   
      ...
      DATA (CF(i,2  ),i=7  ,12 ) /     1,   -8,    1,   10,   -7,    2/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /    10,    1,   -8,    1,   -7,    2/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -8,    1,   10,    1,    2,   -7/    
C               T[ 7, 8]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -6,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     1,   10,    1,   -8,    2,   -7/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     2,    1,   10,   -7,   -8,    1/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   -6,   21,   -6,   21/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,   -8,    1,   -7,    1,   10/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   21,   -6,   21,   -6/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -7,    1,   -8,    2,   10,    1/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   21,   24,   -3,   21,   -6/    
C               T[ 7, 1]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,   10,    1,    2,    1,   -8/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   -3,   24,   -6,   21/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -6,   -7,   -7,   -6,    2,    2/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   21,   -6,   24,   -3/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
      DATA (CF(i,12 ),i=7  ,12 ) /    21,   -6,   -6,   21,   -3,   24/    
C               T[ 5, 1]T[ 2, 8]T[ 7, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     40  ))                                                          
      CALL JIOXXX(W(1,8   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL FVOXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,1   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVOXXX(W(1,7   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,11  ),W(1,52  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
     ...
     &     54  ))                                                          
      ...
      CALL FVIXXX(W(1,8   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      ...
      CALL FVOXXX(W(1,40  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL JIOXXX(W(1,8   ),W(1,59  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(25  ))             
      CALL JVVXXX(W(1,41  ),W(1,51  ),G ,ZERO    ,ZERO    ,W(1,61  ))      
     ...
     &     62  ))                                                          
      ...
      CALL FVIXXX(W(1,11  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL JIOXXX(W(1,64  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,41  ),GG ,BMASS   ,ZERO    ,W(1,67  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,41  ),GG ,AMP(32  ))             
