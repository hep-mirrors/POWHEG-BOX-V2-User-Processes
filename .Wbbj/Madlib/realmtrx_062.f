      SUBROUTINE SREALMTRX_062(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_062/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_062(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_062(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   21,   -3,   21,   -6,   -6/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,    1,   10,    1,    2,   -7/    
C               T[ 7, 8]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   24,   -6,   21,   -6,   -3/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -3,   -6,   24,   -6,   21,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,    1,   -8,    2,   -7/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   21,   -6,   24,   -3,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /     1,   -8,    1,   10,   -7,    2/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   -6,   21,   -3,   24,   21/    
      DATA (CF(i,5  ),i=7  ,12 ) /    10,    1,   -8,    1,   -7,    2/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   -3,   21,   -6,   21,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 8]T[ 2, 1]T[ 7, 6]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,   -7,    1,    1,   10,    2/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   -6,   21,   -6,   21/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,   -7,   10,   -8,    1,    2/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   21,   -6,   21,   -6/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    10,    2,    1,    1,   -8,   -7/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   21,   24,   -3,   21,   -6/    
C               T[ 7, 1]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /     1,    2,   -8,   10,    1,   -7/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   -3,   24,   -6,   21/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /     2,   -6,    2,   -7,   -7,   -6/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   21,   -6,   24,   -3/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -7,   -6,   -7,    2,    2,   -6/    
...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL JIOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
     ...
     &     19  ))                                                          
      ...
      CALL JIOXXX(W(1,19  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      ...
      CALL FVIXXX(W(1,19  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      ...
      CALL JIOXXX(W(1,36  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
     ...
     &     38  ))                                                          
      ...
      CALL JIOXXX(W(1,8   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
     ...
     &     54  ))                                                          
      ...
      CALL JIOXXX(W(1,56  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      ...
      CALL FVOXXX(W(1,14  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
     ...
     &     62  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_062 =REALMTRX_062+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
