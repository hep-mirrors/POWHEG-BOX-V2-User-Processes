      SUBROUTINE SREALMTRX_152(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_152/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_152(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_152(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   21,   21,   -6,   -3/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -7,   -6,   -7,    2,    2,   -6/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   -6,   21,   21/    
      DATA (CF(i,2  ),i=7  ,12 ) /    10,   -7,    1,   -8,    1,    2/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   21,   -6,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   -7,   -8,    1,   10,    2/    
C               T[ 2, 8]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -6,   21,   24,   -3,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -8,    2,    1,   10,    1,   -7/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   -6,   -3,   24,   21/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,    2,   10,    1,   -8,   -7/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -3,   21,   -6,   -6,   21,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     2,   -6,    2,   -7,   -7,   -6/    
C               T[ 5, 8]T[ 1, 7]T[ 2, 6]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -7,   10,    1,   -8,    1,    2/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -6,   -3,   -6,   21,   21/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -6,   -7,   -7,    2,    2,   -6/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -6,   24,   21,   21,   -6,   -3/    
C               T[ 5, 7]T[ 1, 8]T[ 2, 6]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -7,    1,   -8,    1,   10,    2/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -3,   21,   24,   21,   -6,   -6/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /     2,   -8,    1,   10,    1,   -7/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   21,   21,   24,   -3,   -6/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /     2,    1,   10,    1,   -8,   -7/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   -6,   -6,   -3,   24,   21/    
C               T[ 2, 7]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,    2,    2,   -7,   -7,   -6/    
      DATA (CF(i,12 ),i=7  ,12 ) /    21,   -3,   -6,   -6,   21,   24/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     38  ))                                                          
      ...
      CALL JIOXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL FVIXXX(W(1,7   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL FVIXXX(W(1,41  ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     42  ))                                                          
      CALL JIOXXX(W(1,42  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(17  ))             
      CALL FVIXXX(W(1,10  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL JIOXXX(W(1,44  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,45  ),GG ,AMP(18  ))             
      CALL JIOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
     ...
     &     48  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,48  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL FVOXXX(W(1,5   ),W(1,49  ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,40  ),GG ,AMP(20  ))             
      CALL JIOXXX(W(1,41  ),W(1,48  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      ...
      CALL FVIXXX(W(1,8   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL JIOXXX(W(1,53  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,54  ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,2   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL JIOXXX(W(1,8   ),W(1,55  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL JIOXXX(W(1,8   ),W(1,58  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL FVIXXX(W(1,8   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL JIOXXX(W(1,60  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GG ,AMP(27  ))             
      CALL FVOXXX(W(1,48  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,10  ),W(1,65  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,66  ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,65  ),W(1,9   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,67  ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_152 =REALMTRX_152+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
