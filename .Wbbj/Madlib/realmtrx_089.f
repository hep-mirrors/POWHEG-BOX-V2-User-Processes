...
C  
C FOR PROCESS : c~ c -> e+ ve b b~ d u~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
     ...
     &     10  ))                                                          
      CALL JIOXXX(W(1,8   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,14  ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,23  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     25  ))                                                          
      CALL JIOXXX(W(1,8   ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,8   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,27  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      ...
      CALL FVOXXX(W(1,10  ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL JIOXXX(W(1,8   ),W(1,30  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
     ...
     &     33  ))                                                          
      ...
      CALL FVIXXX(W(1,14  ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL JIOXXX(W(1,35  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
