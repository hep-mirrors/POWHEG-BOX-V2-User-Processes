...
C  
C BORN AMPLITUDE IS c d~ -> e+ ve b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,8   ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,12  ),W(1,8   ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      ...
      CALL FVIXXX(W(1,9   ),W(1,8   ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
