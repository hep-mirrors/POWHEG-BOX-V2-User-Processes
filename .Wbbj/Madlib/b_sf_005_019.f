      SUBROUTINE SB_SF_005_019(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_005_019(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_005_019(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,4  ) /   -56,    7,  -57,    6/                
C               T[ 5, 1, 7]T[ 2, 6]                                        
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,4  ) /     7,    7,    6,    6/                
C               T[ 5, 1]T[ 2, 6, 7]                                        
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,4  ) /   -57,    6,  -56,    7/                
C               T[ 2, 6]T[ 5, 1, 7]                                        
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,4  ) /     6,    6,    7,    7/                
C               T[ 5, 1]T[ 2, 6, 7]                                        
C ----------
C BEGIN CODE
C ----------
     ...
     &     23  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_005_019 =B_SF_005_019+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
