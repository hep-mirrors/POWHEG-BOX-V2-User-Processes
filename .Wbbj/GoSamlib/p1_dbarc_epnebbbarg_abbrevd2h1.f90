module     p1_dbarc_epnebbbarg_abbrevd2h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb2(9)=spbk3k1*abb2(7)*spbl5k2*spak1l6
      abb2(10)=spbk4k3*abb2(7)*spak4l6*spbl5k2
      abb2(9)=abb2(9)+abb2(10)
      abb2(10)=gW*TR
      abb2(10)=abb2(3)*abb2(1)*abb2(2)*CVDC*spak1k4*i_*abb2(10)**2
      abb2(9)=4.0_ki*abb2(9)*abb2(10)
      abb2(11)=spbk3k1*spak1l6*abb2(7)
      abb2(7)=spbk4k3*spak4l6*abb2(7)
      abb2(7)=abb2(11)+abb2(7)
      abb2(7)=spbe7l5*abb2(7)
      abb2(11)=NC*spbe7k2
...
end module p1_dbarc_epnebbbarg_abbrevd2h1
