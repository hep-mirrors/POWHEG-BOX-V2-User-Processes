module     p1_dbarc_epnebbbarg_model
   ! Model parameters for the model: /home/tramonta/codes/POWHEG/WBBJ/GoSam_POWH
   ! EG/Virtual/model/model
   ...
   character(len=name_length), dimension(40) :: names = (/& 
      & "alpha  ", &
      & "CVBC   ", &
      & "CVBT   ", &
      & "CVBU   ", &
...
end module p1_dbarc_epnebbbarg_model
