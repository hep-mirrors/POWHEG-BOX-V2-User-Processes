module     p1_dbarc_epnebbbarg_d20h3l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd20h3
      implicit none
      ...
      acc20(8)=acc20(10)+acc20(9)+acc20(1)+acc20(8)
      acc20(8)=Qspvak4k3*acc20(8)
      acc20(9)=Qspvak2k3*acc20(3)
      acc20(10)=Qspk3*acc20(4)
...
!           & sign => diagram20_sign, shift => diagram20_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d20h3l1
