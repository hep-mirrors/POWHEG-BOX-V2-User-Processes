module     p1_dbarc_epnebbbarg_d334h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc334(18)=abb334(64)
      acc334(19)=abb334(90)
      acc334(20)=acc334(3)*Qspvak7k2
      acc334(21)=acc334(6)*Qspval6k7
      acc334(22)=acc334(8)*Qspval6k2
      acc334(23)=acc334(13)*Qspl6
      acc334(24)=acc334(17)*Qspk2
      acc334(25)=Qspval6k3*acc334(15)
      acc334(26)=Qspvak4k2*acc334(16)
      acc334(27)=Qspvak1k2*acc334(12)
      ...
      acc334(22)=acc334(2)*Qspval6k7
      acc334(23)=acc334(4)*Qspval6k2
      acc334(24)=acc334(5)*Qspl6
      acc334(25)=acc334(11)*Qspvak7k2
      acc334(26)=Qspval6e7*acc334(9)
      acc334(27)=Qspvae7k2*acc334(10)
...
!           & sign => diagram334_sign, shift => diagram334_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d334h1l1
