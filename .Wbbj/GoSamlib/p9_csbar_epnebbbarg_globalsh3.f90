module     p9_csbar_epnebbbarg_globalsh3
   use p9_csbar_epnebbbarg_config, only: ki
   use p9_csbar_epnebbbarg_color, only:&
      & c1v => c1,&
      & c2v => c2,&
      & c3v => c3,&
      & c4v => c4
...
subroutine     init_lo()
   use p9_csbar_epnebbbarg_globalsl1, only: epspow, ccontract, amp0
   implicit none
...
end module p9_csbar_epnebbbarg_globalsh3
