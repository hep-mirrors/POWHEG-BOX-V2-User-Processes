module     p5_usbar_epnebbbarg_abbrevd110h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb110(8)=spbl6k2**(-1)
      abb110(9)=TR*gW
      abb110(9)=abb110(9)**2*spbk7e7*i_*spak2e7*CVSU*abb110(3)*abb110(2)*abb110&
      &(1)
...
end module p5_usbar_epnebbbarg_abbrevd110h0
