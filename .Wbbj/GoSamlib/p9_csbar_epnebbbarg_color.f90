module     p9_csbar_epnebbbarg_color
   ! file:      /home/tramonta/codes/POWHEG/WBBJ/GoSam_POWHEG/Virtual/p9_csbar_e
   ! pnebbbarg/common/color.f90
   ! generator: haggies (1.1)
   use p9_csbar_epnebbbarg_config, only: ki
   use p9_csbar_epnebbbarg_model, only: NC, Nf
   implicit none
   save
...
end module p9_csbar_epnebbbarg_color
