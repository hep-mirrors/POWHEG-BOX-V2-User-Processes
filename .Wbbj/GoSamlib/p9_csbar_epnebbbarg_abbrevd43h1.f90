module     p9_csbar_epnebbbarg_abbrevd43h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb43(8)=spbl6k2**(-1)
      abb43(9)=spak2l6**(-1)
      abb43(10)=CVSC*spbk7e7*i_*spak2e7*abb43(5)*abb43(3)*abb43(2)*abb43(1)
      abb43(11)=TR*gW
      abb43(12)=abb43(11)*mB
      abb43(12)=abb43(12)**2
      abb43(13)=abb43(10)*abb43(12)
      abb43(14)=abb43(8)*abb43(13)
      abb43(15)=abb43(4)**2
      ...
      abb43(20)=abb43(19)*spbl5k3
      abb43(21)=spak4k7*abb43(6)
      abb43(22)=abb43(21)*abb43(18)
      abb43(23)=spbl6k3*spak2l6
      ...
      abb43(12)=-spal6k7*abb43(12)
      abb43(13)=-spbl5k2*spal5k7*abb43(37)
...
end module p9_csbar_epnebbbarg_abbrevd43h1
