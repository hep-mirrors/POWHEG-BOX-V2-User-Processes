module     p9_csbar_epnebbbarg_d1h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p9_csbar_epnebbbarg_abbrevd1h2
      implicit none
...
!           & sign => diagram1_sign, shift => diagram1_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p9_csbar_epnebbbarg_d1h2l1
