module     p5_usbar_epnebbbarg_abbrevd125h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb125(7)=TR*gW
      abb125(6)=abb125(7)**2*abb125(6)*abb125(3)*i_*CVSU*abb125(2)*abb125(1)
      abb125(7)=-spak2l5*abb125(6)
      abb125(8)=mB**2
      abb125(9)=-abb125(5)*abb125(8)*abb125(7)
      abb125(6)=abb125(4)*spbl6k2*abb125(8)*abb125(6)
      abb125(8)=-spbl6k2*abb125(7)
      abb125(6)=abb125(6)+abb125(9)-abb125(8)
...
end module p5_usbar_epnebbbarg_abbrevd125h2
