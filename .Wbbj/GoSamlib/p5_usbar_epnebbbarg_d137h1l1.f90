module     p5_usbar_epnebbbarg_d137h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc137(30)=acc137(17)*Qspval6k1
      acc137(31)=acc137(18)*Qspk1
      acc137(32)=acc137(19)*Qspval6l5
...
!           & sign => diagram137_sign, shift => diagram137_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d137h1l1
