module     p5_usbar_epnebbbarg_abbrevd109h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb109(11)=TR*gW
      abb109(11)=abb109(11)**2*spbk7e7*i_*spak2e7*CVSU*abb109(3)*abb109(2)*abb1&
      &09(1)
...
end module p5_usbar_epnebbbarg_abbrevd109h2
