module     p9_csbar_epnebbbarg_d23h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p9_csbar_epnebbbarg_abbrevd23h1
      implicit none
...
!           & sign => diagram23_sign, shift => diagram23_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p9_csbar_epnebbbarg_d23h1l1
