module     p5_usbar_epnebbbarg_abbrevd126h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb126(8)=TR*gW
      abb126(8)=abb126(8)**2*abb126(4)*i_*CVSU*abb126(2)*abb126(1)
      abb126(9)=mB**2
      abb126(10)=abb126(6)*abb126(8)*abb126(9)*spbl5k2*abb126(7)
      abb126(7)=abb126(7)*spak2l6*abb126(8)
      abb126(8)=-abb126(5)*abb126(9)*abb126(7)
      abb126(9)=-spbl5k2*abb126(7)
      ...
      abb126(24)=-spal6k7*abb126(16)
      abb126(21)=abb126(21)+abb126(24)
      abb126(21)=4.0_ki*abb126(21)
      abb126(9)=spak2k4*abb126(9)
      abb126(15)=abb126(15)*spak4l6
...
end module p5_usbar_epnebbbarg_abbrevd126h1
