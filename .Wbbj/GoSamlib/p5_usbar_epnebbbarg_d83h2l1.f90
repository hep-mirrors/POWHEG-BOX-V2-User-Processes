module     p5_usbar_epnebbbarg_d83h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p5_usbar_epnebbbarg_abbrevd83h2
      implicit none
      ...
      acc83(104)=Qspval5l6*acc83(104)
      acc83(105)=-Qspvak2k3*acc83(59)
      acc83(106)=Qspval5k1*acc83(37)
      ...
      acc83(102)=Qspval5l6*acc83(102)
      acc83(103)=Qspvak7k1*acc83(55)
      acc83(104)=Qspval5k1*acc83(23)
...
!           & sign => diagram83_sign, shift => diagram83_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d83h2l1
