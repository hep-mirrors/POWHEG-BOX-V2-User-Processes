module     p1_dbarc_epnebbbarg_d137h0l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd137h0
      implicit none
      ...
      acc137(13)=acc137(8)*Qspvak7k2
      acc137(14)=Qspvae7k2*acc137(5)
      acc137(15)=Qspvak2k7*acc137(1)
      acc137(16)=Qspk7*acc137(9)
      acc137(17)=QspQ*acc137(4)
...
!           & sign => diagram137_sign, shift => diagram137_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d137h0l1
