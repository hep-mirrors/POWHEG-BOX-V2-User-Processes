module     p5_usbar_epnebbbarg_d102h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p5_usbar_epnebbbarg_abbrevd102h2
      implicit none
      ...
      acc102(48)=Qspval5k1*acc102(1)
      acc102(49)=Qspval5l6*acc102(34)
      ...
      acc102(52)=Qspval5k1*acc102(21)
      acc102(53)=Qspval5l6*acc102(30)
      ...
      acc102(49)=Qspval5k1*acc102(38)
      acc102(50)=Qspval5l6*acc102(39)
      ...
      acc102(49)=Qspval5k1*acc102(5)
      acc102(50)=Qspval5l6*acc102(37)
      ...
      acc102(50)=Qspval5k1*acc102(26)
      acc102(51)=Qspval5l6*acc102(28)
...
!           & sign => diagram102_sign, shift => diagram102_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d102h2l1
