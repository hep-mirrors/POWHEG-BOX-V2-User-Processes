module     p9_csbar_epnebbbarg_d229h0l1d
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p9_csbar_epnebbbarg_abbrevd229h0
      implicit none
      ...
      acd229(12)=abb229(22)
      acd229(13)=abb229(167)
      acd229(14)=abb229(252)
      acd229(15)=dotproduct(l6,qshift)
      acd229(16)=abb229(23)
      acd229(17)=abb229(241)
      acd229(18)=dotproduct(k7,qshift)
      acd229(19)=abb229(26)
      acd229(20)=abb229(242)
      acd229(21)=abb229(256)
      acd229(22)=dotproduct(e7,qshift)
      acd229(23)=abb229(21)
      acd229(24)=abb229(218)
      acd229(25)=abb229(24)
      acd229(26)=dotproduct(qshift,qshift)
      acd229(27)=abb229(28)
      acd229(28)=dotproduct(qshift,spval5k2)
      acd229(29)=abb229(41)
      acd229(30)=dotproduct(qshift,spval5l6)
      acd229(31)=abb229(45)
      acd229(32)=dotproduct(qshift,spval5k7)
      acd229(33)=abb229(46)
      acd229(34)=dotproduct(qshift,spval6k2)
      acd229(35)=abb229(44)
      acd229(36)=dotproduct(qshift,spval6l5)
      acd229(37)=abb229(36)
      acd229(38)=dotproduct(qshift,spval6k7)
      acd229(39)=abb229(43)
      acd229(40)=dotproduct(qshift,spvak7k2)
      acd229(41)=abb229(40)
      acd229(42)=dotproduct(qshift,spvae7k2)
      acd229(43)=abb229(38)
      acd229(44)=dotproduct(qshift,spval5e7)
      acd229(45)=abb229(37)
      acd229(46)=dotproduct(qshift,spval6e7)
      acd229(47)=abb229(35)
      acd229(48)=abb229(20)
      acd229(49)=abb229(113)
      acd229(50)=abb229(269)
      acd229(51)=abb229(270)
      acd229(52)=abb229(268)
      acd229(53)=abb229(258)
      acd229(54)=abb229(261)
      acd229(55)=abb229(239)
      acd229(56)=abb229(152)
      acd229(57)=abb229(32)
      acd229(58)=abb229(200)
      acd229(59)=abb229(31)
      acd229(60)=abb229(17)
      acd229(61)=abb229(15)
      acd229(62)=abb229(60)
      acd229(63)=abb229(76)
      acd229(64)=abb229(13)
      acd229(65)=abb229(186)
      acd229(66)=abb229(155)
      acd229(67)=abb229(131)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd229(35)=abb229(41)
      acd229(36)=dotproduct(qshift,spval5l6)
      acd229(37)=abb229(45)
      acd229(38)=dotproduct(qshift,spval5k7)
      acd229(39)=abb229(46)
      acd229(40)=dotproduct(qshift,spval6k2)
      acd229(41)=abb229(44)
      acd229(42)=dotproduct(qshift,spval6l5)
      acd229(43)=abb229(36)
      acd229(44)=dotproduct(qshift,spval6k7)
      acd229(45)=abb229(43)
      acd229(46)=dotproduct(qshift,spvak7k2)
      acd229(47)=abb229(40)
      acd229(48)=dotproduct(qshift,spvae7k2)
      acd229(49)=abb229(38)
      acd229(50)=dotproduct(qshift,spval5e7)
      acd229(51)=abb229(37)
      acd229(52)=dotproduct(qshift,spval6e7)
      acd229(53)=abb229(35)
      acd229(54)=abb229(20)
      acd229(55)=spvak4k1(iv1)
      acd229(56)=abb229(113)
      acd229(57)=abb229(269)
      acd229(58)=abb229(270)
      acd229(59)=abb229(268)
      acd229(60)=abb229(258)
      acd229(61)=abb229(261)
      acd229(62)=abb229(239)
      acd229(63)=abb229(152)
      acd229(64)=abb229(32)
      acd229(65)=abb229(200)
      acd229(66)=abb229(31)
      acd229(67)=spval5k2(iv1)
      acd229(68)=abb229(17)
      acd229(69)=spval5l6(iv1)
      acd229(70)=abb229(15)
      acd229(71)=spval5k7(iv1)
      acd229(72)=abb229(60)
      acd229(73)=spval6k2(iv1)
      acd229(74)=abb229(76)
      acd229(75)=spval6l5(iv1)
      acd229(76)=abb229(13)
      acd229(77)=spval6k7(iv1)
      acd229(78)=abb229(186)
      acd229(79)=spvak7k2(iv1)
      acd229(80)=abb229(155)
      acd229(81)=spvae7k2(iv1)
      acd229(82)=abb229(131)
      acd229(83)=spval5e7(iv1)
      acd229(84)=abb229(109)
      acd229(85)=spval6e7(iv1)
      acd229(86)=abb229(56)
      ...
      acd229(100)=abb229(16)
      acd229(101)=spvak7k1(iv1)
      acd229(102)=abb229(19)
      acd229(103)=spvae7k1(iv1)
      acd229(104)=abb229(39)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd229(19)=k7(iv1)
      acd229(20)=abb229(26)
      acd229(21)=abb229(242)
      acd229(22)=k7(iv2)
      acd229(23)=e7(iv1)
      acd229(24)=abb229(21)
      acd229(25)=abb229(218)
      acd229(26)=e7(iv2)
      acd229(27)=spval5k2(iv2)
      acd229(28)=abb229(41)
      acd229(29)=spval5l6(iv2)
      acd229(30)=abb229(45)
      acd229(31)=spval5k7(iv2)
      acd229(32)=abb229(46)
      acd229(33)=spval6k2(iv2)
      acd229(34)=abb229(44)
      acd229(35)=spval6l5(iv2)
      acd229(36)=abb229(36)
      acd229(37)=spval6k7(iv2)
      acd229(38)=abb229(43)
      acd229(39)=spvak7k2(iv2)
      acd229(40)=abb229(40)
      acd229(41)=spvae7k2(iv2)
      acd229(42)=abb229(38)
      acd229(43)=spval5e7(iv2)
      acd229(44)=abb229(37)
      acd229(45)=spval6e7(iv2)
      acd229(46)=abb229(35)
      acd229(47)=spval5k2(iv1)
      acd229(48)=spval5l6(iv1)
      acd229(49)=spval5k7(iv1)
      acd229(50)=spval6k2(iv1)
      acd229(51)=spval6l5(iv1)
      acd229(52)=spval6k7(iv1)
      acd229(53)=spvak7k2(iv1)
      acd229(54)=spvae7k2(iv1)
      acd229(55)=spval5e7(iv1)
      acd229(56)=spval6e7(iv1)
      acd229(57)=abb229(113)
      acd229(58)=abb229(269)
      acd229(59)=abb229(270)
      acd229(60)=abb229(268)
      acd229(61)=abb229(258)
      acd229(62)=abb229(261)
      acd229(63)=abb229(239)
      acd229(64)=abb229(152)
      acd229(65)=abb229(32)
      acd229(66)=abb229(200)
...
!---#] subroutine reconstruct_d229:
end module     p9_csbar_epnebbbarg_d229h0l1d
