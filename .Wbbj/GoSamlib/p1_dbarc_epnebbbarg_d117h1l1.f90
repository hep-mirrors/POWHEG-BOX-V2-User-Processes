module     p1_dbarc_epnebbbarg_d117h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd117h1
      implicit none
...
!           & sign => diagram117_sign, shift => diagram117_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d117h1l1
