...
C     ----------
      ...
      CALL FFV2_2(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,7),W(1,8),GC_3,AMP(1))
      CALL FFV2_5_3(W(1,5),W(1,4),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,10))
      CALL FFV2_1(W(1,7),W(1,6),GC_100,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,3),W(1,11),W(1,10),GC_62,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,9),W(1,7),W(1,10),-GC_51,GC_59,AMP(3))
      CALL FFV2_3(W(1,3),W(1,7),GC_100,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,8),W(1,9),W(1,6),-GC_3,AMP(4))
      CALL FFS4_3(W(1,5),W(1,4),GC_94,MDL_MH,MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,9),W(1,6),W(1,3),GC_72,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,9),W(1,6),W(1,10),GC_53,AMP(6))
      CALL FFV2_2(W(1,5),W(1,6),GC_100,MDL_MB,ZERO,W(1,3))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,3),W(1,4),W(1,9),GC_100,AMP(7))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,3),W(1,2),W(1,9),GC_100,AMP(8))
      CALL FFV2_2(W(1,1),W(1,9),GC_100,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(9))
      CALL FFV2_3_2(W(1,1),W(1,10),-GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,8),W(1,2),W(1,9),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,10),GC_51,GC_58,AMP(11))
