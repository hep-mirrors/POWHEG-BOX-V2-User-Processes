...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1_1(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,2),W(1,3),W(1,9),GC_100,AMP(8))
      CALL FFV2_1(W(1,1),W(1,9),GC_100,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,3),W(1,8),GC_1,AMP(9))
      CALL FFV2_5_1(W(1,1),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,2),W(1,8),W(1,9),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,10),-GC_51,GC_58,AMP(11))
