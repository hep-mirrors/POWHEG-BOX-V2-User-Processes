...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,6   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,5   ),W(1,4   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,10  ))    
      CALL FVIXXX(W(1,7   ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,6   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,12  ))    
      ...
      CALL JIOXXX(W(1,7   ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,16  ))    
      CALL FVIXXX(W(1,5   ),W(1,16  ),GAU ,TMASS   ,TWIDTH  ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,4   ),W(1,6   ),GG ,AMP(5   ))             
      CALL JIOXXX(W(1,7   ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,18  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL FVIXXX(W(1,22  ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,23  ),W(1,1   ),W(1,6   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,2   ),W(1,10  ),GZD ,ZERO    ,ZERO    ,W(1,24  ))    
      ...
      CALL FVOXXX(W(1,26  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,2   ),W(1,27  ),W(1,6   ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,26  ),W(1,10  ),GZD ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL IOVXXX(W(1,2   ),W(1,28  ),W(1,6   ),GG ,AMP(14  ))             
      CALL JIOXXX(W(1,2   ),W(1,26  ),GAD ,ZERO    ,AWIDTH  ,W(1,29  ))    
      CALL FVIXXX(W(1,5   ),W(1,29  ),GAU ,TMASS   ,TWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,30  ),W(1,4   ),W(1,6   ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,2   ),W(1,26  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
     ...
     &     35  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,35  ),GWF ,ZERO    ,ZERO    ,W(1,36  ))    
      CALL IOVXXX(W(1,36  ),W(1,1   ),W(1,6   ),GG ,AMP(21  ))             
      CALL JVVXXX(W(1,10  ),W(1,3   ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     37  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,37  ),GWF ,ZERO    ,ZERO    ,W(1,38  ))    
     ...
     &     40  ))                                                          
      ...
      CALL IOVXXX(W(1,41  ),W(1,1   ),W(1,6   ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,1   ),W(1,35  ),GWF ,ZERO    ,ZERO    ,W(1,42  ))    
      CALL IOVXXX(W(1,2   ),W(1,42  ),W(1,6   ),GG ,AMP(24  ))             
      CALL FVOXXX(W(1,1   ),W(1,37  ),GWF ,ZERO    ,ZERO    ,W(1,43  ))    
      CALL IOVXXX(W(1,2   ),W(1,43  ),W(1,6   ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,1   ),W(1,40  ),GWF ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL IOVXXX(W(1,2   ),W(1,44  ),W(1,6   ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,45  ))    
     ...
     &     54  ))                                                          
      ...
      CALL FVIXXX(W(1,2   ),W(1,56  ),GWF ,ZERO    ,ZERO    ,W(1,57  ))    
      CALL IOVXXX(W(1,57  ),W(1,1   ),W(1,6   ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,1   ),W(1,56  ),GWF ,ZERO    ,ZERO    ,W(1,58  ))    
      CALL IOVXXX(W(1,2   ),W(1,58  ),W(1,6   ),GG ,AMP(34  ))             
