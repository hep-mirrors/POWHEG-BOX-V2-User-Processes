 ...
 20   wgt=0d0
     ...
     &           abs((wgt-wgt2(i))/wgt).gt.1d-7 ) then
      ...
      enddo
       ...
       subroutine invertic(ic,n)  
       implicit none              
       integer n,ic(n),invic(n)   
       integer j                  
       do j=1,n                   
          invic(ic(j)) = j        
       enddo                      
