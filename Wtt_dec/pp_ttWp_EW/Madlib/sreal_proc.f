 ...
 10   call nexper(nexternal- 3,ic( 3+1),mtc,even)
      ...
      if (str.eq."-12246-60") then
         call srealmtrx_001(p1,wgt)
         goto 20
      elseif (str.eq."-10246-6-2") then
         call srealmtrx_002(p1,wgt)
         goto 20
      elseif (str.eq."2-1246-60") then
         call srealmtrx_003(p1,wgt)
         goto 20
      elseif (str.eq."20246-61") then
         call srealmtrx_004(p1,wgt)
         goto 20
      elseif (str.eq."4-3246-60") then
         call srealmtrx_005(p1,wgt)
         goto 20
      elseif (str.eq."40246-63") then
         call srealmtrx_006(p1,wgt)
         goto 20
      elseif (str.eq."-34246-60") then
         call srealmtrx_007(p1,wgt)
         goto 20
      elseif (str.eq."-30246-6-4") then
         call srealmtrx_008(p1,wgt)
         goto 20
      elseif (str.eq."0-1246-6-2") then
         call srealmtrx_009(p1,wgt)
         goto 20
      elseif (str.eq."02246-61") then
         call srealmtrx_010(p1,wgt)
         goto 20
      elseif (str.eq."04246-63") then
         call srealmtrx_011(p1,wgt)
         goto 20
      elseif (str.eq."0-3246-6-4") then
