...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_004_004(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_004_004(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JIOXXX(W(1,6   ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,7   ),GAU ,AMP(1   ))            
      CALL JIOXXX(W(1,6   ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,8   ))    
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,8   ),GZU ,AMP(2   ))            
      CALL FVOXXX(W(1,1   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL JIOXXX(W(1,2   ),W(1,9   ),GAU ,ZERO    ,AWIDTH  ,W(1,10  ))    
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,10  ),GAU ,AMP(3   ))            
      CALL JIOXXX(W(1,2   ),W(1,9   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,11  ),GZU ,AMP(4   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL FVOXXX(W(1,4   ),W(1,12  ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,5   ),W(1,13  ),W(1,3   ),GWF ,AMP(5   ))            
      CALL JVVXXX(W(1,12  ),W(1,3   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     14  ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,14  ),GAU ,AMP(6   ))            
      CALL JVVXXX(W(1,12  ),W(1,3   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     15  ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,15  ),GZU ,AMP(7   ))            
      CALL HVVXXX(W(1,12  ),W(1,3   ),GWWH ,HMASS   ,HWIDTH  ,W(1,         
     &     16  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,16  ),GHTOP ,AMP(8   ))          
      do i=1,ngraphs
     ...
     &             +AMP(   6)+AMP(   7)+AMP(   8)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_CL_004_004 =B_CL_004_004+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
