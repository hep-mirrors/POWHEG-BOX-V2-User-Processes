...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,6   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,5   ),W(1,4   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,10  ))    
      CALL FVIXXX(W(1,7   ),W(1,10  ),GZD ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,6   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL FVOXXX(W(1,12  ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,6   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,10  ),GZD ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL FVOXXX(W(1,14  ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,2   ),W(1,15  ),W(1,6   ),GG ,AMP(4   ))             
      CALL JIOXXX(W(1,7   ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,16  ))    
      CALL FVIXXX(W(1,5   ),W(1,16  ),GAU ,TMASS   ,TWIDTH  ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,4   ),W(1,6   ),GG ,AMP(5   ))             
      CALL JIOXXX(W(1,7   ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,18  ))    
      ...
      CALL IOVXXX(W(1,7   ),W(1,12  ),W(1,6   ),GG ,AMP(9   ))             
      CALL IOVXXX(W(1,7   ),W(1,14  ),W(1,6   ),GG ,AMP(10  ))             
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL FVIXXX(W(1,22  ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,23  ),W(1,1   ),W(1,6   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,2   ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL FVIXXX(W(1,24  ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,1   ),W(1,6   ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,1   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL FVOXXX(W(1,26  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,2   ),W(1,27  ),W(1,6   ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,26  ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL IOVXXX(W(1,2   ),W(1,28  ),W(1,6   ),GG ,AMP(14  ))             
      CALL JIOXXX(W(1,2   ),W(1,26  ),GAU ,ZERO    ,AWIDTH  ,W(1,29  ))    
      CALL FVIXXX(W(1,5   ),W(1,29  ),GAU ,TMASS   ,TWIDTH  ,W(1,30  ))    
      CALL IOVXXX(W(1,30  ),W(1,4   ),W(1,6   ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,2   ),W(1,26  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
      ...
      CALL IOVXXX(W(1,22  ),W(1,26  ),W(1,6   ),GG ,AMP(19  ))             
      CALL IOVXXX(W(1,24  ),W(1,26  ),W(1,6   ),GG ,AMP(20  ))             
      CALL FVIXXX(W(1,5   ),W(1,3   ),GWF ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL JIOXXX(W(1,35  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,36  ))    
      CALL FVIXXX(W(1,2   ),W(1,36  ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,37  ),W(1,1   ),W(1,6   ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,1   ),W(1,36  ),GWF ,ZERO    ,ZERO    ,W(1,38  ))    
      CALL IOVXXX(W(1,2   ),W(1,38  ),W(1,6   ),GG ,AMP(22  ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,39  ))    
      CALL FVIXXX(W(1,35  ),W(1,39  ),GWF ,TMASS   ,TWIDTH  ,W(1,40  ))    
      CALL IOVXXX(W(1,40  ),W(1,4   ),W(1,6   ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,4   ),W(1,39  ),GWF ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL FVOXXX(W(1,41  ),W(1,3   ),GWF ,TMASS   ,TWIDTH  ,W(1,42  ))    
      CALL IOVXXX(W(1,5   ),W(1,42  ),W(1,6   ),GG ,AMP(24  ))             
      CALL IOVXXX(W(1,35  ),W(1,41  ),W(1,6   ),GG ,AMP(25  ))             
      CALL JVVXXX(W(1,3   ),W(1,8   ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     43  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,43  ),GWF ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL IOVXXX(W(1,44  ),W(1,1   ),W(1,6   ),GG ,AMP(26  ))             
      CALL JVVXXX(W(1,3   ),W(1,10  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     45  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,45  ),GWF ,ZERO    ,ZERO    ,W(1,46  ))    
      CALL IOVXXX(W(1,46  ),W(1,1   ),W(1,6   ),GG ,AMP(27  ))             
     ...
     &     48  ))                                                          
      ...
      CALL IOVXXX(W(1,49  ),W(1,1   ),W(1,6   ),GG ,AMP(28  ))             
      CALL FVOXXX(W(1,1   ),W(1,43  ),GWF ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL IOVXXX(W(1,2   ),W(1,50  ),W(1,6   ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,1   ),W(1,45  ),GWF ,ZERO    ,ZERO    ,W(1,51  ))    
      CALL IOVXXX(W(1,2   ),W(1,51  ),W(1,6   ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,1   ),W(1,48  ),GWF ,ZERO    ,ZERO    ,W(1,52  ))    
      CALL IOVXXX(W(1,2   ),W(1,52  ),W(1,6   ),GG ,AMP(31  ))             
      CALL JVVXXX(W(1,39  ),W(1,3   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     53  ))                                                          
      CALL FVIXXX(W(1,5   ),W(1,53  ),GAU ,TMASS   ,TWIDTH  ,W(1,54  ))    
      CALL IOVXXX(W(1,54  ),W(1,4   ),W(1,6   ),GG ,AMP(32  ))             
      CALL JVVXXX(W(1,39  ),W(1,3   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     55  ))                                                          
      CALL FVIXXX(W(1,5   ),W(1,55  ),GZU ,TMASS   ,TWIDTH  ,W(1,56  ))    
      CALL IOVXXX(W(1,56  ),W(1,4   ),W(1,6   ),GG ,AMP(33  ))             
      CALL HVVXXX(W(1,39  ),W(1,3   ),GWWH ,HMASS   ,HWIDTH  ,W(1,         
     &     57  ))                                                          
      CALL FSIXXX(W(1,5   ),W(1,57  ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     58  ))                                                          
      CALL IOVXXX(W(1,58  ),W(1,4   ),W(1,6   ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,4   ),W(1,53  ),GAU ,TMASS   ,TWIDTH  ,W(1,59  ))    
      CALL IOVXXX(W(1,5   ),W(1,59  ),W(1,6   ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,4   ),W(1,55  ),GZU ,TMASS   ,TWIDTH  ,W(1,60  ))    
      CALL IOVXXX(W(1,5   ),W(1,60  ),W(1,6   ),GG ,AMP(36  ))             
      CALL FSOXXX(W(1,4   ),W(1,57  ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     61  ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,61  ),W(1,6   ),GG ,AMP(37  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)+AMP(   9)
     &             +AMP(  10)+AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
     &             +AMP(  19)+AMP(  20)+AMP(  21)+AMP(  22)+AMP(  26)
     &             +AMP(  27)+AMP(  28)+AMP(  29)+AMP(  30)+AMP(  31)
      JAMP(   2) = +AMP(   5)+AMP(   6)+AMP(   7)+AMP(   8)+AMP(  15)
     &             +AMP(  16)+AMP(  17)+AMP(  18)+AMP(  23)+AMP(  24)
     &             +AMP(  25)+AMP(  32)+AMP(  33)+AMP(  34)+AMP(  35)
     &             +AMP(  36)+AMP(  37)
      REALMTRX_001 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
