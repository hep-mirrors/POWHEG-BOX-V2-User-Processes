      SUBROUTINE SMATRIXHEL2(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
C     Process: d~ u > t t~ e+ ve QCD=0 @2
...
C     
      ...
      COMMON/BORN_BEAM_POL2/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL IS_BORN_HEL_SELECTED2
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED2(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX2(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.-1.OR.IS_BORN_HEL_SELECTED2(IHEL))
     $        THEN
              ANS=ANS+T
            ENDIF
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,1),GC_100,MDL_MW,MDL_WW,W(1,6))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_2,ZERO,ZERO,W(1,8))
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,9),W(1,8),GC_3,AMP(1))
      CALL FFV2_5_3(W(1,5),W(1,4),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,10))
      CALL FFV2_2(W(1,7),W(1,6),GC_100,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,11),W(1,3),W(1,10),GC_62,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,7),W(1,9),W(1,10),-GC_51,GC_59,AMP(3))
      CALL FFV2_3(W(1,7),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,8),W(1,6),W(1,9),-GC_3,AMP(4))
      CALL FFS4_3(W(1,5),W(1,4),GC_94,MDL_MH,MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,6),W(1,9),W(1,3),GC_72,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,6),W(1,9),W(1,10),GC_53,AMP(6))
      CALL FFV2_1(W(1,4),W(1,6),GC_100,MDL_MB,ZERO,W(1,3))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,5),W(1,3),W(1,9),GC_100,AMP(7))
      CALL FFV1_1(W(1,1),W(1,8),GC_1,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,2),W(1,3),W(1,9),GC_100,AMP(8))
      CALL FFV2_1(W(1,1),W(1,9),GC_100,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,3),W(1,8),GC_2,AMP(9))
      CALL FFV2_3_1(W(1,1),W(1,10),-GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,2),W(1,8),W(1,9),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,2),W(1,3),W(1,10),GC_51,GC_58,AMP(11))
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      SUBROUTINE GET_VALUE2(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE INITIALISEMODEL2(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION IS_BORN_HEL_SELECTED2(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
