...
C     
C     Process: u d~ > t t~ e+ ve QCD=0 @1
...
C     
      ...
      COMMON/BORN_BEAM_POL1/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL IS_BORN_HEL_SELECTED1
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED1(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX1(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.-1.OR.IS_BORN_HEL_SELECTED1(IHEL))
     $        THEN
              ANS=ANS+T
            ENDIF
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,3),W(1,2),W(1,9),GC_100,AMP(8))
      CALL FFV2_2(W(1,1),W(1,9),GC_100,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_1,AMP(9))
      CALL FFV2_5_2(W(1,1),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,8),W(1,2),W(1,9),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,10),-GC_51,GC_58,AMP(11))
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      SUBROUTINE GET_VALUE1(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE INITIALISEMODEL1(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION IS_BORN_HEL_SELECTED1(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
