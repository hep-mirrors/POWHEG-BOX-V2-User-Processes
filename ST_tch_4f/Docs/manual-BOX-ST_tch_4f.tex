...
\author{Emanuele Re\\
  ...
  New-e-mail: \email{emanuele.re@physics.ox.ac.uk}\\}
...
can be found within the available processes under the
\tmtexttt{User-Processes-V2} directory, where all processes
implemented or migrated to \tmtexttt{POWHEG-BOX-V2} can be found.
%in the \tmtexttt{POWHEG-BOX/ST\_tch\_4f} subdirectory.
