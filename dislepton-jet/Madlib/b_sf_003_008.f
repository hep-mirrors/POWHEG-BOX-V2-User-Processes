...
C  
C BORN AMPLITUDE IS d d~ -> el- el+ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
     ...
     &     6   ))                                                          
      ...
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,6   ),GAD ,AMP(1   ))            
      CALL JSSXXX(W(1,3   ),W(1,4   ),GZELEL ,ZMASS   ,ZWIDTH  ,W(1,       
     &     8   ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,8   ),GZD ,AMP(2   ))            
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,6   ),GAD ,AMP(3   ))            
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,8   ),GZD ,AMP(4   ))            
      do i=1,ngraphs
