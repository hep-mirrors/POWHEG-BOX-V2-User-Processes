...
cc modification: do not exit, instead write extended output
cc this situation can be caused by limited numerical precision
cc         call pwhg_exit(-1)
         write(*,*) 'in dijterm:'
         write(*,*) 'em   = ', em
         write(*,*) 'rad  = ', rad
         ...
         write(*,*) 'alr  = ', alr
         write(*,*) 'dalr = ', dalr
         write(*,*) 'kn_dijterm(em,rad) = ', kn_dijterm(em,rad)
         write(*,*) 'kn_cmpreal = ', kn_cmpreal
         write(*,*) 'check numerical destructive interference in'
         write(*,*) 'subroutine getdistance ... 1-y^2'
cc
      endif
