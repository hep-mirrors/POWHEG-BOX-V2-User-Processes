...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      numplots = 35  ! <========== DO NOT FORGET TO SET THIS
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
     ...
     $     'LOG',bsz(diag),0d0,2000d0)
      ...
      diag=35
      bsz(diag) = 5d0
      call pwhgbookup(diag+numplots*ncut,'ptl zoom ptW>'//cut,'LOG',
     $     bsz(diag),0d0,100d0)
...
c the 1st and 2nd particle in NLO are the two incoming ones         
         ...
         write(*,*) 'Call to the analysis file by an unknown program'
         write(*,*) 'The POWHEG BOX stops here'
         call exit(1)        
      endif
