...
c      ii=1
c      call intassign(nlegreal,flst_real(1,1),flst_real_tmp(1,ii))
c      do j=2,flst_nreal         
c         do k=1,ii
c           if(flavequiv(nlegreal,flst_real(1,j),flst_real_tmp(1,k)))then
...
c         enddo
c         ii=ii+1
c         call intassign(nlegreal,flst_real(1,j),flst_real_tmp(1,ii))
c 987  continue
c      enddo
c
c      flst_nreal=ii
...
c      do i=1,flst_nreal
c         call intassign(nlegreal,flst_real_tmp(1,i),flst_real(1,i))
c      enddo
