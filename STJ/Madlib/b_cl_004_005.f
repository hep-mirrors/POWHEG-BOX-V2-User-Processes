...
C  
C FOR PROCESS : c1 b1 -> t s1 g g  
C  
C BORN AMPLITUDE IS c1 b1 -> t s1 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      ...
      CALL FVIXXX(W(1,1   ),W(1,6   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
