...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL JIOXXX(W(1,16  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,17  ),G ,AMP(7   ))              
      CALL FVOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,19  ),GWF ,TMASS   ,TWIDTH  ,W(1,21  ))    
      CALL IOVXXX(W(1,21  ),W(1,3   ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,16  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      ...
      JAMP(   2) = -AMP(   1)-AMP(   4)-AMP(   6)-AMP(   7)-AMP(  10)
      JAMP(   3) = -AMP(   2)-AMP(   3)-AMP(   8)-AMP(   9)
      REALMTRX_180 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
