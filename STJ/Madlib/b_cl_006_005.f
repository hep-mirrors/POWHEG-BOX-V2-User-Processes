...
C  
C BORN AMPLITUDE IS b1 u1 -> t d1 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,6   ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,6   ),GWF ,AMP(1   ))            
      CALL JIOXXX(W(1,1   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      ...
      CALL IOVXXX(W(1,1   ),W(1,10  ),W(1,6   ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
