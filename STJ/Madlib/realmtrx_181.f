      SUBROUTINE SREALMTRX_181(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_181/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_181(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_181(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c$$$C               T[ 3, 6, 1]T[ 4, 5, 2]                                     
      DATA Denom(1  )/            1/                                       
      DATA (CF(i,1  ),i=1  ,2  ) /    16,    0/                            
C               T[ 3, 6, 2]T[ 4, 5, 1]                                     
      DATA Denom(2  )/            1/                                       
      DATA (CF(i,2  ),i=1  ,2  ) /     0,   16/                            
C               T[ 3, 6, 1]T[ 4, 5, 2]                                     
C ----------
C BEGIN CODE
C ----------
      ...
      CALL JIOXXX(W(1,5   ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL FVOXXX(W(1,3   ),W(1,12  ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,2   ),GG ,AMP(3   ))             
      CALL IOVXXX(W(1,6   ),W(1,10  ),W(1,12  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL JIOXXX(W(1,14  ),W(1,4   ),GWF ,WMASS   ,WWIDTH  ,W(1,15  ))    
      CALL FVOXXX(W(1,3   ),W(1,15  ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,1   ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,3   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,15  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,19  ),GWF ,AMP(8   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_181 =REALMTRX_181+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
