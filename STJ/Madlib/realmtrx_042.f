...
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,7   ))    
      CALL FVOXXX(W(1,3   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,8   ))    
      ...
      CALL FVIXXX(W(1,10  ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,3   ),W(1,6   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,2   ),W(1,11  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      ...
      CALL FVOXXX(W(1,3   ),W(1,17  ),GWF ,ZERO    ,ZERO    ,W(1,18  ))    
      CALL IOVXXX(W(1,1   ),W(1,18  ),W(1,6   ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,1   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL FVIXXX(W(1,4   ),W(1,19  ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL FVIXXX(W(1,20  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,21  ),W(1,2   ),W(1,6   ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,1   ),W(1,17  ),GWF ,TMASS   ,TWIDTH  ,W(1,22  ))    
      CALL IOVXXX(W(1,22  ),W(1,3   ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,16  ),W(1,19  ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,4   ),W(1,23  ),W(1,6   ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,20  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL VVVXXX(W(1,6   ),W(1,5   ),W(1,24  ),G ,AMP(11  ))              
      CALL IOVXXX(W(1,20  ),W(1,16  ),W(1,6   ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,3   ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,25  ))     
      CALL FVOXXX(W(1,25  ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,1   ),W(1,26  ),W(1,6   ),GG ,AMP(13  ))             
      CALL JIOXXX(W(1,1   ),W(1,25  ),GWF ,WMASS   ,WWIDTH  ,W(1,27  ))    
      CALL FVIXXX(W(1,4   ),W(1,27  ),GWF ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL IOVXXX(W(1,28  ),W(1,2   ),W(1,6   ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,29  ))    
      CALL FVIXXX(W(1,29  ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,30  ))     
      CALL IOVXXX(W(1,30  ),W(1,3   ),W(1,6   ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,2   ),W(1,27  ),GWF ,ZERO    ,ZERO    ,W(1,31  ))    
      CALL IOVXXX(W(1,4   ),W(1,31  ),W(1,6   ),GG ,AMP(16  ))             
      ...
      CALL FVIXXX(W(1,4   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,33  ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,34  ))    
      CALL FVOXXX(W(1,3   ),W(1,34  ),GWF ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL IOVXXX(W(1,1   ),W(1,35  ),W(1,6   ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,33  ),W(1,19  ),GWF ,ZERO    ,ZERO    ,W(1,36  ))    
      CALL IOVXXX(W(1,36  ),W(1,2   ),W(1,6   ),GG ,AMP(20  ))             
      CALL FVIXXX(W(1,1   ),W(1,34  ),GWF ,TMASS   ,TWIDTH  ,W(1,37  ))    
      CALL IOVXXX(W(1,37  ),W(1,3   ),W(1,6   ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,2   ),W(1,19  ),GWF ,ZERO    ,ZERO    ,W(1,38  ))    
      CALL FVOXXX(W(1,38  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,4   ),W(1,39  ),W(1,6   ),GG ,AMP(22  ))             
      CALL JIOXXX(W(1,4   ),W(1,38  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL VVVXXX(W(1,6   ),W(1,5   ),W(1,40  ),G ,AMP(23  ))              
      CALL IOVXXX(W(1,33  ),W(1,38  ),W(1,6   ),GG ,AMP(24  ))             
