...
C  
C FOR PROCESS : b1 c1 -> t s1 u2 u2~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL JIOXXX(W(1,13  ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,14  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
