...
C  
C BORN AMPLITUDE IS d1~ b1 -> t u1~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,3   ),W(1,8   ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,3   ),W(1,5   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))     
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,8   ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,1   ),W(1,6   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
