...
c$$$         call sb_sf_004_006(p_born,wgt)
         wgt=0d0
      elseif ( m.eq.           1  .and. n.eq.           3  ) then
c$$$         call sb_sf_004_007(p_born,wgt)
         wgt=0d0
...
c$$$         call sb_sf_004_010(p_born,wgt)
         wgt=0d0
      elseif ( m.eq.           2  .and. n.eq.           3  ) then
         call sb_sf_004_011(p_born,wgt)
      elseif ( m.eq.           2  .and. n.eq.           4  ) then
c$$$         call sb_sf_004_012(p_born,wgt)
         wgt=0d0
      elseif ( m.eq.           2  .and. n.eq.           5  ) then
         call sb_sf_004_013(p_born,wgt)
      elseif ( m.eq.           3  .and. n.eq.           1  ) then
c$$$         call sb_sf_004_014(p_born,wgt)
         wgt=0d0
      elseif ( m.eq.           3  .and. n.eq.           2  ) then
         call sb_sf_004_015(p_born,wgt)
      elseif ( m.eq.           3  .and. n.eq.           4  ) then
c$$$         call sb_sf_004_016(p_born,wgt)
         wgt=0d0
...
c$$$         call sb_sf_004_019(p_born,wgt)
         wgt=0d0
      elseif ( m.eq.           4  .and. n.eq.           3  ) then
c$$$         call sb_sf_004_020(p_born,wgt)
         wgt=0d0
