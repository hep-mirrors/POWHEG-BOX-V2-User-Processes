      SUBROUTINE ML5_1_MP_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
...
C     
      ...
      COMMON/ML5_1_FILTERS/GOODAMP,GOODHEL
     ...
     $ ,0:NLOOPWAVEFUNCS)
      ...
      COMMON/ML5_1_MP_WL/WL,PL

      COMPLEX*32 AMPL(3,NCTAMPS)
      COMMON/ML5_1_MP_AMPL/AMPL
