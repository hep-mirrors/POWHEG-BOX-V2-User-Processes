      SUBROUTINE ML5_4_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     
      ...
      COMMON/ML5_4_FILTERS/GOODAMP,GOODHEL,HELOFFSET

      LOGICAL CHECKPHASE
      LOGICAL HELDOUBLECHECKED
      COMMON/ML5_4_INIT/CHECKPHASE, HELDOUBLECHECKED
     ...
     $ ,MP_LOOP_REQ_SO_DONE,CTCALL_REQ_SO_DONE,FILTER_SO
      ...
      INTEGER I_SO
      COMMON/ML5_4_I_SO/I_SO
      INTEGER I_LIB
      COMMON/ML5_4_I_LIB/I_LIB

      COMPLEX*16 AMP(NBORNAMPS)
      COMMON/ML5_4_AMPS/AMP
     ...
     $ ,0:NLOOPWAVEFUNCS)
      ...
      COMMON/ML5_4_WL/WL,PL

      COMPLEX*16 AMPL(3,NCTAMPS)
      COMMON/ML5_4_AMPL/AMPL
