      SUBROUTINE ML5_5_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     
      ...
      COMMON/ML5_5_FILTERS/GOODAMP,GOODHEL,HELOFFSET

      LOGICAL CHECKPHASE
      LOGICAL HELDOUBLECHECKED
      COMMON/ML5_5_INIT/CHECKPHASE, HELDOUBLECHECKED
     ...
     $ ,MP_LOOP_REQ_SO_DONE,CTCALL_REQ_SO_DONE,FILTER_SO
      ...
      INTEGER I_SO
      COMMON/ML5_5_I_SO/I_SO
      INTEGER I_LIB
      COMMON/ML5_5_I_LIB/I_LIB

      COMPLEX*16 AMP(NBORNAMPS)
      COMMON/ML5_5_AMPS/AMP
     ...
     $ ,0:NLOOPWAVEFUNCS)
      ...
      COMMON/ML5_5_WL/WL,PL

      COMPLEX*16 AMPL(3,NCTAMPS)
      COMMON/ML5_5_AMPL/AMPL
...
C     Amplitude(s) for born diagram with ID 1
      CALL FFV2_0(W(1,7),W(1,4),W(1,6),GC_47,AMP(1))
      CALL FFV1_1(W(1,4),W(1,5),GC_5,ZERO,ZERO,W(1,8))
C     Amplitude(s) for born diagram with ID 2
      CALL FFV2_0(W(1,2),W(1,8),W(1,6),GC_47,AMP(2))
      CALL FFV1_2(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,2),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,10))
...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL FFV2_0(W(1,7),W(1,4),W(1,6),R2_SXCW,AMPL(1,1))
      CALL FFV2_2(W(1,2),W(1,6),GC_47,ZERO,ZERO,W(1,12))
C     Counter-term amplitude(s) for loop diagram number 6
      CALL R2_QQ_1_0(W(1,12),W(1,8),R2_QQQ,AMPL(1,2))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL FFV2_0(W(1,2),W(1,8),W(1,6),R2_SXCW,AMPL(1,3))
...
C     Counter-term amplitude(s) for loop diagram number 13
      CALL FFV2_0(W(1,2),W(1,4),W(1,13),R2_SXCW,AMPL(1,13))
      CALL FFV2_3(W(1,1),W(1,11),GC_47,MDL_MW,MDL_WW,W(1,14))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL FFV2_0(W(1,2),W(1,4),W(1,14),R2_SXCW,AMPL(1,14))
      CALL FFV2_1(W(1,4),W(1,6),GC_47,ZERO,ZERO,W(1,15))
C     Counter-term amplitude(s) for loop diagram number 15
      CALL R2_QQ_1_0(W(1,7),W(1,15),R2_QQQ,AMPL(1,15))
C     Counter-term amplitude(s) for loop diagram number 16
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,16))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,17))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,18))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,19))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,20))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQT,AMPL(1,21))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQQ_1EPS,AMPL(2,22))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),UV_GQQG_1EPS,AMPL(2,23))
      CALL FFV1_0(W(1,2),W(1,15),W(1,5),R2_GQQ,AMPL(1,24))
