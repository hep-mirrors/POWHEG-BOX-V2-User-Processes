...
C     FUNCTIONS
C     
      INTEGER ML5_2_ML5SOINDEX_FOR_BORN_AMP, ML5_2_ML5SOINDEX_FOR_LOOP_
     $AMP, ML5_2_ML5SQSOINDEX
C     
C     GLOBAL VARIABLES
C     
     ...
     $   ,KIND=8)
        ...
        CONST(ML5_2_ML5SOINDEX_FOR_BORN_AMP(I))=CONST(ML5_2_ML5SOINDEX_
     ...
     $      THEN
          ...
          ENDIF
          CALL ML5_2_MERGE_WL(LOOP_WF,RANK,LCUT_SIZE,CONST(I)
     $     ,LOOPCOEFS(0,ML5_2_ML5SQSOINDEX(I,ML5_2_ML5SOINDEX_FOR_LOOP_
...
C     
     ...
     $      THEN
            CONST(I)=CONST(I)*GOODHEL(HELCONFIG)
          ENDIF
          CALL MP_ML5_2_MERGE_WL(LOOP_WF,RANK,LCUT_SIZE,CONST(I)
     $     ,LOOPCOEFS(0,ML5_2_ML5SQSOINDEX(I,ML5_2_ML5SOINDEX_FOR_LOOP_
     $AMP(COLOR_ID)),LOOP_GROUP_NUMBER))
        ENDIF
      ENDDO
