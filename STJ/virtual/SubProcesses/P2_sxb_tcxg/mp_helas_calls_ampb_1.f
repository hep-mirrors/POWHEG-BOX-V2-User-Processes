...
C      if true.
      ...
      CALL MP_OMLXXX(P(0,1),ZERO,NHEL(1),-1*IC(1),W(1,1))
      ...
      CALL MP_FFV2_3(W(1,4),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,6))
...
C     Amplitude(s) for born diagram with ID 2
      ...
      CALL MP_FFV1_1(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,9))
      CALL MP_FFV2_3(W(1,2),W(1,3),GC_47,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for born diagram with ID 3
      CALL MP_FFV2_0(W(1,4),W(1,9),W(1,10),GC_47,AMP(3))
      CALL MP_FFV1_2(W(1,4),W(1,5),GC_5,ZERO,ZERO,W(1,11))
C     Amplitude(s) for born diagram with ID 4
      CALL MP_FFV2_0(W(1,11),W(1,1),W(1,10),GC_47,AMP(4))
      CALL MP_FFV2_2(W(1,4),W(1,10),GC_47,ZERO,ZERO,W(1,12))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_R2_QQ_1_0(W(1,12),W(1,9),R2_QQQ,AMPL(1,1))
C     Counter-term amplitude(s) for loop diagram number 6
      CALL MP_FFV2_0(W(1,4),W(1,9),W(1,10),R2_SXCW,AMPL(1,2))
C     Counter-term amplitude(s) for loop diagram number 8
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,3))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,4))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,5))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,6))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,7))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQT,AMPL(1,8))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,9))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),UV_GQQG_1EPS,AMPL(2,10))
      CALL MP_FFV1_0(W(1,12),W(1,1),W(1,5),R2_GQQ,AMPL(1,11))
C     Counter-term amplitude(s) for loop diagram number 10
      CALL MP_FFV2_0(W(1,11),W(1,1),W(1,10),R2_SXCW,AMPL(1,12))
      CALL MP_FFV2_3(W(1,7),W(1,3),GC_47,MDL_MW,MDL_WW,W(1,13))
C     Counter-term amplitude(s) for loop diagram number 13
      CALL MP_FFV2_0(W(1,4),W(1,1),W(1,13),R2_SXCW,AMPL(1,13))
      CALL MP_FFV2_3(W(1,2),W(1,8),GC_47,MDL_MW,MDL_WW,W(1,14))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL MP_FFV2_0(W(1,4),W(1,1),W(1,14),R2_SXCW,AMPL(1,14))
      CALL MP_FFV2_1(W(1,1),W(1,10),GC_47,ZERO,ZERO,W(1,15))
C     Counter-term amplitude(s) for loop diagram number 15
      CALL MP_R2_QQ_1_0(W(1,11),W(1,15),R2_QQQ,AMPL(1,15))
...
C     Counter-term amplitude(s) for loop diagram number 23
      ...
      CALL MP_FFV2_3(W(1,4),W(1,9),GC_47,MDL_MW,MDL_WW,W(1,17))
C     Counter-term amplitude(s) for loop diagram number 26
      CALL MP_FFV2_0(W(1,2),W(1,3),W(1,17),R2_SXCW,AMPL(1,37))
      CALL MP_FFV2_3(W(1,11),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,18))
