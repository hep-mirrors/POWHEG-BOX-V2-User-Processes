      SUBROUTINE ML5_9_LOOP_CT_CALLS_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     CutTools call for loop numbers 1,2
      CALL ML5_9_LOOP_3(1,4,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,I_SO,1)
C     CutTools call for loop numbers 3
      CALL ML5_9_LOOP_3(5,7,6,DCMPLX(ZERO),DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,2,I_SO,2)
C     CutTools call for loop numbers 4
      CALL ML5_9_LOOP_2(8,11,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,3)
C     CutTools call for loop numbers 5
      CALL ML5_9_LOOP_3(3,6,8,DCMPLX(MDL_MT),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,2,I_SO,4)
C     CutTools call for loop numbers 6,8
      CALL ML5_9_LOOP_3(2,5,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,2,I_SO,5)
C     CutTools call for loop numbers 7
      CALL ML5_9_LOOP_4(2,5,3,6,DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MT),DCMPLX(ZERO),3,I_SO,6)
C     CutTools call for loop numbers 9
      CALL ML5_9_LOOP_4(2,3,6,5,DCMPLX(ZERO),DCMPLX(MDL_MT)
     $ ,DCMPLX(ZERO),DCMPLX(ZERO),3,I_SO,7)
C     CutTools call for loop numbers 10
      CALL ML5_9_LOOP_4(2,3,5,6,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),DCMPLX(MDL_MT),3,I_SO,8)
C     CutTools call for loop numbers 11
      CALL ML5_9_LOOP_2(7,12,DCMPLX(ZERO),DCMPLX(MDL_MT),1,I_SO,9)
C     CutTools call for loop numbers 12
      CALL ML5_9_LOOP_3(2,3,12,DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,DCMPLX(MDL_MT),2,I_SO,10)
C     CutTools call for loop numbers 13
      CALL ML5_9_LOOP_3(2,3,12,DCMPLX(ZERO),DCMPLX(MDL_MT),DCMPLX(ZERO)
     $ ,2,I_SO,11)
