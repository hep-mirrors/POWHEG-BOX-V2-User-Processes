      SUBROUTINE ML5_9_COEF_CONSTRUCTION_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL ML5_9_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,1))
      CALL FFV1L3_1(PL(0,1),W(1,4),GC_5,ZERO,ZERO,PL(0,2),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL FFV2L2_1(PL(0,2),W(1,9),GC_47,ZERO,ZERO,PL(0,3),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,3),2,4,1,1,1,31,H)
C     Coefficient construction for loop diagram with ID 4
      CALL FFV2L2_1(PL(0,2),W(1,10),GC_47,ZERO,ZERO,PL(0,4),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,4))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,4),2,4,1,1,1,32,H)
C     Coefficient construction for loop diagram with ID 5
      CALL FFV1L2P0_3(PL(0,0),W(1,5),GC_5,ZERO,ZERO,PL(0,5),COEFS)
      CALL ML5_9_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,5))
      CALL FFV1L3_1(PL(0,5),W(1,7),GC_5,MDL_MT,MDL_WT,PL(0,6),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,6))
      CALL FFV2L2_1(PL(0,6),W(1,6),GC_47,ZERO,ZERO,PL(0,7),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,7))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,7),2,4,2,1,1,33,H)
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L2P0_3(PL(0,0),W(1,8),GC_5,ZERO,ZERO,PL(0,8),COEFS)
      CALL ML5_9_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,8))
      CALL FFV1L3_1(PL(0,8),W(1,11),GC_5,ZERO,ZERO,PL(0,9),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,8),4,COEFS,4,4,WL(1,0,1,9))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,9),1,4,3,1,1,34,H)
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L3_1(PL(0,0),W(1,3),GC_5,MDL_MT,MDL_WT,PL(0,10),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,10))
      CALL FFV2L2_1(PL(0,10),W(1,6),GC_47,ZERO,ZERO,PL(0,11),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,11))
      CALL FFV1L2P0_3(PL(0,11),W(1,8),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL ML5_9_UPDATE_WL_2_0(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,12))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,12),2,4,4,1,1,35,H)
C     Coefficient construction for loop diagram with ID 8
      CALL FFV1L2_1(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,13))
      CALL FFV1L2P0_3(PL(0,13),W(1,5),GC_5,ZERO,ZERO,PL(0,14),COEFS)
      CALL ML5_9_UPDATE_WL_1_0(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1,14))
      CALL FFV1L3_1(PL(0,14),W(1,11),GC_5,ZERO,ZERO,PL(0,15),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1,15))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,15),2,4,5,1,1,36,H)
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L3_1(PL(0,14),W(1,3),GC_5,MDL_MT,MDL_WT,PL(0,16),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1,16))
      CALL FFV2L2_1(PL(0,16),W(1,6),GC_47,ZERO,ZERO,PL(0,17),COEFS)
      CALL ML5_9_UPDATE_WL_2_1(WL(1,0,1,16),4,COEFS,4,4,WL(1,0,1,17))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,17),3,4,6,1,1,37,H)
C     Coefficient construction for loop diagram with ID 10
      CALL VVV1L2P0_1(PL(0,0),W(1,2),GC_4,ZERO,ZERO,PL(0,18),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,18))
      CALL FFV1L3_2(PL(0,18),W(1,5),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,18),4,COEFS,4,4,WL(1,0,1,19))
      CALL FFV1L1P0_3(PL(0,19),W(1,11),GC_5,ZERO,ZERO,PL(0,20),COEFS)
      CALL ML5_9_UPDATE_WL_2_0(WL(1,0,1,19),4,COEFS,4,4,WL(1,0,1,20))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,20),2,4,5,1,1,38,H)
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L3_1(PL(0,18),W(1,3),GC_5,MDL_MT,MDL_WT,PL(0,21),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,18),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV2L2_1(PL(0,21),W(1,6),GC_47,ZERO,ZERO,PL(0,22),COEFS)
      CALL ML5_9_UPDATE_WL_2_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL FFV1L2P0_3(PL(0,22),W(1,5),GC_5,ZERO,ZERO,PL(0,23),COEFS)
      CALL ML5_9_UPDATE_WL_3_0(WL(1,0,1,22),4,COEFS,4,4,WL(1,0,1,23))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,23),3,4,7,1,1,39,H)
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L1_2(PL(0,0),W(1,2),GC_5,MDL_MT,MDL_WT,PL(0,24),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,24))
      CALL FFV1L1P0_3(PL(0,24),W(1,3),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL ML5_9_UPDATE_WL_1_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,25))
      CALL FFV1L3_2(PL(0,25),W(1,5),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1,26))
      CALL FFV2L1_2(PL(0,26),W(1,6),GC_47,MDL_MT,MDL_WT,PL(0,27),COEFS)
      CALL ML5_9_UPDATE_WL_2_1(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1,27))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,27),3,4,8,1,1,40,H)
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1P0_3(PL(0,0),W(1,7),GC_5,ZERO,ZERO,PL(0,28),COEFS)
      CALL ML5_9_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,28))
      CALL FFV1L3_2(PL(0,28),W(1,12),GC_5,MDL_MT,MDL_WT,PL(0,29),COEFS)
      CALL ML5_9_UPDATE_WL_0_1(WL(1,0,1,28),4,COEFS,4,4,WL(1,0,1,29))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,29),1,4,9,1,1,41,H)
C     Coefficient construction for loop diagram with ID 14
      CALL FFV1L3_2(PL(0,25),W(1,12),GC_5,MDL_MT,MDL_WT,PL(0,30),COEFS)
      CALL ML5_9_UPDATE_WL_1_1(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1,30))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,30),2,4,10,1,1,42,H)
C     Coefficient construction for loop diagram with ID 15
      CALL FFV1L2P0_3(PL(0,21),W(1,12),GC_5,ZERO,ZERO,PL(0,31),COEFS)
      CALL ML5_9_UPDATE_WL_2_0(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,31))
      CALL ML5_9_CREATE_LOOP_COEFS(WL(1,0,1,31),2,4,11,1,1,43,H)
