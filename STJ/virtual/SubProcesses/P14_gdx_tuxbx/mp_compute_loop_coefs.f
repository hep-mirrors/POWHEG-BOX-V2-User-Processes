      SUBROUTINE ML5_14_MP_COMPUTE_LOOP_COEFS(PS,ANSDP)
C     
...
C     
     ...
     $ ,0:NLOOPWAVEFUNCS)
      ...
      COMMON/ML5_14_LCOEFS/DP_LOOPCOEFS
...
C         Handle the possible requirement of specific polarizations
     ...
     $      THEN
          ...
          IF (COMPUTE_INTEGRAND_IN_QP) THEN
            CALL ML5_14_MP_HELAS_CALLS_AMPB_1(MP_P,NHEL,H,IC)
            CONTINUE
          ELSE
 ...
 2000     CONTINUE
          ...
          IF (COMPUTE_INTEGRAND_IN_QP) THEN
            CALL ML5_14_MP_HELAS_CALLS_UVCT_1(MP_P,NHEL,H,IC)
            CONTINUE
          ELSE
...
C            containers (but only those needed)
 ...
 3000     CONTINUE
     ...
     $           ,0.0E0_16,KIND=16)
                ...
                ITEMP = ML5_14_ML5SQSOINDEX(ML5_14_ML5SOINDEX_FOR_LOOP_
     $AMP(I),ML5_14_ML5SOINDEX_FOR_BORN_AMP(J))
     ...
     $               ,KIND=8)
          ...
          IF (COMPUTE_INTEGRAND_IN_QP) THEN
            ...
            CALL ML5_14_MP_COEF_CONSTRUCTION_1(MP_P,NHEL,H,IC)
