...
C
C###############################################################################
      subroutine imlxxx(p, fmass, nhel, nsf ,fi)
c
...
c
      ...
      subroutine mp_imlxxx(p, fmass, nhel, nsf ,fi)
c
c This subroutine computes a fermion wavefunction with the flowing-IN
...
c
      ...
      subroutine omlxxx(p,fmass,nhel,nsf , fo)
c
...
c
      ...
      subroutine mp_omlxxx(p,fmass,nhel,nsf , fo)
c
c This subroutine computes a fermion wavefunction with the flowing-OUT
c fermion number in quadruple precision.
c
...
c construct eps0
     ...
     &                                + rTwo*e0(i)*e0(j) )
      ...
      subroutine vmlxxx(p,vmass,nhel,nsv , vc)
c
...
c
      ...
      subroutine mp_vmlxxx(p,vmass,nhel,nsv , vc)
c
