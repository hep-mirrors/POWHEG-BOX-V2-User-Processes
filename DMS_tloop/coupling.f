...
c--- alpha-s will be determined again (in coupling2).
      ...
      include 'MCFM_Include/nlooprun.f'
      include 'MCFM_Include/ewinput.f'
      include 'MCFM_Include/nflav.f'
c      include 'MCFM_Include/b0.f'
      character*4 part,mypart
      common/part/part
      integer i

      double precision aemmz,gw!,alphas,amz,cmass,bmass
...
c      as=alphas(abs(scale),amz,nlooprun)
c      ason2pi=as/twopi
c      ason4pi=as/fourpi
c      gsq=fourpi*as
