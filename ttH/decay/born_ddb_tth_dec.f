      SUBROUTINE BORN_DDB_TTH_DEC(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ddb_tth_dec/  amp2,       jamp2

      character*79         hel_buff
      common/to_helicity_ddb_tth_dec/  hel_buff

      integer          isum_hel
      common/to_ddb_tth_dec/isum_hel
      DATA NTRY,IDUM /0,-1/
...
c      CALL SWITCHMOM(P1,P,IC(1,IPROC),JC,NEXTERNAL)
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=DDB_TTH_DEC(P ,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION DDB_TTH_DEC(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     17  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          DDB_TTH_DEC =DDB_TTH_DEC+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
