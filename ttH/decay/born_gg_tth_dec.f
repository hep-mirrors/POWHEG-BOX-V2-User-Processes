      SUBROUTINE BORN_GG_TTH_DEC(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> b e+ ve b~ e- ve~ h  
C  
C Crossing   1 is g g -> b e+ ve b~ e- ve~ h  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gg_tth_dec/  amp2,       jamp2

      character*79         hel_buff
      common/to_helicity_gg_tth_dec/  hel_buff

      integer          isum_hel
      logical                    multi_channel
      common/to_gg_tth_dec/isum_hel
...
c     CALL SWITCHMOM(P1,P,IC(1,IPROC),JC,NEXTERNAL)
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=GG_TTH_DEC(P ,NHEL(1,IHEL),JC(1))                      
      ...
      REAL*8 FUNCTION GG_TTH_DEC(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FSOXXX(W(1,12  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     13  ))                                                          
      CALL FVOXXX(W(1,13  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,11  ),GWF ,AMP(1   ))            
      CALL FVOXXX(W(1,12  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))     
      CALL FSOXXX(W(1,16  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     17  ))                                                          
      CALL FVOXXX(W(1,17  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,11  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,19  ))     
      CALL FSOXXX(W(1,19  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     20  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,11  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,21  ))     
      CALL FVOXXX(W(1,21  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,11  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,12  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,23  ))     
      CALL FSOXXX(W(1,23  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     24  ))                                                          
      CALL FVOXXX(W(1,24  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,11  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,23  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,26  ))     
      CALL FSOXXX(W(1,26  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     27  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,11  ),GWF ,AMP(6   ))            
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,28  ))      
      CALL FVOXXX(W(1,13  ),W(1,28  ),GG ,TMASS   ,TWIDTH  ,W(1,29  ))     
      CALL IOVXXX(W(1,6   ),W(1,29  ),W(1,11  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,12  ),W(1,28  ),GG ,TMASS   ,TWIDTH  ,W(1,30  ))     
      CALL FSOXXX(W(1,30  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     31  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,11  ),GWF ,AMP(8   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          GG_TTH_DEC =GG_TTH_DEC+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
