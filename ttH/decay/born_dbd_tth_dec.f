      SUBROUTINE BORN_DBD_TTH_DEC(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ d -> b e+ ve b~ e- ve~ h  
C  
C Crossing   1 is d~ d -> b e+ ve b~ e- ve~ h  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dbd_tth_dec/  amp2,       jamp2

      character*79         hel_buff
      common/to_helicity_dbd_tth_dec/  hel_buff

      integer          isum_hel
      common/to_dbd_tth_dec/isum_hel
...
c      CALL SWITCHMOM(P1,P,IC(1,IPROC),JC,NEXTERNAL)
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=DBD_TTH_DEC(P ,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION DBD_TTH_DEC(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,11  ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL FSOXXX(W(1,13  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL FVOXXX(W(1,14  ),W(1,10  ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,12  ),GWF ,AMP(1   ))            
      CALL FVOXXX(W(1,13  ),W(1,10  ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))     
      CALL FSOXXX(W(1,16  ),W(1,9   ),GHTOP ,TMASS   ,TWIDTH  ,W(1,        
     &     17  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,12  ),GWF ,AMP(2   ))            
      JAMP(   1) = -AMP(   1)-AMP(   2)
      DBD_TTH_DEC = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          DBD_TTH_DEC =DBD_TTH_DEC+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
