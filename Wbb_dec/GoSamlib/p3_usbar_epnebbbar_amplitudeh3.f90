module    p3_usbar_epnebbbar_amplitudeh3
   use p3_usbar_epnebbbar_config, only: ki, &
       & reduction_interoperation
   use p3_usbar_epnebbbar_color, only: numcs
   use p3_usbar_epnebbbar_groups
   use precision, only: ki_sam => ki
   use p3_usbar_epnebbbar_samuraih3
   use precision_golem, only: ki_gol => ki
   use p3_usbar_epnebbbar_golem95h3
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      use p3_usbar_epnebbbar_util, only: square
      use p3_usbar_epnebbbar_color, only: CF, CA
      use p3_usbar_epnebbbar_kinematics, only: &
      & num_light_quarks, num_gluons
      use p3_usbar_epnebbbar_diagramsh3l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
      use p3_usbar_epnebbbar_config, only: include_eps_terms, include_eps2_terms, &
      & logfile, debug_nlo_diagrams
      use p3_usbar_epnebbbar_globalsl1, only: amp0,perm, use_perm, epspow
      use p3_usbar_epnebbbar_globalsh3, &
     & only: init_lo, rat2
      use p3_usbar_epnebbbar_abbrevd14h3, only: init_abbrevd14 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd33h3, only: init_abbrevd33 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd3h3, only: init_abbrevd3 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd2h3, only: init_abbrevd2 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd27h3, only: init_abbrevd27 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd28h3, only: init_abbrevd28 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd31h3, only: init_abbrevd31 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd1h3, only: init_abbrevd1 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd4h3, only: init_abbrevd4 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd6h3, only: init_abbrevd6 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd8h3, only: init_abbrevd8 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd9h3, only: init_abbrevd9 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd10h3, only: init_abbrevd10 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd24h3, only: init_abbrevd24 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd25h3, only: init_abbrevd25 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd26h3, only: init_abbrevd26 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd29h3, only: init_abbrevd29 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd30h3, only: init_abbrevd30 => init_abbrev
      use p3_usbar_epnebbbar_abbrevd32h3, only: init_abbrevd32 => init_abbrev
      use p3_usbar_epnebbbar_diagramsh3l0, only: amplitudel0 => amplitude
      use p3_usbar_epnebbbar_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   use p3_usbar_epnebbbar_config, only: &
      & logfile, debug_nlo_diagrams
   use p3_usbar_epnebbbar_globalsl1, only: epspow
   use parametre, only: mu2_scale_par
   use form_factor_type, only: form_factor
   use p3_usbar_epnebbbar_golem95h3, only: reconstruct_golem95 => reconstruct_group
   use p3_usbar_epnebbbar_groups, only: contract_golem95, &
      & global_coeffs => coeffs_group0, &
      & reduce_numetens => reduce_numetens_group0
   use p3_usbar_epnebbbar_samuraih3, only: samurai_reduce => reduce_group0
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p3_usbar_epnebbbar_samuraih3, only: samurai_reduce => reduce_group1
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p3_usbar_epnebbbar_samuraih3, only: samurai_reduce => reduce_group2
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p3_usbar_epnebbbar_samuraih3, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p3_usbar_epnebbbar_samuraih3, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
!---#] subroutine evaluate_group4:
end module p3_usbar_epnebbbar_amplitudeh3
