module     p1_dbarc_epnebbbar_d3h1l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity1d3h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbar_abbrevd3h1
      implicit none
      ...
      acc3(38)=Qspval6l5*acc3(38)
      acc3(35)=acc3(35)+acc3(15)
      acc3(35)=acc3(35)*acc3(36)
      acc3(39)=Qspvak1l5*acc3(32)
      acc3(40)=Qspval6k2*acc3(24)
...
!           & sign => diagram3_sign, shift => diagram3_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbar_d3h1l1
