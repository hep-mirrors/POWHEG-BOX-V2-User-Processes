module     p1_dbarc_epnebbbar_d2h2l1d
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity2d2h2l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p1_dbarc_epnebbbar_abbrevd2h2
      implicit none
      ...
      acd2(11)=abb2(35)
      acd2(12)=dotproduct(qshift,spval5l6)
      acd2(13)=abb2(33)
      acd2(14)=abb2(13)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd2(49)=abb2(11)
      acd2(50)=spval5k2(iv1)
      acd2(51)=abb2(34)
      acd2(52)=spval5l6(iv1)
      acd2(53)=abb2(26)
      acd2(54)=abb2(31)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd2(31)=spval5k2(iv1)
      acd2(32)=spval5l6(iv1)
      acd2(33)=k3(iv2)
      acd2(34)=abb2(27)
      acd2(35)=k4(iv2)
      acd2(36)=qshift(iv2)
      ...
      acd2(50)=abb2(41)
      acd2(51)=abb2(29)
      acd2(52)=dotproduct(qshift,spval5l6)
      acd2(53)=abb2(30)
...
!---#] subroutine reconstruct_d2:
end module     p1_dbarc_epnebbbar_d2h2l1d
