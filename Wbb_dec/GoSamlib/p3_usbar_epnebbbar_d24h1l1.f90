module     p3_usbar_epnebbbar_d24h1l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p3_usbar_epnebbbar/helicity1d24h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc24(7)=abb24(22)
      acc24(8)=abb24(23)
      acc24(9)=acc24(8)*Qspval6k3
      acc24(10)=acc24(7)*Qspvak4k3
      acc24(11)=acc24(6)*Qspval6k1
      acc24(12)=acc24(3)*Qspvak2k1
      acc24(13)=acc24(2)*Qspvak2k3
      acc24(14)=acc24(1)*Qspvak4k1
      acc24(15)=-Qspk4+Qspk1-Qspk3
      acc24(15)=acc24(5)*acc24(15)
...
!           & sign => diagram24_sign, shift => diagram24_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p3_usbar_epnebbbar_d24h1l1
