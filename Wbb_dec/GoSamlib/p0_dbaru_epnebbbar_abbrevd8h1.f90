module     p0_dbaru_epnebbbar_abbrevd8h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb8(7)=spbl6k2**(-1)
      abb8(8)=spak1k4*es12
      abb8(9)=spak4l5*spbl5k2*spak1k2
      abb8(8)=abb8(8)-abb8(9)
      abb8(8)=abb8(8)*abb8(7)
      abb8(9)=spak1k2*spak4l6
      abb8(8)=abb8(8)-abb8(9)
      abb8(9)=abb8(2)*c1
      abb8(10)=abb8(9)-c2
      ...
      abb8(13)=spak1l6*spak2k4*abb8(10)
      abb8(8)=abb8(8)+abb8(13)+abb8(11)
      abb8(8)=abb8(8)*abb8(5)
      abb8(11)=abb8(7)*spbl5k2
      abb8(13)=abb8(11)*abb8(6)
      abb8(14)=spak1l6*abb8(10)*abb8(13)*spak2k4
      abb8(8)=abb8(8)+abb8(14)
      abb8(14)=mB**2
      abb8(8)=abb8(8)*abb8(14)
      abb8(15)=spbl5k1*spak1k4
      abb8(16)=spbl6l5*spak4l6
      abb8(15)=abb8(15)-abb8(16)
      abb8(15)=-spak1l6*abb8(15)*abb8(10)
      abb8(8)=abb8(8)+abb8(15)
      abb8(15)=gW*TR
      abb8(15)=i_*abb8(15)**2*abb8(1)*abb8(3)*abb8(4)*CVDU
      ...
      abb8(21)=spak1l6*spbl6l5*abb8(20)
      abb8(23)=abb8(14)*abb8(5)
      abb8(24)=-abb8(23)*spak1k2*abb8(20)
      abb8(21)=abb8(21)+abb8(24)
      abb8(21)=abb8(21)*abb8(18)
      abb8(11)=abb8(11)*spak1k2
      abb8(24)=-abb8(23)*abb8(18)*abb8(11)*abb8(20)
      abb8(13)=abb8(13)+abb8(5)
      abb8(14)=abb8(14)*spak1l6
      abb8(15)=-8.0_ki*abb8(15)*abb8(14)*abb8(10)*abb8(13)
      abb8(25)=spak1l6*spbl6l5*abb8(10)
      abb8(26)=-abb8(23)*spak1k2*abb8(10)
      abb8(25)=abb8(25)+abb8(26)
      abb8(25)=abb8(25)*abb8(17)
      abb8(11)=-abb8(17)*abb8(23)*abb8(11)*abb8(10)
      abb8(13)=-abb8(18)*abb8(14)*abb8(20)*abb8(13)
      abb8(14)=spak1l6*spbl5k1*abb8(20)
      abb8(20)=abb8(7)*es12
      ...
      abb8(9)=abb8(9)*abb8(23)
      abb8(10)=spak1l6*spbl5k1*abb8(10)
...
end module p0_dbaru_epnebbbar_abbrevd8h1
