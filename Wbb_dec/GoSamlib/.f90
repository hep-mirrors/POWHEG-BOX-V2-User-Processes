program test
   use p3_usbar_epnebbbar_config, only: ki, logfile
   use p3_usbar_epnebbbar_kinematics, only: dotproduct
   use p3_usbar_epnebbbar_model, only: parse
   use p3_usbar_epnebbbar_matrix, only: samplitude, &
     & initgolem, ir_subtraction
   use p3_usbar_epnebbbar_color, only: numcs, CA
   use p3_usbar_epnebbbar_rambo, only: ramb
