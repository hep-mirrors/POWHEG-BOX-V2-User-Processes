module     p0_dbaru_epnebbbar_d28h0l1d
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p0_dbaru_epnebbbar/helicity0d28h0l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p0_dbaru_epnebbbar_abbrevd28h0
      implicit none
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(3) :: acd28
      complex(ki) :: brack
      acd28(1)=spval5k2(iv1)
      acd28(2)=abb28(7)
      brack=-acd28(2)*acd28(1)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd28(2)=spval5k2(iv2)
      acd28(3)=abb28(6)
      acd28(4)=spvak1k2(iv2)
      acd28(5)=spval5k2(iv1)
      acd28(6)=spvak4k2(iv2)
      acd28(7)=abb28(8)
      acd28(8)=spvak4k2(iv1)
      acd28(9)=acd28(1)*acd28(2)
      acd28(10)=acd28(4)*acd28(5)
      acd28(9)=acd28(9)+acd28(10)
      acd28(9)=acd28(3)*acd28(9)
      acd28(10)=acd28(6)*acd28(5)
      acd28(11)=acd28(8)*acd28(2)
      acd28(10)=acd28(11)+acd28(10)
      acd28(10)=acd28(7)*acd28(10)
...
!---#] subroutine reconstruct_d28:
end module     p0_dbaru_epnebbbar_d28h0l1d
