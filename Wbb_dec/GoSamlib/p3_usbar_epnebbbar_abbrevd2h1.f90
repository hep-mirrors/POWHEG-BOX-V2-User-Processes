module     p3_usbar_epnebbbar_abbrevd2h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb2(4)=spak2l5**(-1)
      abb2(5)=spbl6k2**(-1)
      abb2(6)=spbl5k3*spak3k4
      abb2(7)=spbl5k1*spak1k4
      abb2(6)=abb2(6)-abb2(7)
      abb2(6)=abb2(6)*spak2l6
      abb2(7)=abb2(2)*c1
      abb2(7)=c2-abb2(7)
      abb2(8)=gW*TR
      abb2(7)=abb2(7)*abb2(8)**2*i_*abb2(3)*CVSU
      ...
      abb2(17)=spbl5k1*spak1k2
      abb2(18)=abb2(17)*spak4l6
      ...
      abb2(32)=spak2k4*spbl5k3*abb2(7)
      abb2(33)=abb2(32)*abb2(12)
      abb2(32)=abb2(32)*abb2(10)
      abb2(34)=abb2(17)*spak3l6
      ...
      abb2(35)=spbl5k3*spak2k3
      abb2(36)=spak2k4*spbl5k4
      abb2(35)=abb2(17)+abb2(35)+abb2(36)
      abb2(35)=-abb2(35)*abb2(22)
      abb2(36)=es12-es23
      abb2(36)=abb2(36)*spbl5k3
      abb2(37)=abb2(17)*spbk3k2
      abb2(36)=abb2(36)+abb2(37)
      abb2(36)=abb2(36)*spak2l6
      abb2(17)=abb2(17)*spak1l6
      ...
      abb2(36)=spak2l6*spbl5k4*abb2(22)
      abb2(26)=-abb2(26)*abb2(17)
      abb2(37)=-spak4l6*abb2(8)
      abb2(38)=abb2(37)*abb2(12)
      abb2(37)=-abb2(37)*abb2(10)
      abb2(39)=spak4l6*spbk4k1
      abb2(40)=spbk3k1*spak3l6
...
end module p3_usbar_epnebbbar_abbrevd2h1
