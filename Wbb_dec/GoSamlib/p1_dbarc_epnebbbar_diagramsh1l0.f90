module     p1_dbarc_epnebbbar_diagramsh1l0
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity1diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(7)=NC**(-1)
      abb(8)=abb(2)*spak2k4*spbl5k2
      abb(9)=spak3k4*abb(2)
      abb(10)=abb(9)*spbl5k3
      abb(8)=abb(8)-abb(10)
      abb(8)=abb(8)*spak1l6*spbk3k2
      abb(10)=spbk4k3*spak4l6
      abb(11)=spbk3k1*spak1l6
      abb(10)=abb(10)+abb(11)
      abb(10)=spak1k4*abb(6)*spbl5k2*abb(10)
      abb(11)=mB*spbk3k2
      abb(9)=abb(11)**2*abb(9)*spak1k2*abb(5)*abb(4)
      abb(8)=-abb(9)+abb(8)-abb(10)
      abb(8)=abb(8)*i_*TR*CVDC*abb(3)*abb(1)*gW**2
      abb(8)=4.0_ki*abb(8)
      abb(9)=-abb(7)*abb(8)
...
!---#] function amplitude:
end module p1_dbarc_epnebbbar_diagramsh1l0
