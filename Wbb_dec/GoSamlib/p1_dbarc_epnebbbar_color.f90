module     p1_dbarc_epnebbbar_color
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/G
   ! oSam_POWHEG/Virtual/p1_dbarc_epnebbbar/common/color.f90
   ! generator: haggies (1.1)
   use p1_dbarc_epnebbbar_config, only: ki
   use p1_dbarc_epnebbbar_model, only: NC, Nf
   implicit none
   save
...
end module p1_dbarc_epnebbbar_color
