module     p0_dbaru_epnebbbar_color
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/G
   ! oSam_POWHEG/Virtual/p0_dbaru_epnebbbar/common/color.f90
   ! generator: haggies (1.1)
   use p0_dbaru_epnebbbar_config, only: ki
   use p0_dbaru_epnebbbar_model, only: NC, Nf
   implicit none
   save
...
end module p0_dbaru_epnebbbar_color
