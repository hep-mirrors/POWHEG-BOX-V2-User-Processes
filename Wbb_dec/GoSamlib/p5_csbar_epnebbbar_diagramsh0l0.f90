module     p5_csbar_epnebbbar_diagramsh0l0
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p5_csbar_epnebbbar/helicity0diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(7)=NC**(-1)
      abb(8)=spbk4k3*spak4l5
      abb(9)=spbk3k2*spak2l5
      abb(8)=abb(8)+abb(9)
      abb(8)=abb(8)*abb(5)
      abb(9)=spbk4k3*spak4l6
      abb(10)=spbk3k2*spak2l6
      abb(9)=abb(9)+abb(10)
      abb(9)=abb(9)*abb(4)
      abb(8)=abb(8)+abb(9)
      abb(8)=abb(2)*abb(8)*spak2k4
      abb(9)=abb(5)*spak2l5
      abb(10)=abb(4)*spak2l6
      abb(9)=abb(10)+abb(9)
      abb(9)=abb(9)*abb(6)*spbk3k1
      abb(10)=abb(9)*spak1k4
      abb(8)=abb(8)-abb(10)
      abb(10)=-spbk2k1*abb(8)
      abb(9)=abb(9)*spbk3k2*spak3k4
      abb(10)=abb(10)+abb(9)
      abb(11)=abb(3)*abb(1)*gW**2
      abb(11)=4.0_ki*abb(11)
      abb(11)=abb(11)*CVSC*mB*TR*i_
      abb(10)=abb(10)*abb(11)
      abb(8)=spbk2k1*abb(7)*abb(8)
      abb(9)=-abb(7)*abb(9)
      abb(8)=abb(8)+abb(9)
      abb(8)=abb(8)*abb(11)
...
!---#] function amplitude:
end module p5_csbar_epnebbbar_diagramsh0l0
