module     p3_usbar_epnebbbar_diagramsh2l0
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p3_usbar_epnebbbar/helicity2diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(7)=NC**(-1)
      abb(8)=abb(2)*spbk3k2*spak2l5
      abb(9)=spbk4k3*abb(2)
      abb(10)=abb(9)*spak4l5
      abb(8)=abb(8)+abb(10)
      abb(8)=abb(8)*spbl6k1*spak2k4
      abb(10)=spak3k4*spbl6k3
      abb(11)=spak1k4*spbl6k1
      abb(10)=abb(10)-abb(11)
      abb(10)=spbk3k1*abb(6)*spak2l5*abb(10)
      abb(11)=mB*spak2k4
      abb(9)=abb(11)**2*abb(9)*spbk2k1*abb(5)*abb(4)
      abb(8)=abb(9)+abb(8)+abb(10)
      abb(8)=abb(8)*i_*TR*CVSU*abb(3)*abb(1)*gW**2
      abb(8)=4.0_ki*abb(8)
      abb(9)=-abb(7)*abb(8)
...
!---#] function amplitude:
end module p3_usbar_epnebbbar_diagramsh2l0
