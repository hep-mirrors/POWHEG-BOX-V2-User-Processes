module     p1_dbarc_epnebbbar_d24h2l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity2d24h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc24(8)=abb24(19)
      acc24(9)=abb24(20)
      acc24(10)=acc24(9)*Qspval5l6
      acc24(11)=acc24(8)*Qspk2
      acc24(12)=acc24(7)*Qspvak4l6
      acc24(13)=acc24(6)*Qspvak1l6
      acc24(14)=acc24(4)*Qspval5k2
...
!           & sign => diagram24_sign, shift => diagram24_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbar_d24h2l1
