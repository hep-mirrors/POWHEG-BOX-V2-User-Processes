module     p1_dbarc_epnebbbar_d29h0l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity0d29h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbar_abbrevd29h0
      implicit none
      ...
      acc29(2)=abb29(7)
      acc29(3)=abb29(8)
      acc29(4)=acc29(3)*Qspvak4k2
      acc29(5)=acc29(1)*Qspvak1k2
      acc29(4)=acc29(5)+acc29(4)+acc29(2)
      brack=Qspval6k2*acc29(4)
...
!           & sign => diagram29_sign, shift => diagram29_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbar_d29h0l1
