module     p5_csbar_epnebbbar_diagramsh3l0
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p5_csbar_epnebbbar/helicity3diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(8)=4.0_ki*i_
      abb(9)=gW*spak2k4
      abb(7)=abb(7)*abb(9)**2*abb(8)*spbk4k3*TR*abb(3)*abb(1)*abb(2)*CVSC*mB
      abb(8)=abb(6)*abb(7)
...
!---#] function amplitude:
end module p5_csbar_epnebbbar_diagramsh3l0
