module     p3_usbar_epnebbbar_dipoles
   use p3_usbar_epnebbbar_config, only: ki
   use p3_usbar_epnebbbar_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T5, &
       & T1T6, &
       ...
       & T2T6, &
       & T5T6
   use p3_usbar_epnebbbar_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p3_usbar_epnebbbar_dipoles
