module     p1_dbarc_epnebbbar_golem95h3
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p1_dbarc_epnebbbar_d14h3l1, only: numerator_d14 => numerator_golem95
   use p1_dbarc_epnebbbar_d14h3l1d, only: reconstruct_d14
   use p1_dbarc_epnebbbar_d33h3l1, only: numerator_d33 => numerator_golem95
   use p1_dbarc_epnebbbar_d33h3l1d, only: reconstruct_d33
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p1_dbarc_epnebbbar_d3h3l1, only: numerator_d3 => numerator_golem95
   use p1_dbarc_epnebbbar_d3h3l1d, only: reconstruct_d3
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p1_dbarc_epnebbbar_d2h3l1, only: numerator_d2 => numerator_golem95
   use p1_dbarc_epnebbbar_d2h3l1d, only: reconstruct_d2
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p1_dbarc_epnebbbar_d27h3l1, only: numerator_d27 => numerator_golem95
   use p1_dbarc_epnebbbar_d27h3l1d, only: reconstruct_d27
   use p1_dbarc_epnebbbar_d28h3l1, only: numerator_d28 => numerator_golem95
   use p1_dbarc_epnebbbar_d28h3l1d, only: reconstruct_d28
   use p1_dbarc_epnebbbar_d31h3l1, only: numerator_d31 => numerator_golem95
   use p1_dbarc_epnebbbar_d31h3l1d, only: reconstruct_d31
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p1_dbarc_epnebbbar_d1h3l1, only: numerator_d1 => numerator_golem95
   use p1_dbarc_epnebbbar_d1h3l1d, only: reconstruct_d1
   use p1_dbarc_epnebbbar_d4h3l1, only: numerator_d4 => numerator_golem95
   use p1_dbarc_epnebbbar_d4h3l1d, only: reconstruct_d4
   use p1_dbarc_epnebbbar_d6h3l1, only: numerator_d6 => numerator_golem95
   use p1_dbarc_epnebbbar_d6h3l1d, only: reconstruct_d6
   use p1_dbarc_epnebbbar_d8h3l1, only: numerator_d8 => numerator_golem95
   use p1_dbarc_epnebbbar_d8h3l1d, only: reconstruct_d8
   use p1_dbarc_epnebbbar_d9h3l1, only: numerator_d9 => numerator_golem95
   use p1_dbarc_epnebbbar_d9h3l1d, only: reconstruct_d9
   use p1_dbarc_epnebbbar_d10h3l1, only: numerator_d10 => numerator_golem95
   use p1_dbarc_epnebbbar_d10h3l1d, only: reconstruct_d10
   use p1_dbarc_epnebbbar_d24h3l1, only: numerator_d24 => numerator_golem95
   use p1_dbarc_epnebbbar_d24h3l1d, only: reconstruct_d24
   use p1_dbarc_epnebbbar_d25h3l1, only: numerator_d25 => numerator_golem95
   use p1_dbarc_epnebbbar_d25h3l1d, only: reconstruct_d25
   use p1_dbarc_epnebbbar_d26h3l1, only: numerator_d26 => numerator_golem95
   use p1_dbarc_epnebbbar_d26h3l1d, only: reconstruct_d26
   use p1_dbarc_epnebbbar_d29h3l1, only: numerator_d29 => numerator_golem95
   use p1_dbarc_epnebbbar_d29h3l1d, only: reconstruct_d29
   use p1_dbarc_epnebbbar_d30h3l1, only: numerator_d30 => numerator_golem95
   use p1_dbarc_epnebbbar_d30h3l1d, only: reconstruct_d30
   use p1_dbarc_epnebbbar_d32h3l1, only: numerator_d32 => numerator_golem95
   use p1_dbarc_epnebbbar_d32h3l1d, only: reconstruct_d32
   implicit none
...
!---#] subroutine reconstruct_group4:
end module p1_dbarc_epnebbbar_golem95h3
