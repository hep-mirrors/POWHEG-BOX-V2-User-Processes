module     p1_dbarc_epnebbbar_d24h3l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p1_dbarc_epnebbbar/helicity3d24h3l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbar_abbrevd24h3
      implicit none
      ...
      acc24(10)=acc24(7)*acc24(10)
      acc24(11)=Qspvak4l6*acc24(9)
      acc24(12)=Qspvak4l5*acc24(3)
      acc24(13)=Qspvak2l6*acc24(6)
      acc24(14)=Qspvak2l5*acc24(4)
      acc24(15)=Qspvak1l6*acc24(5)
      acc24(16)=Qspvak1l5*acc24(2)
      acc24(17)=Qspk2*acc24(8)
      brack=acc24(1)+acc24(10)+acc24(11)+acc24(12)+acc24(13)+acc24(14)+acc24(15&
      &)+acc24(16)+acc24(17)
...
!           & sign => diagram24_sign, shift => diagram24_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbar_d24h3l1
