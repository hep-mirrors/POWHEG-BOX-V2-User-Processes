module     p0_dbaru_epnebbbar_diagramsh0l0
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbb/GoSam &
   ! &_POWHEG/Virtual/p0_dbaru_epnebbbar/helicity0diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(8)=4.0_ki*i_
      abb(9)=gW*spbk3k2
      abb(7)=abb(7)*abb(9)**2*abb(8)*spak3k4*TR*abb(3)*abb(1)*abb(2)*CVDU*mB
      abb(8)=abb(6)*abb(7)
...
!---#] function amplitude:
end module p0_dbaru_epnebbbar_diagramsh0l0
