module    p0_dbaru_epnebbbar_amplitudeh0
   use p0_dbaru_epnebbbar_config, only: ki, &
       & reduction_interoperation
   use p0_dbaru_epnebbbar_color, only: numcs
   use p0_dbaru_epnebbbar_groups
   use precision, only: ki_sam => ki
   use p0_dbaru_epnebbbar_samuraih0
   use precision_golem, only: ki_gol => ki
   use p0_dbaru_epnebbbar_golem95h0
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p0_dbaru_epnebbbar_diagramsh0l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p0_dbaru_epnebbbar_abbrevd14h0, only: init_abbrevd14 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd33h0, only: init_abbrevd33 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd3h0, only: init_abbrevd3 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd2h0, only: init_abbrevd2 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd27h0, only: init_abbrevd27 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd28h0, only: init_abbrevd28 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd31h0, only: init_abbrevd31 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd1h0, only: init_abbrevd1 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd4h0, only: init_abbrevd4 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd6h0, only: init_abbrevd6 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd8h0, only: init_abbrevd8 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd9h0, only: init_abbrevd9 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd10h0, only: init_abbrevd10 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd24h0, only: init_abbrevd24 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd25h0, only: init_abbrevd25 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd26h0, only: init_abbrevd26 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd29h0, only: init_abbrevd29 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd30h0, only: init_abbrevd30 => init_abbrev
      use p0_dbaru_epnebbbar_abbrevd32h0, only: init_abbrevd32 => init_abbrev
      use p0_dbaru_epnebbbar_diagramsh0l0, only: amplitudel0 => amplitude
      use p0_dbaru_epnebbbar_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbar_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p0_dbaru_epnebbbar_groups, only: contract_golem95, &
      & global_coeffs => coeffs_group0, &
      & reduce_numetens => reduce_numetens_group0
   use p0_dbaru_epnebbbar_samuraih0, only: samurai_reduce => reduce_group0
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbar_samuraih0, only: samurai_reduce => reduce_group1
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbar_samuraih0, only: samurai_reduce => reduce_group2
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbar_samuraih0, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbar_samuraih0, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
!---#] subroutine evaluate_group4:
end module p0_dbaru_epnebbbar_amplitudeh0
