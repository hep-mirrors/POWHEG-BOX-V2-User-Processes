module     p0_dbaru_epnebbbar_model
   ! Model parameters for the model: /home/pcl305a/luisonig/Documents/GoSamPowhe
   ! g/POWHEG-BOX-V2/Wbb/GoSam_POWHEG/Virtual/model/model
   ...
   integer, parameter, private :: name_length = max(5,24)
   character(len=name_length), dimension(39) :: names = (/& 
      & "alpha", &
      & "CVBC ", &
      & "CVBT ", &
      & "CVBU ", &
...
end module p0_dbaru_epnebbbar_model
