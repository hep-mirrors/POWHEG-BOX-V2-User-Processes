...
C ----------
     ...
     &     9   ))                                                          
      CALL FVIXXX(W(1,7   ),W(1,9   ),GZD ,BMASS   ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,10  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,11  ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,9   ),GZD ,BMASS   ,ZERO    ,W(1,12  ))    
      CALL JIOXXX(W(1,7   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,13  ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,1   ),W(1,9   ),GZU ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,14  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,9   ),GZU ,AMP(4   ))            
