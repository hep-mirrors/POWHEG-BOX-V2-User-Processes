...
C ----------
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,9   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,2   ),GG ,AMP(1   ))             
      CALL JVVXXX(W(1,7   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL FVOXXX(W(1,1   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,12  ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,13  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,7   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,13  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,2   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,9   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,10  ),GZD ,AMP(5   ))            
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,10  ),GZD ,AMP(6   ))            
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL FVOXXX(W(1,18  ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,7   ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,18  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
