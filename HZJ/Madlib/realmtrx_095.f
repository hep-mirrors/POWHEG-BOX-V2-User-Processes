...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,13  ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,1   ),W(1,9   ),GZU ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,14  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,9   ),GZU ,AMP(4   ))            
