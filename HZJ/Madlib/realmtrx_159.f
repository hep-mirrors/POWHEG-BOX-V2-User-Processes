...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
     ...
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,12  ))    
      CALL JIOXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,13  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,1   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,14  ))    
      CALL JIOXXX(W(1,14  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,15  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,10  ),GZD ,AMP(4   ))            
      CALL JIOXXX(W(1,2   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,17  ),GG ,AMP(5   ))             
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,18  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,19  ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,1   ),W(1,19  ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
