...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,9   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL FVIXXX(W(1,12  ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,1   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,11  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,7   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,11  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,1   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,10  ),GZD ,AMP(5   ))            
      CALL FVIXXX(W(1,12  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
