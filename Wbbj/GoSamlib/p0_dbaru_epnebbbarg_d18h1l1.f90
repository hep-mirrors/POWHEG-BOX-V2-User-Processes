module     p0_dbaru_epnebbbarg_d18h1l1
   ...
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity1d18h1l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d18h1l1_ninja")
