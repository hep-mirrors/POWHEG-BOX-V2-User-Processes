...
contains
   ...
   & bind(C,name="olp_start_")
      ...
      use p0_dbaru_epnebbbarg_config, only: p0_dbaru_epnebbbarg_PSP_rescue => PSP_rescue, &
           ...
           & p0_dbaru_epnebbbarg_PSP_chk_th1 => PSP_chk_th1, &
           & p0_dbaru_epnebbbarg_PSP_chk_th2 => PSP_chk_th2, &
           & p0_dbaru_epnebbbarg_PSP_chk_th3 => PSP_chk_th3, &
      ...
      ! p0_dbaru_epnebbbarg_PSP_chk_kfactor = PSP_chk_kfactor
      if(stage.lt.0) then
         call p0_dbaru_epnebbbarg_initgolem(.true.)
      else
         call p0_dbaru_epnebbbarg_initgolem(.true.,stage,rndseed)
      end if
   ...
   use p0_dbaru_epnebbbarg_version, only: gosamversion, gosamrevision
   ...
   & bind(C,name="olp_setparameter_")
      use, intrinsic :: iso_c_binding
      use p0_dbaru_epnebbbarg_model, only: p0_dbaru_epnebbbarg_set_parameter => set_parameter
      implicit none
      ...
      call p0_dbaru_epnebbbarg_set_parameter(variable_name(1:l),real_part,imag_part,success)
   ...
   & bind(C,name="olp_finalize_")
      ...
      implicit none
      call p0_dbaru_epnebbbarg_exitgolem(.true.)
   ...
   subroutine     eval0(momenta, mu, parameters, res, acc, blha1_mode)
      use, intrinsic :: iso_c_binding
      use p0_dbaru_epnebbbarg_config, only: ki, PSP_chk_th3, nlo_prefactors
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p0_dbaru_epnebbbarg_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
      ...
      if(present(acc)) then
         ...
         if(prec.lt.PSP_chk_th3) then
            ! Give back a zero so that point is discarded
            amp(2)= 0.0_ki
        end if
   ...
   subroutine     eval1(momenta, mu, parameters, res, acc, blha1_mode)
      ...
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p1_dbarg_epnebbbarubar_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
   ...
   subroutine     eval2(momenta, mu, parameters, res, acc, blha1_mode)
      ...
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p2_udbar_epnebbbarg_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
   ...
   subroutine     eval3(momenta, mu, parameters, res, acc, blha1_mode)
      ...
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p3_ug_epnebbbard_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
   ...
   subroutine     eval4(momenta, mu, parameters, res, acc, blha1_mode)
      ...
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p4_gdbar_epnebbbarubar_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
   ...
   subroutine     eval5(momenta, mu, parameters, res, acc, blha1_mode)
      ...
      use p0_dbaru_epnebbbarg_model, only: parseline
      use p0_dbaru_epnebbbarg_kinematics, only: boost_to_cms
      use p5_gu_epnebbbard_matrix, only: samplitude, OLP_spin_correlated_lo2, OLP_color_correlated
      use p0_dbaru_epnebbbarg_groups, only: tear_down_golem95
      use p0_dbaru_epnebbbarg_groups, only: ninja_exit
   ...
   subroutine OLP_Polvec(p,q,eps) &
      ...
      use p0_dbaru_epnebbbarg_kinematics, only: Spab3, Spaa  
      implicit none
   ...
   subroutine OLP_PrintParameter(filename) &
      ...
      use, intrinsic :: iso_c_binding
      use p0_dbaru_epnebbbarg_model, only: p0_dbaru_epnebbbarg_print_parameter => print_parameter
      implicit none
      ...
      write (27, "(A)") "####### Setup of SubProcess p0_dbaru_epnebbbarg #######"
      call p0_dbaru_epnebbbarg_print_parameter(.true.,27)
      write (27, *)
