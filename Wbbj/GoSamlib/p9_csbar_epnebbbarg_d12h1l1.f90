module     p9_csbar_epnebbbarg_d12h1l1
...
!           & sign => diagram12_sign, shift => diagram12_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p9_csbar_epnebbbarg_d12h1l1
