module     p0_dbaru_epnebbbarg_d223h2l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity2d223h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc223(18)=abb223(40)
      acc223(19)=abb223(49)
      acc223(20)=acc223(2)*Qspval5k2
      acc223(21)=acc223(15)*Qspk2
      acc223(22)=acc223(17)*Qspval5l6
      acc223(23)=Qspvak4l6*acc223(7)
      acc223(24)=Qspvak4k2*acc223(10)
      acc223(25)=Qspvak1l6*acc223(4)
      ...
      acc223(24)=acc223(12)*Qspval5k2
      acc223(25)=acc223(14)*Qspval5l6
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d223h2l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_dbaru_epnebbbarg_d223h2l1
