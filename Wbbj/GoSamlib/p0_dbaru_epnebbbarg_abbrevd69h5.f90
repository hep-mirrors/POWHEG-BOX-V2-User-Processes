module     p0_dbaru_epnebbbarg_abbrevd69h5
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb69(17)=-abb69(16)*spbl5k2
      abb69(18)=spal6k7*abb69(17)
      abb69(19)=abb69(18)*spak3k4
      abb69(20)=abb69(19)*spak1l6
      abb69(21)=abb69(20)*spbl6k3
      abb69(22)=abb69(11)*spal6k7
      abb69(23)=c2-c4
      abb69(24)=spbk3k2**2
      ...
      abb69(29)=2.0_ki*spbk7l5
      abb69(30)=abb69(29)*abb69(28)
      abb69(31)=abb69(11)*spbl5k2
      abb69(32)=abb69(31)*spal6k7
      ...
      abb69(13)=abb69(13)*spak1l5
      abb69(39)=abb69(53)*spbl6k2
      ...
      abb69(85)=abb69(83)*spak1l6
      abb69(20)=abb69(85)+abb69(20)
      abb69(20)=abb69(20)*spbl6k3
      ...
      abb69(29)=2.0_ki*spak2l5
      abb69(43)=-abb69(43)*abb69(29)
      abb69(56)=-spbl5k3*spak2k4*abb69(62)
      ...
      abb69(58)=abb69(36)*abb69(7)
      abb69(64)=abb69(58)*abb69(17)
      abb69(74)=abb69(23)*spak1l6
      abb69(81)=abb69(74)*spbl6k3
      ...
      abb69(43)=abb69(24)*abb69(27)
      abb69(67)=-8.0_ki*abb69(43)*abb69(30)
      abb69(88)=16.0_ki*abb69(43)
      abb69(85)=abb69(85)*abb69(63)
      abb69(43)=abb69(85)+abb69(43)
      abb69(85)=8.0_ki*abb69(43)
      abb69(43)=-4.0_ki*abb69(43)
      abb69(17)=abb69(17)*spak2k4
      abb69(89)=abb69(16)*spbl5k3
      abb69(94)=-spak3k4*abb69(89)
      abb69(94)=-abb69(17)+abb69(94)
      abb69(94)=spak1l5*abb69(94)
      abb69(95)=spbl6k2*abb69(42)
      abb69(77)=-abb69(91)+abb69(95)-abb69(77)
      abb69(77)=abb69(16)*abb69(77)
      abb69(37)=abb69(5)*abb69(37)*abb69(8)
      abb69(91)=-abb69(7)*abb69(38)
      ...
      abb69(17)=abb69(7)*abb69(17)
      abb69(36)=abb69(48)*abb69(16)
      abb69(38)=abb69(23)*abb69(42)
      abb69(42)=abb69(45)*abb69(11)
      abb69(38)=-abb69(42)+2.0_ki*abb69(36)-3.0_ki*abb69(38)
      abb69(38)=spbl6k3*abb69(38)
      abb69(37)=abb69(89)*abb69(37)
      abb69(10)=abb69(10)*abb69(82)
      abb69(9)=abb69(72)*abb69(9)
      abb69(9)=abb69(10)-abb69(9)
      abb69(10)=spbl5k3*abb69(9)*abb69(66)
      abb69(45)=abb69(23)*abb69(66)
      abb69(48)=abb69(11)*spbl5k3
      abb69(27)=-abb69(27)*abb69(48)
      abb69(27)=abb69(45)+abb69(27)
      abb69(27)=spbk7k3*abb69(27)
      abb69(45)=spak1l5*spak3k4*abb69(11)*spbl5k3**2
      abb69(10)=abb69(37)+abb69(38)+abb69(17)+abb69(45)+abb69(27)+abb69(10)+abb&
      &69(57)
      abb69(10)=4.0_ki*abb69(10)
      abb69(17)=abb69(48)*spak1k4
      abb69(17)=8.0_ki*abb69(17)
      abb69(27)=abb69(93)*abb69(48)
      abb69(37)=-spak2k4*abb69(81)
      abb69(36)=abb69(36)-abb69(42)
      abb69(36)=spbl5k3*abb69(36)
      abb69(36)=abb69(37)+abb69(36)
      abb69(36)=8.0_ki*abb69(36)
      abb69(37)=abb69(41)*spbk4k2
      abb69(37)=abb69(37)-abb69(78)
      abb69(38)=abb69(30)*abb69(37)
      abb69(42)=-spak1k3*abb69(75)
      abb69(45)=abb69(92)*spak1l6
      abb69(51)=-abb69(45)*abb69(51)
      abb69(55)=abb69(61)*abb69(55)
      abb69(14)=abb69(40)*abb69(14)
      abb69(14)=abb69(42)+abb69(55)+abb69(14)+abb69(51)+abb69(38)
      abb69(14)=4.0_ki*abb69(14)
      abb69(38)=abb69(18)*spak1k3
      abb69(42)=abb69(61)*spbl6k2
      abb69(51)=abb69(45)*abb69(50)
      abb69(40)=abb69(40)*spak1l5
      abb69(37)=-abb69(51)+abb69(42)-abb69(38)+abb69(40)+abb69(37)
      abb69(38)=-8.0_ki*abb69(37)
      abb69(40)=-4.0_ki*abb69(37)
      abb69(37)=2.0_ki*abb69(37)
      abb69(42)=-spak1k7*abb69(59)
      abb69(51)=-spbl6k2*abb69(74)
      abb69(55)=spbk4k2*spak1k4
      abb69(57)=-abb69(23)*abb69(55)
      abb69(60)=-spak1l5*abb69(92)
      abb69(42)=abb69(57)+abb69(51)+abb69(42)+abb69(60)
      abb69(42)=spak2l6*abb69(42)
      abb69(51)=abb69(53)*abb69(35)
      abb69(51)=abb69(51)-abb69(62)
      abb69(51)=spak1k2*abb69(51)
      abb69(57)=-spal5k7*abb69(74)
      abb69(53)=-spak1k7*abb69(53)
      abb69(60)=spbl6k2*spak1l6
      abb69(66)=abb69(22)*abb69(60)
      abb69(53)=abb69(66)+abb69(53)+abb69(57)
      abb69(57)=spak1l5*abb69(15)
      abb69(53)=abb69(57)+2.0_ki*abb69(53)
      abb69(53)=spbk7l5*abb69(53)
      abb69(57)=-spbk7k3*abb69(15)
      abb69(32)=abb69(57)+abb69(32)
      abb69(32)=spak1k3*abb69(32)
      abb69(57)=-abb69(30)*abb69(9)*abb69(70)
      abb69(59)=abb69(59)*abb69(76)*abb69(50)
      abb69(62)=-abb69(62)*abb69(58)
      abb69(66)=spbk7l6*abb69(61)
      abb69(70)=-spbk7k4*abb69(41)
      abb69(29)=abb69(45)*abb69(29)
      abb69(29)=abb69(70)+abb69(66)+abb69(29)+abb69(32)+abb69(62)+abb69(53)+abb&
      &69(59)+abb69(51)+abb69(57)+abb69(42)
      abb69(29)=4.0_ki*abb69(29)
      abb69(32)=16.0_ki*abb69(74)
      abb69(42)=abb69(9)*abb69(69)
      abb69(42)=4.0_ki*abb69(42)+abb69(74)
      abb69(42)=4.0_ki*abb69(42)
      abb69(45)=-2.0_ki*abb69(74)
      abb69(51)=spak1k3*abb69(16)
      abb69(53)=-abb69(55)+abb69(60)
      abb69(53)=abb69(11)*abb69(53)
      abb69(9)=spak1k7*abb69(9)
      abb69(55)=-spak1l5*abb69(23)
      abb69(9)=abb69(51)-3.0_ki*abb69(9)+abb69(55)+abb69(53)
      abb69(9)=4.0_ki*abb69(9)
      abb69(51)=abb69(11)*abb69(35)
      abb69(51)=abb69(51)-abb69(23)
      abb69(51)=spak1k2*abb69(51)
      abb69(53)=spbk7l5*spak1k7
      abb69(55)=spbl6l5*spak1l6
      abb69(57)=-spbl5k4*spak1k4
      abb69(55)=abb69(57)-3.0_ki*abb69(55)+abb69(53)
      abb69(55)=abb69(11)*abb69(55)
      abb69(57)=-abb69(23)*abb69(58)
      abb69(48)=-spak1k3*abb69(48)
      abb69(48)=abb69(48)+abb69(57)+abb69(51)+abb69(55)
      abb69(48)=4.0_ki*abb69(48)
      abb69(23)=-8.0_ki*abb69(23)*abb69(76)
      ...
      abb69(50)=abb69(30)*abb69(73)
      abb69(51)=abb69(53)*abb69(54)
      abb69(41)=abb69(41)*spbk4k3
      abb69(53)=abb69(61)*spbl6k3
      abb69(15)=abb69(80)*abb69(15)
      abb69(54)=abb69(22)*abb69(84)
      abb69(12)=-abb69(12)-abb69(53)-abb69(18)-abb69(54)+abb69(35)+abb69(51)+ab&
      &b69(41)+abb69(50)+abb69(15)
      ...
      abb69(50)=abb69(64)*spak1k2
      abb69(51)=-abb69(50)*abb69(30)
      abb69(53)=-spak1k2*abb69(90)
      abb69(51)=abb69(53)+abb69(51)
      abb69(51)=16.0_ki*abb69(51)
      abb69(44)=abb69(11)*abb69(44)
      abb69(53)=7.0_ki*abb69(50)+abb69(44)
      abb69(53)=4.0_ki*abb69(53)
      abb69(44)=abb69(50)-abb69(44)
      abb69(44)=2.0_ki*abb69(44)
      abb69(50)=spak1k7*abb69(63)
      abb69(54)=-4.0_ki*spak1k7*abb69(16)
      abb69(18)=-spak1k2*abb69(18)
      abb69(16)=abb69(47)*abb69(16)
      abb69(47)=abb69(16)*abb69(30)
      abb69(55)=spak3k4*abb69(90)
      abb69(47)=abb69(55)+abb69(47)
      abb69(47)=8.0_ki*abb69(47)
      abb69(16)=-16.0_ki*abb69(16)
      abb69(55)=spak3k4*abb69(63)
      abb69(57)=abb69(64)*spak2k4
      abb69(58)=-abb69(57)*abb69(30)
      abb69(59)=-spak2k4*abb69(90)
      abb69(58)=abb69(59)+abb69(58)
      abb69(58)=8.0_ki*abb69(58)
      abb69(57)=16.0_ki*abb69(57)
      abb69(59)=-spak2k4*abb69(63)
...
end module p0_dbaru_epnebbbarg_abbrevd69h5
