module     p0_dbaru_epnebbbarg_d3h0l1
   ...
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity0d3h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc3(14)=Qspvak2k7*acc3(4)
      acc3(15)=Qspvak1k3*acc3(5)
      acc3(16)=Qspvak1k2*acc3(3)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d3h0l1_ninja")
