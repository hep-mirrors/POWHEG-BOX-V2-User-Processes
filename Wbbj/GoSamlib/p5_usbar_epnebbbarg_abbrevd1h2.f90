module     p5_usbar_epnebbbarg_abbrevd1h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb1(4)=spak2l6**(-1)
      abb1(5)=c4-c2
      abb1(6)=-spbl6k3*abb1(5)
      abb1(7)=-c1+2.0_ki*c3
      abb1(8)=-spbl6k3*abb1(7)
      abb1(9)=NC*abb1(8)
      abb1(9)=-abb1(6)+abb1(9)
      abb1(10)=gW*TR
      abb1(10)=abb1(10)**2*CVSU*abb1(1)*abb1(2)
      abb1(11)=abb1(10)*i_
      abb1(11)=4.0_ki*abb1(11)
      abb1(12)=spak3k4*spbk3k1
      abb1(9)=abb1(11)*abb1(9)*abb1(12)*spak2l5
      ...
      abb1(10)=abb1(10)*spal5e7*abb1(23)
...
end module p5_usbar_epnebbbarg_abbrevd1h2
