module     p5_usbar_epnebbbarg_color
   ! file:      /home/tramonta/codes/POWHEG/WBBJ/GoSam_POWHEG/Virtual/p5_usbar_e
   ! pnebbbarg/common/color.f90
   ! generator: haggies (1.1)
   use p5_usbar_epnebbbarg_config, only: ki
   use p5_usbar_epnebbbarg_model, only: NC, Nf
   implicit none
   save
...
end module p5_usbar_epnebbbarg_color
