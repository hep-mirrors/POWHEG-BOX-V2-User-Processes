module     p5_usbar_epnebbbarg_abbrevd3h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb3(4)=spbl5k2**(-1)
      abb3(5)=spak2l6**(-1)
      abb3(6)=abb3(3)*i_*CVSU*abb3(2)*abb3(1)
      abb3(7)=TR*gW
      abb3(7)=abb3(7)**2
      ...
      abb3(15)=spak4l5*abb3(15)
      abb3(15)=abb3(15)+abb3(14)
      abb3(15)=spbl6k1*abb3(15)
      abb3(18)=abb3(18)*NC
      ...
      abb3(8)=-abb3(10)*abb3(8)*spbe7l6
      abb3(10)=abb3(16)*spbe7l6
      abb3(16)=abb3(10)*c1
      abb3(17)=-abb3(10)*abb3(17)
      abb3(17)=abb3(16)+abb3(17)+abb3(8)
      abb3(17)=spak4l5*abb3(17)
      abb3(14)=spbe7l6*abb3(14)
      ...
      abb3(9)=2.0_ki*spbe7l6*abb3(9)
      abb3(10)=abb3(10)*c3
      abb3(8)=-abb3(16)-abb3(10)+2.0_ki*abb3(8)
      abb3(8)=2.0_ki*spal5e7*abb3(8)
      abb3(10)=-abb3(13)-abb3(12)+2.0_ki*abb3(11)
      abb3(10)=spal5e7*spbe7l6*abb3(10)
...
end module p5_usbar_epnebbbarg_abbrevd3h2
