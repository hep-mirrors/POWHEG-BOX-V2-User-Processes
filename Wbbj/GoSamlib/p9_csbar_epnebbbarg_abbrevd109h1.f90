module     p9_csbar_epnebbbarg_abbrevd109h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb109(13)=TR*gW
      abb109(13)=abb109(13)**2*spbk7e7*i_*spak2e7*CVSC*abb109(3)*abb109(2)*abb1&
      &09(1)
...
end module p9_csbar_epnebbbarg_abbrevd109h1
