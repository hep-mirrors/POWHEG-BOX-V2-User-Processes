module     p0_dbaru_epnebbbarg_d219h0l1d
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity0d219h0l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki), dimension(52) :: acd219
      complex(ki) :: brack
      ...
      acd219(22)=abb219(21)
      acd219(23)=dotproduct(qshift,spval5k2)
      acd219(24)=abb219(40)
      acd219(25)=dotproduct(qshift,spval5k3)
      acd219(26)=abb219(37)
      acd219(27)=dotproduct(qshift,spval5k7)
      acd219(28)=abb219(33)
      acd219(29)=dotproduct(qshift,spval6k2)
      acd219(30)=abb219(26)
      acd219(31)=dotproduct(qshift,spval6k3)
      acd219(32)=abb219(34)
      acd219(33)=dotproduct(qshift,spvak7l5)
      acd219(34)=abb219(27)
      acd219(35)=abb219(15)
      acd219(36)=-acd219(2)*acd219(1)
      acd219(37)=-acd219(4)*acd219(3)
      acd219(38)=-acd219(6)*acd219(5)
      acd219(39)=-acd219(8)*acd219(7)
      acd219(40)=-acd219(10)*acd219(9)
      acd219(41)=-acd219(12)*acd219(11)
      acd219(42)=-acd219(14)*acd219(13)
      acd219(43)=-acd219(16)*acd219(15)
      acd219(44)=-acd219(18)*acd219(17)
      acd219(45)=-acd219(20)*acd219(19)
      acd219(46)=-acd219(22)*acd219(21)
      acd219(47)=-acd219(24)*acd219(23)
      acd219(48)=-acd219(26)*acd219(25)
      acd219(49)=-acd219(28)*acd219(27)
      acd219(50)=-acd219(30)*acd219(29)
      acd219(51)=-acd219(32)*acd219(31)
      acd219(52)=-acd219(34)*acd219(33)
      brack=acd219(35)+acd219(36)+acd219(37)+acd219(38)+acd219(39)+acd219(40)+a&
      &cd219(41)+acd219(42)+acd219(43)+acd219(44)+acd219(45)+acd219(46)+acd219(&
      &47)+acd219(48)+acd219(49)+acd219(50)+acd219(51)+acd219(52)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd219(22)=abb219(21)
      acd219(23)=spval5k2(iv1)
      acd219(24)=abb219(40)
      acd219(25)=spval5k3(iv1)
      acd219(26)=abb219(37)
      acd219(27)=spval5k7(iv1)
      acd219(28)=abb219(33)
      acd219(29)=spval6k2(iv1)
      acd219(30)=abb219(26)
      acd219(31)=spval6k3(iv1)
      acd219(32)=abb219(34)
      acd219(33)=spvak7l5(iv1)
      acd219(34)=abb219(27)
      ...
      brack=acd219(35)+acd219(36)+acd219(37)+acd219(38)+acd219(39)+acd219(40)+a&
      &cd219(41)+acd219(42)+acd219(43)+acd219(44)+acd219(45)+acd219(46)+acd219(&
      &47)+acd219(48)+acd219(49)+acd219(50)+acd219(51)
...
!---#] subroutine reconstruct_d219:
end module     p0_dbaru_epnebbbarg_d219h0l1d
