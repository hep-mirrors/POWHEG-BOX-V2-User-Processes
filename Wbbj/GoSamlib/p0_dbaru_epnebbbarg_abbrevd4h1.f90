module     p0_dbaru_epnebbbarg_abbrevd4h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb4(11)=abb4(15)*abb4(7)*abb4(11)
...
end module p0_dbaru_epnebbbarg_abbrevd4h1
