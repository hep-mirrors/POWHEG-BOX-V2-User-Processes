module     p5_usbar_epnebbbarg_d85h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p5_usbar_epnebbbarg_abbrevd85h1
      implicit none
      ...
      acc85(99)=-Qspval6k1*acc85(92)
      acc85(100)=Qspval6l5*acc85(69)
      ...
      acc85(101)=Qspval6k1*acc85(65)
      acc85(102)=Qspval6l5*acc85(76)
...
!           & sign => diagram85_sign, shift => diagram85_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d85h1l1
