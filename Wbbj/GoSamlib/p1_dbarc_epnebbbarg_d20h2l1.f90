module     p1_dbarc_epnebbbarg_d20h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd20h2
      implicit none
...
!           & sign => diagram20_sign, shift => diagram20_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d20h2l1
