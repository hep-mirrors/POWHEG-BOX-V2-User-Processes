module     p0_dbaru_epnebbbarg_abbrevd14h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb14(32)=spak1l6*spbl5k1
      abb14(33)=abb14(32)*spbk3k1
      abb14(34)=spak2l6*spbl5k1
      ...
      abb14(9)=abb14(9)+abb14(12)
      abb14(12)=spbk7l5*spak3l6
      abb14(52)=abb14(12)*spak1k7
      abb14(60)=spak1k2*spbl5k2
      abb14(63)=abb14(60)*spak3l6
      ...
      abb14(46)=spbl5k2*spak2l6
      abb14(32)=abb14(46)-abb14(32)
      abb14(32)=abb14(32)*spak1k2
      abb14(46)=spak2k4*spbl5k4
      abb14(52)=spbl5k3*spak2k3
      abb14(46)=abb14(46)+abb14(52)
      abb14(46)=abb14(46)*spak1l6
      abb14(52)=spak1k7*spbk7l5
      abb14(55)=spak1k4*spbl5k4
      abb14(52)=abb14(52)+abb14(55)
      abb14(55)=abb14(52)*spak2l6
      ...
      abb14(42)=spbk3k2*spbl5k1
      abb14(43)=spbl5k3*spbk2k1
      abb14(42)=abb14(42)+abb14(43)
      abb14(42)=abb14(42)*spak1l6*abb14(36)
      ...
      abb14(43)=spak4k7*spbl5k4
      abb14(54)=spbl5k3*spak3k7
      abb14(55)=spak1k7*spbl5k1
      abb14(43)=-abb14(55)+abb14(43)+abb14(54)
      abb14(43)=abb14(43)*spak1l6
      ...
      abb14(45)=abb14(18)*spak2l6*abb14(46)
...
end module p0_dbaru_epnebbbarg_abbrevd14h1
