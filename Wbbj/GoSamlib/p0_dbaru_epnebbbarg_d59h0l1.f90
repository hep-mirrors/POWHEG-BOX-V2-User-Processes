module     p0_dbaru_epnebbbarg_d59h0l1
   ...
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity0d59h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc59(5)=Qspk7*acc59(2)
      brack=acc59(3)+acc59(4)+acc59(5)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d59h0l1_ninja")
