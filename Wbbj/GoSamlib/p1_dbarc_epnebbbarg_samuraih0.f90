module     p1_dbarc_epnebbbarg_samuraih0
...
function     numeval_group0(icut, Q, mu2) result(num)
   ...
   use p1_dbarc_epnebbbarg_d322h0l1, only: numerator_d322 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d176h0l1, only: numerator_d176 => numerator_samurai
   use p1_dbarc_epnebbbarg_d318h0l1, only: numerator_d318 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d28h0l1, only: numerator_d28 => numerator_samurai
   use p1_dbarc_epnebbbarg_d87h0l1, only: numerator_d87 => numerator_samurai
   use p1_dbarc_epnebbbarg_d153h0l1, only: numerator_d153 => numerator_samurai
   use p1_dbarc_epnebbbarg_d180h0l1, only: numerator_d180 => numerator_samurai
   use p1_dbarc_epnebbbarg_d244h0l1, only: numerator_d244 => numerator_samurai
   use p1_dbarc_epnebbbarg_d320h0l1, only: numerator_d320 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group3(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d13h0l1, only: numerator_d13 => numerator_samurai
   use p1_dbarc_epnebbbarg_d84h0l1, only: numerator_d84 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group4(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d12h0l1, only: numerator_d12 => numerator_samurai
   use p1_dbarc_epnebbbarg_d85h0l1, only: numerator_d85 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group5(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d15h0l1, only: numerator_d15 => numerator_samurai
   use p1_dbarc_epnebbbarg_d83h0l1, only: numerator_d83 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group6(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d14h0l1, only: numerator_d14 => numerator_samurai
   use p1_dbarc_epnebbbarg_d82h0l1, only: numerator_d82 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group7(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d68h0l1, only: numerator_d68 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group8(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d80h0l1, only: numerator_d80 => numerator_samurai
   use p1_dbarc_epnebbbarg_d128h0l1, only: numerator_d128 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group9(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d66h0l1, only: numerator_d66 => numerator_samurai
   use p1_dbarc_epnebbbarg_d127h0l1, only: numerator_d127 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group10(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d81h0l1, only: numerator_d81 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group11(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d79h0l1, only: numerator_d79 => numerator_samurai
   use p1_dbarc_epnebbbarg_d109h0l1, only: numerator_d109 => numerator_samurai
   use p1_dbarc_epnebbbarg_d292h0l1, only: numerator_d292 => numerator_samurai
   use p1_dbarc_epnebbbarg_d301h0l1, only: numerator_d301 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group12(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d298h0l1, only: numerator_d298 => numerator_samurai
   use p1_dbarc_epnebbbarg_d303h0l1, only: numerator_d303 => numerator_samurai
   use p1_dbarc_epnebbbarg_d316h0l1, only: numerator_d316 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group13(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d16h0l1, only: numerator_d16 => numerator_samurai
   use p1_dbarc_epnebbbarg_d38h0l1, only: numerator_d38 => numerator_samurai
   use p1_dbarc_epnebbbarg_d42h0l1, only: numerator_d42 => numerator_samurai
   use p1_dbarc_epnebbbarg_d58h0l1, only: numerator_d58 => numerator_samurai
   use p1_dbarc_epnebbbarg_d70h0l1, only: numerator_d70 => numerator_samurai
   use p1_dbarc_epnebbbarg_d76h0l1, only: numerator_d76 => numerator_samurai
   use p1_dbarc_epnebbbarg_d90h0l1, only: numerator_d90 => numerator_samurai
   use p1_dbarc_epnebbbarg_d93h0l1, only: numerator_d93 => numerator_samurai
   use p1_dbarc_epnebbbarg_d102h0l1, only: numerator_d102 => numerator_samurai
   use p1_dbarc_epnebbbarg_d108h0l1, only: numerator_d108 => numerator_samurai
   use p1_dbarc_epnebbbarg_d115h0l1, only: numerator_d115 => numerator_samurai
   use p1_dbarc_epnebbbarg_d126h0l1, only: numerator_d126 => numerator_samurai
   use p1_dbarc_epnebbbarg_d139h0l1, only: numerator_d139 => numerator_samurai
   use p1_dbarc_epnebbbarg_d227h0l1, only: numerator_d227 => numerator_samurai
   use p1_dbarc_epnebbbarg_d295h0l1, only: numerator_d295 => numerator_samurai
   use p1_dbarc_epnebbbarg_d310h0l1, only: numerator_d310 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group14(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d72h0l1, only: numerator_d72 => numerator_samurai
   use p1_dbarc_epnebbbarg_d75h0l1, only: numerator_d75 => numerator_samurai
   use p1_dbarc_epnebbbarg_d98h0l1, only: numerator_d98 => numerator_samurai
   use p1_dbarc_epnebbbarg_d101h0l1, only: numerator_d101 => numerator_samurai
   use p1_dbarc_epnebbbarg_d120h0l1, only: numerator_d120 => numerator_samurai
   use p1_dbarc_epnebbbarg_d121h0l1, only: numerator_d121 => numerator_samurai
   use p1_dbarc_epnebbbarg_d300h0l1, only: numerator_d300 => numerator_samurai
   use p1_dbarc_epnebbbarg_d305h0l1, only: numerator_d305 => numerator_samurai
   use p1_dbarc_epnebbbarg_d315h0l1, only: numerator_d315 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group15(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d6h0l1, only: numerator_d6 => numerator_samurai
   use p1_dbarc_epnebbbarg_d8h0l1, only: numerator_d8 => numerator_samurai
   use p1_dbarc_epnebbbarg_d10h0l1, only: numerator_d10 => numerator_samurai
   use p1_dbarc_epnebbbarg_d17h0l1, only: numerator_d17 => numerator_samurai
   use p1_dbarc_epnebbbarg_d18h0l1, only: numerator_d18 => numerator_samurai
   use p1_dbarc_epnebbbarg_d21h0l1, only: numerator_d21 => numerator_samurai
   use p1_dbarc_epnebbbarg_d24h0l1, only: numerator_d24 => numerator_samurai
   use p1_dbarc_epnebbbarg_d40h0l1, only: numerator_d40 => numerator_samurai
   use p1_dbarc_epnebbbarg_d43h0l1, only: numerator_d43 => numerator_samurai
   use p1_dbarc_epnebbbarg_d59h0l1, only: numerator_d59 => numerator_samurai
   use p1_dbarc_epnebbbarg_d64h0l1, only: numerator_d64 => numerator_samurai
   use p1_dbarc_epnebbbarg_d65h0l1, only: numerator_d65 => numerator_samurai
   use p1_dbarc_epnebbbarg_d71h0l1, only: numerator_d71 => numerator_samurai
   use p1_dbarc_epnebbbarg_d78h0l1, only: numerator_d78 => numerator_samurai
   use p1_dbarc_epnebbbarg_d86h0l1, only: numerator_d86 => numerator_samurai
   use p1_dbarc_epnebbbarg_d91h0l1, only: numerator_d91 => numerator_samurai
   use p1_dbarc_epnebbbarg_d92h0l1, only: numerator_d92 => numerator_samurai
   use p1_dbarc_epnebbbarg_d103h0l1, only: numerator_d103 => numerator_samurai
   use p1_dbarc_epnebbbarg_d110h0l1, only: numerator_d110 => numerator_samurai
   use p1_dbarc_epnebbbarg_d111h0l1, only: numerator_d111 => numerator_samurai
   use p1_dbarc_epnebbbarg_d124h0l1, only: numerator_d124 => numerator_samurai
   use p1_dbarc_epnebbbarg_d137h0l1, only: numerator_d137 => numerator_samurai
   use p1_dbarc_epnebbbarg_d223h0l1, only: numerator_d223 => numerator_samurai
   use p1_dbarc_epnebbbarg_d296h0l1, only: numerator_d296 => numerator_samurai
   use p1_dbarc_epnebbbarg_d302h0l1, only: numerator_d302 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group16(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d67h0l1, only: numerator_d67 => numerator_samurai
   use p1_dbarc_epnebbbarg_d77h0l1, only: numerator_d77 => numerator_samurai
   use p1_dbarc_epnebbbarg_d94h0l1, only: numerator_d94 => numerator_samurai
   use p1_dbarc_epnebbbarg_d107h0l1, only: numerator_d107 => numerator_samurai
   use p1_dbarc_epnebbbarg_d117h0l1, only: numerator_d117 => numerator_samurai
   use p1_dbarc_epnebbbarg_d125h0l1, only: numerator_d125 => numerator_samurai
   use p1_dbarc_epnebbbarg_d145h0l1, only: numerator_d145 => numerator_samurai
   use p1_dbarc_epnebbbarg_d294h0l1, only: numerator_d294 => numerator_samurai
   use p1_dbarc_epnebbbarg_d304h0l1, only: numerator_d304 => numerator_samurai
   use p1_dbarc_epnebbbarg_d314h0l1, only: numerator_d314 => numerator_samurai
   use p1_dbarc_epnebbbarg_d317h0l1, only: numerator_d317 => numerator_samurai
   use p1_dbarc_epnebbbarg_d336h0l1, only: numerator_d336 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group17(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d291h0l1, only: numerator_d291 => numerator_samurai
   use p1_dbarc_epnebbbarg_d309h0l1, only: numerator_d309 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group18(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d1h0l1, only: numerator_d1 => numerator_samurai
   use p1_dbarc_epnebbbarg_d2h0l1, only: numerator_d2 => numerator_samurai
   use p1_dbarc_epnebbbarg_d3h0l1, only: numerator_d3 => numerator_samurai
   use p1_dbarc_epnebbbarg_d4h0l1, only: numerator_d4 => numerator_samurai
   use p1_dbarc_epnebbbarg_d20h0l1, only: numerator_d20 => numerator_samurai
   use p1_dbarc_epnebbbarg_d23h0l1, only: numerator_d23 => numerator_samurai
   use p1_dbarc_epnebbbarg_d62h0l1, only: numerator_d62 => numerator_samurai
   use p1_dbarc_epnebbbarg_d63h0l1, only: numerator_d63 => numerator_samurai
   use p1_dbarc_epnebbbarg_d73h0l1, only: numerator_d73 => numerator_samurai
   use p1_dbarc_epnebbbarg_d74h0l1, only: numerator_d74 => numerator_samurai
   use p1_dbarc_epnebbbarg_d99h0l1, only: numerator_d99 => numerator_samurai
   use p1_dbarc_epnebbbarg_d100h0l1, only: numerator_d100 => numerator_samurai
   use p1_dbarc_epnebbbarg_d104h0l1, only: numerator_d104 => numerator_samurai
   use p1_dbarc_epnebbbarg_d119h0l1, only: numerator_d119 => numerator_samurai
   use p1_dbarc_epnebbbarg_d122h0l1, only: numerator_d122 => numerator_samurai
   use p1_dbarc_epnebbbarg_d175h0l1, only: numerator_d175 => numerator_samurai
   use p1_dbarc_epnebbbarg_d179h0l1, only: numerator_d179 => numerator_samurai
   use p1_dbarc_epnebbbarg_d219h0l1, only: numerator_d219 => numerator_samurai
   use p1_dbarc_epnebbbarg_d221h0l1, only: numerator_d221 => numerator_samurai
   use p1_dbarc_epnebbbarg_d225h0l1, only: numerator_d225 => numerator_samurai
   use p1_dbarc_epnebbbarg_d229h0l1, only: numerator_d229 => numerator_samurai
   use p1_dbarc_epnebbbarg_d240h0l1, only: numerator_d240 => numerator_samurai
   use p1_dbarc_epnebbbarg_d299h0l1, only: numerator_d299 => numerator_samurai
   use p1_dbarc_epnebbbarg_d307h0l1, only: numerator_d307 => numerator_samurai
   use p1_dbarc_epnebbbarg_d313h0l1, only: numerator_d313 => numerator_samurai
   use p1_dbarc_epnebbbarg_d321h0l1, only: numerator_d321 => numerator_samurai
   use p1_dbarc_epnebbbarg_d333h0l1, only: numerator_d333 => numerator_samurai
   use p1_dbarc_epnebbbarg_d335h0l1, only: numerator_d335 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group19(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d293h0l1, only: numerator_d293 => numerator_samurai
   use p1_dbarc_epnebbbarg_d306h0l1, only: numerator_d306 => numerator_samurai
   use p1_dbarc_epnebbbarg_d312h0l1, only: numerator_d312 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group20(icut, Q, mu2) result(num)
   use p1_dbarc_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d69h0l1, only: numerator_d69 => numerator_samurai
   use p1_dbarc_epnebbbarg_d96h0l1, only: numerator_d96 => numerator_samurai
   use p1_dbarc_epnebbbarg_d113h0l1, only: numerator_d113 => numerator_samurai
   use p1_dbarc_epnebbbarg_d123h0l1, only: numerator_d123 => numerator_samurai
   use p1_dbarc_epnebbbarg_d297h0l1, only: numerator_d297 => numerator_samurai
   use p1_dbarc_epnebbbarg_d308h0l1, only: numerator_d308 => numerator_samurai
   use p1_dbarc_epnebbbarg_d311h0l1, only: numerator_d311 => numerator_samurai
   use p1_dbarc_epnebbbarg_d319h0l1, only: numerator_d319 => numerator_samurai
   use p1_dbarc_epnebbbarg_d334h0l1, only: numerator_d334 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d322h0l1, only: numerator_diagram322 => numerator_sa&
   &murai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d176h0l1, only: numerator_diagram176 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d318h0l1, only: numerator_diagram318 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d28h0l1, only: numerator_diagram28 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d87h0l1, only: numerator_diagram87 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d153h0l1, only: numerator_diagram153 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d180h0l1, only: numerator_diagram180 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d244h0l1, only: numerator_diagram244 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d320h0l1, only: numerator_diagram320 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group3(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d13h0l1, only: numerator_diagram13 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d84h0l1, only: numerator_diagram84 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group4(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d12h0l1, only: numerator_diagram12 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d85h0l1, only: numerator_diagram85 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group5(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d15h0l1, only: numerator_diagram15 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d83h0l1, only: numerator_diagram83 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group6(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d14h0l1, only: numerator_diagram14 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d82h0l1, only: numerator_diagram82 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group7(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d68h0l1, only: numerator_diagram68 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group8(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d80h0l1, only: numerator_diagram80 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d128h0l1, only: numerator_diagram128 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group9(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d66h0l1, only: numerator_diagram66 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d127h0l1, only: numerator_diagram127 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group10(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d81h0l1, only: numerator_diagram81 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group11(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d79h0l1, only: numerator_diagram79 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d109h0l1, only: numerator_diagram109 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d292h0l1, only: numerator_diagram292 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d301h0l1, only: numerator_diagram301 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group12(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d298h0l1, only: numerator_diagram298 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d303h0l1, only: numerator_diagram303 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d316h0l1, only: numerator_diagram316 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group13(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d16h0l1, only: numerator_diagram16 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d38h0l1, only: numerator_diagram38 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d42h0l1, only: numerator_diagram42 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d58h0l1, only: numerator_diagram58 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d70h0l1, only: numerator_diagram70 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d76h0l1, only: numerator_diagram76 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d90h0l1, only: numerator_diagram90 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d93h0l1, only: numerator_diagram93 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d102h0l1, only: numerator_diagram102 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d108h0l1, only: numerator_diagram108 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d115h0l1, only: numerator_diagram115 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d126h0l1, only: numerator_diagram126 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d139h0l1, only: numerator_diagram139 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d227h0l1, only: numerator_diagram227 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d295h0l1, only: numerator_diagram295 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d310h0l1, only: numerator_diagram310 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group14(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d72h0l1, only: numerator_diagram72 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d75h0l1, only: numerator_diagram75 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d98h0l1, only: numerator_diagram98 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d101h0l1, only: numerator_diagram101 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d120h0l1, only: numerator_diagram120 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d121h0l1, only: numerator_diagram121 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d300h0l1, only: numerator_diagram300 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d305h0l1, only: numerator_diagram305 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d315h0l1, only: numerator_diagram315 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group15(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d6h0l1, only: numerator_diagram6 => numerator_samurai
   use p1_dbarc_epnebbbarg_d8h0l1, only: numerator_diagram8 => numerator_samurai
   use p1_dbarc_epnebbbarg_d10h0l1, only: numerator_diagram10 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d17h0l1, only: numerator_diagram17 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d18h0l1, only: numerator_diagram18 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d21h0l1, only: numerator_diagram21 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d24h0l1, only: numerator_diagram24 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d40h0l1, only: numerator_diagram40 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d43h0l1, only: numerator_diagram43 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d59h0l1, only: numerator_diagram59 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d64h0l1, only: numerator_diagram64 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d65h0l1, only: numerator_diagram65 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d71h0l1, only: numerator_diagram71 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d78h0l1, only: numerator_diagram78 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d86h0l1, only: numerator_diagram86 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d91h0l1, only: numerator_diagram91 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d92h0l1, only: numerator_diagram92 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d103h0l1, only: numerator_diagram103 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d110h0l1, only: numerator_diagram110 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d111h0l1, only: numerator_diagram111 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d124h0l1, only: numerator_diagram124 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d137h0l1, only: numerator_diagram137 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d223h0l1, only: numerator_diagram223 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d296h0l1, only: numerator_diagram296 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d302h0l1, only: numerator_diagram302 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group16(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d67h0l1, only: numerator_diagram67 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d77h0l1, only: numerator_diagram77 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d94h0l1, only: numerator_diagram94 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d107h0l1, only: numerator_diagram107 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d117h0l1, only: numerator_diagram117 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d125h0l1, only: numerator_diagram125 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d145h0l1, only: numerator_diagram145 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d294h0l1, only: numerator_diagram294 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d304h0l1, only: numerator_diagram304 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d314h0l1, only: numerator_diagram314 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d317h0l1, only: numerator_diagram317 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d336h0l1, only: numerator_diagram336 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group17(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d291h0l1, only: numerator_diagram291 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d309h0l1, only: numerator_diagram309 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group18(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d1h0l1, only: numerator_diagram1 => numerator_samurai
   use p1_dbarc_epnebbbarg_d2h0l1, only: numerator_diagram2 => numerator_samurai
   use p1_dbarc_epnebbbarg_d3h0l1, only: numerator_diagram3 => numerator_samurai
   use p1_dbarc_epnebbbarg_d4h0l1, only: numerator_diagram4 => numerator_samurai
   use p1_dbarc_epnebbbarg_d20h0l1, only: numerator_diagram20 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d23h0l1, only: numerator_diagram23 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d62h0l1, only: numerator_diagram62 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d63h0l1, only: numerator_diagram63 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d73h0l1, only: numerator_diagram73 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d74h0l1, only: numerator_diagram74 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d99h0l1, only: numerator_diagram99 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d100h0l1, only: numerator_diagram100 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d104h0l1, only: numerator_diagram104 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d119h0l1, only: numerator_diagram119 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d122h0l1, only: numerator_diagram122 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d175h0l1, only: numerator_diagram175 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d179h0l1, only: numerator_diagram179 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d219h0l1, only: numerator_diagram219 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d221h0l1, only: numerator_diagram221 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d225h0l1, only: numerator_diagram225 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d229h0l1, only: numerator_diagram229 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d240h0l1, only: numerator_diagram240 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d299h0l1, only: numerator_diagram299 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d307h0l1, only: numerator_diagram307 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d313h0l1, only: numerator_diagram313 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d321h0l1, only: numerator_diagram321 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d333h0l1, only: numerator_diagram333 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d335h0l1, only: numerator_diagram335 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group19(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d293h0l1, only: numerator_diagram293 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d306h0l1, only: numerator_diagram306 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d312h0l1, only: numerator_diagram312 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
subroutine     reduce_group20(scale2,tot,totr,ok)
   ...
   use p1_dbarc_epnebbbarg_kinematics
   use p1_dbarc_epnebbbarg_model
   use p1_dbarc_epnebbbarg_d69h0l1, only: numerator_diagram69 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d96h0l1, only: numerator_diagram96 => numerator_samu&
   &rai
   use p1_dbarc_epnebbbarg_d113h0l1, only: numerator_diagram113 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d123h0l1, only: numerator_diagram123 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d297h0l1, only: numerator_diagram297 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d308h0l1, only: numerator_diagram308 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d311h0l1, only: numerator_diagram311 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d319h0l1, only: numerator_diagram319 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_d334h0l1, only: numerator_diagram334 => numerator_sa&
   &murai
   use p1_dbarc_epnebbbarg_globalsl1, only: epspow
...
!-----#] subroutine reduce_group20:
!---#] reduce groups with samurai:
end module p1_dbarc_epnebbbarg_samuraih0
