module     p0_dbaru_epnebbbarg_abbrevd1h6
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb1(4)=spbk7k2**(-1)
      abb1(5)=c3+c1
      abb1(6)=spal5k7*spak1k4
      abb1(7)=abb1(5)*abb1(6)*NC
      abb1(8)=2.0_ki*c1
      abb1(9)=abb1(8)-c3
      abb1(10)=abb1(9)*NC*spak4l5
      abb1(11)=c4-c2
      abb1(12)=abb1(11)*spak4l5
      ...
      abb1(16)=spbl6k2*abb1(15)
      abb1(16)=8.0_ki*abb1(16)
      abb1(16)=abb1(12)*abb1(16)
      abb1(17)=4.0_ki*spbl6k2
      ...
      abb1(14)=abb1(15)*abb1(14)*abb1(9)*spak3k4*spbl6k3
      abb1(15)=NC*spal5k7
      abb1(5)=abb1(5)*abb1(15)
      abb1(21)=2.0_ki*spal5k7
      abb1(22)=abb1(21)*abb1(11)
      abb1(22)=abb1(22)-abb1(5)
      abb1(22)=spak1k3*abb1(22)
      abb1(23)=-spak1k7*spak3l5*abb1(9)
...
end module p0_dbaru_epnebbbarg_abbrevd1h6
