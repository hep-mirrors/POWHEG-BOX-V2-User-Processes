module     p1_dbarc_epnebbbarg_d8h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd8h2
      implicit none
      ...
      acc8(11)=abb8(23)
      acc8(12)=abb8(24)
      acc8(13)=Qspvae7l6*acc8(10)
      acc8(14)=Qspvak2e7*acc8(7)
      acc8(15)=Qspval5l6*acc8(2)
      acc8(16)=Qspvak4l6*acc8(12)
      acc8(17)=Qspvak4k2*acc8(8)
      acc8(18)=Qspvak2k3*acc8(9)
      acc8(19)=Qspvak1l6*acc8(5)
      acc8(20)=Qspvak1k3*acc8(6)
      acc8(21)=Qspvak1k2*acc8(1)
...
!           & sign => diagram8_sign, shift => diagram8_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d8h2l1
