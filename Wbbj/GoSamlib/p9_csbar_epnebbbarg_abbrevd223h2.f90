module     p9_csbar_epnebbbarg_abbrevd223h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb223(7)=spak2l6**(-1)
      abb223(8)=TR*gW
      abb223(8)=abb223(5)*i_*CVSC*abb223(3)*abb223(2)*abb223(1)*abb223(8)**2
      abb223(9)=abb223(8)*spak2l5
      abb223(10)=spbk3k1*abb223(9)
      abb223(11)=abb223(10)*c4
      abb223(12)=mB**2
      abb223(13)=abb223(11)*abb223(12)
      abb223(14)=abb223(7)*spak2e7
      abb223(15)=abb223(14)*abb223(13)
      abb223(8)=abb223(12)*abb223(8)
      abb223(16)=abb223(8)*spbl6k2
      abb223(17)=abb223(16)*spbk3k1
      abb223(18)=abb223(17)*c4
      abb223(19)=abb223(6)*spak2e7
      abb223(20)=abb223(19)*abb223(18)
      abb223(21)=abb223(11)*spbl6k2
      abb223(22)=abb223(21)*spak2e7
      abb223(15)=-abb223(20)+abb223(22)-abb223(15)
      abb223(15)=abb223(15)*abb223(4)
      abb223(20)=abb223(17)*c1
      abb223(22)=abb223(20)*abb223(19)
      abb223(23)=abb223(10)*c1
      abb223(24)=abb223(12)*abb223(23)
      abb223(25)=abb223(24)*abb223(14)
      abb223(26)=spbl6k2*abb223(23)
      abb223(27)=abb223(26)*spak2e7
      abb223(15)=abb223(15)+abb223(25)+abb223(22)-abb223(27)
      abb223(15)=abb223(15)*abb223(4)
      abb223(22)=NC*c1
      abb223(17)=abb223(17)*abb223(22)
      abb223(17)=abb223(17)-abb223(18)
      abb223(25)=abb223(17)*abb223(19)
      abb223(10)=abb223(22)*abb223(10)
      abb223(12)=abb223(10)*abb223(12)
      abb223(12)=abb223(12)-abb223(13)
      abb223(27)=abb223(14)*abb223(12)
      abb223(28)=abb223(10)*spbl6k2
      ...
      abb223(17)=abb223(17)*abb223(6)
      abb223(12)=abb223(12)*abb223(7)
      abb223(12)=abb223(17)+abb223(12)-abb223(28)
      abb223(17)=abb223(33)*spak2k7
      abb223(28)=abb223(12)*abb223(17)
      abb223(35)=abb223(31)*abb223(10)
      abb223(36)=abb223(32)*abb223(10)
      abb223(35)=abb223(35)-abb223(36)
      abb223(37)=abb223(35)*spal5k7
      abb223(28)=abb223(28)+abb223(37)
      abb223(37)=spak3e7*abb223(28)
      abb223(38)=abb223(10)*spal5e7
      ...
      abb223(36)=abb223(8)*abb223(22)
      abb223(37)=c4*abb223(8)
      abb223(36)=abb223(36)-abb223(37)
      abb223(38)=abb223(36)*abb223(7)
      abb223(22)=abb223(16)*abb223(22)
      abb223(43)=abb223(16)*c4
      abb223(22)=abb223(22)-abb223(43)
      abb223(46)=abb223(22)*abb223(6)
      abb223(47)=c1*abb223(9)
      abb223(48)=abb223(47)*NC
      abb223(49)=abb223(48)*spbl6k2
      abb223(9)=c4*abb223(9)
      abb223(50)=abb223(9)*spbl6k2
      ...
      abb223(56)=spak3l5*spbe7k3
      abb223(57)=spak1l5*spbe7k1
      abb223(53)=-abb223(57)+abb223(53)+abb223(56)
      abb223(45)=abb223(53)*abb223(45)
      abb223(23)=abb223(23)*abb223(18)
      abb223(23)=abb223(23)+abb223(10)
      abb223(56)=spal5k7*abb223(23)*abb223(21)
      abb223(15)=abb223(44)-abb223(45)-abb223(15)+abb223(56)-abb223(26)+2.0_ki*&
      &abb223(25)
      abb223(15)=4.0_ki*abb223(15)
      abb223(13)=abb223(13)*abb223(4)
      abb223(25)=abb223(13)-abb223(12)
      abb223(26)=abb223(25)*spak2k4
      abb223(44)=abb223(29)+abb223(10)
      abb223(45)=abb223(44)*spak4l5
      ...
      abb223(57)=abb223(19)*abb223(43)
      abb223(58)=abb223(37)*abb223(14)
      abb223(59)=abb223(50)*spak2e7
      abb223(57)=abb223(58)+abb223(57)-abb223(59)
      abb223(57)=abb223(57)*abb223(4)
      abb223(8)=abb223(8)*c1
      abb223(58)=abb223(8)*abb223(14)
      abb223(16)=abb223(16)*c1
      abb223(59)=abb223(16)*abb223(19)
      abb223(60)=abb223(47)*spbl6k2
      abb223(61)=abb223(60)*spak2e7
      abb223(57)=abb223(57)-abb223(59)+abb223(61)-abb223(58)
      abb223(57)=abb223(57)*abb223(4)
      abb223(14)=abb223(36)*abb223(14)
      abb223(19)=abb223(22)*abb223(19)
      abb223(22)=abb223(49)*spak2e7
      abb223(14)=-abb223(22)+abb223(14)+abb223(19)
      ...
      abb223(27)=abb223(43)*abb223(6)
      abb223(36)=abb223(37)*abb223(7)
      abb223(27)=-abb223(50)+abb223(27)+abb223(36)
      abb223(27)=abb223(27)*abb223(4)
      abb223(8)=abb223(8)*abb223(7)
      abb223(16)=abb223(16)*abb223(6)
      abb223(8)=abb223(27)+abb223(60)-abb223(8)-abb223(16)
      abb223(16)=abb223(8)*abb223(18)
      abb223(16)=abb223(16)-abb223(38)
      abb223(16)=abb223(16)*abb223(24)
      abb223(24)=abb223(38)*spak4e7
      abb223(27)=abb223(52)*abb223(24)
      abb223(24)=abb223(46)*abb223(24)
      abb223(16)=abb223(24)+abb223(19)-abb223(16)+abb223(27)
      abb223(19)=abb223(48)*spal5e7
      abb223(14)=abb223(19)+abb223(14)
      abb223(19)=-abb223(32)*abb223(14)
      abb223(19)=abb223(19)-abb223(16)
      abb223(19)=spbk4k1*abb223(19)
      abb223(20)=spbk7e7*abb223(20)*spak2k7
      abb223(24)=abb223(51)*spbe7k4
      abb223(12)=abb223(46)*abb223(12)
      abb223(12)=-abb223(24)+abb223(20)-abb223(12)
      abb223(20)=spak3e7*abb223(12)
      abb223(11)=2.0_ki*abb223(11)
      abb223(24)=spak3k7*abb223(11)
      abb223(27)=abb223(10)*spak3e7
      ...
      abb223(18)=spal5k7*abb223(18)
      abb223(18)=abb223(24)+abb223(18)+abb223(20)-abb223(41)+abb223(19)+abb223(&
      &36)+abb223(27)
      abb223(18)=2.0_ki*abb223(18)
      abb223(8)=abb223(8)*abb223(4)
      abb223(8)=abb223(8)-abb223(38)
      abb223(8)=abb223(8)*spak2k4
      abb223(19)=abb223(22)+abb223(48)
      abb223(19)=abb223(19)*spak4l5
      abb223(8)=abb223(8)+abb223(19)
      abb223(19)=-spbk4k1*abb223(8)
      abb223(20)=-spak2k3*abb223(25)
      abb223(22)=-spak3l5*abb223(44)
      abb223(19)=abb223(22)+abb223(20)+abb223(19)
      abb223(19)=16.0_ki*abb223(19)
      abb223(20)=-abb223(31)*abb223(14)
      abb223(16)=abb223(20)+abb223(16)
      abb223(16)=spbk4k3*abb223(16)
      abb223(12)=-spak1e7*abb223(12)
      abb223(11)=-spak1k7*abb223(11)
      abb223(10)=abb223(10)*spak1e7
      abb223(20)=abb223(32)*spbk4k3
      abb223(10)=abb223(10)+abb223(20)
      abb223(10)=-abb223(10)*abb223(53)
      ...
      abb223(9)=spal5k7*abb223(9)
      abb223(9)=abb223(11)+abb223(9)+abb223(12)+abb223(40)+abb223(14)+abb223(16&
      &)+abb223(10)
      abb223(9)=2.0_ki*abb223(9)
      abb223(8)=spbk4k3*abb223(8)
      abb223(10)=-spak1k2*abb223(25)
      abb223(11)=spak1l5*abb223(44)
      abb223(8)=abb223(11)+abb223(10)+abb223(8)
      abb223(8)=16.0_ki*abb223(8)
      abb223(10)=-abb223(13)*abb223(33)
      abb223(11)=8.0_ki*abb223(25)
      abb223(12)=-spak3k4*abb223(11)
...
end module p9_csbar_epnebbbarg_abbrevd223h2
