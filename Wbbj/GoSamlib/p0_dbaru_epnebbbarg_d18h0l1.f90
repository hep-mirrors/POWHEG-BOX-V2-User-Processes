module     p0_dbaru_epnebbbarg_d18h0l1
   ...
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity0d18h0l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d18h0l1_ninja")
