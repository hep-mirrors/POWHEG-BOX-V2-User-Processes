module     p1_dbarc_epnebbbarg_abbrevd123h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb123(8)=abb123(3)*i_*CVDC*abb123(2)*abb123(1)
      abb123(9)=TR*gW
      abb123(10)=abb123(9)*mB
      abb123(10)=abb123(7)*abb123(8)*abb123(10)**2
      abb123(11)=-abb123(6)*abb123(10)
      abb123(12)=spbl6k2*abb123(5)
      ...
      abb123(17)=abb123(17)*spal6e7
      abb123(12)=abb123(4)*abb123(12)*spak1l5*abb123(10)
      abb123(20)=-spak1l5*abb123(11)
      ...
      abb123(7)=-abb123(7)*abb123(9)**2*abb123(8)*spak1l5
      ...
      abb123(30)=-spak2l5*abb123(29)
      abb123(32)=abb123(7)*spbl6k1
      abb123(33)=spak1k2*abb123(32)
      abb123(30)=abb123(33)-abb123(30)
      abb123(33)=spak1k2*abb123(5)
      ...
      abb123(49)=abb123(47)*spak4l5
      abb123(51)=abb123(18)*spak4l6
      ...
      abb123(55)=abb123(53)*spak4l5
      abb123(56)=es12*abb123(5)
      ...
      abb123(60)=abb123(53)*spal5k7
      abb123(61)=abb123(58)*spak1k7
      abb123(63)=abb123(14)*spbe7k2
      abb123(64)=abb123(63)*spal6k7
      ...
      abb123(8)=spal6e7*abb123(8)
      abb123(7)=abb123(12)+abb123(8)+abb123(7)+abb123(16)
      abb123(7)=4.0_ki*abb123(7)
      abb123(8)=8.0_ki*abb123(14)
      abb123(12)=abb123(34)*abb123(8)
      abb123(15)=-abb123(37)*abb123(8)
      abb123(16)=8.0_ki*abb123(35)
      abb123(20)=-8.0_ki*abb123(38)
      abb123(25)=abb123(53)*spal5e7
      ...
      abb123(28)=-spbe7k2*abb123(5)*abb123(31)
      ...
      abb123(38)=-spak3l5*abb123(47)
      abb123(27)=-spak1k3*abb123(27)
      abb123(43)=-spal6k7*abb123(50)
      abb123(18)=-spak3l6*abb123(18)
      ...
      abb123(38)=spak2l5*abb123(53)
      abb123(43)=-spak3l5*abb123(63)
      abb123(44)=-spak1k3*abb123(46)
      abb123(45)=-spak2k3*abb123(65)
      abb123(32)=abb123(52)*abb123(32)
      abb123(14)=-spak3l6*spbe7k3*abb123(14)
...
end module p1_dbarc_epnebbbarg_abbrevd123h2
