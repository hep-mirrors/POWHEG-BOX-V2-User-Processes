module     p5_usbar_epnebbbarg_dipoles
   use p5_usbar_epnebbbarg_config, only: ki
   use p5_usbar_epnebbbarg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T5, &
       & T1T6, &
       ...
       & T5T7, &
       & T6T7
   use p5_usbar_epnebbbarg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p5_usbar_epnebbbarg_dipoles
