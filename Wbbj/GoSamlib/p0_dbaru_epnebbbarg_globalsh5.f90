module     p0_dbaru_epnebbbarg_globalsh5
   use p0_dbaru_epnebbbarg_config, only: ki
   use p0_dbaru_epnebbbarg_color, only:&
      & c1v => c1,&
      & c2v => c2,&
      & c3v => c3,&
      & c4v => c4
...
subroutine     init_lo()
   use p0_dbaru_epnebbbarg_globalsl1, only: epspow, ccontract, amp0
   implicit none
...
end module p0_dbaru_epnebbbarg_globalsh5
