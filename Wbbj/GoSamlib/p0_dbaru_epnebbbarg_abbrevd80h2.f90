...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb80(26)=spbl6k3*spak1l5
      abb80(27)=abb80(26)*abb80(25)
      abb80(20)=abb80(27)+abb80(20)
      abb80(20)=abb80(20)*spak3k4
      abb80(27)=abb80(25)*spbl6k2
      abb80(28)=spak1l5*abb80(27)*spak2k4
      ...
      abb80(32)=spak2l5*spbl6k2
      abb80(33)=abb80(31)*abb80(32)
      abb80(34)=spak2l5*spbl6k3
      ...
      abb80(58)=abb80(57)*spak1l5
      abb80(59)=abb80(58)*spbl6k2
      ...
      abb80(67)=spak2l5*abb80(66)*spbk7l6
      ...
      abb80(70)=-spak4l5*abb80(46)
      abb80(71)=spak2l5*spak1k4*abb80(30)
      abb80(70)=abb80(70)+abb80(71)
      abb80(70)=spbl6k1*abb80(70)
      ...
      abb80(91)=abb80(10)*spak1l5
      abb80(92)=abb80(91)*spbk7l6
      abb80(93)=abb80(92)-abb80(16)
      abb80(51)=-abb80(93)*abb80(51)
      abb80(94)=abb80(58)*spbl6k1
      ...
      abb80(16)=abb80(72)*spbl6k3
      abb80(46)=abb80(57)*spbl6k2
      abb80(86)=abb80(46)*spbk7k3
      abb80(16)=abb80(16)-abb80(86)
      abb80(86)=abb80(16)*spak2l5
      ...
      abb80(31)=-spbl6k2*abb80(31)
      abb80(30)=abb80(30)*spak3k4*spbl6k3
      ...
      abb80(87)=-spbk4k3*spbl6k2*abb80(11)
      abb80(87)=abb80(87)+abb80(27)
      abb80(87)=spak4l5*abb80(87)
      abb80(99)=abb80(103)*abb80(42)
      abb80(103)=-abb80(32)*abb80(66)
      abb80(106)=abb80(11)*spbl6k3
      abb80(107)=spal5k7*spbk7k2*abb80(106)
      ...
      abb80(107)=abb80(91)*spbl6k2
      abb80(108)=es12*abb80(107)
      abb80(72)=-abb80(72)*abb80(105)
      abb80(109)=abb80(46)*spak4l5
      ...
      abb80(95)=spbl6k3*abb80(95)
      abb80(11)=spbl6k4*abb80(11)
      abb80(108)=spak1k7*spbk7l6*abb80(10)
      abb80(11)=abb80(108)+abb80(11)-abb80(46)+abb80(95)
      abb80(11)=8.0_ki*abb80(11)
      abb80(46)=abb80(17)*abb80(42)
      abb80(95)=abb80(91)*spbl6k3
      ...
      abb80(96)=spbl6k3*abb80(96)
      abb80(16)=abb80(96)+abb80(16)
      abb80(16)=spal5k7*abb80(16)
      ...
      abb80(9)=-spbk7l6*abb80(9)
      abb80(25)=spbl6k1*abb80(25)
      abb80(9)=abb80(9)+abb80(25)
      abb80(9)=spak3l5*abb80(9)
      ...
      abb80(19)=spbl6k2*abb80(31)
      abb80(53)=abb80(65)*spak3k4
      abb80(54)=-spbl6k3*abb80(53)
      abb80(19)=abb80(19)+abb80(54)
      abb80(19)=spal5k7*abb80(19)
      ...
      abb80(56)=-spak4l5*abb80(56)
      abb80(10)=-spbk4k2*spak4l5*abb80(10)
      abb80(62)=-spak3l5*abb80(65)
