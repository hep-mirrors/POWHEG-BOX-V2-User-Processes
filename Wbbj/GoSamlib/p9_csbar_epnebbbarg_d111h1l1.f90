module     p9_csbar_epnebbbarg_d111h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p9_csbar_epnebbbarg_abbrevd111h1
      implicit none
...
!           & sign => diagram111_sign, shift => diagram111_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p9_csbar_epnebbbarg_d111h1l1
