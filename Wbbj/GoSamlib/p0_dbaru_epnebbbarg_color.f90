module     p0_dbaru_epnebbbarg_color
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_
   ! tmp/GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/common/color.f90
   ! generator: haggies (1.1)
   use p0_dbaru_epnebbbarg_config, only: ki
   use p0_dbaru_epnebbbarg_model, only: NC, Nf
   implicit none
   save
...
end module p0_dbaru_epnebbbarg_color
