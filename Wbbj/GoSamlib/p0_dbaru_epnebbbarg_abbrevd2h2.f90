module     p0_dbaru_epnebbbarg_abbrevd2h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb2(13)=spbk3k1*spak1l5*abb2(10)
      abb2(17)=spbk4k3*spak4l5*abb2(10)
      abb2(13)=abb2(13)+abb2(17)
      abb2(13)=spbk7l6*abb2(13)
      ...
      abb2(15)=abb2(12)*spbk7l6
      abb2(13)=abb2(15)*abb2(13)*abb2(14)
      abb2(14)=c3+c1
      abb2(14)=NC*abb2(14)
      abb2(8)=-abb2(14)+2.0_ki*abb2(8)
      abb2(8)=abb2(15)*spak2l5*abb2(8)
      abb2(14)=spbk4k3*abb2(8)
      abb2(15)=spbk3k1*abb2(10)*spbl6k2*spak1l5
      abb2(10)=spbk4k3*abb2(10)*spak4l5*spbl6k2
...
end module p0_dbaru_epnebbbarg_abbrevd2h2
