module     p0_dbaru_epnebbbarg_model
   ! Model parameters for the model: /home/pcl305a/luisonig/Documents/GoSamPowhe
   ! g/POWHEG-BOX-V2/Wbbj_tmp/GoSam_POWHEG/Virtual/model/model
   ...
   real(ki) :: Nf =        4.000000000000000_ki
...
!---#[ print_parameter:
   ...
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVBC = ", CVBC
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVBT = ", CVBT
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVBU = ", CVBU
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVDC = ", CVDC
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVDT = ", CVDT
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVDU = ", CVDU
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVSC = ", CVSC
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVST = ", CVST
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "CVSU = ", CVSU
   ...
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VCB  = ", VCB
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VCD  = ", VCD
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VCS  = ", VCS
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VTB  = ", VTB
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VTD  = ", VTD
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VTS  = ", VTS
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VUB  = ", VUB
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VUD  = ", VUD
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "VUS  = ", VUS
...
if (name.eq."alphaEW" .or. name.eq."alpha") then
     ...
     elseif (name .eq. "MASSES&&5") then
               must_be_real = .true.
               mB = re
     elseif (name .eq. "MASSES&&6") then
               must_be_real = .true.
               mT = re
     elseif (name .eq. "MASSES&&13") then
               must_be_real = .true.
               mmu = re
...
end module p0_dbaru_epnebbbarg_model
