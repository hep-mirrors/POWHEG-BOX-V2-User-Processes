module     p5_usbar_epnebbbarg_d113h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p5_usbar_epnebbbarg_abbrevd113h1
      implicit none
...
!           & sign => diagram113_sign, shift => diagram113_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d113h1l1
