module     p0_dbaru_epnebbbarg_d119h6l1d
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity6d119h6l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(12) :: acd119
      complex(ki) :: brack
      acd119(1)=k2(iv1)
      acd119(2)=abb119(9)
      acd119(3)=l6(iv1)
      ...
      acd119(6)=abb119(11)
      acd119(7)=spvak4k2(iv1)
      acd119(8)=abb119(16)
      acd119(9)=-acd119(2)*acd119(1)
      acd119(10)=-acd119(4)*acd119(3)
      acd119(11)=-acd119(6)*acd119(5)
      acd119(12)=-acd119(8)*acd119(7)
      brack=acd119(9)+acd119(10)+acd119(11)+acd119(12)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd119(12)=acd119(6)*acd119(7)
      acd119(11)=acd119(12)+acd119(11)
      acd119(11)=acd119(3)*acd119(11)
      acd119(12)=acd119(9)*acd119(5)
      acd119(13)=acd119(10)*acd119(7)
      acd119(12)=acd119(13)+acd119(12)
      acd119(12)=acd119(8)*acd119(12)
      acd119(13)=acd119(2)*acd119(1)
      brack=acd119(11)+acd119(12)+2.0_ki*acd119(13)
...
!---#] subroutine reconstruct_d119:
end module     p0_dbaru_epnebbbarg_d119h6l1d
