module     p5_usbar_epnebbbarg_abbrevd81h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb81(7)=TR*gW
      abb81(6)=abb81(6)*abb81(7)**2*i_*CVSU*abb81(3)*abb81(1)
      abb81(7)=-abb81(6)*spbk7l5
      abb81(8)=abb81(7)*spak2l6
      abb81(9)=abb81(8)*spak4k7
      abb81(10)=spbe7k1*spbk7k3
      abb81(11)=abb81(10)*spae7k7
      abb81(12)=-abb81(11)*abb81(9)
      abb81(13)=spak2l6*spbl5k3
      ...
      abb81(21)=-abb81(6)*spak4l6
      abb81(35)=abb81(21)*spbl5k1
      abb81(36)=-spbk4k3*spak2e7*abb81(35)
      abb81(37)=-abb81(6)*spak2e7
      abb81(38)=abb81(37)*spbl5k1
      abb81(39)=spal6k7*spbk7k3
      ...
      abb81(52)=spbe7l5*spak4l6
      abb81(59)=abb81(52)*spbk4k3
      abb81(60)=abb81(39)*spbe7l5
      ...
      abb81(51)=spbk4k3*spak4l6
      abb81(73)=spak1l6*spbk3k1
      abb81(74)=spbk3k2*spak2l6
      abb81(73)=abb81(39)-abb81(51)+abb81(73)+abb81(74)
      abb81(73)=abb81(60)*spbk7l5*abb81(73)
      ...
      abb81(88)=-abb81(6)*spbl5k1
      abb81(89)=abb81(88)*spak2l6
      ...
      abb81(90)=spbe7l5*abb81(37)
      abb81(91)=spak2l6*abb81(90)
      ...
      abb81(38)=-spal6k7*spbk7e7*abb81(38)
      abb81(92)=-spak3l6*abb81(33)*abb81(88)
      ...
      abb81(65)=spak3l6*spbe7l5*abb81(66)
      ...
      abb81(93)=-spak3l6*spbk7k3*abb81(90)
      ...
      abb81(97)=spak2k3*spbl5k3*abb81(6)
      abb81(60)=-spbl5k4*abb81(60)
      ...
      abb81(7)=-spal6k7*abb81(23)*abb81(7)
      ...
      abb81(92)=spbl5k4*spak2l6*abb81(76)
      ...
      abb81(47)=-spak1l6*abb81(88)
      abb81(6)=-spbl5k2*spak2l6*abb81(6)
...
end module p5_usbar_epnebbbarg_abbrevd81h1
