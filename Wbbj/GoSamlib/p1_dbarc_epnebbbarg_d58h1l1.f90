module     p1_dbarc_epnebbbarg_d58h1l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p1_dbarc_epnebbbarg_abbrevd58h1
      implicit none
      ...
      acc58(14)=Qspl5+Qspl6
      acc58(14)=acc58(12)*acc58(14)
      acc58(15)=Qspvak7k1*acc58(4)
      acc58(16)=Qspval6l5*acc58(6)
      acc58(17)=Qspval6k2*acc58(9)
      acc58(18)=Qspvak4k3*acc58(7)
      acc58(19)=Qspvak4k2*acc58(1)
      acc58(20)=Qspvak1k7*acc58(3)
      acc58(21)=Qspk7*acc58(11)
      acc58(22)=Qspk2*acc58(8)
      acc58(23)=Qspk1*acc58(5)
...
!           & sign => diagram58_sign, shift => diagram58_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_epnebbbarg_d58h1l1
