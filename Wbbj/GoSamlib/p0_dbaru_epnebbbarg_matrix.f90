module     p0_dbaru_epnebbbarg_matrix
   ...
   use p0_dbaru_epnebbbarg_model, only: Nf, NC, sqrt2, init_functions
   use p0_dbaru_epnebbbarg_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p0_dbaru_epnebbbarg_diagramsh0l0, only: amplitude0l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh0, only: samplitudeh0l1 => samplitude, &
        &   finite_renormalisation0 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh1l0, only: amplitude1l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh1, only: samplitudeh1l1 => samplitude, &
        &   finite_renormalisation1 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh2l0, only: amplitude2l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh2, only: samplitudeh2l1 => samplitude, &
        &   finite_renormalisation2 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh3l0, only: amplitude3l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh3, only: samplitudeh3l1 => samplitude, &
        &   finite_renormalisation3 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh4l0, only: amplitude4l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh4, only: samplitudeh4l1 => samplitude, &
        &   finite_renormalisation4 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh5l0, only: amplitude5l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh5, only: samplitudeh5l1 => samplitude, &
        &   finite_renormalisation5 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh6l0, only: amplitude6l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh6, only: samplitudeh6l1 => samplitude, &
        &   finite_renormalisation6 => finite_renormalisation
   use p0_dbaru_epnebbbarg_diagramsh7l0, only: amplitude7l0 => amplitude
   use p0_dbaru_epnebbbarg_amplitudeh7, only: samplitudeh7l1 => samplitude, &
        &   finite_renormalisation7 => finite_renormalisation
   use p0_dbaru_epnebbbarg_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
   ...
   subroutine     banner()
      ...
      write(banner_ch,'(A74)') "|  \__/ \__/ (___/(_)(_)(_/\/\_)          Version 2.0.1 Rev: 734         |"
      write(banner_ch,'(A74)') "|                                                                        |"
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, ok, h)
      ...
      if(PSP_check) then
         ...
         if(icheck.eq.3.and.PSP_verbosity) then
            ...
            write(42,'(4x,A15,A19,A3)') &
                 &  "<process name='","p0_dbaru_epnebbbarg","'/>"
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use p0_dbaru_epnebbbarg_dipoles, only: pi
      implicit none
      real(ki), dimension(7, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      ...
      case default
         ! not implemented
         print*, "In p0_dbaru_epnebbbarg_matrix:"
      ...
      case (1)
         ...
         if(corrections_are_qcd) then
            ...
            ! wave function renormalisation:
               ...
               amp(2) = amp(2) - 2.5_ki * CF * amp(1)
               if (renorm_logs) then
                  amp(2) = amp(2) &
                 &   - (1.5_ki*log(scale2/mB/mB)) * CF * amp(1)
               end if
               amp(3) = amp(3) - 1.5_ki * CF * amp(1)
               amp(2) = amp(2) - 2.5_ki * CF * amp(1)
               if (renorm_logs) then
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p0_dbaru_epnebbbarg_config, only: logfile
      use p0_dbaru_epnebbbarg_kinematics, only: init_event
      implicit none
      real(ki), dimension(7, 4), intent(in) :: vecs
   ...
   subroutine     ir_subtraction(vecs,scale2,amp,h)
      ...
      if (eval_heli(0)) then
         ...
         color_vectorl0(2) = pcolor(2)
         color_vectorl0(3) = pcolor(3)
         color_vectorl0(4) = pcolor(4)
         if (corrections_are_qcd) then
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use p0_dbaru_epnebbbarg_color, only: T1T1, &
      & T1T2, &
      & T1T5, &
      & T1T6, &
      & T1T7, &
      ...
      res(5,5) = res(5,5)
      res(5,6) = square(color_vector,T5T6)
      res(6,5) = res(5,6)
      res(5,7) = square(color_vector,T5T7)
      res(7,5) = res(5,7)
      res(6,6) = square(color_vector,T6T6)
      res(6,6) = res(6,6)
      res(6,7) = square(color_vector,T6T7)
      res(7,6) = res(6,7)
   ...
   pure subroutine OLP_color_correlated_lo(color_vector,res)
      ...
      res(11) = square(color_vector,T1T6)  
      res(16) = square(color_vector,T1T7)    
      res(8) = square(color_vector,T2T5)  
      res(12) = square(color_vector,T2T6)  
      res(17) = square(color_vector,T2T7)    
      res(15) = square(color_vector,T5T6)  
      res(20) = square(color_vector,T5T7)    
      res(21) = square(color_vector,T6T7)   
   ...
   subroutine OLP_spin_correlated_lo2(vecs, ampsc)
      ...
      mp  = 0.0_ki &
      &          + square_7_5_sc(heli_amp0,heli_amp4) &
      &          + square_7_5_sc(heli_amp1,heli_amp5) &
      &          + square_7_5_sc(heli_amp2,heli_amp6) &
      &          + square_7_5_sc(heli_amp3,heli_amp7)


      ampsc(2*(7-1)+2*(5-1)*num_legs+1)   = ampsc(2*(7-1)+2*(5-1)*num_legs +1) + real(mp, ki)
      ampsc(2*(7-1)+2*(5-1)*num_legs+2) = ampsc(2*(7-1)+2*(5-1)*num_legs + 2)  + real(aimag(mp),ki)
      ...
      mp  = 0.0_ki &
      &          + square_7_6_sc(heli_amp0,heli_amp4) &
      &          + square_7_6_sc(heli_amp1,heli_amp5) &
      &          + square_7_6_sc(heli_amp2,heli_amp6) &
      &          + square_7_6_sc(heli_amp3,heli_amp7)


      ampsc(2*(7-1)+2*(6-1)*num_legs+1)   = ampsc(2*(7-1)+2*(6-1)*num_legs +1) + real(mp, ki)
      ampsc(2*(7-1)+2*(6-1)*num_legs+2) = ampsc(2*(7-1)+2*(6-1)*num_legs + 2)  + real(aimag(mp),ki)
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use p0_dbaru_epnebbbarg_color, only: cmat => CC
      implicit none
   ...
   pure function square_7_1_sc(color_vector1, color_vector2) result(amp)
      use p0_dbaru_epnebbbarg_color, only: cmat => T1T7
   ...
   pure function square_7_2_sc(color_vector1, color_vector2) result(amp)
      use p0_dbaru_epnebbbarg_color, only: cmat => T2T7
   ...
   pure function square_7_5_sc(color_vector1, color_vector2) result(amp)
      use p0_dbaru_epnebbbarg_color, only: cmat => T5T7
      ...
      v2 = conjg(color_vector1)
      amp = sum(v1(:) * v2(:))
   end function  square_7_5_sc
      
   pure function square_7_6_sc(color_vector1, color_vector2) result(amp)
      use p0_dbaru_epnebbbarg_color, only: cmat => T6T7
      ...
      v2 = conjg(color_vector1)
      amp = sum(v1(:) * v2(:))
   end function  square_7_6_sc
       

end module p0_dbaru_epnebbbarg_matrix
