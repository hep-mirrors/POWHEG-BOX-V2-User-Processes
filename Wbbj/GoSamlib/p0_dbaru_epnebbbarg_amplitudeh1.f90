module    p0_dbaru_epnebbbarg_amplitudeh1
   ...
   use p0_dbaru_epnebbbarg_samuraih1
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group0
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group1
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group2
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group5(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group5
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group6(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group6
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group7(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group7
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group8(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group8
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group9(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group9
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group10(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group10
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group11(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group11
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group12(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group12
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group13(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group13
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group14(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group14
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group15(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group15
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group16(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group16
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group17(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group17
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group18(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group18
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group19(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group19
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group20(scale2,samplitude,ok)
   ...
   use p0_dbaru_epnebbbarg_samuraih1, only: samurai_reduce => reduce_group20
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
