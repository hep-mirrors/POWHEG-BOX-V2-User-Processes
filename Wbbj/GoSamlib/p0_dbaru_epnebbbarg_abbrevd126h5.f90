module     p0_dbaru_epnebbbarg_abbrevd126h5
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb126(17)=abb126(11)*spal5l6*abb126(16)*spbl5k2**2
      abb126(18)=-16.0_ki*abb126(17)
      abb126(19)=spal6k7*spak1k4
      abb126(20)=spak4l6*spak1k7
      abb126(21)=abb126(19)+abb126(20)
      abb126(13)=abb126(13)*abb126(14)*spbl5k2*abb126(6)
      ...
      abb126(37)=abb126(24)*spak2l6
      abb126(38)=abb126(15)*abb126(37)
      abb126(15)=-spbl5k2*abb126(15)
      abb126(39)=abb126(15)*spak2l6
      ...
      abb126(20)=-spbl6k2*abb126(19)
      abb126(36)=spal5k7*abb126(47)
      abb126(49)=-spak4l5*abb126(13)*abb126(10)
      ...
      abb126(16)=-abb126(16)*spak1l6
      abb126(31)=-spbl6k2*abb126(16)
      abb126(34)=-spak1l5*abb126(13)
      ...
      abb126(13)=spak2l6*abb126(13)
      abb126(13)=abb126(50)+abb126(13)-abb126(30)
...
end module p0_dbaru_epnebbbarg_abbrevd126h5
