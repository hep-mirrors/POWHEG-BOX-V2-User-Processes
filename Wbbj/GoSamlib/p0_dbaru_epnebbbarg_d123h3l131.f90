module     p0_dbaru_epnebbbarg_d123h3l131
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity3d123h3l131.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p0_dbaru_epnebbbarg_abbrevd123h3
      implicit none
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd123(9)=dotproduct(ninjaE4,spvak1k2)
      acd123(10)=abb123(24)
      acd123(11)=dotproduct(ninjaE4,spval6k2)
      acd123(12)=abb123(37)
      acd123(13)=dotproduct(ninjaE4,spval5k2)
      acd123(14)=abb123(41)
      acd123(15)=dotproduct(ninjaE3,spvak1k2)
      acd123(16)=dotproduct(ninjaE3,spval6k2)
      acd123(17)=dotproduct(ninjaE3,spval5k2)
      acd123(18)=abb123(26)
      acd123(19)=abb123(17)
      acd123(20)=dotproduct(ninjaE3,spvak4k2)
      acd123(21)=abb123(31)
      ...
      acd123(41)=abb123(14)
      acd123(42)=abb123(18)
      acd123(43)=dotproduct(ninjaE3,spvak2k3)
      acd123(44)=abb123(27)
      acd123(45)=abb123(40)
      acd123(46)=dotproduct(ninjaE3,spval6k3)
      acd123(47)=abb123(39)
      acd123(48)=abb123(43)
      acd123(49)=dotproduct(ninjaE3,spval5k3)
      acd123(50)=abb123(42)
      ...
      acd123(57)=abb123(20)
      acd123(58)=abb123(16)
      acd123(59)=dotproduct(ninjaA,spvak1k3)
      acd123(60)=dotproduct(ninjaA,spvak2k3)
      acd123(61)=dotproduct(ninjaA,spval6k3)
      acd123(62)=dotproduct(ninjaA,spval5k3)
      acd123(63)=abb123(11)
      acd123(64)=abb123(22)
      acd123(65)=dotproduct(ninjaE3,spvak7k2)
      acd123(66)=abb123(25)
      acd123(67)=acd123(14)*acd123(13)
      acd123(68)=acd123(12)*acd123(11)
      acd123(69)=acd123(10)*acd123(9)
      acd123(70)=acd123(4)*acd123(8)
      acd123(67)=-acd123(67)+acd123(68)+acd123(69)-acd123(70)
      acd123(67)=acd123(67)*acd123(5)
      acd123(68)=acd123(14)*acd123(17)
      acd123(69)=acd123(12)*acd123(16)
      acd123(70)=acd123(10)*acd123(15)
      ...
      acd123(71)=acd123(71)+acd123(19)
      acd123(72)=acd123(5)*acd123(71)
      acd123(73)=acd123(20)*acd123(21)
      ...
      acd123(74)=acd123(50)*acd123(49)
      acd123(75)=acd123(47)*acd123(46)
      acd123(76)=acd123(44)*acd123(43)
      acd123(77)=acd123(41)*acd123(40)
      acd123(78)=acd123(20)*acd123(39)
      acd123(79)=acd123(17)*acd123(48)
      acd123(80)=acd123(16)*acd123(45)
      acd123(81)=acd123(15)*acd123(42)
      ...
      acd123(72)=acd123(14)*acd123(37)
      acd123(74)=acd123(12)*acd123(36)
      acd123(75)=acd123(10)*acd123(35)
      acd123(76)=acd123(4)*acd123(22)
      acd123(72)=acd123(72)-acd123(74)-acd123(75)+acd123(76)+acd123(38)
      acd123(74)=acd123(5)*acd123(72)
      acd123(74)=acd123(74)+acd123(68)
      acd123(74)=acd123(2)*acd123(74)
      acd123(75)=acd123(20)*acd123(31)
      ...
      acd123(78)=acd123(82)*acd123(19)
      acd123(77)=acd123(77)+acd123(78)
      acd123(78)=acd123(1)*acd123(30)
      ...
      acd123(76)=acd123(50)*acd123(62)
      acd123(78)=acd123(47)*acd123(61)
      acd123(79)=acd123(44)*acd123(60)
      acd123(80)=acd123(41)*acd123(59)
      acd123(81)=acd123(39)*acd123(54)
      acd123(83)=acd123(37)*acd123(48)
      acd123(84)=acd123(36)*acd123(45)
      acd123(85)=acd123(35)*acd123(42)
      ...
      acd123(76)=acd123(19)*acd123(53)
      acd123(78)=acd123(22)*acd123(30)
      acd123(71)=acd123(72)+acd123(78)+acd123(76)+acd123(64)+acd123(74)+acd123(&
      &71)
      ...
      acd123(78)=acd123(31)*acd123(54)
      acd123(79)=acd123(28)*acd123(30)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d123h3_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p0_dbaru_epnebbbarg_d123h3l131
