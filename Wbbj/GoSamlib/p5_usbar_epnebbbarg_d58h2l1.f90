module     p5_usbar_epnebbbarg_d58h2l1
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p5_usbar_epnebbbarg_abbrevd58h2
      implicit none
      ...
      acc58(11)=Qspe7*acc58(5)
      acc58(12)=Qspk7*acc58(6)
      acc58(13)=Qspk1*acc58(1)
      brack=acc58(7)+acc58(8)+acc58(9)+acc58(10)+acc58(11)+acc58(12)+acc58(13)
...
!           & sign => diagram58_sign, shift => diagram58_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p5_usbar_epnebbbarg_d58h2l1
