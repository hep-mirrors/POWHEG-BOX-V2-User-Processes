module     p9_csbar_epnebbbarg_d223h1l1
   ! file: /home/tramonta/codes/POWHEG/WBBJ/GoSam_POWHEG/Virtual/p9_csbar_epneb &
   ! &bbarg/helicity1d223h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p9_csbar_epnebbbarg_abbrevd223h1
      implicit none
      ...
      acc223(19)=Qspval6k3*acc223(16)
      acc223(20)=Qspval6k1*acc223(15)
      acc223(21)=Qspvak2k3*acc223(6)
      ...
      acc223(21)=Qspval6k7*acc223(12)
      acc223(22)=Qspvak2k7*acc223(3)
      acc223(23)=Qspk7*acc223(14)
      acc223(24)=QspQ*acc223(13)
      brack=acc223(5)+acc223(17)+acc223(18)+acc223(19)+acc223(20)+acc223(21)+ac&
...
!           & sign => diagram223_sign, shift => diagram223_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p9_csbar_epnebbbarg_d223h1l1
