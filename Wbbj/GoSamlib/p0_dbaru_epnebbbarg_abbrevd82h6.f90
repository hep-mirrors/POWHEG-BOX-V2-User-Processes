module     p0_dbaru_epnebbbarg_abbrevd82h6
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb82(15)=spak4l5*spbl6k2
      abb82(16)=abb82(15)*spak1k7
      abb82(17)=spbk4k3*abb82(16)
      abb82(18)=spbl6k2*spak1k7
      abb82(19)=spbk3k1*abb82(18)*spak1l5
      ...
      abb82(32)=abb82(34)+abb82(32)
      abb82(32)=spal5k7*spak1k7*abb82(32)
      ...
      abb82(50)=abb82(10)*spak1l5
      abb82(34)=-abb82(50)*abb82(34)
      abb82(33)=-spal5k7*abb82(33)
      ...
      abb82(41)=abb82(50)*spbl6k1
      abb82(39)=abb82(39)-abb82(41)
      abb82(41)=-abb82(9)*spak1l5
      ...
      abb82(51)=abb82(10)*spbl6k3
      abb82(52)=spak1l5*abb82(51)
      ...
      abb82(55)=spak3l5*abb82(50)
      abb82(53)=abb82(55)+abb82(53)
      abb82(53)=spbl6k2*abb82(53)
      ...
      abb82(58)=-8.0_ki*spbl6k2*abb82(41)
      abb82(60)=-spbk7l6*abb82(41)
      ...
      abb82(63)=spak1k2*spbl6k2
      abb82(64)=spbk7l6*spak1k7
      abb82(65)=spak1k3*spbl6k3
      abb82(63)=abb82(65)+abb82(63)+abb82(64)
      abb82(63)=-abb82(9)*abb82(63)
      abb82(64)=spbl6k4*abb82(10)
...
end module p0_dbaru_epnebbbarg_abbrevd82h6
