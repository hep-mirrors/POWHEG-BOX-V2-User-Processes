module     p0_dbaru_epnebbbarg_d223h5l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity5d223h5l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc223(16)=abb223(45)
      acc223(17)=abb223(49)
      acc223(18)=acc223(7)*Qspval6k2
      acc223(19)=acc223(10)*Qspval6l5
      acc223(20)=acc223(16)*Qspk2
      acc223(21)=Qspvak4l5*acc223(13)
      acc223(22)=Qspvak4k2*acc223(9)
      acc223(23)=Qspvak1l5*acc223(4)
      ...
      acc223(21)=acc223(1)*Qspval6l5
      acc223(22)=acc223(3)*Qspval6k2
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d223h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_dbaru_epnebbbarg_d223h5l1
