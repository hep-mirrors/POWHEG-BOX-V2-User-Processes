module     p5_usbar_epnebbbarg_groups
   use precision, only: ki_sam => ki
   use madds
   use precision_golem, only: ki_gol => ki
   use tens_rec
   use p5_usbar_epnebbbarg_config, only: ki , reduction_interoperation, samurai_scalar 
   implicit none
   save
...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use p5_usbar_epnebbbarg_config, only: debug_nlo_diagrams, logfile
   use p5_usbar_epnebbbarg_kinematics, only: k1, k2, k3, k4, k5, k6, k7, es234, es345, es12, es6, es671, es567, es23, &
...
!---#] subroutine tear_down_golem95:
end module p5_usbar_epnebbbarg_groups
