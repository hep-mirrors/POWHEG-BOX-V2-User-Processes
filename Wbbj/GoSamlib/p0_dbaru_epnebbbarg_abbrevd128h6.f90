module     p0_dbaru_epnebbbarg_abbrevd128h6
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb128(77)=abb128(42)*spbk7l6
      abb128(78)=abb128(77)*abb128(71)
      abb128(67)=abb128(67)*abb128(12)
      abb128(79)=abb128(52)*abb128(9)
      ...
      abb128(85)=abb128(10)*spak1k2
      abb128(86)=abb128(84)*abb128(85)
      abb128(87)=abb128(67)*spbl6k2
      abb128(13)=abb128(13)*spbl6k2
      ...
      abb128(96)=abb128(96)*spal6k7
      abb128(97)=abb128(96)*spak1l5
      abb128(36)=abb128(28)*abb128(36)
      abb128(36)=abb128(36)-abb128(40)
      abb128(40)=abb128(36)*abb128(10)
      ...
      abb128(99)=abb128(18)*c1
      abb128(18)=abb128(18)*c3
      abb128(100)=abb128(99)-abb128(18)
      abb128(24)=spal5k7*abb128(24)
      abb128(24)=abb128(24)-abb128(31)
      abb128(31)=abb128(24)*abb128(10)
      ...
      abb128(108)=abb128(107)*spbl5k2
      abb128(94)=abb128(94)-abb128(108)
      abb128(108)=abb128(94)*spak4l5
      ...
      abb128(84)=-abb128(7)*abb128(53)*abb128(20)
      ...
      abb128(125)=-spbl6k2-3.0_ki*abb128(79)
      ...
      abb128(61)=-spbl5k2*abb128(26)
      abb128(46)=abb128(46)+abb128(61)
      abb128(46)=spak2l5*abb128(46)
      abb128(26)=abb128(26)*abb128(73)
      abb128(61)=-spak2l6*spak1k4*abb128(95)
      ...
      abb128(56)=abb128(30)*spak2k7
      abb128(88)=abb128(88)*abb128(11)
      abb128(56)=abb128(56)-abb128(88)
      abb128(88)=abb128(56)*spak1k4
      abb128(92)=abb128(117)*spbl5k2
      abb128(127)=abb128(92)*spbl6k3
      abb128(77)=abb128(77)*abb128(16)
      abb128(77)=abb128(77)-abb128(127)
      abb128(88)=abb128(88)-abb128(77)
      abb128(88)=-abb128(123)+2.0_ki*abb128(88)
      abb128(88)=8.0_ki*abb128(88)
      ...
      abb128(77)=abb128(14)*abb128(32)
      abb128(77)=abb128(77)+abb128(51)
      abb128(77)=abb128(77)*abb128(34)
      abb128(123)=abb128(111)*abb128(32)
      abb128(50)=-abb128(77)+abb128(123)+abb128(50)
      abb128(77)=es12*abb128(50)
      abb128(123)=abb128(51)*spak1k2
      abb128(14)=abb128(14)*abb128(97)
      abb128(14)=abb128(123)+abb128(14)
      abb128(123)=abb128(14)*spbl5k2
      abb128(47)=abb128(47)*abb128(105)
      abb128(123)=abb128(123)-abb128(47)
      abb128(128)=abb128(123)*spak4l5
      ...
      abb128(129)=spak3l5*abb128(94)
      abb128(37)=-spak3k7*abb128(37)
      abb128(45)=abb128(45)*spak1k2
      abb128(130)=spak4l6*spbk4k2
      abb128(131)=abb128(45)*abb128(130)
      abb128(132)=-spak3l6*abb128(109)
      abb128(37)=abb128(132)+abb128(129)+abb128(37)+abb128(131)+abb128(128)+abb&
      &128(77)
      abb128(37)=4.0_ki*abb128(37)
      abb128(77)=abb128(115)*abb128(32)
      abb128(77)=abb128(84)+abb128(77)+abb128(112)-abb128(113)
      abb128(112)=-spak1k3*abb128(77)
      abb128(103)=3.0_ki*abb128(103)
      abb128(115)=-spbl6k2*abb128(60)
      abb128(48)=abb128(115)*abb128(48)
      ...
      abb128(15)=abb128(112)+abb128(15)-abb128(50)
      abb128(15)=8.0_ki*abb128(15)
      abb128(50)=-8.0_ki*abb128(50)
      abb128(112)=spbl6k3*abb128(39)
      abb128(112)=abb128(112)-abb128(68)
      abb128(128)=abb128(51)*spbk7k3
      abb128(112)=abb128(128)+2.0_ki*abb128(112)
      abb128(112)=spak1k3*abb128(112)
      ...
      abb128(118)=spbk7l6*abb128(118)
      abb128(118)=abb128(118)+abb128(132)
      abb128(132)=2.0_ki*spbk4k2
      abb128(118)=abb128(132)*abb128(118)
      abb128(28)=spbl6k4*abb128(28)
      abb128(133)=spbk7k4*abb128(67)
      abb128(25)=abb128(133)+abb128(28)+abb128(25)+abb128(118)+abb128(112)
      abb128(25)=4.0_ki*abb128(25)
      abb128(28)=abb128(51)*spbl6k3
      abb128(28)=abb128(28)+abb128(59)
      abb128(112)=-spak1k3*abb128(28)
      abb128(69)=abb128(69)*spbl6k2
      abb128(13)=abb128(69)-abb128(13)
      abb128(69)=abb128(13)*abb128(82)
      abb128(82)=-spbk4k2*spak1k4*abb128(69)
      abb128(118)=-spbl6k4*abb128(67)
      abb128(82)=abb128(118)+abb128(112)+abb128(45)+abb128(82)
      abb128(82)=4.0_ki*abb128(82)
      abb128(102)=abb128(102)-abb128(17)
      abb128(112)=abb128(102)*spbl5k2
      abb128(112)=abb128(112)-abb128(16)
      abb128(118)=spbl6k3*abb128(112)
      abb128(118)=abb128(56)+abb128(118)
      abb128(133)=-spbl5k3*abb128(51)
      abb128(118)=abb128(133)+2.0_ki*abb128(118)
      abb128(118)=spak1k3*abb128(118)
      abb128(133)=abb128(80)*spak2k7
      abb128(81)=abb128(81)*abb128(64)
      abb128(81)=abb128(133)-abb128(81)
      abb128(133)=abb128(132)*spak1k4*abb128(81)
      abb128(16)=-spak1k4*abb128(16)
      abb128(16)=abb128(16)+abb128(92)
      abb128(16)=spbl6k4*abb128(16)
      abb128(67)=-spbl5k4*abb128(67)
      abb128(16)=abb128(67)+2.0_ki*abb128(16)+abb128(133)-abb128(123)+abb128(11&
      &8)
      abb128(16)=4.0_ki*abb128(16)
      abb128(67)=spal6k7*abb128(21)
      abb128(79)=spbl6k2+6.0_ki*abb128(79)
      abb128(79)=abb128(79)*abb128(99)
      abb128(18)=-4.0_ki*abb128(67)+abb128(79)-abb128(22)-6.0_ki*abb128(18)
      abb128(18)=spak1k2*abb128(18)
      abb128(22)=spak1k7*abb128(122)
      abb128(22)=abb128(49)-abb128(22)
      abb128(49)=4.0_ki*abb128(72)
      abb128(67)=4.0_ki*spbl6k3
      abb128(72)=abb128(67)*abb128(63)
      abb128(79)=abb128(102)*abb128(34)
      abb128(67)=abb128(79)*abb128(67)
      abb128(92)=abb128(85)*abb128(114)
      abb128(99)=abb128(86)+abb128(92)
      abb128(102)=-abb128(11)*abb128(99)
      abb128(84)=abb128(84)*spak1k2
      abb128(18)=4.0_ki*abb128(102)+abb128(72)-2.0_ki*abb128(84)+abb128(67)-abb&
      ...
      abb128(30)=abb128(63)+abb128(79)
      abb128(43)=abb128(98)*abb128(30)
      abb128(63)=abb128(28)*spak1l6
      abb128(43)=-abb128(124)+abb128(43)-abb128(63)+abb128(22)
      abb128(63)=abb128(99)*abb128(91)
      abb128(21)=abb128(21)*abb128(105)
      abb128(65)=abb128(113)*spak1k2
      abb128(21)=abb128(21)-abb128(65)
      abb128(65)=abb128(21)+abb128(84)
      abb128(67)=abb128(63)-abb128(43)+abb128(65)
      abb128(72)=es23-es123
      abb128(79)=-abb128(67)*abb128(72)
      abb128(38)=-spak1k2*abb128(38)
      abb128(47)=spak1l5*abb128(47)
      ...
      abb128(38)=-spak4l6*abb128(45)
      abb128(35)=abb128(38)-abb128(35)
      abb128(35)=spbk4k3*abb128(35)
      abb128(38)=-spak2l5*abb128(94)
      abb128(28)=-es12*abb128(28)
      abb128(45)=spbk3k1*abb128(45)
      abb128(28)=2.0_ki*abb128(28)+abb128(45)
      abb128(28)=spak1l6*abb128(28)
      abb128(45)=spak1k7*abb128(72)
      abb128(47)=es12*abb128(71)
      abb128(45)=abb128(47)+abb128(45)
      abb128(45)=abb128(45)*abb128(128)
      abb128(47)=abb128(51)*spak1l5
      abb128(49)=abb128(47)*spbl5k3
      abb128(72)=-2.0_ki*es12-abb128(72)
      abb128(72)=abb128(72)*abb128(49)
      abb128(73)=spak2l6*abb128(109)
      abb128(14)=abb128(73)+abb128(38)+abb128(35)+abb128(72)+abb128(45)+abb128(&
      &28)+abb128(14)+abb128(79)+abb128(34)+abb128(18)
      abb128(14)=4.0_ki*abb128(14)
      abb128(18)=16.0_ki*abb128(106)
      abb128(28)=abb128(76)*abb128(51)
      abb128(28)=abb128(49)-abb128(28)
      abb128(34)=abb128(28)+abb128(67)
      abb128(35)=8.0_ki*abb128(34)
      abb128(38)=-abb128(92)+abb128(86)
      abb128(38)=abb128(38)*abb128(91)
      abb128(28)=abb128(38)-abb128(65)-abb128(43)+abb128(28)
      abb128(28)=8.0_ki*abb128(28)
      abb128(34)=4.0_ki*abb128(34)
      abb128(38)=-16.0_ki*abb128(36)*abb128(85)
      abb128(43)=16.0_ki*spak1k2
      abb128(45)=-abb128(68)*abb128(43)
      abb128(49)=-abb128(23)*abb128(43)
      abb128(65)=spak1k2*abb128(96)
      abb128(67)=-spak1k2*abb128(100)
      abb128(24)=-abb128(24)*abb128(85)
      abb128(24)=abb128(67)+abb128(24)
      abb128(24)=spbl5k2*abb128(24)
      abb128(24)=abb128(65)+abb128(24)
      abb128(24)=16.0_ki*abb128(24)
      abb128(43)=abb128(56)*abb128(43)
      abb128(54)=abb128(54)-abb128(103)
      abb128(54)=spak1k2*abb128(54)
      abb128(17)=abb128(17)*spbk7l6
      abb128(60)=abb128(60)+abb128(17)
      abb128(65)=-abb128(71)*abb128(60)
      abb128(64)=abb128(64)*abb128(93)
      abb128(67)=abb128(89)*spak1k7
      abb128(64)=abb128(64)+abb128(67)
      abb128(67)=abb128(78)*abb128(85)
      abb128(67)=abb128(67)+abb128(64)
      abb128(67)=abb128(67)*abb128(91)
      abb128(71)=-abb128(80)*abb128(83)
      abb128(72)=spak1l6*abb128(69)
      abb128(73)=-abb128(115)*abb128(105)
      abb128(54)=abb128(72)+abb128(67)+abb128(71)+abb128(73)+abb128(65)+abb128(&
      &54)
      abb128(54)=spbk4k2*abb128(54)
      abb128(65)=abb128(51)*spak1l6
      abb128(30)=-abb128(65)+2.0_ki*abb128(30)
      abb128(65)=-spbl6k4*abb128(30)
      abb128(67)=-spbk7k4*spak1k7*abb128(51)
      abb128(71)=spbl5k4*abb128(47)
      abb128(54)=abb128(71)+abb128(67)+abb128(65)+abb128(54)
      abb128(54)=4.0_ki*abb128(54)
      abb128(21)=abb128(63)+abb128(21)-abb128(22)+abb128(84)+abb128(124)
      abb128(21)=spak1k4*abb128(21)
      abb128(22)=-abb128(87)*abb128(98)
      abb128(63)=-abb128(117)*abb128(101)
      abb128(21)=abb128(63)+abb128(22)+abb128(21)-abb128(121)
      abb128(21)=4.0_ki*spbk3k1*abb128(21)
      abb128(22)=abb128(26)*spak4k7
      abb128(63)=4.0_ki*abb128(20)
      abb128(65)=spak4k7*abb128(63)
      abb128(67)=abb128(51)*spbk4k2
      abb128(71)=-spak4k7*abb128(67)
      abb128(72)=-spak3k7*abb128(20)
      abb128(71)=abb128(71)+abb128(72)
      abb128(71)=4.0_ki*abb128(71)
      abb128(72)=abb128(31)*spak4l5
      abb128(73)=abb128(40)*spak4k7
      abb128(72)=abb128(73)+abb128(72)
      abb128(73)=abb128(20)*spak4l6
      abb128(72)=-abb128(73)+2.0_ki*abb128(72)
      abb128(73)=8.0_ki*abb128(72)
      abb128(72)=4.0_ki*abb128(72)
      abb128(76)=2.0_ki*spak3l5
      abb128(78)=-abb128(31)*abb128(76)
      abb128(79)=-spak4l5*abb128(112)
      abb128(83)=-spak4k7*abb128(39)
      abb128(79)=abb128(83)+abb128(79)
      abb128(79)=abb128(79)*abb128(132)
      abb128(83)=spak4l6*abb128(67)
      abb128(36)=-spak3k7*abb128(36)*abb128(32)
      abb128(84)=spak3l6*abb128(20)
      abb128(36)=abb128(84)+abb128(78)+abb128(36)+abb128(79)+abb128(83)
      abb128(36)=4.0_ki*abb128(36)
      abb128(78)=abb128(26)*spak4l5
      abb128(63)=-spak4l5*abb128(63)
      abb128(67)=spak4l5*abb128(67)
      abb128(20)=spak3l5*abb128(20)
      abb128(20)=abb128(67)+abb128(20)
      abb128(20)=4.0_ki*abb128(20)
      abb128(67)=abb128(26)*spak3k4
      abb128(79)=abb128(77)*abb128(52)
      abb128(83)=abb128(40)*abb128(52)
      abb128(84)=abb128(68)*abb128(52)
      abb128(85)=abb128(23)*abb128(52)
      abb128(86)=abb128(31)*abb128(52)
      abb128(52)=-abb128(56)*abb128(52)
      abb128(26)=abb128(26)*spak2k4
      abb128(77)=spak2k4*abb128(77)
      abb128(44)=abb128(44)-abb128(53)
      abb128(53)=-spak4k7*abb128(44)
      abb128(87)=abb128(56)*spak4l5
      abb128(89)=abb128(122)*spak4k7
      abb128(53)=-abb128(89)+abb128(53)+abb128(87)
      abb128(87)=abb128(59)*spak4l6
      abb128(77)=-abb128(87)+2.0_ki*abb128(53)+abb128(77)
      abb128(87)=8.0_ki*abb128(77)
      abb128(89)=-spak4l6*abb128(23)
      abb128(53)=abb128(89)+abb128(53)
      abb128(53)=16.0_ki*abb128(53)
      abb128(77)=-4.0_ki*abb128(77)
      abb128(89)=8.0_ki*spak2k4
      abb128(40)=-abb128(40)*abb128(89)
      abb128(44)=-abb128(44)-abb128(122)
      abb128(44)=abb128(44)*abb128(89)
      abb128(23)=-abb128(23)*abb128(89)
      abb128(31)=-abb128(31)*abb128(89)
      abb128(89)=abb128(56)*abb128(89)
      abb128(60)=spak1k7*abb128(60)
      abb128(64)=-abb128(11)*abb128(64)
      abb128(80)=abb128(80)*abb128(93)
      abb128(13)=abb128(13)*spak2k7
      abb128(91)=-spak1l6*abb128(13)
...
end module p0_dbaru_epnebbbarg_abbrevd128h6
