module     p0_dbaru_epnebbbarg_abbrevd113h6
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb113(28)=abb113(25)*spak1l5
      abb113(21)=abb113(21)+abb113(28)
      abb113(28)=abb113(21)*spbl5k2
      abb113(29)=spbl6k2**2
      ...
      abb113(29)=spak1l5*abb113(11)
      abb113(35)=abb113(42)*abb113(43)
      abb113(37)=abb113(34)*spal5k7
      abb113(35)=abb113(37)-abb113(35)
      abb113(37)=spak4l5*abb113(35)
      abb113(29)=abb113(37)+abb113(29)
      abb113(29)=spbl5k2*abb113(29)
      ...
      abb113(68)=abb113(9)*abb113(8)
      abb113(62)=abb113(47)*abb113(68)*abb113(62)
      abb113(36)=spak2l6*abb113(36)
      abb113(29)=abb113(36)+abb113(29)+abb113(62)
      abb113(31)=spak4l6*abb113(31)
      abb113(36)=-spbl5k2*abb113(50)
      ...
      abb113(31)=spak2l5*abb113(31)
      abb113(36)=spak4l6*abb113(16)
      abb113(39)=spak1l6*abb113(25)
      abb113(36)=abb113(39)+abb113(36)
      abb113(36)=spbk7l6*abb113(36)
      abb113(39)=c2-c4
      abb113(39)=abb113(39)*abb113(61)
      abb113(39)=abb113(39)+abb113(63)
      abb113(42)=3.0_ki*abb113(9)
      ...
      abb113(38)=-abb113(40)+2.0_ki*abb113(43)
      abb113(38)=abb113(38)*abb113(61)
      abb113(38)=abb113(38)+abb113(24)
      abb113(38)=abb113(38)*abb113(68)
      abb113(22)=abb113(38)-abb113(22)
      abb113(22)=spak1k2*abb113(22)
      abb113(15)=abb113(63)*abb113(15)
      abb113(38)=abb113(52)-2.0_ki*abb113(53)
      abb113(38)=abb113(38)*abb113(61)
      abb113(38)=abb113(38)-abb113(15)
      abb113(38)=abb113(38)*abb113(68)
      abb113(38)=abb113(38)+abb113(41)
      abb113(38)=spak2k4*abb113(38)
      abb113(22)=abb113(38)+abb113(22)
      ...
      abb113(41)=abb113(23)*c4
      abb113(38)=abb113(38)-abb113(41)
      abb113(55)=abb113(38)+abb113(51)
      abb113(55)=abb113(55)*spak1l5
      abb113(10)=abb113(10)*abb113(14)
      abb113(10)=abb113(10)-abb113(34)
      abb113(58)=abb113(10)+abb113(32)
      abb113(58)=abb113(58)*spak4l5
      abb113(55)=abb113(55)+abb113(58)
      abb113(58)=spbl5k2*abb113(55)
      abb113(64)=spak1l6*abb113(49)
      abb113(65)=spak4l6*abb113(54)
      abb113(13)=abb113(64)+abb113(65)+3.0_ki*abb113(13)+abb113(58)
      abb113(13)=4.0_ki*abb113(13)
      abb113(58)=abb113(36)*spak1k7
      abb113(64)=abb113(62)*spak4k7
      abb113(58)=abb113(58)-abb113(64)
      abb113(64)=-16.0_ki*abb113(58)
      abb113(58)=-8.0_ki*abb113(58)
      abb113(65)=-4.0_ki*abb113(37)+5.0_ki*abb113(51)+abb113(38)
      abb113(65)=spak1k7*abb113(65)
      abb113(67)=4.0_ki*abb113(66)+5.0_ki*abb113(32)+abb113(10)
      abb113(67)=spak4k7*abb113(67)
      abb113(65)=abb113(67)+abb113(65)
      abb113(65)=spbk7l6*abb113(65)
      abb113(67)=abb113(63)*abb113(23)
      abb113(69)=-abb113(41)+abb113(51)
      abb113(69)=abb113(69)*abb113(61)
      abb113(69)=abb113(69)+abb113(67)
      abb113(69)=abb113(69)*abb113(42)
      abb113(49)=abb113(69)+abb113(49)
      ...
      abb113(24)=spak1k2*abb113(24)
      abb113(29)=abb113(52)+abb113(53)
      abb113(29)=abb113(29)*abb113(61)
      abb113(15)=abb113(29)-abb113(15)
      abb113(15)=abb113(8)*abb113(15)
      abb113(29)=-abb113(45)*abb113(74)
      abb113(15)=abb113(15)+abb113(29)
      abb113(15)=spak2k4*abb113(15)
      abb113(15)=abb113(15)+abb113(24)
      abb113(15)=abb113(7)*abb113(15)
      abb113(24)=abb113(63)*abb113(14)
      abb113(29)=abb113(34)-abb113(32)
      abb113(29)=abb113(29)*abb113(61)
      abb113(29)=abb113(29)-abb113(24)
      abb113(29)=abb113(29)*abb113(42)
      abb113(29)=abb113(29)-abb113(54)
      abb113(29)=spak2k4*abb113(29)
      abb113(40)=spbl6l5*abb113(55)
      abb113(15)=3.0_ki*abb113(40)+abb113(15)+abb113(49)+abb113(65)+abb113(29)
      abb113(15)=4.0_ki*abb113(15)
      abb113(20)=abb113(6)*abb113(20)
      abb113(29)=-spal5k7*abb113(44)
      abb113(20)=abb113(29)+abb113(20)
      abb113(20)=abb113(6)*abb113(20)
      abb113(18)=abb113(18)+abb113(20)
      abb113(18)=8.0_ki*abb113(18)
      abb113(20)=-c2-abb113(33)
      abb113(20)=abb113(57)*abb113(20)
      abb113(29)=spal5l6*abb113(62)
      abb113(20)=abb113(29)+abb113(20)
      abb113(20)=8.0_ki*abb113(20)
      abb113(29)=-4.0_ki*abb113(16)
      abb113(16)=-2.0_ki*abb113(16)
      abb113(40)=-abb113(34)+2.0_ki*abb113(32)
      abb113(40)=abb113(40)*abb113(61)
      abb113(40)=abb113(40)+abb113(24)
      abb113(40)=abb113(40)*abb113(68)
      abb113(14)=abb113(73)*abb113(14)
      abb113(42)=abb113(75)*abb113(34)
      abb113(14)=abb113(14)-abb113(42)
      abb113(14)=abb113(14)*abb113(6)
      abb113(40)=abb113(40)-abb113(14)
      abb113(40)=abb113(40)*abb113(47)
      abb113(42)=abb113(61)*abb113(9)
      abb113(43)=abb113(42)*abb113(70)
      abb113(34)=abb113(34)*abb113(61)
      abb113(44)=-abb113(9)*abb113(6)*abb113(34)
      abb113(43)=abb113(43)+abb113(44)
      abb113(43)=abb113(6)*abb113(43)
      abb113(32)=-abb113(32)*abb113(42)
      abb113(32)=abb113(32)+abb113(43)
      abb113(32)=spak2l5*abb113(32)
      abb113(35)=spbk7l6*abb113(35)
      abb113(32)=abb113(32)+abb113(35)-abb113(77)+abb113(40)
      abb113(32)=8.0_ki*abb113(32)
      abb113(24)=-abb113(34)+abb113(24)
      abb113(24)=abb113(24)*abb113(68)
      abb113(14)=abb113(24)+abb113(14)
      abb113(14)=16.0_ki*abb113(14)
      abb113(10)=abb113(66)-abb113(10)
      abb113(10)=8.0_ki*abb113(10)
      abb113(21)=-spal5k7*abb113(21)
      abb113(24)=abb113(6)*abb113(27)
      abb113(21)=abb113(21)+abb113(24)
      abb113(21)=abb113(6)*abb113(21)
      abb113(21)=abb113(26)+abb113(21)
      abb113(21)=8.0_ki*abb113(21)
      abb113(24)=-spal5l6*abb113(36)
      abb113(26)=-abb113(59)*abb113(33)
      abb113(24)=abb113(24)-abb113(60)+abb113(26)
      abb113(24)=8.0_ki*abb113(24)
      abb113(26)=-4.0_ki*abb113(25)
      abb113(25)=-2.0_ki*abb113(25)
      abb113(27)=-abb113(41)+2.0_ki*abb113(51)
      abb113(27)=abb113(27)*abb113(61)
      abb113(27)=abb113(27)+abb113(67)
      abb113(27)=abb113(27)*abb113(68)
      abb113(23)=abb113(73)*abb113(23)
      abb113(30)=abb113(30)*abb113(72)
      abb113(23)=abb113(23)-abb113(30)
      abb113(23)=abb113(23)*abb113(6)
      abb113(27)=abb113(27)-abb113(23)
      abb113(27)=abb113(27)*abb113(47)
      abb113(11)=spbk7l6*abb113(11)
      abb113(30)=spak2l5*abb113(42)*abb113(56)
      abb113(11)=abb113(30)+abb113(11)+abb113(27)-abb113(76)
      abb113(11)=8.0_ki*abb113(11)
      abb113(27)=-abb113(61)*abb113(41)
      abb113(27)=abb113(27)+abb113(67)
      abb113(27)=abb113(27)*abb113(68)
      abb113(23)=abb113(27)+abb113(23)
      abb113(23)=16.0_ki*abb113(23)
      abb113(27)=-abb113(37)-abb113(38)
...
end module p0_dbaru_epnebbbarg_abbrevd113h6
