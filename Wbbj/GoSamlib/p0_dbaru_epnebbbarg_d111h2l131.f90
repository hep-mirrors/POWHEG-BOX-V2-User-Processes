module     p0_dbaru_epnebbbarg_d111h2l131
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity2d111h2l131.f90
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd111(4)=abb111(18)
      acd111(5)=dotproduct(ninjaE3,spval5l6)
      acd111(6)=abb111(27)
      acd111(7)=abb111(52)
      ...
      acd111(14)=dotproduct(ninjaE3,spval5k2)
      acd111(15)=abb111(25)
      acd111(16)=abb111(20)
      acd111(17)=abb111(14)
      acd111(18)=dotproduct(ninjaE3,spvak1k7)
      acd111(19)=abb111(30)
      acd111(20)=dotproduct(ninjaE3,spvak4k7)
      acd111(21)=abb111(42)
      acd111(22)=abb111(23)
      acd111(23)=dotproduct(ninjaE3,spvak4k2)
      acd111(24)=abb111(11)
      acd111(25)=dotproduct(ninjaE3,spvak1k2)
      acd111(26)=abb111(12)
      acd111(27)=dotproduct(ninjaE3,spval6k2)
      acd111(28)=abb111(22)
      acd111(29)=dotproduct(ninjaE3,spvak1l6)
      acd111(30)=abb111(24)
      acd111(31)=dotproduct(ninjaE3,spvak4l6)
      acd111(32)=abb111(33)
      acd111(33)=abb111(35)
      acd111(34)=abb111(44)
      ...
      acd111(40)=dotproduct(ninjaA,spval5k2)
      acd111(41)=dotproduct(ninjaA,spvak2k7)
      acd111(42)=dotproduct(ninjaA,spval5l6)
      acd111(43)=dotproduct(ninjaA,spvak1k7)
      acd111(44)=dotproduct(ninjaA,spvak4k7)
      acd111(45)=abb111(19)
      acd111(46)=abb111(41)
      acd111(47)=abb111(32)
      acd111(48)=abb111(16)
      acd111(49)=dotproduct(ninjaA,spvak4k2)
      acd111(50)=dotproduct(ninjaA,spvak1k2)
      acd111(51)=dotproduct(ninjaA,spval6k2)
      acd111(52)=dotproduct(ninjaA,spvak1l6)
      acd111(53)=dotproduct(ninjaA,spvak4l6)
      acd111(54)=abb111(10)
      acd111(55)=abb111(13)
      acd111(56)=abb111(34)
      acd111(57)=abb111(21)
      acd111(58)=abb111(45)
      acd111(59)=dotproduct(ninjaE3,spvak7k2)
      acd111(60)=abb111(29)
      acd111(61)=abb111(37)
      ...
      acd111(68)=acd111(27)*acd111(28)
      acd111(69)=acd111(26)*acd111(25)
      acd111(70)=acd111(24)*acd111(23)
      acd111(71)=acd111(14)*acd111(22)
      ...
      acd111(70)=acd111(18)*acd111(19)
      acd111(71)=acd111(11)*acd111(12)
      acd111(72)=acd111(14)*acd111(15)
      acd111(67)=acd111(69)+acd111(70)+acd111(71)+acd111(72)+acd111(67)+acd111(&
      &68)
      acd111(68)=acd111(5)*acd111(17)
      acd111(69)=acd111(3)*acd111(16)
      ...
      acd111(75)=acd111(28)*acd111(51)
      acd111(76)=acd111(26)*acd111(50)
      acd111(77)=acd111(24)*acd111(49)
      acd111(78)=acd111(22)*acd111(40)
      acd111(79)=acd111(35)*acd111(16)
      ...
      acd111(65)=acd111(41)*acd111(65)
      acd111(67)=acd111(35)*acd111(67)
      acd111(72)=acd111(34)*acd111(44)
      acd111(73)=acd111(33)*acd111(43)
      acd111(74)=-acd111(38)+acd111(74)
      acd111(74)=acd111(6)*acd111(74)
      acd111(75)=acd111(35)*acd111(17)
      acd111(72)=acd111(75)+acd111(74)+acd111(73)+acd111(56)+acd111(72)
      acd111(72)=acd111(5)*acd111(72)
      acd111(63)=-acd111(46)*acd111(63)
      acd111(73)=acd111(59)*acd111(60)
      acd111(74)=acd111(27)*acd111(58)
      acd111(75)=acd111(42)*acd111(34)
      acd111(75)=acd111(61)+acd111(75)
      acd111(75)=acd111(20)*acd111(75)
      acd111(76)=acd111(42)*acd111(33)
      acd111(76)=acd111(57)+acd111(76)
      acd111(76)=acd111(18)*acd111(76)
      acd111(77)=-acd111(15)*acd111(38)
      acd111(77)=acd111(54)+acd111(77)
      acd111(77)=acd111(14)*acd111(77)
      acd111(64)=acd111(48)*acd111(64)
      acd111(68)=acd111(47)-acd111(68)
      acd111(68)=acd111(11)*acd111(68)
      acd111(69)=acd111(42)*acd111(69)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d111h2_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p0_dbaru_epnebbbarg_d111h2l131
