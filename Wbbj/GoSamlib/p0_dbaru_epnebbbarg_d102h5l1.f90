module     p0_dbaru_epnebbbarg_d102h5l1
   ! file: /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX-V2/Wbbj_tmp/ &
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity5d102h5l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc102(42)=acc102(34)*Qspval6k2
      acc102(43)=acc102(36)*Qspval5k2
      ...
      acc102(43)=-acc102(20)*Qspval6k2
      acc102(44)=-acc102(31)*Qspval5k2
      ...
      acc102(45)=acc102(16)*Qspval5k3
      acc102(46)=acc102(17)*Qspval6k3
      acc102(47)=Qspval6k4*acc102(26)
      acc102(48)=Qspval5k4*acc102(29)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d102h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_dbaru_epnebbbarg_d102h5l1
