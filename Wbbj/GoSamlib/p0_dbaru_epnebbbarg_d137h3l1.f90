module     p0_dbaru_epnebbbarg_d137h3l1
   ...
   ! &GoSam_POWHEG/Virtual/p0_dbaru_epnebbbarg/helicity3d137h3l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc137(8)=acc137(9)+acc137(5)+acc137(8)
      acc137(8)=Qspvak2k7*acc137(8)
      acc137(9)=acc137(3)*Qspk2
      acc137(10)=Qspk7*acc137(6)
      acc137(11)=QspQ*acc137(7)
      brack=acc137(4)+acc137(8)+acc137(9)+acc137(10)+acc137(11)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_dbaru_epnebbbarg_d137h3l1_ninja")
