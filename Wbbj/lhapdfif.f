...
C*************************************************************************************
c     when running with nf_light equal 4, we need lam4 to compute the running of alpha_strong 
c     starting from as(MZ). In order to minimize the changes in the rest of the POWHEG BOX code,
c     we keep calling lambda_QCD computed with 4 flavours lam5
C*************************************************************************************
            lam5=genericxlambdNL(asmz,mz,st_nlight)
         elseif(iord.eq.1) then
            lam5=genericxlambdNL(asmz,mz,st_nlight)
         elseif(iord.eq.2) then
            lam5=genericxlambdNNL(asmz,mz,st_nlight)
         endif
