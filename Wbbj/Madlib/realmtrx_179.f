      SUBROUTINE SREALMTRX_179(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> e+ ve b b~ u~ s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_179/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_179(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_179(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    64,   -8,    2,    2,   56,  -16/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,   -7,    1,   -7,   56,   -6/    
      DATA (CF(i,1  ),i=13 ,18 ) /    -6,    2,   -6,   -7,   57,   -7/    
      DATA (CF(i,1  ),i=19 ,20 ) /   -16,    2/                            
C               T[ 8, 6, 1]T[ 5, 7, 2]                                     
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -8,   64,   -7,  -16,   -7,    2/    
      DATA (CF(i,2  ),i=7  ,12 ) /     1,   56,   -8,    2,  -16,   -6/    
      DATA (CF(i,2  ),i=13 ,18 ) /    -6,    2,   12,   -7,   -6,    2/    
      DATA (CF(i,2  ),i=19 ,20 ) /    56,   -7/                            
C               T[ 5, 7]T[ 8, 6, 2, 1]                                     
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     2,   -7,   64,   57,   12,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /   -16,   -6,   56,   -8,   10,   56/    
      DATA (CF(i,3  ),i=13 ,18 ) /   -16,   -6,   -7,   -6,    2,    1/    
      DATA (CF(i,3  ),i=19 ,20 ) /     1,   -8/                            
C               T[ 8, 6, 2]T[ 5, 7, 1]                                     
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     2,  -16,   57,   64,   10,    1/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -7,   -8,   56,   -6,   12,   56/    
      DATA (CF(i,4  ),i=13 ,18 ) /    -7,   -8,  -16,    1,    2,   -6/    
      DATA (CF(i,4  ),i=19 ,20 ) /    -6,   -6/                            
C               T[ 5, 7, 1]T[ 8, 6, 2]                                     
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    56,   -7,   12,   10,   64,   -8/    
      DATA (CF(i,5  ),i=7  ,12 ) /   -16,    1,    2,   -6,   57,    2/    
      DATA (CF(i,5  ),i=13 ,18 ) /   -16,    1,   -7,   -8,   56,   -6/    
      DATA (CF(i,5  ),i=19 ,20 ) /    -6,   -6/                            
C               T[ 5, 7, 2]T[ 8, 6, 1]                                     
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /   -16,    2,   -6,    1,   -8,   64/    
      DATA (CF(i,6  ),i=7  ,12 ) /    56,   10,   -7,   57,   -6,    2/    
      DATA (CF(i,6  ),i=13 ,18 ) /     2,   -8,   -7,    1,   -7,   -6/    
      DATA (CF(i,6  ),i=19 ,20 ) /    12,   -6/                            
C               T[ 8, 6]T[ 5, 7, 1, 2]                                     
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,    1,  -16,   -7,  -16,   56/    
      DATA (CF(i,7  ),i=7  ,12 ) /    64,    2,   -8,   56,   -7,   -6/    
      DATA (CF(i,7  ),i=13 ,18 ) /    12,   -7,   -6,    2,   -6,   -7/    
      DATA (CF(i,7  ),i=19 ,20 ) /     2,    2/                            
C               T[ 8, 6]T[ 5, 7, 1, 2]                                     
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -7,   56,   -6,   -8,    1,   10/    
      DATA (CF(i,8  ),i=7  ,12 ) /     2,   64,  -16,   12,   -6,   -7/    
      DATA (CF(i,8  ),i=13 ,18 ) /    -7,    1,    2,   -8,    2,   -6/    
      DATA (CF(i,8  ),i=19 ,20 ) /    57,   -6/                            
C               T[ 5, 7]T[ 8, 6, 2, 1]                                     
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     1,   -8,   56,   56,    2,   -7/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -8,  -16,   64,  -16,    2,   57/    
      DATA (CF(i,9  ),i=13 ,18 ) /    -6,   -7,   -6,    2,   -6,    2/    
      DATA (CF(i,9  ),i=19 ,20 ) /    -7,   -7/                            
C               T[ 8, 6, 2]T[ 5, 7, 1]                                     
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,    2,   -8,   -6,   -6,   57/    
      DATA (CF(i,10 ),i=7  ,12 ) /    56,   12,  -16,   64,    1,   -7/    
      DATA (CF(i,10 ),i=13 ,18 ) /     2,   -6,   -7,   -6,    2,   -8/    
      DATA (CF(i,10 ),i=19 ,20 ) /    10,    1/                            
C               T[ 8, 6]T[ 5, 7, 1, 2]                                     
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    56,  -16,   10,   12,   57,   -6/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -7,   -6,    2,    1,   64,    2/    
      DATA (CF(i,11 ),i=13 ,18 ) /    -7,   -6,  -16,   -6,   56,   -8/    
      DATA (CF(i,11 ),i=19 ,20 ) /    -8,    1/                            
C               T[ 8, 6, 1]T[ 5, 7, 2]                                     
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,   -6,   56,   56,    2,    2/    
      DATA (CF(i,12 ),i=7  ,12 ) /    -6,   -7,   57,   -7,    2,   64/    
      DATA (CF(i,12 ),i=13 ,18 ) /    -8,  -16,   -8,   -7,    1,   -7/    
      DATA (CF(i,12 ),i=19 ,20 ) /     2,  -16/                            
C               T[ 8, 6, 2]T[ 5, 7, 1]                                     
      DATA Denom(13 )/           18/                                       
      DATA (CF(i,13 ),i=1  ,6  ) /    -6,   -6,  -16,   -7,  -16,    2/    
      DATA (CF(i,13 ),i=7  ,12 ) /    12,   -7,   -6,    2,   -7,   -8/    
      DATA (CF(i,13 ),i=13 ,18 ) /    64,    2,    1,   56,   -8,    2/    
      DATA (CF(i,13 ),i=19 ,20 ) /    -7,   56/                            
C               T[ 5, 7]T[ 8, 6, 1, 2]                                     
      DATA Denom(14 )/           18/                                       
      DATA (CF(i,14 ),i=1  ,6  ) /     2,    2,   -6,   -8,    1,   -8/    
      DATA (CF(i,14 ),i=7  ,12 ) /    -7,    1,   -7,   -6,   -6,  -16/    
      DATA (CF(i,14 ),i=13 ,18 ) /     2,   64,   56,   10,   -7,   57/    
      DATA (CF(i,14 ),i=19 ,20 ) /    -6,   12/                            
C               T[ 8, 6]T[ 5, 7, 2, 1]                                     
      DATA Denom(15 )/           18/                                       
      DATA (CF(i,15 ),i=1  ,6  ) /    -6,   12,   -7,  -16,   -7,   -7/    
      DATA (CF(i,15 ),i=7  ,12 ) /    -6,    2,   -6,   -7,  -16,   -8/    
      DATA (CF(i,15 ),i=13 ,18 ) /     1,   56,   64,    2,   -8,   56/    
      DATA (CF(i,15 ),i=19 ,20 ) /     2,    2/                            
C               T[ 8, 6]T[ 5, 7, 2, 1]                                     
      DATA Denom(16 )/           18/                                       
      DATA (CF(i,16 ),i=1  ,6  ) /    -7,   -7,   -6,    1,   -8,    1/    
      DATA (CF(i,16 ),i=7  ,12 ) /     2,   -8,    2,   -6,   -6,   -7/    
      DATA (CF(i,16 ),i=13 ,18 ) /    56,   10,    2,   64,  -16,   12/    
      DATA (CF(i,16 ),i=19 ,20 ) /    -6,   57/                            
C               T[ 5, 7]T[ 8, 6, 1, 2]                                     
      DATA Denom(17 )/           18/                                       
      DATA (CF(i,17 ),i=1  ,6  ) /    57,   -6,    2,    2,   56,   -7/    
      DATA (CF(i,17 ),i=7  ,12 ) /    -6,    2,   -6,    2,   56,    1/    
      DATA (CF(i,17 ),i=13 ,18 ) /    -8,   -7,   -8,  -16,   64,  -16/    
      DATA (CF(i,17 ),i=19 ,20 ) /    -7,   -7/                            
C               T[ 8, 6, 1]T[ 5, 7, 2]                                     
      DATA Denom(18 )/           18/                                       
      DATA (CF(i,18 ),i=1  ,6  ) /    -7,    2,    1,   -6,   -6,   -6/    
      DATA (CF(i,18 ),i=7  ,12 ) /    -7,   -6,    2,   -8,   -8,   -7/    
      DATA (CF(i,18 ),i=13 ,18 ) /     2,   57,   56,   12,  -16,   64/    
      DATA (CF(i,18 ),i=19 ,20 ) /     1,   10/                            
C               T[ 8, 6]T[ 5, 7, 2, 1]                                     
      DATA Denom(19 )/           18/                                       
      DATA (CF(i,19 ),i=1  ,6  ) /   -16,   56,    1,   -6,   -6,   12/    
      DATA (CF(i,19 ),i=7  ,12 ) /     2,   57,   -7,   10,   -8,    2/    
      DATA (CF(i,19 ),i=13 ,18 ) /    -7,   -6,    2,   -6,   -7,    1/    
      DATA (CF(i,19 ),i=19 ,20 ) /    64,   -8/                            
C               T[ 8, 6, 2, 1]T[ 5, 7]                                     
      DATA Denom(20 )/           18/                                       
      DATA (CF(i,20 ),i=1  ,6  ) /     2,   -7,   -8,   -6,   -6,   -6/    
      DATA (CF(i,20 ),i=7  ,12 ) /     2,   -6,   -7,    1,    1,  -16/    
      DATA (CF(i,20 ),i=13 ,18 ) /    56,   12,    2,   57,   -7,   10/    
...
C ----------
      ...
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     14  ))                                                          
      CALL JIOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
     ...
     &     17  ))                                                          
      CALL FVOXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,17  ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVOXXX(W(1,5   ),W(1,19  ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,1   ),GG ,AMP(3   ))             
      CALL JIOXXX(W(1,17  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      ...
      CALL FVIXXX(W(1,17  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      ...
      CALL JIOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      ...
      CALL FVOXXX(W(1,18  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      ...
      CALL FVOXXX(W(1,11  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL JIOXXX(W(1,39  ),W(1,30  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,40  ),GG ,AMP(11  ))             
      CALL JIOXXX(W(1,39  ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,41  ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,8   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,14  ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      ...
      CALL FVIXXX(W(1,14  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL JIOXXX(W(1,46  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,47  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,24  ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      ...
      CALL FVIXXX(W(1,24  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,52  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      ...
      CALL FVOXXX(W(1,30  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL JIOXXX(W(1,7   ),W(1,57  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,33  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      ...
      CALL JIOXXX(W(1,39  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL FVOXXX(W(1,5   ),W(1,65  ),GG ,BMASS   ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,2   ),GG ,AMP(39  ))             
      CALL FVIXXX(W(1,39  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      CALL JIOXXX(W(1,67  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL FVOXXX(W(1,5   ),W(1,68  ),GG ,BMASS   ,ZERO    ,W(1,69  ))     
      CALL IOVXXX(W(1,6   ),W(1,69  ),W(1,2   ),GG ,AMP(40  ))             
      CALL JIOXXX(W(1,17  ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,70  ))     
      ...
      CALL JIOXXX(W(1,74  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      ...
      CALL FVOXXX(W(1,42  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     79  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,79  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL FVOXXX(W(1,5   ),W(1,80  ),GG ,BMASS   ,ZERO    ,W(1,81  ))     
      CALL IOVXXX(W(1,6   ),W(1,81  ),W(1,2   ),GG ,AMP(45  ))             
      CALL FVOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      ...
      CALL JIOXXX(W(1,67  ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,85  ))     
      ...
      CALL FVIXXX(W(1,67  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      CALL JIOXXX(W(1,88  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,89  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,89  ),GG ,AMP(50  ))             
      CALL JIOXXX(W(1,10  ),W(1,79  ),GG ,ZERO    ,ZERO    ,W(1,90  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,90  ),GG ,AMP(51  ))             
      CALL JIOXXX(W(1,10  ),W(1,82  ),GG ,ZERO    ,ZERO    ,W(1,91  ))     
      ...
      CALL JIOXXX(W(1,74  ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,93  ))     
      ...
      CALL FVIXXX(W(1,74  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,96  ))     
      CALL JIOXXX(W(1,96  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,97  ))     
      ...
      CALL FVOXXX(W(1,79  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,101 ))     
      CALL JIOXXX(W(1,7   ),W(1,101 ),GG ,ZERO    ,ZERO    ,W(1,102 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,102 ),GG ,AMP(61  ))             
      CALL FVOXXX(W(1,82  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,103 ))     
      CALL JIOXXX(W(1,7   ),W(1,103 ),GG ,ZERO    ,ZERO    ,W(1,104 ))     
      ...
      CALL FVIXXX(W(1,39  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,118 ))     
      CALL JIOXXX(W(1,118 ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,119 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,119 ),GG ,AMP(83  ))             
      CALL FVIXXX(W(1,118 ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     120 ))                                                          
      CALL JIOXXX(W(1,120 ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,121 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,121 ),GG ,AMP(84  ))             
      CALL FVIXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,122 ))     
      CALL JIOXXX(W(1,122 ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,123 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,123 ),GG ,AMP(85  ))             
      CALL FVIXXX(W(1,122 ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     124 ))                                                          
      CALL JIOXXX(W(1,124 ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,125 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,125 ),GG ,AMP(86  ))             
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,126 ))      
      CALL FVIXXX(W(1,7   ),W(1,126 ),GG ,ZERO    ,ZERO    ,W(1,127 ))     
      CALL JIOXXX(W(1,127 ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,128 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,128 ),GG ,AMP(87  ))             
      CALL FVIXXX(W(1,127 ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     129 ))                                                          
      CALL JIOXXX(W(1,129 ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,130 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,130 ),GG ,AMP(88  ))             
      CALL FVOXXX(W(1,42  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,131 ))     
      CALL JIOXXX(W(1,17  ),W(1,131 ),GG ,ZERO    ,ZERO    ,W(1,132 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,132 ),GG ,AMP(89  ))             
      CALL FVOXXX(W(1,18  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,133 ))     
      CALL JIOXXX(W(1,17  ),W(1,133 ),GG ,ZERO    ,ZERO    ,W(1,134 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,134 ),GG ,AMP(90  ))             
      CALL FVOXXX(W(1,8   ),W(1,126 ),GG ,ZERO    ,ZERO    ,W(1,135 ))     
      CALL JIOXXX(W(1,17  ),W(1,135 ),GG ,ZERO    ,ZERO    ,W(1,136 ))     
      ...
      CALL FVIXXX(W(1,17  ),W(1,126 ),GG ,ZERO    ,ZERO    ,W(1,138 ))     
      CALL JIOXXX(W(1,138 ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,139 ))     
      ...
      CALL FVOXXX(W(1,131 ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     141 ))                                                          
     ...
     &     143 ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,143 ),GG ,ZERO    ,ZERO    ,W(1,144 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,144 ),GG ,AMP(96  ))             
      CALL FVOXXX(W(1,135 ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     145 ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,145 ),GG ,ZERO    ,ZERO    ,W(1,146 ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,146 ),GG ,AMP(97  ))             
      CALL FVOXXX(W(1,11  ),W(1,126 ),GG ,ZERO    ,ZERO    ,W(1,147 ))     
     ...
     &             -AMP( 100)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_179 =REALMTRX_179+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
