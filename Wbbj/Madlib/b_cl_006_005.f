      SUBROUTINE SB_CL_006_005(P1,ANS)
C  
...
C  
C BORN AMPLITUDE IS u s~ -> e+ ve b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(7,ihel).eq.-1) THEN
                 T=B_CL_006_005(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_006_005(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,8   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,12  ),W(1,8   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      ...
      CALL FVIXXX(W(1,9   ),W(1,8   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
     ...
     &     23  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_006_005=B_CL_006_005 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_006_005=B_CL_006_005 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
