...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   21,   -3,   21,   -6/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -6,    2,    2,   -7,   -7,   -6/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   21,   -6,   21/    
      DATA (CF(i,2  ),i=7  ,12 ) /     2,   -8,    1,   10,    1,   -7/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   21,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /     2,    1,   10,    1,   -8,   -7/    
C               T[ 2, 7]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   -6,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -6,   -7,   -7,    2,    2,   -6/    
C               T[ 5, 7]T[ 1, 8]T[ 2, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   21,   -6,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -7,   10,    1,   -8,    1,    2/    
C               T[ 1, 6]T[ 5, 8]T[ 2, 7]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   21,   -6,   21,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    -7,    1,   -8,    1,   10,    2/    
C               T[ 1, 8]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -6,   21,   21,   -6,   -3/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,   -8,    1,   -7,   10,    1/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -6,   24,   -3,   -6,   21,   21/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     2,    1,   10,   -7,    1,   -8/    
      DATA (CF(i,9  ),i=7  ,12 ) /    21,   -3,   24,   21,   -6,   -6/    
C               T[ 2, 8]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,   10,    1,    2,   -8,    1/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   21,   24,   -3,   -6/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,    1,   -8,    2,    1,   10/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   -6,   -3,   24,   21/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,   -7,   -7,   -6,    2,    2/    
      DATA (CF(i,12 ),i=7  ,12 ) /    -3,   21,   -6,   -6,   21,   24/    
C               T[ 5, 8]T[ 1, 7]T[ 2, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL FVIXXX(W(1,7   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,7   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,25  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,7   ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
     ...
     &     40  ))                                                          
      CALL JIOXXX(W(1,8   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,40  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL FVOXXX(W(1,5   ),W(1,42  ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,41  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,7   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL FVOXXX(W(1,5   ),W(1,44  ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,45  ),W(1,41  ),GG ,AMP(18  ))             
      CALL FVIXXX(W(1,7   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL JIOXXX(W(1,46  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVIXXX(W(1,8   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,49  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,50  ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,1   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL JIOXXX(W(1,8   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL JIOXXX(W(1,8   ),W(1,54  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(24  ))             
      CALL FVIXXX(W(1,8   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,14  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL JIOXXX(W(1,7   ),W(1,58  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
     ...
     &     61  ))                                                          
      ...
      CALL FVIXXX(W(1,40  ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL JIOXXX(W(1,63  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,64  ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL JIOXXX(W(1,40  ),W(1,65  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
