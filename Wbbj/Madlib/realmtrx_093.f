      SUBROUTINE SREALMTRX_093(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ s~ -> e+ ve b b~ u~ c~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_093/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_093(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_093(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,   -2,    7,    7,   -2,   -1/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -2,    8,   -1,   -2,    7,    7/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     7,   -1,    8,    7,   -2,   -2/    
C               T[ 2, 8]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     7,   -2,    7,    8,   -1,   -2/    
C               T[ 1, 6]T[ 5, 7]T[ 2, 8]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -2,    7,   -2,   -1,    8,    7/    
C               T[ 1, 7]T[ 2, 6]T[ 5, 8]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,    7,   -2,   -2,    7,    8/    
C               T[ 5, 8]T[ 1, 7]T[ 2, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     38  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_093 =REALMTRX_093+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
