...
C  
C FOR PROCESS : u d~ -> e+ ve b b~ u u~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   21,   -3,   -6,   21/    
      DATA (CF(i,1  ),i=7  ,12 ) /     2,    2,   -6,   -6,   -7,   -7/    
C               T[ 5, 8]T[ 2, 1]T[ 7, 6]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   21,   21,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -8,    1,   -7,    2,   10,    1/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,   -7,    2,    1,   -8/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -7,   -7,   -6,   -6,    2,    2/    
C               T[ 2, 6]T[ 5, 1]T[ 7, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -6,   21,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   -8,    2,   -7,    1,   10/    
C               T[ 7, 8]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    21,   -6,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    10,    1,    2,   -7,   -8,    1/    
C               T[ 2, 1]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     2,   -8,    1,   -7,    1,   10/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   21,   -6,   -6,   21/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,    1,   10,   -7,   -8,    1/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   -6,   21,   21,   -6/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -6,   -7,   -7,   -6,    2,    2/    
      DATA (CF(i,9  ),i=7  ,12 ) /    21,   -6,   24,   -3,   -6,   21/    
C               T[ 2, 6]T[ 5, 8]T[ 7, 1]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   21,   -3,   24,   21,   -6/    
C               T[ 5, 1]T[ 2, 8]T[ 7, 6]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,   10,    1,    2,    1,   -8/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   -6,   21,   24,   -3/    
C               T[ 2, 8]T[ 7, 6]T[ 5, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -7,    1,   -8,    2,   10,    1/    
...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,10  ),GG ,AMP(1   ))             
     ...
     &     14  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,10  ),GG ,AMP(2   ))             
      CALL JVVXXX(W(1,12  ),W(1,10  ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,17  ),GG ,AMP(3   ))             
      CALL JVVXXX(W(1,15  ),W(1,10  ),G ,ZERO    ,ZERO    ,W(1,18  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,14  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL JIOXXX(W(1,8   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,20  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,8   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JIOXXX(W(1,21  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,22  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,7   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,1   ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,7   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL JIOXXX(W(1,1   ),W(1,25  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,26  ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,27  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL JIOXXX(W(1,29  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL FVOXXX(W(1,5   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,12  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,15  ),GG ,AMP(12  ))             
      CALL FVIXXX(W(1,11  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
     ...
     &     34  ))                                                          
      ...
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,11  ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,36  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     38  ))                                                          
      ...
      CALL FVIXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,41  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,2   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
     ...
     &     44  ))                                                          
      ...
      CALL JIOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      ...
      CALL FVOXXX(W(1,14  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,1   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      ...
      CALL FVIXXX(W(1,41  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     56  ))                                                          
     ...
     &     58  ))                                                          
      CALL JIOXXX(W(1,58  ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,59  ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,58  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      ...
      CALL FVIXXX(W(1,58  ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL JIOXXX(W(1,62  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      ...
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   4)
      JAMP(   2) = +AMP(   3)-AMP(   6)-AMP(  13)-AMP(  14)
      JAMP(   3) = -AMP(   3)-AMP(   5)-AMP(  15)-AMP(  16)
      JAMP(   4) = +AMP(   4)-AMP(  11)-AMP(  12)
      JAMP(   5) = -AMP(   7)-AMP(   8)
      JAMP(   6) = -AMP(   9)-AMP(  10)
