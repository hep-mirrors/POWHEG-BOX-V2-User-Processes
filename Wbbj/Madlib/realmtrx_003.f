...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   -3,   21,   21,   -6/    
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,    1,    1,   10,   -7,    2/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   21,   -3,   -6,   21/    
      DATA (CF(i,2  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 8]T[ 1, 2]T[ 7, 6]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -3,   21,   24,   -6,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,   -8,    1,   -7,    2/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -3,   -6,   24,   21,   -6/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   -6,   21,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   -8,   10,    1,    2,   -7/    
C               T[ 7, 8]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   21,   21,   -6,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    10,    1,    1,   -8,    2,   -7/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,    2,    1,   -7,    1,   10/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   21,   -6,   21,   -6/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,    2,   10,   -7,   -8,    1/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   -6,   21,   -6,   21/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     1,   -7,   -8,    2,   10,    1/    
      DATA (CF(i,9  ),i=7  ,12 ) /    21,   -6,   24,   -3,   21,   -6/    
C               T[ 7, 2]T[ 1, 6]T[ 5, 8]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    10,   -7,    1,    2,    1,   -8/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   21,   -3,   24,   -6,   21/    
C               T[ 1, 8]T[ 7, 6]T[ 5, 2]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -7,   -6,   -7,   -6,    2,    2/    
      DATA (CF(i,11 ),i=7  ,12 ) /    21,   -6,   21,   -6,   24,   -3/    
C               T[ 1, 6]T[ 5, 8]T[ 7, 2]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /     2,   -6,    2,   -6,   -7,   -7/    
...
C ----------
     ...
     &     19  ))                                                          
      ...
      CALL FVOXXX(W(1,19  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL JIOXXX(W(1,8   ),W(1,24  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,25  ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,14  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
