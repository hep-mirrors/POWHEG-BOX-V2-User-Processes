...
C  
C BORN AMPLITUDE IS d~ u -> e+ ve b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      ...
      CALL FVIXXX(W(1,12  ),W(1,8   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      ...
      CALL FVOXXX(W(1,9   ),W(1,8   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
