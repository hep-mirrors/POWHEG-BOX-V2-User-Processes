...
C  
      ...
      DATA (CF(i,1  ),i=7  ,12 ) /    -8,    1,    1,   10,    2,   -7/    
C               T[ 8, 7]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    21,   24,   -6,   -3,   21,   -6/    
      DATA (CF(i,2  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -3,   -6,   24,   21,   -6,   21/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   10,   -8,    1,    2,   -7/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   -3,   21,   24,   -6,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 7]T[ 2, 1]T[ 8, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   21,   -6,   -6,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   -8,   10,    1,   -7,    2/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   -6,   21,   21,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    10,    1,    1,   -8,   -7,    2/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -8,   -7,    1,    2,    1,   10/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   21,   -6,   -6,   21/    
C               T[ 2, 7]T[ 8, 6]T[ 5, 1]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,   -7,   10,    2,   -8,    1/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   -6,   21,   21,   -6/    
C               T[ 2, 6]T[ 5, 7]T[ 8, 1]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     1,    2,   -8,   -7,   10,    1/    
      DATA (CF(i,9  ),i=7  ,12 ) /    21,   -6,   24,   -3,   -6,   21/    
C               T[ 2, 7]T[ 8, 6]T[ 5, 1]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    10,    2,    1,   -7,    1,   -8/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   21,   -3,   24,   21,   -6/    
C               T[ 8, 1]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /     2,   -6,    2,   -6,   -7,   -7/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   -6,   21,   24,   -3/    
C               T[ 2, 6]T[ 5, 7]T[ 8, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -7,   -6,   -7,   -6,    2,    2/    
