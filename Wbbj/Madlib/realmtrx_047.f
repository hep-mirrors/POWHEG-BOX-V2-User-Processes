...
C               T[ 1, 6]T[ 5, 2]T[ 8, 7]                                   
      ...
      DATA (CF(i,2  ),i=7  ,12 ) /    10,    1,   -8,    1,    2,   -7/    
C               T[ 1, 2]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   21,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /     1,   -8,    1,   10,    2,   -7/    
C               T[ 8, 7]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -3,   21,   -6,   24,   -6,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 7]T[ 1, 2]T[ 8, 6]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   21,   -6,   24,   -3/    
      DATA (CF(i,5  ),i=7  ,12 ) /    -8,    1,   10,    1,   -7,    2/    
C               T[ 1, 6]T[ 5, 2]T[ 8, 7]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -6,   21,   -6,   21,   -3,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /     1,   10,    1,   -8,   -7,    2/    
C               T[ 1, 2]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /    -7,   10,    1,    2,   -8,    1/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   -6,   21,   21,   -6/    
C               T[ 1, 6]T[ 5, 7]T[ 8, 2]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /    -7,    1,   -8,    2,    1,   10/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   21,   -6,   -6,   21/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /     2,   -8,    1,   -7,   10,    1/    
      DATA (CF(i,9  ),i=7  ,12 ) /    -6,   21,   24,   -3,   -6,   21/    
C               T[ 1, 7]T[ 8, 6]T[ 5, 2]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /     2,    1,   10,   -7,    1,   -8/    
      DATA (CF(i,10 ),i=7  ,12 ) /    21,   -6,   -3,   24,   21,   -6/    
C               T[ 8, 2]T[ 1, 6]T[ 5, 7]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -6,    2,    2,   -6,   -7,   -7/    
...
C ----------
     ...
     &     40  ))                                                          
      CALL JIOXXX(W(1,40  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL FVIXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,42  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL JIOXXX(W(1,52  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
     ...
     &     54  ))                                                          
      ...
      CALL JIOXXX(W(1,40  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      ...
      CALL FVIXXX(W(1,40  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
     ...
     &     62  ))                                                          
      ...
      CALL FVOXXX(W(1,11  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
