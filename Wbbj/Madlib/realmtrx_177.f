      SUBROUTINE SREALMTRX_177(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> e+ ve b b~ d u~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_177/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_177(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_177(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     17  ))                                                          
      ...
      CALL FVIXXX(W(1,18  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      ...
      CALL FVOXXX(W(1,39  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      ...
      CALL FVIXXX(W(1,42  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     79  ))                                                          
      ...
      CALL FVOXXX(W(1,118 ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     120 ))                                                          
      ...
      CALL FVOXXX(W(1,122 ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     124 ))                                                          
     ...
     &     129 ))                                                          
      ...
      CALL FVIXXX(W(1,131 ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     141 ))                                                          
     ...
     &     143 ))                                                          
      ...
      CALL FVIXXX(W(1,135 ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     145 ))                                                          
     ...
     &             +AMP( 100)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_177 =REALMTRX_177+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
