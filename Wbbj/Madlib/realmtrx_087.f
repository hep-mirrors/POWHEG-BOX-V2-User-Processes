...
C  
C FOR PROCESS : c~ u -> e+ ve b b~ d c~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      DATA Denom(1  )/            6/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /     8,    7,   -2,    7,   -2,   -1/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(2  )/            6/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /     7,    8,   -1,    7,   -2,   -2/    
C               T[ 7, 8]T[ 1, 6]T[ 5, 2]                                   
      DATA Denom(3  )/            6/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -2,   -1,    8,   -2,    7,    7/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(4  )/            6/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     7,    7,   -2,    8,   -1,   -2/    
C               T[ 1, 6]T[ 5, 2]T[ 7, 8]                                   
      DATA Denom(5  )/            6/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    -2,   -2,    7,   -1,    8,    7/    
C               T[ 1, 2]T[ 7, 6]T[ 5, 8]                                   
      DATA Denom(6  )/            6/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -1,   -2,    7,   -2,    7,    8/    
C               T[ 5, 8]T[ 1, 2]T[ 7, 6]                                   
C ----------
C BEGIN CODE
C ----------
