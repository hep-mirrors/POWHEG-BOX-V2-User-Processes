      SUBROUTINE SREALMTRX_011(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ u -> e+ ve b b~ u u~  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_011/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_011(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_011(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     29  ))                                                          
      ...
      CALL FVIXXX(W(1,8   ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     41  ))                                                          
      ...
      CALL FVIXXX(W(1,44  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     45  ))                                                          
      ...
      CALL FVOXXX(W(1,65  ),W(1,9   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_011 =REALMTRX_011+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
