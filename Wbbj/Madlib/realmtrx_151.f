      SUBROUTINE SREALMTRX_151(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_151/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_151(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_151(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     38  ))                                                          
      ...
      CALL FVIXXX(W(1,41  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     42  ))                                                          
     ...
     &     48  ))                                                          
      ...
      CALL FVOXXX(W(1,65  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     67  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_151 =REALMTRX_151+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
