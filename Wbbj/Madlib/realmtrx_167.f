      SUBROUTINE SREALMTRX_167(P1,ANS)
C  
...
C  
C FOR PROCESS : s s~ -> e+ ve b b~ u~ s  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C  
      ...
      common/to_Ramps_167/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_167(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_167(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/           18/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -6,   21,   -6,   21,   -3/    
      DATA (CF(i,1  ),i=7  ,12 ) /     2,    2,   -7,   -7,   -6,   -6/    
C               T[ 5, 7]T[ 2, 1]T[ 8, 6]                                   
      DATA Denom(2  )/           18/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -6,   24,   -3,   21,   -6,   21/    
      DATA (CF(i,2  ),i=7  ,12 ) /     1,   -8,   10,    1,   -7,    2/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
      DATA Denom(3  )/           18/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    21,   -3,   24,   -6,   21,   -6/    
      DATA (CF(i,3  ),i=7  ,12 ) /    10,    1,    1,   -8,   -7,    2/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(4  )/           18/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -6,   21,   -6,   24,   -3,   21/    
      DATA (CF(i,4  ),i=7  ,12 ) /    -8,    1,    1,   10,    2,   -7/    
C               T[ 8, 7]T[ 2, 6]T[ 5, 1]                                   
      DATA Denom(5  )/           18/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /    21,   -6,   21,   -3,   24,   -6/    
      DATA (CF(i,5  ),i=7  ,12 ) /     1,   10,   -8,    1,    2,   -7/    
C               T[ 2, 1]T[ 8, 6]T[ 5, 7]                                   
      DATA Denom(6  )/           18/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -3,   21,   -6,   21,   -6,   24/    
      DATA (CF(i,6  ),i=7  ,12 ) /    -7,   -7,    2,    2,   -6,   -6/    
C               T[ 2, 6]T[ 5, 1]T[ 8, 7]                                   
      DATA Denom(7  )/           18/                                       
      DATA (CF(i,7  ),i=1  ,6  ) /     2,    1,   10,   -8,    1,   -7/    
      DATA (CF(i,7  ),i=7  ,12 ) /    24,   -3,   21,   -6,   -6,   21/    
C               T[ 2, 7]T[ 8, 6]T[ 5, 1]                                   
      DATA Denom(8  )/           18/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     2,   -8,    1,    1,   10,   -7/    
      DATA (CF(i,8  ),i=7  ,12 ) /    -3,   24,   -6,   21,   21,   -6/    
C               T[ 2, 6]T[ 5, 7]T[ 8, 1]                                   
      DATA Denom(9  )/           18/                                       
      DATA (CF(i,9  ),i=1  ,6  ) /    -7,   10,    1,    1,   -8,    2/    
      DATA (CF(i,9  ),i=7  ,12 ) /    21,   -6,   24,   -3,   -6,   21/    
C               T[ 2, 7]T[ 8, 6]T[ 5, 1]                                   
      DATA Denom(10 )/           18/                                       
      DATA (CF(i,10 ),i=1  ,6  ) /    -7,    1,   -8,   10,    1,    2/    
      DATA (CF(i,10 ),i=7  ,12 ) /    -6,   21,   -3,   24,   21,   -6/    
C               T[ 8, 1]T[ 2, 6]T[ 5, 7]                                   
      DATA Denom(11 )/           18/                                       
      DATA (CF(i,11 ),i=1  ,6  ) /    -6,   -7,   -7,    2,    2,   -6/    
      DATA (CF(i,11 ),i=7  ,12 ) /    -6,   21,   -6,   21,   24,   -3/    
C               T[ 2, 6]T[ 5, 7]T[ 8, 1]                                   
      DATA Denom(12 )/           18/                                       
      DATA (CF(i,12 ),i=1  ,6  ) /    -6,    2,    2,   -7,   -7,   -6/    
      DATA (CF(i,12 ),i=7  ,12 ) /    21,   -6,   21,   -6,   -3,   24/    
C               T[ 5, 1]T[ 2, 7]T[ 8, 6]                                   
C ----------
C BEGIN CODE
C ----------
     ...
     &     14  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVOXXX(W(1,5   ),W(1,15  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,11  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL JIOXXX(W(1,17  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      CALL FVOXXX(W(1,14  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      ...
      CALL FVIXXX(W(1,17  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL JIOXXX(W(1,32  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,33  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,10  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JIOXXX(W(1,34  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,35  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL JIOXXX(W(1,10  ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,37  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,36  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     38  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,38  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,10  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL FVOXXX(W(1,2   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
     ...
     &     43  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL FVOXXX(W(1,2   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,1   ),W(1,45  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(18  ))             
      CALL FVIXXX(W(1,1   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL JIOXXX(W(1,47  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,1   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,49  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,50  ),GG ,AMP(20  ))             
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL FVIXXX(W(1,7   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,52  ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,53  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,52  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     54  ))                                                          
      CALL JIOXXX(W(1,54  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,55  ),GG ,AMP(22  ))             
      CALL FVOXXX(W(1,8   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,10  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(23  ))             
      CALL JVVXXX(W(1,44  ),W(1,51  ),G ,ZERO    ,ZERO    ,W(1,58  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GG ,AMP(24  ))             
      CALL FVIXXX(W(1,10  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL JIOXXX(W(1,59  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(25  ))             
      CALL JVVXXX(W(1,40  ),W(1,51  ),G ,ZERO    ,ZERO    ,W(1,61  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,61  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,56  ),W(1,9   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     62  ))                                                          
      CALL JIOXXX(W(1,7   ),W(1,62  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,63  ),GG ,AMP(27  ))             
      CALL FVOXXX(W(1,43  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL JIOXXX(W(1,7   ),W(1,64  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,65  ),GG ,AMP(28  ))             
      CALL FVOXXX(W(1,5   ),W(1,44  ),GG ,BMASS   ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,51  ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,5   ),W(1,40  ),GG ,BMASS   ,ZERO    ,W(1,67  ))     
      CALL IOVXXX(W(1,6   ),W(1,67  ),W(1,51  ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,5   ),W(1,51  ),GG ,BMASS   ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,44  ),GG ,AMP(31  ))             
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,40  ),GG ,AMP(32  ))             
      ...
      JAMP(   7) = -AMP(  17)-AMP(  18)+AMP(  24)+AMP(  26)
      JAMP(   8) = -AMP(  19)-AMP(  20)-AMP(  24)-AMP(  26)
      JAMP(   9) = -AMP(  21)-AMP(  22)-AMP(  25)
      JAMP(  10) = -AMP(  23)-AMP(  27)-AMP(  28)
      JAMP(  11) = -AMP(  29)-AMP(  30)
      JAMP(  12) = -AMP(  31)-AMP(  32)
      REALMTRX_167 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_167 =REALMTRX_167+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
