...
\cp pwgLHEF_analysis-W1_Wpm.top                  $dir/pwgLHEF_analysis_Wpm.top

if [ $PY = 'yes' ] 
then
    \cp pwgPOWHEG+PYTHIA-output_nohad-min_Wpm.top    $dir
    \cp pwgPOWHEG+PYTHIA-output_nohad-max_Wpm.top    $dir
    \cp pwgPOWHEG+PYTHIA-output_nohad-W1_Wpm.top     $dir/pwgPOWHEG+PYTHIA-output_nohad_Wpm.top

    \cp pwgPOWHEG+PYTHIA-output_had-min_Wpm.top      $dir
    \cp pwgPOWHEG+PYTHIA-output_had-max_Wpm.top      $dir
    \cp pwgPOWHEG+PYTHIA-output_had-W1_Wpm.top       $dir/pwgPOWHEG+PYTHIA-output_had_Wpm.top
fi
