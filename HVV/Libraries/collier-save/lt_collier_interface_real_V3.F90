...
! Version 3 (25-01-2018):
!    * cache system reorganized, LT subroutines markcache and restorecache
!      not useful anymore. The user will have to modify the include file
!      'util.h' to deactivate INI_ANGLE(seq) definition and redefine
!      INI_S(seq). The init routine for COLLIER has an additional parameter.
...
#include "lt_collier.h"
  ...
  RealType, intent(in)  :: p10,m02,m12
  ! local variables
...
#include "lt_collier.h"
  ...
  RealType, intent(in)  :: p10,p21,p20,m02,m12,m22
  ! local variables
...
#include "lt_collier.h"
  ...
  RealType, intent(in)  :: p10,p21,p32,p30,p20, &
       p31,m02,m12,m22,m32
  ! local variables
  ComplexType :: p10c,p21c,p32c,p30c,p20c,p31c, &
       m02c,m12c,m22c,m32c
  integer :: i,j,j0
  RealType :: DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  ...
  call D_cll(Dcoeff,Dcoeffuv,p10c,p21c, &
       p32c,p30c,p20c,p31c,m02c,m12c,m22c,m32c, &
       rank,Derr)
...
#include "lt_collier.h"
  ...
  RealType, intent(in)  :: p10,p21,p32,p43,p40,p20,p31,p42,p30,p41
  RealType, intent(in)  :: m02,m12,m22,m32,m42
  ! local variables
  ComplexType :: p10c,p21c,p32c,p43c,p40c,p20c,p31c,p42c,p30c,p41c
  ComplexType :: m02c,m12c,m22c,m32c,m42c
  integer :: i,j,j0
  RealType :: DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  ...
  call E_cll(Ecoeff,Ecoeffuv,p10c,p21c,p32c,p43c, &
       p40c,p20c,p31c,p42c,p30c,p41c, &
       m02c,m12c,m22c,m32c,m42c,rank,Eerr)
...
#include "lt_ff.h"
  integer, intent(in) :: i
  RealType, intent(in) :: p1,p2,p1p2,m1,m2,m3
  ComplexType :: cc(Ncc)
...
#include "lt_ff.h"
  integer, intent(in) :: i
  RealType, intent(in) :: p1,p2,p3,p4,p1p2,p2p3,m1,m2,m3,m4  
  ComplexType :: dd(Ndd)
...
#include "lt_ff.h"
  integer, intent(in) :: i
  RealType, intent(in) :: p1,p2,p3,p4,p5,p1p2,p2p3,p3p4
  RealType, intent(in) :: p4p5,p5p1,m1,m2,m3,m4,m5
  ComplexType :: ee(Nee)
...
! set the cache number cachenum
subroutine clearcache(cachenum)
  use COLLIER
  implicit none
...
subroutine init_collier(Nmax, ncache)
  ...
  implicit none
#include "lt_ff.h"
  ! ncache = number of cache systems to be used
