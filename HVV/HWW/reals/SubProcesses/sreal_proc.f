      ...
      if (str.eq."-112524-240") then
         call srealmtrx_001(p,wgt)
         goto 20
      elseif (str.eq."-102524-24-1") then
         call srealmtrx_002(p,wgt)
         goto 20
      elseif (str.eq."1-12524-240") then
         call srealmtrx_003(p,wgt)
         goto 20
      elseif (str.eq."102524-241") then
         call srealmtrx_004(p,wgt)
         goto 20
      elseif (str.eq."-222524-240") then
         call srealmtrx_005(p,wgt)
         goto 20
      elseif (str.eq."-202524-24-2") then
         call srealmtrx_006(p,wgt)
         goto 20
      elseif (str.eq."2-22524-240") then
         call srealmtrx_007(p,wgt)
         goto 20
      elseif (str.eq."202524-242") then
         call srealmtrx_008(p,wgt)
         goto 20
      elseif (str.eq."-442524-240") then
         call srealmtrx_009(p,wgt)
         goto 20
      elseif (str.eq."-402524-24-4") then
         call srealmtrx_010(p,wgt)
         goto 20
      elseif (str.eq."4-42524-240") then
         call srealmtrx_011(p,wgt)
         goto 20
      elseif (str.eq."402524-244") then
         call srealmtrx_012(p,wgt)
         goto 20
      elseif (str.eq."-332524-240") then
         call srealmtrx_013(p,wgt)
         goto 20
      elseif (str.eq."-302524-24-3") then
         call srealmtrx_014(p,wgt)
         goto 20
      elseif (str.eq."3-32524-240") then
         call srealmtrx_015(p,wgt)
         goto 20
      elseif (str.eq."302524-243") then
         call srealmtrx_016(p,wgt)
         goto 20
      elseif (str.eq."0-12524-24-1") then
         call srealmtrx_017(p,wgt)
         goto 20
      elseif (str.eq."012524-241") then
         call srealmtrx_018(p,wgt)
         goto 20
      elseif (str.eq."0-22524-24-2") then
         call srealmtrx_019(p,wgt)
         goto 20
      elseif (str.eq."022524-242") then
         call srealmtrx_020(p,wgt)
         goto 20
      elseif (str.eq."0-42524-24-4") then
         call srealmtrx_021(p,wgt)
         goto 20
      elseif (str.eq."042524-244") then
         call srealmtrx_022(p,wgt)
         goto 20
      elseif (str.eq."0-32524-24-3") then
         call srealmtrx_023(p,wgt)
         goto 20
      elseif (str.eq."032524-243") then
