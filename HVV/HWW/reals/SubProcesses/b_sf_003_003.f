...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,4   ),GWF ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JVSXXX(W(1,5   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     7   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,7   ),GWF ,AMP(1   ))            
      CALL JVSXXX(W(1,4   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     8   ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,5   ),GWF ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL IOVXXX(W(1,2   ),W(1,9   ),W(1,8   ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,10  ))    
      CALL JVVXXX(W(1,4   ),W(1,10  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     11  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,11  ),W(1,3   ),GWWH ,AMP(3   ))           
      CALL JIOXXX(W(1,2   ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,12  ))    
      CALL JVVXXX(W(1,4   ),W(1,12  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     13  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,13  ),W(1,3   ),GWWH ,AMP(4   ))           
      CALL JVSXXX(W(1,12  ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     14  ))                                                          
      CALL VVVXXX(W(1,5   ),W(1,4   ),W(1,14  ),GWWZ ,AMP(5   ))           
      CALL VVVXXX(W(1,5   ),W(1,8   ),W(1,10  ),GWWA ,AMP(6   ))           
      CALL VVVXXX(W(1,5   ),W(1,8   ),W(1,12  ),GWWZ ,AMP(7   ))           
      do i=1,ngraphs
