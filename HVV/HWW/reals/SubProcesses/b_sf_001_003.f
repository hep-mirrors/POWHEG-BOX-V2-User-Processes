...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,4   ),GWF ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JVSXXX(W(1,5   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     7   ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,7   ),GWF ,AMP(1   ))            
      CALL JVSXXX(W(1,4   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     8   ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,5   ),GWF ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,8   ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,10  ))    
      CALL JVVXXX(W(1,4   ),W(1,10  ),GWWA ,WMASS   ,WWIDTH  ,W(1,         
     &     11  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,11  ),W(1,3   ),GWWH ,AMP(3   ))           
      CALL JIOXXX(W(1,2   ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,12  ))    
