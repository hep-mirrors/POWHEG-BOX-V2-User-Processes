      SUBROUTINE SB_SF_016_003(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_016_003(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_016_003(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,4   ),GZD ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JVSXXX(W(1,5   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     7   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,7   ),GWFCS ,AMP(1   ))          
      CALL FVOXXX(W(1,2   ),W(1,4   ),GZU ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL IOVXXX(W(1,1   ),W(1,8   ),W(1,7   ),GWFCS ,AMP(2   ))          
      CALL JVSXXX(W(1,4   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     9   ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,2   ),W(1,9   ),GZU ,AMP(3   ))            
      CALL FVOXXX(W(1,2   ),W(1,5   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,9   ),GZD ,AMP(4   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GWFCS ,WMASS   ,WWIDTH  ,W(1,        
     &     12  ))                                                          
      CALL JVVXXX(W(1,12  ),W(1,4   ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     13  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,13  ),W(1,3   ),GWWH ,AMP(5   ))           
      CALL JVSXXX(W(1,12  ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     14  ))                                                          
      CALL VVVXXX(W(1,5   ),W(1,14  ),W(1,4   ),GWWZ ,AMP(6   ))           
      CALL VVVXXX(W(1,5   ),W(1,12  ),W(1,9   ),GWWZ ,AMP(7   ))           
      do i=1,ngraphs
     ...
     &             +AMP(   6)+AMP(   7)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_016_003 =B_SF_016_003+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
