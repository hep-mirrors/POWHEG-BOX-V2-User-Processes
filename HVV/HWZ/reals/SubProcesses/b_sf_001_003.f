...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,4   ),GZD ,ZERO    ,ZERO    ,W(1,6   ))    
      CALL JVSXXX(W(1,5   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     7   ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,7   ),GWFUD ,AMP(1   ))          
      CALL FVIXXX(W(1,2   ),W(1,4   ),GZU ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL IOVXXX(W(1,8   ),W(1,1   ),W(1,7   ),GWFUD ,AMP(2   ))          
      CALL JVSXXX(W(1,4   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     9   ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,5   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,9   ),GZU ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,5   ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,9   ),GZD ,AMP(4   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWFUD ,WMASS   ,WWIDTH  ,W(1,        
     &     12  ))                                                          
      CALL JVVXXX(W(1,4   ),W(1,12  ),GWWZ ,WMASS   ,WWIDTH  ,W(1,         
     &     13  ))                                                          
      CALL VVSXXX(W(1,13  ),W(1,5   ),W(1,3   ),GWWH ,AMP(5   ))           
      CALL JVSXXX(W(1,12  ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     14  ))                                                          
      CALL VVVXXX(W(1,14  ),W(1,5   ),W(1,4   ),GWWZ ,AMP(6   ))           
      CALL VVVXXX(W(1,12  ),W(1,5   ),W(1,9   ),GWWZ ,AMP(7   ))           
      do i=1,ngraphs
