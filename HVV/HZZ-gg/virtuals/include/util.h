...
c#define INI_S(seq) call clearcache
c#define INI_ANGLE(seq) call markcache
c#define DEINI(seq) call restorecache
#define INI_S(seq) call clearcache(seq)
#define INI_ANGLE(seq)
#define DEINI(seq)
