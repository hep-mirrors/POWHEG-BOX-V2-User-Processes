...
C ----------
     ...
     &     7   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,7   ),GZD ,AMP(1   ))            
      CALL FVOXXX(W(1,2   ),W(1,4   ),GZD ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL IOVXXX(W(1,1   ),W(1,8   ),W(1,7   ),GZD ,AMP(2   ))            
      CALL JVSXXX(W(1,4   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     9   ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GZD ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL IOVXXX(W(1,10  ),W(1,2   ),W(1,9   ),GZD ,AMP(3   ))            
      CALL FVOXXX(W(1,2   ),W(1,5   ),GZD ,ZERO    ,ZERO    ,W(1,11  ))    
