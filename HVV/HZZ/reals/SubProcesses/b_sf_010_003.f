      SUBROUTINE SB_SF_010_003(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_010_003(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_010_003(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     6   ))                                                          
      CALL FVOXXX(W(1,6   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,5   ),GZD ,AMP(1   ))            
      CALL FVIXXX(W(1,1   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,8   ))    
      CALL FVOXXX(W(1,2   ),W(1,5   ),GZD ,BMASS   ,ZERO    ,W(1,9   ))    
      CALL IOSXXX(W(1,8   ),W(1,9   ),W(1,3   ),GHBOT ,AMP(2   ))          
      CALL JVSXXX(W(1,5   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     10  ))                                                          
      CALL IOVXXX(W(1,8   ),W(1,2   ),W(1,10  ),GZD ,AMP(3   ))            
      CALL HIOXXX(W(1,1   ),W(1,6   ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     11  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,4   ),W(1,11  ),GZZH ,AMP(4   ))           
      CALL IOVXXX(W(1,8   ),W(1,6   ),W(1,5   ),GZD ,AMP(5   ))            
      CALL FVOXXX(W(1,2   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,12  ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL IOSXXX(W(1,13  ),W(1,12  ),W(1,3   ),GHBOT ,AMP(6   ))          
      CALL FSIXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL FVIXXX(W(1,14  ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,5   ),GZD ,AMP(7   ))            
      CALL IOVXXX(W(1,1   ),W(1,12  ),W(1,10  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,14  ),W(1,2   ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     16  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,4   ),W(1,16  ),GZZH ,AMP(9   ))           
      CALL IOVXXX(W(1,14  ),W(1,12  ),W(1,5   ),GZD ,AMP(10  ))            
      CALL JVSXXX(W(1,4   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     17  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,17  ),GZD ,AMP(11  ))            
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,17  ),GZD ,AMP(12  ))            
     ...
     &             +AMP(  16)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_010_003 =B_SF_010_003+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
