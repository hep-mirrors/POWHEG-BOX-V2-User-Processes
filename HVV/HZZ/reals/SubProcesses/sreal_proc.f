      ...
      if (str.eq."-112523230") then
         call srealmtrx_001(p,wgt)
         goto 20
      elseif (str.eq."-10252323-1") then
         call srealmtrx_002(p,wgt)
         goto 20
      elseif (str.eq."1-12523230") then
         call srealmtrx_003(p,wgt)
         goto 20
      elseif (str.eq."102523231") then
         call srealmtrx_004(p,wgt)
         goto 20
      elseif (str.eq."-222523230") then
         call srealmtrx_005(p,wgt)
         goto 20
      elseif (str.eq."-20252323-2") then
         call srealmtrx_006(p,wgt)
         goto 20
      elseif (str.eq."2-22523230") then
         call srealmtrx_007(p,wgt)
         goto 20
      elseif (str.eq."202523232") then
         call srealmtrx_008(p,wgt)
         goto 20
      elseif (str.eq."-442523230") then
         call srealmtrx_009(p,wgt)
         goto 20
      elseif (str.eq."-40252323-4") then
         call srealmtrx_010(p,wgt)
         goto 20
      elseif (str.eq."4-42523230") then
         call srealmtrx_011(p,wgt)
         goto 20
      elseif (str.eq."402523234") then
         call srealmtrx_012(p,wgt)
         goto 20
      elseif (str.eq."-332523230") then
         call srealmtrx_013(p,wgt)
         goto 20
      elseif (str.eq."-30252323-3") then
         call srealmtrx_014(p,wgt)
         goto 20
      elseif (str.eq."3-32523230") then
         call srealmtrx_015(p,wgt)
         goto 20
      elseif (str.eq."302523233") then
         call srealmtrx_016(p,wgt)
         goto 20
      elseif (str.eq."-552523230") then
         call srealmtrx_017(p,wgt)
         goto 20
      elseif (str.eq."-50252323-5") then
         call srealmtrx_018(p,wgt)
         goto 20
      elseif (str.eq."5-52523230") then
         call srealmtrx_019(p,wgt)
         goto 20
      elseif (str.eq."502523235") then
         call srealmtrx_020(p,wgt)
         goto 20
      elseif (str.eq."0-1252323-1") then
         call srealmtrx_021(p,wgt)
         goto 20
      elseif (str.eq."012523231") then
         call srealmtrx_022(p,wgt)
         goto 20
      elseif (str.eq."0-2252323-2") then
         call srealmtrx_023(p,wgt)
         goto 20
      elseif (str.eq."022523232") then
         call srealmtrx_024(p,wgt)
         goto 20
      elseif (str.eq."0-4252323-4") then
         call srealmtrx_025(p,wgt)
         goto 20
      elseif (str.eq."042523234") then
         call srealmtrx_026(p,wgt)
         goto 20
      elseif (str.eq."0-3252323-3") then
         call srealmtrx_027(p,wgt)
         goto 20
      elseif (str.eq."032523233") then
         call srealmtrx_028(p,wgt)
         goto 20
      elseif (str.eq."0-5252323-5") then
         call srealmtrx_029(p,wgt)
         goto 20
      elseif (str.eq."052523235") then
