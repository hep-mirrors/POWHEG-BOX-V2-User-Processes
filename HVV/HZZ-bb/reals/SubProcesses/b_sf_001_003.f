...
C ----------
     ...
     &     6   ))                                                          
      CALL FVIXXX(W(1,6   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,1   ),W(1,5   ),GZD ,AMP(1   ))            
      CALL FVOXXX(W(1,1   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,8   ))    
      CALL FVIXXX(W(1,2   ),W(1,5   ),GZD ,BMASS   ,ZERO    ,W(1,9   ))    
      CALL IOSXXX(W(1,9   ),W(1,8   ),W(1,3   ),GHBOT ,AMP(2   ))          
      CALL JVSXXX(W(1,5   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     10  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,8   ),W(1,10  ),GZD ,AMP(3   ))            
      CALL HIOXXX(W(1,6   ),W(1,1   ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     11  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,4   ),W(1,11  ),GZZH ,AMP(4   ))           
      CALL IOVXXX(W(1,6   ),W(1,8   ),W(1,5   ),GZD ,AMP(5   ))            
      CALL FVIXXX(W(1,2   ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,12  ))    
      CALL FVOXXX(W(1,1   ),W(1,5   ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL IOSXXX(W(1,12  ),W(1,13  ),W(1,3   ),GHBOT ,AMP(6   ))          
      CALL FSOXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL FVOXXX(W(1,14  ),W(1,4   ),GZD ,BMASS   ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,2   ),W(1,15  ),W(1,5   ),GZD ,AMP(7   ))            
      CALL IOVXXX(W(1,12  ),W(1,1   ),W(1,10  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,2   ),W(1,14  ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     16  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,4   ),W(1,16  ),GZZH ,AMP(9   ))           
      CALL IOVXXX(W(1,12  ),W(1,14  ),W(1,5   ),GZD ,AMP(10  ))            
      CALL JVSXXX(W(1,4   ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     17  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,17  ),GZD ,AMP(11  ))            
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,17  ),GZD ,AMP(12  ))            
      CALL HIOXXX(W(1,2   ),W(1,1   ),GHBOT ,HMASS   ,HWIDTH  ,W(1,        
     &     18  ))                                                          
      CALL JVSXXX(W(1,4   ),W(1,18  ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     19  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,19  ),W(1,3   ),GZZH ,AMP(13  ))           
      CALL HSSXXX(W(1,18  ),W(1,3   ),GHHH ,HMASS   ,HWIDTH  ,W(1,         
     &     20  ))                                                          
      CALL VVSXXX(W(1,5   ),W(1,4   ),W(1,20  ),GZZH ,AMP(14  ))           
      CALL VVSSXX(W(1,4   ),W(1,5   ),W(1,3   ),W(1,18  ),GZZHH ,          
     &     AMP(15  ))                                                      
      CALL VVSXXX(W(1,5   ),W(1,17  ),W(1,18  ),GZZH ,AMP(16  ))           
      do i=1,ngraphs
