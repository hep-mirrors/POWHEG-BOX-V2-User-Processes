...
c     the value of massaren
     ...
     $     ph_MSUSY,ph_mbmb,ph_asmz_nnlo,ph_gfermi
     ...
     $     ph_tanb_mz,ph_ma_mz,ph_MSUSY,ph_mbmb,ph_asmz_nnlo,ph_gfermi
...
c      common /couplings/lambdafer, lambdasca
