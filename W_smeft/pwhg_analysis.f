...
c and in the CS frame (a0-a7), as a function of a cut on mW
      ...
      call bookupeqbins('mW_1',10d0,10d0,150d0)   
      call bookupeqbins('mW_2',100d0,150d0,1050d0)   
      call bookupeqbins('mW_3',500d0,1000d0,5000d0)   

      call bookupeqbins('mTW_1',10d0,10d0,150d0)   
      call bookupeqbins('mTW_2',100d0,150d0,1050d0)   
      call bookupeqbins('mTW_3',500d0,1000d0,5000d0)   

      call bookupeqbins('pT_1',10d0,1d0,101d0)   
      call bookupeqbins('pT_2',50d0,100d0,1000d0)   
      
      call bookupeqbins('eta_l',0.5d0,-5d0,5d0)   
      call bookupeqbins('eta_nu',0.5d0,-5d0,5d0)   
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      call filld('mW_1',m,dsig)
      call filld('mW_2',m,dsig)
      call filld('mW_3',m,dsig)
      
      call filld('mTW_1',mtv,dsig)
      call filld('mTW_2',mtv,dsig)
      call filld('mTW_3',mtv,dsig)
      
      
      call filld('pT_1',pt,dsig)
      call filld('pT_2',pt,dsig)
      
      call filld('eta_l',etal,dsig)
      call filld('eta_nu',etanu,dsig)
