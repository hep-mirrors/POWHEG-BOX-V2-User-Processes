      ...
      include 'pwhg_math.h'
      character * 5 scheme
      character * 30 form1,filename   
      character * 3 whichpdfpk
      real * 8 powheginput, vbfnloinput
      integer iorder,iret,iun,j,iunsoft(0:6),i
      include 'vbfnlo-files/global.inc'
      external whichpdfpk,powheginput,vbfnloinput
...
c thresholds 
      ...
      rad_charmthr2=vbfnloinput("#CHARMMASS")
      if(rad_charmthr2.lt.0) rad_charmthr2=1.5d0
      rad_charmthr2=rad_charmthr2**2
      rad_bottomthr2=vbfnloinput("#BOTTOMMASS")
