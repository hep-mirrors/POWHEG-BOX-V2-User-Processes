      SUBROUTINE SUS_USBBH(PBAR,FSIGN,FLAV,PH,ANS)
...
c     T=US_USBBH(P ,NHEL(1,IHEL),JC(1)) 
               call US_USBBH(pbar,fsign,flav,ph,nhel(1,ihel),T)
               do ICOL = 0,2
...
c      print*,'nc matrix element sq=',ans
      ...
      subroutine US_USBBH(PBAR,FSIGN,FLAV,PH,NHEL,MATRIX)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c
     ...
     &     17  ))                                                          
      ...
      JAMP(   1) = -AMP(   1)-AMP(   5)-AMP(  10)-AMP(  11)
      JAMP(   2) = -AMP(   3)-AMP(   7)-AMP(   9)-AMP(  12)
c     get color factors 
      do i = 1,ncolor
         do j =1,ncolor
