      SUBROUTINE SDC_USBBH(PBAR,FSIGN,PH,ANS)
...
c     T=DC_USBBH(P ,NHEL(1,IHEL),JC(1))            
               call DC_USBBH(PBAR,FSIGN,PH,nhel(1,ihel),T)
               DO ICOL=0,2
...
c       
c       
      subroutine DC_USBBH(PBAR,FSIGN,PH,NHEL,MATRIX)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c      CALL OXXXXX(P(0,6   ),BMASS ,NHEL(6   ),+1*IC(6   ),W(1,6   ))       
c      CALL SXXXXX(P(0,7   ),+1*IC(7   ),W(1,7   ))  
     ...
     &     13  ))                                                          
      CALL FVOXXX(W(1,4   ),W(1,13  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL IOVXXX(W(1,2   ),W(1,14  ),W(1,9   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,15  ),W(1,3   ),W(1,9   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,2   ),W(1,13  ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,16  ),W(1,4   ),W(1,9   ),GG ,AMP(4   ))             
