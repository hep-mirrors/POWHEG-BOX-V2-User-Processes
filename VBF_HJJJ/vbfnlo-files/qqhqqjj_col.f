...
c     
      ...
      subroutine qqHqqjj_channel(pbar,sign,qbar,gsign,k,ans,ansc)
c
...
c      real*8 p57,p68,den,betah,lamb
      ...
      logical lcol
c      parameter (lcol = .false.) ! compute color sum
      parameter (lcol = .true.) ! compute individual color structures
